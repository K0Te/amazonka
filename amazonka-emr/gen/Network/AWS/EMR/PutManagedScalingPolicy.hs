...
data PutManagedScalingPolicy = PutManagedScalingPolicy'{_pmspClusterId
                                                        :: !Text,
...
putManagedScalingPolicy
    :: Text -- ^ 'pmspClusterId'
    -> ManagedScalingPolicy -- ^ 'pmspManagedScalingPolicy'
    -> PutManagedScalingPolicy
putManagedScalingPolicy pClusterId_
  pManagedScalingPolicy_
  = PutManagedScalingPolicy'{_pmspClusterId =
                               pClusterId_,
...
instance AWSRequest PutManagedScalingPolicy where
        type Rs PutManagedScalingPolicy =
             PutManagedScalingPolicyResponse
...
instance Hashable PutManagedScalingPolicy where

instance NFData PutManagedScalingPolicy where
...
newtype PutManagedScalingPolicyResponse = PutManagedScalingPolicyResponse'{_pmsprsResponseStatus
                                                                           ::
                                                                           Int}
...
putManagedScalingPolicyResponse
    :: Int -- ^ 'pmsprsResponseStatus'
    -> PutManagedScalingPolicyResponse
putManagedScalingPolicyResponse pResponseStatus_
  = PutManagedScalingPolicyResponse'{_pmsprsResponseStatus
                                       = pResponseStatus_}
...
instance NFData PutManagedScalingPolicyResponse where
