...
instance AWSRequest GetBlockPublicAccessConfiguration
         where
...
instance ToHeaders GetBlockPublicAccessConfiguration
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON GetBlockPublicAccessConfiguration
         where
        toJSON = const (Object mempty)

instance ToPath GetBlockPublicAccessConfiguration
         where
        toPath = const "/"

instance ToQuery GetBlockPublicAccessConfiguration
         where
        toQuery = const mempty

-- | /See:/ 'getBlockPublicAccessConfigurationResponse' smart constructor.
data GetBlockPublicAccessConfigurationResponse = GetBlockPublicAccessConfigurationResponse'{_gbpacrsResponseStatus
                                                                                            ::
                                                                                            !Int,
...
getBlockPublicAccessConfigurationResponse
    :: Int -- ^ 'gbpacrsResponseStatus'
    -> BlockPublicAccessConfiguration -- ^ 'gbpacrsBlockPublicAccessConfiguration'
    -> BlockPublicAccessConfigurationMetadata -- ^ 'gbpacrsBlockPublicAccessConfigurationMetadata'
    -> GetBlockPublicAccessConfigurationResponse
getBlockPublicAccessConfigurationResponse
  pResponseStatus_ pBlockPublicAccessConfiguration_
  pBlockPublicAccessConfigurationMetadata_
  = GetBlockPublicAccessConfigurationResponse'{_gbpacrsResponseStatus
                                                 = pResponseStatus_,
                                               _gbpacrsBlockPublicAccessConfiguration
                                                 =
