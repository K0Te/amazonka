...
newtype DescribeStudio = DescribeStudio'{_dsStudioId
                                         :: Text}
...
instance Hashable DescribeStudio where

instance NFData DescribeStudio where
...
data DescribeStudioResponse = DescribeStudioResponse'{_desrsStudio
                                                      :: !(Maybe Studio),
...
describeStudioResponse pResponseStatus_
  = DescribeStudioResponse'{_desrsStudio = Nothing,
...
instance NFData DescribeStudioResponse where
