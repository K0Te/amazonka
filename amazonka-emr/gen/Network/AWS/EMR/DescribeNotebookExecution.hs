...
newtype DescribeNotebookExecution = DescribeNotebookExecution'{_dneNotebookExecutionId
                                                               :: Text}
...
describeNotebookExecution
    :: Text -- ^ 'dneNotebookExecutionId'
    -> DescribeNotebookExecution
describeNotebookExecution pNotebookExecutionId_
  = DescribeNotebookExecution'{_dneNotebookExecutionId
...
instance Hashable DescribeNotebookExecution where

instance NFData DescribeNotebookExecution where
...
data DescribeNotebookExecutionResponse = DescribeNotebookExecutionResponse'{_dnersNotebookExecution
                                                                            ::
                                                                            !(Maybe
                                                                                NotebookExecution),
...
describeNotebookExecutionResponse
    :: Int -- ^ 'dnersResponseStatus'
    -> DescribeNotebookExecutionResponse
describeNotebookExecutionResponse pResponseStatus_
  = DescribeNotebookExecutionResponse'{_dnersNotebookExecution
                                         = Nothing,
