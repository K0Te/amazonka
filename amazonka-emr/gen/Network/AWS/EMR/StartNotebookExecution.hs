...
data StartNotebookExecution = StartNotebookExecution'{_sneNotebookInstanceSecurityGroupId
                                                      :: !(Maybe Text),
...
startNotebookExecution
    :: Text -- ^ 'sneEditorId'
    -> Text -- ^ 'sneRelativePath'
    -> ExecutionEngineConfig -- ^ 'sneExecutionEngine'
    -> Text -- ^ 'sneServiceRole'
    -> StartNotebookExecution
startNotebookExecution pEditorId_ pRelativePath_
  pExecutionEngine_ pServiceRole_
  = StartNotebookExecution'{_sneNotebookInstanceSecurityGroupId
                              = Nothing,
                            _sneNotebookExecutionName = Nothing,
                            _sneNotebookParams = Nothing, _sneTags = Nothing,
...
instance AWSRequest StartNotebookExecution where
        type Rs StartNotebookExecution =
             StartNotebookExecutionResponse
...
instance Hashable StartNotebookExecution where

instance NFData StartNotebookExecution where
...
data StartNotebookExecutionResponse = StartNotebookExecutionResponse'{_snersNotebookExecutionId
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _snersResponseStatus
                                                                      :: !Int}
...
startNotebookExecutionResponse
    :: Int -- ^ 'snersResponseStatus'
    -> StartNotebookExecutionResponse
startNotebookExecutionResponse pResponseStatus_
  = StartNotebookExecutionResponse'{_snersNotebookExecutionId
                                      = Nothing,
...
instance NFData StartNotebookExecutionResponse where
