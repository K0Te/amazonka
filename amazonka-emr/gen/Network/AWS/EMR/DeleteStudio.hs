...
newtype DeleteStudio = DeleteStudio'{_dStudioId ::
                                     Text}
...
deleteStudio pStudioId_
  = DeleteStudio'{_dStudioId = pStudioId_}
...
instance Hashable DeleteStudio where

instance NFData DeleteStudio where
...
instance NFData DeleteStudioResponse where
