...
data ModifyCluster = ModifyCluster'{_mcStepConcurrencyLevel
                                    :: !(Maybe Int),
                                    _mcClusterId :: !Text}
...
modifyCluster pClusterId_
  = ModifyCluster'{_mcStepConcurrencyLevel = Nothing,
...
data ModifyClusterResponse = ModifyClusterResponse'{_mcrsStepConcurrencyLevel
                                                    :: !(Maybe Int),
...
modifyClusterResponse pResponseStatus_
  = ModifyClusterResponse'{_mcrsStepConcurrencyLevel =
                             Nothing,
