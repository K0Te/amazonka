...
data CreateStudioSessionMapping = CreateStudioSessionMapping'{_cssmIdentityId
                                                              :: !(Maybe Text),
                                                              _cssmIdentityName
                                                              :: !(Maybe Text),
                                                              _cssmStudioId ::
...
createStudioSessionMapping
    :: Text -- ^ 'cssmStudioId'
    -> IdentityType -- ^ 'cssmIdentityType'
    -> Text -- ^ 'cssmSessionPolicyARN'
    -> CreateStudioSessionMapping
createStudioSessionMapping pStudioId_ pIdentityType_
  pSessionPolicyARN_
  = CreateStudioSessionMapping'{_cssmIdentityId =
                                  Nothing,
...
instance AWSRequest CreateStudioSessionMapping where
        type Rs CreateStudioSessionMapping =
             CreateStudioSessionMappingResponse
        request = postJSON emr
        response
          = receiveNull CreateStudioSessionMappingResponse'

instance Hashable CreateStudioSessionMapping where

instance NFData CreateStudioSessionMapping where
