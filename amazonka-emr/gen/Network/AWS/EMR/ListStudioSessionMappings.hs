...
data ListStudioSessionMappings = ListStudioSessionMappings'{_lssmStudioId
                                                            :: !(Maybe Text),
                                                            _lssmIdentityType ::
                                                            !(Maybe
                                                                IdentityType),
...
listStudioSessionMappings
    :: ListStudioSessionMappings
listStudioSessionMappings
  = ListStudioSessionMappings'{_lssmStudioId = Nothing,
...
instance AWSPager ListStudioSessionMappings where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lssmMarker .~ rs ^. lssmrsMarker
...
instance Hashable ListStudioSessionMappings where

instance NFData ListStudioSessionMappings where
...
data ListStudioSessionMappingsResponse = ListStudioSessionMappingsResponse'{_lssmrsSessionMappings
                                                                            ::
                                                                            !(Maybe
...
listStudioSessionMappingsResponse
    :: Int -- ^ 'lssmrsResponseStatus'
    -> ListStudioSessionMappingsResponse
listStudioSessionMappingsResponse pResponseStatus_
  = ListStudioSessionMappingsResponse'{_lssmrsSessionMappings
                                         = Nothing,
