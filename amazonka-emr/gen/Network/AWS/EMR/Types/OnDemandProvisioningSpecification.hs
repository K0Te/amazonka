...
newtype OnDemandProvisioningSpecification = OnDemandProvisioningSpecification'{_odpsAllocationStrategy
                                                                               ::
...
onDemandProvisioningSpecification
    :: OnDemandProvisioningAllocationStrategy -- ^ 'odpsAllocationStrategy'
    -> OnDemandProvisioningSpecification
onDemandProvisioningSpecification
  pAllocationStrategy_
  = OnDemandProvisioningSpecification'{_odpsAllocationStrategy
                                         = pAllocationStrategy_}
...
instance FromJSON OnDemandProvisioningSpecification
         where
        parseJSON
          = withObject "OnDemandProvisioningSpecification"
              (\ x ->
                 OnDemandProvisioningSpecification' <$>
...
instance ToJSON OnDemandProvisioningSpecification
         where
