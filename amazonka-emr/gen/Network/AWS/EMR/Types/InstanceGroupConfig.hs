...
data InstanceGroupConfig = InstanceGroupConfig'{_igcEBSConfiguration
...
instanceGroupConfig pInstanceRole_ pInstanceType_
  pInstanceCount_
  = InstanceGroupConfig'{_igcEBSConfiguration =
                           Nothing,
                         _igcBidPrice = Nothing, _igcConfigurations = Nothing,
                         _igcMarket = Nothing, _igcName = Nothing,
