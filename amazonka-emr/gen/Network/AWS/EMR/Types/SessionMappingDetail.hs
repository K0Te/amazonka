...
data SessionMappingDetail = SessionMappingDetail'{_smdCreationTime
                                                  :: !(Maybe POSIX),
...
sessionMappingDetail
    :: SessionMappingDetail
sessionMappingDetail
  = SessionMappingDetail'{_smdCreationTime = Nothing,
                          _smdStudioId = Nothing,
                          _smdLastModifiedTime = Nothing,
                          _smdIdentityType = Nothing, _smdIdentityId = Nothing,
...
instance FromJSON SessionMappingDetail where
        parseJSON
          = withObject "SessionMappingDetail"
              (\ x ->
                 SessionMappingDetail' <$>
...
instance Hashable SessionMappingDetail where

instance NFData SessionMappingDetail where
