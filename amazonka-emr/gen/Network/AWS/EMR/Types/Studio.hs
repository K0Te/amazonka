...
studio
    :: Studio
studio
  = Studio'{_stuCreationTime = Nothing,
            _stuEngineSecurityGroupId = Nothing,
            _stuSubnetIds = Nothing, _stuStudioId = Nothing,
            _stuVPCId = Nothing, _stuURL = Nothing,
            _stuAuthMode = Nothing,
            _stuDefaultS3Location = Nothing,
            _stuWorkspaceSecurityGroupId = Nothing,
            _stuName = Nothing, _stuStudioARN = Nothing,
            _stuUserRole = Nothing, _stuDescription = Nothing,
            _stuTags = Nothing, _stuServiceRole = Nothing}
...
instance Hashable Studio where

instance NFData Studio where
