...
data PlacementGroupConfig = PlacementGroupConfig'{_pgcPlacementStrategy
                                                  ::
                                                  !(Maybe
...
placementGroupConfig
    :: InstanceRoleType -- ^ 'pgcInstanceRole'
    -> PlacementGroupConfig
placementGroupConfig pInstanceRole_
  = PlacementGroupConfig'{_pgcPlacementStrategy =
                            Nothing,
...
instance FromJSON PlacementGroupConfig where
        parseJSON
          = withObject "PlacementGroupConfig"
              (\ x ->
                 PlacementGroupConfig' <$>
                   (x .:? "PlacementStrategy") <*>
                     (x .: "InstanceRole"))

instance Hashable PlacementGroupConfig where

instance NFData PlacementGroupConfig where
