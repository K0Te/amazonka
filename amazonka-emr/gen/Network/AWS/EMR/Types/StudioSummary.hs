...
data StudioSummary = StudioSummary'{_ssCreationTime
                                    :: !(Maybe POSIX),
...
studioSummary
    :: StudioSummary
studioSummary
  = StudioSummary'{_ssCreationTime = Nothing,
                   _ssStudioId = Nothing, _ssVPCId = Nothing,
                   _ssURL = Nothing, _ssName = Nothing,
...
instance Hashable StudioSummary where

instance NFData StudioSummary where
