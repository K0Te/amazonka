...
data ExecutionEngineConfig = ExecutionEngineConfig'{_eecMasterInstanceSecurityGroupId
                                                    :: !(Maybe Text),
                                                    _eecType ::
                                                    !(Maybe
                                                        ExecutionEngineType),
...
executionEngineConfig pId_
  = ExecutionEngineConfig'{_eecMasterInstanceSecurityGroupId
                             = Nothing,
                           _eecType = Nothing, _eecId = pId_}
...
instance FromJSON ExecutionEngineConfig where
        parseJSON
          = withObject "ExecutionEngineConfig"
              (\ x ->
                 ExecutionEngineConfig' <$>
...
instance Hashable ExecutionEngineConfig where

instance NFData ExecutionEngineConfig where
