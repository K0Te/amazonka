...
newtype RemoveManagedScalingPolicy = RemoveManagedScalingPolicy'{_rmspClusterId
                                                                 :: Text}
...
removeManagedScalingPolicy pClusterId_
  = RemoveManagedScalingPolicy'{_rmspClusterId =
                                  pClusterId_}
...
instance Hashable RemoveManagedScalingPolicy where

instance NFData RemoveManagedScalingPolicy where
...
newtype RemoveManagedScalingPolicyResponse = RemoveManagedScalingPolicyResponse'{_rmsprsResponseStatus
                                                                                 ::
                                                                                 Int}
...
removeManagedScalingPolicyResponse
    :: Int -- ^ 'rmsprsResponseStatus'
    -> RemoveManagedScalingPolicyResponse
removeManagedScalingPolicyResponse pResponseStatus_
  = RemoveManagedScalingPolicyResponse'{_rmsprsResponseStatus
                                          = pResponseStatus_}
