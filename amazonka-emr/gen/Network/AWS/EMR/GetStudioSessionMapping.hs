...
data GetStudioSessionMapping = GetStudioSessionMapping'{_gssmIdentityId
                                                        :: !(Maybe Text),
                                                        _gssmIdentityName ::
                                                        !(Maybe Text),
                                                        _gssmStudioId :: !Text,
...
getStudioSessionMapping
    :: Text -- ^ 'gssmStudioId'
    -> IdentityType -- ^ 'gssmIdentityType'
    -> GetStudioSessionMapping
getStudioSessionMapping pStudioId_ pIdentityType_
  = GetStudioSessionMapping'{_gssmIdentityId = Nothing,
...
instance AWSRequest GetStudioSessionMapping where
        type Rs GetStudioSessionMapping =
             GetStudioSessionMappingResponse
...
instance Hashable GetStudioSessionMapping where

instance NFData GetStudioSessionMapping where
...
data GetStudioSessionMappingResponse = GetStudioSessionMappingResponse'{_gssmrsSessionMapping
                                                                        ::
                                                                        !(Maybe
...
getStudioSessionMappingResponse
    :: Int -- ^ 'gssmrsResponseStatus'
    -> GetStudioSessionMappingResponse
getStudioSessionMappingResponse pResponseStatus_
  = GetStudioSessionMappingResponse'{_gssmrsSessionMapping
                                       = Nothing,
...
instance NFData GetStudioSessionMappingResponse where
