...
data UpdateStudioSessionMapping = UpdateStudioSessionMapping'{_ussmIdentityId
                                                              :: !(Maybe Text),
                                                              _ussmIdentityName
                                                              :: !(Maybe Text),
                                                              _ussmStudioId ::
...
updateStudioSessionMapping
    :: Text -- ^ 'ussmStudioId'
    -> IdentityType -- ^ 'ussmIdentityType'
    -> Text -- ^ 'ussmSessionPolicyARN'
    -> UpdateStudioSessionMapping
updateStudioSessionMapping pStudioId_ pIdentityType_
  pSessionPolicyARN_
  = UpdateStudioSessionMapping'{_ussmIdentityId =
                                  Nothing,
...
instance Hashable UpdateStudioSessionMapping where

instance NFData UpdateStudioSessionMapping where
