...
newtype StopNotebookExecution = StopNotebookExecution'{_sneNotebookExecutionId
                                                       :: Text}
...
stopNotebookExecution
    :: Text -- ^ 'sneNotebookExecutionId'
    -> StopNotebookExecution
stopNotebookExecution pNotebookExecutionId_
  = StopNotebookExecution'{_sneNotebookExecutionId =
...
instance AWSRequest StopNotebookExecution where
        type Rs StopNotebookExecution =
             StopNotebookExecutionResponse
        request = postJSON emr
        response = receiveNull StopNotebookExecutionResponse'

instance Hashable StopNotebookExecution where

instance NFData StopNotebookExecution where
...
instance NFData StopNotebookExecutionResponse where
