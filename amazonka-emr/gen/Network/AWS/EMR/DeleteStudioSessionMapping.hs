...
data DeleteStudioSessionMapping = DeleteStudioSessionMapping'{_dssmIdentityId
                                                              :: !(Maybe Text),
                                                              _dssmIdentityName
                                                              :: !(Maybe Text),
                                                              _dssmStudioId ::
...
deleteStudioSessionMapping
    :: Text -- ^ 'dssmStudioId'
    -> IdentityType -- ^ 'dssmIdentityType'
    -> DeleteStudioSessionMapping
deleteStudioSessionMapping pStudioId_ pIdentityType_
  = DeleteStudioSessionMapping'{_dssmIdentityId =
                                  Nothing,
...
instance Hashable DeleteStudioSessionMapping where

instance NFData DeleteStudioSessionMapping where
