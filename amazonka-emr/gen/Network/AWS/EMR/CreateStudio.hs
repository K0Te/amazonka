...
data CreateStudio = CreateStudio'{_csDefaultS3Location
                                  :: !(Maybe Text),
                                  _csDescription :: !(Maybe Text),
                                  _csTags :: !(Maybe [Tag]), _csName :: !Text,
                                  _csAuthMode :: !AuthMode, _csVPCId :: !Text,
                                  _csSubnetIds :: ![Text],
                                  _csServiceRole :: !Text, _csUserRole :: !Text,
...
createStudio
    ...
    -> Text -- ^ 'csServiceRole'
    -> Text -- ^ 'csUserRole'
    -> Text -- ^ 'csWorkspaceSecurityGroupId'
    -> Text -- ^ 'csEngineSecurityGroupId'
    -> CreateStudio
createStudio pName_ pAuthMode_ pVPCId_ pServiceRole_
  pUserRole_ pWorkspaceSecurityGroupId_
  pEngineSecurityGroupId_
  = CreateStudio'{_csDefaultS3Location = Nothing,
                  _csDescription = Nothing, _csTags = Nothing,
                  _csName = pName_, _csAuthMode = pAuthMode_,
                  _csVPCId = pVPCId_, _csSubnetIds = mempty,
                  _csServiceRole = pServiceRole_,
                  _csUserRole = pUserRole_,
                  _csWorkspaceSecurityGroupId =
...
instance Hashable CreateStudio where

instance NFData CreateStudio where
...
data CreateStudioResponse = CreateStudioResponse'{_crsStudioId
                                                  :: !(Maybe Text),
                                                  _crsURL :: !(Maybe Text),
...
createStudioResponse pResponseStatus_
  = CreateStudioResponse'{_crsStudioId = Nothing,
                          _crsURL = Nothing,
...
instance NFData CreateStudioResponse where
