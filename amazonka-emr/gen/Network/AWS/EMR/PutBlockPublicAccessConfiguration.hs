...
newtype PutBlockPublicAccessConfiguration = PutBlockPublicAccessConfiguration'{_pbpacBlockPublicAccessConfiguration
                                                                               ::
...
putBlockPublicAccessConfiguration
    :: BlockPublicAccessConfiguration -- ^ 'pbpacBlockPublicAccessConfiguration'
    -> PutBlockPublicAccessConfiguration
putBlockPublicAccessConfiguration
  pBlockPublicAccessConfiguration_
  = PutBlockPublicAccessConfiguration'{_pbpacBlockPublicAccessConfiguration
                                         = pBlockPublicAccessConfiguration_}
...
instance AWSRequest PutBlockPublicAccessConfiguration
         where
...
instance ToHeaders PutBlockPublicAccessConfiguration
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON PutBlockPublicAccessConfiguration
         where
...
instance ToPath PutBlockPublicAccessConfiguration
         where
        toPath = const "/"

instance ToQuery PutBlockPublicAccessConfiguration
         where
        toQuery = const mempty

-- | /See:/ 'putBlockPublicAccessConfigurationResponse' smart constructor.
newtype PutBlockPublicAccessConfigurationResponse = PutBlockPublicAccessConfigurationResponse'{_pbpacrsResponseStatus
                                                                                               ::
                                                                                               Int}
...
putBlockPublicAccessConfigurationResponse
    :: Int -- ^ 'pbpacrsResponseStatus'
    -> PutBlockPublicAccessConfigurationResponse
putBlockPublicAccessConfigurationResponse
  pResponseStatus_
  = PutBlockPublicAccessConfigurationResponse'{_pbpacrsResponseStatus
                                                 = pResponseStatus_}
