...
newtype GetManagedScalingPolicy = GetManagedScalingPolicy'{_gmspClusterId
                                                           :: Text}
...
getManagedScalingPolicy pClusterId_
  = GetManagedScalingPolicy'{_gmspClusterId =
                               pClusterId_}
...
instance AWSRequest GetManagedScalingPolicy where
        type Rs GetManagedScalingPolicy =
             GetManagedScalingPolicyResponse
...
instance Hashable GetManagedScalingPolicy where

instance NFData GetManagedScalingPolicy where
...
data GetManagedScalingPolicyResponse = GetManagedScalingPolicyResponse'{_gmsprsManagedScalingPolicy
                                                                        ::
                                                                        !(Maybe
...
getManagedScalingPolicyResponse
    :: Int -- ^ 'gmsprsResponseStatus'
    -> GetManagedScalingPolicyResponse
getManagedScalingPolicyResponse pResponseStatus_
  = GetManagedScalingPolicyResponse'{_gmsprsManagedScalingPolicy
                                       = Nothing,
...
instance NFData GetManagedScalingPolicyResponse where
