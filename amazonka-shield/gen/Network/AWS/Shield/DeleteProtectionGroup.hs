...
newtype DeleteProtectionGroup = DeleteProtectionGroup'{_dpgProtectionGroupId
                                                       :: Text}
...
deleteProtectionGroup
    :: Text -- ^ 'dpgProtectionGroupId'
    -> DeleteProtectionGroup
deleteProtectionGroup pProtectionGroupId_
  = DeleteProtectionGroup'{_dpgProtectionGroupId =
                             pProtectionGroupId_}
...
instance Hashable DeleteProtectionGroup where

instance NFData DeleteProtectionGroup where
...
newtype DeleteProtectionGroupResponse = DeleteProtectionGroupResponse'{_dpgrsResponseStatus
                                                                       :: Int}
...
deleteProtectionGroupResponse pResponseStatus_
  = DeleteProtectionGroupResponse'{_dpgrsResponseStatus
                                     = pResponseStatus_}
...
instance NFData DeleteProtectionGroupResponse where
