...
data ListResourcesInProtectionGroup = ListResourcesInProtectionGroup'{_lripgNextToken
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _lripgMaxResults
...
listResourcesInProtectionGroup
    :: Text -- ^ 'lripgProtectionGroupId'
    -> ListResourcesInProtectionGroup
listResourcesInProtectionGroup pProtectionGroupId_
  = ListResourcesInProtectionGroup'{_lripgNextToken =
                                      Nothing,
...
instance AWSRequest ListResourcesInProtectionGroup
         where
...
instance NFData ListResourcesInProtectionGroup where

instance ToHeaders ListResourcesInProtectionGroup
         where
        toHeaders
          = const
              (mconcat
...
data ListResourcesInProtectionGroupResponse = ListResourcesInProtectionGroupResponse'{_lripgrsNextToken
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
...
listResourcesInProtectionGroupResponse
    :: Int -- ^ 'lripgrsResponseStatus'
    -> ListResourcesInProtectionGroupResponse
listResourcesInProtectionGroupResponse
  pResponseStatus_
  = ListResourcesInProtectionGroupResponse'{_lripgrsNextToken
                                              = Nothing,
                                            _lripgrsResponseStatus =
                                              pResponseStatus_,
