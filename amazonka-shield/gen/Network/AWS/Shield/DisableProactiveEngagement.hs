...
instance Hashable DisableProactiveEngagement where

instance NFData DisableProactiveEngagement where
...
newtype DisableProactiveEngagementResponse = DisableProactiveEngagementResponse'{_dpersResponseStatus
                                                                                 ::
                                                                                 Int}
...
disableProactiveEngagementResponse pResponseStatus_
  = DisableProactiveEngagementResponse'{_dpersResponseStatus
                                          = pResponseStatus_}
