...
newtype UpdateEmergencyContactSettings = UpdateEmergencyContactSettings'{_uecsEmergencyContactList
                                                                         ::
                                                                         Maybe
                                                                           [EmergencyContact]}
...
updateEmergencyContactSettings
    :: UpdateEmergencyContactSettings
updateEmergencyContactSettings
  = UpdateEmergencyContactSettings'{_uecsEmergencyContactList
                                      = Nothing}
...
instance AWSRequest UpdateEmergencyContactSettings
         where
...
instance NFData UpdateEmergencyContactSettings where

instance ToHeaders UpdateEmergencyContactSettings
         where
        toHeaders
          = const
              (mconcat
...
newtype UpdateEmergencyContactSettingsResponse = UpdateEmergencyContactSettingsResponse'{_uecsrsResponseStatus
                                                                                         ::
                                                                                         Int}
...
updateEmergencyContactSettingsResponse
    :: Int -- ^ 'uecsrsResponseStatus'
    -> UpdateEmergencyContactSettingsResponse
updateEmergencyContactSettingsResponse
  pResponseStatus_
  = UpdateEmergencyContactSettingsResponse'{_uecsrsResponseStatus
                                              = pResponseStatus_}
