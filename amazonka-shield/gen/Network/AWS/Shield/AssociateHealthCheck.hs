...
data AssociateHealthCheck = AssociateHealthCheck'{_ahcProtectionId
                                                  :: !Text,
...
associateHealthCheck
    :: Text -- ^ 'ahcProtectionId'
    -> Text -- ^ 'ahcHealthCheckARN'
    -> AssociateHealthCheck
associateHealthCheck pProtectionId_ pHealthCheckARN_
  = AssociateHealthCheck'{_ahcProtectionId =
                            pProtectionId_,
...
instance Hashable AssociateHealthCheck where

instance NFData AssociateHealthCheck where
...
newtype AssociateHealthCheckResponse = AssociateHealthCheckResponse'{_ahcrsResponseStatus
                                                                     :: Int}
...
associateHealthCheckResponse
    :: Int -- ^ 'ahcrsResponseStatus'
    -> AssociateHealthCheckResponse
associateHealthCheckResponse pResponseStatus_
  = AssociateHealthCheckResponse'{_ahcrsResponseStatus
                                    = pResponseStatus_}
...
instance NFData AssociateHealthCheckResponse where
