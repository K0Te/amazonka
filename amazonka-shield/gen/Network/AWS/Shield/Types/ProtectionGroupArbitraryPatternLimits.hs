...
newtype ProtectionGroupArbitraryPatternLimits = ProtectionGroupArbitraryPatternLimits'{_pgaplMaxMembers
                                                                                       ::
                                                                                       Integer}
...
protectionGroupArbitraryPatternLimits
    :: Integer -- ^ 'pgaplMaxMembers'
    -> ProtectionGroupArbitraryPatternLimits
protectionGroupArbitraryPatternLimits pMaxMembers_
  = ProtectionGroupArbitraryPatternLimits'{_pgaplMaxMembers
                                             = pMaxMembers_}
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "ProtectionGroupArbitraryPatternLimits"
              (\ x ->
                 ProtectionGroupArbitraryPatternLimits' <$>
                   (x .: "MaxMembers"))
