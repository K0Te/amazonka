...
data ProtectionGroupLimits = ProtectionGroupLimits'{_pglMaxProtectionGroups
                                                    :: !Integer,
...
protectionGroupLimits
    :: Integer -- ^ 'pglMaxProtectionGroups'
    -> ProtectionGroupPatternTypeLimits -- ^ 'pglPatternTypeLimits'
    -> ProtectionGroupLimits
protectionGroupLimits pMaxProtectionGroups_
  pPatternTypeLimits_
  = ProtectionGroupLimits'{_pglMaxProtectionGroups =
...
instance FromJSON ProtectionGroupLimits where
        parseJSON
          = withObject "ProtectionGroupLimits"
              (\ x ->
                 ProtectionGroupLimits' <$>
                   (x .: "MaxProtectionGroups") <*>
                     (x .: "PatternTypeLimits"))

instance Hashable ProtectionGroupLimits where

instance NFData ProtectionGroupLimits where
