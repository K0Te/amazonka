...
newtype ProtectionLimits = ProtectionLimits'{_plProtectedResourceTypeLimits
                                             :: [Limit]}
...
protectionLimits
    :: ProtectionLimits
protectionLimits
  = ProtectionLimits'{_plProtectedResourceTypeLimits =
                        mempty}
...
instance FromJSON ProtectionLimits where
        parseJSON
          = withObject "ProtectionLimits"
              (\ x ->
                 ProtectionLimits' <$>
                   (x .:? "ProtectedResourceTypeLimits" .!= mempty))

instance Hashable ProtectionLimits where

instance NFData ProtectionLimits where
