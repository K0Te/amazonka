...
data AttackStatisticsDataItem = AttackStatisticsDataItem'{_asdiAttackVolume
                                                          ::
                                                          !(Maybe AttackVolume),
                                                          _asdiAttackCount ::
                                                          !Integer}
...
attackStatisticsDataItem
    :: Integer -- ^ 'asdiAttackCount'
    -> AttackStatisticsDataItem
attackStatisticsDataItem pAttackCount_
  = AttackStatisticsDataItem'{_asdiAttackVolume =
                                Nothing,
...
instance FromJSON AttackStatisticsDataItem where
        parseJSON
          = withObject "AttackStatisticsDataItem"
              (\ x ->
                 AttackStatisticsDataItem' <$>
                   (x .:? "AttackVolume") <*> (x .: "AttackCount"))

instance Hashable AttackStatisticsDataItem where

instance NFData AttackStatisticsDataItem where
