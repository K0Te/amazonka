...
newtype ProtectionGroupPatternTypeLimits = ProtectionGroupPatternTypeLimits'{_pgptlArbitraryPatternLimits
                                                                             ::
...
protectionGroupPatternTypeLimits
    :: ProtectionGroupArbitraryPatternLimits -- ^ 'pgptlArbitraryPatternLimits'
    -> ProtectionGroupPatternTypeLimits
protectionGroupPatternTypeLimits
  pArbitraryPatternLimits_
  = ProtectionGroupPatternTypeLimits'{_pgptlArbitraryPatternLimits
                                        = pArbitraryPatternLimits_}
...
instance FromJSON ProtectionGroupPatternTypeLimits
         where
        parseJSON
          = withObject "ProtectionGroupPatternTypeLimits"
              (\ x ->
                 ProtectionGroupPatternTypeLimits' <$>
