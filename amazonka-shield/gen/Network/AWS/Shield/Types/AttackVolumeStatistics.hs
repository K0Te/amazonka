...
newtype AttackVolumeStatistics = AttackVolumeStatistics'{_avsMax
                                                         :: Double}
...
instance FromJSON AttackVolumeStatistics where
        parseJSON
          = withObject "AttackVolumeStatistics"
              (\ x -> AttackVolumeStatistics' <$> (x .: "Max"))

instance Hashable AttackVolumeStatistics where

instance NFData AttackVolumeStatistics where
