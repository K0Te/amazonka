...
data SubscriptionLimits = SubscriptionLimits'{_slProtectionLimits
                                              :: !ProtectionLimits,
...
subscriptionLimits
    :: ProtectionLimits -- ^ 'slProtectionLimits'
    -> ProtectionGroupLimits -- ^ 'slProtectionGroupLimits'
    -> SubscriptionLimits
subscriptionLimits pProtectionLimits_
  pProtectionGroupLimits_
  = SubscriptionLimits'{_slProtectionLimits =
                          pProtectionLimits_,
...
instance FromJSON SubscriptionLimits where
        parseJSON
          = withObject "SubscriptionLimits"
              (\ x ->
                 SubscriptionLimits' <$>
                   (x .: "ProtectionLimits") <*>
                     (x .: "ProtectionGroupLimits"))

instance Hashable SubscriptionLimits where

instance NFData SubscriptionLimits where
