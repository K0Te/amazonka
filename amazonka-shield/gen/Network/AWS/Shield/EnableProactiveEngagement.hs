...
instance Hashable EnableProactiveEngagement where

instance NFData EnableProactiveEngagement where
...
newtype EnableProactiveEngagementResponse = EnableProactiveEngagementResponse'{_epersResponseStatus
                                                                               ::
                                                                               Int}
...
enableProactiveEngagementResponse
    :: Int -- ^ 'epersResponseStatus'
    -> EnableProactiveEngagementResponse
enableProactiveEngagementResponse pResponseStatus_
  = EnableProactiveEngagementResponse'{_epersResponseStatus
                                         = pResponseStatus_}
