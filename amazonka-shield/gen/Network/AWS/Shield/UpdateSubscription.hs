...
newtype UpdateSubscription = UpdateSubscription'{_usAutoRenew
                                                 :: Maybe AutoRenew}
...
newtype UpdateSubscriptionResponse = UpdateSubscriptionResponse'{_usrsResponseStatus
                                                                 :: Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
updateSubscriptionResponse pResponseStatus_
  = UpdateSubscriptionResponse'{_usrsResponseStatus =
                                  pResponseStatus_}
