...
newtype DescribeProtectionGroup = DescribeProtectionGroup'{_dProtectionGroupId
                                                           :: Text}
...
describeProtectionGroup
    :: Text -- ^ 'dProtectionGroupId'
    -> DescribeProtectionGroup
describeProtectionGroup pProtectionGroupId_
  = DescribeProtectionGroup'{_dProtectionGroupId =
                               pProtectionGroupId_}
...
instance AWSRequest DescribeProtectionGroup where
        type Rs DescribeProtectionGroup =
             DescribeProtectionGroupResponse
...
instance Hashable DescribeProtectionGroup where

instance NFData DescribeProtectionGroup where
...
data DescribeProtectionGroupResponse = DescribeProtectionGroupResponse'{_drsResponseStatus
                                                                        :: !Int,
                                                                        _drsProtectionGroup
                                                                        ::
                                                                        !ProtectionGroup}
...
describeProtectionGroupResponse
    ...
    -> ProtectionGroup -- ^ 'drsProtectionGroup'
    -> DescribeProtectionGroupResponse
describeProtectionGroupResponse pResponseStatus_
  pProtectionGroup_
  = DescribeProtectionGroupResponse'{_drsResponseStatus
                                       = pResponseStatus_,
...
instance NFData DescribeProtectionGroupResponse where
