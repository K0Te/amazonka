...
newtype AssociateDRTLogBucket = AssociateDRTLogBucket'{_adrtlbLogBucket
                                                       :: Text}
...
associateDRTLogBucket pLogBucket_
  = AssociateDRTLogBucket'{_adrtlbLogBucket =
                             pLogBucket_}
...
newtype AssociateDRTLogBucketResponse = AssociateDRTLogBucketResponse'{_adrtlbrsResponseStatus
                                                                       :: Int}
...
associateDRTLogBucketResponse pResponseStatus_
  = AssociateDRTLogBucketResponse'{_adrtlbrsResponseStatus
                                     = pResponseStatus_}
