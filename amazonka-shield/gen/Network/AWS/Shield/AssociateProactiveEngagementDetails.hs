...
newtype AssociateProactiveEngagementDetails = AssociateProactiveEngagementDetails'{_apedEmergencyContactList
                                                                                   ::
                                                                                   [EmergencyContact]}
...
associateProactiveEngagementDetails
    :: AssociateProactiveEngagementDetails
associateProactiveEngagementDetails
  = AssociateProactiveEngagementDetails'{_apedEmergencyContactList
                                           = mempty}
...
instance AWSRequest
           AssociateProactiveEngagementDetails
         where
        type Rs AssociateProactiveEngagementDetails =
             AssociateProactiveEngagementDetailsResponse
...
instance ToJSON AssociateProactiveEngagementDetails
         where
...
instance ToPath AssociateProactiveEngagementDetails
         where
        toPath = const "/"

instance ToQuery AssociateProactiveEngagementDetails
         where
        toQuery = const mempty

-- | /See:/ 'associateProactiveEngagementDetailsResponse' smart constructor.
newtype AssociateProactiveEngagementDetailsResponse = AssociateProactiveEngagementDetailsResponse'{_apedrsResponseStatus
                                                                                                   ::
                                                                                                   Int}
                                                        deriving (Eq, Read,
                                                                  Show, Data,
...
associateProactiveEngagementDetailsResponse
    :: Int -- ^ 'apedrsResponseStatus'
    -> AssociateProactiveEngagementDetailsResponse
associateProactiveEngagementDetailsResponse
  pResponseStatus_
  = AssociateProactiveEngagementDetailsResponse'{_apedrsResponseStatus
                                                   = pResponseStatus_}
