...
instance AWSRequest DescribeAttackStatistics where
        type Rs DescribeAttackStatistics =
             DescribeAttackStatisticsResponse
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribeAttackStatisticsResponse' <$>
                   (pure (fromEnum s)) <*> (x .:> "TimeRange") <*>
                     (x .?> "DataItems" .!@ mempty))

instance Hashable DescribeAttackStatistics where

instance NFData DescribeAttackStatistics where
...
data DescribeAttackStatisticsResponse = DescribeAttackStatisticsResponse'{_dasrsResponseStatus
                                                                          ::
                                                                          !Int,
                                                                          _dasrsTimeRange
                                                                          ::
...
describeAttackStatisticsResponse
    ...
    -> TimeRange -- ^ 'dasrsTimeRange'
    -> DescribeAttackStatisticsResponse
describeAttackStatisticsResponse pResponseStatus_
  pTimeRange_
  = DescribeAttackStatisticsResponse'{_dasrsResponseStatus
                                        = pResponseStatus_,
