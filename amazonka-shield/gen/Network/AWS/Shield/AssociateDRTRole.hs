...
newtype AssociateDRTRole = AssociateDRTRole'{_adrtrRoleARN
                                             :: Text}
...
instance Hashable AssociateDRTRole where

instance NFData AssociateDRTRole where
...
newtype AssociateDRTRoleResponse = AssociateDRTRoleResponse'{_adrtrrsResponseStatus
                                                             :: Int}
...
associateDRTRoleResponse
    :: Int -- ^ 'adrtrrsResponseStatus'
    -> AssociateDRTRoleResponse
associateDRTRoleResponse pResponseStatus_
  = AssociateDRTRoleResponse'{_adrtrrsResponseStatus =
                                pResponseStatus_}
...
instance NFData AssociateDRTRoleResponse where
