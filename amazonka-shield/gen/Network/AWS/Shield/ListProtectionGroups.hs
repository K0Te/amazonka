...
data ListProtectionGroups = ListProtectionGroups'{_lpgNextToken
                                                  :: !(Maybe Text),
                                                  _lpgMaxResults ::
                                                  !(Maybe Nat)}
...
listProtectionGroups
    :: ListProtectionGroups
listProtectionGroups
  = ListProtectionGroups'{_lpgNextToken = Nothing,
...
instance Hashable ListProtectionGroups where

instance NFData ListProtectionGroups where
...
data ListProtectionGroupsResponse = ListProtectionGroupsResponse'{_lpgrsNextToken
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _lpgrsResponseStatus
                                                                  :: !Int,
...
-- * 'lpgrsProtectionGroups' - 
listProtectionGroupsResponse
    :: Int -- ^ 'lpgrsResponseStatus'
    -> ListProtectionGroupsResponse
listProtectionGroupsResponse pResponseStatus_
  = ListProtectionGroupsResponse'{_lpgrsNextToken =
                                    Nothing,
...
instance NFData ListProtectionGroupsResponse where
