...
data DescribeEmergencyContactSettingsResponse = DescribeEmergencyContactSettingsResponse'{_decsrsEmergencyContactList
                                                                                          ::
                                                                                          !(Maybe
                                                                                              [EmergencyContact]),
...
describeEmergencyContactSettingsResponse
  pResponseStatus_
  = DescribeEmergencyContactSettingsResponse'{_decsrsEmergencyContactList
                                                = Nothing,
                                              _decsrsResponseStatus =
                                                pResponseStatus_}
