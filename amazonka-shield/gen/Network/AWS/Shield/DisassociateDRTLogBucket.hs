...
newtype DisassociateDRTLogBucket = DisassociateDRTLogBucket'{_ddrtlbLogBucket
                                                             :: Text}
...
disassociateDRTLogBucket pLogBucket_
  = DisassociateDRTLogBucket'{_ddrtlbLogBucket =
                                pLogBucket_}
...
newtype DisassociateDRTLogBucketResponse = DisassociateDRTLogBucketResponse'{_ddrtlbrsResponseStatus
                                                                             ::
                                                                             Int}
...
disassociateDRTLogBucketResponse pResponseStatus_
  = DisassociateDRTLogBucketResponse'{_ddrtlbrsResponseStatus
                                        = pResponseStatus_}
