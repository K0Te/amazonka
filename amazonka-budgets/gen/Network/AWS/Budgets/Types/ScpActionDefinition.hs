...
data ScpActionDefinition = ScpActionDefinition'{_sadPolicyId
                                                :: !Text,
...
scpActionDefinition
    :: Text -- ^ 'sadPolicyId'
    -> NonEmpty Text -- ^ 'sadTargetIds'
    -> ScpActionDefinition
scpActionDefinition pPolicyId_ pTargetIds_
  = ScpActionDefinition'{_sadPolicyId = pPolicyId_,
...
instance FromJSON ScpActionDefinition where
        parseJSON
          = withObject "ScpActionDefinition"
              (\ x ->
                 ScpActionDefinition' <$>
                   (x .: "PolicyId") <*> (x .: "TargetIds"))

instance Hashable ScpActionDefinition where

instance NFData ScpActionDefinition where
