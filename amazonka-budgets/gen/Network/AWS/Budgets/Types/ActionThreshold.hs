...
data ActionThreshold = ActionThreshold'{_atActionThresholdValue
                                        :: !Double,
...
actionThreshold
    :: Double -- ^ 'atActionThresholdValue'
    -> ThresholdType -- ^ 'atActionThresholdType'
    -> ActionThreshold
actionThreshold pActionThresholdValue_
  pActionThresholdType_
  = ActionThreshold'{_atActionThresholdValue =
...
instance FromJSON ActionThreshold where
        parseJSON
          = withObject "ActionThreshold"
              (\ x ->
                 ActionThreshold' <$>
                   (x .: "ActionThresholdValue") <*>
                     (x .: "ActionThresholdType"))

instance Hashable ActionThreshold where

instance NFData ActionThreshold where
