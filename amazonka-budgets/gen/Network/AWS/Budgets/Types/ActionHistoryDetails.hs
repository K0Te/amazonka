...
data ActionHistoryDetails = ActionHistoryDetails'{_ahdMessage
                                                  :: !Text,
                                                  _ahdAction :: !Action}
...
actionHistoryDetails pMessage_ pAction_
  = ActionHistoryDetails'{_ahdMessage = pMessage_,
                          _ahdAction = pAction_}
...
instance FromJSON ActionHistoryDetails where
        parseJSON
          = withObject "ActionHistoryDetails"
              (\ x ->
                 ActionHistoryDetails' <$>
                   (x .: "Message") <*> (x .: "Action"))

instance Hashable ActionHistoryDetails where

instance NFData ActionHistoryDetails where
