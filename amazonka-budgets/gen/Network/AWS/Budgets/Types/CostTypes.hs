...
data CostTypes = CostTypes'{_ctUseAmortized ::
                            !(Maybe Bool),
...
costTypes
    :: CostTypes
costTypes
  = CostTypes'{_ctUseAmortized = Nothing,
               _ctIncludeRecurring = Nothing,
               _ctUseBlended = Nothing, _ctIncludeSupport = Nothing,
               ...
               _ctIncludeTax = Nothing, _ctIncludeCredit = Nothing}
