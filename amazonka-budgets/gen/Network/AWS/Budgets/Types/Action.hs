...
data Action = Action'{_aActionId :: !Text,
                      _aBudgetName :: !Text,
...
action
    ...
    -> ActionThreshold -- ^ 'aActionThreshold'
    -> Definition -- ^ 'aDefinition'
    -> Text -- ^ 'aExecutionRoleARN'
    -> ApprovalModel -- ^ 'aApprovalModel'
    -> ActionStatus -- ^ 'aStatus'
    -> NonEmpty Subscriber -- ^ 'aSubscribers'
    -> Action
action pActionId_ pBudgetName_ pNotificationType_
  pActionType_ pActionThreshold_ pDefinition_
  pExecutionRoleARN_ pApprovalModel_ pStatus_
  pSubscribers_
  = Action'{_aActionId = pActionId_,
