...
data DescribeBudgetActionsForBudget = DescribeBudgetActionsForBudget'{_dbafbNextToken
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _dbafbMaxResults
...
describeBudgetActionsForBudget
    :: Text -- ^ 'dbafbAccountId'
    -> Text -- ^ 'dbafbBudgetName'
    -> DescribeBudgetActionsForBudget
describeBudgetActionsForBudget pAccountId_
  pBudgetName_
  = DescribeBudgetActionsForBudget'{_dbafbNextToken =
                                      Nothing,
...
instance AWSPager DescribeBudgetActionsForBudget
         where
        page rq rs
          | stop (rs ^. dbafbrsNextToken) = Nothing
          | stop (rs ^. dbafbrsActions) = Nothing
          | otherwise =
            Just $ rq & dbafbNextToken .~ rs ^. dbafbrsNextToken

instance AWSRequest DescribeBudgetActionsForBudget
         where
...
instance NFData DescribeBudgetActionsForBudget where

instance ToHeaders DescribeBudgetActionsForBudget
         where
        toHeaders
          = const
              (mconcat
...
data DescribeBudgetActionsForBudgetResponse = DescribeBudgetActionsForBudgetResponse'{_dbafbrsNextToken
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
...
describeBudgetActionsForBudgetResponse
    :: Int -- ^ 'dbafbrsResponseStatus'
    -> DescribeBudgetActionsForBudgetResponse
describeBudgetActionsForBudgetResponse
  pResponseStatus_
  = DescribeBudgetActionsForBudgetResponse'{_dbafbrsNextToken
                                              = Nothing,
                                            _dbafbrsResponseStatus =
                                              pResponseStatus_,
