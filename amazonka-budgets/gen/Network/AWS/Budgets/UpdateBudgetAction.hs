...
data UpdateBudgetAction = UpdateBudgetAction'{_ubaDefinition
                                              :: !(Maybe Definition),
...
updateBudgetAction
    ...
    -> Text -- ^ 'ubaActionId'
    -> UpdateBudgetAction
updateBudgetAction pAccountId_ pBudgetName_
  pActionId_
  = UpdateBudgetAction'{_ubaDefinition = Nothing,
...
instance Hashable UpdateBudgetAction where

instance NFData UpdateBudgetAction where
...
data UpdateBudgetActionResponse = UpdateBudgetActionResponse'{_ubarsResponseStatus
                                                              :: !Int,
                                                              _ubarsAccountId ::
                                                              !Text,
                                                              _ubarsBudgetName
...
updateBudgetActionResponse
    :: Int -- ^ 'ubarsResponseStatus'
    -> Text -- ^ 'ubarsAccountId'
    -> Text -- ^ 'ubarsBudgetName'
    -> Action -- ^ 'ubarsOldAction'
    -> Action -- ^ 'ubarsNewAction'
    -> UpdateBudgetActionResponse
updateBudgetActionResponse pResponseStatus_
  pAccountId_ pBudgetName_ pOldAction_ pNewAction_
  = UpdateBudgetActionResponse'{_ubarsResponseStatus =
                                  pResponseStatus_,
...
instance NFData UpdateBudgetActionResponse where
