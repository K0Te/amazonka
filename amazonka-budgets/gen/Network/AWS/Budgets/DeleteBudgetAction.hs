...
data DeleteBudgetAction = DeleteBudgetAction'{_dbaAccountId
                                              :: !Text,
                                              _dbaBudgetName :: !Text,
                                              _dbaActionId :: !Text}
...
deleteBudgetAction
    ...
    -> Text -- ^ 'dbaActionId'
    -> DeleteBudgetAction
deleteBudgetAction pAccountId_ pBudgetName_
  pActionId_
  = DeleteBudgetAction'{_dbaAccountId = pAccountId_,
...
instance Hashable DeleteBudgetAction where

instance NFData DeleteBudgetAction where
...
data DeleteBudgetActionResponse = DeleteBudgetActionResponse'{_drsResponseStatus
                                                              :: !Int,
                                                              _drsAccountId ::
                                                              !Text,
                                                              _drsBudgetName ::
...
deleteBudgetActionResponse
    ...
    -> Action -- ^ 'drsAction'
    -> DeleteBudgetActionResponse
deleteBudgetActionResponse pResponseStatus_
  pAccountId_ pBudgetName_ pAction_
  = DeleteBudgetActionResponse'{_drsResponseStatus =
                                  pResponseStatus_,
...
instance NFData DeleteBudgetActionResponse where
