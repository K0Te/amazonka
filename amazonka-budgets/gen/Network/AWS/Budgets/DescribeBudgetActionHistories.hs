...
data DescribeBudgetActionHistories = DescribeBudgetActionHistories'{_dbahTimePeriod
                                                                    ::
                                                                    !(Maybe
                                                                        TimePeriod),
                                                                    _dbahNextToken
...
describeBudgetActionHistories
    ...
    -> Text -- ^ 'dbahActionId'
    -> DescribeBudgetActionHistories
describeBudgetActionHistories pAccountId_
  pBudgetName_ pActionId_
  = DescribeBudgetActionHistories'{_dbahTimePeriod =
                                     Nothing,
...
instance AWSPager DescribeBudgetActionHistories where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dbahNextToken .~ rs ^. dbahrsNextToken

instance AWSRequest DescribeBudgetActionHistories
         where
...
instance Hashable DescribeBudgetActionHistories where

instance NFData DescribeBudgetActionHistories where

instance ToHeaders DescribeBudgetActionHistories
         where
        toHeaders
          = const
              (mconcat
...
data DescribeBudgetActionHistoriesResponse = DescribeBudgetActionHistoriesResponse'{_dbahrsNextToken
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Text),
...
describeBudgetActionHistoriesResponse
    :: Int -- ^ 'dbahrsResponseStatus'
    -> DescribeBudgetActionHistoriesResponse
describeBudgetActionHistoriesResponse
  pResponseStatus_
  = DescribeBudgetActionHistoriesResponse'{_dbahrsNextToken
                                             = Nothing,
                                           _dbahrsResponseStatus =
                                             pResponseStatus_,
