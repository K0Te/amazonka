...
data ExecuteBudgetAction = ExecuteBudgetAction'{_ebaAccountId
                                                :: !Text,
                                                _ebaBudgetName :: !Text,
                                                _ebaActionId :: !Text,
                                                _ebaExecutionType ::
...
executeBudgetAction
    ...
    -> Text -- ^ 'ebaBudgetName'
    -> Text -- ^ 'ebaActionId'
    -> ExecutionType -- ^ 'ebaExecutionType'
    -> ExecuteBudgetAction
executeBudgetAction pAccountId_ pBudgetName_
  pActionId_ pExecutionType_
  = ExecuteBudgetAction'{_ebaAccountId = pAccountId_,
...
instance Hashable ExecuteBudgetAction where

instance NFData ExecuteBudgetAction where
...
data ExecuteBudgetActionResponse = ExecuteBudgetActionResponse'{_ebarsResponseStatus
                                                                :: !Int,
                                                                _ebarsAccountId
                                                                :: !Text,
                                                                _ebarsBudgetName
...
executeBudgetActionResponse
    :: Int -- ^ 'ebarsResponseStatus'
    -> Text -- ^ 'ebarsAccountId'
    -> Text -- ^ 'ebarsBudgetName'
    -> Text -- ^ 'ebarsActionId'
    -> ExecutionType -- ^ 'ebarsExecutionType'
    -> ExecuteBudgetActionResponse
executeBudgetActionResponse pResponseStatus_
  pAccountId_ pBudgetName_ pActionId_ pExecutionType_
  = ExecuteBudgetActionResponse'{_ebarsResponseStatus =
                                   pResponseStatus_,
...
instance NFData ExecuteBudgetActionResponse where
