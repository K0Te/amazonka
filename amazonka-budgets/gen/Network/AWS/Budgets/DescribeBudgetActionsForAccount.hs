...
data DescribeBudgetActionsForAccount = DescribeBudgetActionsForAccount'{_dbafaNextToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _dbafaMaxResults
...
describeBudgetActionsForAccount pAccountId_
  = DescribeBudgetActionsForAccount'{_dbafaNextToken =
                                       Nothing,
...
instance AWSPager DescribeBudgetActionsForAccount
         where
        page rq rs
          | stop (rs ^. dbafarsNextToken) = Nothing
          | stop (rs ^. dbafarsActions) = Nothing
          | otherwise =
            Just $ rq & dbafaNextToken .~ rs ^. dbafarsNextToken

instance AWSRequest DescribeBudgetActionsForAccount
         where
        type Rs DescribeBudgetActionsForAccount =
             DescribeBudgetActionsForAccountResponse
...
instance NFData DescribeBudgetActionsForAccount where

instance ToHeaders DescribeBudgetActionsForAccount
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery DescribeBudgetActionsForAccount
         where
        toQuery = const mempty

-- | /See:/ 'describeBudgetActionsForAccountResponse' smart constructor.
data DescribeBudgetActionsForAccountResponse = DescribeBudgetActionsForAccountResponse'{_dbafarsNextToken
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
...
describeBudgetActionsForAccountResponse
    :: Int -- ^ 'dbafarsResponseStatus'
    -> DescribeBudgetActionsForAccountResponse
describeBudgetActionsForAccountResponse
  pResponseStatus_
  = DescribeBudgetActionsForAccountResponse'{_dbafarsNextToken
                                               = Nothing,
                                             _dbafarsResponseStatus =
                                               pResponseStatus_,
