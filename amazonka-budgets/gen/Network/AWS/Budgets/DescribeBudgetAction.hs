...
data DescribeBudgetAction = DescribeBudgetAction'{_dbabAccountId
                                                  :: !Text,
...
describeBudgetAction
    ...
    -> Text -- ^ 'dbabActionId'
    -> DescribeBudgetAction
describeBudgetAction pAccountId_ pBudgetName_
  pActionId_
  = DescribeBudgetAction'{_dbabAccountId = pAccountId_,
...
instance Hashable DescribeBudgetAction where

instance NFData DescribeBudgetAction where
...
data DescribeBudgetActionResponse = DescribeBudgetActionResponse'{_dbarsResponseStatus
                                                                  :: !Int,
                                                                  _dbarsAccountId
                                                                  :: !Text,
                                                                  _dbarsBudgetName
...
describeBudgetActionResponse
    :: Int -- ^ 'dbarsResponseStatus'
    -> Text -- ^ 'dbarsAccountId'
    -> Text -- ^ 'dbarsBudgetName'
    -> Action -- ^ 'dbarsAction'
    -> DescribeBudgetActionResponse
describeBudgetActionResponse pResponseStatus_
  pAccountId_ pBudgetName_ pAction_
  = DescribeBudgetActionResponse'{_dbarsResponseStatus
                                    = pResponseStatus_,
...
instance NFData DescribeBudgetActionResponse where
