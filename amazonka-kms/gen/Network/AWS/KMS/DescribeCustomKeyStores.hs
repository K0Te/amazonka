...
data DescribeCustomKeyStores = DescribeCustomKeyStores'{_dckssCustomKeyStoreName
                                                        :: !(Maybe Text),
                                                        _dckssMarker ::
                                                        !(Maybe Text),
                                                        _dckssLimit ::
...
describeCustomKeyStores
    :: DescribeCustomKeyStores
describeCustomKeyStores
  = DescribeCustomKeyStores'{_dckssCustomKeyStoreName =
                               Nothing,
                             _dckssMarker = Nothing, _dckssLimit = Nothing,
...
instance AWSRequest DescribeCustomKeyStores where
        type Rs DescribeCustomKeyStores =
             DescribeCustomKeyStoresResponse
...
instance Hashable DescribeCustomKeyStores where

instance NFData DescribeCustomKeyStores where
...
data DescribeCustomKeyStoresResponse = DescribeCustomKeyStoresResponse'{_dckssrsTruncated
                                                                        ::
                                                                        !(Maybe
                                                                            Bool),
                                                                        _dckssrsNextMarker
...
describeCustomKeyStoresResponse
    :: Int -- ^ 'dckssrsResponseStatus'
    -> DescribeCustomKeyStoresResponse
describeCustomKeyStoresResponse pResponseStatus_
  = DescribeCustomKeyStoresResponse'{_dckssrsTruncated
                                       = Nothing,
...
instance NFData DescribeCustomKeyStoresResponse where
