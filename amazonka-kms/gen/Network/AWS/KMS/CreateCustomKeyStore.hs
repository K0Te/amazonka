...
data CreateCustomKeyStore = CreateCustomKeyStore'{_ccksCustomKeyStoreName
                                                  :: !Text,
...
createCustomKeyStore
    ...
    -> CreateCustomKeyStore
createCustomKeyStore pCustomKeyStoreName_
  pCloudHSMClusterId_ pTrustAnchorCertificate_
  pKeyStorePassword_
  = CreateCustomKeyStore'{_ccksCustomKeyStoreName =
...
data CreateCustomKeyStoreResponse = CreateCustomKeyStoreResponse'{_ccksrsCustomKeyStoreId
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _ccksrsResponseStatus
                                                                  :: !Int}
...
createCustomKeyStoreResponse pResponseStatus_
  = CreateCustomKeyStoreResponse'{_ccksrsCustomKeyStoreId
                                    = Nothing,
