...
newtype DisconnectCustomKeyStore = DisconnectCustomKeyStore'{_dCustomKeyStoreId
                                                             :: Text}
...
disconnectCustomKeyStore pCustomKeyStoreId_
  = DisconnectCustomKeyStore'{_dCustomKeyStoreId =
                                pCustomKeyStoreId_}
...
newtype DisconnectCustomKeyStoreResponse = DisconnectCustomKeyStoreResponse'{_dcksrsResponseStatus
                                                                             ::
                                                                             Int}
...
disconnectCustomKeyStoreResponse pResponseStatus_
  = DisconnectCustomKeyStoreResponse'{_dcksrsResponseStatus
                                        = pResponseStatus_}
