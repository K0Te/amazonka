...
data GenerateDataKeyPair = GenerateDataKeyPair'{_gdkpEncryptionContext
                                                :: !(Maybe (Map Text Text)),
                                                _gdkpGrantTokens ::
                                                !(Maybe [Text]),
                                                _gdkpKeyId :: !Text,
...
generateDataKeyPair
    :: Text -- ^ 'gdkpKeyId'
    -> DataKeyPairSpec -- ^ 'gdkpKeyPairSpec'
    -> GenerateDataKeyPair
generateDataKeyPair pKeyId_ pKeyPairSpec_
  = GenerateDataKeyPair'{_gdkpEncryptionContext =
                           Nothing,
                         _gdkpGrantTokens = Nothing, _gdkpKeyId = pKeyId_,
...
instance Hashable GenerateDataKeyPair where

instance NFData GenerateDataKeyPair where
...
data GenerateDataKeyPairResponse = GenerateDataKeyPairResponse'{_gdkprsKeyId
                                                                ::
                                                                !(Maybe Text),
                                                                _gdkprsPublicKey
                                                                ::
...
generateDataKeyPairResponse
    :: Int -- ^ 'gdkprsResponseStatus'
    -> GenerateDataKeyPairResponse
generateDataKeyPairResponse pResponseStatus_
  = GenerateDataKeyPairResponse'{_gdkprsKeyId =
                                   Nothing,
...
instance NFData GenerateDataKeyPairResponse where
