...
newtype ConnectCustomKeyStore = ConnectCustomKeyStore'{_ccksCustomKeyStoreId
                                                       :: Text}
...
connectCustomKeyStore pCustomKeyStoreId_
  = ConnectCustomKeyStore'{_ccksCustomKeyStoreId =
                             pCustomKeyStoreId_}
...
newtype ConnectCustomKeyStoreResponse = ConnectCustomKeyStoreResponse'{_crsResponseStatus
                                                                       :: Int}
...
connectCustomKeyStoreResponse pResponseStatus_
  = ConnectCustomKeyStoreResponse'{_crsResponseStatus =
                                     pResponseStatus_}
