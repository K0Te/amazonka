...
data GenerateDataKeyPairWithoutPlaintext = GenerateDataKeyPairWithoutPlaintext'{_gdkpwpEncryptionContext
                                                                                ::
                                                                                !(Maybe
                                                                                    (Map
                                                                                       Text
...
generateDataKeyPairWithoutPlaintext
    :: Text -- ^ 'gdkpwpKeyId'
    -> DataKeyPairSpec -- ^ 'gdkpwpKeyPairSpec'
    -> GenerateDataKeyPairWithoutPlaintext
generateDataKeyPairWithoutPlaintext pKeyId_
  pKeyPairSpec_
  = GenerateDataKeyPairWithoutPlaintext'{_gdkpwpEncryptionContext
                                           = Nothing,
...
instance AWSRequest
           GenerateDataKeyPairWithoutPlaintext
         where
        type Rs GenerateDataKeyPairWithoutPlaintext =
             GenerateDataKeyPairWithoutPlaintextResponse
...
instance ToJSON GenerateDataKeyPairWithoutPlaintext
         where
...
instance ToPath GenerateDataKeyPairWithoutPlaintext
         where
        toPath = const "/"

instance ToQuery GenerateDataKeyPairWithoutPlaintext
         where
        toQuery = const mempty

-- | /See:/ 'generateDataKeyPairWithoutPlaintextResponse' smart constructor.
data GenerateDataKeyPairWithoutPlaintextResponse = GenerateDataKeyPairWithoutPlaintextResponse'{_gdkpwprsKeyId
                                                                                                ::
                                                                                                !(Maybe
                                                                                                    Text),
                                                                                                _gdkpwprsPublicKey
...
generateDataKeyPairWithoutPlaintextResponse
    :: Int -- ^ 'gdkpwprsResponseStatus'
    -> GenerateDataKeyPairWithoutPlaintextResponse
generateDataKeyPairWithoutPlaintextResponse
  pResponseStatus_
  = GenerateDataKeyPairWithoutPlaintextResponse'{_gdkpwprsKeyId
                                                   = Nothing,
