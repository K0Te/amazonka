...
data UpdateCustomKeyStore = UpdateCustomKeyStore'{_ucksKeyStorePassword
...
updateCustomKeyStore pCustomKeyStoreId_
  = UpdateCustomKeyStore'{_ucksKeyStorePassword =
                            Nothing,
...
newtype UpdateCustomKeyStoreResponse = UpdateCustomKeyStoreResponse'{_ucksrsResponseStatus
                                                                     :: Int}
...
updateCustomKeyStoreResponse pResponseStatus_
  = UpdateCustomKeyStoreResponse'{_ucksrsResponseStatus
                                    = pResponseStatus_}
