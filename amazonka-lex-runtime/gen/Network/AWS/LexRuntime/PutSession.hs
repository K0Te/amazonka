...
data PutSession = PutSession'{_psAccept ::
                              !(Maybe Text),
                              _psActiveContexts ::
                              ...
                              _psBotName :: !Text, _psBotAlias :: !Text,
                              _psUserId :: !Text}
...
instance Hashable PutSession where

instance NFData PutSession where
...
instance ToPath PutSession where
        toPath PutSession'{..}
          = mconcat
              ["/bot/", toBS _psBotName, "/alias/",
               toBS _psBotAlias, "/user/", toBS _psUserId,
               "/session"]
...
data PutSessionResponse = PutSessionResponse'{_psrsSlots
                                              :: !(Maybe Text),
