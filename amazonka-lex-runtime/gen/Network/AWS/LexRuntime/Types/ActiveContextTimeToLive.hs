...
data ActiveContextTimeToLive = ActiveContextTimeToLive'{_acttlTurnsToLive
                                                        :: !(Maybe Nat),
...
activeContextTimeToLive
    :: ActiveContextTimeToLive
activeContextTimeToLive
  = ActiveContextTimeToLive'{_acttlTurnsToLive =
                               Nothing,
...
instance FromJSON ActiveContextTimeToLive where
        parseJSON
          = withObject "ActiveContextTimeToLive"
              (\ x ->
                 ActiveContextTimeToLive' <$>
                   (x .:? "turnsToLive") <*>
                     (x .:? "timeToLiveInSeconds"))

instance Hashable ActiveContextTimeToLive where

instance NFData ActiveContextTimeToLive where
