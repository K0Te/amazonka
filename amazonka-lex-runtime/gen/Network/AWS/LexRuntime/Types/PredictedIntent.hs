...
data PredictedIntent = PredictedIntent'{_piNluIntentConfidence
...
predictedIntent
    :: PredictedIntent
predictedIntent
  = PredictedIntent'{_piNluIntentConfidence = Nothing,
                     _piSlots = Nothing, _piIntentName = Nothing}
...
instance Hashable PredictedIntent where

instance NFData PredictedIntent where
