...
newtype SlotDefaultValueSpec = SlotDefaultValueSpec'{_sdvsDefaultValueList
                                                     :: [SlotDefaultValue]}
...
slotDefaultValueSpec
    :: SlotDefaultValueSpec
slotDefaultValueSpec
  = SlotDefaultValueSpec'{_sdvsDefaultValueList =
                            mempty}
...
instance FromJSON SlotDefaultValueSpec where
        parseJSON
          = withObject "SlotDefaultValueSpec"
              (\ x ->
                 SlotDefaultValueSpec' <$>
                   (x .:? "defaultValueList" .!= mempty))

instance Hashable SlotDefaultValueSpec where

instance NFData SlotDefaultValueSpec where
