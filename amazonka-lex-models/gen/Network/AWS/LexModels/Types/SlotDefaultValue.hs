...
newtype SlotDefaultValue = SlotDefaultValue'{_sdvDefaultValue
                                             :: Text}
...
slotDefaultValue
    :: Text -- ^ 'sdvDefaultValue'
    -> SlotDefaultValue
slotDefaultValue pDefaultValue_
  = SlotDefaultValue'{_sdvDefaultValue =
                        pDefaultValue_}
...
instance FromJSON SlotDefaultValue where
        parseJSON
          = withObject "SlotDefaultValue"
              (\ x -> SlotDefaultValue' <$> (x .: "defaultValue"))

instance Hashable SlotDefaultValue where

instance NFData SlotDefaultValue where
