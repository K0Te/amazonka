...
data GetIntent = GetIntent'{_giName :: !Text,
                            _giVersion :: !Text}
...
data GetIntentResponse = GetIntentResponse'{_getrsFulfillmentActivity
                                            :: !(Maybe FulfillmentActivity),
                                            _getrsSlots :: !(Maybe [Slot]),
                                            _getrsRejectionStatement ::
                                            !(Maybe Statement),
                                            _getrsChecksum :: !(Maybe Text),
                                            _getrsConclusionStatement ::
                                            !(Maybe Statement),
                                            _getrsSampleUtterances ::
                                            !(Maybe [Text]),
                                            _getrsParentIntentSignature ::
                                            !(Maybe Text),
                                            ...
                                            _getrsInputContexts ::
                                            !(Maybe [InputContext]),
                                            _getrsFollowUpPrompt ::
                                            !(Maybe FollowUpPrompt),
                                            _getrsLastUpdatedDate ::
                                            !(Maybe POSIX),
                                            _getrsOutputContexts ::
                                            !(Maybe [OutputContext]),
                                            _getrsConfirmationPrompt ::
                                            !(Maybe Prompt),
                                            _getrsDialogCodeHook ::
                                            !(Maybe CodeHook),
...
getIntentResponse pResponseStatus_
  = GetIntentResponse'{_getrsFulfillmentActivity =
                         Nothing,
                       _getrsSlots = Nothing,
                       ...
                       _getrsName = Nothing, _getrsVersion = Nothing,
