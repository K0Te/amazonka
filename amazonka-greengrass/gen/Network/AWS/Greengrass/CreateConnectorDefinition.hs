...
data CreateConnectorDefinition = CreateConnectorDefinition'{_cAmznClientToken
                                                            :: !(Maybe Text),
                                                            _cInitialVersion ::
                                                            !(Maybe
...
createConnectorDefinition
    :: CreateConnectorDefinition
createConnectorDefinition
  = CreateConnectorDefinition'{_cAmznClientToken =
                                 Nothing,
                               _cInitialVersion = Nothing, _cName = Nothing,
                               _cTags = Nothing}
...
data CreateConnectorDefinitionResponse = CreateConnectorDefinitionResponse'{_crersLatestVersionARN
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _crersARN
...
createConnectorDefinitionResponse pResponseStatus_
  = CreateConnectorDefinitionResponse'{_crersLatestVersionARN
                                         = Nothing,
                                       _crersARN = Nothing,
                                       _crersName = Nothing,
