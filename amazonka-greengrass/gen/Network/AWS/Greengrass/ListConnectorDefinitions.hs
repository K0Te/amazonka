...
data ListConnectorDefinitions = ListConnectorDefinitions'{_lNextToken
                                                          :: !(Maybe Text),
                                                          _lMaxResults ::
                                                          !(Maybe Text)}
...
listConnectorDefinitions
    :: ListConnectorDefinitions
listConnectorDefinitions
  = ListConnectorDefinitions'{_lNextToken = Nothing,
...
instance AWSRequest ListConnectorDefinitions where
        type Rs ListConnectorDefinitions =
             ListConnectorDefinitionsResponse
...
instance Hashable ListConnectorDefinitions where

instance NFData ListConnectorDefinitions where
...
data ListConnectorDefinitionsResponse = ListConnectorDefinitionsResponse'{_lrsNextToken
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _lrsDefinitions
...
listConnectorDefinitionsResponse pResponseStatus_
  = ListConnectorDefinitionsResponse'{_lrsNextToken =
                                        Nothing,
