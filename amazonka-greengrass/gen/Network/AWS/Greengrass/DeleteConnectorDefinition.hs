...
newtype DeleteConnectorDefinition = DeleteConnectorDefinition'{_dcdConnectorDefinitionId
                                                               :: Text}
...
deleteConnectorDefinition pConnectorDefinitionId_
  = DeleteConnectorDefinition'{_dcdConnectorDefinitionId
...
newtype DeleteConnectorDefinitionResponse = DeleteConnectorDefinitionResponse'{_dcdrsResponseStatus
                                                                               ::
                                                                               Int}
...
deleteConnectorDefinitionResponse pResponseStatus_
  = DeleteConnectorDefinitionResponse'{_dcdrsResponseStatus
                                         = pResponseStatus_}
