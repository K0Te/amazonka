...
newtype GetThingRuntimeConfiguration = GetThingRuntimeConfiguration'{_gtrcThingName
                                                                     :: Text}
...
getThingRuntimeConfiguration pThingName_
  = GetThingRuntimeConfiguration'{_gtrcThingName =
                                    pThingName_}
...
instance AWSRequest GetThingRuntimeConfiguration
         where
...
instance Hashable GetThingRuntimeConfiguration where

instance NFData GetThingRuntimeConfiguration where
...
instance ToPath GetThingRuntimeConfiguration where
        toPath GetThingRuntimeConfiguration'{..}
          = mconcat
              ["/greengrass/things/", toBS _gtrcThingName,
               "/runtimeconfig"]
...
data GetThingRuntimeConfigurationResponse = GetThingRuntimeConfigurationResponse'{_gtrcrsRuntimeConfiguration
                                                                                  ::
                                                                                  !(Maybe
...
getThingRuntimeConfigurationResponse
    :: Int -- ^ 'gtrcrsResponseStatus'
    -> GetThingRuntimeConfigurationResponse
getThingRuntimeConfigurationResponse pResponseStatus_
  = GetThingRuntimeConfigurationResponse'{_gtrcrsRuntimeConfiguration
                                            = Nothing,
                                          _gtrcrsResponseStatus =
                                            pResponseStatus_}
