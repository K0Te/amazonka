...
data ListBulkDeploymentDetailedReports = ListBulkDeploymentDetailedReports'{_lbddrNextToken
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _lbddrMaxResults
...
listBulkDeploymentDetailedReports pBulkDeploymentId_
  = ListBulkDeploymentDetailedReports'{_lbddrNextToken
                                         = Nothing,
...
data ListBulkDeploymentDetailedReportsResponse = ListBulkDeploymentDetailedReportsResponse'{_lbddrrsNextToken
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
                                                                                            _lbddrrsDeployments
...
listBulkDeploymentDetailedReportsResponse
  pResponseStatus_
  = ListBulkDeploymentDetailedReportsResponse'{_lbddrrsNextToken
                                                 = Nothing,
