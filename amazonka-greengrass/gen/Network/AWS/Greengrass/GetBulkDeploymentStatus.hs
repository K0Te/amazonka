...
newtype GetBulkDeploymentStatus = GetBulkDeploymentStatus'{_gbdsBulkDeploymentId
                                                           :: Text}
...
getBulkDeploymentStatus pBulkDeploymentId_
  = GetBulkDeploymentStatus'{_gbdsBulkDeploymentId =
                               pBulkDeploymentId_}
...
data GetBulkDeploymentStatusResponse = GetBulkDeploymentStatusResponse'{_gbdsrsCreatedAt
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _gbdsrsErrorDetails
...
getBulkDeploymentStatusResponse pResponseStatus_
  = GetBulkDeploymentStatusResponse'{_gbdsrsCreatedAt =
                                       Nothing,
