...
data UpdateConnectorDefinition = UpdateConnectorDefinition'{_uName
                                                            :: !(Maybe Text),
...
updateConnectorDefinition pConnectorDefinitionId_
  = UpdateConnectorDefinition'{_uName = Nothing,
                               _uConnectorDefinitionId =
...
newtype UpdateConnectorDefinitionResponse = UpdateConnectorDefinitionResponse'{_ucdrsResponseStatus
                                                                               ::
                                                                               Int}
...
updateConnectorDefinitionResponse pResponseStatus_
  = UpdateConnectorDefinitionResponse'{_ucdrsResponseStatus
                                         = pResponseStatus_}
