...
data GetConnectorDefinitionVersion = GetConnectorDefinitionVersion'{_gcdvNextToken
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
...
getConnectorDefinitionVersion
    :: Text -- ^ 'gcdvConnectorDefinitionId'
    -> Text -- ^ 'gcdvConnectorDefinitionVersionId'
    -> GetConnectorDefinitionVersion
getConnectorDefinitionVersion pConnectorDefinitionId_
  pConnectorDefinitionVersionId_
  = GetConnectorDefinitionVersion'{_gcdvNextToken =
                                     Nothing,
                                   _gcdvConnectorDefinitionId =
...
instance AWSRequest GetConnectorDefinitionVersion
         where
...
instance Hashable GetConnectorDefinitionVersion where

instance NFData GetConnectorDefinitionVersion where

instance ToHeaders GetConnectorDefinitionVersion
         where
        toHeaders
          = const
              (mconcat
        ...
        toPath GetConnectorDefinitionVersion'{..}
          = mconcat
              ["/greengrass/definition/connectors/",
               toBS _gcdvConnectorDefinitionId, "/versions/",
...
data GetConnectorDefinitionVersionResponse = GetConnectorDefinitionVersionResponse'{_gcdvrsDefinition
                                                                                    ::
                                                                                    !(Maybe
...
getConnectorDefinitionVersionResponse
  pResponseStatus_
  = GetConnectorDefinitionVersionResponse'{_gcdvrsDefinition
                                             = Nothing,
                                           _gcdvrsARN = Nothing,
