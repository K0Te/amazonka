...
data ListBulkDeployments = ListBulkDeployments'{_lbdNextToken
                                                :: !(Maybe Text),
...
listBulkDeployments
    :: ListBulkDeployments
listBulkDeployments
  = ListBulkDeployments'{_lbdNextToken = Nothing,
...
data ListBulkDeploymentsResponse = ListBulkDeploymentsResponse'{_lbdrsNextToken
                                                                ::
                                                                !(Maybe Text),
                                                                _lbdrsBulkDeployments
                                                                ::
                                                                !(Maybe
                                                                    [BulkDeployment]),
                                                                _lbdrsResponseStatus
                                                                :: !Int}
...
listBulkDeploymentsResponse pResponseStatus_
  = ListBulkDeploymentsResponse'{_lbdrsNextToken =
                                   Nothing,
