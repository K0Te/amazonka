...
data ListConnectorDefinitionVersions = ListConnectorDefinitionVersions'{_lcdvNextToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _lcdvMaxResults
...
listConnectorDefinitionVersions
  ...
  = ListConnectorDefinitionVersions'{_lcdvNextToken =
                                       Nothing,
...
data ListConnectorDefinitionVersionsResponse = ListConnectorDefinitionVersionsResponse'{_lcdvsrsVersions
                                                                                        ::
                                                                                        !(Maybe
                                                                                            [VersionInformation]),
                                                                                        _lcdvsrsNextToken
...
listConnectorDefinitionVersionsResponse
  pResponseStatus_
  = ListConnectorDefinitionVersionsResponse'{_lcdvsrsVersions
                                               = Nothing,
