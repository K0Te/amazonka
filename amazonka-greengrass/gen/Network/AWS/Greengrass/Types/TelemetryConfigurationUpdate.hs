...
newtype TelemetryConfigurationUpdate = TelemetryConfigurationUpdate'{_tcuTelemetry
                                                                     ::
                                                                     Telemetry}
...
telemetryConfigurationUpdate
    :: Telemetry -- ^ 'tcuTelemetry'
    -> TelemetryConfigurationUpdate
telemetryConfigurationUpdate pTelemetry_
  = TelemetryConfigurationUpdate'{_tcuTelemetry =
                                    pTelemetry_}
...
instance Hashable TelemetryConfigurationUpdate where

instance NFData TelemetryConfigurationUpdate where
