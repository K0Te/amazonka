...
data UpdateThingRuntimeConfiguration = UpdateThingRuntimeConfiguration'{_utrcTelemetryConfiguration
                                                                        ::
                                                                        !(Maybe
...
updateThingRuntimeConfiguration pThingName_
  = UpdateThingRuntimeConfiguration'{_utrcTelemetryConfiguration
                                       = Nothing,
...
instance AWSRequest UpdateThingRuntimeConfiguration
         where
...
instance NFData UpdateThingRuntimeConfiguration where

instance ToHeaders UpdateThingRuntimeConfiguration
         where
        toHeaders
          = const
              (mconcat
...
instance ToPath UpdateThingRuntimeConfiguration where
        toPath UpdateThingRuntimeConfiguration'{..}
          = mconcat
              ["/greengrass/things/", toBS _utrcThingName,
               "/runtimeconfig"]

instance ToQuery UpdateThingRuntimeConfiguration
         where
        toQuery = const mempty

-- | /See:/ 'updateThingRuntimeConfigurationResponse' smart constructor.
newtype UpdateThingRuntimeConfigurationResponse = UpdateThingRuntimeConfigurationResponse'{_utrcrsResponseStatus
                                                                                           ::
                                                                                           Int}
...
updateThingRuntimeConfigurationResponse
    :: Int -- ^ 'utrcrsResponseStatus'
    -> UpdateThingRuntimeConfigurationResponse
updateThingRuntimeConfigurationResponse
  pResponseStatus_
  = UpdateThingRuntimeConfigurationResponse'{_utrcrsResponseStatus
                                               = pResponseStatus_}
