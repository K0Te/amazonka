...
data CreateConnectorDefinitionVersion = CreateConnectorDefinitionVersion'{_ccdvAmznClientToken
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _ccdvConnectors
...
createConnectorDefinitionVersion
    :: Text -- ^ 'ccdvConnectorDefinitionId'
    -> CreateConnectorDefinitionVersion
createConnectorDefinitionVersion
  pConnectorDefinitionId_
  = CreateConnectorDefinitionVersion'{_ccdvAmznClientToken
                                        = Nothing,
...
instance AWSRequest CreateConnectorDefinitionVersion
         where
...
instance ToHeaders CreateConnectorDefinitionVersion
         where
...
instance ToJSON CreateConnectorDefinitionVersion
         where
        toJSON CreateConnectorDefinitionVersion'{..}
          = object
              (catMaybes [("Connectors" .=) <$> _ccdvConnectors])

instance ToPath CreateConnectorDefinitionVersion
         where
        toPath CreateConnectorDefinitionVersion'{..}
          = mconcat
              ["/greengrass/definition/connectors/",
               toBS _ccdvConnectorDefinitionId, "/versions"]

instance ToQuery CreateConnectorDefinitionVersion
         where
        toQuery = const mempty

-- | /See:/ 'createConnectorDefinitionVersionResponse' smart constructor.
data CreateConnectorDefinitionVersionResponse = CreateConnectorDefinitionVersionResponse'{_ccdvrsARN
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
...
createConnectorDefinitionVersionResponse
  pResponseStatus_
  = CreateConnectorDefinitionVersionResponse'{_ccdvrsARN
                                                = Nothing,
                                              _ccdvrsCreationTimestamp =
                                                Nothing,
