...
newtype GetConnectorDefinition = GetConnectorDefinition'{_gcdConnectorDefinitionId
                                                         :: Text}
...
getConnectorDefinition pConnectorDefinitionId_
  = GetConnectorDefinition'{_gcdConnectorDefinitionId =
...
data GetConnectorDefinitionResponse = GetConnectorDefinitionResponse'{_grsLatestVersionARN
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _grsARN ::
...
getConnectorDefinitionResponse pResponseStatus_
  = GetConnectorDefinitionResponse'{_grsLatestVersionARN
                                      = Nothing,
                                    _grsARN = Nothing, _grsName = Nothing,
