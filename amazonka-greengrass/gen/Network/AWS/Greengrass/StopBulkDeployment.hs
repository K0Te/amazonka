...
newtype StopBulkDeployment = StopBulkDeployment'{_sbdBulkDeploymentId
                                                 :: Text}
...
stopBulkDeployment
    :: Text -- ^ 'sbdBulkDeploymentId'
    -> StopBulkDeployment
stopBulkDeployment pBulkDeploymentId_
  = StopBulkDeployment'{_sbdBulkDeploymentId =
                          pBulkDeploymentId_}
...
instance Hashable StopBulkDeployment where

instance NFData StopBulkDeployment where
        ...
        toPath StopBulkDeployment'{..}
          = mconcat
              ["/greengrass/bulk/deployments/",
               toBS _sbdBulkDeploymentId, "/$stop"]

instance ToQuery StopBulkDeployment where
        toQuery = const mempty

-- | /See:/ 'stopBulkDeploymentResponse' smart constructor.
newtype StopBulkDeploymentResponse = StopBulkDeploymentResponse'{_sbdrsResponseStatus
                                                                 :: Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
stopBulkDeploymentResponse
    :: Int -- ^ 'sbdrsResponseStatus'
    -> StopBulkDeploymentResponse
stopBulkDeploymentResponse pResponseStatus_
  = StopBulkDeploymentResponse'{_sbdrsResponseStatus =
                                  pResponseStatus_}
...
instance NFData StopBulkDeploymentResponse where
