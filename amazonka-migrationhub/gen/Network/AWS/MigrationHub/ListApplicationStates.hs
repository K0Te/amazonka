...
data ListApplicationStates = ListApplicationStates'{_lasNextToken
                                                    :: !(Maybe Text),
                                                    _lasApplicationIds ::
                                                    !(Maybe (List1 Text)),
                                                    _lasMaxResults ::
...
listApplicationStates
    :: ListApplicationStates
listApplicationStates
  = ListApplicationStates'{_lasNextToken = Nothing,
...
instance Hashable ListApplicationStates where

instance NFData ListApplicationStates where
...
data ListApplicationStatesResponse = ListApplicationStatesResponse'{_lasrsApplicationStateList
                                                                    ::
                                                                    !(Maybe
                                                                        [ApplicationState]),
                                                                    _lasrsNextToken
...
listApplicationStatesResponse pResponseStatus_
  = ListApplicationStatesResponse'{_lasrsApplicationStateList
                                     = Nothing,
...
instance NFData ListApplicationStatesResponse where
