...
newtype DeleteReplicationTaskAssessmentRun = DeleteReplicationTaskAssessmentRun'{_drtarReplicationTaskAssessmentRunARN
                                                                                 ::
                                                                                 Text}
...
deleteReplicationTaskAssessmentRun
    :: Text -- ^ 'drtarReplicationTaskAssessmentRunARN'
    -> DeleteReplicationTaskAssessmentRun
deleteReplicationTaskAssessmentRun
  pReplicationTaskAssessmentRunARN_
  = DeleteReplicationTaskAssessmentRun'{_drtarReplicationTaskAssessmentRunARN
                                          = pReplicationTaskAssessmentRunARN_}
...
instance ToHeaders DeleteReplicationTaskAssessmentRun
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DeleteReplicationTaskAssessmentRun
         where
...
instance ToPath DeleteReplicationTaskAssessmentRun
         where
        toPath = const "/"

instance ToQuery DeleteReplicationTaskAssessmentRun
         where
...
data DeleteReplicationTaskAssessmentRunResponse = DeleteReplicationTaskAssessmentRunResponse'{_drtarrsReplicationTaskAssessmentRun
                                                                                              ::
                                                                                              !(Maybe
...
deleteReplicationTaskAssessmentRunResponse
  pResponseStatus_
  = DeleteReplicationTaskAssessmentRunResponse'{_drtarrsReplicationTaskAssessmentRun
                                                  = Nothing,
                                                _drtarrsResponseStatus =
                                                  pResponseStatus_}
