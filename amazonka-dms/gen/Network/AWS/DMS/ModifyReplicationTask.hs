...
data ModifyReplicationTask = ModifyReplicationTask'{_mReplicationTaskSettings
                                                    :: !(Maybe Text),
                                                    _mReplicationTaskIdentifier
                                                    :: !(Maybe Text),
                                                    _mCdcStartPosition ::
                                                    !(Maybe Text),
                                                    _mTableMappings ::
...
modifyReplicationTask
    :: Text -- ^ 'mReplicationTaskARN'
    -> ModifyReplicationTask
modifyReplicationTask pReplicationTaskARN_
  = ModifyReplicationTask'{_mReplicationTaskSettings =
                             Nothing,
                           _mReplicationTaskIdentifier = Nothing,
                           _mCdcStartPosition = Nothing,
                           _mTableMappings = Nothing, _mMigrationType = Nothing,
                           _mTaskData = Nothing, _mCdcStopPosition = Nothing,
...
data ModifyReplicationTaskResponse = ModifyReplicationTaskResponse'{_mrsReplicationTask
                                                                    ::
                                                                    !(Maybe
                                                                        ReplicationTask),
                                                                    _mrsResponseStatus
...
modifyReplicationTaskResponse
    :: Int -- ^ 'mrsResponseStatus'
    -> ModifyReplicationTaskResponse
modifyReplicationTaskResponse pResponseStatus_
  = ModifyReplicationTaskResponse'{_mrsReplicationTask
                                     = Nothing,
