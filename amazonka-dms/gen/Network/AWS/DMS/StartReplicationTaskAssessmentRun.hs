...
data StartReplicationTaskAssessmentRun = StartReplicationTaskAssessmentRun'{_srtarIncludeOnly
                                                                            ::
                                                                            !(Maybe
                                                                                [Text]),
...
startReplicationTaskAssessmentRun
    :: Text -- ^ 'srtarReplicationTaskARN'
    -> Text -- ^ 'srtarServiceAccessRoleARN'
    -> Text -- ^ 'srtarResultLocationBucket'
    -> Text -- ^ 'srtarAssessmentRunName'
    -> StartReplicationTaskAssessmentRun
startReplicationTaskAssessmentRun
  pReplicationTaskARN_ pServiceAccessRoleARN_
  pResultLocationBucket_ pAssessmentRunName_
  = StartReplicationTaskAssessmentRun'{_srtarIncludeOnly
                                         = Nothing,
...
instance AWSRequest StartReplicationTaskAssessmentRun
         where
...
instance ToHeaders StartReplicationTaskAssessmentRun
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON StartReplicationTaskAssessmentRun
         where
...
instance ToPath StartReplicationTaskAssessmentRun
         where
        toPath = const "/"

instance ToQuery StartReplicationTaskAssessmentRun
         where
...
data StartReplicationTaskAssessmentRunResponse = StartReplicationTaskAssessmentRunResponse'{_srtarrsReplicationTaskAssessmentRun
                                                                                            ::
                                                                                            !(Maybe
...
startReplicationTaskAssessmentRunResponse
    :: Int -- ^ 'srtarrsResponseStatus'
    -> StartReplicationTaskAssessmentRunResponse
startReplicationTaskAssessmentRunResponse
  pResponseStatus_
  = StartReplicationTaskAssessmentRunResponse'{_srtarrsReplicationTaskAssessmentRun
                                                 = Nothing,
                                               _srtarrsResponseStatus =
                                                 pResponseStatus_}
