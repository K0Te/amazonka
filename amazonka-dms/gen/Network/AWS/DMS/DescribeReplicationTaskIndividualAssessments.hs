...
data DescribeReplicationTaskIndividualAssessments = DescribeReplicationTaskIndividualAssessments'{_drtiaFilters
                                                                                                  ::
                                                                                                  !(Maybe
                                                                                                      [Filter]),
                                                                                                  _drtiaMarker
...
describeReplicationTaskIndividualAssessments
    :: DescribeReplicationTaskIndividualAssessments
describeReplicationTaskIndividualAssessments
  = DescribeReplicationTaskIndividualAssessments'{_drtiaFilters
                                                    = Nothing,
...
data DescribeReplicationTaskIndividualAssessmentsResponse = DescribeReplicationTaskIndividualAssessmentsResponse'{_drtiarsReplicationTaskIndividualAssessments
                                                                                                                  ::
                                                                                                                  !(Maybe
...
describeReplicationTaskIndividualAssessmentsResponse
    :: Int -- ^ 'drtiarsResponseStatus'
    -> DescribeReplicationTaskIndividualAssessmentsResponse
describeReplicationTaskIndividualAssessmentsResponse
  pResponseStatus_
  = DescribeReplicationTaskIndividualAssessmentsResponse'{_drtiarsReplicationTaskIndividualAssessments
                                                            = Nothing,
                                                          _drtiarsMarker =
                                                            Nothing,
                                                          _drtiarsResponseStatus
