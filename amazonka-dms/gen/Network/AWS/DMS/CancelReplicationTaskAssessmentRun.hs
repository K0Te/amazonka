...
newtype CancelReplicationTaskAssessmentRun = CancelReplicationTaskAssessmentRun'{_crtarReplicationTaskAssessmentRunARN
                                                                                 ::
                                                                                 Text}
...
cancelReplicationTaskAssessmentRun
    :: Text -- ^ 'crtarReplicationTaskAssessmentRunARN'
    -> CancelReplicationTaskAssessmentRun
cancelReplicationTaskAssessmentRun
  pReplicationTaskAssessmentRunARN_
  = CancelReplicationTaskAssessmentRun'{_crtarReplicationTaskAssessmentRunARN
                                          = pReplicationTaskAssessmentRunARN_}
...
instance ToHeaders CancelReplicationTaskAssessmentRun
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON CancelReplicationTaskAssessmentRun
         where
...
instance ToPath CancelReplicationTaskAssessmentRun
         where
        toPath = const "/"

instance ToQuery CancelReplicationTaskAssessmentRun
         where
...
data CancelReplicationTaskAssessmentRunResponse = CancelReplicationTaskAssessmentRunResponse'{_crtarrsReplicationTaskAssessmentRun
                                                                                              ::
                                                                                              !(Maybe
...
cancelReplicationTaskAssessmentRunResponse
    :: Int -- ^ 'crtarrsResponseStatus'
    -> CancelReplicationTaskAssessmentRunResponse
cancelReplicationTaskAssessmentRunResponse
  pResponseStatus_
  = CancelReplicationTaskAssessmentRunResponse'{_crtarrsReplicationTaskAssessmentRun
                                                  = Nothing,
                                                _crtarrsResponseStatus =
                                                  pResponseStatus_}
