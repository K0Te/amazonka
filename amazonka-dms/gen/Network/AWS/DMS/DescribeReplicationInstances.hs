...
data DescribeReplicationInstances = DescribeReplicationInstances'{_driFilters
                                                                  ::
                                                                  !(Maybe
                                                                      [Filter]),
                                                                  _driMarker ::
...
describeReplicationInstances
    :: DescribeReplicationInstances
describeReplicationInstances
  = DescribeReplicationInstances'{_driFilters =
                                    Nothing,
                                  _driMarker = Nothing,
...
data DescribeReplicationInstancesResponse = DescribeReplicationInstancesResponse'{_drisrsMarker
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
describeReplicationInstancesResponse pResponseStatus_
  = DescribeReplicationInstancesResponse'{_drisrsMarker
                                            = Nothing,
