...
data DescribeApplicableIndividualAssessments = DescribeApplicableIndividualAssessments'{_daiaMigrationType
                                                                                        ::
                                                                                        !(Maybe
                                                                                            MigrationTypeValue),
...
describeApplicableIndividualAssessments
    :: DescribeApplicableIndividualAssessments
describeApplicableIndividualAssessments
  = DescribeApplicableIndividualAssessments'{_daiaMigrationType
                                               = Nothing,
...
data DescribeApplicableIndividualAssessmentsResponse = DescribeApplicableIndividualAssessmentsResponse'{_daiarsMarker
                                                                                                        ::
                                                                                                        !(Maybe
                                                                                                            Text),
...
describeApplicableIndividualAssessmentsResponse
    :: Int -- ^ 'daiarsResponseStatus'
    -> DescribeApplicableIndividualAssessmentsResponse
describeApplicableIndividualAssessmentsResponse
  pResponseStatus_
  = DescribeApplicableIndividualAssessmentsResponse'{_daiarsMarker
                                                       = Nothing,
                                                     _daiarsIndividualAssessmentNames
                                                       = Nothing,
                                                     _daiarsResponseStatus =
