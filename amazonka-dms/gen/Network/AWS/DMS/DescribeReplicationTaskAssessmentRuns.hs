...
data DescribeReplicationTaskAssessmentRuns = DescribeReplicationTaskAssessmentRuns'{_drtarFilters
                                                                                    ::
                                                                                    !(Maybe
                                                                                        [Filter]),
                                                                                    _drtarMarker
...
describeReplicationTaskAssessmentRuns
    :: DescribeReplicationTaskAssessmentRuns
describeReplicationTaskAssessmentRuns
  = DescribeReplicationTaskAssessmentRuns'{_drtarFilters
                                             = Nothing,
...
instance ToJSON DescribeReplicationTaskAssessmentRuns
         where
...
instance ToPath DescribeReplicationTaskAssessmentRuns
         where
        toPath = const "/"
...
data DescribeReplicationTaskAssessmentRunsResponse = DescribeReplicationTaskAssessmentRunsResponse'{_drtarsrsReplicationTaskAssessmentRuns
                                                                                                    ::
                                                                                                    !(Maybe
...
describeReplicationTaskAssessmentRunsResponse
    :: Int -- ^ 'drtarsrsResponseStatus'
    -> DescribeReplicationTaskAssessmentRunsResponse
describeReplicationTaskAssessmentRunsResponse
  pResponseStatus_
  = DescribeReplicationTaskAssessmentRunsResponse'{_drtarsrsReplicationTaskAssessmentRuns
                                                     = Nothing,
