...
data MoveReplicationTask = MoveReplicationTask'{_mrtReplicationTaskARN
                                                :: !Text,
...
moveReplicationTask
    ...
    -> Text -- ^ 'mrtTargetReplicationInstanceARN'
    -> MoveReplicationTask
moveReplicationTask pReplicationTaskARN_
  pTargetReplicationInstanceARN_
  = MoveReplicationTask'{_mrtReplicationTaskARN =
...
instance Hashable MoveReplicationTask where

instance NFData MoveReplicationTask where
...
data MoveReplicationTaskResponse = MoveReplicationTaskResponse'{_mrtrsReplicationTask
                                                                ::
                                                                !(Maybe
                                                                    ReplicationTask),
...
moveReplicationTaskResponse pResponseStatus_
  = MoveReplicationTaskResponse'{_mrtrsReplicationTask
                                   = Nothing,
...
instance NFData MoveReplicationTaskResponse where
