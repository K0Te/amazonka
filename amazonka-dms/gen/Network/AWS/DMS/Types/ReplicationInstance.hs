...
data ReplicationInstance = ReplicationInstance'{_riEngineVersion
                                                :: !(Maybe Text),
...
replicationInstance
    :: ReplicationInstance
replicationInstance
  = ReplicationInstance'{_riEngineVersion = Nothing,
                         ...
                         _riKMSKeyId = Nothing, _riAvailabilityZone = Nothing,
                         _riVPCSecurityGroups = Nothing, _riMultiAZ = Nothing,
