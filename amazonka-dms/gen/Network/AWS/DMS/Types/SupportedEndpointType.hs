...
data SupportedEndpointType = SupportedEndpointType'{_setEngineDisplayName
                                                    :: !(Maybe Text),
                                                    _setEndpointType ::
                                                    !(Maybe
...
supportedEndpointType
    :: SupportedEndpointType
supportedEndpointType
  = SupportedEndpointType'{_setEngineDisplayName =
                             Nothing,
                           _setEndpointType = Nothing, _setEngineName = Nothing,
                           _setReplicationInstanceEngineMinimumVersion =
                             Nothing,
