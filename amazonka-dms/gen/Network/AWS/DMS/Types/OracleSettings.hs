...
data OracleSettings = OracleSettings'{_osFailTasksOnLobTruncation
                                      :: !(Maybe Bool),
...
oracleSettings
    :: OracleSettings
oracleSettings
  = OracleSettings'{_osFailTasksOnLobTruncation =
                      Nothing,
                    _osServerName = Nothing,
                    _osDirectPathNoLog = Nothing,
                    _osSecurityDBEncryptionName = Nothing,
                    _osOraclePathPrefix = Nothing, _osUsername = Nothing,
                    ...
                    _osRetryInterval = Nothing, _osPassword = Nothing,
                    ...
                    _osUsePathPrefix = Nothing, _osAsmUser = Nothing,
...
instance Hashable OracleSettings where

instance NFData OracleSettings where
