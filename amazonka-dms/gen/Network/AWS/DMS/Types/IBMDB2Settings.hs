...
data IBMDB2Settings = IBMDB2Settings'{_ibmdsServerName
                                      :: !(Maybe Text),
...
iBMDB2Settings
    :: IBMDB2Settings
iBMDB2Settings
  = IBMDB2Settings'{_ibmdsServerName = Nothing,
                    _ibmdsCurrentLsn = Nothing,
                    _ibmdsSetDataCaptureChanges = Nothing,
                    _ibmdsUsername = Nothing, _ibmdsPassword = Nothing,
...
instance FromJSON IBMDB2Settings where
        parseJSON
          = withObject "IBMDB2Settings"
              (\ x ->
                 IBMDB2Settings' <$>
                   (x .:? "ServerName") <*> (x .:? "CurrentLsn") <*>
...
instance Hashable IBMDB2Settings where

instance NFData IBMDB2Settings where
