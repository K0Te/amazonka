...
data DocDBSettings = DocDBSettings'{_ddsServerName ::
                                    !(Maybe Text),
...
docDBSettings
    :: DocDBSettings
docDBSettings
  = DocDBSettings'{_ddsServerName = Nothing,
                   _ddsUsername = Nothing, _ddsKMSKeyId = Nothing,
                   _ddsPassword = Nothing, _ddsNestingLevel = Nothing,
                   _ddsDatabaseName = Nothing,
                   _ddsDocsToInvestigate = Nothing,
                   _ddsExtractDocId = Nothing, _ddsPort = Nothing}
...
instance FromJSON DocDBSettings where
        parseJSON
          = withObject "DocDBSettings"
              (\ x ->
                 DocDBSettings' <$>
                   (x .:? "ServerName") <*> (x .:? "Username") <*>
                     (x .:? "KmsKeyId")
                     <*> (x .:? "Password")
                     <*> (x .:? "NestingLevel")
                     <*> (x .:? "DatabaseName")
...
instance Hashable DocDBSettings where

instance NFData DocDBSettings where
