...
endpoint
  = Endpoint'{_eStatus = Nothing,
              ...
              _eMySQLSettings = Nothing, _eServerName = Nothing,
              ...
              _eOracleSettings = Nothing, _eEndpointType = Nothing,
              ...
              _eIBMDB2Settings = Nothing, _eKMSKeyId = Nothing,
              _eMongoDBSettings = Nothing, _eSSLMode = Nothing,
              _eSybaseSettings = Nothing, _eDatabaseName = Nothing,
