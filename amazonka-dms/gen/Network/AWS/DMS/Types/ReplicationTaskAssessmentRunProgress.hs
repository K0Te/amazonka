...
data ReplicationTaskAssessmentRunProgress = ReplicationTaskAssessmentRunProgress'{_rtarpIndividualAssessmentCount
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Int),
...
replicationTaskAssessmentRunProgress
    :: ReplicationTaskAssessmentRunProgress
replicationTaskAssessmentRunProgress
  = ReplicationTaskAssessmentRunProgress'{_rtarpIndividualAssessmentCount
                                            = Nothing,
                                          _rtarpIndividualAssessmentCompletedCount
                                            = Nothing}
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "ReplicationTaskAssessmentRunProgress"
              (\ x ->
                 ReplicationTaskAssessmentRunProgress' <$>
