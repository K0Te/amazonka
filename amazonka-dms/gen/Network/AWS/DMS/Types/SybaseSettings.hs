...
data SybaseSettings = SybaseSettings'{_ssServerName
                                      :: !(Maybe Text),
...
sybaseSettings
    :: SybaseSettings
sybaseSettings
  = SybaseSettings'{_ssServerName = Nothing,
                    _ssUsername = Nothing, _ssPassword = Nothing,
                    _ssDatabaseName = Nothing, _ssPort = Nothing}
...
instance Hashable SybaseSettings where

instance NFData SybaseSettings where
