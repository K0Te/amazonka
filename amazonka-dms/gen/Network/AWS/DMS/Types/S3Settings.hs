...
data S3Settings = S3Settings'{_ssParquetVersion ::
...
--
-- * 'ssPreserveTransactions' - If set to @true@ , AWS DMS saves the transaction order for a change data capture (CDC) load on the Amazon S3 target specified by <dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-CdcPath @CdcPath@ > .
--
-- * 'ssCSVNoSupValue' - This setting only applies if your Amazon S3 output files during a change data capture (CDC) load are written in .csv format. If <dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-UseCsvNoSupValue @UseCsvNoSupValue@ > is set to true, specify a string value that you want AWS DMS to use for all columns not included in the supplemental log. If you do not specify a string value, AWS DMS uses the null value for these columns regardless of the @UseCsvNoSupValue@ setting.
--
...
--
-- * 'ssUseCSVNoSupValue' - This setting applies if the S3 output files during a change data capture (CDC) load are written in .csv format. If set to @true@ for columns not included in the supplemental log, AWS DMS uses the value specified by <dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-CsvNoSupValue @CsvNoSupValue@ > . If not set or set to @false@ , AWS DMS uses the null value for these columns.
--
...
--
-- * 'ssCdcPath' - Specifies the folder path of CDC files. For an S3 source, this setting is required if a task captures change data; otherwise, it's optional. If @CdcPath@ is set, AWS DMS reads CDC files from this path and replicates the data changes to the target endpoint. For an S3 target, if @CdcPath@ is set, it is the folder path where data changes are replicated. If you set <dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-PreserveTransactions @PreserveTransactions@ > to @true@ , AWS DMS verifies that you have set this parameter to a folder path on your S3 target where AWS DMS can save the transaction order for the CDC load. AWS DMS creates this CDC folder path in either your S3 target working directory or the S3 target location specified by <dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-BucketFolder @BucketFolder@ > and <dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-BucketName @BucketName@ > . For example, if you specify @CdcPath@ as @MyChangedData@ , and you specify @BucketName@ as @MyTargetBucket@ but do not specify @BucketFolder@ , AWS DMS creates the CDC folder path following: @MyTargetBucket/MyChangedData@ . If you specify the same @CdcPath@ , and you specify @BucketName@ as @MyTargetBucket@ and @BucketFolder@ as @MyTargetData@ , AWS DMS creates the CDC folder path following: @MyTargetBucket/MyTargetData/MyChangedData@ .
s3Settings
    :: S3Settings
s3Settings
  = S3Settings'{_ssParquetVersion = Nothing,
                ...
                _ssRowGroupLength = Nothing, _ssCdcPath = Nothing}
...
-- | If set to @true@ , AWS DMS saves the transaction order for a change data capture (CDC) load on the Amazon S3 target specified by <dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-CdcPath @CdcPath@ > .
...
-- | This setting only applies if your Amazon S3 output files during a change data capture (CDC) load are written in .csv format. If <dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-UseCsvNoSupValue @UseCsvNoSupValue@ > is set to true, specify a string value that you want AWS DMS to use for all columns not included in the supplemental log. If you do not specify a string value, AWS DMS uses the null value for these columns regardless of the @UseCsvNoSupValue@ setting.
...
-- | This setting applies if the S3 output files during a change data capture (CDC) load are written in .csv format. If set to @true@ for columns not included in the supplemental log, AWS DMS uses the value specified by <dms/latest/APIReference/API_S3Settings.html#DMS-Type-S3Settings-CsvNoSupValue @CsvNoSupValue@ > . If not set or set to @false@ , AWS DMS uses the null value for these columns.
