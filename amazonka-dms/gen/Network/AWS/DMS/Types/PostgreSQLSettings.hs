...
data PostgreSQLSettings = PostgreSQLSettings'{_psqlsExecuteTimeout
                                              :: !(Maybe Int),
...
instance FromJSON PostgreSQLSettings where
        parseJSON
          = withObject "PostgreSQLSettings"
              (\ x ->
                 PostgreSQLSettings' <$>
                   (x .:? "ExecuteTimeout") <*> (x .:? "MaxFileSize")
...
instance Hashable PostgreSQLSettings where

instance NFData PostgreSQLSettings where
