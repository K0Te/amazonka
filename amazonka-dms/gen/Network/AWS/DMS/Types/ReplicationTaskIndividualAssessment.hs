...
data ReplicationTaskIndividualAssessment = ReplicationTaskIndividualAssessment'{_rtiaStatus
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
...
replicationTaskIndividualAssessment
    :: ReplicationTaskIndividualAssessment
replicationTaskIndividualAssessment
  = ReplicationTaskIndividualAssessment'{_rtiaStatus =
                                           Nothing,
                                         _rtiaReplicationTaskIndividualAssessmentStartDate
                                           = Nothing,
                                         _rtiaIndividualAssessmentName =
...
instance FromJSON ReplicationTaskIndividualAssessment
         where
        parseJSON
          = withObject "ReplicationTaskIndividualAssessment"
              (\ x ->
                 ReplicationTaskIndividualAssessment' <$>
                   (x .:? "Status") <*>
                     (x .:?
