...
data CreateQueue = CreateQueue'{_cqAttributes ::
...
createQueue pQueueName_
  = CreateQueue'{_cqAttributes = Nothing,
                 _cqTags = Nothing, _cqQueueName = pQueueName_}
...
data CreateQueueResponse = CreateQueueResponse'{_cqrsQueueURL
                                                :: !(Maybe Text),
...
createQueueResponse pResponseStatus_
  = CreateQueueResponse'{_cqrsQueueURL = Nothing,
