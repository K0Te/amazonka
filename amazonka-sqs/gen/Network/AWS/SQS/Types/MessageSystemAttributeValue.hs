...
data MessageSystemAttributeValue = MessageSystemAttributeValue'{_msavBinaryValue
                                                                ::
                                                                !(Maybe Base64),
...
messageSystemAttributeValue pDataType_
  = MessageSystemAttributeValue'{_msavBinaryValue =
                                   Nothing,
...
instance Hashable MessageSystemAttributeValue where

instance NFData MessageSystemAttributeValue where
