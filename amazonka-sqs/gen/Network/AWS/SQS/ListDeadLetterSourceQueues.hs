...
data ListDeadLetterSourceQueues = ListDeadLetterSourceQueues'{_ldlsqNextToken
                                                              :: !(Maybe Text),
                                                              _ldlsqMaxResults
                                                              :: !(Maybe Int),
                                                              _ldlsqQueueURL ::
...
listDeadLetterSourceQueues pQueueURL_
  = ListDeadLetterSourceQueues'{_ldlsqNextToken =
                                  Nothing,
...
instance AWSPager ListDeadLetterSourceQueues where
        page rq rs
          ...
          | otherwise =
            Just $ rq & ldlsqNextToken .~ rs ^. ldlsqrsNextToken
...
data ListDeadLetterSourceQueuesResponse = ListDeadLetterSourceQueuesResponse'{_ldlsqrsNextToken
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
...
listDeadLetterSourceQueuesResponse pResponseStatus_
  = ListDeadLetterSourceQueuesResponse'{_ldlsqrsNextToken
                                          = Nothing,
                                        _ldlsqrsResponseStatus =
                                          pResponseStatus_,
