...
data StartProjectVersion = StartProjectVersion'{_spvProjectVersionARN
                                                :: !Text,
...
startProjectVersion
    :: Text -- ^ 'spvProjectVersionARN'
    -> Natural -- ^ 'spvMinInferenceUnits'
    -> StartProjectVersion
startProjectVersion pProjectVersionARN_
  pMinInferenceUnits_
  = StartProjectVersion'{_spvProjectVersionARN =
                           pProjectVersionARN_,
...
instance Hashable StartProjectVersion where

instance NFData StartProjectVersion where
...
data StartProjectVersionResponse = StartProjectVersionResponse'{_spvrsStatus
                                                                ::
                                                                !(Maybe
                                                                    ProjectVersionStatus),
                                                                _spvrsResponseStatus
                                                                :: !Int}
...
startProjectVersionResponse
    :: Int -- ^ 'spvrsResponseStatus'
    -> StartProjectVersionResponse
startProjectVersionResponse pResponseStatus_
  = StartProjectVersionResponse'{_spvrsStatus =
                                   Nothing,
...
instance NFData StartProjectVersionResponse where
