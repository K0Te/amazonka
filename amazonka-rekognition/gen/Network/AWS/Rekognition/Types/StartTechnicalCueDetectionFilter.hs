...
newtype StartTechnicalCueDetectionFilter = StartTechnicalCueDetectionFilter'{_stcdfMinSegmentConfidence
                                                                             ::
                                                                             Maybe
                                                                               Double}
...
startTechnicalCueDetectionFilter
    :: StartTechnicalCueDetectionFilter
startTechnicalCueDetectionFilter
  = StartTechnicalCueDetectionFilter'{_stcdfMinSegmentConfidence
                                        = Nothing}
...
instance ToJSON StartTechnicalCueDetectionFilter
         where
