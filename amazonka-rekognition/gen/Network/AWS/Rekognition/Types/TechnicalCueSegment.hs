...
data TechnicalCueSegment = TechnicalCueSegment'{_tcsConfidence
                                                :: !(Maybe Double),
                                                _tcsType ::
...
technicalCueSegment
    :: TechnicalCueSegment
technicalCueSegment
  = TechnicalCueSegment'{_tcsConfidence = Nothing,
                         _tcsType = Nothing}
...
instance FromJSON TechnicalCueSegment where
        parseJSON
          = withObject "TechnicalCueSegment"
              (\ x ->
                 TechnicalCueSegment' <$>
                   (x .:? "Confidence") <*> (x .:? "Type"))

instance Hashable TechnicalCueSegment where

instance NFData TechnicalCueSegment where
