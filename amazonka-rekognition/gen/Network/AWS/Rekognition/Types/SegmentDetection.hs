...
data SegmentDetection = SegmentDetection'{_sdTechnicalCueSegment
...
segmentDetection
    :: SegmentDetection
segmentDetection
  = SegmentDetection'{_sdTechnicalCueSegment = Nothing,
                      ...
                      _sdStartTimestampMillis = Nothing, _sdType = Nothing,
...
instance Hashable SegmentDetection where

instance NFData SegmentDetection where
