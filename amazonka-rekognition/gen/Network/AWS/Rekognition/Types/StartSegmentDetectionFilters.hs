...
data StartSegmentDetectionFilters = StartSegmentDetectionFilters'{_ssdfTechnicalCueFilter
                                                                  ::
                                                                  !(Maybe
...
startSegmentDetectionFilters
    :: StartSegmentDetectionFilters
startSegmentDetectionFilters
  = StartSegmentDetectionFilters'{_ssdfTechnicalCueFilter
                                    = Nothing,
...
instance Hashable StartSegmentDetectionFilters where

instance NFData StartSegmentDetectionFilters where
