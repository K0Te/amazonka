...
data ProtectiveEquipmentPerson = ProtectiveEquipmentPerson'{_pepBodyParts
                                                            ::
                                                            !(Maybe
...
protectiveEquipmentPerson
    :: ProtectiveEquipmentPerson
protectiveEquipmentPerson
  = ProtectiveEquipmentPerson'{_pepBodyParts = Nothing,
                               _pepBoundingBox = Nothing,
                               _pepConfidence = Nothing, _pepId = Nothing}
...
instance FromJSON ProtectiveEquipmentPerson where
        parseJSON
          = withObject "ProtectiveEquipmentPerson"
              (\ x ->
                 ProtectiveEquipmentPerson' <$>
                   (x .:? "BodyParts" .!= mempty) <*>
                     (x .:? "BoundingBox")
...
instance Hashable ProtectiveEquipmentPerson where

instance NFData ProtectiveEquipmentPerson where
