...
data ProjectVersionDescription = ProjectVersionDescription'{_pvdMinInferenceUnits
                                                            :: !(Maybe Nat),
                                                            _pvdStatus ::
                                                            !(Maybe
...
projectVersionDescription
    :: ProjectVersionDescription
projectVersionDescription
  = ProjectVersionDescription'{_pvdMinInferenceUnits =
                                 Nothing,
                               _pvdStatus = Nothing,
...
instance FromJSON ProjectVersionDescription where
        parseJSON
          = withObject "ProjectVersionDescription"
              (\ x ->
                 ProjectVersionDescription' <$>
                   (x .:? "MinInferenceUnits") <*> (x .:? "Status") <*>
                     (x .:? "EvaluationResult")
                     <*> (x .:? "ManifestSummary")
                     <*> (x .:? "TestingDataResult")
                     <*> (x .:? "StatusMessage")
...
instance Hashable ProjectVersionDescription where

instance NFData ProjectVersionDescription where
