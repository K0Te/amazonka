...
data ProtectiveEquipmentBodyPart = ProtectiveEquipmentBodyPart'{_pebpEquipmentDetections
                                                                ::
                                                                !(Maybe
                                                                    [EquipmentDetection]),
                                                                _pebpConfidence
...
protectiveEquipmentBodyPart
    :: ProtectiveEquipmentBodyPart
protectiveEquipmentBodyPart
  = ProtectiveEquipmentBodyPart'{_pebpEquipmentDetections
                                   = Nothing,
                                 _pebpConfidence = Nothing, _pebpName = Nothing}
...
instance FromJSON ProtectiveEquipmentBodyPart where
        parseJSON
          = withObject "ProtectiveEquipmentBodyPart"
              (\ x ->
                 ProtectiveEquipmentBodyPart' <$>
...
instance Hashable ProtectiveEquipmentBodyPart where

instance NFData ProtectiveEquipmentBodyPart where
