...
newtype GroundTruthManifest = GroundTruthManifest'{_gtmS3Object
                                                   :: Maybe S3Object}
...
instance FromJSON GroundTruthManifest where
        parseJSON
          = withObject "GroundTruthManifest"
              (\ x -> GroundTruthManifest' <$> (x .:? "S3Object"))

instance Hashable GroundTruthManifest where

instance NFData GroundTruthManifest where
