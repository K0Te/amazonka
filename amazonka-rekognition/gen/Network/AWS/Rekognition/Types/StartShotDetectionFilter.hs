...
newtype StartShotDetectionFilter = StartShotDetectionFilter'{_ssdfMinSegmentConfidence
                                                             :: Maybe Double}
...
startShotDetectionFilter
    :: StartShotDetectionFilter
startShotDetectionFilter
  = StartShotDetectionFilter'{_ssdfMinSegmentConfidence
                                = Nothing}
...
instance Hashable StartShotDetectionFilter where

instance NFData StartShotDetectionFilter where
