...
data StartTextDetection = StartTextDetection'{_stdJobTag
                                              :: !(Maybe Text),
                                              _stdFilters ::
                                              !(Maybe
...
startTextDetection pVideo_
  = StartTextDetection'{_stdJobTag = Nothing,
                        _stdFilters = Nothing,
...
instance Hashable StartTextDetection where

instance NFData StartTextDetection where
...
data StartTextDetectionResponse = StartTextDetectionResponse'{_stdrsJobId
                                                              :: !(Maybe Text),
                                                              _stdrsResponseStatus
                                                              :: !Int}
...
startTextDetectionResponse pResponseStatus_
  = StartTextDetectionResponse'{_stdrsJobId = Nothing,
...
instance NFData StartTextDetectionResponse where
