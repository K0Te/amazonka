...
data DetectProtectiveEquipment = DetectProtectiveEquipment'{_dpeSummarizationAttributes
                                                            ::
                                                            !(Maybe
...
detectProtectiveEquipment pImage_
  = DetectProtectiveEquipment'{_dpeSummarizationAttributes
                                 = Nothing,
                               _dpeImage = pImage_}
...
instance Hashable DetectProtectiveEquipment where

instance NFData DetectProtectiveEquipment where
...
data DetectProtectiveEquipmentResponse = DetectProtectiveEquipmentResponse'{_dpersSummary
                                                                            ::
                                                                            !(Maybe
...
detectProtectiveEquipmentResponse pResponseStatus_
  = DetectProtectiveEquipmentResponse'{_dpersSummary =
                                         Nothing,
                                       _dpersProtectiveEquipmentModelVersion =
                                         Nothing,
