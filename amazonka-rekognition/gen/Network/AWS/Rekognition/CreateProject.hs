...
newtype CreateProject = CreateProject'{_cpProjectName
                                       :: Text}
...
data CreateProjectResponse = CreateProjectResponse'{_cprsProjectARN
                                                    :: !(Maybe Text),
...
createProjectResponse pResponseStatus_
  = CreateProjectResponse'{_cprsProjectARN = Nothing,
