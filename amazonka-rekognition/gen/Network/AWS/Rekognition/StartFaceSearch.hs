...
data StartFaceSearch = StartFaceSearch'{_sfsFaceMatchThreshold
                                        :: !(Maybe Double),
...
startFaceSearch pVideo_ pCollectionId_
  = StartFaceSearch'{_sfsFaceMatchThreshold = Nothing,
                     _sfsJobTag = Nothing,
...
data StartFaceSearchResponse = StartFaceSearchResponse'{_sfsrsJobId
                                                        :: !(Maybe Text),
                                                        _sfsrsResponseStatus ::
                                                        !Int}
...
startFaceSearchResponse pResponseStatus_
  = StartFaceSearchResponse'{_sfsrsJobId = Nothing,
                             _sfsrsResponseStatus = pResponseStatus_}
