...
newtype DeleteProject = DeleteProject'{_dpProjectARN
                                       :: Text}
...
data DeleteProjectResponse = DeleteProjectResponse'{_dprsStatus
                                                    :: !(Maybe ProjectStatus),
...
deleteProjectResponse pResponseStatus_
  = DeleteProjectResponse'{_dprsStatus = Nothing,
