...
data DescribeProjectVersions = DescribeProjectVersions'{_dpvNextToken
                                                        :: !(Maybe Text),
                                                        _dpvVersionNames ::
                                                        !(Maybe (List1 Text)),
                                                        _dpvMaxResults ::
...
describeProjectVersions pProjectARN_
  = DescribeProjectVersions'{_dpvNextToken = Nothing,
...
instance AWSPager DescribeProjectVersions where
        page rq rs
          ...
          | stop (rs ^. dpvrsProjectVersionDescriptions) =
            Nothing
          | otherwise =
            Just $ rq & dpvNextToken .~ rs ^. dpvrsNextToken

instance AWSRequest DescribeProjectVersions where
        type Rs DescribeProjectVersions =
             DescribeProjectVersionsResponse
...
instance Hashable DescribeProjectVersions where

instance NFData DescribeProjectVersions where
...
data DescribeProjectVersionsResponse = DescribeProjectVersionsResponse'{_dpvrsNextToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
describeProjectVersionsResponse pResponseStatus_
  = DescribeProjectVersionsResponse'{_dpvrsNextToken =
                                       Nothing,
...
instance NFData DescribeProjectVersionsResponse where
