...
newtype DescribeCollection = DescribeCollection'{_dCollectionId
                                                 :: Text}
...
describeCollection pCollectionId_
  = DescribeCollection'{_dCollectionId =
                          pCollectionId_}
...
instance AWSRequest DescribeCollection where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribeCollectionResponse' <$>
                   (x .?> "FaceModelVersion") <*> (x .?> "FaceCount")
                     <*> (x .?> "CreationTimestamp")
                     <*> (x .?> "CollectionARN")
                     <*> (pure (fromEnum s)))

instance Hashable DescribeCollection where

instance NFData DescribeCollection where
...
data DescribeCollectionResponse = DescribeCollectionResponse'{_drsFaceModelVersion
                                                              :: !(Maybe Text),
                                                              _drsFaceCount ::
                                                              !(Maybe Nat),
...
describeCollectionResponse pResponseStatus_
  = DescribeCollectionResponse'{_drsFaceModelVersion =
                                  Nothing,
...
instance NFData DescribeCollectionResponse where
