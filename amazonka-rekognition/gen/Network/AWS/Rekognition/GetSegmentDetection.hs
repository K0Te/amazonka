...
data GetSegmentDetection = GetSegmentDetection'{_gsdNextToken
                                                :: !(Maybe Text),
...
getSegmentDetection pJobId_
  = GetSegmentDetection'{_gsdNextToken = Nothing,
                         _gsdMaxResults = Nothing, _gsdJobId = pJobId_}
...
instance Hashable GetSegmentDetection where

instance NFData GetSegmentDetection where
...
data GetSegmentDetectionResponse = GetSegmentDetectionResponse'{_gsdrsSelectedSegmentTypes
                                                                ::
                                                                !(Maybe
                                                                    [SegmentTypeInfo]),
                                                                _gsdrsNextToken
...
getSegmentDetectionResponse pResponseStatus_
  = GetSegmentDetectionResponse'{_gsdrsSelectedSegmentTypes
                                   = Nothing,
...
instance NFData GetSegmentDetectionResponse where
