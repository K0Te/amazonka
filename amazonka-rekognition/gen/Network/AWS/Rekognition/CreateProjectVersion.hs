...
data CreateProjectVersion = CreateProjectVersion'{_cpvProjectARN
                                                  :: !Text,
...
createProjectVersion
    :: Text -- ^ 'cpvProjectARN'
    -> Text -- ^ 'cpvVersionName'
    -> OutputConfig -- ^ 'cpvOutputConfig'
    -> TrainingData -- ^ 'cpvTrainingData'
    -> TestingData -- ^ 'cpvTestingData'
    -> CreateProjectVersion
createProjectVersion pProjectARN_ pVersionName_
  pOutputConfig_ pTrainingData_ pTestingData_
  = CreateProjectVersion'{_cpvProjectARN =
                            pProjectARN_,
...
instance Hashable CreateProjectVersion where

instance NFData CreateProjectVersion where
...
data CreateProjectVersionResponse = CreateProjectVersionResponse'{_cpvrsProjectVersionARN
                                                                  ::
                                                                  !(Maybe Text),
...
createProjectVersionResponse pResponseStatus_
  = CreateProjectVersionResponse'{_cpvrsProjectVersionARN
                                    = Nothing,
...
instance NFData CreateProjectVersionResponse where
