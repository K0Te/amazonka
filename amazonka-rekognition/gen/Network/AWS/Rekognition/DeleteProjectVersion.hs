...
newtype DeleteProjectVersion = DeleteProjectVersion'{_dpvProjectVersionARN
                                                     :: Text}
...
deleteProjectVersion
    :: Text -- ^ 'dpvProjectVersionARN'
    -> DeleteProjectVersion
deleteProjectVersion pProjectVersionARN_
  = DeleteProjectVersion'{_dpvProjectVersionARN =
                            pProjectVersionARN_}
...
instance Hashable DeleteProjectVersion where

instance NFData DeleteProjectVersion where
...
data DeleteProjectVersionResponse = DeleteProjectVersionResponse'{_delrsStatus
                                                                  ::
                                                                  !(Maybe
...
deleteProjectVersionResponse pResponseStatus_
  = DeleteProjectVersionResponse'{_delrsStatus =
                                    Nothing,
...
instance NFData DeleteProjectVersionResponse where
