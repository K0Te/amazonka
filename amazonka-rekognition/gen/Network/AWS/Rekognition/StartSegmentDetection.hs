...
data StartSegmentDetection = StartSegmentDetection'{_ssdJobTag
                                                    :: !(Maybe Text),
                                                    _ssdFilters ::
                                                    !(Maybe
...
startSegmentDetection
    :: Video -- ^ 'ssdVideo'
    -> NonEmpty SegmentType -- ^ 'ssdSegmentTypes'
    -> StartSegmentDetection
startSegmentDetection pVideo_ pSegmentTypes_
  = StartSegmentDetection'{_ssdJobTag = Nothing,
                           _ssdFilters = Nothing,
...
instance Hashable StartSegmentDetection where

instance NFData StartSegmentDetection where
...
data StartSegmentDetectionResponse = StartSegmentDetectionResponse'{_ssdrsJobId
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _ssdrsResponseStatus
                                                                    :: !Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
startSegmentDetectionResponse
    :: Int -- ^ 'ssdrsResponseStatus'
    -> StartSegmentDetectionResponse
startSegmentDetectionResponse pResponseStatus_
  = StartSegmentDetectionResponse'{_ssdrsJobId =
                                     Nothing,
...
instance NFData StartSegmentDetectionResponse where
