...
data DetectCustomLabels = DetectCustomLabels'{_dclMinConfidence
                                              :: !(Maybe Double),
...
detectCustomLabels
    :: Text -- ^ 'dclProjectVersionARN'
    -> Image -- ^ 'dclImage'
    -> DetectCustomLabels
detectCustomLabels pProjectVersionARN_ pImage_
  = DetectCustomLabels'{_dclMinConfidence = Nothing,
...
instance Hashable DetectCustomLabels where

instance NFData DetectCustomLabels where
...
data DetectCustomLabelsResponse = DetectCustomLabelsResponse'{_dclrsCustomLabels
                                                              ::
                                                              !(Maybe
                                                                  [CustomLabel]),
                                                              _dclrsResponseStatus
                                                              :: !Int}
...
detectCustomLabelsResponse pResponseStatus_
  = DetectCustomLabelsResponse'{_dclrsCustomLabels =
                                  Nothing,
...
instance NFData DetectCustomLabelsResponse where
