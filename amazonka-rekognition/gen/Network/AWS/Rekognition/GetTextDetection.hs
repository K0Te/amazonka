...
data GetTextDetection = GetTextDetection'{_gtdNextToken
                                          :: !(Maybe Text),
...
getTextDetection pJobId_
  = GetTextDetection'{_gtdNextToken = Nothing,
                      _gtdMaxResults = Nothing, _gtdJobId = pJobId_}
...
instance Hashable GetTextDetection where

instance NFData GetTextDetection where
...
data GetTextDetectionResponse = GetTextDetectionResponse'{_gtdrsTextDetections
                                                          ::
                                                          !(Maybe
                                                              [TextDetectionResult]),
                                                          _gtdrsNextToken ::
                                                          ...
                                                          _gtdrsStatusMessage ::
                                                          !(Maybe Text),
                                                          _gtdrsTextModelVersion
                                                          :: !(Maybe Text),
                                                          _gtdrsJobStatus ::
                                                          !(Maybe
                                                              VideoJobStatus),
                                                          _gtdrsResponseStatus
                                                          :: !Int}
...
getTextDetectionResponse
    :: Int -- ^ 'gtdrsResponseStatus'
    -> GetTextDetectionResponse
getTextDetectionResponse pResponseStatus_
  = GetTextDetectionResponse'{_gtdrsTextDetections =
                                Nothing,
...
instance NFData GetTextDetectionResponse where
