...
data DescribeProjects = DescribeProjects'{_dpNextToken
                                          :: !(Maybe Text),
...
describeProjects
    :: DescribeProjects
describeProjects
  = DescribeProjects'{_dpNextToken = Nothing,
...
instance AWSPager DescribeProjects where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dpNextToken .~ rs ^. dpsrsNextToken
...
instance Hashable DescribeProjects where

instance NFData DescribeProjects where
...
data DescribeProjectsResponse = DescribeProjectsResponse'{_dpsrsNextToken
                                                          :: !(Maybe Text),
...
describeProjectsResponse pResponseStatus_
  = DescribeProjectsResponse'{_dpsrsNextToken =
                                Nothing,
...
instance NFData DescribeProjectsResponse where
