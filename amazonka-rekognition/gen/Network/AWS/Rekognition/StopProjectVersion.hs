...
newtype StopProjectVersion = StopProjectVersion'{_sProjectVersionARN
                                                 :: Text}
...
stopProjectVersion
    :: Text -- ^ 'sProjectVersionARN'
    -> StopProjectVersion
stopProjectVersion pProjectVersionARN_
  = StopProjectVersion'{_sProjectVersionARN =
                          pProjectVersionARN_}
...
instance Hashable StopProjectVersion where

instance NFData StopProjectVersion where
...
data StopProjectVersionResponse = StopProjectVersionResponse'{_srsStatus
                                                              ::
                                                              !(Maybe
...
stopProjectVersionResponse pResponseStatus_
  = StopProjectVersionResponse'{_srsStatus = Nothing,
...
instance NFData StopProjectVersionResponse where
