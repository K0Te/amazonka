...
data DescribeOrganizationConfigRules = DescribeOrganizationConfigRules'{_docrOrganizationConfigRuleNames
                                                                        ::
                                                                        !(Maybe
                                                                            [Text]),
                                                                        _docrNextToken
...
describeOrganizationConfigRules
    :: DescribeOrganizationConfigRules
describeOrganizationConfigRules
  = DescribeOrganizationConfigRules'{_docrOrganizationConfigRuleNames
                                       = Nothing,
...
instance AWSRequest DescribeOrganizationConfigRules
         where
...
instance NFData DescribeOrganizationConfigRules where

instance ToHeaders DescribeOrganizationConfigRules
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery DescribeOrganizationConfigRules
         where
        toQuery = const mempty

-- | /See:/ 'describeOrganizationConfigRulesResponse' smart constructor.
data DescribeOrganizationConfigRulesResponse = DescribeOrganizationConfigRulesResponse'{_docrrsOrganizationConfigRules
                                                                                        ::
                                                                                        !(Maybe
...
describeOrganizationConfigRulesResponse
    :: Int -- ^ 'docrrsResponseStatus'
    -> DescribeOrganizationConfigRulesResponse
describeOrganizationConfigRulesResponse
  pResponseStatus_
  = DescribeOrganizationConfigRulesResponse'{_docrrsOrganizationConfigRules
                                               = Nothing,
