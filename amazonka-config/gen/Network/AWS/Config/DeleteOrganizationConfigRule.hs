...
instance AWSRequest DeleteOrganizationConfigRule
         where
...
instance Hashable DeleteOrganizationConfigRule where

instance NFData DeleteOrganizationConfigRule where
