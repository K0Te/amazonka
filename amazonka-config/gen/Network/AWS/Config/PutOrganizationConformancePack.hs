...
data PutOrganizationConformancePack = PutOrganizationConformancePack'{_pocpDeliveryS3Bucket
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
...
putOrganizationConformancePack
  ...
  = PutOrganizationConformancePack'{_pocpDeliveryS3Bucket
                                      = Nothing,
...
instance AWSRequest PutOrganizationConformancePack
         where
...
instance NFData PutOrganizationConformancePack where

instance ToHeaders PutOrganizationConformancePack
         where
        toHeaders
          = const
              (mconcat
