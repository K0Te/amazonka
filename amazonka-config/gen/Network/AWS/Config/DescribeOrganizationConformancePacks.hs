...
instance ToJSON DescribeOrganizationConformancePacks
         where
...
instance ToPath DescribeOrganizationConformancePacks
         where
        toPath = const "/"

instance ToQuery DescribeOrganizationConformancePacks
         where
