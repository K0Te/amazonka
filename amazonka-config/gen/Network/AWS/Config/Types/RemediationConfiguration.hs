...
data RemediationConfiguration = RemediationConfiguration'{_rcResourceType
                                                          :: !(Maybe Text),
                                                          _rcARN ::
                                                          !(Maybe Text),
                                                          _rcAutomatic ::
...
remediationConfiguration
    ...
    -> Text -- ^ 'rcTargetId'
    -> RemediationConfiguration
remediationConfiguration pConfigRuleName_
  pTargetType_ pTargetId_
  = RemediationConfiguration'{_rcResourceType =
                                Nothing,
                              _rcARN = Nothing, _rcAutomatic = Nothing,
