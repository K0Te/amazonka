...
data OrganizationConformancePack = OrganizationConformancePack'{_ocpDeliveryS3Bucket
                                                                ::
                                                                !(Maybe Text),
...
organizationConformancePack
  ...
  pOrganizationConformancePackARN_ pLastUpdateTime_
  = OrganizationConformancePack'{_ocpDeliveryS3Bucket =
                                   Nothing,
