...
data ConformancePackDetail = ConformancePackDetail'{_cpdDeliveryS3Bucket
                                                    :: !(Maybe Text),
...
conformancePackDetail
    ...
    -> ConformancePackDetail
conformancePackDetail pConformancePackName_
  pConformancePackARN_ pConformancePackId_
  = ConformancePackDetail'{_cpdDeliveryS3Bucket =
                             Nothing,
