...
data ConformancePackInputParameter = ConformancePackInputParameter'{_cpipParameterName
                                                                    :: !Text,
                                                                    _cpipParameterValue
                                                                    :: !Text}
...
conformancePackInputParameter
    ...
    -> ConformancePackInputParameter
conformancePackInputParameter pParameterName_
  pParameterValue_
  = ConformancePackInputParameter'{_cpipParameterName =
                                     pParameterName_,
