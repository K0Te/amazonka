...
data PutConformancePack = PutConformancePack'{_pcpDeliveryS3Bucket
                                              :: !(Maybe Text),
...
putConformancePack pConformancePackName_
  = PutConformancePack'{_pcpDeliveryS3Bucket = Nothing,
...
instance Hashable PutConformancePack where

instance NFData PutConformancePack where
...
instance NFData PutConformancePackResponse where
