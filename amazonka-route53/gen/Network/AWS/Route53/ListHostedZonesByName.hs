...
data ListHostedZonesByName = ListHostedZonesByName'{_lhzbnHostedZoneId
                                                    :: !(Maybe ResourceId),
                                                    _lhzbnMaxItems ::
                                                    !(Maybe Text),
                                                    _lhzbnDNSName ::
...
listHostedZonesByName
    :: ListHostedZonesByName
listHostedZonesByName
  = ListHostedZonesByName'{_lhzbnHostedZoneId =
                             Nothing,
                           _lhzbnMaxItems = Nothing, _lhzbnDNSName = Nothing}
...
data ListHostedZonesByNameResponse = ListHostedZonesByNameResponse'{_lhzbnrsHostedZoneId
                                                                    ::
                                                                    !(Maybe
                                                                        ResourceId),
                                                                    _lhzbnrsNextHostedZoneId
                                                                    ::
                                                                    !(Maybe
                                                                        ResourceId),
                                                                    _lhzbnrsDNSName
...
listHostedZonesByNameResponse
    ...
    -> ListHostedZonesByNameResponse
listHostedZonesByNameResponse pResponseStatus_
  pIsTruncated_ pMaxItems_
  = ListHostedZonesByNameResponse'{_lhzbnrsHostedZoneId
                                     = Nothing,
