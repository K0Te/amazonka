...
data GetGeoLocation = GetGeoLocation'{_gglSubdivisionCode
                                      :: !(Maybe Text),
...
getGeoLocation
    :: GetGeoLocation
getGeoLocation
  = GetGeoLocation'{_gglSubdivisionCode = Nothing,
...
data GetGeoLocationResponse = GetGeoLocationResponse'{_gglrsResponseStatus
                                                      :: !Int,
...
getGeoLocationResponse
    ...
    -> GetGeoLocationResponse
getGeoLocationResponse pResponseStatus_
  pGeoLocationDetails_
  = GetGeoLocationResponse'{_gglrsResponseStatus =
                              pResponseStatus_,
