...
data ChangeResourceRecordSets = ChangeResourceRecordSets'{_crrsHostedZoneId
                                                          :: !ResourceId,
                                                          _crrsChangeBatch ::
                                                          !ChangeBatch}
...
changeResourceRecordSets pHostedZoneId_ pChangeBatch_
  = ChangeResourceRecordSets'{_crrsHostedZoneId =
                                pHostedZoneId_,
...
data ChangeResourceRecordSetsResponse = ChangeResourceRecordSetsResponse'{_crrsrsResponseStatus
                                                                          ::
                                                                          !Int,
                                                                          _crrsrsChangeInfo
                                                                          ::
...
changeResourceRecordSetsResponse
    ...
    -> ChangeResourceRecordSetsResponse
changeResourceRecordSetsResponse pResponseStatus_
  pChangeInfo_
  = ChangeResourceRecordSetsResponse'{_crrsrsResponseStatus
                                        = pResponseStatus_,
