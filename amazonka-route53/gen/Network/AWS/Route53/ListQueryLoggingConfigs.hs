...
data ListQueryLoggingConfigs = ListQueryLoggingConfigs'{_lqlcHostedZoneId
                                                        :: !(Maybe ResourceId),
                                                        _lqlcNextToken ::
                                                        !(Maybe Text),
                                                        _lqlcMaxResults ::
...
listQueryLoggingConfigs
    :: ListQueryLoggingConfigs
listQueryLoggingConfigs
  = ListQueryLoggingConfigs'{_lqlcHostedZoneId =
                               Nothing,
...
data ListQueryLoggingConfigsResponse = ListQueryLoggingConfigsResponse'{_lqlcrsNextToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _lqlcrsResponseStatus
                                                                        :: !Int,
                                                                        _lqlcrsQueryLoggingConfigs
                                                                        ::
                                                                        ![QueryLoggingConfig]}
...
--
-- * 'lqlcrsQueryLoggingConfigs' - An array that contains one <https://docs.aws.amazon.com/Route53/latest/APIReference/API_QueryLoggingConfig.html QueryLoggingConfig> element for each configuration for DNS query logging that is associated with the current AWS account.
listQueryLoggingConfigsResponse
    :: Int -- ^ 'lqlcrsResponseStatus'
    -> ListQueryLoggingConfigsResponse
listQueryLoggingConfigsResponse pResponseStatus_
  = ListQueryLoggingConfigsResponse'{_lqlcrsNextToken =
                                       Nothing,
