...
data ListHostedZonesByVPC = ListHostedZonesByVPC'{_lhzbvNextToken
                                                  :: !(Maybe Text),
                                                  _lhzbvMaxItems ::
                                                  !(Maybe Text),
                                                  _lhzbvVPCId :: !Text,
...
listHostedZonesByVPC
    :: Text -- ^ 'lhzbvVPCId'
    -> VPCRegion -- ^ 'lhzbvVPCRegion'
    -> ListHostedZonesByVPC
listHostedZonesByVPC pVPCId_ pVPCRegion_
  = ListHostedZonesByVPC'{_lhzbvNextToken = Nothing,
                          _lhzbvMaxItems = Nothing, _lhzbvVPCId = pVPCId_,
...
instance Hashable ListHostedZonesByVPC where

instance NFData ListHostedZonesByVPC where
        ...
        toQuery ListHostedZonesByVPC'{..}
          = mconcat
              ["nexttoken" =: _lhzbvNextToken,
               "maxitems" =: _lhzbvMaxItems, "vpcid" =: _lhzbvVPCId,
               "vpcregion" =: _lhzbvVPCRegion]

-- | /See:/ 'listHostedZonesByVPCResponse' smart constructor.
data ListHostedZonesByVPCResponse = ListHostedZonesByVPCResponse'{_lhzbvrsNextToken
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _lhzbvrsResponseStatus
                                                                  :: !Int,
...
listHostedZonesByVPCResponse
    :: Int -- ^ 'lhzbvrsResponseStatus'
    -> Text -- ^ 'lhzbvrsMaxItems'
    -> ListHostedZonesByVPCResponse
listHostedZonesByVPCResponse pResponseStatus_
  pMaxItems_
  = ListHostedZonesByVPCResponse'{_lhzbvrsNextToken =
                                    Nothing,
...
instance NFData ListHostedZonesByVPCResponse where
