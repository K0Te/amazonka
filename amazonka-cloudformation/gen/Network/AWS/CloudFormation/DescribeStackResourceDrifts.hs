...
data DescribeStackResourceDrifts = DescribeStackResourceDrifts'{_dsrdNextToken
                                                                ::
                                                                !(Maybe Text),
                                                                _dsrdMaxResults
                                                                :: !(Maybe Nat),
...
describeStackResourceDrifts pStackName_
  = DescribeStackResourceDrifts'{_dsrdNextToken =
                                   Nothing,
...
data DescribeStackResourceDriftsResponse = DescribeStackResourceDriftsResponse'{_drsNextToken
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
                                                                                _drsResponseStatus
...
describeStackResourceDriftsResponse pResponseStatus_
  = DescribeStackResourceDriftsResponse'{_drsNextToken
                                           = Nothing,
