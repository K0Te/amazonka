...
newtype DescribeStackDriftDetectionStatus = DescribeStackDriftDetectionStatus'{_dsddsStackDriftDetectionId
                                                                               ::
                                                                               Text}
...
describeStackDriftDetectionStatus
  ...
  = DescribeStackDriftDetectionStatus'{_dsddsStackDriftDetectionId
                                         = pStackDriftDetectionId_}
...
data DescribeStackDriftDetectionStatusResponse = DescribeStackDriftDetectionStatusResponse'{_dsddsrsStackDriftStatus
                                                                                            ::
                                                                                            !(Maybe
                                                                                                StackDriftStatus),
...
describeStackDriftDetectionStatusResponse
    ...
    -> DescribeStackDriftDetectionStatusResponse
describeStackDriftDetectionStatusResponse
  pResponseStatus_ pStackId_ pStackDriftDetectionId_
  pDetectionStatus_ pTimestamp_
  = DescribeStackDriftDetectionStatusResponse'{_dsddsrsStackDriftStatus
                                                 = Nothing,
                                               _dsddsrsDriftedStackResourceCount
                                                 = Nothing,
                                               _dsddsrsDetectionStatusReason =
