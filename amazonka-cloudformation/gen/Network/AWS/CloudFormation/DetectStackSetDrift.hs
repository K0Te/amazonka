...
data DetectStackSetDrift = DetectStackSetDrift'{_dssdOperationPreferences
                                                ::
                                                !(Maybe
...
detectStackSetDrift pStackSetName_
  = DetectStackSetDrift'{_dssdOperationPreferences =
                           Nothing,
...
data DetectStackSetDriftResponse = DetectStackSetDriftResponse'{_dssdrsOperationId
                                                                ::
                                                                !(Maybe Text),
                                                                _dssdrsResponseStatus
                                                                :: !Int}
...
detectStackSetDriftResponse pResponseStatus_
  = DetectStackSetDriftResponse'{_dssdrsOperationId =
                                   Nothing,
