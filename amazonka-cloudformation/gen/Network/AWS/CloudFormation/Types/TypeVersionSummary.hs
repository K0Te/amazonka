...
data TypeVersionSummary = TypeVersionSummary'{_tvsVersionId
                                              :: !(Maybe Text),
...
typeVersionSummary
    :: TypeVersionSummary
typeVersionSummary
  = TypeVersionSummary'{_tvsVersionId = Nothing,
                        _tvsTypeName = Nothing, _tvsARN = Nothing,
                        _tvsTimeCreated = Nothing, _tvsType = Nothing,
