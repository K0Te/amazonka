...
data StackInstanceFilter = StackInstanceFilter'{_sifValues
                                                :: !(Maybe Text),
                                                _sifName ::
                                                !(Maybe
...
stackInstanceFilter
    :: StackInstanceFilter
stackInstanceFilter
  = StackInstanceFilter'{_sifValues = Nothing,
                         _sifName = Nothing}
...
instance Hashable StackInstanceFilter where

instance NFData StackInstanceFilter where
