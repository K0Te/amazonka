...
data StackResourceDrift = StackResourceDrift'{_srdActualProperties
                                              :: !(Maybe Text),
...
stackResourceDrift
    ...
    -> StackResourceDrift
stackResourceDrift pStackId_ pLogicalResourceId_
  pResourceType_ pStackResourceDriftStatus_ pTimestamp_
  = StackResourceDrift'{_srdActualProperties = Nothing,
