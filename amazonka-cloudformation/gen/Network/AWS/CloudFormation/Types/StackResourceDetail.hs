...
data StackResourceDetail = StackResourceDetail'{_sPhysicalResourceId
                                                :: !(Maybe Text),
                                                _sResourceStatusReason ::
                                                !(Maybe Text),
                                                _sDriftInformation ::
                                                !(Maybe
...
stackResourceDetail pLogicalResourceId_
  ...
  pResourceStatus_
  = StackResourceDetail'{_sPhysicalResourceId =
                           Nothing,
                         _sResourceStatusReason = Nothing,
                         _sDriftInformation = Nothing, _sModuleInfo = Nothing,
                         _sMetadata = Nothing, _sStackId = Nothing,
                         _sDescription = Nothing, _sStackName = Nothing,
