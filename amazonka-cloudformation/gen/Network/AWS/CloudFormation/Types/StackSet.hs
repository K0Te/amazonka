...
data StackSet = StackSet'{_ssStackSetDriftDetectionDetails
...
stackSet
    :: StackSet
stackSet
  = StackSet'{_ssStackSetDriftDetectionDetails =
                Nothing,
              _ssStatus = Nothing,
              ...
              _ssParameters = Nothing, _ssTemplateBody = Nothing,
              _ssStackSetName = Nothing, _ssDescription = Nothing,
              _ssCapabilities = Nothing, _ssTags = Nothing,
