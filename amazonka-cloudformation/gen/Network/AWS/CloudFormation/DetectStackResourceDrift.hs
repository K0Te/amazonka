...
data DetectStackResourceDrift = DetectStackResourceDrift'{_detStackName
                                                          :: !Text,
                                                          _detLogicalResourceId
                                                          :: !Text}
...
detectStackResourceDrift
    ...
    -> DetectStackResourceDrift
detectStackResourceDrift pStackName_
  pLogicalResourceId_
  = DetectStackResourceDrift'{_detStackName =
                                pStackName_,
                              _detLogicalResourceId = pLogicalResourceId_}
...
data DetectStackResourceDriftResponse = DetectStackResourceDriftResponse'{_dsrdrsResponseStatus
                                                                          ::
                                                                          !Int,
                                                                          _dsrdrsStackResourceDrift
                                                                          ::
                                                                          !StackResourceDrift}
...
detectStackResourceDriftResponse
    ...
    -> DetectStackResourceDriftResponse
detectStackResourceDriftResponse pResponseStatus_
  pStackResourceDrift_
  = DetectStackResourceDriftResponse'{_dsrdrsResponseStatus
                                        = pResponseStatus_,
                                      _dsrdrsStackResourceDrift =
                                        pStackResourceDrift_}
