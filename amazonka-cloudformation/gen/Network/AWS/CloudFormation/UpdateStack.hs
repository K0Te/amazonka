...
data UpdateStack = UpdateStack'{_usUsePreviousTemplate
                                :: !(Maybe Bool),
...
updateStack pStackName_
  = UpdateStack'{_usUsePreviousTemplate = Nothing,
                 ...
                 _usParameters = Nothing, _usStackPolicyURL = Nothing,
                 _usTemplateBody = Nothing, _usTemplateURL = Nothing,
                 _usClientRequestToken = Nothing,
                 _usCapabilities = Nothing,
                 _usRollbackConfiguration = Nothing,
                 _usResourceTypes = Nothing, _usTags = Nothing,
                 _usRoleARN = Nothing, _usStackName = pStackName_}
...
data UpdateStackResponse = UpdateStackResponse'{_usrsStackId
                                                :: !(Maybe Text),
...
updateStackResponse pResponseStatus_
  = UpdateStackResponse'{_usrsStackId = Nothing,
