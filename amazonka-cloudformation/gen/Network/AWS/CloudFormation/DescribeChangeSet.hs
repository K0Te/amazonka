...
data DescribeChangeSetResponse = DescribeChangeSetResponse'{_dcscrsCreationTime
                                                            :: !(Maybe ISO8601),
...
describeChangeSetResponse pResponseStatus_ pStatus_
  = DescribeChangeSetResponse'{_dcscrsCreationTime =
                                 Nothing,
