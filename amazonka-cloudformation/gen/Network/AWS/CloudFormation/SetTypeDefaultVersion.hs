...
data SetTypeDefaultVersion = SetTypeDefaultVersion'{_stdvVersionId
                                                    :: !(Maybe Text),
                                                    _stdvTypeName ::
                                                    !(Maybe Text),
                                                    _stdvARN :: !(Maybe Text),
...
setTypeDefaultVersion
    :: SetTypeDefaultVersion
setTypeDefaultVersion
  = SetTypeDefaultVersion'{_stdvVersionId = Nothing,
                           _stdvTypeName = Nothing, _stdvARN = Nothing,
                           _stdvType = Nothing}
...
newtype SetTypeDefaultVersionResponse = SetTypeDefaultVersionResponse'{_stdvrsResponseStatus
                                                                       :: Int}
...
setTypeDefaultVersionResponse pResponseStatus_
  = SetTypeDefaultVersionResponse'{_stdvrsResponseStatus
                                     = pResponseStatus_}
