...
data ListTypeRegistrations = ListTypeRegistrations'{_ltrTypeName
                                                    :: !(Maybe Text),
...
listTypeRegistrations
    :: ListTypeRegistrations
listTypeRegistrations
  = ListTypeRegistrations'{_ltrTypeName = Nothing,
                           _ltrRegistrationStatusFilter = Nothing,
                           _ltrNextToken = Nothing, _ltrTypeARN = Nothing,
                           _ltrType = Nothing, _ltrMaxResults = Nothing}
...
data ListTypeRegistrationsResponse = ListTypeRegistrationsResponse'{_ltrrsRegistrationTokenList
                                                                    ::
                                                                    !(Maybe
                                                                        [Text]),
                                                                    _ltrrsNextToken
...
listTypeRegistrationsResponse pResponseStatus_
  = ListTypeRegistrationsResponse'{_ltrrsRegistrationTokenList
                                     = Nothing,
