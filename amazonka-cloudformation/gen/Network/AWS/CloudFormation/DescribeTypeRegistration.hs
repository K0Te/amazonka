...
newtype DescribeTypeRegistration = DescribeTypeRegistration'{_dtrRegistrationToken
                                                             :: Text}
...
describeTypeRegistration pRegistrationToken_
  = DescribeTypeRegistration'{_dtrRegistrationToken =
                                pRegistrationToken_}
...
data DescribeTypeRegistrationResponse = DescribeTypeRegistrationResponse'{_dtrrsTypeVersionARN
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
describeTypeRegistrationResponse pResponseStatus_
  = DescribeTypeRegistrationResponse'{_dtrrsTypeVersionARN
                                        = Nothing,
