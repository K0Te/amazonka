...
data ListTypes = ListTypes'{_ltVisibility ::
                            !(Maybe Visibility),
...
listTypes
    :: ListTypes
listTypes
  = ListTypes'{_ltVisibility = Nothing,
               _ltNextToken = Nothing,
               _ltDeprecatedStatus = Nothing, _ltType = Nothing,
        ...
        toQuery ListTypes'{..}
          = mconcat
              ["Action" =: ("ListTypes" :: ByteString),
               ...
               "Type" =: _ltType, "MaxResults" =: _ltMaxResults,
               "ProvisioningType" =: _ltProvisioningType]

-- | /See:/ 'listTypesResponse' smart constructor.
data ListTypesResponse = ListTypesResponse'{_ltrsTypeSummaries
                                            :: !(Maybe [TypeSummary]),
...
listTypesResponse pResponseStatus_
  = ListTypesResponse'{_ltrsTypeSummaries = Nothing,
