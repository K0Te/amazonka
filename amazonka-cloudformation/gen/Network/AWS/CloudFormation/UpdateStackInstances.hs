...
data UpdateStackInstances = UpdateStackInstances'{_usiAccounts
                                                  :: !(Maybe [Text]),
...
updateStackInstances pStackSetName_
  = UpdateStackInstances'{_usiAccounts = Nothing,
...
data UpdateStackInstancesResponse = UpdateStackInstancesResponse'{_usirsOperationId
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _usirsResponseStatus
                                                                  :: !Int}
...
updateStackInstancesResponse pResponseStatus_
  = UpdateStackInstancesResponse'{_usirsOperationId =
                                    Nothing,
