...
data ListTypeVersions = ListTypeVersions'{_ltvTypeName
                                          :: !(Maybe Text),
                                          _ltvARN :: !(Maybe Text),
...
listTypeVersions
    :: ListTypeVersions
listTypeVersions
  = ListTypeVersions'{_ltvTypeName = Nothing,
                      _ltvARN = Nothing, _ltvNextToken = Nothing,
                      _ltvDeprecatedStatus = Nothing, _ltvType = Nothing,
...
data ListTypeVersionsResponse = ListTypeVersionsResponse'{_ltvrsNextToken
                                                          :: !(Maybe Text),
...
listTypeVersionsResponse pResponseStatus_
  = ListTypeVersionsResponse'{_ltvrsNextToken =
                                Nothing,
