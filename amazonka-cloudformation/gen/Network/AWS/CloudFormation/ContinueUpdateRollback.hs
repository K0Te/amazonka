...
data ContinueUpdateRollback = ContinueUpdateRollback'{_curResourcesToSkip
                                                      :: !(Maybe [Text]),
...
continueUpdateRollback pStackName_
  = ContinueUpdateRollback'{_curResourcesToSkip =
                              Nothing,
                            _curClientRequestToken = Nothing,
                            _curRoleARN = Nothing, _curStackName = pStackName_}
...
newtype ContinueUpdateRollbackResponse = ContinueUpdateRollbackResponse'{_currsResponseStatus
                                                                         :: Int}
...
continueUpdateRollbackResponse pResponseStatus_
  = ContinueUpdateRollbackResponse'{_currsResponseStatus
                                      = pResponseStatus_}
