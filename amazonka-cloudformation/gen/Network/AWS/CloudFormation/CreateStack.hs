...
data CreateStack = CreateStack'{_csDisableRollback ::
                                !(Maybe Bool),
...
createStack pStackName_
  = CreateStack'{_csDisableRollback = Nothing,
                 _csNotificationARNs = Nothing,
                 _csEnableTerminationProtection = Nothing,
                 _csStackPolicyBody = Nothing,
                 _csParameters = Nothing, _csStackPolicyURL = Nothing,
                 _csTemplateBody = Nothing, _csTemplateURL = Nothing,
                 _csClientRequestToken = Nothing,
                 _csCapabilities = Nothing,
                 _csRollbackConfiguration = Nothing,
                 _csOnFailure = Nothing, _csResourceTypes = Nothing,
                 _csTags = Nothing, _csTimeoutInMinutes = Nothing,
                 _csRoleARN = Nothing, _csStackName = pStackName_}
...
data CreateStackResponse = CreateStackResponse'{_csrsStackId
                                                :: !(Maybe Text),
...
createStackResponse pResponseStatus_
  = CreateStackResponse'{_csrsStackId = Nothing,
