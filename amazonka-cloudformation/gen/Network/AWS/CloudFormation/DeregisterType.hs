...
data DeregisterType = DeregisterType'{_dVersionId ::
                                      !(Maybe Text),
...
deregisterType
    :: DeregisterType
deregisterType
  = DeregisterType'{_dVersionId = Nothing,
                    _dTypeName = Nothing, _dARN = Nothing,
                    _dType = Nothing}
...
newtype DeregisterTypeResponse = DeregisterTypeResponse'{_dtrsResponseStatus
                                                         :: Int}
...
deregisterTypeResponse pResponseStatus_
  = DeregisterTypeResponse'{_dtrsResponseStatus =
                              pResponseStatus_}
