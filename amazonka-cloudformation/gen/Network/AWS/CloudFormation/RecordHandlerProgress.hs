...
data RecordHandlerProgress = RecordHandlerProgress'{_rhpResourceModel
                                                    :: !(Maybe Text),
                                                    _rhpStatusMessage ::
                                                    !(Maybe Text),
                                                    _rhpErrorCode ::
...
recordHandlerProgress pBearerToken_ pOperationStatus_
  = RecordHandlerProgress'{_rhpResourceModel = Nothing,
                           _rhpStatusMessage = Nothing, _rhpErrorCode = Nothing,
...
newtype RecordHandlerProgressResponse = RecordHandlerProgressResponse'{_rhprsResponseStatus
                                                                       :: Int}
...
recordHandlerProgressResponse pResponseStatus_
  = RecordHandlerProgressResponse'{_rhprsResponseStatus
                                     = pResponseStatus_}
