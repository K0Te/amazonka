...
data UpdateStackSet = UpdateStackSet'{_ussAdministrationRoleARN
                                      :: !(Maybe Text),
...
updateStackSet pStackSetName_
  = UpdateStackSet'{_ussAdministrationRoleARN =
                      Nothing,
                    _ussUsePreviousTemplate = Nothing,
                    _ussAccounts = Nothing, _ussRegions = Nothing,
                    ...
                    _ussCapabilities = Nothing, _ussTags = Nothing,
...
data UpdateStackSetResponse = UpdateStackSetResponse'{_ussrsOperationId
                                                      :: !(Maybe Text),
...
updateStackSetResponse pResponseStatus_
  = UpdateStackSetResponse'{_ussrsOperationId =
                              Nothing,
