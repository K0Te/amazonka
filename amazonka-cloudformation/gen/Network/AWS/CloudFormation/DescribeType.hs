...
data DescribeTypeResponse = DescribeTypeResponse'{_dttrsLastUpdated
                                                  :: !(Maybe ISO8601),
                                                  _dttrsTypeName ::
                                                  !(Maybe Text),
                                                  _dttrsARN :: !(Maybe Text),
                                                  _dttrsExecutionRoleARN ::
                                                  !(Maybe Text),
                                                  _dttrsVisibility ::
                                                  !(Maybe Visibility),
                                                  _dttrsSchema :: !(Maybe Text),
                                                  _dttrsDefaultVersionId ::
                                                  !(Maybe Text),
                                                  ...
                                                  _dttrsType ::
                                                  !(Maybe RegistryType),
                                                  _dttrsIsDefaultVersion ::
                                                  !(Maybe Bool),
                                                  _dttrsDescription ::
                                                  !(Maybe Text),
                                                  _dttrsSourceURL ::
                                                  !(Maybe Text),
                                                  _dttrsDocumentationURL ::
                                                  !(Maybe Text),
...
describeTypeResponse pResponseStatus_
  = DescribeTypeResponse'{_dttrsLastUpdated = Nothing,
                          _dttrsTypeName = Nothing, _dttrsARN = Nothing,
                          _dttrsExecutionRoleARN = Nothing,
                          _dttrsVisibility = Nothing, _dttrsSchema = Nothing,
                          _dttrsDefaultVersionId = Nothing,
                          _dttrsDeprecatedStatus = Nothing,
                          _dttrsTimeCreated = Nothing, _dttrsType = Nothing,
