...
data DetectStackDrift = DetectStackDrift'{_dsdLogicalResourceIds
                                          :: !(Maybe (List1 Text)),
                                          _dsdStackName :: !Text}
...
detectStackDrift pStackName_
  = DetectStackDrift'{_dsdLogicalResourceIds = Nothing,
...
data DetectStackDriftResponse = DetectStackDriftResponse'{_dsdrsResponseStatus
                                                          :: !Int,
                                                          _dsdrsStackDriftDetectionId
                                                          :: !Text}
...
detectStackDriftResponse
    ...
    -> DetectStackDriftResponse
detectStackDriftResponse pResponseStatus_
  pStackDriftDetectionId_
  = DetectStackDriftResponse'{_dsdrsResponseStatus =
                                pResponseStatus_,
                              _dsdrsStackDriftDetectionId =
                                pStackDriftDetectionId_}
