...
data RegisterType = RegisterType'{_rExecutionRoleARN
                                  :: !(Maybe Text),
...
registerType pTypeName_ pSchemaHandlerPackage_
  = RegisterType'{_rExecutionRoleARN = Nothing,
                  _rType = Nothing, _rClientRequestToken = Nothing,
                  _rLoggingConfig = Nothing, _rTypeName = pTypeName_,
...
data RegisterTypeResponse = RegisterTypeResponse'{_rtrsRegistrationToken
                                                  :: !(Maybe Text),
...
registerTypeResponse pResponseStatus_
  = RegisterTypeResponse'{_rtrsRegistrationToken =
                            Nothing,
