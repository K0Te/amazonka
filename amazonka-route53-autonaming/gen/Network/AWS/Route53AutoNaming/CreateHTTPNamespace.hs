...
data CreateHTTPNamespace = CreateHTTPNamespace'{_chttpnCreatorRequestId
                                                :: !(Maybe Text),
                                                _chttpnDescription ::
                                                !(Maybe Text),
...
createHTTPNamespace pName_
  = CreateHTTPNamespace'{_chttpnCreatorRequestId =
                           Nothing,
                         _chttpnDescription = Nothing, _chttpnTags = Nothing,
                         _chttpnName = pName_}
...
data CreateHTTPNamespaceResponse = CreateHTTPNamespaceResponse'{_chttpnrsOperationId
                                                                ::
                                                                !(Maybe Text),
                                                                _chttpnrsResponseStatus
                                                                :: !Int}
...
createHTTPNamespaceResponse pResponseStatus_
  = CreateHTTPNamespaceResponse'{_chttpnrsOperationId =
                                   Nothing,
