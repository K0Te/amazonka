...
data DiscoverInstances = DiscoverInstances'{_diQueryParameters
                                            :: !(Maybe (Map Text Text)),
...
discoverInstances pNamespaceName_ pServiceName_
  = DiscoverInstances'{_diQueryParameters = Nothing,
                       _diOptionalParameters = Nothing,
                       _diHealthStatus = Nothing, _diMaxResults = Nothing,
...
data DiscoverInstancesResponse = DiscoverInstancesResponse'{_dirsInstances
                                                            ::
                                                            !(Maybe
                                                                [HTTPInstanceSummary]),
                                                            _dirsResponseStatus
...
discoverInstancesResponse pResponseStatus_
  = DiscoverInstancesResponse'{_dirsInstances =
                                 Nothing,
