...
data UpdateMailboxQuota = UpdateMailboxQuota'{_umqOrganizationId
                                              :: !Text,
                                              _umqUserId :: !Text,
...
updateMailboxQuota
    :: Text -- ^ 'umqOrganizationId'
    -> Text -- ^ 'umqUserId'
    -> Natural -- ^ 'umqMailboxQuota'
    -> UpdateMailboxQuota
updateMailboxQuota pOrganizationId_ pUserId_
  pMailboxQuota_
  = UpdateMailboxQuota'{_umqOrganizationId =
                          pOrganizationId_,
                        _umqUserId = pUserId_,
...
instance Hashable UpdateMailboxQuota where

instance NFData UpdateMailboxQuota where
...
newtype UpdateMailboxQuotaResponse = UpdateMailboxQuotaResponse'{_umqrsResponseStatus
                                                                 :: Int}
...
updateMailboxQuotaResponse
    :: Int -- ^ 'umqrsResponseStatus'
    -> UpdateMailboxQuotaResponse
updateMailboxQuotaResponse pResponseStatus_
  = UpdateMailboxQuotaResponse'{_umqrsResponseStatus =
                                  pResponseStatus_}
...
instance NFData UpdateMailboxQuotaResponse where
