...
data DeleteAccessControlRule = DeleteAccessControlRule'{_dacrOrganizationId
                                                        :: !Text,
                                                        _dacrName :: !Text}
...
deleteAccessControlRule
    :: Text -- ^ 'dacrOrganizationId'
    -> Text -- ^ 'dacrName'
    -> DeleteAccessControlRule
deleteAccessControlRule pOrganizationId_ pName_
  = DeleteAccessControlRule'{_dacrOrganizationId =
                               pOrganizationId_,
                             _dacrName = pName_}
...
instance AWSRequest DeleteAccessControlRule where
        type Rs DeleteAccessControlRule =
             DeleteAccessControlRuleResponse
...
instance Hashable DeleteAccessControlRule where

instance NFData DeleteAccessControlRule where
...
newtype DeleteAccessControlRuleResponse = DeleteAccessControlRuleResponse'{_dacrrsResponseStatus
                                                                           ::
                                                                           Int}
...
deleteAccessControlRuleResponse
    :: Int -- ^ 'dacrrsResponseStatus'
    -> DeleteAccessControlRuleResponse
deleteAccessControlRuleResponse pResponseStatus_
  = DeleteAccessControlRuleResponse'{_dacrrsResponseStatus
                                       = pResponseStatus_}
...
instance NFData DeleteAccessControlRuleResponse where
