...
data DescribeMailboxExportJob = DescribeMailboxExportJob'{_dmejJobId
                                                          :: !Text,
                                                          _dmejOrganizationId ::
                                                          !Text}
...
describeMailboxExportJob
    :: Text -- ^ 'dmejJobId'
    -> Text -- ^ 'dmejOrganizationId'
    -> DescribeMailboxExportJob
describeMailboxExportJob pJobId_ pOrganizationId_
  = DescribeMailboxExportJob'{_dmejJobId = pJobId_,
...
instance AWSRequest DescribeMailboxExportJob where
        type Rs DescribeMailboxExportJob =
             DescribeMailboxExportJobResponse
...
instance Hashable DescribeMailboxExportJob where

instance NFData DescribeMailboxExportJob where
...
data DescribeMailboxExportJobResponse = DescribeMailboxExportJobResponse'{_dmejrsState
                                                                          ::
                                                                          !(Maybe
...
describeMailboxExportJobResponse
    :: Int -- ^ 'dmejrsResponseStatus'
    -> DescribeMailboxExportJobResponse
describeMailboxExportJobResponse pResponseStatus_
  = DescribeMailboxExportJobResponse'{_dmejrsState =
                                        Nothing,
