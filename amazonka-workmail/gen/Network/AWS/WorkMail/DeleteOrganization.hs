...
data DeleteOrganization = DeleteOrganization'{_doClientToken
                                              :: !(Maybe Text),
...
deleteOrganization
    ...
    -> Bool -- ^ 'doDeleteDirectory'
    -> DeleteOrganization
deleteOrganization pOrganizationId_ pDeleteDirectory_
  = DeleteOrganization'{_doClientToken = Nothing,
...
data DeleteOrganizationResponse = DeleteOrganizationResponse'{_delrsState
                                                              :: !(Maybe Text),
                                                              _delrsOrganizationId
                                                              :: !(Maybe Text),
...
deleteOrganizationResponse pResponseStatus_
  = DeleteOrganizationResponse'{_delrsState = Nothing,
