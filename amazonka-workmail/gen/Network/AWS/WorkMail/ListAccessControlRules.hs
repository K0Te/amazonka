...
newtype ListAccessControlRules = ListAccessControlRules'{_lacrOrganizationId
                                                         :: Text}
...
listAccessControlRules
    :: Text -- ^ 'lacrOrganizationId'
    -> ListAccessControlRules
listAccessControlRules pOrganizationId_
  = ListAccessControlRules'{_lacrOrganizationId =
                              pOrganizationId_}
...
instance AWSRequest ListAccessControlRules where
        type Rs ListAccessControlRules =
             ListAccessControlRulesResponse
...
instance Hashable ListAccessControlRules where

instance NFData ListAccessControlRules where
...
data ListAccessControlRulesResponse = ListAccessControlRulesResponse'{_lacrrsRules
                                                                      ::
                                                                      !(Maybe
                                                                          [AccessControlRule]),
                                                                      _lacrrsResponseStatus
                                                                      :: !Int}
...
listAccessControlRulesResponse
    :: Int -- ^ 'lacrrsResponseStatus'
    -> ListAccessControlRulesResponse
listAccessControlRulesResponse pResponseStatus_
  = ListAccessControlRulesResponse'{_lacrrsRules =
                                      Nothing,
...
instance NFData ListAccessControlRulesResponse where
