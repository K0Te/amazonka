...
data GetAccessControlEffect = GetAccessControlEffect'{_gaceOrganizationId
                                                      :: !Text,
                                                      _gaceIPAddress :: !Text,
                                                      _gaceAction :: !Text,
                                                      _gaceUserId :: !Text}
...
getAccessControlEffect
    :: Text -- ^ 'gaceOrganizationId'
    -> Text -- ^ 'gaceIPAddress'
    -> Text -- ^ 'gaceAction'
    -> Text -- ^ 'gaceUserId'
    -> GetAccessControlEffect
getAccessControlEffect pOrganizationId_ pIPAddress_
  pAction_ pUserId_
  = GetAccessControlEffect'{_gaceOrganizationId =
                              pOrganizationId_,
                            _gaceIPAddress = pIPAddress_,
                            _gaceAction = pAction_, _gaceUserId = pUserId_}
...
instance AWSRequest GetAccessControlEffect where
        type Rs GetAccessControlEffect =
             GetAccessControlEffectResponse
...
instance Hashable GetAccessControlEffect where

instance NFData GetAccessControlEffect where
...
data GetAccessControlEffectResponse = GetAccessControlEffectResponse'{_gacersEffect
                                                                      ::
                                                                      !(Maybe
...
getAccessControlEffectResponse
    :: Int -- ^ 'gacersResponseStatus'
    -> GetAccessControlEffectResponse
getAccessControlEffectResponse pResponseStatus_
  = GetAccessControlEffectResponse'{_gacersEffect =
                                      Nothing,
...
instance NFData GetAccessControlEffectResponse where
