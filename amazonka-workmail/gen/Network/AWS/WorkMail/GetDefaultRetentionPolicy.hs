...
newtype GetDefaultRetentionPolicy = GetDefaultRetentionPolicy'{_gdrpOrganizationId
                                                               :: Text}
...
getDefaultRetentionPolicy
    :: Text -- ^ 'gdrpOrganizationId'
    -> GetDefaultRetentionPolicy
getDefaultRetentionPolicy pOrganizationId_
  = GetDefaultRetentionPolicy'{_gdrpOrganizationId =
                                 pOrganizationId_}
...
instance Hashable GetDefaultRetentionPolicy where

instance NFData GetDefaultRetentionPolicy where
...
data GetDefaultRetentionPolicyResponse = GetDefaultRetentionPolicyResponse'{_gdrprsName
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _gdrprsId
...
getDefaultRetentionPolicyResponse pResponseStatus_
  = GetDefaultRetentionPolicyResponse'{_gdrprsName =
                                         Nothing,
                                       _gdrprsId = Nothing,
