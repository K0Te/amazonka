...
data MailboxExportJob = MailboxExportJob'{_mejState
...
mailboxExportJob
    :: MailboxExportJob
mailboxExportJob
  = MailboxExportJob'{_mejState = Nothing,
                      _mejJobId = Nothing, _mejStartTime = Nothing,
                      _mejEstimatedProgress = Nothing,
                      _mejEndTime = Nothing, _mejS3Path = Nothing,
                      _mejEntityId = Nothing, _mejDescription = Nothing,
...
instance Hashable MailboxExportJob where

instance NFData MailboxExportJob where
