...
data ListMailboxExportJobs = ListMailboxExportJobs'{_lmejNextToken
                                                    :: !(Maybe Text),
                                                    _lmejMaxResults ::
                                                    !(Maybe Nat),
                                                    _lmejOrganizationId ::
...
listMailboxExportJobs
    :: Text -- ^ 'lmejOrganizationId'
    -> ListMailboxExportJobs
listMailboxExportJobs pOrganizationId_
  = ListMailboxExportJobs'{_lmejNextToken = Nothing,
...
instance Hashable ListMailboxExportJobs where

instance NFData ListMailboxExportJobs where
...
data ListMailboxExportJobsResponse = ListMailboxExportJobsResponse'{_lmejrsNextToken
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _lmejrsJobs
...
listMailboxExportJobsResponse
    :: Int -- ^ 'lmejrsResponseStatus'
    -> ListMailboxExportJobsResponse
listMailboxExportJobsResponse pResponseStatus_
  = ListMailboxExportJobsResponse'{_lmejrsNextToken =
                                     Nothing,
                                   _lmejrsJobs = Nothing,
...
instance NFData ListMailboxExportJobsResponse where
