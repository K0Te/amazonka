...
data CreateOrganization = CreateOrganization'{_coDirectoryId
                                              :: !(Maybe Text),
...
createOrganization pAlias_
  = CreateOrganization'{_coDirectoryId = Nothing,
                        _coEnableInteroperability = Nothing,
                        _coKMSKeyARN = Nothing, _coClientToken = Nothing,
                        _coDomains = Nothing, _coAlias = pAlias_}
...
data CreateOrganizationResponse = CreateOrganizationResponse'{_corsOrganizationId
                                                              :: !(Maybe Text),
                                                              _corsResponseStatus
                                                              :: !Int}
...
createOrganizationResponse pResponseStatus_
  = CreateOrganizationResponse'{_corsOrganizationId =
                                  Nothing,
