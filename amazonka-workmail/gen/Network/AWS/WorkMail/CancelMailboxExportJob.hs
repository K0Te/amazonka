...
data CancelMailboxExportJob = CancelMailboxExportJob'{_cmejClientToken
                                                      :: !Text,
                                                      _cmejJobId :: !Text,
                                                      _cmejOrganizationId ::
                                                      !Text}
...
cancelMailboxExportJob
    :: Text -- ^ 'cmejClientToken'
    -> Text -- ^ 'cmejJobId'
    -> Text -- ^ 'cmejOrganizationId'
    -> CancelMailboxExportJob
cancelMailboxExportJob pClientToken_ pJobId_
  pOrganizationId_
  = CancelMailboxExportJob'{_cmejClientToken =
                              pClientToken_,
                            _cmejJobId = pJobId_,
...
instance AWSRequest CancelMailboxExportJob where
        type Rs CancelMailboxExportJob =
             CancelMailboxExportJobResponse
...
instance Hashable CancelMailboxExportJob where

instance NFData CancelMailboxExportJob where
...
newtype CancelMailboxExportJobResponse = CancelMailboxExportJobResponse'{_cmejrsResponseStatus
                                                                         :: Int}
...
cancelMailboxExportJobResponse
    :: Int -- ^ 'cmejrsResponseStatus'
    -> CancelMailboxExportJobResponse
cancelMailboxExportJobResponse pResponseStatus_
  = CancelMailboxExportJobResponse'{_cmejrsResponseStatus
                                      = pResponseStatus_}
...
instance NFData CancelMailboxExportJobResponse where
