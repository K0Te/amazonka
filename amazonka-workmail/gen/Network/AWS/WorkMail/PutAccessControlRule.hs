...
data PutAccessControlRule = PutAccessControlRule'{_pacrUserIds
                                                  :: !(Maybe [Text]),
                                                  _pacrActions ::
                                                  !(Maybe [Text]),
                                                  _pacrNotUserIds ::
...
putAccessControlRule
    :: Text -- ^ 'pacrName'
    -> AccessControlRuleEffect -- ^ 'pacrEffect'
    -> Text -- ^ 'pacrDescription'
    -> Text -- ^ 'pacrOrganizationId'
    -> PutAccessControlRule
putAccessControlRule pName_ pEffect_ pDescription_
  pOrganizationId_
  = PutAccessControlRule'{_pacrUserIds = Nothing,
                          _pacrActions = Nothing, _pacrNotUserIds = Nothing,
                          _pacrIPRanges = Nothing, _pacrNotIPRanges = Nothing,
                          _pacrNotActions = Nothing, _pacrName = pName_,
...
instance Hashable PutAccessControlRule where

instance NFData PutAccessControlRule where
...
newtype PutAccessControlRuleResponse = PutAccessControlRuleResponse'{_pacrrsResponseStatus
                                                                     :: Int}
...
putAccessControlRuleResponse
    :: Int -- ^ 'pacrrsResponseStatus'
    -> PutAccessControlRuleResponse
putAccessControlRuleResponse pResponseStatus_
  = PutAccessControlRuleResponse'{_pacrrsResponseStatus
                                    = pResponseStatus_}
...
instance NFData PutAccessControlRuleResponse where
