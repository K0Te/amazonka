...
data PutRetentionPolicy = PutRetentionPolicy'{_prpId
                                              :: !(Maybe Text),
                                              _prpDescription ::
...
putRetentionPolicy
    :: Text -- ^ 'prpOrganizationId'
    -> Text -- ^ 'prpName'
    -> PutRetentionPolicy
putRetentionPolicy pOrganizationId_ pName_
  = PutRetentionPolicy'{_prpId = Nothing,
                        _prpDescription = Nothing,
                        _prpOrganizationId = pOrganizationId_,
                        _prpName = pName_, _prpFolderConfigurations = mempty}
...
newtype PutRetentionPolicyResponse = PutRetentionPolicyResponse'{_prprsResponseStatus
                                                                 :: Int}
...
putRetentionPolicyResponse pResponseStatus_
  = PutRetentionPolicyResponse'{_prprsResponseStatus =
                                  pResponseStatus_}
