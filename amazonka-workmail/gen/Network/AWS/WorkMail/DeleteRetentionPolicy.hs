...
data DeleteRetentionPolicy = DeleteRetentionPolicy'{_drpOrganizationId
                                                    :: !Text,
                                                    _drpId :: !Text}
...
deleteRetentionPolicy
    :: Text -- ^ 'drpOrganizationId'
    -> Text -- ^ 'drpId'
    -> DeleteRetentionPolicy
deleteRetentionPolicy pOrganizationId_ pId_
  = DeleteRetentionPolicy'{_drpOrganizationId =
                             pOrganizationId_,
                           _drpId = pId_}
...
newtype DeleteRetentionPolicyResponse = DeleteRetentionPolicyResponse'{_drprsResponseStatus
                                                                       :: Int}
...
deleteRetentionPolicyResponse pResponseStatus_
  = DeleteRetentionPolicyResponse'{_drprsResponseStatus
                                     = pResponseStatus_}
