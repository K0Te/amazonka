...
data ModifyBackupAttributes = ModifyBackupAttributes'{_mbaBackupId
                                                      :: !Text,
...
modifyBackupAttributes
    :: Text -- ^ 'mbaBackupId'
    -> Bool -- ^ 'mbaNeverExpires'
    -> ModifyBackupAttributes
modifyBackupAttributes pBackupId_ pNeverExpires_
  = ModifyBackupAttributes'{_mbaBackupId = pBackupId_,
...
instance AWSRequest ModifyBackupAttributes where
        type Rs ModifyBackupAttributes =
             ModifyBackupAttributesResponse
...
instance Hashable ModifyBackupAttributes where

instance NFData ModifyBackupAttributes where
...
data ModifyBackupAttributesResponse = ModifyBackupAttributesResponse'{_mbarsBackup
                                                                      ::
                                                                      !(Maybe
                                                                          Backup),
                                                                      _mbarsResponseStatus
                                                                      :: !Int}
...
modifyBackupAttributesResponse
    :: Int -- ^ 'mbarsResponseStatus'
    -> ModifyBackupAttributesResponse
modifyBackupAttributesResponse pResponseStatus_
  = ModifyBackupAttributesResponse'{_mbarsBackup =
                                      Nothing,
...
instance NFData ModifyBackupAttributesResponse where
