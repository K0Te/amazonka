...
data BackupRetentionPolicy = BackupRetentionPolicy'{_brpValue
                                                    :: !(Maybe Text),
                                                    _brpType ::
                                                    !(Maybe
                                                        BackupRetentionType)}
...
backupRetentionPolicy
    :: BackupRetentionPolicy
backupRetentionPolicy
  = BackupRetentionPolicy'{_brpValue = Nothing,
                           _brpType = Nothing}
...
instance FromJSON BackupRetentionPolicy where
        parseJSON
          = withObject "BackupRetentionPolicy"
              (\ x ->
                 BackupRetentionPolicy' <$>
                   (x .:? "Value") <*> (x .:? "Type"))

instance Hashable BackupRetentionPolicy where

instance NFData BackupRetentionPolicy where
