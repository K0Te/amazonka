...
data Cluster = Cluster'{_cPreCoPassword ::
                        !(Maybe Text),
                        ...
                        _cHSMs :: !(Maybe [HSM]), _cVPCId :: !(Maybe Text),
                        _cTagList :: !(Maybe [Tag]),
...
cluster
    :: Cluster
cluster
  = Cluster'{_cPreCoPassword = Nothing,
             _cStateMessage = Nothing, _cState = Nothing,
             _cSubnetMapping = Nothing,
             _cBackupRetentionPolicy = Nothing, _cHSMs = Nothing,
             _cVPCId = Nothing, _cTagList = Nothing,
             _cSourceBackupId = Nothing, _cCertificates = Nothing,
             _cSecurityGroup = Nothing, _cClusterId = Nothing,
             _cCreateTimestamp = Nothing,
             _cBackupPolicy = Nothing, _cHSMType = Nothing}
