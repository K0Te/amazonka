...
newtype DeleteResourcesByExternalId = DeleteResourcesByExternalId'{_drbeiExternalId
                                                                   ::
                                                                   Maybe Text}
...
deleteResourcesByExternalId
    :: DeleteResourcesByExternalId
deleteResourcesByExternalId
  = DeleteResourcesByExternalId'{_drbeiExternalId =
                                   Nothing}
...
instance Hashable DeleteResourcesByExternalId where

instance NFData DeleteResourcesByExternalId where
...
newtype DeleteResourcesByExternalIdResponse = DeleteResourcesByExternalIdResponse'{_drbeirsResponseStatus
                                                                                   ::
                                                                                   Int}
                                                deriving (Eq, Read, Show, Data,
                                                          Typeable, Generic)
...
deleteResourcesByExternalIdResponse
    :: Int -- ^ 'drbeirsResponseStatus'
    -> DeleteResourcesByExternalIdResponse
deleteResourcesByExternalIdResponse pResponseStatus_
  = DeleteResourcesByExternalIdResponse'{_drbeirsResponseStatus
                                           = pResponseStatus_}
