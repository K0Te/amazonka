...
data CloudFormationTarget = CloudFormationTarget'{_cftTargetId
                                                  :: !(Maybe Text),
                                                  _cftStatus ::
                                                  !(Maybe TargetStatus),
                                                  _cftDeploymentId ::
...
cloudFormationTarget
    :: CloudFormationTarget
cloudFormationTarget
  = CloudFormationTarget'{_cftTargetId = Nothing,
                          _cftStatus = Nothing, _cftDeploymentId = Nothing,
...
instance FromJSON CloudFormationTarget where
        parseJSON
          = withObject "CloudFormationTarget"
              (\ x ->
                 CloudFormationTarget' <$>
                   (x .:? "targetId") <*> (x .:? "status") <*>
                     (x .:? "deploymentId")
...
instance Hashable CloudFormationTarget where

instance NFData CloudFormationTarget where
