...
data ScalableTarget = ScalableTarget'{_stSuspendedState
...
scalableTarget
    ...
    -> ScalableTarget
scalableTarget pServiceNamespace_ pResourceId_
  pScalableDimension_ pMinCapacity_ pMaxCapacity_
  pRoleARN_ pCreationTime_
  = ScalableTarget'{_stSuspendedState = Nothing,
