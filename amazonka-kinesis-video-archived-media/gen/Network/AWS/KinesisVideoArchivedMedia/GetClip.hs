...
data GetClip = GetClip'{_gcStreamARN ::
                        !(Maybe Text),
...
getClip
    :: ClipFragmentSelector -- ^ 'gcClipFragmentSelector'
    -> GetClip
getClip pClipFragmentSelector_
  = GetClip'{_gcStreamARN = Nothing,
...
instance Hashable GetClip where

instance NFData GetClip where
...
data GetClipResponse = GetClipResponse'{_gcrsContentType
                                        :: !(Maybe Text),
...
getClipResponse pResponseStatus_ pPayload_
  = GetClipResponse'{_gcrsContentType = Nothing,
