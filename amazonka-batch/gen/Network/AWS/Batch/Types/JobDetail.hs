...
jobDetail
    ...
    -> JobDetail
jobDetail pJobName_ pJobId_ pJobQueue_ pStatus_
  pJobDefinition_
  = JobDetail'{_jdStoppedAt = Nothing,
               _jdJobARN = Nothing, _jdPropagateTags = Nothing,
               _jdCreatedAt = Nothing, _jdRetryStrategy = Nothing,
               _jdAttempts = Nothing,
               _jdPlatformCapabilities = Nothing,
               _jdStartedAt = Nothing, _jdDependsOn = Nothing,
               _jdContainer = Nothing, _jdNodeDetails = Nothing,
               _jdParameters = Nothing, _jdStatusReason = Nothing,
               _jdArrayProperties = Nothing, _jdTimeout = Nothing,
               _jdNodeProperties = Nothing, _jdTags = Nothing,
               _jdJobName = pJobName_, _jdJobId = pJobId_,
               _jdJobQueue = pJobQueue_, _jdStatus = pStatus_,
