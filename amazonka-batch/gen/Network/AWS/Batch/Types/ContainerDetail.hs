...
containerDetail
  = ContainerDetail'{_cdImage = Nothing,
                     _cdCommand = Nothing, _cdSecrets = Nothing,
                     ...
                     _cdUser = Nothing, _cdLogConfiguration = Nothing,
                     _cdLinuxParameters = Nothing, _cdReason = Nothing,
                     _cdLogStreamName = Nothing, _cdMountPoints = Nothing,
                     _cdExitCode = Nothing,
