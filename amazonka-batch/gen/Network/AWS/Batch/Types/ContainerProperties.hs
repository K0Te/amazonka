...
containerProperties
  = ContainerProperties'{_cpImage = Nothing,
                         _cpCommand = Nothing, _cpSecrets = Nothing,
                         _cpEnvironment = Nothing, _cpUlimits = Nothing,
                         _cpExecutionRoleARN = Nothing,
                         _cpPrivileged = Nothing, _cpJobRoleARN = Nothing,
                         _cpResourceRequirements = Nothing,
                         _cpInstanceType = Nothing, _cpMemory = Nothing,
                         _cpUser = Nothing, _cpLogConfiguration = Nothing,
