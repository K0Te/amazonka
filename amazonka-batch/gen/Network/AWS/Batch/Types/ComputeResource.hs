...
computeResource pType_ pMaxvCPUs_
  = ComputeResource'{_crSecurityGroupIds = Nothing,
                     _crInstanceTypes = Nothing,
                     _crInstanceRole = Nothing, _crEc2KeyPair = Nothing,
                     _crMinvCPUs = Nothing, _crEc2Configuration = Nothing,
                     _crBidPercentage = Nothing,
                     _crSpotIAMFleetRole = Nothing, _crImageId = Nothing,
                     _crLaunchTemplate = Nothing,
                     _crDesiredvCPUs = Nothing,
                     _crAllocationStrategy = Nothing,
                     _crPlacementGroup = Nothing, _crTags = Nothing,
                     _crType = pType_, _crMaxvCPUs = pMaxvCPUs_,
                     _crSubnets = mempty}
