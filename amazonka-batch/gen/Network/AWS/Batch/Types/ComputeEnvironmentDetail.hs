...
computeEnvironmentDetail
    ...
    -> ComputeEnvironmentDetail
computeEnvironmentDetail pComputeEnvironmentName_
  pComputeEnvironmentARN_ pEcsClusterARN_
  = ComputeEnvironmentDetail'{_cedStatus = Nothing,
                              _cedState = Nothing,
                              _cedComputeResources = Nothing,
                              _cedStatusReason = Nothing, _cedType = Nothing,
                              _cedServiceRole = Nothing, _cedTags = Nothing,
                              _cedComputeEnvironmentName =
