...
jobSummary pJobId_ pJobName_
  = JobSummary'{_jsStoppedAt = Nothing,
                _jsStatus = Nothing, _jsJobARN = Nothing,
                _jsCreatedAt = Nothing, _jsStartedAt = Nothing,
                _jsContainer = Nothing, _jsStatusReason = Nothing,
                _jsArrayProperties = Nothing,
                _jsNodeProperties = Nothing, _jsJobId = pJobId_,
