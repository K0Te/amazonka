...
jobDefinition pJobDefinitionName_ pJobDefinitionARN_
  ...
  = JobDefinition'{_jddStatus = Nothing,
                   ...
                   _jddNodeProperties = Nothing, _jddTags = Nothing,
...
jddPlatformCapabilities = lens _jddPlatformCapabilities (\ s a -> s{_jddPlatformCapabilities = a}) . _Default . _Coerce
