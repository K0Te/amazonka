...
data ListApplicationDependencies = ListApplicationDependencies'{_ladSemanticVersion
                                                                ::
                                                                !(Maybe Text),
                                                                _ladNextToken ::
                                                                !(Maybe Text),
...
listApplicationDependencies
    :: Text -- ^ 'ladApplicationId'
    -> ListApplicationDependencies
listApplicationDependencies pApplicationId_
  = ListApplicationDependencies'{_ladSemanticVersion =
                                   Nothing,
...
instance AWSPager ListApplicationDependencies where
        page rq rs
          ...
          | otherwise =
            Just $ rq & ladNextToken .~ rs ^. ladrsNextToken
...
instance Hashable ListApplicationDependencies where

instance NFData ListApplicationDependencies where
...
instance ToPath ListApplicationDependencies where
        toPath ListApplicationDependencies'{..}
          = mconcat
              ["/applications/", toBS _ladApplicationId,
               "/dependencies"]
...
data ListApplicationDependenciesResponse = ListApplicationDependenciesResponse'{_ladrsDependencies
                                                                                ::
                                                                                !(Maybe
...
listApplicationDependenciesResponse
    :: Int -- ^ 'ladrsResponseStatus'
    -> ListApplicationDependenciesResponse
listApplicationDependenciesResponse pResponseStatus_
  = ListApplicationDependenciesResponse'{_ladrsDependencies
                                           = Nothing,
