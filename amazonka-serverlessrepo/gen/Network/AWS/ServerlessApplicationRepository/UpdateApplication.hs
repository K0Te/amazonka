...
data UpdateApplication = UpdateApplication'{_uHomePageURL
                                            :: !(Maybe Text),
...
updateApplication pApplicationId_
  = UpdateApplication'{_uHomePageURL = Nothing,
                       _uReadmeBody = Nothing, _uReadmeURL = Nothing,
                       _uAuthor = Nothing, _uLabels = Nothing,
...
data UpdateApplicationResponse = UpdateApplicationResponse'{_uarsCreationTime
                                                            ...
                                                            _uarsLabels ::
                                                            !(Maybe [Text]),
                                                            _uarsVerifiedAuthorURL
                                                            :: !(Maybe Text),
                                                            _uarsDescription ::
                                                            !(Maybe Text),
                                                            _uarsSpdxLicenseId
                                                            :: !(Maybe Text),
                                                            _uarsIsVerifiedAuthor
                                                            :: !(Maybe Bool),
                                                            _uarsResponseStatus
                                                            :: !Int}
