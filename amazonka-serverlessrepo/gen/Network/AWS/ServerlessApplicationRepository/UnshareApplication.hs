...
data UnshareApplication = UnshareApplication'{_uaApplicationId
                                              :: !Text,
...
unshareApplication
    ...
    -> Text -- ^ 'uaOrganizationId'
    -> UnshareApplication
unshareApplication pApplicationId_ pOrganizationId_
  = UnshareApplication'{_uaApplicationId =
                          pApplicationId_,
...
instance AWSRequest UnshareApplication where
        type Rs UnshareApplication =
             UnshareApplicationResponse
        request = postJSON serverlessApplicationRepository
        response = receiveNull UnshareApplicationResponse'

instance Hashable UnshareApplication where

instance NFData UnshareApplication where
...
instance NFData UnshareApplicationResponse where
