...
createApplication pDescription_ pName_ pAuthor_
  = CreateApplication'{_caHomePageURL = Nothing,
                       ...
                       _caDescription = pDescription_, _caName = pName_,
                       _caAuthor = pAuthor_}
...
data CreateApplicationResponse = CreateApplicationResponse'{_carsCreationTime
                                                            ...
                                                            _carsLabels ::
                                                            !(Maybe [Text]),
                                                            _carsVerifiedAuthorURL
                                                            :: !(Maybe Text),
                                                            _carsDescription ::
                                                            !(Maybe Text),
                                                            _carsSpdxLicenseId
                                                            :: !(Maybe Text),
                                                            _carsIsVerifiedAuthor
                                                            :: !(Maybe Bool),
                                                            _carsResponseStatus
                                                            :: !Int}
...
--
-- * 'carsVerifiedAuthorURL' - The URL to the public profile of a verified author. This URL is submitted by the author.
--
...
--
-- * 'carsIsVerifiedAuthor' - Whether the author of this application has been verified. This means means that AWS has made a good faith review, as a reasonable and prudent service provider, of the information provided by the requester and has confirmed that the requester's identity is as claimed.
--
...
createApplicationResponse pResponseStatus_
  = CreateApplicationResponse'{_carsCreationTime =
                               ...
                               _carsVerifiedAuthorURL = Nothing,
                               _carsDescription = Nothing,
                               _carsSpdxLicenseId = Nothing,
                               _carsIsVerifiedAuthor = Nothing,
...
carsVerifiedAuthorURL :: Lens' CreateApplicationResponse (Maybe Text)
carsVerifiedAuthorURL = lens _carsVerifiedAuthorURL (\ s a -> s{_carsVerifiedAuthorURL = a})
...
carsIsVerifiedAuthor :: Lens' CreateApplicationResponse (Maybe Bool)
carsIsVerifiedAuthor = lens _carsIsVerifiedAuthor (\ s a -> s{_carsIsVerifiedAuthor = a})
