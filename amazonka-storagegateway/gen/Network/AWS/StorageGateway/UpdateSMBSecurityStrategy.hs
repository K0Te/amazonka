...
data UpdateSMBSecurityStrategy = UpdateSMBSecurityStrategy'{_usmbssGatewayARN
                                                            :: !Text,
...
updateSMBSecurityStrategy
    :: Text -- ^ 'usmbssGatewayARN'
    -> SMBSecurityStrategy -- ^ 'usmbssSMBSecurityStrategy'
    -> UpdateSMBSecurityStrategy
updateSMBSecurityStrategy pGatewayARN_
  pSMBSecurityStrategy_
  = UpdateSMBSecurityStrategy'{_usmbssGatewayARN =
                                 pGatewayARN_,
                               _usmbssSMBSecurityStrategy =
                                 pSMBSecurityStrategy_}
...
instance Hashable UpdateSMBSecurityStrategy where

instance NFData UpdateSMBSecurityStrategy where
...
data UpdateSMBSecurityStrategyResponse = UpdateSMBSecurityStrategyResponse'{_usmbssrsGatewayARN
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
updateSMBSecurityStrategyResponse
    :: Int -- ^ 'usmbssrsResponseStatus'
    -> UpdateSMBSecurityStrategyResponse
updateSMBSecurityStrategyResponse pResponseStatus_
  = UpdateSMBSecurityStrategyResponse'{_usmbssrsGatewayARN
                                         = Nothing,
                                       _usmbssrsResponseStatus =
                                         pResponseStatus_}
