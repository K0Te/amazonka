...
newtype DeleteAutomaticTapeCreationPolicy = DeleteAutomaticTapeCreationPolicy'{_datcpGatewayARN
                                                                               ::
                                                                               Text}
...
deleteAutomaticTapeCreationPolicy
    :: Text -- ^ 'datcpGatewayARN'
    -> DeleteAutomaticTapeCreationPolicy
deleteAutomaticTapeCreationPolicy pGatewayARN_
  = DeleteAutomaticTapeCreationPolicy'{_datcpGatewayARN
                                         = pGatewayARN_}
...
instance AWSRequest DeleteAutomaticTapeCreationPolicy
         where
...
instance ToHeaders DeleteAutomaticTapeCreationPolicy
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DeleteAutomaticTapeCreationPolicy
         where
        toJSON DeleteAutomaticTapeCreationPolicy'{..}
          = object
              (catMaybes [Just ("GatewayARN" .= _datcpGatewayARN)])

instance ToPath DeleteAutomaticTapeCreationPolicy
         where
        toPath = const "/"

instance ToQuery DeleteAutomaticTapeCreationPolicy
         where
        toQuery = const mempty

-- | /See:/ 'deleteAutomaticTapeCreationPolicyResponse' smart constructor.
data DeleteAutomaticTapeCreationPolicyResponse = DeleteAutomaticTapeCreationPolicyResponse'{_datcprsGatewayARN
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
...
deleteAutomaticTapeCreationPolicyResponse
    :: Int -- ^ 'datcprsResponseStatus'
    -> DeleteAutomaticTapeCreationPolicyResponse
deleteAutomaticTapeCreationPolicyResponse
  pResponseStatus_
  = DeleteAutomaticTapeCreationPolicyResponse'{_datcprsGatewayARN
                                                 = Nothing,
                                               _datcprsResponseStatus =
                                                 pResponseStatus_}
