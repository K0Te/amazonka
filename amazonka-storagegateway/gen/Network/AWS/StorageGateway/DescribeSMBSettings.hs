...
newtype DescribeSMBSettings = DescribeSMBSettings'{_dsmbsGatewayARN
                                                   :: Text}
...
describeSMBSettings pGatewayARN_
  = DescribeSMBSettings'{_dsmbsGatewayARN =
                           pGatewayARN_}
...
instance AWSRequest DescribeSMBSettings where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribeSMBSettingsResponse' <$>
                   (x .?> "GatewayARN") <*> (x .?> "FileSharesVisible")
...
data DescribeSMBSettingsResponse = DescribeSMBSettingsResponse'{_dsmbsrsGatewayARN
                                                                ::
                                                                !(Maybe Text),
...
describeSMBSettingsResponse
    :: Int -- ^ 'dsmbsrsResponseStatus'
    -> DescribeSMBSettingsResponse
describeSMBSettingsResponse pResponseStatus_
  = DescribeSMBSettingsResponse'{_dsmbsrsGatewayARN =
                                   Nothing,
...
instance NFData DescribeSMBSettingsResponse where
