...
data UpdateBandwidthRateLimitSchedule = UpdateBandwidthRateLimitSchedule'{_ubrlsGatewayARN
                                                                          ::
                                                                          !Text,
...
updateBandwidthRateLimitSchedule
    :: Text -- ^ 'ubrlsGatewayARN'
    -> UpdateBandwidthRateLimitSchedule
updateBandwidthRateLimitSchedule pGatewayARN_
  = UpdateBandwidthRateLimitSchedule'{_ubrlsGatewayARN
                                        = pGatewayARN_,
                                      _ubrlsBandwidthRateLimitIntervals =
                                        mempty}
...
instance AWSRequest UpdateBandwidthRateLimitSchedule
         where
...
instance ToHeaders UpdateBandwidthRateLimitSchedule
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON UpdateBandwidthRateLimitSchedule
         where
...
instance ToPath UpdateBandwidthRateLimitSchedule
         where
        toPath = const "/"

instance ToQuery UpdateBandwidthRateLimitSchedule
         where
        toQuery = const mempty

-- | /See:/ 'updateBandwidthRateLimitScheduleResponse' smart constructor.
data UpdateBandwidthRateLimitScheduleResponse = UpdateBandwidthRateLimitScheduleResponse'{_ubrlsrsGatewayARN
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
...
updateBandwidthRateLimitScheduleResponse
    :: Int -- ^ 'ubrlsrsResponseStatus'
    -> UpdateBandwidthRateLimitScheduleResponse
updateBandwidthRateLimitScheduleResponse
  pResponseStatus_
  = UpdateBandwidthRateLimitScheduleResponse'{_ubrlsrsGatewayARN
                                                = Nothing,
                                              _ubrlsrsResponseStatus =
                                                pResponseStatus_}
