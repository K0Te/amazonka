...
newtype StartAvailabilityMonitorTest = StartAvailabilityMonitorTest'{_samtGatewayARN
                                                                     :: Text}
...
startAvailabilityMonitorTest pGatewayARN_
  = StartAvailabilityMonitorTest'{_samtGatewayARN =
                                    pGatewayARN_}
...
instance AWSRequest StartAvailabilityMonitorTest
         where
...
instance Hashable StartAvailabilityMonitorTest where

instance NFData StartAvailabilityMonitorTest where
...
data StartAvailabilityMonitorTestResponse = StartAvailabilityMonitorTestResponse'{_samtrsGatewayARN
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
startAvailabilityMonitorTestResponse
    :: Int -- ^ 'samtrsResponseStatus'
    -> StartAvailabilityMonitorTestResponse
startAvailabilityMonitorTestResponse pResponseStatus_
  = StartAvailabilityMonitorTestResponse'{_samtrsGatewayARN
                                            = Nothing,
                                          _samtrsResponseStatus =
                                            pResponseStatus_}
