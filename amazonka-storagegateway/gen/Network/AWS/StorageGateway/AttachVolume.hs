...
data AttachVolume = AttachVolume'{_avDiskId ::
                                  !(Maybe Text),
                                  _avTargetName :: !(Maybe Text),
                                  _avGatewayARN :: !Text, _avVolumeARN :: !Text,
...
attachVolume
    ...
    -> AttachVolume
attachVolume pGatewayARN_ pVolumeARN_
  pNetworkInterfaceId_
  = AttachVolume'{_avDiskId = Nothing,
...
data AttachVolumeResponse = AttachVolumeResponse'{_avrsTargetARN
                                                  :: !(Maybe Text),
                                                  _avrsVolumeARN ::
                                                  !(Maybe Text),
...
attachVolumeResponse pResponseStatus_
  = AttachVolumeResponse'{_avrsTargetARN = Nothing,
