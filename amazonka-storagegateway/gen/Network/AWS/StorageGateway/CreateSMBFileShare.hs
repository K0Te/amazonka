...
data CreateSMBFileShare = CreateSMBFileShare'{_csmbfsAccessBasedEnumeration
                                              :: !(Maybe Bool),
...
createSMBFileShare
    ...
    -> CreateSMBFileShare
createSMBFileShare pClientToken_ pGatewayARN_ pRole_
  pLocationARN_
  = CreateSMBFileShare'{_csmbfsAccessBasedEnumeration =
                          Nothing,
...
data CreateSMBFileShareResponse = CreateSMBFileShareResponse'{_csmbfsrsFileShareARN
                                                              :: !(Maybe Text),
                                                              _csmbfsrsResponseStatus
                                                              :: !Int}
...
createSMBFileShareResponse pResponseStatus_
  = CreateSMBFileShareResponse'{_csmbfsrsFileShareARN =
                                  Nothing,
