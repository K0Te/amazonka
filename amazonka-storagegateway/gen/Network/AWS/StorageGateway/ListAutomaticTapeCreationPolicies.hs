...
newtype ListAutomaticTapeCreationPolicies = ListAutomaticTapeCreationPolicies'{_latcpGatewayARN
                                                                               ::
                                                                               Maybe
                                                                                 Text}
...
listAutomaticTapeCreationPolicies
    :: ListAutomaticTapeCreationPolicies
listAutomaticTapeCreationPolicies
  = ListAutomaticTapeCreationPolicies'{_latcpGatewayARN
                                         = Nothing}
...
instance AWSRequest ListAutomaticTapeCreationPolicies
         where
...
instance ToHeaders ListAutomaticTapeCreationPolicies
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON ListAutomaticTapeCreationPolicies
         where
        toJSON ListAutomaticTapeCreationPolicies'{..}
          = object
              (catMaybes [("GatewayARN" .=) <$> _latcpGatewayARN])

instance ToPath ListAutomaticTapeCreationPolicies
         where
        toPath = const "/"

instance ToQuery ListAutomaticTapeCreationPolicies
         where
        toQuery = const mempty

-- | /See:/ 'listAutomaticTapeCreationPoliciesResponse' smart constructor.
data ListAutomaticTapeCreationPoliciesResponse = ListAutomaticTapeCreationPoliciesResponse'{_latcprsAutomaticTapeCreationPolicyInfos
                                                                                            ::
                                                                                            !(Maybe
...
listAutomaticTapeCreationPoliciesResponse
    :: Int -- ^ 'latcprsResponseStatus'
    -> ListAutomaticTapeCreationPoliciesResponse
listAutomaticTapeCreationPoliciesResponse
  pResponseStatus_
  = ListAutomaticTapeCreationPoliciesResponse'{_latcprsAutomaticTapeCreationPolicyInfos
                                                 = Nothing,
                                               _latcprsResponseStatus =
                                                 pResponseStatus_}
