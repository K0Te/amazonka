...
newtype DescribeChapCredentials = DescribeChapCredentials'{_dccTargetARN
                                                           :: Text}
...
describeChapCredentials pTargetARN_
  = DescribeChapCredentials'{_dccTargetARN =
                               pTargetARN_}
...
data DescribeChapCredentialsResponse = DescribeChapCredentialsResponse'{_dccrsChapCredentials
                                                                        ::
                                                                        !(Maybe
                                                                            [ChapInfo]),
...
describeChapCredentialsResponse pResponseStatus_
  = DescribeChapCredentialsResponse'{_dccrsChapCredentials
                                       = Nothing,
