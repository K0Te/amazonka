...
data UpdateSMBFileShareVisibility = UpdateSMBFileShareVisibility'{_usmbfsvGatewayARN
                                                                  :: !Text,
...
updateSMBFileShareVisibility
    :: Text -- ^ 'usmbfsvGatewayARN'
    -> Bool -- ^ 'usmbfsvFileSharesVisible'
    -> UpdateSMBFileShareVisibility
updateSMBFileShareVisibility pGatewayARN_
  pFileSharesVisible_
  = UpdateSMBFileShareVisibility'{_usmbfsvGatewayARN =
                                    pGatewayARN_,
                                  _usmbfsvFileSharesVisible =
                                    pFileSharesVisible_}
...
instance AWSRequest UpdateSMBFileShareVisibility
         where
...
instance Hashable UpdateSMBFileShareVisibility where

instance NFData UpdateSMBFileShareVisibility where
...
data UpdateSMBFileShareVisibilityResponse = UpdateSMBFileShareVisibilityResponse'{_usmbfsvrsGatewayARN
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
updateSMBFileShareVisibilityResponse
    :: Int -- ^ 'usmbfsvrsResponseStatus'
    -> UpdateSMBFileShareVisibilityResponse
updateSMBFileShareVisibilityResponse pResponseStatus_
  = UpdateSMBFileShareVisibilityResponse'{_usmbfsvrsGatewayARN
                                            = Nothing,
                                          _usmbfsvrsResponseStatus =
                                            pResponseStatus_}
