...
newtype DeleteTapePool = DeleteTapePool'{_dtpPoolARN
                                         :: Text}
...
instance Hashable DeleteTapePool where

instance NFData DeleteTapePool where
...
data DeleteTapePoolResponse = DeleteTapePoolResponse'{_dtprsPoolARN
                                                      :: !(Maybe Text),
...
deleteTapePoolResponse pResponseStatus_
  = DeleteTapePoolResponse'{_dtprsPoolARN = Nothing,
...
instance NFData DeleteTapePoolResponse where
