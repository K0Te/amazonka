...
data BandwidthRateLimitInterval = BandwidthRateLimitInterval'{_brliAverageUploadRateLimitInBitsPerSec
                                                              :: !(Maybe Nat),
...
bandwidthRateLimitInterval
    :: Natural -- ^ 'brliStartHourOfDay'
    -> Natural -- ^ 'brliStartMinuteOfHour'
    -> Natural -- ^ 'brliEndHourOfDay'
    -> Natural -- ^ 'brliEndMinuteOfHour'
    -> NonEmpty Natural -- ^ 'brliDaysOfWeek'
    -> BandwidthRateLimitInterval
bandwidthRateLimitInterval pStartHourOfDay_
  pStartMinuteOfHour_ pEndHourOfDay_ pEndMinuteOfHour_
  pDaysOfWeek_
  = BandwidthRateLimitInterval'{_brliAverageUploadRateLimitInBitsPerSec
                                  = Nothing,
                                _brliAverageDownloadRateLimitInBitsPerSec =
                                  Nothing,
...
instance FromJSON BandwidthRateLimitInterval where
        parseJSON
          = withObject "BandwidthRateLimitInterval"
              (\ x ->
                 BandwidthRateLimitInterval' <$>
...
instance Hashable BandwidthRateLimitInterval where

instance NFData BandwidthRateLimitInterval where
