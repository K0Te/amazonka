...
newtype DescribeSMBFileShares = DescribeSMBFileShares'{_dsmbfsFileShareARNList
                                                       :: List1 Text}
...
describeSMBFileShares pFileShareARNList_
  = DescribeSMBFileShares'{_dsmbfsFileShareARNList =
...
data DescribeSMBFileSharesResponse = DescribeSMBFileSharesResponse'{_dsmbfsrsSMBFileShareInfoList
                                                                    ::
                                                                    !(Maybe
                                                                        [SMBFileShareInfo]),
                                                                    _dsmbfsrsResponseStatus
                                                                    :: !Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
describeSMBFileSharesResponse pResponseStatus_
  = DescribeSMBFileSharesResponse'{_dsmbfsrsSMBFileShareInfoList
                                     = Nothing,
