...
data UpdateSMBFileShare = UpdateSMBFileShare'{_usmbfsAccessBasedEnumeration
                                              :: !(Maybe Bool),
...
updateSMBFileShare pFileShareARN_
  = UpdateSMBFileShare'{_usmbfsAccessBasedEnumeration =
                          Nothing,
...
data UpdateSMBFileShareResponse = UpdateSMBFileShareResponse'{_usmbfsrsFileShareARN
                                                              :: !(Maybe Text),
                                                              _usmbfsrsResponseStatus
                                                              :: !Int}
...
updateSMBFileShareResponse pResponseStatus_
  = UpdateSMBFileShareResponse'{_usmbfsrsFileShareARN =
                                  Nothing,
