...
data UpdateAutomaticTapeCreationPolicy = UpdateAutomaticTapeCreationPolicy'{_uatcpAutomaticTapeCreationRules
                                                                            ::
                                                                            !(List1
...
updateAutomaticTapeCreationPolicy
    :: NonEmpty AutomaticTapeCreationRule -- ^ 'uatcpAutomaticTapeCreationRules'
    -> Text -- ^ 'uatcpGatewayARN'
    -> UpdateAutomaticTapeCreationPolicy
updateAutomaticTapeCreationPolicy
  pAutomaticTapeCreationRules_ pGatewayARN_
  = UpdateAutomaticTapeCreationPolicy'{_uatcpAutomaticTapeCreationRules
                                         =
...
instance AWSRequest UpdateAutomaticTapeCreationPolicy
         where
...
instance ToHeaders UpdateAutomaticTapeCreationPolicy
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON UpdateAutomaticTapeCreationPolicy
         where
...
instance ToPath UpdateAutomaticTapeCreationPolicy
         where
        toPath = const "/"

instance ToQuery UpdateAutomaticTapeCreationPolicy
         where
        toQuery = const mempty

-- | /See:/ 'updateAutomaticTapeCreationPolicyResponse' smart constructor.
data UpdateAutomaticTapeCreationPolicyResponse = UpdateAutomaticTapeCreationPolicyResponse'{_uatcprsGatewayARN
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
...
updateAutomaticTapeCreationPolicyResponse
    :: Int -- ^ 'uatcprsResponseStatus'
    -> UpdateAutomaticTapeCreationPolicyResponse
updateAutomaticTapeCreationPolicyResponse
  pResponseStatus_
  = UpdateAutomaticTapeCreationPolicyResponse'{_uatcprsGatewayARN
                                                 = Nothing,
                                               _uatcprsResponseStatus =
                                                 pResponseStatus_}
