...
data SetSMBGuestPassword = SetSMBGuestPassword'{_ssmbgpGatewayARN
                                                :: !Text,
                                                _ssmbgpPassword ::
                                                !(Sensitive Text)}
...
setSMBGuestPassword pGatewayARN_ pPassword_
  = SetSMBGuestPassword'{_ssmbgpGatewayARN =
                           pGatewayARN_,
...
data SetSMBGuestPasswordResponse = SetSMBGuestPasswordResponse'{_ssmbgprsGatewayARN
                                                                ::
                                                                !(Maybe Text),
                                                                _ssmbgprsResponseStatus
                                                                :: !Int}
...
setSMBGuestPasswordResponse pResponseStatus_
  = SetSMBGuestPasswordResponse'{_ssmbgprsGatewayARN =
                                   Nothing,
