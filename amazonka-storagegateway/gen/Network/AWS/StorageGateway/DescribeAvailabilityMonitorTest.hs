...
newtype DescribeAvailabilityMonitorTest = DescribeAvailabilityMonitorTest'{_damtGatewayARN
                                                                           ::
                                                                           Text}
...
describeAvailabilityMonitorTest pGatewayARN_
  = DescribeAvailabilityMonitorTest'{_damtGatewayARN =
                                       pGatewayARN_}
...
instance AWSRequest DescribeAvailabilityMonitorTest
         where
...
instance NFData DescribeAvailabilityMonitorTest where

instance ToHeaders DescribeAvailabilityMonitorTest
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery DescribeAvailabilityMonitorTest
         where
        toQuery = const mempty

-- | /See:/ 'describeAvailabilityMonitorTestResponse' smart constructor.
data DescribeAvailabilityMonitorTestResponse = DescribeAvailabilityMonitorTestResponse'{_damtrsStatus
                                                                                        ::
                                                                                        !(Maybe
...
describeAvailabilityMonitorTestResponse
    :: Int -- ^ 'damtrsResponseStatus'
    -> DescribeAvailabilityMonitorTestResponse
describeAvailabilityMonitorTestResponse
  pResponseStatus_
  = DescribeAvailabilityMonitorTestResponse'{_damtrsStatus
                                               = Nothing,
