...
data DetachVolume = DetachVolume'{_dvForceDetach ::
                                  !(Maybe Bool),
                                  _dvVolumeARN :: !Text}
...
detachVolume pVolumeARN_
  = DetachVolume'{_dvForceDetach = Nothing,
...
data DetachVolumeResponse = DetachVolumeResponse'{_dvrsVolumeARN
                                                  :: !(Maybe Text),
...
detachVolumeResponse pResponseStatus_
  = DetachVolumeResponse'{_dvrsVolumeARN = Nothing,
