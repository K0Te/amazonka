...
data CreateTapePool = CreateTapePool'{_ctpRetentionLockType
...
createTapePool
    :: Text -- ^ 'ctpPoolName'
    -> TapeStorageClass -- ^ 'ctpStorageClass'
    -> CreateTapePool
createTapePool pPoolName_ pStorageClass_
  = CreateTapePool'{_ctpRetentionLockType = Nothing,
                    _ctpRetentionLockTimeInDays = Nothing,
                    _ctpTags = Nothing, _ctpPoolName = pPoolName_,
...
instance Hashable CreateTapePool where

instance NFData CreateTapePool where
...
data CreateTapePoolResponse = CreateTapePoolResponse'{_ctprsPoolARN
                                                      :: !(Maybe Text),
                                                      _ctprsResponseStatus ::
                                                      !Int}
...
createTapePoolResponse pResponseStatus_
  = CreateTapePoolResponse'{_ctprsPoolARN = Nothing,
...
instance NFData CreateTapePoolResponse where
