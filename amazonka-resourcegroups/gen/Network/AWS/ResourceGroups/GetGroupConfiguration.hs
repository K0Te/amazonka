...
newtype GetGroupConfiguration = GetGroupConfiguration'{_ggcGroup
                                                       :: Maybe Text}
...
instance Hashable GetGroupConfiguration where

instance NFData GetGroupConfiguration where
...
data GetGroupConfigurationResponse = GetGroupConfigurationResponse'{_ggcrsGroupConfiguration
                                                                    ::
                                                                    !(Maybe
                                                                        GroupConfiguration),
...
getGroupConfigurationResponse pResponseStatus_
  = GetGroupConfigurationResponse'{_ggcrsGroupConfiguration
                                     = Nothing,
...
instance NFData GetGroupConfigurationResponse where
