...
data GroupConfigurationParameter = GroupConfigurationParameter'{_gcpValues
                                                                ::
                                                                !(Maybe [Text]),
                                                                _gcpName ::
                                                                !Text}
...
groupConfigurationParameter pName_
  = GroupConfigurationParameter'{_gcpValues = Nothing,
                                 _gcpName = pName_}
...
instance FromJSON GroupConfigurationParameter where
        parseJSON
          = withObject "GroupConfigurationParameter"
              (\ x ->
                 GroupConfigurationParameter' <$>
                   (x .:? "Values" .!= mempty) <*> (x .: "Name"))

instance Hashable GroupConfigurationParameter where

instance NFData GroupConfigurationParameter where
