...
data GroupConfiguration = GroupConfiguration'{_gcStatus
                                              ::
...
groupConfiguration
    :: GroupConfiguration
groupConfiguration
  = GroupConfiguration'{_gcStatus = Nothing,
...
instance Hashable GroupConfiguration where

instance NFData GroupConfiguration where
