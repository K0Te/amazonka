...
data GroupResources = GroupResources'{_grGroup ::
                                      !Text,
...
groupResources
    :: Text -- ^ 'grGroup'
    -> NonEmpty Text -- ^ 'grResourceARNs'
    -> GroupResources
groupResources pGroup_ pResourceARNs_
  = GroupResources'{_grGroup = pGroup_,
...
instance Hashable GroupResources where

instance NFData GroupResources where
...
data GroupResourcesResponse = GroupResourcesResponse'{_grrsSucceeded
                                                      :: !(Maybe (List1 Text)),
                                                      _grrsFailed ::
...
groupResourcesResponse pResponseStatus_
  = GroupResourcesResponse'{_grrsSucceeded = Nothing,
                            _grrsFailed = Nothing,
...
instance NFData GroupResourcesResponse where
