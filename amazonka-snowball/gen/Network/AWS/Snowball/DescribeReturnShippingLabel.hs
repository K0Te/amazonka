...
newtype DescribeReturnShippingLabel = DescribeReturnShippingLabel'{_drslJobId
                                                                   ::
                                                                   Maybe Text}
...
instance Hashable DescribeReturnShippingLabel where

instance NFData DescribeReturnShippingLabel where
...
data DescribeReturnShippingLabelResponse = DescribeReturnShippingLabelResponse'{_drslrsStatus
                                                                                ::
                                                                                !(Maybe
                                                                                    ShippingLabelStatus),
...
describeReturnShippingLabelResponse
    :: Int -- ^ 'drslrsResponseStatus'
    -> DescribeReturnShippingLabelResponse
describeReturnShippingLabelResponse pResponseStatus_
  = DescribeReturnShippingLabelResponse'{_drslrsStatus
                                           = Nothing,
