...
newtype GetSoftwareUpdates = GetSoftwareUpdates'{_gsuJobId
                                                 :: Text}
...
instance Hashable GetSoftwareUpdates where

instance NFData GetSoftwareUpdates where
...
data GetSoftwareUpdatesResponse = GetSoftwareUpdatesResponse'{_gsursUpdatesURI
                                                              :: !(Maybe Text),
...
getSoftwareUpdatesResponse pResponseStatus_
  = GetSoftwareUpdatesResponse'{_gsursUpdatesURI =
                                  Nothing,
...
instance NFData GetSoftwareUpdatesResponse where
