...
data Address = Address'{_aIsRestricted ::
                        !(Maybe Bool),
                        ...
                        _aCompany :: !(Maybe Text), _aName :: !(Maybe Text),
...
address
    :: Address
address
  = Address'{_aIsRestricted = Nothing,
             _aStreet3 = Nothing, _aLandmark = Nothing,
             _aPostalCode = Nothing, _aCountry = Nothing,
             _aStateOrProvince = Nothing, _aStreet2 = Nothing,
             _aAddressId = Nothing, _aCity = Nothing,
             _aPhoneNumber = Nothing, _aCompany = Nothing,
             _aName = Nothing, _aPrefectureOrDistrict = Nothing,
             _aStreet1 = Nothing}
