...
newtype DeviceConfiguration = DeviceConfiguration'{_dcSnowconeDeviceConfiguration
                                                   ::
                                                   Maybe
...
deviceConfiguration
    :: DeviceConfiguration
deviceConfiguration
  = DeviceConfiguration'{_dcSnowconeDeviceConfiguration
                           = Nothing}
...
instance FromJSON DeviceConfiguration where
        parseJSON
          = withObject "DeviceConfiguration"
              (\ x ->
                 DeviceConfiguration' <$>
                   (x .:? "SnowconeDeviceConfiguration"))

instance Hashable DeviceConfiguration where

instance NFData DeviceConfiguration where
