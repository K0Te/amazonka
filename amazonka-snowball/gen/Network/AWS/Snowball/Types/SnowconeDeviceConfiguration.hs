...
newtype SnowconeDeviceConfiguration = SnowconeDeviceConfiguration'{_sdcWirelessConnection
                                                                   ::
                                                                   Maybe
                                                                     WirelessConnection}
...
snowconeDeviceConfiguration
    :: SnowconeDeviceConfiguration
snowconeDeviceConfiguration
  = SnowconeDeviceConfiguration'{_sdcWirelessConnection
                                   = Nothing}
...
instance FromJSON SnowconeDeviceConfiguration where
        parseJSON
          = withObject "SnowconeDeviceConfiguration"
              (\ x ->
                 SnowconeDeviceConfiguration' <$>
                   (x .:? "WirelessConnection"))

instance Hashable SnowconeDeviceConfiguration where

instance NFData SnowconeDeviceConfiguration where
