...
data UpdateJobShipmentState = UpdateJobShipmentState'{_ujssJobId
                                                      :: !Text,
                                                      _ujssShipmentState ::
                                                      !ShipmentState}
...
updateJobShipmentState
    :: Text -- ^ 'ujssJobId'
    -> ShipmentState -- ^ 'ujssShipmentState'
    -> UpdateJobShipmentState
updateJobShipmentState pJobId_ pShipmentState_
  = UpdateJobShipmentState'{_ujssJobId = pJobId_,
...
instance AWSRequest UpdateJobShipmentState where
        type Rs UpdateJobShipmentState =
             UpdateJobShipmentStateResponse
...
instance Hashable UpdateJobShipmentState where

instance NFData UpdateJobShipmentState where
...
newtype UpdateJobShipmentStateResponse = UpdateJobShipmentStateResponse'{_ujssrsResponseStatus
                                                                         :: Int}
...
updateJobShipmentStateResponse
    :: Int -- ^ 'ujssrsResponseStatus'
    -> UpdateJobShipmentStateResponse
updateJobShipmentStateResponse pResponseStatus_
  = UpdateJobShipmentStateResponse'{_ujssrsResponseStatus
                                      = pResponseStatus_}
...
instance NFData UpdateJobShipmentStateResponse where
