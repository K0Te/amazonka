...
data CreateReturnShippingLabel = CreateReturnShippingLabel'{_crslShippingOption
                                                            ::
                                                            !(Maybe
                                                                ShippingOption),
                                                            _crslJobId :: !Text}
...
createReturnShippingLabel pJobId_
  = CreateReturnShippingLabel'{_crslShippingOption =
                                 Nothing,
                               _crslJobId = pJobId_}
...
instance Hashable CreateReturnShippingLabel where

instance NFData CreateReturnShippingLabel where
...
data CreateReturnShippingLabelResponse = CreateReturnShippingLabelResponse'{_crslrsStatus
                                                                            ::
                                                                            !(Maybe
                                                                                ShippingLabelStatus),
...
createReturnShippingLabelResponse
    :: Int -- ^ 'crslrsResponseStatus'
    -> CreateReturnShippingLabelResponse
createReturnShippingLabelResponse pResponseStatus_
  = CreateReturnShippingLabelResponse'{_crslrsStatus =
                                         Nothing,
