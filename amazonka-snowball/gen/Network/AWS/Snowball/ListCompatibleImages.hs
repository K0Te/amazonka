...
data ListCompatibleImages = ListCompatibleImages'{_lciNextToken
                                                  :: !(Maybe Text),
                                                  _lciMaxResults ::
                                                  !(Maybe Nat)}
...
listCompatibleImages
    :: ListCompatibleImages
listCompatibleImages
  = ListCompatibleImages'{_lciNextToken = Nothing,
...
data ListCompatibleImagesResponse = ListCompatibleImagesResponse'{_lcirsCompatibleImages
                                                                  ::
                                                                  !(Maybe
                                                                      [CompatibleImage]),
                                                                  _lcirsNextToken
...
listCompatibleImagesResponse pResponseStatus_
  = ListCompatibleImagesResponse'{_lcirsCompatibleImages
                                    = Nothing,
