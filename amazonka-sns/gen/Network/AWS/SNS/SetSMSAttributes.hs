...
newtype SetSMSAttributes = SetSMSAttributes'{_ssmsaAttributes
                                             :: Map Text Text}
...
newtype SetSMSAttributesResponse = SetSMSAttributesResponse'{_ssmsarsResponseStatus
                                                             :: Int}
...
setSMSAttributesResponse pResponseStatus_
  = SetSMSAttributesResponse'{_ssmsarsResponseStatus =
                                pResponseStatus_}
