...
data DissociatePackage = DissociatePackage'{_dpPackageId
                                            :: !Text,
                                            _dpDomainName :: !Text}
...
dissociatePackage pPackageId_ pDomainName_
  = DissociatePackage'{_dpPackageId = pPackageId_,
...
instance Hashable DissociatePackage where

instance NFData DissociatePackage where
        ...
        toPath DissociatePackage'{..}
          = mconcat
              ["/2015-01-01/packages/dissociate/",
               toBS _dpPackageId, "/", toBS _dpDomainName]
...
data DissociatePackageResponse = DissociatePackageResponse'{_disrsDomainPackageDetails
                                                            ::
                                                            !(Maybe
...
dissociatePackageResponse pResponseStatus_
  = DissociatePackageResponse'{_disrsDomainPackageDetails
                                 = Nothing,
...
instance NFData DissociatePackageResponse where
