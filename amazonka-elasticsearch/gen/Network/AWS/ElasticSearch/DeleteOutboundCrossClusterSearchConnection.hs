...
newtype DeleteOutboundCrossClusterSearchConnection = DeleteOutboundCrossClusterSearchConnection'{_doccscCrossClusterSearchConnectionId
                                                                                                 ::
                                                                                                 Text}
...
deleteOutboundCrossClusterSearchConnection
    :: Text -- ^ 'doccscCrossClusterSearchConnectionId'
    -> DeleteOutboundCrossClusterSearchConnection
deleteOutboundCrossClusterSearchConnection
  pCrossClusterSearchConnectionId_
  = DeleteOutboundCrossClusterSearchConnection'{_doccscCrossClusterSearchConnectionId
                                                  =
                                                  pCrossClusterSearchConnectionId_}
...
data DeleteOutboundCrossClusterSearchConnectionResponse = DeleteOutboundCrossClusterSearchConnectionResponse'{_doccscrsCrossClusterSearchConnection
                                                                                                              ::
                                                                                                              !(Maybe
...
deleteOutboundCrossClusterSearchConnectionResponse
    :: Int -- ^ 'doccscrsResponseStatus'
    -> DeleteOutboundCrossClusterSearchConnectionResponse
deleteOutboundCrossClusterSearchConnectionResponse
  pResponseStatus_
  = DeleteOutboundCrossClusterSearchConnectionResponse'{_doccscrsCrossClusterSearchConnection
                                                          = Nothing,
                                                        _doccscrsResponseStatus
                                                          = pResponseStatus_}
