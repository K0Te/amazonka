...
data UpgradeElasticsearchDomain = UpgradeElasticsearchDomain'{_uedPerformCheckOnly
                                                              :: !(Maybe Bool),
                                                              _uedDomainName ::
                                                              !Text,
                                                              _uedTargetVersion
...
upgradeElasticsearchDomain
    ...
    -> UpgradeElasticsearchDomain
upgradeElasticsearchDomain pDomainName_
  pTargetVersion_
  = UpgradeElasticsearchDomain'{_uedPerformCheckOnly =
                                  Nothing,
...
data UpgradeElasticsearchDomainResponse = UpgradeElasticsearchDomainResponse'{_uedrsDomainName
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
...
upgradeElasticsearchDomainResponse pResponseStatus_
  = UpgradeElasticsearchDomainResponse'{_uedrsDomainName
                                          = Nothing,
