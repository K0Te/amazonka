...
data DescribeInboundCrossClusterSearchConnections = DescribeInboundCrossClusterSearchConnections'{_diccscFilters
                                                                                                  ::
                                                                                                  !(Maybe
                                                                                                      [Filter]),
                                                                                                  _diccscNextToken
...
describeInboundCrossClusterSearchConnections
    :: DescribeInboundCrossClusterSearchConnections
describeInboundCrossClusterSearchConnections
  = DescribeInboundCrossClusterSearchConnections'{_diccscFilters
                                                    = Nothing,
...
data DescribeInboundCrossClusterSearchConnectionsResponse = DescribeInboundCrossClusterSearchConnectionsResponse'{_diccscrsCrossClusterSearchConnections
                                                                                                                  ::
                                                                                                                  !(Maybe
...
describeInboundCrossClusterSearchConnectionsResponse
    :: Int -- ^ 'diccscrsResponseStatus'
    -> DescribeInboundCrossClusterSearchConnectionsResponse
describeInboundCrossClusterSearchConnectionsResponse
  pResponseStatus_
  = DescribeInboundCrossClusterSearchConnectionsResponse'{_diccscrsCrossClusterSearchConnections
                                                            = Nothing,
                                                          _diccscrsNextToken =
                                                            Nothing,
                                                          _diccscrsResponseStatus
