...
newtype RejectInboundCrossClusterSearchConnection = RejectInboundCrossClusterSearchConnection'{_riccscCrossClusterSearchConnectionId
                                                                                               ::
                                                                                               Text}
...
rejectInboundCrossClusterSearchConnection
    :: Text -- ^ 'riccscCrossClusterSearchConnectionId'
    -> RejectInboundCrossClusterSearchConnection
rejectInboundCrossClusterSearchConnection
  pCrossClusterSearchConnectionId_
  = RejectInboundCrossClusterSearchConnection'{_riccscCrossClusterSearchConnectionId
                                                 =
                                                 pCrossClusterSearchConnectionId_}
...
data RejectInboundCrossClusterSearchConnectionResponse = RejectInboundCrossClusterSearchConnectionResponse'{_riccscrsCrossClusterSearchConnection
                                                                                                            ::
                                                                                                            !(Maybe
...
rejectInboundCrossClusterSearchConnectionResponse
    :: Int -- ^ 'riccscrsResponseStatus'
    -> RejectInboundCrossClusterSearchConnectionResponse
rejectInboundCrossClusterSearchConnectionResponse
  pResponseStatus_
  = RejectInboundCrossClusterSearchConnectionResponse'{_riccscrsCrossClusterSearchConnection
                                                         = Nothing,
                                                       _riccscrsResponseStatus =
                                                         pResponseStatus_}
