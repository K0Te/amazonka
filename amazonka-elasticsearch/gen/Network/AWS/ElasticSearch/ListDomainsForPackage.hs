...
data ListDomainsForPackage = ListDomainsForPackage'{_ldfpNextToken
                                                    :: !(Maybe Text),
                                                    _ldfpMaxResults ::
                                                    !(Maybe Int),
                                                    _ldfpPackageId :: !Text}
...
listDomainsForPackage pPackageId_
  = ListDomainsForPackage'{_ldfpNextToken = Nothing,
...
instance Hashable ListDomainsForPackage where

instance NFData ListDomainsForPackage where
...
instance ToPath ListDomainsForPackage where
        toPath ListDomainsForPackage'{..}
          = mconcat
              ["/2015-01-01/packages/", toBS _ldfpPackageId,
               "/domains"]
...
data ListDomainsForPackageResponse = ListDomainsForPackageResponse'{_ldfprsDomainPackageDetailsList
                                                                    ::
                                                                    !(Maybe
...
listDomainsForPackageResponse
    :: Int -- ^ 'ldfprsResponseStatus'
    -> ListDomainsForPackageResponse
listDomainsForPackageResponse pResponseStatus_
  = ListDomainsForPackageResponse'{_ldfprsDomainPackageDetailsList
                                     = Nothing,
...
instance NFData ListDomainsForPackageResponse where
