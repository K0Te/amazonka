...
data CreateOutboundCrossClusterSearchConnection = CreateOutboundCrossClusterSearchConnection'{_coccscSourceDomainInfo
                                                                                              ::
                                                                                              !DomainInformation,
...
createOutboundCrossClusterSearchConnection
    :: DomainInformation -- ^ 'coccscSourceDomainInfo'
    -> DomainInformation -- ^ 'coccscDestinationDomainInfo'
    -> Text -- ^ 'coccscConnectionAlias'
    -> CreateOutboundCrossClusterSearchConnection
createOutboundCrossClusterSearchConnection
  pSourceDomainInfo_ pDestinationDomainInfo_
  pConnectionAlias_
  = CreateOutboundCrossClusterSearchConnection'{_coccscSourceDomainInfo
                                                  = pSourceDomainInfo_,
                                                _coccscDestinationDomainInfo =
...
data CreateOutboundCrossClusterSearchConnectionResponse = CreateOutboundCrossClusterSearchConnectionResponse'{_coccscrsDestinationDomainInfo
                                                                                                              ::
                                                                                                              !(Maybe
                                                                                                                  DomainInformation),
...
createOutboundCrossClusterSearchConnectionResponse
    :: Int -- ^ 'coccscrsResponseStatus'
    -> CreateOutboundCrossClusterSearchConnectionResponse
createOutboundCrossClusterSearchConnectionResponse
  pResponseStatus_
  = CreateOutboundCrossClusterSearchConnectionResponse'{_coccscrsDestinationDomainInfo
                                                          = Nothing,
                                                        _coccscrsConnectionAlias
                                                          = Nothing,
                                                        _coccscrsCrossClusterSearchConnectionId
