...
data UpdatePackage = UpdatePackage'{_upPackageDescription
                                    :: !(Maybe Text),
...
updatePackage
    :: Text -- ^ 'upPackageId'
    -> PackageSource -- ^ 'upPackageSource'
    -> UpdatePackage
updatePackage pPackageId_ pPackageSource_
  = UpdatePackage'{_upPackageDescription = Nothing,
...
instance Hashable UpdatePackage where

instance NFData UpdatePackage where
...
data UpdatePackageResponse = UpdatePackageResponse'{_uprsPackageDetails
...
updatePackageResponse pResponseStatus_
  = UpdatePackageResponse'{_uprsPackageDetails =
                             Nothing,
...
instance NFData UpdatePackageResponse where
