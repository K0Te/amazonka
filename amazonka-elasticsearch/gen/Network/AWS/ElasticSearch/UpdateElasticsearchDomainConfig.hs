...
data UpdateElasticsearchDomainConfig = UpdateElasticsearchDomainConfig'{_uedcEBSOptions
                                                                        ::
                                                                        !(Maybe
                                                                            EBSOptions),
                                                                        _uedcAccessPolicies
...
updateElasticsearchDomainConfig pDomainName_
  = UpdateElasticsearchDomainConfig'{_uedcEBSOptions =
                                       Nothing,
...
data UpdateElasticsearchDomainConfigResponse = UpdateElasticsearchDomainConfigResponse'{_uedcrsResponseStatus
                                                                                        ::
                                                                                        !Int,
                                                                                        _uedcrsDomainConfig
                                                                                        ::
...
updateElasticsearchDomainConfigResponse
  ...
  = UpdateElasticsearchDomainConfigResponse'{_uedcrsResponseStatus
                                               = pResponseStatus_,
                                             _uedcrsDomainConfig =
                                               pDomainConfig_}
