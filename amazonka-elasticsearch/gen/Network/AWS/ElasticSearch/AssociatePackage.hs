...
data AssociatePackage = AssociatePackage'{_apPackageId
                                          :: !Text,
                                          _apDomainName :: !Text}
...
associatePackage pPackageId_ pDomainName_
  = AssociatePackage'{_apPackageId = pPackageId_,
...
instance Hashable AssociatePackage where

instance NFData AssociatePackage where
        ...
        toPath AssociatePackage'{..}
          = mconcat
              ["/2015-01-01/packages/associate/",
               toBS _apPackageId, "/", toBS _apDomainName]
...
data AssociatePackageResponse = AssociatePackageResponse'{_aprsDomainPackageDetails
                                                          ::
                                                          !(Maybe
...
associatePackageResponse pResponseStatus_
  = AssociatePackageResponse'{_aprsDomainPackageDetails
                                = Nothing,
...
instance NFData AssociatePackageResponse where
