...
newtype StartElasticsearchServiceSoftwareUpdate = StartElasticsearchServiceSoftwareUpdate'{_sessuDomainName
                                                                                           ::
                                                                                           Text}
...
startElasticsearchServiceSoftwareUpdate
    :: Text -- ^ 'sessuDomainName'
    -> StartElasticsearchServiceSoftwareUpdate
startElasticsearchServiceSoftwareUpdate pDomainName_
  = StartElasticsearchServiceSoftwareUpdate'{_sessuDomainName
                                               = pDomainName_}
...
data StartElasticsearchServiceSoftwareUpdateResponse = StartElasticsearchServiceSoftwareUpdateResponse'{_sessursServiceSoftwareOptions
                                                                                                        ::
                                                                                                        !(Maybe
...
startElasticsearchServiceSoftwareUpdateResponse
    :: Int -- ^ 'sessursResponseStatus'
    -> StartElasticsearchServiceSoftwareUpdateResponse
startElasticsearchServiceSoftwareUpdateResponse
  pResponseStatus_
  = StartElasticsearchServiceSoftwareUpdateResponse'{_sessursServiceSoftwareOptions
                                                       = Nothing,
                                                     _sessursResponseStatus =
                                                       pResponseStatus_}
