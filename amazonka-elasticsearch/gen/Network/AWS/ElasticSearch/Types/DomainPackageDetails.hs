...
data DomainPackageDetails = DomainPackageDetails'{_dpdLastUpdated
                                                  :: !(Maybe POSIX),
                                                  _dpdPackageId ::
                                                  !(Maybe Text),
                                                  _dpdPackageType ::
...
domainPackageDetails
    :: DomainPackageDetails
domainPackageDetails
  = DomainPackageDetails'{_dpdLastUpdated = Nothing,
                          _dpdPackageId = Nothing, _dpdPackageType = Nothing,
                          _dpdPackageName = Nothing,
                          _dpdPackageVersion = Nothing,
                          _dpdDomainPackageStatus = Nothing,
                          _dpdDomainName = Nothing, _dpdErrorDetails = Nothing,
