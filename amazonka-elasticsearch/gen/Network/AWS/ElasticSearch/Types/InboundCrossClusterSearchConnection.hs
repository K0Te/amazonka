...
data InboundCrossClusterSearchConnection = InboundCrossClusterSearchConnection'{_iccscDestinationDomainInfo
                                                                                ::
                                                                                !(Maybe
                                                                                    DomainInformation),
...
inboundCrossClusterSearchConnection
    :: InboundCrossClusterSearchConnection
inboundCrossClusterSearchConnection
  = InboundCrossClusterSearchConnection'{_iccscDestinationDomainInfo
                                           = Nothing,
                                         _iccscCrossClusterSearchConnectionId =
                                           Nothing,
