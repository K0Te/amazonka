...
data OutboundCrossClusterSearchConnection = OutboundCrossClusterSearchConnection'{_occscDestinationDomainInfo
                                                                                  ::
                                                                                  !(Maybe
                                                                                      DomainInformation),
...
outboundCrossClusterSearchConnection
    :: OutboundCrossClusterSearchConnection
outboundCrossClusterSearchConnection
  = OutboundCrossClusterSearchConnection'{_occscDestinationDomainInfo
                                            = Nothing,
