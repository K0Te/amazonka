...
newtype AcceptInboundCrossClusterSearchConnection = AcceptInboundCrossClusterSearchConnection'{_aiccscCrossClusterSearchConnectionId
                                                                                               ::
                                                                                               Text}
...
acceptInboundCrossClusterSearchConnection
    :: Text -- ^ 'aiccscCrossClusterSearchConnectionId'
    -> AcceptInboundCrossClusterSearchConnection
acceptInboundCrossClusterSearchConnection
  pCrossClusterSearchConnectionId_
  = AcceptInboundCrossClusterSearchConnection'{_aiccscCrossClusterSearchConnectionId
                                                 =
                                                 pCrossClusterSearchConnectionId_}
...
data AcceptInboundCrossClusterSearchConnectionResponse = AcceptInboundCrossClusterSearchConnectionResponse'{_aiccscrsCrossClusterSearchConnection
                                                                                                            ::
                                                                                                            !(Maybe
...
acceptInboundCrossClusterSearchConnectionResponse
    :: Int -- ^ 'aiccscrsResponseStatus'
    -> AcceptInboundCrossClusterSearchConnectionResponse
acceptInboundCrossClusterSearchConnectionResponse
  pResponseStatus_
  = AcceptInboundCrossClusterSearchConnectionResponse'{_aiccscrsCrossClusterSearchConnection
                                                         = Nothing,
                                                       _aiccscrsResponseStatus =
                                                         pResponseStatus_}
