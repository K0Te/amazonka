...
data DescribeOutboundCrossClusterSearchConnections = DescribeOutboundCrossClusterSearchConnections'{_doccscFilters
                                                                                                    ::
                                                                                                    !(Maybe
                                                                                                        [Filter]),
                                                                                                    _doccscNextToken
...
describeOutboundCrossClusterSearchConnections
    :: DescribeOutboundCrossClusterSearchConnections
describeOutboundCrossClusterSearchConnections
  = DescribeOutboundCrossClusterSearchConnections'{_doccscFilters
                                                     = Nothing,
...
data DescribeOutboundCrossClusterSearchConnectionsResponse = DescribeOutboundCrossClusterSearchConnectionsResponse'{_drsCrossClusterSearchConnections
                                                                                                                    ::
                                                                                                                    !(Maybe
...
describeOutboundCrossClusterSearchConnectionsResponse
  pResponseStatus_
  = DescribeOutboundCrossClusterSearchConnectionsResponse'{_drsCrossClusterSearchConnections
                                                             = Nothing,
                                                           _drsNextToken =
                                                             Nothing,
                                                           _drsResponseStatus =
