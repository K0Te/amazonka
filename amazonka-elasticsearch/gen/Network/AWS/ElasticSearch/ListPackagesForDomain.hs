...
data ListPackagesForDomain = ListPackagesForDomain'{_lpfdNextToken
                                                    :: !(Maybe Text),
                                                    _lpfdMaxResults ::
                                                    !(Maybe Int),
...
listPackagesForDomain pDomainName_
  = ListPackagesForDomain'{_lpfdNextToken = Nothing,
...
instance Hashable ListPackagesForDomain where

instance NFData ListPackagesForDomain where
...
instance ToPath ListPackagesForDomain where
        toPath ListPackagesForDomain'{..}
          = mconcat
              ["/2015-01-01/domain/", toBS _lpfdDomainName,
               "/packages"]
...
data ListPackagesForDomainResponse = ListPackagesForDomainResponse'{_lpfdrsDomainPackageDetailsList
                                                                    ::
                                                                    !(Maybe
...
listPackagesForDomainResponse
    :: Int -- ^ 'lpfdrsResponseStatus'
    -> ListPackagesForDomainResponse
listPackagesForDomainResponse pResponseStatus_
  = ListPackagesForDomainResponse'{_lpfdrsDomainPackageDetailsList
                                     = Nothing,
...
instance NFData ListPackagesForDomainResponse where
