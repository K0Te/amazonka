...
newtype GetCompatibleElasticsearchVersions = GetCompatibleElasticsearchVersions'{_gcevDomainName
                                                                                 ::
                                                                                 Maybe
                                                                                   Text}
...
getCompatibleElasticsearchVersions
    :: GetCompatibleElasticsearchVersions
getCompatibleElasticsearchVersions
  = GetCompatibleElasticsearchVersions'{_gcevDomainName
                                          = Nothing}
...
data GetCompatibleElasticsearchVersionsResponse = GetCompatibleElasticsearchVersionsResponse'{_gcevrsCompatibleElasticsearchVersions
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  [CompatibleVersionsMap]),
                                                                                              _gcevrsResponseStatus
                                                                                              ::
                                                                                              !Int}
...
getCompatibleElasticsearchVersionsResponse
  pResponseStatus_
  = GetCompatibleElasticsearchVersionsResponse'{_gcevrsCompatibleElasticsearchVersions
                                                  = Nothing,
                                                _gcevrsResponseStatus =
                                                  pResponseStatus_}
