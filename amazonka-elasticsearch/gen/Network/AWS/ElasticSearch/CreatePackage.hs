...
data CreatePackage = CreatePackage'{_cpPackageDescription
                                    :: !(Maybe Text),
                                    _cpPackageName :: !Text,
...
createPackage
    :: Text -- ^ 'cpPackageName'
    -> PackageType -- ^ 'cpPackageType'
    -> PackageSource -- ^ 'cpPackageSource'
    -> CreatePackage
createPackage pPackageName_ pPackageType_
  pPackageSource_
  = CreatePackage'{_cpPackageDescription = Nothing,
...
instance Hashable CreatePackage where

instance NFData CreatePackage where
...
data CreatePackageResponse = CreatePackageResponse'{_cprsPackageDetails
...
createPackageResponse pResponseStatus_
  = CreatePackageResponse'{_cprsPackageDetails =
                             Nothing,
...
instance NFData CreatePackageResponse where
