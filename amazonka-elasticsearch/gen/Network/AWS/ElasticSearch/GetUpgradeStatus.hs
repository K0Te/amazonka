...
newtype GetUpgradeStatus = GetUpgradeStatus'{_gusDomainName
                                             :: Text}
...
data GetUpgradeStatusResponse = GetUpgradeStatusResponse'{_gusrsStepStatus
                                                          ::
                                                          !(Maybe
                                                              UpgradeStatus),
                                                          _gusrsUpgradeName ::
...
getUpgradeStatusResponse pResponseStatus_
  = GetUpgradeStatusResponse'{_gusrsStepStatus =
                                Nothing,
