...
newtype DeleteInboundCrossClusterSearchConnection = DeleteInboundCrossClusterSearchConnection'{_diccscCrossClusterSearchConnectionId
                                                                                               ::
                                                                                               Text}
...
deleteInboundCrossClusterSearchConnection
    :: Text -- ^ 'diccscCrossClusterSearchConnectionId'
    -> DeleteInboundCrossClusterSearchConnection
deleteInboundCrossClusterSearchConnection
  pCrossClusterSearchConnectionId_
  = DeleteInboundCrossClusterSearchConnection'{_diccscCrossClusterSearchConnectionId
                                                 =
                                                 pCrossClusterSearchConnectionId_}
...
data DeleteInboundCrossClusterSearchConnectionResponse = DeleteInboundCrossClusterSearchConnectionResponse'{_diccscirsCrossClusterSearchConnection
                                                                                                            ::
                                                                                                            !(Maybe
...
deleteInboundCrossClusterSearchConnectionResponse
    :: Int -- ^ 'diccscirsResponseStatus'
    -> DeleteInboundCrossClusterSearchConnectionResponse
deleteInboundCrossClusterSearchConnectionResponse
  pResponseStatus_
  = DeleteInboundCrossClusterSearchConnectionResponse'{_diccscirsCrossClusterSearchConnection
                                                         = Nothing,
                                                       _diccscirsResponseStatus
                                                         = pResponseStatus_}
