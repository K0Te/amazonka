...
newtype CancelElasticsearchServiceSoftwareUpdate = CancelElasticsearchServiceSoftwareUpdate'{_cessuDomainName
                                                                                             ::
                                                                                             Text}
...
cancelElasticsearchServiceSoftwareUpdate pDomainName_
  = CancelElasticsearchServiceSoftwareUpdate'{_cessuDomainName
                                                = pDomainName_}
...
data CancelElasticsearchServiceSoftwareUpdateResponse = CancelElasticsearchServiceSoftwareUpdateResponse'{_cessursServiceSoftwareOptions
                                                                                                          ::
                                                                                                          !(Maybe
...
cancelElasticsearchServiceSoftwareUpdateResponse
  pResponseStatus_
  = CancelElasticsearchServiceSoftwareUpdateResponse'{_cessursServiceSoftwareOptions
                                                        = Nothing,
                                                      _cessursResponseStatus =
                                                        pResponseStatus_}
