...
data DescribePackages = DescribePackages'{_dpFilters
...
describePackages
    :: DescribePackages
describePackages
  = DescribePackages'{_dpFilters = Nothing,
                      _dpNextToken = Nothing, _dpMaxResults = Nothing}
...
instance Hashable DescribePackages where

instance NFData DescribePackages where
...
data DescribePackagesResponse = DescribePackagesResponse'{_dprsPackageDetailsList
                                                          ::
                                                          !(Maybe
                                                              [PackageDetails]),
                                                          _dprsNextToken ::
...
describePackagesResponse pResponseStatus_
  = DescribePackagesResponse'{_dprsPackageDetailsList =
                                Nothing,
...
instance NFData DescribePackagesResponse where
