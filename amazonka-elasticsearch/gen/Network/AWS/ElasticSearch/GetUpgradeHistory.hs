...
data GetUpgradeHistory = GetUpgradeHistory'{_guhNextToken
                                            :: !(Maybe Text),
...
getUpgradeHistory pDomainName_
  = GetUpgradeHistory'{_guhNextToken = Nothing,
...
instance AWSPager GetUpgradeHistory where
        page rq rs
          ...
          | otherwise =
            Just $ rq & guhNextToken .~ rs ^. guhrsNextToken
...
instance Hashable GetUpgradeHistory where

instance NFData GetUpgradeHistory where
...
data GetUpgradeHistoryResponse = GetUpgradeHistoryResponse'{_guhrsNextToken
                                                            :: !(Maybe Text),
                                                            _guhrsUpgradeHistories
                                                            ::
                                                            !(Maybe
                                                                [UpgradeHistory]),
                                                            _guhrsResponseStatus
                                                            :: !Int}
...
getUpgradeHistoryResponse
    :: Int -- ^ 'guhrsResponseStatus'
    -> GetUpgradeHistoryResponse
getUpgradeHistoryResponse pResponseStatus_
  = GetUpgradeHistoryResponse'{_guhrsNextToken =
                                 Nothing,
...
instance NFData GetUpgradeHistoryResponse where
