...
data GetPackageVersionHistory = GetPackageVersionHistory'{_gpvhNextToken
                                                          :: !(Maybe Text),
                                                          _gpvhMaxResults ::
                                                          !(Maybe Int),
                                                          _gpvhPackageId ::
...
getPackageVersionHistory pPackageId_
  = GetPackageVersionHistory'{_gpvhNextToken = Nothing,
...
instance AWSRequest GetPackageVersionHistory where
        type Rs GetPackageVersionHistory =
             GetPackageVersionHistoryResponse
...
instance Hashable GetPackageVersionHistory where

instance NFData GetPackageVersionHistory where
...
instance ToPath GetPackageVersionHistory where
        toPath GetPackageVersionHistory'{..}
          = mconcat
              ["/2015-01-01/packages/", toBS _gpvhPackageId,
               "/history"]
...
data GetPackageVersionHistoryResponse = GetPackageVersionHistoryResponse'{_gpvhrsPackageId
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
getPackageVersionHistoryResponse
    :: Int -- ^ 'gpvhrsResponseStatus'
    -> GetPackageVersionHistoryResponse
getPackageVersionHistoryResponse pResponseStatus_
  = GetPackageVersionHistoryResponse'{_gpvhrsPackageId
                                        = Nothing,
                                      _gpvhrsPackageVersionHistoryList =
                                        Nothing,
