...
data DescribeWorkflowType = DescribeWorkflowType'{_dwtDomain
                                                  :: !Text,
                                                  _dwtWorkflowType ::
                                                  !WorkflowType}
...
describeWorkflowType pDomain_ pWorkflowType_
  = DescribeWorkflowType'{_dwtDomain = pDomain_,
...
data DescribeWorkflowTypeResponse = DescribeWorkflowTypeResponse'{_dwtrsResponseStatus
                                                                  :: !Int,
                                                                  _dwtrsTypeInfo
                                                                  ::
                                                                  !WorkflowTypeInfo,
...
describeWorkflowTypeResponse
    ...
    -> DescribeWorkflowTypeResponse
describeWorkflowTypeResponse pResponseStatus_
  pTypeInfo_ pConfiguration_
  = DescribeWorkflowTypeResponse'{_dwtrsResponseStatus
                                    = pResponseStatus_,
