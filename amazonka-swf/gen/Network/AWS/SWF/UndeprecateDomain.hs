...
newtype UndeprecateDomain = UndeprecateDomain'{_udName
                                               :: Text}
...
instance Hashable UndeprecateDomain where

instance NFData UndeprecateDomain where
...
instance NFData UndeprecateDomainResponse where
