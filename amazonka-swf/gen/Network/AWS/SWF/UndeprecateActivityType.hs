...
data UndeprecateActivityType = UndeprecateActivityType'{_uatDomain
                                                        :: !Text,
                                                        _uatActivityType ::
                                                        !ActivityType}
...
undeprecateActivityType
    :: Text -- ^ 'uatDomain'
    -> ActivityType -- ^ 'uatActivityType'
    -> UndeprecateActivityType
undeprecateActivityType pDomain_ pActivityType_
  = UndeprecateActivityType'{_uatDomain = pDomain_,
...
instance AWSRequest UndeprecateActivityType where
        type Rs UndeprecateActivityType =
             UndeprecateActivityTypeResponse
        request = postJSON swf
        response
          = receiveNull UndeprecateActivityTypeResponse'

instance Hashable UndeprecateActivityType where

instance NFData UndeprecateActivityType where
...
instance NFData UndeprecateActivityTypeResponse where
