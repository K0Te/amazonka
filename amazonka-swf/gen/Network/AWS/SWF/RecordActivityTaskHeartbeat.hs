...
data RecordActivityTaskHeartbeat = RecordActivityTaskHeartbeat'{_rathDetails
                                                                ::
                                                                !(Maybe Text),
                                                                _rathTaskToken
                                                                :: !Text}
...
recordActivityTaskHeartbeat pTaskToken_
  = RecordActivityTaskHeartbeat'{_rathDetails =
                                   Nothing,
...
data RecordActivityTaskHeartbeatResponse = RecordActivityTaskHeartbeatResponse'{_rathrsResponseStatus
                                                                                ::
                                                                                !Int,
                                                                                _rathrsCancelRequested
                                                                                ::
                                                                                !Bool}
...
recordActivityTaskHeartbeatResponse
    ...
    -> RecordActivityTaskHeartbeatResponse
recordActivityTaskHeartbeatResponse pResponseStatus_
  pCancelRequested_
  = RecordActivityTaskHeartbeatResponse'{_rathrsResponseStatus
                                           = pResponseStatus_,
                                         _rathrsCancelRequested =
                                           pCancelRequested_}
