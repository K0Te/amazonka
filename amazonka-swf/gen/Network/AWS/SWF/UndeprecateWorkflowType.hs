...
data UndeprecateWorkflowType = UndeprecateWorkflowType'{_uwtDomain
                                                        :: !Text,
                                                        _uwtWorkflowType ::
                                                        !WorkflowType}
...
undeprecateWorkflowType
    :: Text -- ^ 'uwtDomain'
    -> WorkflowType -- ^ 'uwtWorkflowType'
    -> UndeprecateWorkflowType
undeprecateWorkflowType pDomain_ pWorkflowType_
  = UndeprecateWorkflowType'{_uwtDomain = pDomain_,
...
instance AWSRequest UndeprecateWorkflowType where
        type Rs UndeprecateWorkflowType =
             UndeprecateWorkflowTypeResponse
        request = postJSON swf
        response
          = receiveNull UndeprecateWorkflowTypeResponse'

instance Hashable UndeprecateWorkflowType where

instance NFData UndeprecateWorkflowType where
...
instance NFData UndeprecateWorkflowTypeResponse where
