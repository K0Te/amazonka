...
data DeleteProvisionedConcurrencyConfig = DeleteProvisionedConcurrencyConfig'{_dpccFunctionName
                                                                              ::
                                                                              !Text,
                                                                              _dpccQualifier
                                                                              ::
...
deleteProvisionedConcurrencyConfig
    :: Text -- ^ 'dpccFunctionName'
    -> Text -- ^ 'dpccQualifier'
    -> DeleteProvisionedConcurrencyConfig
deleteProvisionedConcurrencyConfig pFunctionName_
  pQualifier_
  = DeleteProvisionedConcurrencyConfig'{_dpccFunctionName
                                          = pFunctionName_,
...
instance ToHeaders DeleteProvisionedConcurrencyConfig
         where
        toHeaders = const mempty

instance ToPath DeleteProvisionedConcurrencyConfig
         where
        toPath DeleteProvisionedConcurrencyConfig'{..}
          = mconcat
              ["/2019-09-30/functions/", toBS _dpccFunctionName,
               "/provisioned-concurrency"]

instance ToQuery DeleteProvisionedConcurrencyConfig
         where
