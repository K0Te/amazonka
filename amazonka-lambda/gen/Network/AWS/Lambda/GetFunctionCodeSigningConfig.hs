...
newtype GetFunctionCodeSigningConfig = GetFunctionCodeSigningConfig'{_gfcscFunctionName
                                                                     :: Text}
...
getFunctionCodeSigningConfig
    :: Text -- ^ 'gfcscFunctionName'
    -> GetFunctionCodeSigningConfig
getFunctionCodeSigningConfig pFunctionName_
  = GetFunctionCodeSigningConfig'{_gfcscFunctionName =
                                    pFunctionName_}
...
instance AWSRequest GetFunctionCodeSigningConfig
         where
...
instance Hashable GetFunctionCodeSigningConfig where

instance NFData GetFunctionCodeSigningConfig where
...
instance ToPath GetFunctionCodeSigningConfig where
        toPath GetFunctionCodeSigningConfig'{..}
          = mconcat
              ["/2020-06-30/functions/", toBS _gfcscFunctionName,
               "/code-signing-config"]
...
data GetFunctionCodeSigningConfigResponse = GetFunctionCodeSigningConfigResponse'{_gfcscrsResponseStatus
                                                                                  ::
                                                                                  !Int,
...
getFunctionCodeSigningConfigResponse
    :: Int -- ^ 'gfcscrsResponseStatus'
    -> Text -- ^ 'gfcscrsCodeSigningConfigARN'
    -> Text -- ^ 'gfcscrsFunctionName'
    -> GetFunctionCodeSigningConfigResponse
getFunctionCodeSigningConfigResponse pResponseStatus_
  pCodeSigningConfigARN_ pFunctionName_
  = GetFunctionCodeSigningConfigResponse'{_gfcscrsResponseStatus
                                            = pResponseStatus_,
                                          _gfcscrsCodeSigningConfigARN =
