...
data DeleteFunctionEventInvokeConfig = DeleteFunctionEventInvokeConfig'{_dfeicQualifier
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _dfeicFunctionName
...
deleteFunctionEventInvokeConfig
    :: Text -- ^ 'dfeicFunctionName'
    -> DeleteFunctionEventInvokeConfig
deleteFunctionEventInvokeConfig pFunctionName_
  = DeleteFunctionEventInvokeConfig'{_dfeicQualifier =
                                       Nothing,
...
instance AWSRequest DeleteFunctionEventInvokeConfig
         where
        type Rs DeleteFunctionEventInvokeConfig =
             DeleteFunctionEventInvokeConfigResponse
...
instance NFData DeleteFunctionEventInvokeConfig where

instance ToHeaders DeleteFunctionEventInvokeConfig
         where
...
instance ToPath DeleteFunctionEventInvokeConfig where
        toPath DeleteFunctionEventInvokeConfig'{..}
          = mconcat
              ["/2019-09-25/functions/", toBS _dfeicFunctionName,
               "/event-invoke-config"]

instance ToQuery DeleteFunctionEventInvokeConfig
         where
