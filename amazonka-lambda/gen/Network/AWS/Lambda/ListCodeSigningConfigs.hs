...
data ListCodeSigningConfigs = ListCodeSigningConfigs'{_lcscMarker
                                                      :: !(Maybe Text),
                                                      _lcscMaxItems ::
                                                      !(Maybe Nat)}
...
listCodeSigningConfigs
    :: ListCodeSigningConfigs
listCodeSigningConfigs
  = ListCodeSigningConfigs'{_lcscMarker = Nothing,
...
instance AWSPager ListCodeSigningConfigs where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lcscMarker .~ rs ^. lcscrsNextMarker

instance AWSRequest ListCodeSigningConfigs where
        type Rs ListCodeSigningConfigs =
             ListCodeSigningConfigsResponse
        request = get lambda
        response
          = receiveJSON
...
instance Hashable ListCodeSigningConfigs where

instance NFData ListCodeSigningConfigs where
...
data ListCodeSigningConfigsResponse = ListCodeSigningConfigsResponse'{_lcscrsCodeSigningConfigs
                                                                      ::
                                                                      !(Maybe
                                                                          [CodeSigningConfig]),
                                                                      _lcscrsNextMarker
...
listCodeSigningConfigsResponse
    :: Int -- ^ 'lcscrsResponseStatus'
    -> ListCodeSigningConfigsResponse
listCodeSigningConfigsResponse pResponseStatus_
  = ListCodeSigningConfigsResponse'{_lcscrsCodeSigningConfigs
                                      = Nothing,
...
instance NFData ListCodeSigningConfigsResponse where
