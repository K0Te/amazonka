...
data ListLayerVersions = ListLayerVersions'{_llvCompatibleRuntime
                                            :: !(Maybe Runtime),
...
listLayerVersions pLayerName_
  = ListLayerVersions'{_llvCompatibleRuntime = Nothing,
                       _llvMarker = Nothing, _llvMaxItems = Nothing,
...
data ListLayerVersionsResponse = ListLayerVersionsResponse'{_llvrsLayerVersions
                                                            ::
                                                            !(Maybe
                                                                [LayerVersionsListItem]),
                                                            _llvrsNextMarker ::
                                                            !(Maybe Text),
                                                            _llvrsResponseStatus
                                                            :: !Int}
...
listLayerVersionsResponse pResponseStatus_
  = ListLayerVersionsResponse'{_llvrsLayerVersions =
                                 Nothing,
