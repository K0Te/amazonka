...
data UpdateFunctionEventInvokeConfig = UpdateFunctionEventInvokeConfig'{_ufeicMaximumEventAgeInSeconds
                                                                        ::
                                                                        !(Maybe
                                                                            Nat),
...
updateFunctionEventInvokeConfig
    :: Text -- ^ 'ufeicFunctionName'
    -> UpdateFunctionEventInvokeConfig
updateFunctionEventInvokeConfig pFunctionName_
  = UpdateFunctionEventInvokeConfig'{_ufeicMaximumEventAgeInSeconds
                                       = Nothing,
...
instance AWSRequest UpdateFunctionEventInvokeConfig
         where
...
instance NFData UpdateFunctionEventInvokeConfig where

instance ToHeaders UpdateFunctionEventInvokeConfig
         where
...
instance ToPath UpdateFunctionEventInvokeConfig where
        toPath UpdateFunctionEventInvokeConfig'{..}
          = mconcat
              ["/2019-09-25/functions/", toBS _ufeicFunctionName,
               "/event-invoke-config"]

instance ToQuery UpdateFunctionEventInvokeConfig
         where
