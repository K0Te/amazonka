...
--
-- * 'uImageURI' - URI of a container image in the Amazon ECR registry.
--
...
updateFunctionCode pFunctionName_
  = UpdateFunctionCode'{_uS3ObjectVersion = Nothing,
                        ...
                        _uImageURI = Nothing, _uS3Bucket = Nothing,
                        _uDryRun = Nothing, _uRevisionId = Nothing,
                        _uPublish = Nothing, _uFunctionName = pFunctionName_}
...
uImageURI :: Lens' UpdateFunctionCode (Maybe Text)
uImageURI = lens _uImageURI (\ s a -> s{_uImageURI = a})
