...
data AddLayerVersionPermission = AddLayerVersionPermission'{_alvpRevisionId
                                                            :: !(Maybe Text),
                                                            _alvpOrganizationId
                                                            :: !(Maybe Text),
                                                            _alvpLayerName ::
...
addLayerVersionPermission
    ...
    -> Text -- ^ 'alvpPrincipal'
    -> AddLayerVersionPermission
addLayerVersionPermission pLayerName_ pVersionNumber_
  pStatementId_ pAction_ pPrincipal_
  = AddLayerVersionPermission'{_alvpRevisionId =
                                 Nothing,
...
data AddLayerVersionPermissionResponse = AddLayerVersionPermissionResponse'{_alvprsStatement
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _alvprsRevisionId
...
addLayerVersionPermissionResponse pResponseStatus_
  = AddLayerVersionPermissionResponse'{_alvprsStatement
                                         = Nothing,
