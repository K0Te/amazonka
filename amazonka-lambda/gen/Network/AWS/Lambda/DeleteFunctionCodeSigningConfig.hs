...
newtype DeleteFunctionCodeSigningConfig = DeleteFunctionCodeSigningConfig'{_dfcscFunctionName
                                                                           ::
                                                                           Text}
...
deleteFunctionCodeSigningConfig
    :: Text -- ^ 'dfcscFunctionName'
    -> DeleteFunctionCodeSigningConfig
deleteFunctionCodeSigningConfig pFunctionName_
  = DeleteFunctionCodeSigningConfig'{_dfcscFunctionName
                                       = pFunctionName_}
...
instance AWSRequest DeleteFunctionCodeSigningConfig
         where
...
instance NFData DeleteFunctionCodeSigningConfig where

instance ToHeaders DeleteFunctionCodeSigningConfig
         where
...
instance ToPath DeleteFunctionCodeSigningConfig where
        toPath DeleteFunctionCodeSigningConfig'{..}
          = mconcat
              ["/2020-06-30/functions/", toBS _dfcscFunctionName,
               "/code-signing-config"]

instance ToQuery DeleteFunctionCodeSigningConfig
         where
