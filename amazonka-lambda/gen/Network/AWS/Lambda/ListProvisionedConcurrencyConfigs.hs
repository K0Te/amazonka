...
data ListProvisionedConcurrencyConfigs = ListProvisionedConcurrencyConfigs'{_lpccMarker
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _lpccMaxItems
...
listProvisionedConcurrencyConfigs
    :: Text -- ^ 'lpccFunctionName'
    -> ListProvisionedConcurrencyConfigs
listProvisionedConcurrencyConfigs pFunctionName_
  = ListProvisionedConcurrencyConfigs'{_lpccMarker =
                                         Nothing,
...
instance AWSPager ListProvisionedConcurrencyConfigs
         where
        page rq rs
          | stop (rs ^. lpccrsNextMarker) = Nothing
          | stop (rs ^. lpccrsProvisionedConcurrencyConfigs) =
            Nothing
          | otherwise =
            Just $ rq & lpccMarker .~ rs ^. lpccrsNextMarker

instance AWSRequest ListProvisionedConcurrencyConfigs
         where
...
instance ToHeaders ListProvisionedConcurrencyConfigs
         where
        toHeaders = const mempty

instance ToPath ListProvisionedConcurrencyConfigs
         where
        toPath ListProvisionedConcurrencyConfigs'{..}
          = mconcat
              ["/2019-09-30/functions/", toBS _lpccFunctionName,
               "/provisioned-concurrency"]

instance ToQuery ListProvisionedConcurrencyConfigs
         where
        toQuery ListProvisionedConcurrencyConfigs'{..}
          = mconcat
              ["Marker" =: _lpccMarker,
               "MaxItems" =: _lpccMaxItems, "List=ALL"]

-- | /See:/ 'listProvisionedConcurrencyConfigsResponse' smart constructor.
data ListProvisionedConcurrencyConfigsResponse = ListProvisionedConcurrencyConfigsResponse'{_lpccrsProvisionedConcurrencyConfigs
                                                                                            ::
                                                                                            !(Maybe
...
listProvisionedConcurrencyConfigsResponse
    :: Int -- ^ 'lpccrsResponseStatus'
    -> ListProvisionedConcurrencyConfigsResponse
listProvisionedConcurrencyConfigsResponse
  pResponseStatus_
  = ListProvisionedConcurrencyConfigsResponse'{_lpccrsProvisionedConcurrencyConfigs
                                                 = Nothing,
