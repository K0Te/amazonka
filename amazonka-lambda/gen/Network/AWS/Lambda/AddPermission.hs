...
data AddPermission = AddPermission'{_apSourceAccount
                                    :: !(Maybe Text),
                                    ...
                                    _apStatementId :: !Text, _apAction :: !Text,
                                    _apPrincipal :: !Text}
...
addPermission
    ...
    -> Text -- ^ 'apPrincipal'
    -> AddPermission
addPermission pFunctionName_ pStatementId_ pAction_
  pPrincipal_
  = AddPermission'{_apSourceAccount = Nothing,
                   _apEventSourceToken = Nothing,
                   _apSourceARN = Nothing, _apQualifier = Nothing,
                   _apRevisionId = Nothing,
                   _apFunctionName = pFunctionName_,
                   _apStatementId = pStatementId_, _apAction = pAction_,
...
data AddPermissionResponse = AddPermissionResponse'{_aprsStatement
                                                    :: !(Maybe Text),
...
addPermissionResponse pResponseStatus_
  = AddPermissionResponse'{_aprsStatement = Nothing,
