...
data PutFunctionCodeSigningConfig = PutFunctionCodeSigningConfig'{_pfcscCodeSigningConfigARN
                                                                  :: !Text,
                                                                  _pfcscFunctionName
                                                                  :: !Text}
...
putFunctionCodeSigningConfig
    :: Text -- ^ 'pfcscCodeSigningConfigARN'
    -> Text -- ^ 'pfcscFunctionName'
    -> PutFunctionCodeSigningConfig
putFunctionCodeSigningConfig pCodeSigningConfigARN_
  pFunctionName_
  = PutFunctionCodeSigningConfig'{_pfcscCodeSigningConfigARN
...
instance AWSRequest PutFunctionCodeSigningConfig
         where
        type Rs PutFunctionCodeSigningConfig =
             PutFunctionCodeSigningConfigResponse
...
instance Hashable PutFunctionCodeSigningConfig where

instance NFData PutFunctionCodeSigningConfig where
...
instance ToPath PutFunctionCodeSigningConfig where
        toPath PutFunctionCodeSigningConfig'{..}
          = mconcat
              ["/2020-06-30/functions/", toBS _pfcscFunctionName,
               "/code-signing-config"]
...
data PutFunctionCodeSigningConfigResponse = PutFunctionCodeSigningConfigResponse'{_pfcscrsResponseStatus
                                                                                  ::
                                                                                  !Int,
...
putFunctionCodeSigningConfigResponse
    :: Int -- ^ 'pfcscrsResponseStatus'
    -> Text -- ^ 'pfcscrsCodeSigningConfigARN'
    -> Text -- ^ 'pfcscrsFunctionName'
    -> PutFunctionCodeSigningConfigResponse
putFunctionCodeSigningConfigResponse pResponseStatus_
  pCodeSigningConfigARN_ pFunctionName_
  = PutFunctionCodeSigningConfigResponse'{_pfcscrsResponseStatus
                                            = pResponseStatus_,
                                          _pfcscrsCodeSigningConfigARN =
                                            pCodeSigningConfigARN_,
