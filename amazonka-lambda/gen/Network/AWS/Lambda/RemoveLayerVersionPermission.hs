...
data RemoveLayerVersionPermission = RemoveLayerVersionPermission'{_rlvpRevisionId
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _rlvpLayerName
                                                                  :: !Text,
...
removeLayerVersionPermission
    ...
    -> RemoveLayerVersionPermission
removeLayerVersionPermission pLayerName_
  pVersionNumber_ pStatementId_
  = RemoveLayerVersionPermission'{_rlvpRevisionId =
                                    Nothing,
