...
data PutFunctionEventInvokeConfig = PutFunctionEventInvokeConfig'{_pfeicMaximumEventAgeInSeconds
                                                                  ::
                                                                  !(Maybe Nat),
...
putFunctionEventInvokeConfig
    :: Text -- ^ 'pfeicFunctionName'
    -> PutFunctionEventInvokeConfig
putFunctionEventInvokeConfig pFunctionName_
  = PutFunctionEventInvokeConfig'{_pfeicMaximumEventAgeInSeconds
                                    = Nothing,
...
instance AWSRequest PutFunctionEventInvokeConfig
         where
...
instance Hashable PutFunctionEventInvokeConfig where

instance NFData PutFunctionEventInvokeConfig where
...
instance ToPath PutFunctionEventInvokeConfig where
        toPath PutFunctionEventInvokeConfig'{..}
          = mconcat
              ["/2019-09-25/functions/", toBS _pfeicFunctionName,
               "/event-invoke-config"]
