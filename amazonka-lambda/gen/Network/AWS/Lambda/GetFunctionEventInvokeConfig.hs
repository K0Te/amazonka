...
data GetFunctionEventInvokeConfig = GetFunctionEventInvokeConfig'{_gfeicQualifier
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _gfeicFunctionName
                                                                  :: !Text}
...
getFunctionEventInvokeConfig
    :: Text -- ^ 'gfeicFunctionName'
    -> GetFunctionEventInvokeConfig
getFunctionEventInvokeConfig pFunctionName_
  = GetFunctionEventInvokeConfig'{_gfeicQualifier =
                                    Nothing,
...
instance AWSRequest GetFunctionEventInvokeConfig
         where
...
instance Hashable GetFunctionEventInvokeConfig where

instance NFData GetFunctionEventInvokeConfig where
...
instance ToPath GetFunctionEventInvokeConfig where
        toPath GetFunctionEventInvokeConfig'{..}
          = mconcat
              ["/2019-09-25/functions/", toBS _gfeicFunctionName,
               "/event-invoke-config"]
