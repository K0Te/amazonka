...
data ListEventSourceMappings = ListEventSourceMappings'{_lesmEventSourceARN
                                                        :: !(Maybe Text),
                                                        _lesmMarker ::
                                                        !(Maybe Text),
                                                        _lesmMaxItems ::
...
listEventSourceMappings
    :: ListEventSourceMappings
listEventSourceMappings
  = ListEventSourceMappings'{_lesmEventSourceARN =
                               Nothing,
                             _lesmMarker = Nothing, _lesmMaxItems = Nothing,
...
data ListEventSourceMappingsResponse = ListEventSourceMappingsResponse'{_lesmrsEventSourceMappings
                                                                        ::
                                                                        !(Maybe
...
listEventSourceMappingsResponse pResponseStatus_
  = ListEventSourceMappingsResponse'{_lesmrsEventSourceMappings
                                       = Nothing,
