...
data CreateFunction = CreateFunction'{_cfMemorySize
                                      :: !(Maybe Nat),
...
--
-- * 'cfImageConfig' - Configuration values that override the container image Dockerfile.
--
...
createFunction pFunctionName_ pRole_ pCode_
  = CreateFunction'{_cfMemorySize = Nothing,
                    _cfRuntime = Nothing, _cfKMSKeyARN = Nothing,
                    _cfPackageType = Nothing,
                    _cfFileSystemConfigs = Nothing,
                    _cfEnvironment = Nothing, _cfImageConfig = Nothing,
                    _cfDeadLetterConfig = Nothing,
                    _cfCodeSigningConfigARN = Nothing,
                    _cfVPCConfig = Nothing, _cfLayers = Nothing,
                    _cfHandler = Nothing, _cfTimeout = Nothing,
                    _cfTracingConfig = Nothing, _cfDescription = Nothing,
                    _cfTags = Nothing, _cfPublish = Nothing,
                    _cfFunctionName = pFunctionName_, _cfRole = pRole_,
                    _cfCode = pCode_}
          ...
          = object
              (catMaybes
                 [("MemorySize" .=) <$> _cfMemorySize,
                  ...
                  Just ("Role" .= _cfRole), Just ("Code" .= _cfCode)])
