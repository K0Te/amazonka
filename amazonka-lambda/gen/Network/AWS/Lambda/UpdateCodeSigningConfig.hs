...
data UpdateCodeSigningConfig = UpdateCodeSigningConfig'{_ucscAllowedPublishers
                                                        ::
                                                        !(Maybe
                                                            AllowedPublishers),
...
updateCodeSigningConfig
    :: Text -- ^ 'ucscCodeSigningConfigARN'
    -> UpdateCodeSigningConfig
updateCodeSigningConfig pCodeSigningConfigARN_
  = UpdateCodeSigningConfig'{_ucscAllowedPublishers =
                               Nothing,
...
instance AWSRequest UpdateCodeSigningConfig where
        type Rs UpdateCodeSigningConfig =
             UpdateCodeSigningConfigResponse
...
instance Hashable UpdateCodeSigningConfig where

instance NFData UpdateCodeSigningConfig where
...
data UpdateCodeSigningConfigResponse = UpdateCodeSigningConfigResponse'{_ucscrsResponseStatus
                                                                        :: !Int,
...
updateCodeSigningConfigResponse
    :: Int -- ^ 'ucscrsResponseStatus'
    -> CodeSigningConfig -- ^ 'ucscrsCodeSigningConfig'
    -> UpdateCodeSigningConfigResponse
updateCodeSigningConfigResponse pResponseStatus_
  pCodeSigningConfig_
  = UpdateCodeSigningConfigResponse'{_ucscrsResponseStatus
                                       = pResponseStatus_,
                                     _ucscrsCodeSigningConfig =
                                       pCodeSigningConfig_}
...
instance NFData UpdateCodeSigningConfigResponse where
