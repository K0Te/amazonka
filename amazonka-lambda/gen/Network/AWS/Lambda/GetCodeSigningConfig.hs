...
newtype GetCodeSigningConfig = GetCodeSigningConfig'{_gcscCodeSigningConfigARN
                                                     :: Text}
...
getCodeSigningConfig
    :: Text -- ^ 'gcscCodeSigningConfigARN'
    -> GetCodeSigningConfig
getCodeSigningConfig pCodeSigningConfigARN_
  = GetCodeSigningConfig'{_gcscCodeSigningConfigARN =
...
instance Hashable GetCodeSigningConfig where

instance NFData GetCodeSigningConfig where
...
data GetCodeSigningConfigResponse = GetCodeSigningConfigResponse'{_gcscrsResponseStatus
                                                                  :: !Int,
...
getCodeSigningConfigResponse
    :: Int -- ^ 'gcscrsResponseStatus'
    -> CodeSigningConfig -- ^ 'gcscrsCodeSigningConfig'
    -> GetCodeSigningConfigResponse
getCodeSigningConfigResponse pResponseStatus_
  pCodeSigningConfig_
  = GetCodeSigningConfigResponse'{_gcscrsResponseStatus
                                    = pResponseStatus_,
                                  _gcscrsCodeSigningConfig =
                                    pCodeSigningConfig_}
...
instance NFData GetCodeSigningConfigResponse where
