...
data ListLayers = ListLayers'{_llCompatibleRuntime ::
                              !(Maybe Runtime),
...
listLayers
    :: ListLayers
listLayers
  = ListLayers'{_llCompatibleRuntime = Nothing,
                _llMarker = Nothing, _llMaxItems = Nothing}
...
data ListLayersResponse = ListLayersResponse'{_llrsNextMarker
                                              :: !(Maybe Text),
                                              _llrsLayers ::
...
listLayersResponse pResponseStatus_
  = ListLayersResponse'{_llrsNextMarker = Nothing,
                        _llrsLayers = Nothing,
