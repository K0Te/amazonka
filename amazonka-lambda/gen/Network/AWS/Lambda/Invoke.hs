...
invoke pFunctionName_ pPayload_
  = Invoke'{_iInvocationType = Nothing,
            _iLogType = Nothing, _iQualifier = Nothing,
...
data InvokeResponse = InvokeResponse'{_irsFunctionError
                                      :: !(Maybe Text),
...
invokeResponse pStatusCode_
  = InvokeResponse'{_irsFunctionError = Nothing,
                    _irsLogResult = Nothing, _irsPayload = Nothing,
