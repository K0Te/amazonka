...
data PutProvisionedConcurrencyConfig = PutProvisionedConcurrencyConfig'{_ppccFunctionName
                                                                        ::
                                                                        !Text,
                                                                        _ppccQualifier
                                                                        ::
...
putProvisionedConcurrencyConfig
    :: Text -- ^ 'ppccFunctionName'
    -> Text -- ^ 'ppccQualifier'
    -> Natural -- ^ 'ppccProvisionedConcurrentExecutions'
    -> PutProvisionedConcurrencyConfig
putProvisionedConcurrencyConfig pFunctionName_
  pQualifier_ pProvisionedConcurrentExecutions_
  = PutProvisionedConcurrencyConfig'{_ppccFunctionName
                                       = pFunctionName_,
...
instance AWSRequest PutProvisionedConcurrencyConfig
         where
...
instance NFData PutProvisionedConcurrencyConfig where

instance ToHeaders PutProvisionedConcurrencyConfig
         where
...
instance ToPath PutProvisionedConcurrencyConfig where
        toPath PutProvisionedConcurrencyConfig'{..}
          = mconcat
              ["/2019-09-30/functions/", toBS _ppccFunctionName,
               "/provisioned-concurrency"]

instance ToQuery PutProvisionedConcurrencyConfig
         where
...
data PutProvisionedConcurrencyConfigResponse = PutProvisionedConcurrencyConfigResponse'{_ppccrsStatus
                                                                                        ::
                                                                                        !(Maybe
...
putProvisionedConcurrencyConfigResponse
    :: Int -- ^ 'ppccrsResponseStatus'
    -> PutProvisionedConcurrencyConfigResponse
putProvisionedConcurrencyConfigResponse
  pResponseStatus_
  = PutProvisionedConcurrencyConfigResponse'{_ppccrsStatus
                                               = Nothing,
                                             _ppccrsRequestedProvisionedConcurrentExecutions
                                               = Nothing,
                                             _ppccrsAvailableProvisionedConcurrentExecutions
