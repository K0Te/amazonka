...
data ListFunctionsByCodeSigningConfig = ListFunctionsByCodeSigningConfig'{_lfbcscMarker
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _lfbcscMaxItems
...
listFunctionsByCodeSigningConfig
    :: Text -- ^ 'lfbcscCodeSigningConfigARN'
    -> ListFunctionsByCodeSigningConfig
listFunctionsByCodeSigningConfig
  pCodeSigningConfigARN_
  = ListFunctionsByCodeSigningConfig'{_lfbcscMarker =
                                        Nothing,
...
instance AWSPager ListFunctionsByCodeSigningConfig
         where
        page rq rs
          | stop (rs ^. lfbcscrsNextMarker) = Nothing
          | stop (rs ^. lfbcscrsFunctionARNs) = Nothing
          | otherwise =
            Just $ rq & lfbcscMarker .~ rs ^. lfbcscrsNextMarker

instance AWSRequest ListFunctionsByCodeSigningConfig
         where
...
instance ToHeaders ListFunctionsByCodeSigningConfig
         where
        toHeaders = const mempty

instance ToPath ListFunctionsByCodeSigningConfig
         where
        toPath ListFunctionsByCodeSigningConfig'{..}
          = mconcat
              ["/2020-04-22/code-signing-configs/",
               toBS _lfbcscCodeSigningConfigARN, "/functions"]

instance ToQuery ListFunctionsByCodeSigningConfig
         where
...
data ListFunctionsByCodeSigningConfigResponse = ListFunctionsByCodeSigningConfigResponse'{_lfbcscrsFunctionARNs
                                                                                          ::
                                                                                          !(Maybe
                                                                                              [Text]),
                                                                                          _lfbcscrsNextMarker
...
listFunctionsByCodeSigningConfigResponse
    :: Int -- ^ 'lfbcscrsResponseStatus'
    -> ListFunctionsByCodeSigningConfigResponse
listFunctionsByCodeSigningConfigResponse
  pResponseStatus_
  = ListFunctionsByCodeSigningConfigResponse'{_lfbcscrsFunctionARNs
                                                = Nothing,
