...
data PublishLayerVersion = PublishLayerVersion'{_plvLicenseInfo
                                                :: !(Maybe Text),
                                                _plvDescription ::
                                                !(Maybe Text),
...
publishLayerVersion pLayerName_ pContent_
  = PublishLayerVersion'{_plvLicenseInfo = Nothing,
                         _plvDescription = Nothing,
                         _plvCompatibleRuntimes = Nothing,
                         _plvLayerName = pLayerName_, _plvContent = pContent_}
...
data PublishLayerVersionResponse = PublishLayerVersionResponse'{_plvrsLayerVersionARN
                                                                ::
                                                                !(Maybe Text),
                                                                _plvrsContent ::
                                                                !(Maybe
...
publishLayerVersionResponse pResponseStatus_
  = PublishLayerVersionResponse'{_plvrsLayerVersionARN
                                   = Nothing,
