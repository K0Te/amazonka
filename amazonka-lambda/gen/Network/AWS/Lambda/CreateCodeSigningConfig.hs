...
data CreateCodeSigningConfig = CreateCodeSigningConfig'{_ccscCodeSigningPolicies
                                                        ::
                                                        !(Maybe
                                                            CodeSigningPolicies),
                                                        _ccscDescription ::
...
createCodeSigningConfig
    :: AllowedPublishers -- ^ 'ccscAllowedPublishers'
    -> CreateCodeSigningConfig
createCodeSigningConfig pAllowedPublishers_
  = CreateCodeSigningConfig'{_ccscCodeSigningPolicies =
                               Nothing,
...
instance AWSRequest CreateCodeSigningConfig where
        type Rs CreateCodeSigningConfig =
             CreateCodeSigningConfigResponse
...
instance Hashable CreateCodeSigningConfig where

instance NFData CreateCodeSigningConfig where
...
data CreateCodeSigningConfigResponse = CreateCodeSigningConfigResponse'{_ccscrsResponseStatus
                                                                        :: !Int,
...
createCodeSigningConfigResponse
    :: Int -- ^ 'ccscrsResponseStatus'
    -> CodeSigningConfig -- ^ 'ccscrsCodeSigningConfig'
    -> CreateCodeSigningConfigResponse
createCodeSigningConfigResponse pResponseStatus_
  pCodeSigningConfig_
  = CreateCodeSigningConfigResponse'{_ccscrsResponseStatus
                                       = pResponseStatus_,
                                     _ccscrsCodeSigningConfig =
                                       pCodeSigningConfig_}
...
instance NFData CreateCodeSigningConfigResponse where
