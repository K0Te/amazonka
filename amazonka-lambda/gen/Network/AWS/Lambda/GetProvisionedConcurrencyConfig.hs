...
data GetProvisionedConcurrencyConfig = GetProvisionedConcurrencyConfig'{_gpccFunctionName
                                                                        ::
                                                                        !Text,
                                                                        _gpccQualifier
                                                                        ::
...
getProvisionedConcurrencyConfig
    :: Text -- ^ 'gpccFunctionName'
    -> Text -- ^ 'gpccQualifier'
    -> GetProvisionedConcurrencyConfig
getProvisionedConcurrencyConfig pFunctionName_
  pQualifier_
  = GetProvisionedConcurrencyConfig'{_gpccFunctionName
                                       = pFunctionName_,
...
instance AWSRequest GetProvisionedConcurrencyConfig
         where
...
instance NFData GetProvisionedConcurrencyConfig where

instance ToHeaders GetProvisionedConcurrencyConfig
         where
...
instance ToPath GetProvisionedConcurrencyConfig where
        toPath GetProvisionedConcurrencyConfig'{..}
          = mconcat
              ["/2019-09-30/functions/", toBS _gpccFunctionName,
               "/provisioned-concurrency"]

instance ToQuery GetProvisionedConcurrencyConfig
         where
...
data GetProvisionedConcurrencyConfigResponse = GetProvisionedConcurrencyConfigResponse'{_gpccrsStatus
                                                                                        ::
                                                                                        !(Maybe
...
getProvisionedConcurrencyConfigResponse
    :: Int -- ^ 'gpccrsResponseStatus'
    -> GetProvisionedConcurrencyConfigResponse
getProvisionedConcurrencyConfigResponse
  pResponseStatus_
  = GetProvisionedConcurrencyConfigResponse'{_gpccrsStatus
                                               = Nothing,
                                             _gpccrsRequestedProvisionedConcurrentExecutions
                                               = Nothing,
                                             _gpccrsAvailableProvisionedConcurrentExecutions
