...
data CodeSigningConfig = CodeSigningConfig'{_cscDescription
                                            :: !(Maybe Text),
...
codeSigningConfig
    :: Text -- ^ 'cscCodeSigningConfigId'
    -> Text -- ^ 'cscCodeSigningConfigARN'
    -> AllowedPublishers -- ^ 'cscAllowedPublishers'
    -> CodeSigningPolicies -- ^ 'cscCodeSigningPolicies'
    -> Text -- ^ 'cscLastModified'
    -> CodeSigningConfig
codeSigningConfig pCodeSigningConfigId_
  pCodeSigningConfigARN_ pAllowedPublishers_
  pCodeSigningPolicies_ pLastModified_
  = CodeSigningConfig'{_cscDescription = Nothing,
...
instance Hashable CodeSigningConfig where

instance NFData CodeSigningConfig where
