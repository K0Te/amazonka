...
data SourceAccessConfiguration = SourceAccessConfiguration'{_sacURI
                                                            :: !(Maybe Text),
                                                            _sacType ::
                                                            !(Maybe
                                                                SourceAccessType)}
...
sourceAccessConfiguration
    :: SourceAccessConfiguration
sourceAccessConfiguration
  = SourceAccessConfiguration'{_sacURI = Nothing,
                               _sacType = Nothing}
...
instance FromJSON SourceAccessConfiguration where
        parseJSON
          = withObject "SourceAccessConfiguration"
              (\ x ->
                 SourceAccessConfiguration' <$>
                   (x .:? "URI") <*> (x .:? "Type"))

instance Hashable SourceAccessConfiguration where

instance NFData SourceAccessConfiguration where
