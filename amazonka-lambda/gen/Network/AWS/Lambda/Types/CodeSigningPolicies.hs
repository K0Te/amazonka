...
newtype CodeSigningPolicies = CodeSigningPolicies'{_cspUntrustedArtifactOnDeployment
...
codeSigningPolicies
    :: CodeSigningPolicies
codeSigningPolicies
  = CodeSigningPolicies'{_cspUntrustedArtifactOnDeployment
                           = Nothing}
...
instance FromJSON CodeSigningPolicies where
        parseJSON
          = withObject "CodeSigningPolicies"
              (\ x ->
                 CodeSigningPolicies' <$>
                   (x .:? "UntrustedArtifactOnDeployment"))

instance Hashable CodeSigningPolicies where

instance NFData CodeSigningPolicies where
