...
data Layer = Layer'{_lSigningProfileVersionARN ::
                    !(Maybe Text),
                    _lARN :: !(Maybe Text),
...
layer
    :: Layer
layer
  = Layer'{_lSigningProfileVersionARN = Nothing,
           _lARN = Nothing, _lSigningJobARN = Nothing,
           _lCodeSize = Nothing}
...
instance FromJSON Layer where
        parseJSON
          = withObject "Layer"
              (\ x ->
                 Layer' <$>
                   (x .:? "SigningProfileVersionArn") <*> (x .:? "Arn")
                     <*> (x .:? "SigningJobArn")
                     <*> (x .:? "CodeSize"))
