...
data GetLayerVersionPolicy = GetLayerVersionPolicy'{_glvpLayerName
                                                    :: !Text,
                                                    _glvpVersionNumber ::
                                                    !Integer}
...
getLayerVersionPolicy pLayerName_ pVersionNumber_
  = GetLayerVersionPolicy'{_glvpLayerName =
                             pLayerName_,
...
data GetLayerVersionPolicyResponse = GetLayerVersionPolicyResponse'{_glvprsPolicy
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _glvprsRevisionId
...
getLayerVersionPolicyResponse pResponseStatus_
  = GetLayerVersionPolicyResponse'{_glvprsPolicy =
                                     Nothing,
