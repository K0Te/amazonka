...
newtype DeleteCodeSigningConfig = DeleteCodeSigningConfig'{_dcscCodeSigningConfigARN
                                                           :: Text}
...
deleteCodeSigningConfig
    :: Text -- ^ 'dcscCodeSigningConfigARN'
    -> DeleteCodeSigningConfig
deleteCodeSigningConfig pCodeSigningConfigARN_
  = DeleteCodeSigningConfig'{_dcscCodeSigningConfigARN
...
instance AWSRequest DeleteCodeSigningConfig where
        type Rs DeleteCodeSigningConfig =
             DeleteCodeSigningConfigResponse
...
instance Hashable DeleteCodeSigningConfig where

instance NFData DeleteCodeSigningConfig where
...
newtype DeleteCodeSigningConfigResponse = DeleteCodeSigningConfigResponse'{_dcscrsResponseStatus
                                                                           ::
                                                                           Int}
...
deleteCodeSigningConfigResponse pResponseStatus_
  = DeleteCodeSigningConfigResponse'{_dcscrsResponseStatus
                                       = pResponseStatus_}
...
instance NFData DeleteCodeSigningConfigResponse where
