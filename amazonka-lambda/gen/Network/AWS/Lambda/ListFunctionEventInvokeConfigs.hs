...
data ListFunctionEventInvokeConfigs = ListFunctionEventInvokeConfigs'{_lfeicMarker
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _lfeicMaxItems
...
listFunctionEventInvokeConfigs
    :: Text -- ^ 'lfeicFunctionName'
    -> ListFunctionEventInvokeConfigs
listFunctionEventInvokeConfigs pFunctionName_
  = ListFunctionEventInvokeConfigs'{_lfeicMarker =
                                      Nothing,
...
instance AWSPager ListFunctionEventInvokeConfigs
         where
        page rq rs
          | stop (rs ^. lfeicrsNextMarker) = Nothing
          | stop (rs ^. lfeicrsFunctionEventInvokeConfigs) =
            Nothing
          | otherwise =
            Just $ rq & lfeicMarker .~ rs ^. lfeicrsNextMarker

instance AWSRequest ListFunctionEventInvokeConfigs
         where
...
instance NFData ListFunctionEventInvokeConfigs where

instance ToHeaders ListFunctionEventInvokeConfigs
         where
...
instance ToPath ListFunctionEventInvokeConfigs where
        toPath ListFunctionEventInvokeConfigs'{..}
          = mconcat
              ["/2019-09-25/functions/", toBS _lfeicFunctionName,
...
data ListFunctionEventInvokeConfigsResponse = ListFunctionEventInvokeConfigsResponse'{_lfeicrsFunctionEventInvokeConfigs
                                                                                      ::
                                                                                      !(Maybe
...
listFunctionEventInvokeConfigsResponse
    :: Int -- ^ 'lfeicrsResponseStatus'
    -> ListFunctionEventInvokeConfigsResponse
listFunctionEventInvokeConfigsResponse
  pResponseStatus_
  = ListFunctionEventInvokeConfigsResponse'{_lfeicrsFunctionEventInvokeConfigs
                                              = Nothing,
