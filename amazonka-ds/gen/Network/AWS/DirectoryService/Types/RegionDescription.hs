...
data RegionDescription = RegionDescription'{_rdStatus
...
regionDescription
    :: RegionDescription
regionDescription
  = RegionDescription'{_rdStatus = Nothing,
                       _rdDirectoryId = Nothing, _rdRegionName = Nothing,
                       _rdDesiredNumberOfDomainControllers = Nothing,
                       _rdRegionType = Nothing, _rdLaunchTime = Nothing,
...
instance Hashable RegionDescription where

instance NFData RegionDescription where
