...
newtype ClientCertAuthSettings = ClientCertAuthSettings'{_ccasOCSPURL
                                                         :: Maybe Text}
...
instance FromJSON ClientCertAuthSettings where
        parseJSON
          = withObject "ClientCertAuthSettings"
              (\ x ->
                 ClientCertAuthSettings' <$> (x .:? "OCSPUrl"))

instance Hashable ClientCertAuthSettings where

instance NFData ClientCertAuthSettings where
