...
data DirectoryDescription = DirectoryDescription'{_ddEdition
...
directoryDescription
    :: DirectoryDescription
directoryDescription
  = DirectoryDescription'{_ddEdition = Nothing,
                          _ddRadiusStatus = Nothing, _ddStage = Nothing,
                          _ddDirectoryId = Nothing, _ddAccessURL = Nothing,
                          _ddShortName = Nothing, _ddRegionsInfo = Nothing,
                          _ddSize = Nothing,
                          _ddDesiredNumberOfDomainControllers = Nothing,
                          _ddRadiusSettings = Nothing, _ddLaunchTime = Nothing,
                          _ddAlias = Nothing, _ddShareStatus = Nothing,
                          _ddName = Nothing, _ddShareMethod = Nothing,
                          _ddStageLastUpdatedDateTime = Nothing,
                          _ddSSOEnabled = Nothing, _ddDNSIPAddrs = Nothing,
                          _ddVPCSettings = Nothing, _ddType = Nothing,
                          _ddStageReason = Nothing,
                          _ddConnectSettings = Nothing,
                          _ddOwnerDirectoryDescription = Nothing,
                          _ddDescription = Nothing, _ddShareNotes = Nothing}
