...
data AddRegion = AddRegion'{_arDirectoryId :: !Text,
                            _arRegionName :: !Text,
...
addRegion
    :: Text -- ^ 'arDirectoryId'
    -> Text -- ^ 'arRegionName'
    -> DirectoryVPCSettings -- ^ 'arVPCSettings'
    -> AddRegion
addRegion pDirectoryId_ pRegionName_ pVPCSettings_
  = AddRegion'{_arDirectoryId = pDirectoryId_,
...
instance Hashable AddRegion where

instance NFData AddRegion where
...
newtype AddRegionResponse = AddRegionResponse'{_arrsResponseStatus
                                               :: Int}
                              deriving (Eq, Read, Show, Data, Typeable, Generic)
...
addRegionResponse pResponseStatus_
  = AddRegionResponse'{_arrsResponseStatus =
                         pResponseStatus_}
...
instance NFData AddRegionResponse where
