...
data DescribeRegions = DescribeRegions'{_drsRegionName
                                        :: !(Maybe Text),
...
describeRegions pDirectoryId_
  = DescribeRegions'{_drsRegionName = Nothing,
...
data DescribeRegionsResponse = DescribeRegionsResponse'{_drrsNextToken
                                                        :: !(Maybe Text),
...
--
-- * 'drrsRegionsDescription' - List of Region information related to the directory for each replicated Region.
--
...
describeRegionsResponse pResponseStatus_
  = DescribeRegionsResponse'{_drrsNextToken = Nothing,
