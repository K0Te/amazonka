...
newtype RemoveRegion = RemoveRegion'{_rrDirectoryId
                                     :: Text}
...
instance Hashable RemoveRegion where

instance NFData RemoveRegion where
...
newtype RemoveRegionResponse = RemoveRegionResponse'{_rrrsResponseStatus
                                                     :: Int}
...
removeRegionResponse pResponseStatus_
  = RemoveRegionResponse'{_rrrsResponseStatus =
                            pResponseStatus_}
...
instance NFData RemoveRegionResponse where
