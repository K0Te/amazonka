...
data EnableClientAuthentication = EnableClientAuthentication'{_ecaDirectoryId
                                                              :: !Text,
                                                              _ecaType ::
...
enableClientAuthentication
    :: Text -- ^ 'ecaDirectoryId'
    -> ClientAuthenticationType -- ^ 'ecaType'
    -> EnableClientAuthentication
enableClientAuthentication pDirectoryId_ pType_
  = EnableClientAuthentication'{_ecaDirectoryId =
                                  pDirectoryId_,
                                _ecaType = pType_}
...
instance AWSRequest EnableClientAuthentication where
        type Rs EnableClientAuthentication =
             EnableClientAuthenticationResponse
...
instance Hashable EnableClientAuthentication where

instance NFData EnableClientAuthentication where
...
newtype EnableClientAuthenticationResponse = EnableClientAuthenticationResponse'{_ecarsResponseStatus
                                                                                 ::
                                                                                 Int}
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'ecarsResponseStatus' - -- | The response status code.
enableClientAuthenticationResponse
    :: Int -- ^ 'ecarsResponseStatus'
    -> EnableClientAuthenticationResponse
enableClientAuthenticationResponse pResponseStatus_
  = EnableClientAuthenticationResponse'{_ecarsResponseStatus
                                          = pResponseStatus_}

-- | -- | The response status code.
ecarsResponseStatus :: Lens' EnableClientAuthenticationResponse Int
ecarsResponseStatus = lens _ecarsResponseStatus (\ s a -> s{_ecarsResponseStatus = a})
