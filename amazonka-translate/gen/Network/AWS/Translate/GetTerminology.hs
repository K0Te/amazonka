...
data GetTerminology = GetTerminology'{_gtName ::
                                      !Text,
...
data GetTerminologyResponse = GetTerminologyResponse'{_gtrsTerminologyProperties
                                                      ::
                                                      !(Maybe
                                                          TerminologyProperties),
                                                      _gtrsTerminologyDataLocation
                                                      ::
                                                      !(Maybe
...
getTerminologyResponse pResponseStatus_
  = GetTerminologyResponse'{_gtrsTerminologyProperties
                              = Nothing,
