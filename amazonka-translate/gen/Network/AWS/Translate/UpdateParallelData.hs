...
data UpdateParallelData = UpdateParallelData'{_updDescription
                                              :: !(Maybe Text),
                                              _updName :: !Text,
...
updateParallelData
    :: Text -- ^ 'updName'
    -> ParallelDataConfig -- ^ 'updParallelDataConfig'
    -> Text -- ^ 'updClientToken'
    -> UpdateParallelData
updateParallelData pName_ pParallelDataConfig_
  pClientToken_
  = UpdateParallelData'{_updDescription = Nothing,
                        _updName = pName_,
...
instance Hashable UpdateParallelData where

instance NFData UpdateParallelData where
...
data UpdateParallelDataResponse = UpdateParallelDataResponse'{_updrsStatus
                                                              ::
                                                              !(Maybe
                                                                  ParallelDataStatus),
                                                              _updrsName ::
...
updateParallelDataResponse pResponseStatus_
  = UpdateParallelDataResponse'{_updrsStatus = Nothing,
                                _updrsName = Nothing,
...
instance NFData UpdateParallelDataResponse where
