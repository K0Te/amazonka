...
data ImportTerminology = ImportTerminology'{_itEncryptionKey
                                            :: !(Maybe EncryptionKey),
...
importTerminology
    :: Text -- ^ 'itName'
    -> MergeStrategy -- ^ 'itMergeStrategy'
    -> TerminologyData -- ^ 'itTerminologyData'
    -> ImportTerminology
importTerminology pName_ pMergeStrategy_
  pTerminologyData_
  = ImportTerminology'{_itEncryptionKey = Nothing,
                       _itDescription = Nothing, _itName = pName_,
...
instance Hashable ImportTerminology where

instance NFData ImportTerminology where
...
data ImportTerminologyResponse = ImportTerminologyResponse'{_itrsTerminologyProperties
                                                            ::
                                                            !(Maybe
...
importTerminologyResponse
    :: Int -- ^ 'itrsResponseStatus'
    -> ImportTerminologyResponse
importTerminologyResponse pResponseStatus_
  = ImportTerminologyResponse'{_itrsTerminologyProperties
                                 = Nothing,
...
instance NFData ImportTerminologyResponse where
