...
data CreateParallelData = CreateParallelData'{_cpdEncryptionKey
                                              :: !(Maybe EncryptionKey),
...
createParallelData
    :: Text -- ^ 'cpdName'
    -> ParallelDataConfig -- ^ 'cpdParallelDataConfig'
    -> Text -- ^ 'cpdClientToken'
    -> CreateParallelData
createParallelData pName_ pParallelDataConfig_
  pClientToken_
  = CreateParallelData'{_cpdEncryptionKey = Nothing,
                        _cpdDescription = Nothing, _cpdName = pName_,
...
instance Hashable CreateParallelData where

instance NFData CreateParallelData where
...
data CreateParallelDataResponse = CreateParallelDataResponse'{_cpdrsStatus
                                                              ::
                                                              !(Maybe
                                                                  ParallelDataStatus),
                                                              _cpdrsName ::
...
createParallelDataResponse pResponseStatus_
  = CreateParallelDataResponse'{_cpdrsStatus = Nothing,
                                _cpdrsName = Nothing,
...
instance NFData CreateParallelDataResponse where
