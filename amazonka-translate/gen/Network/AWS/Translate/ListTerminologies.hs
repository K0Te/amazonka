...
data ListTerminologies = ListTerminologies'{_ltNextToken
                                            :: !(Maybe Text),
...
listTerminologies
    :: ListTerminologies
listTerminologies
  = ListTerminologies'{_ltNextToken = Nothing,
...
data ListTerminologiesResponse = ListTerminologiesResponse'{_ltrsTerminologyPropertiesList
                                                            ::
                                                            !(Maybe
...
listTerminologiesResponse pResponseStatus_
  = ListTerminologiesResponse'{_ltrsTerminologyPropertiesList
                                 = Nothing,
