...
newtype DeleteParallelData = DeleteParallelData'{_dpdName
                                                 :: Text}
...
instance Hashable DeleteParallelData where

instance NFData DeleteParallelData where
...
data DeleteParallelDataResponse = DeleteParallelDataResponse'{_dpdrsStatus
                                                              ::
                                                              !(Maybe
                                                                  ParallelDataStatus),
                                                              _dpdrsName ::
...
deleteParallelDataResponse pResponseStatus_
  = DeleteParallelDataResponse'{_dpdrsStatus = Nothing,
                                _dpdrsName = Nothing,
...
instance NFData DeleteParallelDataResponse where
