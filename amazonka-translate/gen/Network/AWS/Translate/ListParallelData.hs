...
data ListParallelData = ListParallelData'{_lpdNextToken
                                          :: !(Maybe Text),
...
listParallelData
    :: ListParallelData
listParallelData
  = ListParallelData'{_lpdNextToken = Nothing,
...
instance Hashable ListParallelData where

instance NFData ListParallelData where
...
data ListParallelDataResponse = ListParallelDataResponse'{_lpdrsParallelDataPropertiesList
                                                          ::
                                                          !(Maybe
...
listParallelDataResponse pResponseStatus_
  = ListParallelDataResponse'{_lpdrsParallelDataPropertiesList
                                = Nothing,
...
instance NFData ListParallelDataResponse where
