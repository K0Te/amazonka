...
newtype StopTextTranslationJob = StopTextTranslationJob'{_sttjJobId
                                                         :: Text}
...
instance AWSRequest StopTextTranslationJob where
        type Rs StopTextTranslationJob =
             StopTextTranslationJobResponse
...
instance Hashable StopTextTranslationJob where

instance NFData StopTextTranslationJob where
...
data StopTextTranslationJobResponse = StopTextTranslationJobResponse'{_sttjrsJobId
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _sttjrsJobStatus
...
stopTextTranslationJobResponse
    :: Int -- ^ 'sttjrsResponseStatus'
    -> StopTextTranslationJobResponse
stopTextTranslationJobResponse pResponseStatus_
  = StopTextTranslationJobResponse'{_sttjrsJobId =
                                      Nothing,
...
instance NFData StopTextTranslationJobResponse where
