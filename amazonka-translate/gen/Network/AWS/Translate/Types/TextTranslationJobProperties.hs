...
data TextTranslationJobProperties = TextTranslationJobProperties'{_ttjpJobId
                                                                  ::
                                                                  !(Maybe Text),
...
textTranslationJobProperties
    :: TextTranslationJobProperties
textTranslationJobProperties
  = TextTranslationJobProperties'{_ttjpJobId = Nothing,
...
instance FromJSON TextTranslationJobProperties where
        parseJSON
          = withObject "TextTranslationJobProperties"
              (\ x ->
                 TextTranslationJobProperties' <$>
                   (x .:? "JobId") <*> (x .:? "TargetLanguageCodes") <*>
                     (x .:? "JobName")
                     <*> (x .:? "SubmittedTime")
                     <*> (x .:? "InputDataConfig")
...
instance Hashable TextTranslationJobProperties where

instance NFData TextTranslationJobProperties where
