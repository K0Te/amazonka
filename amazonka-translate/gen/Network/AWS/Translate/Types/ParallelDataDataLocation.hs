...
data ParallelDataDataLocation = ParallelDataDataLocation'{_pddlRepositoryType
                                                          :: !Text,
                                                          _pddlLocation ::
                                                          !Text}
...
parallelDataDataLocation
    :: Text -- ^ 'pddlRepositoryType'
    -> Text -- ^ 'pddlLocation'
    -> ParallelDataDataLocation
parallelDataDataLocation pRepositoryType_ pLocation_
  = ParallelDataDataLocation'{_pddlRepositoryType =
                                pRepositoryType_,
...
instance FromJSON ParallelDataDataLocation where
        parseJSON
          = withObject "ParallelDataDataLocation"
              (\ x ->
                 ParallelDataDataLocation' <$>
                   (x .: "RepositoryType") <*> (x .: "Location"))

instance Hashable ParallelDataDataLocation where

instance NFData ParallelDataDataLocation where
