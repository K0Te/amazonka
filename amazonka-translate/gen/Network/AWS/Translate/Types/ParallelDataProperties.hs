...
data ParallelDataProperties = ParallelDataProperties'{_pdpStatus
                                                      ::
                                                      !(Maybe
                                                          ParallelDataStatus),
                                                      _pdpLastUpdatedAt ::
...
parallelDataProperties
    :: ParallelDataProperties
parallelDataProperties
  = ParallelDataProperties'{_pdpStatus = Nothing,
                            ...
                            _pdpImportedDataSize = Nothing, _pdpName = Nothing,
                            ...
                            _pdpMessage = Nothing, _pdpDescription = Nothing,
...
instance FromJSON ParallelDataProperties where
        parseJSON
          = withObject "ParallelDataProperties"
              (\ x ->
                 ParallelDataProperties' <$>
...
instance Hashable ParallelDataProperties where

instance NFData ParallelDataProperties where
