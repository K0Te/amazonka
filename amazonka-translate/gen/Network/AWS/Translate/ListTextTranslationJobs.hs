...
data ListTextTranslationJobs = ListTextTranslationJobs'{_lttjNextToken
                                                        :: !(Maybe Text),
                                                        _lttjFilter ::
                                                        !(Maybe
...
listTextTranslationJobs
    :: ListTextTranslationJobs
listTextTranslationJobs
  = ListTextTranslationJobs'{_lttjNextToken = Nothing,
                             _lttjFilter = Nothing, _lttjMaxResults = Nothing}
...
instance AWSRequest ListTextTranslationJobs where
        type Rs ListTextTranslationJobs =
             ListTextTranslationJobsResponse
...
instance Hashable ListTextTranslationJobs where

instance NFData ListTextTranslationJobs where
...
data ListTextTranslationJobsResponse = ListTextTranslationJobsResponse'{_lttjrsTextTranslationJobPropertiesList
                                                                        ::
                                                                        !(Maybe
...
listTextTranslationJobsResponse
    :: Int -- ^ 'lttjrsResponseStatus'
    -> ListTextTranslationJobsResponse
listTextTranslationJobsResponse pResponseStatus_
  = ListTextTranslationJobsResponse'{_lttjrsTextTranslationJobPropertiesList
                                       = Nothing,
...
instance NFData ListTextTranslationJobsResponse where
