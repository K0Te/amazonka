...
newtype DescribeTextTranslationJob = DescribeTextTranslationJob'{_dttjJobId
                                                                 :: Text}
...
instance Hashable DescribeTextTranslationJob where

instance NFData DescribeTextTranslationJob where
...
data DescribeTextTranslationJobResponse = DescribeTextTranslationJobResponse'{_dttjrsTextTranslationJobProperties
                                                                              ::
                                                                              !(Maybe
...
describeTextTranslationJobResponse
    :: Int -- ^ 'dttjrsResponseStatus'
    -> DescribeTextTranslationJobResponse
describeTextTranslationJobResponse pResponseStatus_
  = DescribeTextTranslationJobResponse'{_dttjrsTextTranslationJobProperties
                                          = Nothing,
                                        _dttjrsResponseStatus =
                                          pResponseStatus_}
