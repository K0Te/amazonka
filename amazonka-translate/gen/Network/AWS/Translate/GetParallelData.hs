...
newtype GetParallelData = GetParallelData'{_gpdName
                                           :: Text}
...
instance Hashable GetParallelData where

instance NFData GetParallelData where
...
data GetParallelDataResponse = GetParallelDataResponse'{_gpdrsParallelDataProperties
                                                        ::
                                                        !(Maybe
...
getParallelDataResponse pResponseStatus_
  = GetParallelDataResponse'{_gpdrsParallelDataProperties
                               = Nothing,
...
instance NFData GetParallelDataResponse where
