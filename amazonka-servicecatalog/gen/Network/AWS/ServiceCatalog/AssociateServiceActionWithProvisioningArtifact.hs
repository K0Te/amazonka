...
data AssociateServiceActionWithProvisioningArtifact = AssociateServiceActionWithProvisioningArtifact'{_asawpaAcceptLanguage
                                                                                                      ::
                                                                                                      !(Maybe
                                                                                                          Text),
                                                                                                      _asawpaProductId
...
associateServiceActionWithProvisioningArtifact
    :: Text -- ^ 'asawpaProductId'
    -> Text -- ^ 'asawpaProvisioningArtifactId'
    -> Text -- ^ 'asawpaServiceActionId'
    -> AssociateServiceActionWithProvisioningArtifact
associateServiceActionWithProvisioningArtifact
  pProductId_ pProvisioningArtifactId_
  pServiceActionId_
  = AssociateServiceActionWithProvisioningArtifact'{_asawpaAcceptLanguage
                                                      = Nothing,
                                                    _asawpaProductId =
                                                      pProductId_,
                                                    _asawpaProvisioningArtifactId
...
newtype AssociateServiceActionWithProvisioningArtifactResponse = AssociateServiceActionWithProvisioningArtifactResponse'{_asawparsResponseStatus
                                                                                                                         ::
                                                                                                                         Int}
                                                                   deriving (Eq,
                                                                             Read,
...
associateServiceActionWithProvisioningArtifactResponse
    :: Int -- ^ 'asawparsResponseStatus'
    -> AssociateServiceActionWithProvisioningArtifactResponse
associateServiceActionWithProvisioningArtifactResponse
  pResponseStatus_
  = AssociateServiceActionWithProvisioningArtifactResponse'{_asawparsResponseStatus
                                                              =
                                                              pResponseStatus_}
