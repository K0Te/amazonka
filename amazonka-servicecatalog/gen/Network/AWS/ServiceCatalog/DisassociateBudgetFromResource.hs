...
data DisassociateBudgetFromResource = DisassociateBudgetFromResource'{_dbfrBudgetName
                                                                      :: !Text,
                                                                      _dbfrResourceId
                                                                      :: !Text}
...
disassociateBudgetFromResource
    ...
    -> Text -- ^ 'dbfrResourceId'
    -> DisassociateBudgetFromResource
disassociateBudgetFromResource pBudgetName_
  pResourceId_
  = DisassociateBudgetFromResource'{_dbfrBudgetName =
                                      pBudgetName_,
...
instance AWSRequest DisassociateBudgetFromResource
         where
...
instance NFData DisassociateBudgetFromResource where

instance ToHeaders DisassociateBudgetFromResource
         where
        toHeaders
          = const
              (mconcat
...
newtype DisassociateBudgetFromResourceResponse = DisassociateBudgetFromResourceResponse'{_dbfrrsResponseStatus
                                                                                         ::
                                                                                         Int}
...
disassociateBudgetFromResourceResponse
    :: Int -- ^ 'dbfrrsResponseStatus'
    -> DisassociateBudgetFromResourceResponse
disassociateBudgetFromResourceResponse
  pResponseStatus_
  = DisassociateBudgetFromResourceResponse'{_dbfrrsResponseStatus
                                              = pResponseStatus_}
