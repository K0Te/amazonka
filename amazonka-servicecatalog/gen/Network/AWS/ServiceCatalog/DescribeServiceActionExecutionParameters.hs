...
data DescribeServiceActionExecutionParameters = DescribeServiceActionExecutionParameters'{_dsaepAcceptLanguage
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
...
describeServiceActionExecutionParameters
    :: Text -- ^ 'dsaepProvisionedProductId'
    -> Text -- ^ 'dsaepServiceActionId'
    -> DescribeServiceActionExecutionParameters
describeServiceActionExecutionParameters
  pProvisionedProductId_ pServiceActionId_
  = DescribeServiceActionExecutionParameters'{_dsaepAcceptLanguage
                                                = Nothing,
                                              _dsaepProvisionedProductId =
...
data DescribeServiceActionExecutionParametersResponse = DescribeServiceActionExecutionParametersResponse'{_dsaeprsServiceActionParameters
                                                                                                          ::
                                                                                                          !(Maybe
                                                                                                              [ExecutionParameter]),
...
describeServiceActionExecutionParametersResponse
    :: Int -- ^ 'dsaeprsResponseStatus'
    -> DescribeServiceActionExecutionParametersResponse
describeServiceActionExecutionParametersResponse
  pResponseStatus_
  = DescribeServiceActionExecutionParametersResponse'{_dsaeprsServiceActionParameters
                                                        = Nothing,
                                                      _dsaeprsResponseStatus =
                                                        pResponseStatus_}
