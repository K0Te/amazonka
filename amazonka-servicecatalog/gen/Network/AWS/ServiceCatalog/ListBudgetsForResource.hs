...
data ListBudgetsForResource = ListBudgetsForResource'{_lbfrAcceptLanguage
                                                      :: !(Maybe Text),
                                                      _lbfrPageToken ::
                                                      !(Maybe Text),
                                                      _lbfrPageSize ::
...
listBudgetsForResource pResourceId_
  = ListBudgetsForResource'{_lbfrAcceptLanguage =
                              Nothing,
                            _lbfrPageToken = Nothing, _lbfrPageSize = Nothing,
...
instance AWSRequest ListBudgetsForResource where
        type Rs ListBudgetsForResource =
             ListBudgetsForResourceResponse
...
instance Hashable ListBudgetsForResource where

instance NFData ListBudgetsForResource where
...
data ListBudgetsForResourceResponse = ListBudgetsForResourceResponse'{_lbfrrsNextPageToken
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _lbfrrsBudgets
...
listBudgetsForResourceResponse
    :: Int -- ^ 'lbfrrsResponseStatus'
    -> ListBudgetsForResourceResponse
listBudgetsForResourceResponse pResponseStatus_
  = ListBudgetsForResourceResponse'{_lbfrrsNextPageToken
                                      = Nothing,
...
instance NFData ListBudgetsForResourceResponse where
