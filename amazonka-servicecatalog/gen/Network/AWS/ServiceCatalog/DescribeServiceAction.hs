...
data DescribeServiceAction = DescribeServiceAction'{_dsaAcceptLanguage
                                                    :: !(Maybe Text),
                                                    _dsaId :: !Text}
...
describeServiceAction pId_
  = DescribeServiceAction'{_dsaAcceptLanguage =
                             Nothing,
                           _dsaId = pId_}
...
data DescribeServiceActionResponse = DescribeServiceActionResponse'{_dsarsServiceActionDetail
                                                                    ::
                                                                    !(Maybe
                                                                        ServiceActionDetail),
...
describeServiceActionResponse pResponseStatus_
  = DescribeServiceActionResponse'{_dsarsServiceActionDetail
                                     = Nothing,
