...
data ListStackInstancesForProvisionedProduct = ListStackInstancesForProvisionedProduct'{_lsifppAcceptLanguage
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
                                                                                        _lsifppPageToken
...
listStackInstancesForProvisionedProduct
    :: Text -- ^ 'lsifppProvisionedProductId'
    -> ListStackInstancesForProvisionedProduct
listStackInstancesForProvisionedProduct
  pProvisionedProductId_
  = ListStackInstancesForProvisionedProduct'{_lsifppAcceptLanguage
                                               = Nothing,
...
data ListStackInstancesForProvisionedProductResponse = ListStackInstancesForProvisionedProductResponse'{_lsifpprsNextPageToken
                                                                                                        ::
                                                                                                        !(Maybe
                                                                                                            Text),
...
listStackInstancesForProvisionedProductResponse
    :: Int -- ^ 'lsifpprsResponseStatus'
    -> ListStackInstancesForProvisionedProductResponse
listStackInstancesForProvisionedProductResponse
  pResponseStatus_
  = ListStackInstancesForProvisionedProductResponse'{_lsifpprsNextPageToken
                                                       = Nothing,
                                                     _lsifpprsStackInstances =
                                                       Nothing,
                                                     _lsifpprsResponseStatus =
