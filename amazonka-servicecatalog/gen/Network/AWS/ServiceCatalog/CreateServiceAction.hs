...
data CreateServiceAction = CreateServiceAction'{_csaAcceptLanguage
                                                :: !(Maybe Text),
                                                _csaDescription ::
                                                !(Maybe Text),
                                                _csaName :: !Text,
                                                ...
                                                _csaDefinition ::
                                                !(Map ServiceActionDefinitionKey
                                                    Text),
...
createServiceAction
    :: Text -- ^ 'csaName'
    -> ServiceActionDefinitionType -- ^ 'csaDefinitionType'
    -> Text -- ^ 'csaIdempotencyToken'
    -> CreateServiceAction
createServiceAction pName_ pDefinitionType_
  pIdempotencyToken_
  = CreateServiceAction'{_csaAcceptLanguage = Nothing,
                         _csaDescription = Nothing, _csaName = pName_,
...
instance Hashable CreateServiceAction where

instance NFData CreateServiceAction where
...
data CreateServiceActionResponse = CreateServiceActionResponse'{_csarsServiceActionDetail
                                                                ::
                                                                !(Maybe
                                                                    ServiceActionDetail),
                                                                _csarsResponseStatus
                                                                :: !Int}
...
createServiceActionResponse
    :: Int -- ^ 'csarsResponseStatus'
    -> CreateServiceActionResponse
createServiceActionResponse pResponseStatus_
  = CreateServiceActionResponse'{_csarsServiceActionDetail
                                   = Nothing,
...
instance NFData CreateServiceActionResponse where
