...
data UpdateProvisionedProductProperties = UpdateProvisionedProductProperties'{_upppAcceptLanguage
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
...
updateProvisionedProductProperties
    :: Text -- ^ 'upppProvisionedProductId'
    -> Text -- ^ 'upppIdempotencyToken'
    -> UpdateProvisionedProductProperties
updateProvisionedProductProperties
  pProvisionedProductId_ pIdempotencyToken_
  = UpdateProvisionedProductProperties'{_upppAcceptLanguage
                                          = Nothing,
                                        _upppProvisionedProductId =
...
instance ToHeaders UpdateProvisionedProductProperties
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON UpdateProvisionedProductProperties
         where
...
instance ToPath UpdateProvisionedProductProperties
         where
        toPath = const "/"

instance ToQuery UpdateProvisionedProductProperties
         where
        toQuery = const mempty

-- | /See:/ 'updateProvisionedProductPropertiesResponse' smart constructor.
data UpdateProvisionedProductPropertiesResponse = UpdateProvisionedProductPropertiesResponse'{_uppprsStatus
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  RecordStatus),
...
updateProvisionedProductPropertiesResponse
    :: Int -- ^ 'uppprsResponseStatus'
    -> UpdateProvisionedProductPropertiesResponse
updateProvisionedProductPropertiesResponse
  pResponseStatus_
  = UpdateProvisionedProductPropertiesResponse'{_uppprsStatus
                                                  = Nothing,
                                                _uppprsProvisionedProductProperties
                                                  = Nothing,
