...
data DeleteServiceAction = DeleteServiceAction'{_dsasAcceptLanguage
                                                :: !(Maybe Text),
                                                _dsasId :: !Text}
...
deleteServiceAction pId_
  = DeleteServiceAction'{_dsasAcceptLanguage = Nothing,
                         _dsasId = pId_}
...
newtype DeleteServiceActionResponse = DeleteServiceActionResponse'{_dsasrsResponseStatus
                                                                   :: Int}
...
deleteServiceActionResponse pResponseStatus_
  = DeleteServiceActionResponse'{_dsasrsResponseStatus
                                   = pResponseStatus_}
