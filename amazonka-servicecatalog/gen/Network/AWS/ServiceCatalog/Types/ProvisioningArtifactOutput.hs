...
data ProvisioningArtifactOutput = ProvisioningArtifactOutput'{_paoKey
                                                              :: !(Maybe Text),
                                                              _paoDescription ::
                                                              !(Maybe Text)}
...
provisioningArtifactOutput
    :: ProvisioningArtifactOutput
provisioningArtifactOutput
  = ProvisioningArtifactOutput'{_paoKey = Nothing,
...
instance FromJSON ProvisioningArtifactOutput where
        parseJSON
          = withObject "ProvisioningArtifactOutput"
              (\ x ->
                 ProvisioningArtifactOutput' <$>
                   (x .:? "Key") <*> (x .:? "Description"))

instance Hashable ProvisioningArtifactOutput where

instance NFData ProvisioningArtifactOutput where
