...
data RecordDetail = RecordDetail'{_rdLaunchRoleARN ::
                                  !(Maybe Text),
...
recordDetail
    :: RecordDetail
recordDetail
  = RecordDetail'{_rdLaunchRoleARN = Nothing,
                  _rdStatus = Nothing, _rdRecordTags = Nothing,
                  _rdProvisionedProductName = Nothing,
                  _rdProvisioningArtifactId = Nothing,
                  _rdCreatedTime = Nothing, _rdRecordType = Nothing,
                  _rdRecordId = Nothing,
                  _rdProvisionedProductType = Nothing,
                  _rdUpdatedTime = Nothing, _rdPathId = Nothing,
                  _rdProvisionedProductId = Nothing,
                  _rdRecordErrors = Nothing, _rdProductId = Nothing}
