...
data ProvisionedProductAttribute = ProvisionedProductAttribute'{_ppaIdempotencyToken
                                                                ::
                                                                !(Maybe Text),
                                                                _ppaStatus ::
                                                                !(Maybe
...
provisionedProductAttribute
    :: ProvisionedProductAttribute
provisionedProductAttribute
  = ProvisionedProductAttribute'{_ppaIdempotencyToken =
                                   Nothing,
                                 _ppaStatus = Nothing,
                                 ...
                                 _ppaARN = Nothing, _ppaCreatedTime = Nothing,
                                 _ppaProvisioningArtifactName = Nothing,
                                 _ppaUserARN = Nothing,
                                 _ppaStatusMessage = Nothing,
                                 _ppaName = Nothing, _ppaLastRecordId = Nothing,
                                 _ppaUserARNSession = Nothing, _ppaId = Nothing,
                                 _ppaType = Nothing, _ppaPhysicalId = Nothing,
                                 _ppaLastProvisioningRecordId = Nothing,
                                 _ppaProductId = Nothing, _ppaTags = Nothing}
