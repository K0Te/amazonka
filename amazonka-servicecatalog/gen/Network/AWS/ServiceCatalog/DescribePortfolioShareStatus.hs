...
newtype DescribePortfolioShareStatus = DescribePortfolioShareStatus'{_dpssPortfolioShareToken
                                                                     :: Text}
...
describePortfolioShareStatus pPortfolioShareToken_
  = DescribePortfolioShareStatus'{_dpssPortfolioShareToken
...
data DescribePortfolioShareStatusResponse = DescribePortfolioShareStatusResponse'{_dpssrsStatus
                                                                                  ::
                                                                                  !(Maybe
                                                                                      ShareStatus),
...
describePortfolioShareStatusResponse pResponseStatus_
  = DescribePortfolioShareStatusResponse'{_dpssrsStatus
                                            = Nothing,
