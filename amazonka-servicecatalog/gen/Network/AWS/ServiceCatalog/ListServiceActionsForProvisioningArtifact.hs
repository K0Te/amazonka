...
data ListServiceActionsForProvisioningArtifact = ListServiceActionsForProvisioningArtifact'{_lsafpaAcceptLanguage
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
                                                                                            _lsafpaPageToken
...
listServiceActionsForProvisioningArtifact
    :: Text -- ^ 'lsafpaProductId'
    -> Text -- ^ 'lsafpaProvisioningArtifactId'
    -> ListServiceActionsForProvisioningArtifact
listServiceActionsForProvisioningArtifact pProductId_
  pProvisioningArtifactId_
  = ListServiceActionsForProvisioningArtifact'{_lsafpaAcceptLanguage
                                                 = Nothing,
...
instance AWSPager
        ...
        page rq rs
          ...
          | stop (rs ^. lsafparsServiceActionSummaries) =
            Nothing
          | otherwise =
            Just $ rq &
              lsafpaPageToken .~ rs ^. lsafparsNextPageToken
...
data ListServiceActionsForProvisioningArtifactResponse = ListServiceActionsForProvisioningArtifactResponse'{_lsafparsNextPageToken
                                                                                                            ::
                                                                                                            !(Maybe
                                                                                                                Text),
...
listServiceActionsForProvisioningArtifactResponse
    :: Int -- ^ 'lsafparsResponseStatus'
    -> ListServiceActionsForProvisioningArtifactResponse
listServiceActionsForProvisioningArtifactResponse
  pResponseStatus_
  = ListServiceActionsForProvisioningArtifactResponse'{_lsafparsNextPageToken
                                                         = Nothing,
                                                       _lsafparsServiceActionSummaries
                                                         = Nothing,
                                                       _lsafparsResponseStatus =
