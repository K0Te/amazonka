...
data ListServiceActions = ListServiceActions'{_lsaAcceptLanguage
                                              :: !(Maybe Text),
...
listServiceActions
    :: ListServiceActions
listServiceActions
  = ListServiceActions'{_lsaAcceptLanguage = Nothing,
                        _lsaPageToken = Nothing, _lsaPageSize = Nothing}
...
instance AWSPager ListServiceActions where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lsaPageToken .~ rs ^. lsarsNextPageToken

instance AWSRequest ListServiceActions where
        type Rs ListServiceActions =
             ListServiceActionsResponse
...
instance Hashable ListServiceActions where

instance NFData ListServiceActions where
...
data ListServiceActionsResponse = ListServiceActionsResponse'{_lsarsNextPageToken
                                                              :: !(Maybe Text),
                                                              _lsarsServiceActionSummaries
                                                              ::
                                                              !(Maybe
                                                                  [ServiceActionSummary]),
                                                              _lsarsResponseStatus
                                                              :: !Int}
...
listServiceActionsResponse
    :: Int -- ^ 'lsarsResponseStatus'
    -> ListServiceActionsResponse
listServiceActionsResponse pResponseStatus_
  = ListServiceActionsResponse'{_lsarsNextPageToken =
                                  Nothing,
...
instance NFData ListServiceActionsResponse where
