...
data ListProvisioningArtifactsForServiceAction = ListProvisioningArtifactsForServiceAction'{_lpafsaAcceptLanguage
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
                                                                                            _lpafsaPageToken
...
listProvisioningArtifactsForServiceAction
    :: Text -- ^ 'lpafsaServiceActionId'
    -> ListProvisioningArtifactsForServiceAction
listProvisioningArtifactsForServiceAction
  pServiceActionId_
  = ListProvisioningArtifactsForServiceAction'{_lpafsaAcceptLanguage
                                                 = Nothing,
...
instance AWSPager
        ...
        page rq rs
          ...
          | stop (rs ^. lpafsarsProvisioningArtifactViews) =
            Nothing
          | otherwise =
            Just $ rq &
              lpafsaPageToken .~ rs ^. lpafsarsNextPageToken
...
data ListProvisioningArtifactsForServiceActionResponse = ListProvisioningArtifactsForServiceActionResponse'{_lpafsarsNextPageToken
                                                                                                            ::
                                                                                                            !(Maybe
                                                                                                                Text),
...
listProvisioningArtifactsForServiceActionResponse
    :: Int -- ^ 'lpafsarsResponseStatus'
    -> ListProvisioningArtifactsForServiceActionResponse
listProvisioningArtifactsForServiceActionResponse
  pResponseStatus_
  = ListProvisioningArtifactsForServiceActionResponse'{_lpafsarsNextPageToken
                                                         = Nothing,
                                                       _lpafsarsProvisioningArtifactViews
                                                         = Nothing,
                                                       _lpafsarsResponseStatus =
