...
data BatchDisassociateServiceActionFromProvisioningArtifact = BatchDisassociateServiceActionFromProvisioningArtifact'{_bdsafpaAcceptLanguage
                                                                                                                      ::
                                                                                                                      !(Maybe
                                                                                                                          Text),
...
batchDisassociateServiceActionFromProvisioningArtifact
    :: NonEmpty ServiceActionAssociation -- ^ 'bdsafpaServiceActionAssociations'
    -> BatchDisassociateServiceActionFromProvisioningArtifact
batchDisassociateServiceActionFromProvisioningArtifact
  pServiceActionAssociations_
  = BatchDisassociateServiceActionFromProvisioningArtifact'{_bdsafpaAcceptLanguage
                                                              = Nothing,
                                                            _bdsafpaServiceActionAssociations
                                                              =
                                                              _List1 #
...
data BatchDisassociateServiceActionFromProvisioningArtifactResponse = BatchDisassociateServiceActionFromProvisioningArtifactResponse'{_bdsafparsFailedServiceActionAssociations
                                                                                                                                      ::
                                                                                                                                      !(Maybe
...
batchDisassociateServiceActionFromProvisioningArtifactResponse
    :: Int -- ^ 'bdsafparsResponseStatus'
    -> BatchDisassociateServiceActionFromProvisioningArtifactResponse
batchDisassociateServiceActionFromProvisioningArtifactResponse
  pResponseStatus_
  = BatchDisassociateServiceActionFromProvisioningArtifactResponse'{_bdsafparsFailedServiceActionAssociations
                                                                      = Nothing,
                                                                    _bdsafparsResponseStatus
                                                                      =
                                                                      pResponseStatus_}
