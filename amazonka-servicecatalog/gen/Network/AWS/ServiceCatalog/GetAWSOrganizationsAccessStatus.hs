...
instance AWSRequest GetAWSOrganizationsAccessStatus
         where
...
instance NFData GetAWSOrganizationsAccessStatus where

instance ToHeaders GetAWSOrganizationsAccessStatus
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery GetAWSOrganizationsAccessStatus
         where
        toQuery = const mempty

-- | /See:/ 'getAWSOrganizationsAccessStatusResponse' smart constructor.
data GetAWSOrganizationsAccessStatusResponse = GetAWSOrganizationsAccessStatusResponse'{_gaoasrsAccessStatus
                                                                                        ::
                                                                                        !(Maybe
                                                                                            AccessStatus),
...
getAWSOrganizationsAccessStatusResponse
    :: Int -- ^ 'gaoasrsResponseStatus'
    -> GetAWSOrganizationsAccessStatusResponse
getAWSOrganizationsAccessStatusResponse
  pResponseStatus_
  = GetAWSOrganizationsAccessStatusResponse'{_gaoasrsAccessStatus
                                               = Nothing,
                                             _gaoasrsResponseStatus =
                                               pResponseStatus_}
