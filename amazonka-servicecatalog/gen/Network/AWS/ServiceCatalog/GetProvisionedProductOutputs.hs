...
data GetProvisionedProductOutputs = GetProvisionedProductOutputs'{_gppoProvisionedProductName
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _gppoOutputKeys
                                                                  ::
...
getProvisionedProductOutputs
    :: GetProvisionedProductOutputs
getProvisionedProductOutputs
  = GetProvisionedProductOutputs'{_gppoProvisionedProductName
                                    = Nothing,
...
instance AWSRequest GetProvisionedProductOutputs
         where
...
instance Hashable GetProvisionedProductOutputs where

instance NFData GetProvisionedProductOutputs where
...
data GetProvisionedProductOutputsResponse = GetProvisionedProductOutputsResponse'{_gpporsNextPageToken
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
                                                                                  _gpporsOutputs
...
getProvisionedProductOutputsResponse
    :: Int -- ^ 'gpporsResponseStatus'
    -> GetProvisionedProductOutputsResponse
getProvisionedProductOutputsResponse pResponseStatus_
  = GetProvisionedProductOutputsResponse'{_gpporsNextPageToken
                                            = Nothing,
