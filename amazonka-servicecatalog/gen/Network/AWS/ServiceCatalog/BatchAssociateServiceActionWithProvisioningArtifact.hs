...
data BatchAssociateServiceActionWithProvisioningArtifact = BatchAssociateServiceActionWithProvisioningArtifact'{_basawpaAcceptLanguage
                                                                                                                ::
                                                                                                                !(Maybe
                                                                                                                    Text),
...
batchAssociateServiceActionWithProvisioningArtifact
  ...
  = BatchAssociateServiceActionWithProvisioningArtifact'{_basawpaAcceptLanguage
                                                           = Nothing,
                                                         _basawpaServiceActionAssociations
                                                           =
                                                           _List1 #
...
data BatchAssociateServiceActionWithProvisioningArtifactResponse = BatchAssociateServiceActionWithProvisioningArtifactResponse'{_basawparsFailedServiceActionAssociations
                                                                                                                                ::
                                                                                                                                !(Maybe
                                                                                                                                    [FailedServiceActionAssociation]),
                                                                                                                                _basawparsResponseStatus
                                                                                                                                ::
                                                                                                                                !Int}
                                                                     deriving (Eq,
                                                                               Read,
...
batchAssociateServiceActionWithProvisioningArtifactResponse
  pResponseStatus_
  = BatchAssociateServiceActionWithProvisioningArtifactResponse'{_basawparsFailedServiceActionAssociations
                                                                   = Nothing,
                                                                 _basawparsResponseStatus
                                                                   =
                                                                   pResponseStatus_}
