...
newtype DisableAWSOrganizationsAccessResponse = DisableAWSOrganizationsAccessResponse'{_daoarsResponseStatus
                                                                                       ::
                                                                                       Int}
...
disableAWSOrganizationsAccessResponse
  pResponseStatus_
  = DisableAWSOrganizationsAccessResponse'{_daoarsResponseStatus
                                             = pResponseStatus_}
