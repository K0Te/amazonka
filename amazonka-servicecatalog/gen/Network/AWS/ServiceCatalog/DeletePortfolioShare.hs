...
data DeletePortfolioShare = DeletePortfolioShare'{_dpsAccountId
                                                  :: !(Maybe Text),
                                                  _dpsAcceptLanguage ::
                                                  !(Maybe Text),
                                                  _dpsOrganizationNode ::
...
deletePortfolioShare pPortfolioId_
  = DeletePortfolioShare'{_dpsAccountId = Nothing,
...
data DeletePortfolioShareResponse = DeletePortfolioShareResponse'{_dpsrsPortfolioShareToken
                                                                  ::
                                                                  !(Maybe Text),
...
deletePortfolioShareResponse pResponseStatus_
  = DeletePortfolioShareResponse'{_dpsrsPortfolioShareToken
                                    = Nothing,
