...
data AssociateBudgetWithResource = AssociateBudgetWithResource'{_abwrBudgetName
                                                                :: !Text,
                                                                _abwrResourceId
                                                                :: !Text}
...
associateBudgetWithResource pBudgetName_ pResourceId_
  = AssociateBudgetWithResource'{_abwrBudgetName =
                                   pBudgetName_,
...
instance Hashable AssociateBudgetWithResource where

instance NFData AssociateBudgetWithResource where
...
newtype AssociateBudgetWithResourceResponse = AssociateBudgetWithResourceResponse'{_abwrrsResponseStatus
                                                                                   ::
                                                                                   Int}
...
associateBudgetWithResourceResponse
    :: Int -- ^ 'abwrrsResponseStatus'
    -> AssociateBudgetWithResourceResponse
associateBudgetWithResourceResponse pResponseStatus_
  = AssociateBudgetWithResourceResponse'{_abwrrsResponseStatus
                                           = pResponseStatus_}
