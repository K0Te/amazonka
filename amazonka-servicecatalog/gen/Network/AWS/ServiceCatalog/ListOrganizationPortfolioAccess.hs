...
data ListOrganizationPortfolioAccess = ListOrganizationPortfolioAccess'{_lopaAcceptLanguage
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _lopaPageToken
...
listOrganizationPortfolioAccess
    ...
    -> ListOrganizationPortfolioAccess
listOrganizationPortfolioAccess pPortfolioId_
  pOrganizationNodeType_
  = ListOrganizationPortfolioAccess'{_lopaAcceptLanguage
                                       = Nothing,
...
data ListOrganizationPortfolioAccessResponse = ListOrganizationPortfolioAccessResponse'{_loparsNextPageToken
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
...
listOrganizationPortfolioAccessResponse
  pResponseStatus_
  = ListOrganizationPortfolioAccessResponse'{_loparsNextPageToken
                                               = Nothing,
