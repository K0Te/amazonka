...
data ImportAsProvisionedProduct = ImportAsProvisionedProduct'{_iappAcceptLanguage
                                                              :: !(Maybe Text),
                                                              _iappProductId ::
                                                              !Text,
...
importAsProvisionedProduct
    :: Text -- ^ 'iappProductId'
    -> Text -- ^ 'iappProvisioningArtifactId'
    -> Text -- ^ 'iappProvisionedProductName'
    -> Text -- ^ 'iappPhysicalId'
    -> Text -- ^ 'iappIdempotencyToken'
    -> ImportAsProvisionedProduct
importAsProvisionedProduct pProductId_
  pProvisioningArtifactId_ pProvisionedProductName_
  pPhysicalId_ pIdempotencyToken_
  = ImportAsProvisionedProduct'{_iappAcceptLanguage =
                                  Nothing,
...
instance Hashable ImportAsProvisionedProduct where

instance NFData ImportAsProvisionedProduct where
...
data ImportAsProvisionedProductResponse = ImportAsProvisionedProductResponse'{_iapprsRecordDetail
                                                                              ::
                                                                              !(Maybe
                                                                                  RecordDetail),
...
importAsProvisionedProductResponse
    :: Int -- ^ 'iapprsResponseStatus'
    -> ImportAsProvisionedProductResponse
importAsProvisionedProductResponse pResponseStatus_
  = ImportAsProvisionedProductResponse'{_iapprsRecordDetail
                                          = Nothing,
                                        _iapprsResponseStatus =
                                          pResponseStatus_}
