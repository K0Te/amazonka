...
data DisassociateServiceActionFromProvisioningArtifact = DisassociateServiceActionFromProvisioningArtifact'{_dsafpaAcceptLanguage
                                                                                                            ::
                                                                                                            !(Maybe
                                                                                                                Text),
                                                                                                            _dsafpaProductId
...
disassociateServiceActionFromProvisioningArtifact
  ...
  pServiceActionId_
  = DisassociateServiceActionFromProvisioningArtifact'{_dsafpaAcceptLanguage
                                                         = Nothing,
                                                       _dsafpaProductId =
                                                         pProductId_,
                                                       _dsafpaProvisioningArtifactId
...
newtype DisassociateServiceActionFromProvisioningArtifactResponse = DisassociateServiceActionFromProvisioningArtifactResponse'{_dsafparsResponseStatus
                                                                                                                               ::
                                                                                                                               Int}
                                                                      deriving (Eq,
                                                                                Read,
...
disassociateServiceActionFromProvisioningArtifactResponse
  pResponseStatus_
  = DisassociateServiceActionFromProvisioningArtifactResponse'{_dsafparsResponseStatus
                                                                 =
                                                                 pResponseStatus_}
