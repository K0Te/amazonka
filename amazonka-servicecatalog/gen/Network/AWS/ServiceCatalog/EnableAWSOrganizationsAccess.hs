...
newtype EnableAWSOrganizationsAccessResponse = EnableAWSOrganizationsAccessResponse'{_eaoarsResponseStatus
                                                                                     ::
                                                                                     Int}
...
enableAWSOrganizationsAccessResponse pResponseStatus_
  = EnableAWSOrganizationsAccessResponse'{_eaoarsResponseStatus
                                            = pResponseStatus_}
