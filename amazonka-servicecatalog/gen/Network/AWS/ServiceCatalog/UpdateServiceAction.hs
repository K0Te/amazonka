...
data UpdateServiceAction = UpdateServiceAction'{_usaDefinition
                                                ::
                                                !(Maybe
                                                    (Map
...
updateServiceAction pId_
  = UpdateServiceAction'{_usaDefinition = Nothing,
                         _usaName = Nothing, _usaAcceptLanguage = Nothing,
                         _usaDescription = Nothing, _usaId = pId_}
...
data UpdateServiceActionResponse = UpdateServiceActionResponse'{_usarsServiceActionDetail
                                                                ::
                                                                !(Maybe
                                                                    ServiceActionDetail),
                                                                _usarsResponseStatus
                                                                :: !Int}
...
updateServiceActionResponse pResponseStatus_
  = UpdateServiceActionResponse'{_usarsServiceActionDetail
                                   = Nothing,
