...
data DomainName = DomainName'{_dnRegionalHostedZoneId
                              :: !(Maybe Text),
...
domainName
  = DomainName'{_dnRegionalHostedZoneId = Nothing,
                ...
                _dnDomainNameStatus = Nothing, _dnTags = Nothing}
