...
data VPCLink = VPCLink'{_vlStatus ::
                        !(Maybe VPCLinkStatus),
...
vpcLink
    :: VPCLink
vpcLink
  = VPCLink'{_vlStatus = Nothing,
             _vlTargetARNs = Nothing, _vlName = Nothing,
             _vlStatusMessage = Nothing, _vlId = Nothing,
             _vlDescription = Nothing, _vlTags = Nothing}
