...
data MutualTLSAuthentication = MutualTLSAuthentication'{_mtaTruststoreWarnings
                                                        :: !(Maybe [Text]),
                                                        _mtaTruststoreURI ::
                                                        !(Maybe Text),
...
mutualTLSAuthentication
    :: MutualTLSAuthentication
mutualTLSAuthentication
  = MutualTLSAuthentication'{_mtaTruststoreWarnings =
                               Nothing,
...
instance FromJSON MutualTLSAuthentication where
        parseJSON
          = withObject "MutualTLSAuthentication"
              (\ x ->
                 MutualTLSAuthentication' <$>
...
instance Hashable MutualTLSAuthentication where

instance NFData MutualTLSAuthentication where
