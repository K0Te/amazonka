...
data MutualTLSAuthenticationInput = MutualTLSAuthenticationInput'{_mtaiTruststoreURI
                                                                  ::
                                                                  !(Maybe Text),
...
mutualTLSAuthenticationInput
    :: MutualTLSAuthenticationInput
mutualTLSAuthenticationInput
  = MutualTLSAuthenticationInput'{_mtaiTruststoreURI =
                                    Nothing,
...
instance Hashable MutualTLSAuthenticationInput where

instance NFData MutualTLSAuthenticationInput where
