...
data DescribeClusterSnapshots = DescribeClusterSnapshots'{_dSnapshotIdentifier
                                                          :: !(Maybe Text),
                                                          _dTagValues ::
                                                          !(Maybe [Text]),
                                                          _dClusterExists ::
...
describeClusterSnapshots
    :: DescribeClusterSnapshots
describeClusterSnapshots
  = DescribeClusterSnapshots'{_dSnapshotIdentifier =
                                Nothing,
...
data DescribeClusterSnapshotsResponse = DescribeClusterSnapshotsResponse'{_dcssrsSnapshots
                                                                          ::
                                                                          !(Maybe
                                                                              [Snapshot]),
                                                                          _dcssrsMarker
