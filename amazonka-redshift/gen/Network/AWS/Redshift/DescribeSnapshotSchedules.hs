...
data DescribeSnapshotSchedules = DescribeSnapshotSchedules'{_dssTagValues
                                                            :: !(Maybe [Text]),
                                                            _dssTagKeys ::
                                                            !(Maybe [Text]),
...
describeSnapshotSchedules
    :: DescribeSnapshotSchedules
describeSnapshotSchedules
  = DescribeSnapshotSchedules'{_dssTagValues = Nothing,
                               _dssTagKeys = Nothing,
                               _dssClusterIdentifier = Nothing,
                               _dssMarker = Nothing, _dssMaxRecords = Nothing,
...
data DescribeSnapshotSchedulesResponse = DescribeSnapshotSchedulesResponse'{_dssrsSnapshotSchedules
                                                                            ::
                                                                            !(Maybe
                                                                                [SnapshotSchedule]),
                                                                            _dssrsMarker
...
describeSnapshotSchedulesResponse pResponseStatus_
  = DescribeSnapshotSchedulesResponse'{_dssrsSnapshotSchedules
                                         = Nothing,
