...
data ModifyUsageLimit = ModifyUsageLimit'{_mulAmount
                                          :: !(Maybe Integer),
                                          _mulBreachAction ::
...
modifyUsageLimit
    :: Text -- ^ 'mulUsageLimitId'
    -> ModifyUsageLimit
modifyUsageLimit pUsageLimitId_
  = ModifyUsageLimit'{_mulAmount = Nothing,
...
instance AWSRequest ModifyUsageLimit where
        ...
        response
          = receiveXMLWrapper "ModifyUsageLimitResult"
              (\ s h x -> parseXML x)

instance Hashable ModifyUsageLimit where

instance NFData ModifyUsageLimit where
