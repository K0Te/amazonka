...
newtype DeleteUsageLimit = DeleteUsageLimit'{_dulUsageLimitId
                                             :: Text}
...
deleteUsageLimit
    :: Text -- ^ 'dulUsageLimitId'
    -> DeleteUsageLimit
deleteUsageLimit pUsageLimitId_
  = DeleteUsageLimit'{_dulUsageLimitId =
                        pUsageLimitId_}
...
instance Hashable DeleteUsageLimit where

instance NFData DeleteUsageLimit where
...
instance NFData DeleteUsageLimitResponse where
