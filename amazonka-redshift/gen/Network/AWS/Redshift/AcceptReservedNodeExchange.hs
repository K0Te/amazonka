...
data AcceptReservedNodeExchange = AcceptReservedNodeExchange'{_arneReservedNodeId
                                                              :: !Text,
...
acceptReservedNodeExchange
    ...
    -> AcceptReservedNodeExchange
acceptReservedNodeExchange pReservedNodeId_
  pTargetReservedNodeOfferingId_
  = AcceptReservedNodeExchange'{_arneReservedNodeId =
                                  pReservedNodeId_,
                                _arneTargetReservedNodeOfferingId =
                                  pTargetReservedNodeOfferingId_}
...
data AcceptReservedNodeExchangeResponse = AcceptReservedNodeExchangeResponse'{_arnersExchangedReservedNode
                                                                              ::
                                                                              !(Maybe
                                                                                  ReservedNode),
...
acceptReservedNodeExchangeResponse pResponseStatus_
  = AcceptReservedNodeExchangeResponse'{_arnersExchangedReservedNode
                                          = Nothing,
                                        _arnersResponseStatus =
                                          pResponseStatus_}
