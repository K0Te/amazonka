...
data ModifyClusterSnapshot = ModifyClusterSnapshot'{_mcsManualSnapshotRetentionPeriod
                                                    :: !(Maybe Int),
...
modifyClusterSnapshot pSnapshotIdentifier_
  = ModifyClusterSnapshot'{_mcsManualSnapshotRetentionPeriod
                             = Nothing,
                           _mcsForce = Nothing,
...
data ModifyClusterSnapshotResponse = ModifyClusterSnapshotResponse'{_mcsrsSnapshot
                                                                    ::
                                                                    !(Maybe
                                                                        Snapshot),
                                                                    _mcsrsResponseStatus
                                                                    :: !Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
modifyClusterSnapshotResponse pResponseStatus_
  = ModifyClusterSnapshotResponse'{_mcsrsSnapshot =
                                     Nothing,
