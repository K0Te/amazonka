...
instance AWSRequest DescribeStorage where
        ...
        response
          = receiveXMLWrapper "DescribeStorageResult"
              (\ s h x ->
                 DescribeStorageResponse' <$>
...
instance Hashable DescribeStorage where

instance NFData DescribeStorage where
...
data DescribeStorageResponse = DescribeStorageResponse'{_dsrsTotalProvisionedStorageInMegaBytes
                                                        :: !(Maybe Double),
...
describeStorageResponse pResponseStatus_
  = DescribeStorageResponse'{_dsrsTotalProvisionedStorageInMegaBytes
                               = Nothing,
...
instance NFData DescribeStorageResponse where
