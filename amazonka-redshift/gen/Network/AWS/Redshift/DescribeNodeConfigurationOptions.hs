...
data DescribeNodeConfigurationOptions = DescribeNodeConfigurationOptions'{_dncoSnapshotIdentifier
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _dncoFilters
...
describeNodeConfigurationOptions
    :: ActionType -- ^ 'dncoActionType'
    -> DescribeNodeConfigurationOptions
describeNodeConfigurationOptions pActionType_
  = DescribeNodeConfigurationOptions'{_dncoSnapshotIdentifier
                                        = Nothing,
...
instance AWSPager DescribeNodeConfigurationOptions
         where
        page rq rs
          | stop (rs ^. dncorsMarker) = Nothing
          | stop (rs ^. dncorsNodeConfigurationOptionList) =
            Nothing
          | otherwise =
            Just $ rq & dncoMarker .~ rs ^. dncorsMarker

instance AWSRequest DescribeNodeConfigurationOptions
         where
...
instance ToHeaders DescribeNodeConfigurationOptions
         where
        toHeaders = const mempty

instance ToPath DescribeNodeConfigurationOptions
         where
        toPath = const "/"

instance ToQuery DescribeNodeConfigurationOptions
         where
...
data DescribeNodeConfigurationOptionsResponse = DescribeNodeConfigurationOptionsResponse'{_dncorsNodeConfigurationOptionList
                                                                                          ::
                                                                                          !(Maybe
...
describeNodeConfigurationOptionsResponse
    :: Int -- ^ 'dncorsResponseStatus'
    -> DescribeNodeConfigurationOptionsResponse
describeNodeConfigurationOptionsResponse
  pResponseStatus_
  = DescribeNodeConfigurationOptionsResponse'{_dncorsNodeConfigurationOptionList
                                                = Nothing,
