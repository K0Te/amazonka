...
data DescribeClusterTracks = DescribeClusterTracks'{_dctMaintenanceTrackName
                                                    :: !(Maybe Text),
...
describeClusterTracks
    :: DescribeClusterTracks
describeClusterTracks
  = DescribeClusterTracks'{_dctMaintenanceTrackName =
                             Nothing,
                           _dctMarker = Nothing, _dctMaxRecords = Nothing}
...
data DescribeClusterTracksResponse = DescribeClusterTracksResponse'{_dctrsMaintenanceTracks
                                                                    ::
                                                                    !(Maybe
                                                                        [MaintenanceTrack]),
                                                                    _dctrsMarker
...
describeClusterTracksResponse pResponseStatus_
  = DescribeClusterTracksResponse'{_dctrsMaintenanceTracks
                                     = Nothing,
