...
data BatchModifyClusterSnapshots = BatchModifyClusterSnapshots'{_bmcsManualSnapshotRetentionPeriod
                                                                :: !(Maybe Int),
                                                                _bmcsForce ::
                                                                !(Maybe Bool),
...
batchModifyClusterSnapshots
    :: BatchModifyClusterSnapshots
batchModifyClusterSnapshots
  = BatchModifyClusterSnapshots'{_bmcsManualSnapshotRetentionPeriod
                                   = Nothing,
                                 _bmcsForce = Nothing,
...
data BatchModifyClusterSnapshotsResponse = BatchModifyClusterSnapshotsResponse'{_bmcsrsResources
                                                                                ::
                                                                                !(Maybe
                                                                                    [Text]),
                                                                                _bmcsrsErrors
...
batchModifyClusterSnapshotsResponse pResponseStatus_
  = BatchModifyClusterSnapshotsResponse'{_bmcsrsResources
                                           = Nothing,
