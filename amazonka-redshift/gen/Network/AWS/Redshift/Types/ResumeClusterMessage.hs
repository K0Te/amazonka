...
newtype ResumeClusterMessage = ResumeClusterMessage'{_rClusterIdentifier
                                                     :: Text}
...
resumeClusterMessage pClusterIdentifier_
  = ResumeClusterMessage'{_rClusterIdentifier =
                            pClusterIdentifier_}
...
instance Hashable ResumeClusterMessage where

instance NFData ResumeClusterMessage where
