...
data Endpoint = Endpoint'{_eAddress :: !(Maybe Text),
                          _eVPCEndpoints :: !(Maybe [SpartaProxyVPCEndpoint]),
                          _ePort :: !(Maybe Int)}
...
endpoint
    :: Endpoint
endpoint
  = Endpoint'{_eAddress = Nothing,
              _eVPCEndpoints = Nothing, _ePort = Nothing}
...
-- | Describes a connection endpoint.
eVPCEndpoints :: Lens' Endpoint [SpartaProxyVPCEndpoint]
          ...
          = Endpoint' <$>
              (x .@? "Address") <*>
                (x .@? "VpcEndpoints" .!@ mempty >>=
                   may (parseXMLList "SpartaProxyVpcEndpoint"))
                <*> (x .@? "Port")
