...
data Cluster = Cluster'{_cResizeInfo ::
                        !(Maybe ResizeInfo),
...
cluster
  = Cluster'{_cResizeInfo = Nothing,
             ...
             _cVPCId = Nothing, _cClusterSecurityGroups = Nothing,
             ...
             _cIAMRoles = Nothing, _cPendingActions = Nothing,
