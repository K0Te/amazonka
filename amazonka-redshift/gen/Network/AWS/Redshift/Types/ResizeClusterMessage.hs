...
data ResizeClusterMessage = ResizeClusterMessage'{_rcmNumberOfNodes
                                                  :: !(Maybe Int),
...
resizeClusterMessage
    :: Text -- ^ 'rcmClusterIdentifier'
    -> ResizeClusterMessage
resizeClusterMessage pClusterIdentifier_
  = ResizeClusterMessage'{_rcmNumberOfNodes = Nothing,
                          _rcmClassic = Nothing, _rcmClusterType = Nothing,
...
instance FromXML ResizeClusterMessage where
        parseXML x
          = ResizeClusterMessage' <$>
              (x .@? "NumberOfNodes") <*> (x .@? "Classic") <*>
                (x .@? "ClusterType")
                <*> (x .@? "NodeType")
                <*> (x .@ "ClusterIdentifier")

instance Hashable ResizeClusterMessage where

instance NFData ResizeClusterMessage where
