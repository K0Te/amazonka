...
newtype CancelResize = CancelResize'{_crClusterIdentifier
                                     :: Text}
...
cancelResize
    :: Text -- ^ 'crClusterIdentifier'
    -> CancelResize
cancelResize pClusterIdentifier_
  = CancelResize'{_crClusterIdentifier =
                    pClusterIdentifier_}
...
instance AWSRequest CancelResize where
        ...
        response
          = receiveXMLWrapper "CancelResizeResult"
              (\ s h x -> parseXML x)

instance Hashable CancelResize where

instance NFData CancelResize where
