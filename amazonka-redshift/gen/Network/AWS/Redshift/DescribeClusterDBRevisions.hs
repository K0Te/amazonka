...
data DescribeClusterDBRevisions = DescribeClusterDBRevisions'{_dcdrClusterIdentifier
                                                              :: !(Maybe Text),
                                                              _dcdrMarker ::
                                                              !(Maybe Text),
                                                              _dcdrMaxRecords ::
...
describeClusterDBRevisions
    :: DescribeClusterDBRevisions
describeClusterDBRevisions
  = DescribeClusterDBRevisions'{_dcdrClusterIdentifier
                                  = Nothing,
                                _dcdrMarker = Nothing,
...
instance AWSPager DescribeClusterDBRevisions where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dcdrMarker .~ rs ^. dcdrrsMarker
...
instance Hashable DescribeClusterDBRevisions where

instance NFData DescribeClusterDBRevisions where
...
data DescribeClusterDBRevisionsResponse = DescribeClusterDBRevisionsResponse'{_dcdrrsClusterDBRevisions
                                                                              ::
                                                                              !(Maybe
                                                                                  [ClusterDBRevision]),
                                                                              _dcdrrsMarker
...
describeClusterDBRevisionsResponse
    :: Int -- ^ 'dcdrrsResponseStatus'
    -> DescribeClusterDBRevisionsResponse
describeClusterDBRevisionsResponse pResponseStatus_
  = DescribeClusterDBRevisionsResponse'{_dcdrrsClusterDBRevisions
                                          = Nothing,
