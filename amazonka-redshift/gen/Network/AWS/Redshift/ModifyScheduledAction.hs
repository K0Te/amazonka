...
data ModifyScheduledAction = ModifyScheduledAction'{_msaTargetAction
                                                    ::
                                                    !(Maybe
                                                        ScheduledActionType),
                                                    _msaStartTime ::
...
modifyScheduledAction
    :: Text -- ^ 'msaScheduledActionName'
    -> ModifyScheduledAction
modifyScheduledAction pScheduledActionName_
  = ModifyScheduledAction'{_msaTargetAction = Nothing,
                           _msaStartTime = Nothing, _msaSchedule = Nothing,
                           _msaScheduledActionDescription = Nothing,
                           _msaEnable = Nothing, _msaEndTime = Nothing,
                           _msaIAMRole = Nothing,
...
instance AWSRequest ModifyScheduledAction where
        ...
        response
          = receiveXMLWrapper "ModifyScheduledActionResult"
              (\ s h x -> parseXML x)

instance Hashable ModifyScheduledAction where

instance NFData ModifyScheduledAction where
          ...
          = mconcat
              ["Action" =: ("ModifyScheduledAction" :: ByteString),
               ...
               "ScheduledActionDescription" =:
                 _msaScheduledActionDescription,
               "Enable" =: _msaEnable, "EndTime" =: _msaEndTime,
               "IamRole" =: _msaIAMRole,
