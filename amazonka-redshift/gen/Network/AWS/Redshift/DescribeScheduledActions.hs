...
describeScheduledActions
  = DescribeScheduledActions'{_dsasStartTime = Nothing,
                              ...
                              _dsasFilters = Nothing, _dsasActive = Nothing,
                              _dsasTargetActionType = Nothing,
                              _dsasMarker = Nothing, _dsasMaxRecords = Nothing,
...
instance AWSPager DescribeScheduledActions where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dsasMarker .~ rs ^. dsarsMarker
...
data DescribeScheduledActionsResponse = DescribeScheduledActionsResponse'{_dsarsScheduledActions
                                                                          ::
                                                                          !(Maybe
                                                                              [ScheduledAction]),
                                                                          _dsarsMarker
...
describeScheduledActionsResponse pResponseStatus_
  = DescribeScheduledActionsResponse'{_dsarsScheduledActions
                                        = Nothing,
