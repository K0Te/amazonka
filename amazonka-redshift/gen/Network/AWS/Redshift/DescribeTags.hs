...
data DescribeTags = DescribeTags'{_dtTagValues ::
                                  !(Maybe [Text]),
...
describeTags
    :: DescribeTags
describeTags
  = DescribeTags'{_dtTagValues = Nothing,
                  _dtResourceType = Nothing, _dtResourceName = Nothing,
                  _dtTagKeys = Nothing, _dtMarker = Nothing,
...
data DescribeTagsResponse = DescribeTagsResponse'{_dtrsMarker
                                                  :: !(Maybe Text),
                                                  _dtrsTaggedResources ::
...
describeTagsResponse pResponseStatus_
  = DescribeTagsResponse'{_dtrsMarker = Nothing,
