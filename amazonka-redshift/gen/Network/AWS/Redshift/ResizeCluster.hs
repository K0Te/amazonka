...
data ResizeCluster = ResizeCluster'{_rcNumberOfNodes
                                    :: !(Maybe Int),
...
resizeCluster pClusterIdentifier_
  = ResizeCluster'{_rcNumberOfNodes = Nothing,
                   _rcClassic = Nothing, _rcClusterType = Nothing,
                   _rcNodeType = Nothing,
...
data ResizeClusterResponse = ResizeClusterResponse'{_resrsCluster
                                                    :: !(Maybe Cluster),
...
resizeClusterResponse pResponseStatus_
  = ResizeClusterResponse'{_resrsCluster = Nothing,
