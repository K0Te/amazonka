...
data CreateScheduledAction = CreateScheduledAction'{_csaStartTime
                                                    :: !(Maybe ISO8601),
...
createScheduledAction
    :: Text -- ^ 'csaScheduledActionName'
    -> ScheduledActionType -- ^ 'csaTargetAction'
    -> Text -- ^ 'csaSchedule'
    -> Text -- ^ 'csaIAMRole'
    -> CreateScheduledAction
createScheduledAction pScheduledActionName_
  pTargetAction_ pSchedule_ pIAMRole_
  = CreateScheduledAction'{_csaStartTime = Nothing,
                           _csaScheduledActionDescription = Nothing,
                           _csaEnable = Nothing, _csaEndTime = Nothing,
                           _csaScheduledActionName = pScheduledActionName_,
                           _csaTargetAction = pTargetAction_,
                           _csaSchedule = pSchedule_, _csaIAMRole = pIAMRole_}
...
instance AWSRequest CreateScheduledAction where
        ...
        response
          = receiveXMLWrapper "CreateScheduledActionResult"
              (\ s h x -> parseXML x)

instance Hashable CreateScheduledAction where

instance NFData CreateScheduledAction where
          ...
          = mconcat
              ["Action" =: ("CreateScheduledAction" :: ByteString),
               ...
               "ScheduledActionDescription" =:
                 _csaScheduledActionDescription,
               "Enable" =: _csaEnable, "EndTime" =: _csaEndTime,
               "ScheduledActionName" =: _csaScheduledActionName,
               "TargetAction" =: _csaTargetAction,
               "Schedule" =: _csaSchedule, "IamRole" =: _csaIAMRole]
