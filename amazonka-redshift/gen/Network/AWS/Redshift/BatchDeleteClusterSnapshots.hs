...
newtype BatchDeleteClusterSnapshots = BatchDeleteClusterSnapshots'{_bdcsIdentifiers
                                                                   ::
...
batchDeleteClusterSnapshots
    :: BatchDeleteClusterSnapshots
batchDeleteClusterSnapshots
  = BatchDeleteClusterSnapshots'{_bdcsIdentifiers =
                                   mempty}
...
data BatchDeleteClusterSnapshotsResponse = BatchDeleteClusterSnapshotsResponse'{_bdcsrsResources
                                                                                ::
                                                                                !(Maybe
                                                                                    [Text]),
                                                                                _bdcsrsErrors
...
batchDeleteClusterSnapshotsResponse pResponseStatus_
  = BatchDeleteClusterSnapshotsResponse'{_bdcsrsResources
                                           = Nothing,
