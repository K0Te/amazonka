...
data CreateSnapshotSchedule = CreateSnapshotSchedule'{_cssNextInvocations
                                                      :: !(Maybe Int),
...
instance AWSRequest CreateSnapshotSchedule where
        ...
        response
          = receiveXMLWrapper "CreateSnapshotScheduleResult"
              (\ s h x -> parseXML x)

instance Hashable CreateSnapshotSchedule where

instance NFData CreateSnapshotSchedule where
