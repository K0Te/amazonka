...
data ListLoggingConfigurations = ListLoggingConfigurations'{_llcNextMarker
                                                            :: !(Maybe Text),
                                                            _llcLimit ::
                                                            !(Maybe Nat)}
...
listLoggingConfigurations
    :: ListLoggingConfigurations
listLoggingConfigurations
  = ListLoggingConfigurations'{_llcNextMarker =
                                 Nothing,
                               _llcLimit = Nothing}
...
data ListLoggingConfigurationsResponse = ListLoggingConfigurationsResponse'{_llcrsNextMarker
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
listLoggingConfigurationsResponse pResponseStatus_
  = ListLoggingConfigurationsResponse'{_llcrsNextMarker
                                         = Nothing,
