...
data CreateWebACLMigrationStack = CreateWebACLMigrationStack'{_cwamsWebACLId
                                                              :: !Text,
                                                              _cwamsS3BucketName
                                                              :: !Text,
...
createWebACLMigrationStack
    :: Text -- ^ 'cwamsWebACLId'
    -> Text -- ^ 'cwamsS3BucketName'
    -> Bool -- ^ 'cwamsIgnoreUnsupportedType'
    -> CreateWebACLMigrationStack
createWebACLMigrationStack pWebACLId_ pS3BucketName_
  pIgnoreUnsupportedType_
  = CreateWebACLMigrationStack'{_cwamsWebACLId =
                                  pWebACLId_,
...
instance Hashable CreateWebACLMigrationStack where

instance NFData CreateWebACLMigrationStack where
...
data CreateWebACLMigrationStackResponse = CreateWebACLMigrationStackResponse'{_cwamsrsResponseStatus
                                                                              ::
                                                                              !Int,
                                                                              _cwamsrsS3ObjectURL
                                                                              ::
...
createWebACLMigrationStackResponse
    :: Int -- ^ 'cwamsrsResponseStatus'
    -> Text -- ^ 'cwamsrsS3ObjectURL'
    -> CreateWebACLMigrationStackResponse
createWebACLMigrationStackResponse pResponseStatus_
  pS3ObjectURL_
  = CreateWebACLMigrationStackResponse'{_cwamsrsResponseStatus
                                          = pResponseStatus_,
