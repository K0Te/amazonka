...
newtype PutLoggingConfiguration = PutLoggingConfiguration'{_plcLoggingConfiguration
                                                           ::
...
putLoggingConfiguration pLoggingConfiguration_
  = PutLoggingConfiguration'{_plcLoggingConfiguration =
...
data PutLoggingConfigurationResponse = PutLoggingConfigurationResponse'{_plcrsLoggingConfiguration
                                                                        ::
                                                                        !(Maybe
                                                                            LoggingConfiguration),
...
putLoggingConfigurationResponse pResponseStatus_
  = PutLoggingConfigurationResponse'{_plcrsLoggingConfiguration
                                       = Nothing,
