...
data ListSecrets = ListSecrets'{_lsFilters ::
                                !(Maybe [Filter]),
                                _lsNextToken :: !(Maybe Text),
                                _lsSortOrder :: !(Maybe SortOrderType),
...
listSecrets
    :: ListSecrets
listSecrets
  = ListSecrets'{_lsFilters = Nothing,
                 _lsNextToken = Nothing, _lsSortOrder = Nothing,
...
data ListSecretsResponse = ListSecretsResponse'{_lsrsNextToken
                                                :: !(Maybe Text),
                                                _lsrsSecretList ::
...
listSecretsResponse pResponseStatus_
  = ListSecretsResponse'{_lsrsNextToken = Nothing,
