...
data ValidateResourcePolicy = ValidateResourcePolicy'{_vrpSecretId
                                                      :: !(Maybe Text),
                                                      _vrpResourcePolicy ::
                                                      !Text}
...
validateResourcePolicy
    :: Text -- ^ 'vrpResourcePolicy'
    -> ValidateResourcePolicy
validateResourcePolicy pResourcePolicy_
  = ValidateResourcePolicy'{_vrpSecretId = Nothing,
...
instance AWSRequest ValidateResourcePolicy where
        type Rs ValidateResourcePolicy =
             ValidateResourcePolicyResponse
...
instance Hashable ValidateResourcePolicy where

instance NFData ValidateResourcePolicy where
...
data ValidateResourcePolicyResponse = ValidateResourcePolicyResponse'{_vrprsValidationErrors
                                                                      ::
                                                                      !(Maybe
...
validateResourcePolicyResponse
    :: Int -- ^ 'vrprsResponseStatus'
    -> ValidateResourcePolicyResponse
validateResourcePolicyResponse pResponseStatus_
  = ValidateResourcePolicyResponse'{_vrprsValidationErrors
                                      = Nothing,
...
instance NFData ValidateResourcePolicyResponse where
