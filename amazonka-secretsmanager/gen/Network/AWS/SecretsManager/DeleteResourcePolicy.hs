...
newtype DeleteResourcePolicy = DeleteResourcePolicy'{_drpSecretId
                                                     :: Text}
...
data DeleteResourcePolicyResponse = DeleteResourcePolicyResponse'{_drprsARN
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _drprsName ::
                                                                  !(Maybe Text),
...
deleteResourcePolicyResponse pResponseStatus_
  = DeleteResourcePolicyResponse'{_drprsARN = Nothing,
                                  _drprsName = Nothing,
