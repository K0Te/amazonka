...
newtype GetResourcePolicy = GetResourcePolicy'{_grpSecretId
                                               :: Text}
...
data GetResourcePolicyResponse = GetResourcePolicyResponse'{_grprsResourcePolicy
                                                            :: !(Maybe Text),
                                                            _grprsARN ::
                                                            !(Maybe Text),
                                                            _grprsName ::
...
getResourcePolicyResponse pResponseStatus_
  = GetResourcePolicyResponse'{_grprsResourcePolicy =
                                 Nothing,
                               _grprsARN = Nothing, _grprsName = Nothing,
