...
data GetInsightSummaries = GetInsightSummaries'{_gisStates
                                                :: !(Maybe [InsightState]),
...
getInsightSummaries
    :: UTCTime -- ^ 'gisStartTime'
    -> UTCTime -- ^ 'gisEndTime'
    -> GetInsightSummaries
getInsightSummaries pStartTime_ pEndTime_
  = GetInsightSummaries'{_gisStates = Nothing,
                         _gisNextToken = Nothing, _gisGroupARN = Nothing,
                         _gisGroupName = Nothing, _gisMaxResults = Nothing,
...
instance Hashable GetInsightSummaries where

instance NFData GetInsightSummaries where
...
data GetInsightSummariesResponse = GetInsightSummariesResponse'{_gisrsInsightSummaries
                                                                ::
                                                                !(Maybe
                                                                    [InsightSummary]),
                                                                _gisrsNextToken
...
getInsightSummariesResponse pResponseStatus_
  = GetInsightSummariesResponse'{_gisrsInsightSummaries
                                   = Nothing,
...
instance NFData GetInsightSummariesResponse where
