...
data DeleteSamplingRule = DeleteSamplingRule'{_dsrRuleName
                                              :: !(Maybe Text),
...
deleteSamplingRule
    :: DeleteSamplingRule
deleteSamplingRule
  = DeleteSamplingRule'{_dsrRuleName = Nothing,
                        _dsrRuleARN = Nothing}
...
data DeleteSamplingRuleResponse = DeleteSamplingRuleResponse'{_dsrrsSamplingRuleRecord
                                                              ::
                                                              !(Maybe
                                                                  SamplingRuleRecord),
...
deleteSamplingRuleResponse pResponseStatus_
  = DeleteSamplingRuleResponse'{_dsrrsSamplingRuleRecord
                                  = Nothing,
