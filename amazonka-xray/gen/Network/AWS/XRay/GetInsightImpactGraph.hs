...
data GetInsightImpactGraph = GetInsightImpactGraph'{_giigNextToken
                                                    :: !(Maybe Text),
                                                    _giigInsightId :: !Text,
...
getInsightImpactGraph
    :: Text -- ^ 'giigInsightId'
    -> UTCTime -- ^ 'giigStartTime'
    -> UTCTime -- ^ 'giigEndTime'
    -> GetInsightImpactGraph
getInsightImpactGraph pInsightId_ pStartTime_
  pEndTime_
  = GetInsightImpactGraph'{_giigNextToken = Nothing,
...
instance Hashable GetInsightImpactGraph where

instance NFData GetInsightImpactGraph where
...
data GetInsightImpactGraphResponse = GetInsightImpactGraphResponse'{_giigrsServiceGraphStartTime
                                                                    ::
                                                                    !(Maybe
                                                                        POSIX),
                                                                    _giigrsStartTime
...
getInsightImpactGraphResponse
    :: Int -- ^ 'giigrsResponseStatus'
    -> GetInsightImpactGraphResponse
getInsightImpactGraphResponse pResponseStatus_
  = GetInsightImpactGraphResponse'{_giigrsServiceGraphStartTime
                                     = Nothing,
...
instance NFData GetInsightImpactGraphResponse where
