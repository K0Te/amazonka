...
data ResponseTimeRootCauseEntity = ResponseTimeRootCauseEntity'{_rtrceRemote
                                                                ::
                                                                !(Maybe Bool),
                                                                _rtrceCoverage
                                                                ::
...
responseTimeRootCauseEntity
    :: ResponseTimeRootCauseEntity
responseTimeRootCauseEntity
  = ResponseTimeRootCauseEntity'{_rtrceRemote =
                                   Nothing,
                                 _rtrceCoverage = Nothing, _rtrceName = Nothing}
