...
data SamplingStatisticSummary = SamplingStatisticSummary'{_sssRequestCount
                                                          :: !(Maybe Int),
                                                          _sssBorrowCount ::
                                                          !(Maybe Int),
                                                          _sssRuleName ::
...
samplingStatisticSummary
    :: SamplingStatisticSummary
samplingStatisticSummary
  = SamplingStatisticSummary'{_sssRequestCount =
                                Nothing,
                              _sssBorrowCount = Nothing, _sssRuleName = Nothing,
