...
data TimeSeriesServiceStatistics = TimeSeriesServiceStatistics'{_tsssServiceSummaryStatistics
                                                                ::
                                                                !(Maybe
                                                                    ServiceStatistics),
...
timeSeriesServiceStatistics
    :: TimeSeriesServiceStatistics
timeSeriesServiceStatistics
  = TimeSeriesServiceStatistics'{_tsssServiceSummaryStatistics
                                   = Nothing,
...
instance FromJSON TimeSeriesServiceStatistics where
        parseJSON
          = withObject "TimeSeriesServiceStatistics"
              (\ x ->
                 TimeSeriesServiceStatistics' <$>
...
instance Hashable TimeSeriesServiceStatistics where

instance NFData TimeSeriesServiceStatistics where
