...
data ForecastStatistics = ForecastStatistics'{_fsFaultCountLow
                                              :: !(Maybe Integer),
                                              _fsFaultCountHigh ::
                                              !(Maybe Integer)}
...
forecastStatistics
    :: ForecastStatistics
forecastStatistics
  = ForecastStatistics'{_fsFaultCountLow = Nothing,
...
instance FromJSON ForecastStatistics where
        parseJSON
          = withObject "ForecastStatistics"
              (\ x ->
                 ForecastStatistics' <$>
                   (x .:? "FaultCountLow") <*> (x .:? "FaultCountHigh"))

instance Hashable ForecastStatistics where

instance NFData ForecastStatistics where
