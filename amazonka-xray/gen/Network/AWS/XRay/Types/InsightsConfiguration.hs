...
data InsightsConfiguration = InsightsConfiguration'{_icNotificationsEnabled
                                                    :: !(Maybe Bool),
                                                    _icInsightsEnabled ::
                                                    !(Maybe Bool)}
...
insightsConfiguration
    :: InsightsConfiguration
insightsConfiguration
  = InsightsConfiguration'{_icNotificationsEnabled =
                             Nothing,
...
instance FromJSON InsightsConfiguration where
        parseJSON
          = withObject "InsightsConfiguration"
              (\ x ->
                 InsightsConfiguration' <$>
                   (x .:? "NotificationsEnabled") <*>
                     (x .:? "InsightsEnabled"))

instance Hashable InsightsConfiguration where

instance NFData InsightsConfiguration where
