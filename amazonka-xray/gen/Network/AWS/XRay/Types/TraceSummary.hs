...
traceSummary
  = TraceSummary'{_tsAnnotations = Nothing,
                  ...
                  _tsEntryPoint = Nothing, _tsHasFault = Nothing,
                  _tsServiceIds = Nothing,
                  _tsMatchedEventTime = Nothing,
                  _tsIsPartial = Nothing, _tsErrorRootCauses = Nothing,
                  _tsResourceARNs = Nothing,
                  _tsAvailabilityZones = Nothing,
                  _tsInstanceIds = Nothing,
                  _tsResponseTimeRootCauses = Nothing,
                  _tsHasError = Nothing, _tsId = Nothing,
                  _tsHTTP = Nothing, _tsRevision = Nothing,
                  _tsDuration = Nothing, _tsFaultRootCauses = Nothing,
