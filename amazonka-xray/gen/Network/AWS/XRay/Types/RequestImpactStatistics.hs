...
data RequestImpactStatistics = RequestImpactStatistics'{_risOKCount
                                                        :: !(Maybe Integer),
                                                        _risFaultCount ::
                                                        !(Maybe Integer),
                                                        _risTotalCount ::
...
requestImpactStatistics
    :: RequestImpactStatistics
requestImpactStatistics
  = RequestImpactStatistics'{_risOKCount = Nothing,
                             _risFaultCount = Nothing, _risTotalCount = Nothing}
...
instance FromJSON RequestImpactStatistics where
        parseJSON
          = withObject "RequestImpactStatistics"
              (\ x ->
                 RequestImpactStatistics' <$>
                   (x .:? "OkCount") <*> (x .:? "FaultCount") <*>
                     (x .:? "TotalCount"))

instance Hashable RequestImpactStatistics where

instance NFData RequestImpactStatistics where
