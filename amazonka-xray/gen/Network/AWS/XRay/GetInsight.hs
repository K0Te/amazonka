...
newtype GetInsight = GetInsight'{_giInsightId ::
                                 Text}
...
instance Hashable GetInsight where

instance NFData GetInsight where
...
data GetInsightResponse = GetInsightResponse'{_girsInsight
                                              :: !(Maybe Insight),
...
getInsightResponse pResponseStatus_
  = GetInsightResponse'{_girsInsight = Nothing,
...
instance NFData GetInsightResponse where
