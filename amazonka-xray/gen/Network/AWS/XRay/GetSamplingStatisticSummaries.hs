...
newtype GetSamplingStatisticSummaries = GetSamplingStatisticSummaries'{_gsssNextToken
                                                                       ::
                                                                       Maybe
                                                                         Text}
...
getSamplingStatisticSummaries
    :: GetSamplingStatisticSummaries
getSamplingStatisticSummaries
  = GetSamplingStatisticSummaries'{_gsssNextToken =
                                     Nothing}
...
data GetSamplingStatisticSummariesResponse = GetSamplingStatisticSummariesResponse'{_gsssrsSamplingStatisticSummaries
                                                                                    ::
                                                                                    !(Maybe
...
--
-- * 'gsssrsNextToken' - Pagination token.
--
...
getSamplingStatisticSummariesResponse
  pResponseStatus_
  = GetSamplingStatisticSummariesResponse'{_gsssrsSamplingStatisticSummaries
                                             = Nothing,
