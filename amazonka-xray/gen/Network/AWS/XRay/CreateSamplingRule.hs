...
data CreateSamplingRule = CreateSamplingRule'{_csrTags
                                              :: !(Maybe [Tag]),
...
createSamplingRule pSamplingRule_
  = CreateSamplingRule'{_csrTags = Nothing,
...
data CreateSamplingRuleResponse = CreateSamplingRuleResponse'{_csrrsSamplingRuleRecord
                                                              ::
                                                              !(Maybe
                                                                  SamplingRuleRecord),
...
createSamplingRuleResponse pResponseStatus_
  = CreateSamplingRuleResponse'{_csrrsSamplingRuleRecord
                                  = Nothing,
