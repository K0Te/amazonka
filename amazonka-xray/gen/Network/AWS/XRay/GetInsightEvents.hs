...
data GetInsightEvents = GetInsightEvents'{_gieNextToken
                                          :: !(Maybe Text),
...
getInsightEvents pInsightId_
  = GetInsightEvents'{_gieNextToken = Nothing,
...
instance Hashable GetInsightEvents where

instance NFData GetInsightEvents where
...
data GetInsightEventsResponse = GetInsightEventsResponse'{_giersInsightEvents
                                                          ::
                                                          !(Maybe
                                                              [InsightEvent]),
                                                          _giersNextToken ::
                                                          !(Maybe Text),
                                                          _giersResponseStatus
                                                          :: !Int}
...
getInsightEventsResponse
    :: Int -- ^ 'giersResponseStatus'
    -> GetInsightEventsResponse
getInsightEventsResponse pResponseStatus_
  = GetInsightEventsResponse'{_giersInsightEvents =
                                Nothing,
...
instance NFData GetInsightEventsResponse where
