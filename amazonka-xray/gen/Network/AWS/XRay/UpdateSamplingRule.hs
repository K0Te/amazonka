...
newtype UpdateSamplingRule = UpdateSamplingRule'{_usrSamplingRuleUpdate
                                                 :: SamplingRuleUpdate}
...
updateSamplingRule pSamplingRuleUpdate_
  = UpdateSamplingRule'{_usrSamplingRuleUpdate =
...
data UpdateSamplingRuleResponse = UpdateSamplingRuleResponse'{_usrrsSamplingRuleRecord
                                                              ::
                                                              !(Maybe
                                                                  SamplingRuleRecord),
...
updateSamplingRuleResponse pResponseStatus_
  = UpdateSamplingRuleResponse'{_usrrsSamplingRuleRecord
                                  = Nothing,
