...
newtype GetSamplingTargets = GetSamplingTargets'{_gstSamplingStatisticsDocuments
                                                 ::
...
getSamplingTargets
    :: GetSamplingTargets
getSamplingTargets
  = GetSamplingTargets'{_gstSamplingStatisticsDocuments
                          = mempty}
...
data GetSamplingTargetsResponse = GetSamplingTargetsResponse'{_gstrsUnprocessedStatistics
                                                              ::
                                                              !(Maybe
...
getSamplingTargetsResponse pResponseStatus_
  = GetSamplingTargetsResponse'{_gstrsUnprocessedStatistics
                                  = Nothing,
