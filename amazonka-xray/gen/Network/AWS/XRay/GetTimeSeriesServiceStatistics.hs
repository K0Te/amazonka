...
data GetTimeSeriesServiceStatistics = GetTimeSeriesServiceStatistics'{_gtsssEntitySelectorExpression
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _gtsssPeriod
...
getTimeSeriesServiceStatistics
    :: UTCTime -- ^ 'gtsssStartTime'
    -> UTCTime -- ^ 'gtsssEndTime'
    -> GetTimeSeriesServiceStatistics
getTimeSeriesServiceStatistics pStartTime_ pEndTime_
  = GetTimeSeriesServiceStatistics'{_gtsssEntitySelectorExpression
                                      = Nothing,
...
instance AWSPager GetTimeSeriesServiceStatistics
         where
        page rq rs
          | stop (rs ^. gtsssrsNextToken) = Nothing
          | stop (rs ^. gtsssrsTimeSeriesServiceStatistics) =
            Nothing
          | otherwise =
            Just $ rq & gtsssNextToken .~ rs ^. gtsssrsNextToken

instance AWSRequest GetTimeSeriesServiceStatistics
         where
...
instance NFData GetTimeSeriesServiceStatistics where

instance ToHeaders GetTimeSeriesServiceStatistics
         where
...
data GetTimeSeriesServiceStatisticsResponse = GetTimeSeriesServiceStatisticsResponse'{_gtsssrsContainsOldGroupVersions
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Bool),
...
getTimeSeriesServiceStatisticsResponse
    :: Int -- ^ 'gtsssrsResponseStatus'
    -> GetTimeSeriesServiceStatisticsResponse
getTimeSeriesServiceStatisticsResponse
  pResponseStatus_
  = GetTimeSeriesServiceStatisticsResponse'{_gtsssrsContainsOldGroupVersions
                                              = Nothing,
                                            _gtsssrsTimeSeriesServiceStatistics
                                              = Nothing,
