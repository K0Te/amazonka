...
newtype GetSamplingRules = GetSamplingRules'{_gsrNextToken
                                             :: Maybe Text}
...
data GetSamplingRulesResponse = GetSamplingRulesResponse'{_gsrrsSamplingRuleRecords
                                                          ::
                                                          !(Maybe
                                                              [SamplingRuleRecord]),
                                                          _gsrrsNextToken ::
...
--
-- * 'gsrrsNextToken' - Pagination token.
--
...
getSamplingRulesResponse pResponseStatus_
  = GetSamplingRulesResponse'{_gsrrsSamplingRuleRecords
                                = Nothing,
