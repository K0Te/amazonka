...
data CreateCapacityProvider = CreateCapacityProvider'{_ccpTags
                                                      :: !(Maybe [Tag]),
                                                      _ccpName :: !Text,
...
createCapacityProvider
    :: Text -- ^ 'ccpName'
    -> AutoScalingGroupProvider -- ^ 'ccpAutoScalingGroupProvider'
    -> CreateCapacityProvider
createCapacityProvider pName_
  pAutoScalingGroupProvider_
  = CreateCapacityProvider'{_ccpTags = Nothing,
                            _ccpName = pName_,
                            _ccpAutoScalingGroupProvider =
                              pAutoScalingGroupProvider_}
...
instance AWSRequest CreateCapacityProvider where
        type Rs CreateCapacityProvider =
             CreateCapacityProviderResponse
...
instance Hashable CreateCapacityProvider where

instance NFData CreateCapacityProvider where
...
instance ToJSON CreateCapacityProvider where
        toJSON CreateCapacityProvider'{..}
          = object
              (catMaybes
                 [("tags" .=) <$> _ccpTags, Just ("name" .= _ccpName),
                  Just
                    ("autoScalingGroupProvider" .=
                       _ccpAutoScalingGroupProvider)])
...
data CreateCapacityProviderResponse = CreateCapacityProviderResponse'{_ccprsCapacityProvider
                                                                      ::
                                                                      !(Maybe
                                                                          CapacityProvider),
...
createCapacityProviderResponse pResponseStatus_
  = CreateCapacityProviderResponse'{_ccprsCapacityProvider
                                      = Nothing,
...
instance NFData CreateCapacityProviderResponse where
