...
data DeleteTaskSet = DeleteTaskSet'{_dtsForce ::
                                    !(Maybe Bool),
                                    _dtsCluster :: !Text, _dtsService :: !Text,
                                    _dtsTaskSet :: !Text}
...
deleteTaskSet pCluster_ pService_ pTaskSet_
  = DeleteTaskSet'{_dtsForce = Nothing,
                   _dtsCluster = pCluster_, _dtsService = pService_,
...
instance Hashable DeleteTaskSet where

instance NFData DeleteTaskSet where
...
data DeleteTaskSetResponse = DeleteTaskSetResponse'{_dtsrsTaskSet
                                                    :: !(Maybe TaskSet),
...
deleteTaskSetResponse pResponseStatus_
  = DeleteTaskSetResponse'{_dtsrsTaskSet = Nothing,
...
instance NFData DeleteTaskSetResponse where
