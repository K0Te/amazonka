...
data DescribeTaskSets = DescribeTaskSets'{_dtssTaskSets
                                          :: !(Maybe [Text]),
                                          _dtssInclude ::
                                          !(Maybe [TaskSetField]),
                                          _dtssCluster :: !Text,
...
describeTaskSets pCluster_ pService_
  = DescribeTaskSets'{_dtssTaskSets = Nothing,
                      _dtssInclude = Nothing, _dtssCluster = pCluster_,
...
instance Hashable DescribeTaskSets where

instance NFData DescribeTaskSets where
...
data DescribeTaskSetsResponse = DescribeTaskSetsResponse'{_dtssrsTaskSets
                                                          :: !(Maybe [TaskSet]),
                                                          _dtssrsFailures ::
                                                          !(Maybe [Failure]),
                                                          _dtssrsResponseStatus
                                                          :: !Int}
...
describeTaskSetsResponse
    :: Int -- ^ 'dtssrsResponseStatus'
    -> DescribeTaskSetsResponse
describeTaskSetsResponse pResponseStatus_
  = DescribeTaskSetsResponse'{_dtssrsTaskSets =
                                Nothing,
...
instance NFData DescribeTaskSetsResponse where
