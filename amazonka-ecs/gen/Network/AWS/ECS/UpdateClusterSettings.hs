...
data UpdateClusterSettings = UpdateClusterSettings'{_ucsCluster
                                                    :: !Text,
                                                    _ucsSettings ::
                                                    ![ClusterSetting]}
...
updateClusterSettings pCluster_
  = UpdateClusterSettings'{_ucsCluster = pCluster_,
                           _ucsSettings = mempty}
...
instance Hashable UpdateClusterSettings where

instance NFData UpdateClusterSettings where
...
data UpdateClusterSettingsResponse = UpdateClusterSettingsResponse'{_ucsrsCluster
                                                                    ::
                                                                    !(Maybe
                                                                        Cluster),
...
updateClusterSettingsResponse pResponseStatus_
  = UpdateClusterSettingsResponse'{_ucsrsCluster =
                                     Nothing,
...
instance NFData UpdateClusterSettingsResponse where
