...
data PutAccountSettingDefault = PutAccountSettingDefault'{_pasdName
                                                          :: !SettingName,
                                                          _pasdValue :: !Text}
...
putAccountSettingDefault pName_ pValue_
  = PutAccountSettingDefault'{_pasdName = pName_,
                              _pasdValue = pValue_}
...
data PutAccountSettingDefaultResponse = PutAccountSettingDefaultResponse'{_pasdrsSetting
                                                                          ::
                                                                          !(Maybe
                                                                              Setting),
...
putAccountSettingDefaultResponse pResponseStatus_
  = PutAccountSettingDefaultResponse'{_pasdrsSetting =
                                        Nothing,
