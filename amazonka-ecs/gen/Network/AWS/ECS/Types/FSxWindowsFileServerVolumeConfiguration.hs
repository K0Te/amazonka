...
data FSxWindowsFileServerVolumeConfiguration = FSxWindowsFileServerVolumeConfiguration'{_fswfsvcFileSystemId
                                                                                        ::
                                                                                        !Text,
...
fSxWindowsFileServerVolumeConfiguration
    :: Text -- ^ 'fswfsvcFileSystemId'
    -> Text -- ^ 'fswfsvcRootDirectory'
    -> FSxWindowsFileServerAuthorizationConfig -- ^ 'fswfsvcAuthorizationConfig'
    -> FSxWindowsFileServerVolumeConfiguration
fSxWindowsFileServerVolumeConfiguration
  pFileSystemId_ pRootDirectory_ pAuthorizationConfig_
  = FSxWindowsFileServerVolumeConfiguration'{_fswfsvcFileSystemId
                                               = pFileSystemId_,
                                             _fswfsvcRootDirectory =
                                               pRootDirectory_,
                                             _fswfsvcAuthorizationConfig =
...
instance FromJSON
        ...
        parseJSON
          = withObject
              ...
              (\ x ->
                 FSxWindowsFileServerVolumeConfiguration' <$>
                   (x .: "fileSystemId") <*> (x .: "rootDirectory") <*>
