...
data EFSVolumeConfiguration = EFSVolumeConfiguration'{_efsvcRootDirectory
                                                      :: !(Maybe Text),
...
eFSVolumeConfiguration
    :: Text -- ^ 'efsvcFileSystemId'
    -> EFSVolumeConfiguration
eFSVolumeConfiguration pFileSystemId_
  = EFSVolumeConfiguration'{_efsvcRootDirectory =
                              Nothing,
...
instance FromJSON EFSVolumeConfiguration where
        parseJSON
          = withObject "EFSVolumeConfiguration"
              (\ x ->
                 EFSVolumeConfiguration' <$>
                   (x .:? "rootDirectory") <*>
                     (x .:? "transitEncryption")
...
instance Hashable EFSVolumeConfiguration where

instance NFData EFSVolumeConfiguration where
