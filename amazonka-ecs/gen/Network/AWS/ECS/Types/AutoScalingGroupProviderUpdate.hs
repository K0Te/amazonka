...
data AutoScalingGroupProviderUpdate = AutoScalingGroupProviderUpdate'{_asgpuManagedScaling
                                                                      ::
                                                                      !(Maybe
                                                                          ManagedScaling),
...
autoScalingGroupProviderUpdate
    :: AutoScalingGroupProviderUpdate
autoScalingGroupProviderUpdate
  = AutoScalingGroupProviderUpdate'{_asgpuManagedScaling
                                      = Nothing,
                                    _asgpuManagedTerminationProtection =
                                      Nothing}
...
instance NFData AutoScalingGroupProviderUpdate where
