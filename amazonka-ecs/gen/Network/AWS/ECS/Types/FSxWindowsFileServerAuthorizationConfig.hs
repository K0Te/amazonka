...
data FSxWindowsFileServerAuthorizationConfig = FSxWindowsFileServerAuthorizationConfig'{_fswfsacCredentialsParameter
                                                                                        ::
                                                                                        !Text,
                                                                                        _fswfsacDomain
                                                                                        ::
...
fSxWindowsFileServerAuthorizationConfig
    :: Text -- ^ 'fswfsacCredentialsParameter'
    -> Text -- ^ 'fswfsacDomain'
    -> FSxWindowsFileServerAuthorizationConfig
fSxWindowsFileServerAuthorizationConfig
  pCredentialsParameter_ pDomain_
  = FSxWindowsFileServerAuthorizationConfig'{_fswfsacCredentialsParameter
