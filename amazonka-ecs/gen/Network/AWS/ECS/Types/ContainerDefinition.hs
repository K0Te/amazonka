...
containerDefinition
  = ContainerDefinition'{_cdImage = Nothing,
                         ...
                         _cdDisableNetworking = Nothing, _cdSecrets = Nothing,
                         ...
                         _cdStopTimeout = Nothing, _cdPrivileged = Nothing,
                         _cdPortMappings = Nothing,
                         _cdResourceRequirements = Nothing,
                         _cdDockerLabels = Nothing, _cdExtraHosts = Nothing,
                         _cdMemory = Nothing, _cdSystemControls = Nothing,
                         _cdUser = Nothing,
                         _cdFirelensConfiguration = Nothing,
                         _cdDnsSearchDomains = Nothing,
                         _cdLogConfiguration = Nothing,
                         _cdLinuxParameters = Nothing,
                         _cdPseudoTerminal = Nothing, _cdDependsOn = Nothing,
                         _cdName = Nothing, _cdDnsServers = Nothing,
                         _cdMountPoints = Nothing, _cdInteractive = Nothing,
                         _cdStartTimeout = Nothing, _cdLinks = Nothing,
