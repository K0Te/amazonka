...
data EFSAuthorizationConfig = EFSAuthorizationConfig'{_efsacAccessPointId
                                                      :: !(Maybe Text),
                                                      _efsacIam ::
                                                      !(Maybe
...
eFSAuthorizationConfig
    :: EFSAuthorizationConfig
eFSAuthorizationConfig
  = EFSAuthorizationConfig'{_efsacAccessPointId =
                              Nothing,
                            _efsacIam = Nothing}
...
instance FromJSON EFSAuthorizationConfig where
        parseJSON
          = withObject "EFSAuthorizationConfig"
              (\ x ->
                 EFSAuthorizationConfig' <$>
                   (x .:? "accessPointId") <*> (x .:? "iam"))

instance Hashable EFSAuthorizationConfig where

instance NFData EFSAuthorizationConfig where
