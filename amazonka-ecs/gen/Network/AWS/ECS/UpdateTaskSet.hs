...
data UpdateTaskSet = UpdateTaskSet'{_utsCluster ::
                                    !Text,
                                    _utsService :: !Text, _utsTaskSet :: !Text,
                                    _utsScale :: !Scale}
...
updateTaskSet pCluster_ pService_ pTaskSet_ pScale_
  = UpdateTaskSet'{_utsCluster = pCluster_,
                   _utsService = pService_, _utsTaskSet = pTaskSet_,
                   _utsScale = pScale_}
...
instance Hashable UpdateTaskSet where

instance NFData UpdateTaskSet where
...
data UpdateTaskSetResponse = UpdateTaskSetResponse'{_utsrsTaskSet
                                                    :: !(Maybe TaskSet),
...
updateTaskSetResponse pResponseStatus_
  = UpdateTaskSetResponse'{_utsrsTaskSet = Nothing,
...
instance NFData UpdateTaskSetResponse where
