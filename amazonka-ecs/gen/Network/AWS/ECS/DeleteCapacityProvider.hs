...
newtype DeleteCapacityProvider = DeleteCapacityProvider'{_dcpCapacityProvider
                                                         :: Text}
...
deleteCapacityProvider
    :: Text -- ^ 'dcpCapacityProvider'
    -> DeleteCapacityProvider
deleteCapacityProvider pCapacityProvider_
  = DeleteCapacityProvider'{_dcpCapacityProvider =
                              pCapacityProvider_}
...
instance AWSRequest DeleteCapacityProvider where
        type Rs DeleteCapacityProvider =
             DeleteCapacityProviderResponse
...
instance Hashable DeleteCapacityProvider where

instance NFData DeleteCapacityProvider where
...
data DeleteCapacityProviderResponse = DeleteCapacityProviderResponse'{_delrsCapacityProvider
                                                                      ::
                                                                      !(Maybe
                                                                          CapacityProvider),
...
deleteCapacityProviderResponse pResponseStatus_
  = DeleteCapacityProviderResponse'{_delrsCapacityProvider
                                      = Nothing,
...
instance NFData DeleteCapacityProviderResponse where
