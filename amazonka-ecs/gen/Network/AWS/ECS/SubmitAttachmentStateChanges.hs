...
data SubmitAttachmentStateChanges = SubmitAttachmentStateChanges'{_sascCluster
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _sascAttachments
                                                                  ::
...
submitAttachmentStateChanges
    :: SubmitAttachmentStateChanges
submitAttachmentStateChanges
  = SubmitAttachmentStateChanges'{_sascCluster =
                                    Nothing,
...
instance AWSRequest SubmitAttachmentStateChanges
         where
...
instance Hashable SubmitAttachmentStateChanges where

instance NFData SubmitAttachmentStateChanges where
...
data SubmitAttachmentStateChangesResponse = SubmitAttachmentStateChangesResponse'{_sascrsAcknowledgment
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
submitAttachmentStateChangesResponse
    :: Int -- ^ 'sascrsResponseStatus'
    -> SubmitAttachmentStateChangesResponse
submitAttachmentStateChangesResponse pResponseStatus_
  = SubmitAttachmentStateChangesResponse'{_sascrsAcknowledgment
                                            = Nothing,
                                          _sascrsResponseStatus =
                                            pResponseStatus_}
