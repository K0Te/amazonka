...
data UpdateCapacityProvider = UpdateCapacityProvider'{_ucpName
                                                      :: !Text,
...
updateCapacityProvider
    :: Text -- ^ 'ucpName'
    -> AutoScalingGroupProviderUpdate -- ^ 'ucpAutoScalingGroupProvider'
    -> UpdateCapacityProvider
updateCapacityProvider pName_
  pAutoScalingGroupProvider_
  = UpdateCapacityProvider'{_ucpName = pName_,
                            _ucpAutoScalingGroupProvider =
                              pAutoScalingGroupProvider_}
...
instance AWSRequest UpdateCapacityProvider where
        type Rs UpdateCapacityProvider =
             UpdateCapacityProviderResponse
...
instance Hashable UpdateCapacityProvider where

instance NFData UpdateCapacityProvider where
...
data UpdateCapacityProviderResponse = UpdateCapacityProviderResponse'{_ucprsCapacityProvider
                                                                      ::
                                                                      !(Maybe
                                                                          CapacityProvider),
...
updateCapacityProviderResponse pResponseStatus_
  = UpdateCapacityProviderResponse'{_ucprsCapacityProvider
                                      = Nothing,
...
instance NFData UpdateCapacityProviderResponse where
