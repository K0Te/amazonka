...
data PutClusterCapacityProviders = PutClusterCapacityProviders'{_pccpCluster
                                                                :: !Text,
...
putClusterCapacityProviders pCluster_
  = PutClusterCapacityProviders'{_pccpCluster =
                                   pCluster_,
...
instance Hashable PutClusterCapacityProviders where

instance NFData PutClusterCapacityProviders where
...
data PutClusterCapacityProvidersResponse = PutClusterCapacityProvidersResponse'{_pccprsCluster
                                                                                ::
                                                                                !(Maybe
                                                                                    Cluster),
...
putClusterCapacityProvidersResponse
    :: Int -- ^ 'pccprsResponseStatus'
    -> PutClusterCapacityProvidersResponse
putClusterCapacityProvidersResponse pResponseStatus_
  = PutClusterCapacityProvidersResponse'{_pccprsCluster
                                           = Nothing,
                                         _pccprsResponseStatus =
                                           pResponseStatus_}
