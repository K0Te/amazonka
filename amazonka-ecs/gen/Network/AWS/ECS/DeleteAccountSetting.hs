...
data DeleteAccountSetting = DeleteAccountSetting'{_dasPrincipalARN
                                                  :: !(Maybe Text),
...
deleteAccountSetting pName_
  = DeleteAccountSetting'{_dasPrincipalARN = Nothing,
                          _dasName = pName_}
...
instance Hashable DeleteAccountSetting where

instance NFData DeleteAccountSetting where
...
data DeleteAccountSettingResponse = DeleteAccountSettingResponse'{_dasrsSetting
                                                                  ::
                                                                  !(Maybe
                                                                      Setting),
...
deleteAccountSettingResponse pResponseStatus_
  = DeleteAccountSettingResponse'{_dasrsSetting =
                                    Nothing,
...
instance NFData DeleteAccountSettingResponse where
