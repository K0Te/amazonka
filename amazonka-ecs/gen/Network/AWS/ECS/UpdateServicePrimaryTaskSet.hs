...
data UpdateServicePrimaryTaskSet = UpdateServicePrimaryTaskSet'{_usptsCluster
                                                                :: !Text,
                                                                _usptsService ::
                                                                !Text,
...
updateServicePrimaryTaskSet
    :: Text -- ^ 'usptsCluster'
    -> Text -- ^ 'usptsService'
    -> Text -- ^ 'usptsPrimaryTaskSet'
    -> UpdateServicePrimaryTaskSet
updateServicePrimaryTaskSet pCluster_ pService_
  pPrimaryTaskSet_
  = UpdateServicePrimaryTaskSet'{_usptsCluster =
                                   pCluster_,
...
instance Hashable UpdateServicePrimaryTaskSet where

instance NFData UpdateServicePrimaryTaskSet where
...
data UpdateServicePrimaryTaskSetResponse = UpdateServicePrimaryTaskSetResponse'{_usptsrsTaskSet
                                                                                ::
                                                                                !(Maybe
                                                                                    TaskSet),
...
updateServicePrimaryTaskSetResponse
    :: Int -- ^ 'usptsrsResponseStatus'
    -> UpdateServicePrimaryTaskSetResponse
updateServicePrimaryTaskSetResponse pResponseStatus_
  = UpdateServicePrimaryTaskSetResponse'{_usptsrsTaskSet
                                           = Nothing,
                                         _usptsrsResponseStatus =
                                           pResponseStatus_}
