...
data PutAccountSetting = PutAccountSetting'{_pasPrincipalARN
                                            :: !(Maybe Text),
...
putAccountSetting pName_ pValue_
  = PutAccountSetting'{_pasPrincipalARN = Nothing,
                       _pasName = pName_, _pasValue = pValue_}
...
data PutAccountSettingResponse = PutAccountSettingResponse'{_pasrsSetting
                                                            :: !(Maybe Setting),
                                                            _pasrsResponseStatus
                                                            :: !Int}
...
putAccountSettingResponse pResponseStatus_
  = PutAccountSettingResponse'{_pasrsSetting = Nothing,
