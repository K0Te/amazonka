...
data ListAccountSettings = ListAccountSettings'{_lasValue
                                                :: !(Maybe Text),
...
listAccountSettings
    :: ListAccountSettings
listAccountSettings
  = ListAccountSettings'{_lasValue = Nothing,
                         _lasNextToken = Nothing, _lasName = Nothing,
...
instance AWSRequest ListAccountSettings where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 ListAccountSettingsResponse' <$>
                   (x .?> "settings" .!@ mempty) <*> (x .?> "nextToken")
                     <*> (pure (fromEnum s)))

instance Hashable ListAccountSettings where

instance NFData ListAccountSettings where
...
data ListAccountSettingsResponse = ListAccountSettingsResponse'{_lasrsSettings
                                                                ::
                                                                !(Maybe
                                                                    [Setting]),
                                                                _lasrsNextToken
...
listAccountSettingsResponse pResponseStatus_
  = ListAccountSettingsResponse'{_lasrsSettings =
                                   Nothing,
...
instance NFData ListAccountSettingsResponse where
