...
data GetMetricWidgetImage = GetMetricWidgetImage'{_gmwiOutputFormat
                                                  :: !(Maybe Text),
...
getMetricWidgetImage pMetricWidget_
  = GetMetricWidgetImage'{_gmwiOutputFormat = Nothing,
...
data GetMetricWidgetImageResponse = GetMetricWidgetImageResponse'{_gmwirsMetricWidgetImage
                                                                  ::
                                                                  !(Maybe
                                                                      Base64),
                                                                  _gmwirsResponseStatus
                                                                  :: !Int}
...
getMetricWidgetImageResponse pResponseStatus_
  = GetMetricWidgetImageResponse'{_gmwirsMetricWidgetImage
                                    = Nothing,
