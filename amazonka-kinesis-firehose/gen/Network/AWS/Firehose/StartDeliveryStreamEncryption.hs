...
data StartDeliveryStreamEncryption = StartDeliveryStreamEncryption'{_sDeliveryStreamEncryptionConfigurationInput
                                                                    ::
                                                                    !(Maybe
...
startDeliveryStreamEncryption pDeliveryStreamName_
  = StartDeliveryStreamEncryption'{_sDeliveryStreamEncryptionConfigurationInput
                                     = Nothing,
...
newtype StartDeliveryStreamEncryptionResponse = StartDeliveryStreamEncryptionResponse'{_srsResponseStatus
                                                                                       ::
                                                                                       Int}
...
startDeliveryStreamEncryptionResponse
  pResponseStatus_
  = StartDeliveryStreamEncryptionResponse'{_srsResponseStatus
                                             = pResponseStatus_}
