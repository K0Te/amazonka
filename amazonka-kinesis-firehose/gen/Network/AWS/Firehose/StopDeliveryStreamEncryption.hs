...
newtype StopDeliveryStreamEncryption = StopDeliveryStreamEncryption'{_sdseDeliveryStreamName
                                                                     :: Text}
...
stopDeliveryStreamEncryption
    :: Text -- ^ 'sdseDeliveryStreamName'
    -> StopDeliveryStreamEncryption
stopDeliveryStreamEncryption pDeliveryStreamName_
  = StopDeliveryStreamEncryption'{_sdseDeliveryStreamName
...
instance AWSRequest StopDeliveryStreamEncryption
         where
...
instance Hashable StopDeliveryStreamEncryption where

instance NFData StopDeliveryStreamEncryption where
...
newtype StopDeliveryStreamEncryptionResponse = StopDeliveryStreamEncryptionResponse'{_sdsersResponseStatus
                                                                                     ::
                                                                                     Int}
                                                 deriving (Eq, Read, Show, Data,
                                                           Typeable, Generic)
...
stopDeliveryStreamEncryptionResponse
    :: Int -- ^ 'sdsersResponseStatus'
    -> StopDeliveryStreamEncryptionResponse
stopDeliveryStreamEncryptionResponse pResponseStatus_
  = StopDeliveryStreamEncryptionResponse'{_sdsersResponseStatus
                                            = pResponseStatus_}
