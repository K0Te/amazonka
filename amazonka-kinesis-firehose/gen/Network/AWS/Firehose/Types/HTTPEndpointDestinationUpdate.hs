...
data HTTPEndpointDestinationUpdate = HTTPEndpointDestinationUpdate'{_httpeduS3BackupMode
                                                                    ::
                                                                    !(Maybe
...
hTTPEndpointDestinationUpdate
    :: HTTPEndpointDestinationUpdate
hTTPEndpointDestinationUpdate
  = HTTPEndpointDestinationUpdate'{_httpeduS3BackupMode
                                     = Nothing,
...
instance Hashable HTTPEndpointDestinationUpdate where

instance NFData HTTPEndpointDestinationUpdate where
