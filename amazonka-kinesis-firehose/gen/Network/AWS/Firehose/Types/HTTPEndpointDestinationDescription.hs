...
data HTTPEndpointDestinationDescription = HTTPEndpointDestinationDescription'{_httpeddS3BackupMode
                                                                              ::
                                                                              !(Maybe
...
hTTPEndpointDestinationDescription
    :: HTTPEndpointDestinationDescription
hTTPEndpointDestinationDescription
  = HTTPEndpointDestinationDescription'{_httpeddS3BackupMode
                                          = Nothing,
                                        _httpeddCloudWatchLoggingOptions =
                                          Nothing,
                                        _httpeddS3DestinationDescription =
...
instance FromJSON HTTPEndpointDestinationDescription
         where
        parseJSON
          = withObject "HTTPEndpointDestinationDescription"
              (\ x ->
                 HTTPEndpointDestinationDescription' <$>
                   (x .:? "S3BackupMode") <*>
