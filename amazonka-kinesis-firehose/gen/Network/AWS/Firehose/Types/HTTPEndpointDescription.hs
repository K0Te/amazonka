...
data HTTPEndpointDescription = HTTPEndpointDescription'{_httpedURL
                                                        ::
                                                        !(Maybe
                                                            (Sensitive Text)),
                                                        _httpedName ::
...
hTTPEndpointDescription
    :: HTTPEndpointDescription
hTTPEndpointDescription
  = HTTPEndpointDescription'{_httpedURL = Nothing,
                             _httpedName = Nothing}
...
instance FromJSON HTTPEndpointDescription where
        parseJSON
          = withObject "HTTPEndpointDescription"
              (\ x ->
                 HTTPEndpointDescription' <$>
                   (x .:? "Url") <*> (x .:? "Name"))

instance Hashable HTTPEndpointDescription where

instance NFData HTTPEndpointDescription where
