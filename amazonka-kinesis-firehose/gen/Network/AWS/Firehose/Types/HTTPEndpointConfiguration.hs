...
data HTTPEndpointConfiguration = HTTPEndpointConfiguration'{_httpecName
                                                            :: !(Maybe Text),
                                                            _httpecAccessKey ::
                                                            !(Maybe
                                                                (Sensitive
...
hTTPEndpointConfiguration pURL_
  = HTTPEndpointConfiguration'{_httpecName = Nothing,
...
instance Hashable HTTPEndpointConfiguration where

instance NFData HTTPEndpointConfiguration where
