...
newtype HTTPEndpointRetryOptions = HTTPEndpointRetryOptions'{_httperoDurationInSeconds
                                                             :: Maybe Nat}
...
hTTPEndpointRetryOptions
    :: HTTPEndpointRetryOptions
hTTPEndpointRetryOptions
  = HTTPEndpointRetryOptions'{_httperoDurationInSeconds
                                = Nothing}
...
instance FromJSON HTTPEndpointRetryOptions where
        parseJSON
          = withObject "HTTPEndpointRetryOptions"
              (\ x ->
                 HTTPEndpointRetryOptions' <$>
                   (x .:? "DurationInSeconds"))

instance Hashable HTTPEndpointRetryOptions where

instance NFData HTTPEndpointRetryOptions where
