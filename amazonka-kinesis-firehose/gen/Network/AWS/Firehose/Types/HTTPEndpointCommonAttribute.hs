...
data HTTPEndpointCommonAttribute = HTTPEndpointCommonAttribute'{_httpecaAttributeName
                                                                ::
                                                                !(Sensitive
                                                                    Text),
...
hTTPEndpointCommonAttribute
    :: Text -- ^ 'httpecaAttributeName'
    -> Text -- ^ 'httpecaAttributeValue'
    -> HTTPEndpointCommonAttribute
hTTPEndpointCommonAttribute pAttributeName_
  pAttributeValue_
  = HTTPEndpointCommonAttribute'{_httpecaAttributeName
...
instance FromJSON HTTPEndpointCommonAttribute where
        parseJSON
          = withObject "HTTPEndpointCommonAttribute"
              (\ x ->
                 HTTPEndpointCommonAttribute' <$>
                   (x .: "AttributeName") <*> (x .: "AttributeValue"))

instance Hashable HTTPEndpointCommonAttribute where

instance NFData HTTPEndpointCommonAttribute where
