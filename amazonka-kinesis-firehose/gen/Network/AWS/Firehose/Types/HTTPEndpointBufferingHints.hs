...
data HTTPEndpointBufferingHints = HTTPEndpointBufferingHints'{_httpebhSizeInMBs
                                                              :: !(Maybe Nat),
...
hTTPEndpointBufferingHints
    :: HTTPEndpointBufferingHints
hTTPEndpointBufferingHints
  = HTTPEndpointBufferingHints'{_httpebhSizeInMBs =
                                  Nothing,
...
instance FromJSON HTTPEndpointBufferingHints where
        parseJSON
          = withObject "HTTPEndpointBufferingHints"
              (\ x ->
                 HTTPEndpointBufferingHints' <$>
                   (x .:? "SizeInMBs") <*> (x .:? "IntervalInSeconds"))

instance Hashable HTTPEndpointBufferingHints where

instance NFData HTTPEndpointBufferingHints where
