...
data RedshiftDestinationConfiguration = RedshiftDestinationConfiguration'{_rdcS3BackupMode
                                                                          ::
                                                                          !(Maybe
...
redshiftDestinationConfiguration
    ...
    -> RedshiftDestinationConfiguration
redshiftDestinationConfiguration pRoleARN_
  pClusterJDBCURL_ pCopyCommand_ pUsername_ pPassword_
  pS3Configuration_
  = RedshiftDestinationConfiguration'{_rdcS3BackupMode
                                        = Nothing,
