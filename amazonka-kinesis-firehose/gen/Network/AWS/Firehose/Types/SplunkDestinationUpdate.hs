...
data SplunkDestinationUpdate = SplunkDestinationUpdate'{_sduS3BackupMode
                                                        ::
                                                        !(Maybe
                                                            SplunkS3BackupMode),
                                                        _sduHECToken ::
...
splunkDestinationUpdate
    :: SplunkDestinationUpdate
splunkDestinationUpdate
  = SplunkDestinationUpdate'{_sduS3BackupMode =
                               Nothing,
                             ...
                             _sduS3Update = Nothing, _sduHECEndpoint = Nothing,
