...
data HTTPEndpointRequestConfiguration = HTTPEndpointRequestConfiguration'{_httpercCommonAttributes
                                                                          ::
                                                                          !(Maybe
...
hTTPEndpointRequestConfiguration
    :: HTTPEndpointRequestConfiguration
hTTPEndpointRequestConfiguration
  = HTTPEndpointRequestConfiguration'{_httpercCommonAttributes
                                        = Nothing,
...
instance FromJSON HTTPEndpointRequestConfiguration
         where
        parseJSON
          = withObject "HTTPEndpointRequestConfiguration"
              (\ x ->
                 HTTPEndpointRequestConfiguration' <$>
...
instance ToJSON HTTPEndpointRequestConfiguration
         where
