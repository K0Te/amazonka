...
data HTTPEndpointDestinationConfiguration = HTTPEndpointDestinationConfiguration'{_httpedcS3BackupMode
                                                                                  ::
                                                                                  !(Maybe
...
hTTPEndpointDestinationConfiguration
    :: HTTPEndpointConfiguration -- ^ 'httpedcEndpointConfiguration'
    -> S3DestinationConfiguration -- ^ 'httpedcS3Configuration'
    -> HTTPEndpointDestinationConfiguration
hTTPEndpointDestinationConfiguration
  pEndpointConfiguration_ pS3Configuration_
  = HTTPEndpointDestinationConfiguration'{_httpedcS3BackupMode
                                            = Nothing,
                                          _httpedcCloudWatchLoggingOptions =
                                            Nothing,
...
instance ToJSON HTTPEndpointDestinationConfiguration
         where
