...
data ExtendedS3DestinationConfiguration = ExtendedS3DestinationConfiguration'{_esdcS3BackupMode
                                                                              ::
                                                                              !(Maybe
                                                                                  S3BackupMode),
                                                                              _esdcPrefix
...
extendedS3DestinationConfiguration
    ...
    -> Text -- ^ 'esdcBucketARN'
    -> ExtendedS3DestinationConfiguration
extendedS3DestinationConfiguration pRoleARN_
  pBucketARN_
  = ExtendedS3DestinationConfiguration'{_esdcS3BackupMode
                                          = Nothing,
                                        _esdcPrefix = Nothing,
