...
data SplunkDestinationConfiguration = SplunkDestinationConfiguration'{_splS3BackupMode
                                                                      ::
                                                                      !(Maybe
                                                                          SplunkS3BackupMode),
...
splunkDestinationConfiguration
    ...
    -> SplunkDestinationConfiguration
splunkDestinationConfiguration pHECEndpoint_
  pHECEndpointType_ pHECToken_ pS3Configuration_
  = SplunkDestinationConfiguration'{_splS3BackupMode =
                                      Nothing,
