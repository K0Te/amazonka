...
data ListTagsForResource = ListTagsForResource'{_ltfrNextMarker
                                                :: !(Maybe Text),
...
listTagsForResource pResourceARN_
  = ListTagsForResource'{_ltfrNextMarker = Nothing,
                         _ltfrLimit = Nothing,
...
instance AWSRequest ListTagsForResource where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 ListTagsForResourceResponse' <$>
                   (x .?> "TagInfoForResource") <*> (x .?> "NextMarker")
                     <*> (pure (fromEnum s)))
...
data ListTagsForResourceResponse = ListTagsForResourceResponse'{_ltfrrsTagInfoForResource
                                                                ::
                                                                !(Maybe
                                                                    TagInfoForResource),
                                                                _ltfrrsNextMarker
...
listTagsForResourceResponse pResponseStatus_
  = ListTagsForResourceResponse'{_ltfrrsTagInfoForResource
                                   = Nothing,
