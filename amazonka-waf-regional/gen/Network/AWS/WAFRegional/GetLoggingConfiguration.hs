...
newtype GetLoggingConfiguration = GetLoggingConfiguration'{_glcResourceARN
                                                           :: Text}
...
getLoggingConfiguration pResourceARN_
  = GetLoggingConfiguration'{_glcResourceARN =
                               pResourceARN_}
...
data GetLoggingConfigurationResponse = GetLoggingConfigurationResponse'{_glcrsLoggingConfiguration
                                                                        ::
                                                                        !(Maybe
...
getLoggingConfigurationResponse pResponseStatus_
  = GetLoggingConfigurationResponse'{_glcrsLoggingConfiguration
                                       = Nothing,
