...
newtype DeleteLoggingConfiguration = DeleteLoggingConfiguration'{_dlcResourceARN
                                                                 :: Text}
...
deleteLoggingConfiguration pResourceARN_
  = DeleteLoggingConfiguration'{_dlcResourceARN =
                                  pResourceARN_}
...
newtype DeleteLoggingConfigurationResponse = DeleteLoggingConfigurationResponse'{_dlcrsResponseStatus
                                                                                 ::
                                                                                 Int}
...
deleteLoggingConfigurationResponse pResponseStatus_
  = DeleteLoggingConfigurationResponse'{_dlcrsResponseStatus
                                          = pResponseStatus_}
