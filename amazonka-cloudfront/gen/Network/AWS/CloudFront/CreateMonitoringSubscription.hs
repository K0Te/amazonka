...
data CreateMonitoringSubscription = CreateMonitoringSubscription'{_cmsMonitoringSubscription
                                                                  ::
...
createMonitoringSubscription
    :: MonitoringSubscription -- ^ 'cmsMonitoringSubscription'
    -> Text -- ^ 'cmsDistributionId'
    -> CreateMonitoringSubscription
createMonitoringSubscription pMonitoringSubscription_
  pDistributionId_
  = CreateMonitoringSubscription'{_cmsMonitoringSubscription
...
instance AWSRequest CreateMonitoringSubscription
         where
...
instance Hashable CreateMonitoringSubscription where

instance NFData CreateMonitoringSubscription where
        ...
        toPath CreateMonitoringSubscription'{..}
          = mconcat
              ["/2020-05-31/distributions/",
               toBS _cmsDistributionId, "/monitoring-subscription"]

instance ToQuery CreateMonitoringSubscription where
        toQuery = const mempty

-- | /See:/ 'createMonitoringSubscriptionResponse' smart constructor.
data CreateMonitoringSubscriptionResponse = CreateMonitoringSubscriptionResponse'{_cmsrsMonitoringSubscription
                                                                                  ::
                                                                                  !(Maybe
                                                                                      MonitoringSubscription),
...
createMonitoringSubscriptionResponse
    :: Int -- ^ 'cmsrsResponseStatus'
    -> CreateMonitoringSubscriptionResponse
createMonitoringSubscriptionResponse pResponseStatus_
  = CreateMonitoringSubscriptionResponse'{_cmsrsMonitoringSubscription
                                            = Nothing,
                                          _cmsrsResponseStatus =
                                            pResponseStatus_}
