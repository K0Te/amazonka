...
newtype GetMonitoringSubscription = GetMonitoringSubscription'{_gmsDistributionId
                                                               :: Text}
...
getMonitoringSubscription
    :: Text -- ^ 'gmsDistributionId'
    -> GetMonitoringSubscription
getMonitoringSubscription pDistributionId_
  = GetMonitoringSubscription'{_gmsDistributionId =
                                 pDistributionId_}
...
instance Hashable GetMonitoringSubscription where

instance NFData GetMonitoringSubscription where
        ...
        toPath GetMonitoringSubscription'{..}
          = mconcat
              ["/2020-05-31/distributions/",
               toBS _gmsDistributionId, "/monitoring-subscription"]

instance ToQuery GetMonitoringSubscription where
        toQuery = const mempty

-- | /See:/ 'getMonitoringSubscriptionResponse' smart constructor.
data GetMonitoringSubscriptionResponse = GetMonitoringSubscriptionResponse'{_gmsrsMonitoringSubscription
                                                                            ::
                                                                            !(Maybe
...
getMonitoringSubscriptionResponse pResponseStatus_
  = GetMonitoringSubscriptionResponse'{_gmsrsMonitoringSubscription
                                         = Nothing,
