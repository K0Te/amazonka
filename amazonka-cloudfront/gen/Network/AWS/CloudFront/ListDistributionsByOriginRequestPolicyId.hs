...
data ListDistributionsByOriginRequestPolicyId = ListDistributionsByOriginRequestPolicyId'{_ldborpiMarker
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
                                                                                          _ldborpiMaxItems
...
listDistributionsByOriginRequestPolicyId
    :: Text -- ^ 'ldborpiOriginRequestPolicyId'
    -> ListDistributionsByOriginRequestPolicyId
listDistributionsByOriginRequestPolicyId
  pOriginRequestPolicyId_
  = ListDistributionsByOriginRequestPolicyId'{_ldborpiMarker
                                                = Nothing,
...
data ListDistributionsByOriginRequestPolicyIdResponse = ListDistributionsByOriginRequestPolicyIdResponse'{_ldborpirsDistributionIdList
                                                                                                          ::
                                                                                                          !(Maybe
                                                                                                              DistributionIdList),
...
listDistributionsByOriginRequestPolicyIdResponse
    :: Int -- ^ 'ldborpirsResponseStatus'
    -> ListDistributionsByOriginRequestPolicyIdResponse
listDistributionsByOriginRequestPolicyIdResponse
  pResponseStatus_
  = ListDistributionsByOriginRequestPolicyIdResponse'{_ldborpirsDistributionIdList
                                                        = Nothing,
                                                      _ldborpirsResponseStatus =
                                                        pResponseStatus_}
