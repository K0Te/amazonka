...
data UpdateKeyGroup = UpdateKeyGroup'{_ukgIfMatch ::
                                      !(Maybe Text),
...
updateKeyGroup
    :: KeyGroupConfig -- ^ 'ukgKeyGroupConfig'
    -> Text -- ^ 'ukgId'
    -> UpdateKeyGroup
updateKeyGroup pKeyGroupConfig_ pId_
  = UpdateKeyGroup'{_ukgIfMatch = Nothing,
                    _ukgKeyGroupConfig = pKeyGroupConfig_, _ukgId = pId_}
...
instance Hashable UpdateKeyGroup where

instance NFData UpdateKeyGroup where
...
data UpdateKeyGroupResponse = UpdateKeyGroupResponse'{_ukgrsETag
                                                      :: !(Maybe Text),
                                                      _ukgrsKeyGroup ::
                                                      !(Maybe KeyGroup),
                                                      _ukgrsResponseStatus ::
                                                      !Int}
...
updateKeyGroupResponse
    :: Int -- ^ 'ukgrsResponseStatus'
    -> UpdateKeyGroupResponse
updateKeyGroupResponse pResponseStatus_
  = UpdateKeyGroupResponse'{_ukgrsETag = Nothing,
...
instance NFData UpdateKeyGroupResponse where
