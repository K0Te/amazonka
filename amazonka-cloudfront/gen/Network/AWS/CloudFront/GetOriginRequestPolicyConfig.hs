...
newtype GetOriginRequestPolicyConfig = GetOriginRequestPolicyConfig'{_gorpcId
                                                                     :: Text}
...
instance AWSRequest GetOriginRequestPolicyConfig
         where
...
instance Hashable GetOriginRequestPolicyConfig where

instance NFData GetOriginRequestPolicyConfig where
...
instance ToPath GetOriginRequestPolicyConfig where
        toPath GetOriginRequestPolicyConfig'{..}
          = mconcat
              ["/2020-05-31/origin-request-policy/", toBS _gorpcId,
               "/config"]
...
data GetOriginRequestPolicyConfigResponse = GetOriginRequestPolicyConfigResponse'{_gorpcrsETag
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
getOriginRequestPolicyConfigResponse
    :: Int -- ^ 'gorpcrsResponseStatus'
    -> GetOriginRequestPolicyConfigResponse
getOriginRequestPolicyConfigResponse pResponseStatus_
  = GetOriginRequestPolicyConfigResponse'{_gorpcrsETag
                                            = Nothing,
                                          _gorpcrsOriginRequestPolicyConfig =
                                            Nothing,
                                          _gorpcrsResponseStatus =
