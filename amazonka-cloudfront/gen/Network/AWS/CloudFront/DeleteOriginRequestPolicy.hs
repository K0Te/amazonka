...
data DeleteOriginRequestPolicy = DeleteOriginRequestPolicy'{_dorpIfMatch
                                                            :: !(Maybe Text),
                                                            _dorpId :: !Text}
...
deleteOriginRequestPolicy pId_
  = DeleteOriginRequestPolicy'{_dorpIfMatch = Nothing,
                               _dorpId = pId_}
...
instance Hashable DeleteOriginRequestPolicy where

instance NFData DeleteOriginRequestPolicy where
