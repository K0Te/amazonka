...
newtype CreateOriginRequestPolicy = CreateOriginRequestPolicy'{_corpOriginRequestPolicyConfig
                                                               ::
...
createOriginRequestPolicy
    :: OriginRequestPolicyConfig -- ^ 'corpOriginRequestPolicyConfig'
    -> CreateOriginRequestPolicy
createOriginRequestPolicy pOriginRequestPolicyConfig_
  = CreateOriginRequestPolicy'{_corpOriginRequestPolicyConfig
...
instance Hashable CreateOriginRequestPolicy where

instance NFData CreateOriginRequestPolicy where
...
data CreateOriginRequestPolicyResponse = CreateOriginRequestPolicyResponse'{_corprsETag
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _corprsLocation
...
createOriginRequestPolicyResponse
    :: Int -- ^ 'corprsResponseStatus'
    -> CreateOriginRequestPolicyResponse
createOriginRequestPolicyResponse pResponseStatus_
  = CreateOriginRequestPolicyResponse'{_corprsETag =
                                         Nothing,
