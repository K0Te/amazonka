...
data UpdateOriginRequestPolicy = UpdateOriginRequestPolicy'{_uorpIfMatch
                                                            :: !(Maybe Text),
...
updateOriginRequestPolicy
    :: OriginRequestPolicyConfig -- ^ 'uorpOriginRequestPolicyConfig'
    -> Text -- ^ 'uorpId'
    -> UpdateOriginRequestPolicy
updateOriginRequestPolicy pOriginRequestPolicyConfig_
  pId_
  = UpdateOriginRequestPolicy'{_uorpIfMatch = Nothing,
                               _uorpOriginRequestPolicyConfig =
...
instance Hashable UpdateOriginRequestPolicy where

instance NFData UpdateOriginRequestPolicy where
...
data UpdateOriginRequestPolicyResponse = UpdateOriginRequestPolicyResponse'{_uorprsETag
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
updateOriginRequestPolicyResponse
    :: Int -- ^ 'uorprsResponseStatus'
    -> UpdateOriginRequestPolicyResponse
updateOriginRequestPolicyResponse pResponseStatus_
  = UpdateOriginRequestPolicyResponse'{_uorprsETag =
                                         Nothing,
