...
instance Hashable GetKeyGroup where

instance NFData GetKeyGroup where
...
data GetKeyGroupResponse = GetKeyGroupResponse'{_gkgrsETag
                                                :: !(Maybe Text),
                                                _gkgrsKeyGroup ::
                                                !(Maybe KeyGroup),
...
getKeyGroupResponse
    :: Int -- ^ 'gkgrsResponseStatus'
    -> GetKeyGroupResponse
getKeyGroupResponse pResponseStatus_
  = GetKeyGroupResponse'{_gkgrsETag = Nothing,
...
instance NFData GetKeyGroupResponse where
