...
data ListKeyGroups = ListKeyGroups'{_lkgMarker ::
                                    !(Maybe Text),
...
listKeyGroups
    :: ListKeyGroups
listKeyGroups
  = ListKeyGroups'{_lkgMarker = Nothing,
...
instance Hashable ListKeyGroups where

instance NFData ListKeyGroups where
...
instance ToQuery ListKeyGroups where
        toQuery ListKeyGroups'{..}
          = mconcat
              ["Marker" =: _lkgMarker, "MaxItems" =: _lkgMaxItems]

-- | /See:/ 'listKeyGroupsResponse' smart constructor.
data ListKeyGroupsResponse = ListKeyGroupsResponse'{_lkgrsKeyGroupList
                                                    :: !(Maybe KeyGroupList),
                                                    _lkgrsResponseStatus ::
                                                    !Int}
...
listKeyGroupsResponse
    :: Int -- ^ 'lkgrsResponseStatus'
    -> ListKeyGroupsResponse
listKeyGroupsResponse pResponseStatus_
  = ListKeyGroupsResponse'{_lkgrsKeyGroupList =
                             Nothing,
...
instance NFData ListKeyGroupsResponse where
