...
newtype CreateKeyGroup = CreateKeyGroup'{_ckgKeyGroupConfig
                                         :: KeyGroupConfig}
...
createKeyGroup
    :: KeyGroupConfig -- ^ 'ckgKeyGroupConfig'
    -> CreateKeyGroup
createKeyGroup pKeyGroupConfig_
  = CreateKeyGroup'{_ckgKeyGroupConfig =
                      pKeyGroupConfig_}
...
instance Hashable CreateKeyGroup where

instance NFData CreateKeyGroup where
...
data CreateKeyGroupResponse = CreateKeyGroupResponse'{_ckgrsETag
                                                      :: !(Maybe Text),
                                                      _ckgrsLocation ::
                                                      !(Maybe Text),
                                                      _ckgrsKeyGroup ::
                                                      !(Maybe KeyGroup),
                                                      _ckgrsResponseStatus ::
                                                      !Int}
...
createKeyGroupResponse
    :: Int -- ^ 'ckgrsResponseStatus'
    -> CreateKeyGroupResponse
createKeyGroupResponse pResponseStatus_
  = CreateKeyGroupResponse'{_ckgrsETag = Nothing,
                            _ckgrsLocation = Nothing, _ckgrsKeyGroup = Nothing,
...
instance NFData CreateKeyGroupResponse where
