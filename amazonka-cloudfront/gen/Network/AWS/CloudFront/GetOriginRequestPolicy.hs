...
newtype GetOriginRequestPolicy = GetOriginRequestPolicy'{_gorpId
                                                         :: Text}
...
instance AWSRequest GetOriginRequestPolicy where
        type Rs GetOriginRequestPolicy =
             GetOriginRequestPolicyResponse
...
instance Hashable GetOriginRequestPolicy where

instance NFData GetOriginRequestPolicy where
...
data GetOriginRequestPolicyResponse = GetOriginRequestPolicyResponse'{_gorprsETag
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
...
getOriginRequestPolicyResponse
    :: Int -- ^ 'gorprsResponseStatus'
    -> GetOriginRequestPolicyResponse
getOriginRequestPolicyResponse pResponseStatus_
  = GetOriginRequestPolicyResponse'{_gorprsETag =
                                      Nothing,
...
instance NFData GetOriginRequestPolicyResponse where
