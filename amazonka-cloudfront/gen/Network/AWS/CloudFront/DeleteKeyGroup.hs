...
data DeleteKeyGroup = DeleteKeyGroup'{_dkgIfMatch ::
                                      !(Maybe Text),
                                      _dkgId :: !Text}
...
deleteKeyGroup
    ...
    -> DeleteKeyGroup
deleteKeyGroup pId_
  = DeleteKeyGroup'{_dkgIfMatch = Nothing,
                    _dkgId = pId_}
...
instance Hashable DeleteKeyGroup where

instance NFData DeleteKeyGroup where
...
instance NFData DeleteKeyGroupResponse where
