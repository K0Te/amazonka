...
data UpdateCachePolicy = UpdateCachePolicy'{_ucpIfMatch
                                            :: !(Maybe Text),
...
updateCachePolicy
    :: CachePolicyConfig -- ^ 'ucpCachePolicyConfig'
    -> Text -- ^ 'ucpId'
    -> UpdateCachePolicy
updateCachePolicy pCachePolicyConfig_ pId_
  = UpdateCachePolicy'{_ucpIfMatch = Nothing,
...
instance Hashable UpdateCachePolicy where

instance NFData UpdateCachePolicy where
...
data UpdateCachePolicyResponse = UpdateCachePolicyResponse'{_ucprsCachePolicy
                                                            ::
                                                            !(Maybe
                                                                CachePolicy),
                                                            _ucprsETag ::
...
updateCachePolicyResponse pResponseStatus_
  = UpdateCachePolicyResponse'{_ucprsCachePolicy =
                                 Nothing,
                               _ucprsETag = Nothing,
...
instance NFData UpdateCachePolicyResponse where
