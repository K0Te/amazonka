...
newtype GetCachePolicyConfig = GetCachePolicyConfig'{_gcpcId
                                                     :: Text}
...
instance Hashable GetCachePolicyConfig where

instance NFData GetCachePolicyConfig where
...
instance ToPath GetCachePolicyConfig where
        toPath GetCachePolicyConfig'{..}
          = mconcat
              ["/2020-05-31/cache-policy/", toBS _gcpcId,
               "/config"]
...
data GetCachePolicyConfigResponse = GetCachePolicyConfigResponse'{_gcpcrsETag
                                                                  ::
                                                                  !(Maybe Text),
...
getCachePolicyConfigResponse
    :: Int -- ^ 'gcpcrsResponseStatus'
    -> GetCachePolicyConfigResponse
getCachePolicyConfigResponse pResponseStatus_
  = GetCachePolicyConfigResponse'{_gcpcrsETag =
                                    Nothing,
...
instance NFData GetCachePolicyConfigResponse where
