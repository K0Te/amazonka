...
data DeleteRealtimeLogConfig = DeleteRealtimeLogConfig'{_drlcARN
                                                        :: !(Maybe Text),
                                                        _drlcName ::
                                                        !(Maybe Text)}
...
deleteRealtimeLogConfig
    :: DeleteRealtimeLogConfig
deleteRealtimeLogConfig
  = DeleteRealtimeLogConfig'{_drlcARN = Nothing,
                             _drlcName = Nothing}
...
instance AWSRequest DeleteRealtimeLogConfig where
        type Rs DeleteRealtimeLogConfig =
             DeleteRealtimeLogConfigResponse
        request = postXML cloudFront
        response
          = receiveNull DeleteRealtimeLogConfigResponse'

instance Hashable DeleteRealtimeLogConfig where

instance NFData DeleteRealtimeLogConfig where
...
instance NFData DeleteRealtimeLogConfigResponse where
