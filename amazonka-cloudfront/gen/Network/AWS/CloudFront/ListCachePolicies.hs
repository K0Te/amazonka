...
data ListCachePolicies = ListCachePolicies'{_lcpMarker
                                            :: !(Maybe Text),
...
listCachePolicies
    :: ListCachePolicies
listCachePolicies
  = ListCachePolicies'{_lcpMarker = Nothing,
                       _lcpMaxItems = Nothing, _lcpType = Nothing}
...
instance Hashable ListCachePolicies where

instance NFData ListCachePolicies where
...
instance ToQuery ListCachePolicies where
        toQuery ListCachePolicies'{..}
          = mconcat
              ["Marker" =: _lcpMarker, "MaxItems" =: _lcpMaxItems,
               "Type" =: _lcpType]

-- | /See:/ 'listCachePoliciesResponse' smart constructor.
data ListCachePoliciesResponse = ListCachePoliciesResponse'{_lcprsCachePolicyList
                                                            ::
                                                            !(Maybe
                                                                CachePolicyList),
...
listCachePoliciesResponse pResponseStatus_
  = ListCachePoliciesResponse'{_lcprsCachePolicyList =
                                 Nothing,
...
instance NFData ListCachePoliciesResponse where
