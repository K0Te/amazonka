...
data ListRealtimeLogConfigs = ListRealtimeLogConfigs'{_lrlcMarker
                                                      :: !(Maybe Text),
                                                      _lrlcMaxItems ::
                                                      !(Maybe Text)}
...
listRealtimeLogConfigs
    :: ListRealtimeLogConfigs
listRealtimeLogConfigs
  = ListRealtimeLogConfigs'{_lrlcMarker = Nothing,
...
instance AWSRequest ListRealtimeLogConfigs where
        type Rs ListRealtimeLogConfigs =
             ListRealtimeLogConfigsResponse
...
instance Hashable ListRealtimeLogConfigs where

instance NFData ListRealtimeLogConfigs where
...
data ListRealtimeLogConfigsResponse = ListRealtimeLogConfigsResponse'{_lrlcrsRealtimeLogConfigs
                                                                      ::
                                                                      !(Maybe
                                                                          RealtimeLogConfigs),
                                                                      _lrlcrsResponseStatus
                                                                      :: !Int}
...
listRealtimeLogConfigsResponse
    :: Int -- ^ 'lrlcrsResponseStatus'
    -> ListRealtimeLogConfigsResponse
listRealtimeLogConfigsResponse pResponseStatus_
  = ListRealtimeLogConfigsResponse'{_lrlcrsRealtimeLogConfigs
                                      = Nothing,
...
instance NFData ListRealtimeLogConfigsResponse where
