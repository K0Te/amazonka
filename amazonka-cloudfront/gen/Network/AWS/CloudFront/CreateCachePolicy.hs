...
newtype CreateCachePolicy = CreateCachePolicy'{_ccpCachePolicyConfig
                                               :: CachePolicyConfig}
...
createCachePolicy
    :: CachePolicyConfig -- ^ 'ccpCachePolicyConfig'
    -> CreateCachePolicy
createCachePolicy pCachePolicyConfig_
  = CreateCachePolicy'{_ccpCachePolicyConfig =
                         pCachePolicyConfig_}
...
instance Hashable CreateCachePolicy where

instance NFData CreateCachePolicy where
...
data CreateCachePolicyResponse = CreateCachePolicyResponse'{_ccprsCachePolicy
                                                            ::
                                                            !(Maybe
                                                                CachePolicy),
                                                            _ccprsETag ::
...
createCachePolicyResponse pResponseStatus_
  = CreateCachePolicyResponse'{_ccprsCachePolicy =
                                 Nothing,
                               _ccprsETag = Nothing, _ccprsLocation = Nothing,
...
instance NFData CreateCachePolicyResponse where
