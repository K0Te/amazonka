...
data ListInvalidations = ListInvalidations'{_liMarker
                                            :: !(Maybe Text),
...
listInvalidations pDistributionId_
  = ListInvalidations'{_liMarker = Nothing,
                       _liMaxItems = Nothing,
...
instance ToPath ListInvalidations where
        toPath ListInvalidations'{..}
          = mconcat
              ["/2020-05-31/distribution/", toBS _liDistributionId,
               "/invalidation"]
...
data ListInvalidationsResponse = ListInvalidationsResponse'{_lirsResponseStatus
                                                            :: !Int,
...
listInvalidationsResponse
    ...
    -> ListInvalidationsResponse
listInvalidationsResponse pResponseStatus_
  pInvalidationList_
  = ListInvalidationsResponse'{_lirsResponseStatus =
                                 pResponseStatus_,
