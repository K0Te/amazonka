...
data ListOriginRequestPolicies = ListOriginRequestPolicies'{_lorpMarker
                                                            :: !(Maybe Text),
                                                            _lorpMaxItems ::
                                                            !(Maybe Text),
                                                            _lorpType ::
...
listOriginRequestPolicies
    :: ListOriginRequestPolicies
listOriginRequestPolicies
  = ListOriginRequestPolicies'{_lorpMarker = Nothing,
                               _lorpMaxItems = Nothing, _lorpType = Nothing}
...
instance Hashable ListOriginRequestPolicies where

instance NFData ListOriginRequestPolicies where
...
instance ToQuery ListOriginRequestPolicies where
        toQuery ListOriginRequestPolicies'{..}
          = mconcat
              ["Marker" =: _lorpMarker,
               "MaxItems" =: _lorpMaxItems, "Type" =: _lorpType]

-- | /See:/ 'listOriginRequestPoliciesResponse' smart constructor.
data ListOriginRequestPoliciesResponse = ListOriginRequestPoliciesResponse'{_lorprsOriginRequestPolicyList
                                                                            ::
                                                                            !(Maybe
...
listOriginRequestPoliciesResponse
    :: Int -- ^ 'lorprsResponseStatus'
    -> ListOriginRequestPoliciesResponse
listOriginRequestPoliciesResponse pResponseStatus_
  = ListOriginRequestPoliciesResponse'{_lorprsOriginRequestPolicyList
                                         = Nothing,
