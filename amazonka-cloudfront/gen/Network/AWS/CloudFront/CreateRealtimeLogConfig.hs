...
data CreateRealtimeLogConfig = CreateRealtimeLogConfig'{_crlcEndPoints
                                                        :: ![EndPoint],
                                                        _crlcFields :: ![Text],
                                                        _crlcName :: !Text,
                                                        _crlcSamplingRate ::
...
createRealtimeLogConfig
    :: Text -- ^ 'crlcName'
    -> Integer -- ^ 'crlcSamplingRate'
    -> CreateRealtimeLogConfig
createRealtimeLogConfig pName_ pSamplingRate_
  = CreateRealtimeLogConfig'{_crlcEndPoints = mempty,
                             _crlcFields = mempty, _crlcName = pName_,
...
instance AWSRequest CreateRealtimeLogConfig where
        type Rs CreateRealtimeLogConfig =
             CreateRealtimeLogConfigResponse
...
instance Hashable CreateRealtimeLogConfig where

instance NFData CreateRealtimeLogConfig where
...
data CreateRealtimeLogConfigResponse = CreateRealtimeLogConfigResponse'{_crlcrsRealtimeLogConfig
                                                                        ::
                                                                        !(Maybe
                                                                            RealtimeLogConfig),
...
createRealtimeLogConfigResponse
    :: Int -- ^ 'crlcrsResponseStatus'
    -> CreateRealtimeLogConfigResponse
createRealtimeLogConfigResponse pResponseStatus_
  = CreateRealtimeLogConfigResponse'{_crlcrsRealtimeLogConfig
                                       = Nothing,
...
instance NFData CreateRealtimeLogConfigResponse where
