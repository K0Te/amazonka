...
data UpdateRealtimeLogConfig = UpdateRealtimeLogConfig'{_urlcARN
                                                        :: !(Maybe Text),
                                                        _urlcSamplingRate ::
                                                        !(Maybe Integer),
                                                        _urlcName ::
...
updateRealtimeLogConfig
    :: UpdateRealtimeLogConfig
updateRealtimeLogConfig
  = UpdateRealtimeLogConfig'{_urlcARN = Nothing,
                             _urlcSamplingRate = Nothing, _urlcName = Nothing,
                             _urlcEndPoints = Nothing, _urlcFields = Nothing}
...
instance AWSRequest UpdateRealtimeLogConfig where
        type Rs UpdateRealtimeLogConfig =
             UpdateRealtimeLogConfigResponse
...
instance Hashable UpdateRealtimeLogConfig where

instance NFData UpdateRealtimeLogConfig where
...
data UpdateRealtimeLogConfigResponse = UpdateRealtimeLogConfigResponse'{_urlcrsRealtimeLogConfig
                                                                        ::
                                                                        !(Maybe
                                                                            RealtimeLogConfig),
...
updateRealtimeLogConfigResponse
    :: Int -- ^ 'urlcrsResponseStatus'
    -> UpdateRealtimeLogConfigResponse
updateRealtimeLogConfigResponse pResponseStatus_
  = UpdateRealtimeLogConfigResponse'{_urlcrsRealtimeLogConfig
                                       = Nothing,
...
instance NFData UpdateRealtimeLogConfigResponse where
