...
data ListDistributionsByKeyGroup = ListDistributionsByKeyGroup'{_ldbkgMarker
                                                                ::
                                                                !(Maybe Text),
                                                                _ldbkgMaxItems
                                                                ::
...
listDistributionsByKeyGroup
    :: Text -- ^ 'ldbkgKeyGroupId'
    -> ListDistributionsByKeyGroup
listDistributionsByKeyGroup pKeyGroupId_
  = ListDistributionsByKeyGroup'{_ldbkgMarker =
                                   Nothing,
...
instance Hashable ListDistributionsByKeyGroup where

instance NFData ListDistributionsByKeyGroup where
...
data ListDistributionsByKeyGroupResponse = ListDistributionsByKeyGroupResponse'{_ldbkgrsDistributionIdList
                                                                                ::
                                                                                !(Maybe
                                                                                    DistributionIdList),
...
listDistributionsByKeyGroupResponse
    :: Int -- ^ 'ldbkgrsResponseStatus'
    -> ListDistributionsByKeyGroupResponse
listDistributionsByKeyGroupResponse pResponseStatus_
  = ListDistributionsByKeyGroupResponse'{_ldbkgrsDistributionIdList
                                           = Nothing,
                                         _ldbkgrsResponseStatus =
                                           pResponseStatus_}
