...
newtype GetCachePolicy = GetCachePolicy'{_gcpId ::
                                         Text}
...
instance Hashable GetCachePolicy where

instance NFData GetCachePolicy where
...
data GetCachePolicyResponse = GetCachePolicyResponse'{_gcprsCachePolicy
                                                      :: !(Maybe CachePolicy),
                                                      _gcprsETag ::
                                                      !(Maybe Text),
...
getCachePolicyResponse pResponseStatus_
  = GetCachePolicyResponse'{_gcprsCachePolicy =
                              Nothing,
                            _gcprsETag = Nothing,
...
instance NFData GetCachePolicyResponse where
