...
data ListDistributionsByCachePolicyId = ListDistributionsByCachePolicyId'{_ldbcpiMarker
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _ldbcpiMaxItems
...
listDistributionsByCachePolicyId
    :: Text -- ^ 'ldbcpiCachePolicyId'
    -> ListDistributionsByCachePolicyId
listDistributionsByCachePolicyId pCachePolicyId_
  = ListDistributionsByCachePolicyId'{_ldbcpiMarker =
                                        Nothing,
...
instance AWSRequest ListDistributionsByCachePolicyId
         where
...
instance ToHeaders ListDistributionsByCachePolicyId
         where
        toHeaders = const mempty

instance ToPath ListDistributionsByCachePolicyId
         where
...
instance ToQuery ListDistributionsByCachePolicyId
         where
...
data ListDistributionsByCachePolicyIdResponse = ListDistributionsByCachePolicyIdResponse'{_ldbcpirsDistributionIdList
                                                                                          ::
                                                                                          !(Maybe
                                                                                              DistributionIdList),
...
listDistributionsByCachePolicyIdResponse
    :: Int -- ^ 'ldbcpirsResponseStatus'
    -> ListDistributionsByCachePolicyIdResponse
listDistributionsByCachePolicyIdResponse
  pResponseStatus_
  = ListDistributionsByCachePolicyIdResponse'{_ldbcpirsDistributionIdList
                                                = Nothing,
                                              _ldbcpirsResponseStatus =
                                                pResponseStatus_}
