...
data DistributionIdList = DistributionIdList'{_dilItems
                                              :: !(Maybe [Text]),
...
distributionIdList
    ...
    -> Int -- ^ 'dilQuantity'
    -> DistributionIdList
distributionIdList pMarker_ pMaxItems_ pIsTruncated_
  pQuantity_
  = DistributionIdList'{_dilItems = Nothing,
                        _dilNextMarker = Nothing, _dilMarker = pMarker_,
...
instance Hashable DistributionIdList where

instance NFData DistributionIdList where
