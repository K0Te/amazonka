...
data KGKeyPairIds = KGKeyPairIds'{_kgkpiKeyPairIds ::
                                  !(Maybe KeyPairIds),
...
kGKeyPairIds
    :: KGKeyPairIds
kGKeyPairIds
  = KGKeyPairIds'{_kgkpiKeyPairIds = Nothing,
...
instance Hashable KGKeyPairIds where

instance NFData KGKeyPairIds where
