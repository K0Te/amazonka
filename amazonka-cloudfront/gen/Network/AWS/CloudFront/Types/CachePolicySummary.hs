...
data CachePolicySummary = CachePolicySummary'{_cpsType
                                              :: !CachePolicyType,
...
cachePolicySummary
    :: CachePolicyType -- ^ 'cpsType'
    -> CachePolicy -- ^ 'cpsCachePolicy'
    -> CachePolicySummary
cachePolicySummary pType_ pCachePolicy_
  = CachePolicySummary'{_cpsType = pType_,
...
instance Hashable CachePolicySummary where

instance NFData CachePolicySummary where
