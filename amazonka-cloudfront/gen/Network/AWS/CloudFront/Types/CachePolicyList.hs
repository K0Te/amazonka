...
data CachePolicyList = CachePolicyList'{_cplItems ::
...
cachePolicyList pMaxItems_ pQuantity_
  = CachePolicyList'{_cplItems = Nothing,
                     _cplNextMarker = Nothing, _cplMaxItems = pMaxItems_,
...
instance Hashable CachePolicyList where

instance NFData CachePolicyList where
