...
data OriginShield = OriginShield'{_osOriginShieldRegion
                                  :: !(Maybe Text),
                                  _osEnabled :: !Bool}
...
originShield pEnabled_
  = OriginShield'{_osOriginShieldRegion = Nothing,
...
instance Hashable OriginShield where

instance NFData OriginShield where
