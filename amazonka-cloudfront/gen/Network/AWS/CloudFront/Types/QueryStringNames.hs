...
data QueryStringNames = QueryStringNames'{_qsnItems
                                          :: !(Maybe [Text]),
                                          _qsnQuantity :: !Int}
...
queryStringNames pQuantity_
  = QueryStringNames'{_qsnItems = Nothing,
...
instance Hashable QueryStringNames where

instance NFData QueryStringNames where
