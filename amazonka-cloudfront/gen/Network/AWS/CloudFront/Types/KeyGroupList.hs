...
data KeyGroupList = KeyGroupList'{_kglItems ::
                                  !(Maybe [KeyGroupSummary]),
                                  _kglNextMarker :: !(Maybe Text),
                                  _kglMaxItems :: !Int, _kglQuantity :: !Int}
...
keyGroupList pMaxItems_ pQuantity_
  = KeyGroupList'{_kglItems = Nothing,
                  _kglNextMarker = Nothing, _kglMaxItems = pMaxItems_,
...
instance Hashable KeyGroupList where

instance NFData KeyGroupList where
