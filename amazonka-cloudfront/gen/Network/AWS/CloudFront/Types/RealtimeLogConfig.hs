...
data RealtimeLogConfig = RealtimeLogConfig'{_rlcARN
                                            :: !Text,
                                            _rlcName :: !Text,
...
realtimeLogConfig
    :: Text -- ^ 'rlcARN'
    -> Text -- ^ 'rlcName'
    -> Integer -- ^ 'rlcSamplingRate'
    -> RealtimeLogConfig
realtimeLogConfig pARN_ pName_ pSamplingRate_
  = RealtimeLogConfig'{_rlcARN = pARN_,
                       _rlcName = pName_, _rlcSamplingRate = pSamplingRate_,
                       _rlcEndPoints = mempty, _rlcFields = mempty}
...
instance Hashable RealtimeLogConfig where

instance NFData RealtimeLogConfig where
