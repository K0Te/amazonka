...
data OriginRequestPolicyConfig = OriginRequestPolicyConfig'{_orpcComment
                                                            :: !(Maybe Text),
                                                            _orpcName :: !Text,
                                                            _orpcHeadersConfig
                                                            ::
...
originRequestPolicyConfig
    :: Text -- ^ 'orpcName'
    -> OriginRequestPolicyHeadersConfig -- ^ 'orpcHeadersConfig'
    -> OriginRequestPolicyCookiesConfig -- ^ 'orpcCookiesConfig'
    -> OriginRequestPolicyQueryStringsConfig -- ^ 'orpcQueryStringsConfig'
    -> OriginRequestPolicyConfig
originRequestPolicyConfig pName_ pHeadersConfig_
  pCookiesConfig_ pQueryStringsConfig_
  = OriginRequestPolicyConfig'{_orpcComment = Nothing,
                               _orpcName = pName_,
...
instance Hashable OriginRequestPolicyConfig where

instance NFData OriginRequestPolicyConfig where

instance ToXML OriginRequestPolicyConfig where
        toXML OriginRequestPolicyConfig'{..}
          = mconcat
              ["Comment" @= _orpcComment, "Name" @= _orpcName,
