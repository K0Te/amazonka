...
data OriginRequestPolicyList = OriginRequestPolicyList'{_orplItems
                                                        ::
                                                        !(Maybe
...
originRequestPolicyList pMaxItems_ pQuantity_
  = OriginRequestPolicyList'{_orplItems = Nothing,
...
instance Hashable OriginRequestPolicyList where

instance NFData OriginRequestPolicyList where
