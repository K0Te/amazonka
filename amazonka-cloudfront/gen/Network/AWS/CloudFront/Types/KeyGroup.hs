...
data KeyGroup = KeyGroup'{_kgId :: !Text,
...
keyGroup
    :: Text -- ^ 'kgId'
    -> UTCTime -- ^ 'kgLastModifiedTime'
    -> KeyGroupConfig -- ^ 'kgKeyGroupConfig'
    -> KeyGroup
...
instance Hashable KeyGroup where

instance NFData KeyGroup where
