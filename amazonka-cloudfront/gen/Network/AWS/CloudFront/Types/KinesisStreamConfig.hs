...
data KinesisStreamConfig = KinesisStreamConfig'{_kscRoleARN
                                                :: !Text,
                                                _kscStreamARN :: !Text}
...
kinesisStreamConfig pRoleARN_ pStreamARN_
  = KinesisStreamConfig'{_kscRoleARN = pRoleARN_,
...
instance Hashable KinesisStreamConfig where

instance NFData KinesisStreamConfig where
