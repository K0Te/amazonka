...
data CachePolicy = CachePolicy'{_cpId :: !Text,
...
cachePolicy
    :: Text -- ^ 'cpId'
    -> UTCTime -- ^ 'cpLastModifiedTime'
    -> CachePolicyConfig -- ^ 'cpCachePolicyConfig'
    -> CachePolicy
cachePolicy pId_ pLastModifiedTime_
  pCachePolicyConfig_
  = CachePolicy'{_cpId = pId_,
...
instance Hashable CachePolicy where

instance NFData CachePolicy where
