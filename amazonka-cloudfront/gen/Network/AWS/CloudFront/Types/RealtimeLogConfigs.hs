...
data RealtimeLogConfigs = RealtimeLogConfigs'{_rlcItems
...
realtimeLogConfigs pMaxItems_ pIsTruncated_ pMarker_
  = RealtimeLogConfigs'{_rlcItems = Nothing,
                        _rlcNextMarker = Nothing, _rlcMaxItems = pMaxItems_,
...
instance Hashable RealtimeLogConfigs where

instance NFData RealtimeLogConfigs where
