...
data OriginRequestPolicy = OriginRequestPolicy'{_orpId
                                                :: !Text,
...
originRequestPolicy
    :: Text -- ^ 'orpId'
    -> UTCTime -- ^ 'orpLastModifiedTime'
    -> OriginRequestPolicyConfig -- ^ 'orpOriginRequestPolicyConfig'
    -> OriginRequestPolicy
originRequestPolicy pId_ pLastModifiedTime_
  pOriginRequestPolicyConfig_
  = OriginRequestPolicy'{_orpId = pId_,
...
instance Hashable OriginRequestPolicy where

instance NFData OriginRequestPolicy where
