...
data Distribution = Distribution'{_dActiveTrustedKeyGroups
...
distribution pId_ pARN_ pStatus_ pLastModifiedTime_
  ...
  = Distribution'{_dActiveTrustedKeyGroups = Nothing,
                  _dAliasICPRecordals = Nothing,
                  _dActiveTrustedSigners = Nothing, _dId = pId_,
                  _dARN = pARN_, _dStatus = pStatus_,
