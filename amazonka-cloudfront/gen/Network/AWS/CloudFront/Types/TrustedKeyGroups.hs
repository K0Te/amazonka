...
data TrustedKeyGroups = TrustedKeyGroups'{_tkgItems
                                          :: !(Maybe [Text]),
                                          _tkgEnabled :: !Bool,
                                          _tkgQuantity :: !Int}
...
trustedKeyGroups pEnabled_ pQuantity_
  = TrustedKeyGroups'{_tkgItems = Nothing,
                      _tkgEnabled = pEnabled_, _tkgQuantity = pQuantity_}
...
instance Hashable TrustedKeyGroups where

instance NFData TrustedKeyGroups where
        ...
        toXML TrustedKeyGroups'{..}
          = mconcat
              ["Items" @=
               ...
               "Enabled" @= _tkgEnabled, "Quantity" @= _tkgQuantity]
