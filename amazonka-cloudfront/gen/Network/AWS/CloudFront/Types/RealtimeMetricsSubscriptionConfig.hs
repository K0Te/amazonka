...
newtype RealtimeMetricsSubscriptionConfig = RealtimeMetricsSubscriptionConfig'{_rmscRealtimeMetricsSubscriptionStatus
                                                                               ::
...
realtimeMetricsSubscriptionConfig
    :: RealtimeMetricsSubscriptionStatus -- ^ 'rmscRealtimeMetricsSubscriptionStatus'
    -> RealtimeMetricsSubscriptionConfig
realtimeMetricsSubscriptionConfig
  pRealtimeMetricsSubscriptionStatus_
  = RealtimeMetricsSubscriptionConfig'{_rmscRealtimeMetricsSubscriptionStatus
                                         = pRealtimeMetricsSubscriptionStatus_}
...
instance FromXML RealtimeMetricsSubscriptionConfig
         where
        parseXML x
          = RealtimeMetricsSubscriptionConfig' <$>
...
instance ToXML RealtimeMetricsSubscriptionConfig
         where
