...
newtype MonitoringSubscription = MonitoringSubscription'{_msRealtimeMetricsSubscriptionConfig
                                                         ::
                                                         Maybe
...
monitoringSubscription
    :: MonitoringSubscription
monitoringSubscription
  = MonitoringSubscription'{_msRealtimeMetricsSubscriptionConfig
                              = Nothing}
...
instance Hashable MonitoringSubscription where

instance NFData MonitoringSubscription where
