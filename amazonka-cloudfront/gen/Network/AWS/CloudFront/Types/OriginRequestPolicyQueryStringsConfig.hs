...
data OriginRequestPolicyQueryStringsConfig = OriginRequestPolicyQueryStringsConfig'{_orpqscQueryStrings
                                                                                    ::
                                                                                    !(Maybe
                                                                                        QueryStringNames),
...
originRequestPolicyQueryStringsConfig
    :: OriginRequestPolicyQueryStringBehavior -- ^ 'orpqscQueryStringBehavior'
    -> OriginRequestPolicyQueryStringsConfig
originRequestPolicyQueryStringsConfig
  pQueryStringBehavior_
  = OriginRequestPolicyQueryStringsConfig'{_orpqscQueryStrings
                                             = Nothing,
                                           _orpqscQueryStringBehavior =
                                             pQueryStringBehavior_}
...
instance ToXML OriginRequestPolicyQueryStringsConfig
         where
