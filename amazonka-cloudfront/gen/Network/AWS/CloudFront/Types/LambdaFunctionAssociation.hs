...
data LambdaFunctionAssociation = LambdaFunctionAssociation'{_lfaIncludeBody
                                                            :: !(Maybe Bool),
...
lambdaFunctionAssociation
    ...
    -> LambdaFunctionAssociation
lambdaFunctionAssociation pLambdaFunctionARN_
  pEventType_
  = LambdaFunctionAssociation'{_lfaIncludeBody =
                                 Nothing,
