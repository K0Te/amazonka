...
data ActiveTrustedKeyGroups = ActiveTrustedKeyGroups'{_atkgItems
                                                      ::
                                                      !(Maybe [KGKeyPairIds]),
                                                      _atkgEnabled :: !Bool,
                                                      _atkgQuantity :: !Int}
...
activeTrustedKeyGroups pEnabled_ pQuantity_
  = ActiveTrustedKeyGroups'{_atkgItems = Nothing,
...
instance Hashable ActiveTrustedKeyGroups where

instance NFData ActiveTrustedKeyGroups where
