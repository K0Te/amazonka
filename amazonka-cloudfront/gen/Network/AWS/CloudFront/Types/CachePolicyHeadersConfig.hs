...
data CachePolicyHeadersConfig = CachePolicyHeadersConfig'{_cphcHeaders
                                                          :: !(Maybe Headers),
                                                          _cphcHeaderBehavior ::
...
cachePolicyHeadersConfig
    :: CachePolicyHeaderBehavior -- ^ 'cphcHeaderBehavior'
    -> CachePolicyHeadersConfig
cachePolicyHeadersConfig pHeaderBehavior_
  = CachePolicyHeadersConfig'{_cphcHeaders = Nothing,
...
instance Hashable CachePolicyHeadersConfig where

instance NFData CachePolicyHeadersConfig where
