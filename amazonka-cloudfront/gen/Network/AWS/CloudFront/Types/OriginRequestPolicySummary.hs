...
data OriginRequestPolicySummary = OriginRequestPolicySummary'{_orpsType
                                                              ::
...
originRequestPolicySummary
    :: OriginRequestPolicyType -- ^ 'orpsType'
    -> OriginRequestPolicy -- ^ 'orpsOriginRequestPolicy'
    -> OriginRequestPolicySummary
originRequestPolicySummary pType_
  pOriginRequestPolicy_
  = OriginRequestPolicySummary'{_orpsType = pType_,
                                _orpsOriginRequestPolicy =
                                  pOriginRequestPolicy_}
...
instance Hashable OriginRequestPolicySummary where

instance NFData OriginRequestPolicySummary where
