...
data ListDistributionsByRealtimeLogConfig = ListDistributionsByRealtimeLogConfig'{_ldbrlcRealtimeLogConfigName
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
listDistributionsByRealtimeLogConfig
    :: ListDistributionsByRealtimeLogConfig
listDistributionsByRealtimeLogConfig
  = ListDistributionsByRealtimeLogConfig'{_ldbrlcRealtimeLogConfigName
                                            = Nothing,
...
instance ToPath ListDistributionsByRealtimeLogConfig
         where
        toPath
          = const
              "/2020-05-31/distributionsByRealtimeLogConfig/"

instance ToQuery ListDistributionsByRealtimeLogConfig
         where
        toQuery = const mempty

instance ToXML ListDistributionsByRealtimeLogConfig
         where
...
data ListDistributionsByRealtimeLogConfigResponse = ListDistributionsByRealtimeLogConfigResponse'{_ldbrlcrsDistributionList
                                                                                                  ::
                                                                                                  !(Maybe
                                                                                                      DistributionList),
...
listDistributionsByRealtimeLogConfigResponse
    :: Int -- ^ 'ldbrlcrsResponseStatus'
    -> ListDistributionsByRealtimeLogConfigResponse
listDistributionsByRealtimeLogConfigResponse
  pResponseStatus_
  = ListDistributionsByRealtimeLogConfigResponse'{_ldbrlcrsDistributionList
                                                    = Nothing,
                                                  _ldbrlcrsResponseStatus =
                                                    pResponseStatus_}
