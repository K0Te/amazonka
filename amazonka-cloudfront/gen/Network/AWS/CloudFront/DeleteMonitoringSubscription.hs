...
newtype DeleteMonitoringSubscription = DeleteMonitoringSubscription'{_dmsDistributionId
                                                                     :: Text}
...
deleteMonitoringSubscription
    :: Text -- ^ 'dmsDistributionId'
    -> DeleteMonitoringSubscription
deleteMonitoringSubscription pDistributionId_
  = DeleteMonitoringSubscription'{_dmsDistributionId =
                                    pDistributionId_}
...
instance AWSRequest DeleteMonitoringSubscription
         where
...
instance Hashable DeleteMonitoringSubscription where

instance NFData DeleteMonitoringSubscription where
        ...
        toPath DeleteMonitoringSubscription'{..}
          = mconcat
              ["/2020-05-31/distributions/",
               toBS _dmsDistributionId, "/monitoring-subscription"]

instance ToQuery DeleteMonitoringSubscription where
        toQuery = const mempty

-- | /See:/ 'deleteMonitoringSubscriptionResponse' smart constructor.
newtype DeleteMonitoringSubscriptionResponse = DeleteMonitoringSubscriptionResponse'{_dmsrsResponseStatus
                                                                                     ::
                                                                                     Int}
                                                 deriving (Eq, Read, Show, Data,
                                                           Typeable, Generic)
...
deleteMonitoringSubscriptionResponse
    :: Int -- ^ 'dmsrsResponseStatus'
    -> DeleteMonitoringSubscriptionResponse
deleteMonitoringSubscriptionResponse pResponseStatus_
  = DeleteMonitoringSubscriptionResponse'{_dmsrsResponseStatus
                                            = pResponseStatus_}
