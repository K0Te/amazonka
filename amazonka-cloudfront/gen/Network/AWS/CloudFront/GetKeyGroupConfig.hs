...
newtype GetKeyGroupConfig = GetKeyGroupConfig'{_gkgcId
                                               :: Text}
...
instance Hashable GetKeyGroupConfig where

instance NFData GetKeyGroupConfig where
...
data GetKeyGroupConfigResponse = GetKeyGroupConfigResponse'{_gkgcrsETag
                                                            :: !(Maybe Text),
                                                            _gkgcrsKeyGroupConfig
                                                            ::
                                                            !(Maybe
                                                                KeyGroupConfig),
                                                            _gkgcrsResponseStatus
                                                            :: !Int}
...
getKeyGroupConfigResponse
    :: Int -- ^ 'gkgcrsResponseStatus'
    -> GetKeyGroupConfigResponse
getKeyGroupConfigResponse pResponseStatus_
  = GetKeyGroupConfigResponse'{_gkgcrsETag = Nothing,
...
instance NFData GetKeyGroupConfigResponse where
