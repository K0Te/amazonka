...
data StartInstanceRefresh = StartInstanceRefresh'{_sirPreferences
                                                  ::
...
startInstanceRefresh
    :: Text -- ^ 'sirAutoScalingGroupName'
    -> StartInstanceRefresh
startInstanceRefresh pAutoScalingGroupName_
  = StartInstanceRefresh'{_sirPreferences = Nothing,
...
instance Hashable StartInstanceRefresh where

instance NFData StartInstanceRefresh where
...
data StartInstanceRefreshResponse = StartInstanceRefreshResponse'{_sirrsInstanceRefreshId
                                                                  ::
                                                                  !(Maybe Text),
...
startInstanceRefreshResponse
    :: Int -- ^ 'sirrsResponseStatus'
    -> StartInstanceRefreshResponse
startInstanceRefreshResponse pResponseStatus_
  = StartInstanceRefreshResponse'{_sirrsInstanceRefreshId
                                    = Nothing,
...
instance NFData StartInstanceRefreshResponse where
