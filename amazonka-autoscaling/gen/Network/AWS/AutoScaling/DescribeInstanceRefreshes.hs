...
data DescribeInstanceRefreshes = DescribeInstanceRefreshes'{_dirNextToken
                                                            :: !(Maybe Text),
                                                            _dirMaxRecords ::
                                                            !(Maybe Int),
...
describeInstanceRefreshes
    :: Text -- ^ 'dirAutoScalingGroupName'
    -> DescribeInstanceRefreshes
describeInstanceRefreshes pAutoScalingGroupName_
  = DescribeInstanceRefreshes'{_dirNextToken = Nothing,
...
instance Hashable DescribeInstanceRefreshes where

instance NFData DescribeInstanceRefreshes where
...
data DescribeInstanceRefreshesResponse = DescribeInstanceRefreshesResponse'{_dirrsNextToken
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
describeInstanceRefreshesResponse pResponseStatus_
  = DescribeInstanceRefreshesResponse'{_dirrsNextToken
                                         = Nothing,
