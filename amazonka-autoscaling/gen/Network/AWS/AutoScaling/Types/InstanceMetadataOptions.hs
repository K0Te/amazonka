...
data InstanceMetadataOptions = InstanceMetadataOptions'{_imoHTTPEndpoint
                                                        ::
                                                        !(Maybe
...
instanceMetadataOptions
    :: InstanceMetadataOptions
instanceMetadataOptions
  = InstanceMetadataOptions'{_imoHTTPEndpoint =
                               Nothing,
...
instance Hashable InstanceMetadataOptions where

instance NFData InstanceMetadataOptions where
