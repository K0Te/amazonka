...
data ScalingPolicy = ScalingPolicy'{_sMinAdjustmentStep
                                    :: !(Maybe Int),
...
scalingPolicy
    :: ScalingPolicy
scalingPolicy
  = ScalingPolicy'{_sMinAdjustmentStep = Nothing,
                   _sEstimatedInstanceWarmup = Nothing,
                   _sPolicyName = Nothing, _sEnabled = Nothing,
                   _sPolicyType = Nothing, _sStepAdjustments = Nothing,
                   _sTargetTrackingConfiguration = Nothing,
                   _sAdjustmentType = Nothing,
                   _sAutoScalingGroupName = Nothing,
                   _sScalingAdjustment = Nothing, _sCooldown = Nothing,
                   _sPolicyARN = Nothing, _sAlarms = Nothing,
