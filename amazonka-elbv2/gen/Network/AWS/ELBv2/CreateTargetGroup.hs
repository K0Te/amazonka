...
data CreateTargetGroup = CreateTargetGroup'{_ctgProtocolVersion
                                            :: !(Maybe Text),
...
createTargetGroup pName_
  = CreateTargetGroup'{_ctgProtocolVersion = Nothing,
                       _ctgMatcher = Nothing, _ctgHealthCheckPath = Nothing,
                       ...
                       _ctgHealthCheckPort = Nothing, _ctgTags = Nothing,
                       _ctgPort = Nothing, _ctgName = pName_}
