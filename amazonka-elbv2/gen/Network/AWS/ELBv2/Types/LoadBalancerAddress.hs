...
data LoadBalancerAddress = LoadBalancerAddress'{_lbaIPv6Address
                                                :: !(Maybe Text),
...
loadBalancerAddress
    :: LoadBalancerAddress
loadBalancerAddress
  = LoadBalancerAddress'{_lbaIPv6Address = Nothing,
                         _lbaIPAddress = Nothing, _lbaAllocationId = Nothing,
