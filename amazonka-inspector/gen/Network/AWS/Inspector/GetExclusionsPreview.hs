...
data GetExclusionsPreview = GetExclusionsPreview'{_gepLocale
                                                  :: !(Maybe Locale),
                                                  _gepNextToken ::
                                                  !(Maybe Text),
                                                  _gepMaxResults ::
...
getExclusionsPreview
    ...
    -> GetExclusionsPreview
getExclusionsPreview pAssessmentTemplateARN_
  pPreviewToken_
  = GetExclusionsPreview'{_gepLocale = Nothing,
                          _gepNextToken = Nothing, _gepMaxResults = Nothing,
...
data GetExclusionsPreviewResponse = GetExclusionsPreviewResponse'{_geprsExclusionPreviews
                                                                  ::
                                                                  !(Maybe
                                                                      [ExclusionPreview]),
                                                                  _geprsNextToken
...
getExclusionsPreviewResponse
    ...
    -> GetExclusionsPreviewResponse
getExclusionsPreviewResponse pResponseStatus_
  pPreviewStatus_
  = GetExclusionsPreviewResponse'{_geprsExclusionPreviews
                                    = Nothing,
