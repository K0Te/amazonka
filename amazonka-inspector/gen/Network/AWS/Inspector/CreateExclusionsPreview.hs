...
newtype CreateExclusionsPreview = CreateExclusionsPreview'{_cepAssessmentTemplateARN
                                                           :: Text}
...
createExclusionsPreview
    :: Text -- ^ 'cepAssessmentTemplateARN'
    -> CreateExclusionsPreview
createExclusionsPreview pAssessmentTemplateARN_
  = CreateExclusionsPreview'{_cepAssessmentTemplateARN
...
instance AWSRequest CreateExclusionsPreview where
        type Rs CreateExclusionsPreview =
             CreateExclusionsPreviewResponse
...
instance Hashable CreateExclusionsPreview where

instance NFData CreateExclusionsPreview where
...
data CreateExclusionsPreviewResponse = CreateExclusionsPreviewResponse'{_ceprsResponseStatus
                                                                        :: !Int,
                                                                        _ceprsPreviewToken
                                                                        ::
                                                                        !Text}
...
createExclusionsPreviewResponse
    :: Int -- ^ 'ceprsResponseStatus'
    -> Text -- ^ 'ceprsPreviewToken'
    -> CreateExclusionsPreviewResponse
createExclusionsPreviewResponse pResponseStatus_
  pPreviewToken_
  = CreateExclusionsPreviewResponse'{_ceprsResponseStatus
                                       = pResponseStatus_,
...
instance NFData CreateExclusionsPreviewResponse where
