...
data DescribeExclusions = DescribeExclusions'{_deLocale
                                              :: !(Maybe Locale),
...
describeExclusions pExclusionARNs_
  = DescribeExclusions'{_deLocale = Nothing,
...
data DescribeExclusionsResponse = DescribeExclusionsResponse'{_dersResponseStatus
                                                              :: !Int,
                                                              _dersExclusions ::
                                                              !(Map Text
                                                                  Exclusion),
...
describeExclusionsResponse pResponseStatus_
  = DescribeExclusionsResponse'{_dersResponseStatus =
                                  pResponseStatus_,
