...
data DeleteSignalingChannel = DeleteSignalingChannel'{_dscCurrentVersion
                                                      :: !(Maybe Text),
                                                      _dscChannelARN :: !Text}
...
deleteSignalingChannel pChannelARN_
  = DeleteSignalingChannel'{_dscCurrentVersion =
                              Nothing,
...
instance AWSRequest DeleteSignalingChannel where
        type Rs DeleteSignalingChannel =
             DeleteSignalingChannelResponse
...
instance Hashable DeleteSignalingChannel where

instance NFData DeleteSignalingChannel where
...
newtype DeleteSignalingChannelResponse = DeleteSignalingChannelResponse'{_dscrsResponseStatus
                                                                         :: Int}
...
deleteSignalingChannelResponse pResponseStatus_
  = DeleteSignalingChannelResponse'{_dscrsResponseStatus
                                      = pResponseStatus_}
...
instance NFData DeleteSignalingChannelResponse where
