...
data ListSignalingChannels = ListSignalingChannels'{_lscChannelNameCondition
                                                    ::
                                                    !(Maybe
...
listSignalingChannels
    :: ListSignalingChannels
listSignalingChannels
  = ListSignalingChannels'{_lscChannelNameCondition =
                             Nothing,
                           _lscNextToken = Nothing, _lscMaxResults = Nothing}
...
instance AWSPager ListSignalingChannels where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lscNextToken .~ rs ^. lscrsNextToken

instance AWSRequest ListSignalingChannels where
        type Rs ListSignalingChannels =
             ListSignalingChannelsResponse
...
instance Hashable ListSignalingChannels where

instance NFData ListSignalingChannels where
...
data ListSignalingChannelsResponse = ListSignalingChannelsResponse'{_lscrsChannelInfoList
                                                                    ::
                                                                    !(Maybe
                                                                        [ChannelInfo]),
                                                                    _lscrsNextToken
...
listSignalingChannelsResponse pResponseStatus_
  = ListSignalingChannelsResponse'{_lscrsChannelInfoList
                                     = Nothing,
...
instance NFData ListSignalingChannelsResponse where
