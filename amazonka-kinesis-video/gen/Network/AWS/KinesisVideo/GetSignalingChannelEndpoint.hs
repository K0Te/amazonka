...
data GetSignalingChannelEndpoint = GetSignalingChannelEndpoint'{_gsceSingleMasterChannelEndpointConfiguration
                                                                ::
                                                                !(Maybe
...
getSignalingChannelEndpoint pChannelARN_
  = GetSignalingChannelEndpoint'{_gsceSingleMasterChannelEndpointConfiguration
                                   = Nothing,
...
instance Hashable GetSignalingChannelEndpoint where

instance NFData GetSignalingChannelEndpoint where
...
data GetSignalingChannelEndpointResponse = GetSignalingChannelEndpointResponse'{_gscersResourceEndpointList
                                                                                ::
                                                                                !(Maybe
...
getSignalingChannelEndpointResponse
    :: Int -- ^ 'gscersResponseStatus'
    -> GetSignalingChannelEndpointResponse
getSignalingChannelEndpointResponse pResponseStatus_
  = GetSignalingChannelEndpointResponse'{_gscersResourceEndpointList
                                           = Nothing,
                                         _gscersResponseStatus =
                                           pResponseStatus_}
