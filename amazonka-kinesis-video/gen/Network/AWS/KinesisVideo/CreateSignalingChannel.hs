...
data CreateSignalingChannel = CreateSignalingChannel'{_cscSingleMasterConfiguration
                                                      ::
                                                      !(Maybe
...
createSignalingChannel pChannelName_
  = CreateSignalingChannel'{_cscSingleMasterConfiguration
                              = Nothing,
                            _cscChannelType = Nothing, _cscTags = Nothing,
...
instance AWSRequest CreateSignalingChannel where
        type Rs CreateSignalingChannel =
             CreateSignalingChannelResponse
...
instance Hashable CreateSignalingChannel where

instance NFData CreateSignalingChannel where
...
data CreateSignalingChannelResponse = CreateSignalingChannelResponse'{_cscrsChannelARN
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
...
createSignalingChannelResponse pResponseStatus_
  = CreateSignalingChannelResponse'{_cscrsChannelARN =
                                      Nothing,
...
instance NFData CreateSignalingChannelResponse where
