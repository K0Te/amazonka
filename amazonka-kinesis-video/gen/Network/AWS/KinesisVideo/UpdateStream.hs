...
data UpdateStream = UpdateStream'{_uMediaType ::
                                  !(Maybe Text),
...
updateStream pCurrentVersion_
  = UpdateStream'{_uMediaType = Nothing,
                  _uStreamARN = Nothing, _uDeviceName = Nothing,
...
newtype UpdateStreamResponse = UpdateStreamResponse'{_usrsResponseStatus
                                                     :: Int}
...
updateStreamResponse pResponseStatus_
  = UpdateStreamResponse'{_usrsResponseStatus =
                            pResponseStatus_}
