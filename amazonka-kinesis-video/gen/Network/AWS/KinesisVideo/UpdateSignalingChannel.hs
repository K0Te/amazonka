...
data UpdateSignalingChannel = UpdateSignalingChannel'{_uscSingleMasterConfiguration
                                                      ::
                                                      !(Maybe
...
updateSignalingChannel
    :: Text -- ^ 'uscChannelARN'
    -> Text -- ^ 'uscCurrentVersion'
    -> UpdateSignalingChannel
updateSignalingChannel pChannelARN_ pCurrentVersion_
  = UpdateSignalingChannel'{_uscSingleMasterConfiguration
                              = Nothing,
...
instance AWSRequest UpdateSignalingChannel where
        type Rs UpdateSignalingChannel =
             UpdateSignalingChannelResponse
...
instance Hashable UpdateSignalingChannel where

instance NFData UpdateSignalingChannel where
...
newtype UpdateSignalingChannelResponse = UpdateSignalingChannelResponse'{_uscrsResponseStatus
                                                                         :: Int}
...
updateSignalingChannelResponse pResponseStatus_
  = UpdateSignalingChannelResponse'{_uscrsResponseStatus
                                      = pResponseStatus_}
...
instance NFData UpdateSignalingChannelResponse where
