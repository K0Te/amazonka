...
data DescribeSignalingChannel = DescribeSignalingChannel'{_dChannelARN
                                                          :: !(Maybe Text),
                                                          _dChannelName ::
                                                          !(Maybe Text)}
...
describeSignalingChannel
    :: DescribeSignalingChannel
describeSignalingChannel
  = DescribeSignalingChannel'{_dChannelARN = Nothing,
...
instance AWSRequest DescribeSignalingChannel where
        type Rs DescribeSignalingChannel =
             DescribeSignalingChannelResponse
...
instance Hashable DescribeSignalingChannel where

instance NFData DescribeSignalingChannel where
...
data DescribeSignalingChannelResponse = DescribeSignalingChannelResponse'{_desrsChannelInfo
                                                                          ::
                                                                          !(Maybe
                                                                              ChannelInfo),
...
describeSignalingChannelResponse pResponseStatus_
  = DescribeSignalingChannelResponse'{_desrsChannelInfo
                                        = Nothing,
