...
data ListJobs = ListJobs'{_ljMarker :: !(Maybe Text),
                          _ljCompleted :: !(Maybe Text),
                          _ljLimit :: !(Maybe Text),
                          _ljStatuscode :: !(Maybe Text),
                          _ljAccountId :: !Text, _ljVaultName :: !Text}
...
listJobs pAccountId_ pVaultName_
  = ListJobs'{_ljMarker = Nothing,
              _ljCompleted = Nothing, _ljLimit = Nothing,
              _ljStatuscode = Nothing, _ljAccountId = pAccountId_,
...
data ListJobsResponse = ListJobsResponse'{_ljrsMarker
                                          :: !(Maybe Text),
                                          _ljrsJobList ::
...
listJobsResponse pResponseStatus_
  = ListJobsResponse'{_ljrsMarker = Nothing,
