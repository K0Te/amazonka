...
data ListParts = ListParts'{_lpMarker ::
                            !(Maybe Text),
                            _lpLimit :: !(Maybe Text), _lpAccountId :: !Text,
                            _lpVaultName :: !Text, _lpUploadId :: !Text}
...
listParts pAccountId_ pVaultName_ pUploadId_
  = ListParts'{_lpMarker = Nothing, _lpLimit = Nothing,
               _lpAccountId = pAccountId_,
               _lpVaultName = pVaultName_, _lpUploadId = pUploadId_}
...
data ListPartsResponse = ListPartsResponse'{_lprsParts
                                            ...
                                            _lprsMultipartUploadId ::
                                            !(Maybe Text),
                                            _lprsPartSizeInBytes ::
                                            !(Maybe Integer),
                                            _lprsArchiveDescription ::
                                            !(Maybe Text),
...
listPartsResponse pResponseStatus_
  = ListPartsResponse'{_lprsParts = Nothing,
                       ...
                       _lprsVaultARN = Nothing, _lprsMarker = Nothing,
