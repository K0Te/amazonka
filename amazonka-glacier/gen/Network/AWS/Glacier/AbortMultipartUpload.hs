...
data AbortMultipartUpload = AbortMultipartUpload'{_amuAccountId
                                                  :: !Text,
                                                  _amuVaultName :: !Text,
                                                  _amuUploadId :: !Text}
...
abortMultipartUpload
    ...
    -> Text -- ^ 'amuUploadId'
    -> AbortMultipartUpload
abortMultipartUpload pAccountId_ pVaultName_
  pUploadId_
  = AbortMultipartUpload'{_amuAccountId = pAccountId_,
