...
newtype DeleteLifecyclePolicy = DeleteLifecyclePolicy'{_dlpContainerName
                                                       :: Text}
...
deleteLifecyclePolicy pContainerName_
  = DeleteLifecyclePolicy'{_dlpContainerName =
                             pContainerName_}
...
newtype DeleteLifecyclePolicyResponse = DeleteLifecyclePolicyResponse'{_dlprsResponseStatus
                                                                       :: Int}
...
deleteLifecyclePolicyResponse pResponseStatus_
  = DeleteLifecyclePolicyResponse'{_dlprsResponseStatus
                                     = pResponseStatus_}
