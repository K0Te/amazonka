...
newtype StartAccessLogging = StartAccessLogging'{_sContainerName
                                                 :: Text}
...
startAccessLogging pContainerName_
  = StartAccessLogging'{_sContainerName =
                          pContainerName_}
...
newtype StartAccessLoggingResponse = StartAccessLoggingResponse'{_srsResponseStatus
                                                                 :: Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
startAccessLoggingResponse pResponseStatus_
  = StartAccessLoggingResponse'{_srsResponseStatus =
                                  pResponseStatus_}
