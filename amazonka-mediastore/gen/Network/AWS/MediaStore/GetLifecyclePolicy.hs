...
newtype GetLifecyclePolicy = GetLifecyclePolicy'{_glpContainerName
                                                 :: Text}
...
getLifecyclePolicy
    :: Text -- ^ 'glpContainerName'
    -> GetLifecyclePolicy
getLifecyclePolicy pContainerName_
  = GetLifecyclePolicy'{_glpContainerName =
                          pContainerName_}
...
data GetLifecyclePolicyResponse = GetLifecyclePolicyResponse'{_glprsResponseStatus
                                                              :: !Int,
                                                              _glprsLifecyclePolicy
                                                              :: !Text}
                                    deriving (Eq, Read, Show, Data, Typeable,
                                              Generic)
...
getLifecyclePolicyResponse
    ...
    -> Text -- ^ 'glprsLifecyclePolicy'
    -> GetLifecyclePolicyResponse
getLifecyclePolicyResponse pResponseStatus_
  pLifecyclePolicy_
  = GetLifecyclePolicyResponse'{_glprsResponseStatus =
                                  pResponseStatus_,
