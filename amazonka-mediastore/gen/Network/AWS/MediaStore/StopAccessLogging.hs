...
newtype StopAccessLogging = StopAccessLogging'{_salContainerName
                                               :: Text}
...
stopAccessLogging pContainerName_
  = StopAccessLogging'{_salContainerName =
                         pContainerName_}
...
newtype StopAccessLoggingResponse = StopAccessLoggingResponse'{_salrsResponseStatus
                                                               :: Int}
...
stopAccessLoggingResponse pResponseStatus_
  = StopAccessLoggingResponse'{_salrsResponseStatus =
                                 pResponseStatus_}
