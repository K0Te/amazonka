...
data PutLifecyclePolicy = PutLifecyclePolicy'{_plpContainerName
                                              :: !Text,
...
putLifecyclePolicy
    :: Text -- ^ 'plpContainerName'
    -> Text -- ^ 'plpLifecyclePolicy'
    -> PutLifecyclePolicy
putLifecyclePolicy pContainerName_ pLifecyclePolicy_
  = PutLifecyclePolicy'{_plpContainerName =
                          pContainerName_,
...
newtype PutLifecyclePolicyResponse = PutLifecyclePolicyResponse'{_plprsResponseStatus
                                                                 :: Int}
...
putLifecyclePolicyResponse pResponseStatus_
  = PutLifecyclePolicyResponse'{_plprsResponseStatus =
                                  pResponseStatus_}
