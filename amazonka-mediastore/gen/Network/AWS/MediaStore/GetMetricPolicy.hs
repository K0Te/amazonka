...
newtype GetMetricPolicy = GetMetricPolicy'{_gmpContainerName
                                           :: Text}
...
getMetricPolicy
    :: Text -- ^ 'gmpContainerName'
    -> GetMetricPolicy
getMetricPolicy pContainerName_
  = GetMetricPolicy'{_gmpContainerName =
                       pContainerName_}
...
instance Hashable GetMetricPolicy where

instance NFData GetMetricPolicy where
...
data GetMetricPolicyResponse = GetMetricPolicyResponse'{_gmprsResponseStatus
                                                        :: !Int,
                                                        _gmprsMetricPolicy ::
                                                        !MetricPolicy}
...
getMetricPolicyResponse
    :: Int -- ^ 'gmprsResponseStatus'
    -> MetricPolicy -- ^ 'gmprsMetricPolicy'
    -> GetMetricPolicyResponse
getMetricPolicyResponse pResponseStatus_
  pMetricPolicy_
  = GetMetricPolicyResponse'{_gmprsResponseStatus =
                               pResponseStatus_,
...
instance NFData GetMetricPolicyResponse where
