...
newtype DeleteMetricPolicy = DeleteMetricPolicy'{_dmpContainerName
                                                 :: Text}
...
deleteMetricPolicy
    :: Text -- ^ 'dmpContainerName'
    -> DeleteMetricPolicy
deleteMetricPolicy pContainerName_
  = DeleteMetricPolicy'{_dmpContainerName =
                          pContainerName_}
...
instance Hashable DeleteMetricPolicy where

instance NFData DeleteMetricPolicy where
...
newtype DeleteMetricPolicyResponse = DeleteMetricPolicyResponse'{_dmprsResponseStatus
                                                                 :: Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
deleteMetricPolicyResponse pResponseStatus_
  = DeleteMetricPolicyResponse'{_dmprsResponseStatus =
                                  pResponseStatus_}
...
instance NFData DeleteMetricPolicyResponse where
