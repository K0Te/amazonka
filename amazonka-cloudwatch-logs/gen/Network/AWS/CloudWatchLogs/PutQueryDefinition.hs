...
data PutQueryDefinition = PutQueryDefinition'{_pqdLogGroupNames
                                              :: !(Maybe [Text]),
...
putQueryDefinition pName_ pQueryString_
  = PutQueryDefinition'{_pqdLogGroupNames = Nothing,
                        _pqdQueryDefinitionId = Nothing, _pqdName = pName_,
...
instance Hashable PutQueryDefinition where

instance NFData PutQueryDefinition where
...
data PutQueryDefinitionResponse = PutQueryDefinitionResponse'{_pqdrsQueryDefinitionId
                                                              :: !(Maybe Text),
                                                              _pqdrsResponseStatus
                                                              :: !Int}
...
putQueryDefinitionResponse
    :: Int -- ^ 'pqdrsResponseStatus'
    -> PutQueryDefinitionResponse
putQueryDefinitionResponse pResponseStatus_
  = PutQueryDefinitionResponse'{_pqdrsQueryDefinitionId
                                  = Nothing,
...
instance NFData PutQueryDefinitionResponse where
