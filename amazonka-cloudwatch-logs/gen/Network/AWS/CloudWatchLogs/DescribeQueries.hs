...
data DescribeQueries = DescribeQueries'{_dqStatus ::
                                        !(Maybe QueryStatus),
...
describeQueries
    :: DescribeQueries
describeQueries
  = DescribeQueries'{_dqStatus = Nothing,
                     _dqLogGroupName = Nothing, _dqNextToken = Nothing,
...
data DescribeQueriesResponse = DescribeQueriesResponse'{_dqrsQueries
                                                        :: !(Maybe [QueryInfo]),
                                                        _dqrsNextToken ::
                                                        !(Maybe Text),
                                                        _dqrsResponseStatus ::
...
describeQueriesResponse pResponseStatus_
  = DescribeQueriesResponse'{_dqrsQueries = Nothing,
