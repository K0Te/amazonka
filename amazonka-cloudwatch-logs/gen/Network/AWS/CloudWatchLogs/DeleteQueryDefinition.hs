...
newtype DeleteQueryDefinition = DeleteQueryDefinition'{_dqdQueryDefinitionId
                                                       :: Text}
...
deleteQueryDefinition
    :: Text -- ^ 'dqdQueryDefinitionId'
    -> DeleteQueryDefinition
deleteQueryDefinition pQueryDefinitionId_
  = DeleteQueryDefinition'{_dqdQueryDefinitionId =
                             pQueryDefinitionId_}
...
instance Hashable DeleteQueryDefinition where

instance NFData DeleteQueryDefinition where
...
data DeleteQueryDefinitionResponse = DeleteQueryDefinitionResponse'{_drsSuccess
                                                                    ::
                                                                    !(Maybe
                                                                        Bool),
                                                                    _drsResponseStatus
...
deleteQueryDefinitionResponse pResponseStatus_
  = DeleteQueryDefinitionResponse'{_drsSuccess =
                                     Nothing,
...
instance NFData DeleteQueryDefinitionResponse where
