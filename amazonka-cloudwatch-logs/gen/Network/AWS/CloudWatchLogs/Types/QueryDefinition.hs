...
data QueryDefinition = QueryDefinition'{_qdLogGroupNames
                                        :: !(Maybe [Text]),
...
queryDefinition
    :: QueryDefinition
queryDefinition
  = QueryDefinition'{_qdLogGroupNames = Nothing,
                     _qdQueryDefinitionId = Nothing, _qdName = Nothing,
                     _qdQueryString = Nothing, _qdLastModified = Nothing}
...
instance Hashable QueryDefinition where

instance NFData QueryDefinition where
