...
newtype GetLogRecord = GetLogRecord'{_glrLogRecordPointer
                                     :: Text}
...
getLogRecord pLogRecordPointer_
  = GetLogRecord'{_glrLogRecordPointer =
                    pLogRecordPointer_}
...
data GetLogRecordResponse = GetLogRecordResponse'{_glrrsLogRecord
                                                  :: !(Maybe (Map Text Text)),
...
getLogRecordResponse pResponseStatus_
  = GetLogRecordResponse'{_glrrsLogRecord = Nothing,
