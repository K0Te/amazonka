...
data DescribeQueryDefinitions = DescribeQueryDefinitions'{_dqdQueryDefinitionNamePrefix
                                                          :: !(Maybe Text),
                                                          _dqdNextToken ::
                                                          !(Maybe Text),
                                                          _dqdMaxResults ::
...
describeQueryDefinitions
    :: DescribeQueryDefinitions
describeQueryDefinitions
  = DescribeQueryDefinitions'{_dqdQueryDefinitionNamePrefix
                                = Nothing,
                              _dqdNextToken = Nothing, _dqdMaxResults = Nothing}
...
instance AWSRequest DescribeQueryDefinitions where
        type Rs DescribeQueryDefinitions =
             DescribeQueryDefinitionsResponse
...
instance Hashable DescribeQueryDefinitions where

instance NFData DescribeQueryDefinitions where
...
data DescribeQueryDefinitionsResponse = DescribeQueryDefinitionsResponse'{_dqdrsQueryDefinitions
                                                                          ::
                                                                          !(Maybe
                                                                              [QueryDefinition]),
                                                                          _dqdrsNextToken
...
describeQueryDefinitionsResponse
    :: Int -- ^ 'dqdrsResponseStatus'
    -> DescribeQueryDefinitionsResponse
describeQueryDefinitionsResponse pResponseStatus_
  = DescribeQueryDefinitionsResponse'{_dqdrsQueryDefinitions
                                        = Nothing,
