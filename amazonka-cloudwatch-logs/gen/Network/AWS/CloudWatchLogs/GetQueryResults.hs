...
newtype GetQueryResults = GetQueryResults'{_gqrQueryId
                                           :: Text}
...
data GetQueryResultsResponse = GetQueryResultsResponse'{_gqrrsStatus
                                                        :: !(Maybe QueryStatus),
                                                        _gqrrsResults ::
                                                        !(Maybe
                                                            [[ResultField]]),
...
getQueryResultsResponse pResponseStatus_
  = GetQueryResultsResponse'{_gqrrsStatus = Nothing,
