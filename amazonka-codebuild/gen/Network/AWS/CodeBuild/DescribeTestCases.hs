...
instance AWSPager DescribeTestCases where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dtcNextToken .~ rs ^. dtcrsNextToken
...
instance Hashable DescribeTestCases where

instance NFData DescribeTestCases where
...
instance NFData DescribeTestCasesResponse where
