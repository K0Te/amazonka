...
data DeleteReportGroup = DeleteReportGroup'{_drgDeleteReports
                                            :: !(Maybe Bool),
                                            _drgArn :: !Text}
...
deleteReportGroup pArn_
  = DeleteReportGroup'{_drgDeleteReports = Nothing,
                       _drgArn = pArn_}
...
instance Hashable DeleteReportGroup where

instance NFData DeleteReportGroup where
...
instance NFData DeleteReportGroupResponse where
