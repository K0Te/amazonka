...
data StartBuildBatch = StartBuildBatch'{_sbbEncryptionKeyOverride
                                        :: !(Maybe Text),
...
startBuildBatch pProjectName_
  = StartBuildBatch'{_sbbEncryptionKeyOverride =
                       Nothing,
...
instance Hashable StartBuildBatch where

instance NFData StartBuildBatch where
...
data StartBuildBatchResponse = StartBuildBatchResponse'{_starsBuildBatch
                                                        :: !(Maybe BuildBatch),
...
startBuildBatchResponse pResponseStatus_
  = StartBuildBatchResponse'{_starsBuildBatch =
                               Nothing,
...
instance NFData StartBuildBatchResponse where
