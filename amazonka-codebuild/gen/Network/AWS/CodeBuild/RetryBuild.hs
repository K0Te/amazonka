...
data RetryBuild = RetryBuild'{_rbIdempotencyToken ::
                              !(Maybe Text),
                              _rbId :: !(Maybe Text)}
...
retryBuild
    :: RetryBuild
retryBuild
  = RetryBuild'{_rbIdempotencyToken = Nothing,
                _rbId = Nothing}
...
instance Hashable RetryBuild where

instance NFData RetryBuild where
...
data RetryBuildResponse = RetryBuildResponse'{_rbrsBuild
                                              :: !(Maybe Build),
...
retryBuildResponse pResponseStatus_
  = RetryBuildResponse'{_rbrsBuild = Nothing,
...
instance NFData RetryBuildResponse where
