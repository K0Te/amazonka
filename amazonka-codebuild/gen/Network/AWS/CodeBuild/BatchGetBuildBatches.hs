...
newtype BatchGetBuildBatches = BatchGetBuildBatches'{_bgbbIds
                                                     :: [Text]}
...
instance Hashable BatchGetBuildBatches where

instance NFData BatchGetBuildBatches where
...
data BatchGetBuildBatchesResponse = BatchGetBuildBatchesResponse'{_bgbbrsBuildBatches
                                                                  ::
                                                                  !(Maybe
                                                                      [BuildBatch]),
...
batchGetBuildBatchesResponse
    :: Int -- ^ 'bgbbrsResponseStatus'
    -> BatchGetBuildBatchesResponse
batchGetBuildBatchesResponse pResponseStatus_
  = BatchGetBuildBatchesResponse'{_bgbbrsBuildBatches =
                                    Nothing,
...
instance NFData BatchGetBuildBatchesResponse where
