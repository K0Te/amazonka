...
newtype DeleteBuildBatch = DeleteBuildBatch'{_dbbId
                                             :: Text}
...
instance Hashable DeleteBuildBatch where

instance NFData DeleteBuildBatch where
...
data DeleteBuildBatchResponse = DeleteBuildBatchResponse'{_dbbrsBuildsNotDeleted
                                                          ::
                                                          !(Maybe
                                                              [BuildNotDeleted]),
                                                          _dbbrsBuildsDeleted ::
...
deleteBuildBatchResponse
    :: Int -- ^ 'dbbrsResponseStatus'
    -> DeleteBuildBatchResponse
deleteBuildBatchResponse pResponseStatus_
  = DeleteBuildBatchResponse'{_dbbrsBuildsNotDeleted =
                                Nothing,
...
instance NFData DeleteBuildBatchResponse where
