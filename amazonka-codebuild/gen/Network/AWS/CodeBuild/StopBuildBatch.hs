...
newtype StopBuildBatch = StopBuildBatch'{_sbbId ::
                                         Text}
...
instance Hashable StopBuildBatch where

instance NFData StopBuildBatch where
...
data StopBuildBatchResponse = StopBuildBatchResponse'{_sbbrsBuildBatch
                                                      :: !(Maybe BuildBatch),
                                                      _sbbrsResponseStatus ::
                                                      !Int}
...
stopBuildBatchResponse
    :: Int -- ^ 'sbbrsResponseStatus'
    -> StopBuildBatchResponse
stopBuildBatchResponse pResponseStatus_
  = StopBuildBatchResponse'{_sbbrsBuildBatch = Nothing,
...
instance NFData StopBuildBatchResponse where
