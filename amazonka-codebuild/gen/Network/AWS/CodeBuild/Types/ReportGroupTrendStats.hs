...
data ReportGroupTrendStats = ReportGroupTrendStats'{_rgtsMax
                                                    :: !(Maybe Text),
                                                    _rgtsAverage ::
                                                    !(Maybe Text),
                                                    _rgtsMin :: !(Maybe Text)}
...
reportGroupTrendStats
    :: ReportGroupTrendStats
reportGroupTrendStats
  = ReportGroupTrendStats'{_rgtsMax = Nothing,
                           _rgtsAverage = Nothing, _rgtsMin = Nothing}
...
instance FromJSON ReportGroupTrendStats where
        parseJSON
          = withObject "ReportGroupTrendStats"
              (\ x ->
                 ReportGroupTrendStats' <$>
                   (x .:? "max") <*> (x .:? "average") <*>
                     (x .:? "min"))

instance Hashable ReportGroupTrendStats where

instance NFData ReportGroupTrendStats where
