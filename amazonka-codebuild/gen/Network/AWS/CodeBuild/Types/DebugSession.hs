...
data DebugSession = DebugSession'{_dsSessionEnabled
                                  :: !(Maybe Bool),
...
debugSession
    :: DebugSession
debugSession
  = DebugSession'{_dsSessionEnabled = Nothing,
...
instance FromJSON DebugSession where
        parseJSON
          = withObject "DebugSession"
              (\ x ->
                 DebugSession' <$>
                   (x .:? "sessionEnabled") <*> (x .:? "sessionTarget"))

instance Hashable DebugSession where

instance NFData DebugSession where
