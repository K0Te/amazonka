...
data ProjectBuildBatchConfig = ProjectBuildBatchConfig'{_pbbcCombineArtifacts
                                                        :: !(Maybe Bool),
                                                        _pbbcTimeoutInMins ::
                                                        !(Maybe Int),
                                                        _pbbcRestrictions ::
...
projectBuildBatchConfig
    :: ProjectBuildBatchConfig
projectBuildBatchConfig
  = ProjectBuildBatchConfig'{_pbbcCombineArtifacts =
                               Nothing,
...
instance FromJSON ProjectBuildBatchConfig where
        parseJSON
          = withObject "ProjectBuildBatchConfig"
              (\ x ->
                 ProjectBuildBatchConfig' <$>
                   (x .:? "combineArtifacts") <*>
                     (x .:? "timeoutInMins")
...
instance Hashable ProjectBuildBatchConfig where

instance NFData ProjectBuildBatchConfig where
