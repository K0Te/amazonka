...
data ProjectEnvironment = ProjectEnvironment'{_peImagePullCredentialsType
                                              ::
...
projectEnvironment pType_ pImage_ pComputeType_
  = ProjectEnvironment'{_peImagePullCredentialsType =
                          Nothing,
                        _pePrivilegedMode = Nothing,
                        _peRegistryCredential = Nothing,
                        _peCertificate = Nothing,
                        _peEnvironmentVariables = Nothing, _peType = pType_,
                        _peImage = pImage_, _peComputeType = pComputeType_}
