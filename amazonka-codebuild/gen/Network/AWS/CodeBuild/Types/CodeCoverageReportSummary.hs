...
data CodeCoverageReportSummary = CodeCoverageReportSummary'{_ccrsBranchesMissed
                                                            :: !(Maybe Nat),
                                                            _ccrsLinesMissed ::
                                                            !(Maybe Nat),
...
codeCoverageReportSummary
    :: CodeCoverageReportSummary
codeCoverageReportSummary
  = CodeCoverageReportSummary'{_ccrsBranchesMissed =
                                 Nothing,
...
instance FromJSON CodeCoverageReportSummary where
        parseJSON
          = withObject "CodeCoverageReportSummary"
              (\ x ->
                 CodeCoverageReportSummary' <$>
                   (x .:? "branchesMissed") <*> (x .:? "linesMissed")
                     <*> (x .:? "branchesCovered")
                     <*> (x .:? "linesCovered")
                     <*> (x .:? "branchCoveragePercentage")
                     <*> (x .:? "lineCoveragePercentage"))

instance Hashable CodeCoverageReportSummary where

instance NFData CodeCoverageReportSummary where
