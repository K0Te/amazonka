...
data ListBuildBatchesForProject = ListBuildBatchesForProject'{_lbbfpSortOrder
                                                              ::
                                                              !(Maybe
                                                                  SortOrderType),
                                                              _lbbfpNextToken ::
...
listBuildBatchesForProject
    :: ListBuildBatchesForProject
listBuildBatchesForProject
  = ListBuildBatchesForProject'{_lbbfpSortOrder =
                                  Nothing,
...
instance AWSPager ListBuildBatchesForProject where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lbbfpNextToken .~ rs ^. lbbfprsNextToken
...
instance Hashable ListBuildBatchesForProject where

instance NFData ListBuildBatchesForProject where
...
data ListBuildBatchesForProjectResponse = ListBuildBatchesForProjectResponse'{_lbbfprsIds
                                                                              ::
                                                                              !(Maybe
                                                                                  [Text]),
                                                                              _lbbfprsNextToken
...
listBuildBatchesForProjectResponse
    :: Int -- ^ 'lbbfprsResponseStatus'
    -> ListBuildBatchesForProjectResponse
listBuildBatchesForProjectResponse pResponseStatus_
  = ListBuildBatchesForProjectResponse'{_lbbfprsIds =
                                          Nothing,
