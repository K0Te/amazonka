...
data RetryBuildBatch = RetryBuildBatch'{_rbbIdempotencyToken
                                        :: !(Maybe Text),
                                        _rbbId :: !(Maybe Text),
                                        _rbbRetryType ::
...
retryBuildBatch
    :: RetryBuildBatch
retryBuildBatch
  = RetryBuildBatch'{_rbbIdempotencyToken = Nothing,
                     _rbbId = Nothing, _rbbRetryType = Nothing}
...
instance Hashable RetryBuildBatch where

instance NFData RetryBuildBatch where
...
data RetryBuildBatchResponse = RetryBuildBatchResponse'{_rbbrsBuildBatch
                                                        :: !(Maybe BuildBatch),
                                                        _rbbrsResponseStatus ::
                                                        !Int}
...
retryBuildBatchResponse
    :: Int -- ^ 'rbbrsResponseStatus'
    -> RetryBuildBatchResponse
retryBuildBatchResponse pResponseStatus_
  = RetryBuildBatchResponse'{_rbbrsBuildBatch =
                               Nothing,
...
instance NFData RetryBuildBatchResponse where
