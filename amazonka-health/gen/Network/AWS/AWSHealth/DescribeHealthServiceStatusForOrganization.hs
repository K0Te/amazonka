...
data DescribeHealthServiceStatusForOrganizationResponse = DescribeHealthServiceStatusForOrganizationResponse'{_dhssforsHealthServiceAccessStatusForOrganization
                                                                                                              ::
                                                                                                              !(Maybe
                                                                                                                  Text),
...
describeHealthServiceStatusForOrganizationResponse
    :: Int -- ^ 'dhssforsResponseStatus'
    -> DescribeHealthServiceStatusForOrganizationResponse
describeHealthServiceStatusForOrganizationResponse
  pResponseStatus_
  = DescribeHealthServiceStatusForOrganizationResponse'{_dhssforsHealthServiceAccessStatusForOrganization
                                                          = Nothing,
                                                        _dhssforsResponseStatus
                                                          = pResponseStatus_}
