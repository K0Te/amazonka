...
data OrganizationEventDetails = OrganizationEventDetails'{_oedEvent
                                                          :: !(Maybe Event),
...
organizationEventDetails
    :: OrganizationEventDetails
organizationEventDetails
  = OrganizationEventDetails'{_oedEvent = Nothing,
...
instance FromJSON OrganizationEventDetails where
        parseJSON
          = withObject "OrganizationEventDetails"
              (\ x ->
                 OrganizationEventDetails' <$>
...
instance Hashable OrganizationEventDetails where

instance NFData OrganizationEventDetails where
