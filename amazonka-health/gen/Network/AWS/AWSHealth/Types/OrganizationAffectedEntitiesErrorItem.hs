...
data OrganizationAffectedEntitiesErrorItem = OrganizationAffectedEntitiesErrorItem'{_oaeeiAwsAccountId
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Text),
                                                                                    _oaeeiEventARN
...
organizationAffectedEntitiesErrorItem
    :: OrganizationAffectedEntitiesErrorItem
organizationAffectedEntitiesErrorItem
  = OrganizationAffectedEntitiesErrorItem'{_oaeeiAwsAccountId
                                             = Nothing,
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "OrganizationAffectedEntitiesErrorItem"
              (\ x ->
                 OrganizationAffectedEntitiesErrorItem' <$>
