...
data OrganizationEventFilter = OrganizationEventFilter'{_oefLastUpdatedTime
                                                        ::
                                                        !(Maybe DateTimeRange),
                                                        _oefAwsAccountIds ::
                                                        !(Maybe (List1 Text)),
...
organizationEventFilter
    :: OrganizationEventFilter
organizationEventFilter
  = OrganizationEventFilter'{_oefLastUpdatedTime =
                               Nothing,
                             _oefAwsAccountIds = Nothing,
                             _oefEventTypeCategories = Nothing,
                             _oefEventTypeCodes = Nothing,
                             _oefStartTime = Nothing, _oefRegions = Nothing,
                             _oefEventStatusCodes = Nothing,
                             _oefEndTime = Nothing, _oefEntityARNs = Nothing,
                             _oefEntityValues = Nothing, _oefServices = Nothing}
...
instance Hashable OrganizationEventFilter where

instance NFData OrganizationEventFilter where
