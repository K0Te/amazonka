...
data OrganizationEventDetailsErrorItem = OrganizationEventDetailsErrorItem'{_oedeiAwsAccountId
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _oedeiEventARN
...
organizationEventDetailsErrorItem
    :: OrganizationEventDetailsErrorItem
organizationEventDetailsErrorItem
  = OrganizationEventDetailsErrorItem'{_oedeiAwsAccountId
                                         = Nothing,
...
instance FromJSON OrganizationEventDetailsErrorItem
         where
        parseJSON
          = withObject "OrganizationEventDetailsErrorItem"
              (\ x ->
                 OrganizationEventDetailsErrorItem' <$>
                   (x .:? "awsAccountId") <*> (x .:? "eventArn") <*>
                     (x .:? "errorName")
                     <*> (x .:? "errorMessage"))
