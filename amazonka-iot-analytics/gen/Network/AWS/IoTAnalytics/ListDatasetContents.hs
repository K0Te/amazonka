...
data ListDatasetContents = ListDatasetContents'{_ldcNextToken
                                                :: !(Maybe Text),
                                                _ldcScheduledBefore ::
                                                !(Maybe POSIX),
...
listDatasetContents pDatasetName_
  = ListDatasetContents'{_ldcNextToken = Nothing,
...
instance Hashable ListDatasetContents where

instance NFData ListDatasetContents where
...
data ListDatasetContentsResponse = ListDatasetContentsResponse'{_ldcrsDatasetContentSummaries
                                                                ::
                                                                !(Maybe
...
listDatasetContentsResponse pResponseStatus_
  = ListDatasetContentsResponse'{_ldcrsDatasetContentSummaries
                                   = Nothing,
...
instance NFData ListDatasetContentsResponse where
