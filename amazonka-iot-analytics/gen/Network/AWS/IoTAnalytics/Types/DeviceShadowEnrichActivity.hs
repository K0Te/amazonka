...
data DeviceShadowEnrichActivity = DeviceShadowEnrichActivity'{_dseaNext
                                                              :: !(Maybe Text),
                                                              _dseaName ::
                                                              !Text,
                                                              _dseaAttribute ::
...
deviceShadowEnrichActivity
    ...
    -> Text -- ^ 'dseaRoleARN'
    -> DeviceShadowEnrichActivity
deviceShadowEnrichActivity pName_ pAttribute_
  pThingName_ pRoleARN_
  = DeviceShadowEnrichActivity'{_dseaNext = Nothing,
                                _dseaName = pName_,
