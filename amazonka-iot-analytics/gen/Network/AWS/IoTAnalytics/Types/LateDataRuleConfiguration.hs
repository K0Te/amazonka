...
newtype LateDataRuleConfiguration = LateDataRuleConfiguration'{_ldrcDeltaTimeSessionWindowConfiguration
                                                               ::
                                                               Maybe
...
lateDataRuleConfiguration
    :: LateDataRuleConfiguration
lateDataRuleConfiguration
  = LateDataRuleConfiguration'{_ldrcDeltaTimeSessionWindowConfiguration
                                 = Nothing}
...
instance FromJSON LateDataRuleConfiguration where
        parseJSON
          = withObject "LateDataRuleConfiguration"
              (\ x ->
                 LateDataRuleConfiguration' <$>
                   (x .:? "deltaTimeSessionWindowConfiguration"))

instance Hashable LateDataRuleConfiguration where

instance NFData LateDataRuleConfiguration where
