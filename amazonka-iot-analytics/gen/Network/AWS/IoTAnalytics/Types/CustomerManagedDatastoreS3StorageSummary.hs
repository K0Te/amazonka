...
data CustomerManagedDatastoreS3StorageSummary = CustomerManagedDatastoreS3StorageSummary'{_cmdsssBucket
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
                                                                                          _cmdsssKeyPrefix
...
customerManagedDatastoreS3StorageSummary
    :: CustomerManagedDatastoreS3StorageSummary
customerManagedDatastoreS3StorageSummary
  = CustomerManagedDatastoreS3StorageSummary'{_cmdsssBucket
                                                = Nothing,
