...
data DatasetContentDeliveryDestination = DatasetContentDeliveryDestination'{_dcddS3DestinationConfiguration
                                                                            ::
                                                                            !(Maybe
...
datasetContentDeliveryDestination
    :: DatasetContentDeliveryDestination
datasetContentDeliveryDestination
  = DatasetContentDeliveryDestination'{_dcddS3DestinationConfiguration
                                         = Nothing,
                                       _dcddIotEventsDestinationConfiguration =
                                         Nothing}
