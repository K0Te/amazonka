...
newtype DeltaTimeSessionWindowConfiguration = DeltaTimeSessionWindowConfiguration'{_dtswcTimeoutInMinutes
                                                                                   ::
                                                                                   Nat}
...
deltaTimeSessionWindowConfiguration
    :: Natural -- ^ 'dtswcTimeoutInMinutes'
    -> DeltaTimeSessionWindowConfiguration
deltaTimeSessionWindowConfiguration
  pTimeoutInMinutes_
  = DeltaTimeSessionWindowConfiguration'{_dtswcTimeoutInMinutes
...
instance FromJSON DeltaTimeSessionWindowConfiguration
         where
        parseJSON
          = withObject "DeltaTimeSessionWindowConfiguration"
              (\ x ->
                 DeltaTimeSessionWindowConfiguration' <$>
                   (x .: "timeoutInMinutes"))
...
instance ToJSON DeltaTimeSessionWindowConfiguration
         where
