...
--
-- * 'dsFileFormatType' - The file format of the data in the data store.
--
...
dsFileFormatType :: Lens' DatastoreSummary (Maybe FileFormatType)
dsFileFormatType = lens _dsFileFormatType (\ s a -> s{_dsFileFormatType = a})
