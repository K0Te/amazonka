...
data CustomerManagedChannelS3StorageSummary = CustomerManagedChannelS3StorageSummary'{_cmcsssBucket
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
                                                                                      _cmcsssKeyPrefix
...
customerManagedChannelS3StorageSummary
    :: CustomerManagedChannelS3StorageSummary
customerManagedChannelS3StorageSummary
  = CustomerManagedChannelS3StorageSummary'{_cmcsssBucket
                                              = Nothing,
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "CustomerManagedChannelS3StorageSummary"
              (\ x ->
                 CustomerManagedChannelS3StorageSummary' <$>
                   (x .:? "bucket") <*> (x .:? "keyPrefix") <*>
                     (x .:? "roleArn"))
