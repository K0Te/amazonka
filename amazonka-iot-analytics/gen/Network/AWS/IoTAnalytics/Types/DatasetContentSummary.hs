...
data DatasetContentSummary = DatasetContentSummary'{_dcsCreationTime
                                                    :: !(Maybe POSIX),
                                                    _dcsStatus ::
                                                    !(Maybe
...
datasetContentSummary
    :: DatasetContentSummary
datasetContentSummary
  = DatasetContentSummary'{_dcsCreationTime = Nothing,
                           _dcsStatus = Nothing, _dcsScheduleTime = Nothing,
                           _dcsCompletionTime = Nothing, _dcsVersion = Nothing}
