...
data ContainerDatasetAction = ContainerDatasetAction'{_cdaVariables
                                                      :: !(Maybe [Variable]),
                                                      _cdaImage :: !Text,
...
containerDatasetAction
    ...
    -> ContainerDatasetAction
containerDatasetAction pImage_ pExecutionRoleARN_
  pResourceConfiguration_
  = ContainerDatasetAction'{_cdaVariables = Nothing,
                            _cdaImage = pImage_,
