...
data DeviceRegistryEnrichActivity = DeviceRegistryEnrichActivity'{_dreaNext
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _dreaName ::
                                                                  !Text,
...
deviceRegistryEnrichActivity
    ...
    -> Text -- ^ 'dreaRoleARN'
    -> DeviceRegistryEnrichActivity
deviceRegistryEnrichActivity pName_ pAttribute_
  pThingName_ pRoleARN_
  = DeviceRegistryEnrichActivity'{_dreaNext = Nothing,
                                  _dreaName = pName_,
