...
data DatastoreStorage = DatastoreStorage'{_dsServiceManagedS3
                                          ::
                                          !(Maybe
...
datastoreStorage
    :: DatastoreStorage
datastoreStorage
  = DatastoreStorage'{_dsServiceManagedS3 = Nothing,
...
instance FromJSON DatastoreStorage where
        parseJSON
          = withObject "DatastoreStorage"
              (\ x ->
                 DatastoreStorage' <$>
                   (x .:? "serviceManagedS3") <*>
                     (x .:? "customerManagedS3"))

instance Hashable DatastoreStorage where

instance NFData DatastoreStorage where
