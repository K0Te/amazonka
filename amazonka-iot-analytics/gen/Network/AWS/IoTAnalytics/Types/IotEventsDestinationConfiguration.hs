...
data IotEventsDestinationConfiguration = IotEventsDestinationConfiguration'{_iedcInputName
                                                                            ::
                                                                            !Text,
                                                                            _iedcRoleARN
                                                                            ::
...
iotEventsDestinationConfiguration
    ...
    -> Text -- ^ 'iedcRoleARN'
    -> IotEventsDestinationConfiguration
iotEventsDestinationConfiguration pInputName_
  pRoleARN_
  = IotEventsDestinationConfiguration'{_iedcInputName =
                                         pInputName_,
