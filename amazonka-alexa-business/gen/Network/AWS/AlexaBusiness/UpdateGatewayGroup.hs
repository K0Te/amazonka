...
data UpdateGatewayGroup = UpdateGatewayGroup'{_uggName
                                              :: !(Maybe Text),
...
updateGatewayGroup
    :: Text -- ^ 'uggGatewayGroupARN'
    -> UpdateGatewayGroup
updateGatewayGroup pGatewayGroupARN_
  = UpdateGatewayGroup'{_uggName = Nothing,
...
instance Hashable UpdateGatewayGroup where

instance NFData UpdateGatewayGroup where
...
newtype UpdateGatewayGroupResponse = UpdateGatewayGroupResponse'{_uggrsResponseStatus
                                                                 :: Int}
...
updateGatewayGroupResponse
    :: Int -- ^ 'uggrsResponseStatus'
    -> UpdateGatewayGroupResponse
updateGatewayGroupResponse pResponseStatus_
  = UpdateGatewayGroupResponse'{_uggrsResponseStatus =
                                  pResponseStatus_}
...
instance NFData UpdateGatewayGroupResponse where
