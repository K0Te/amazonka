...
data ListSkillsStoreSkillsByCategory = ListSkillsStoreSkillsByCategory'{_lsssbcNextToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _lsssbcMaxResults
...
listSkillsStoreSkillsByCategory pCategoryId_
  = ListSkillsStoreSkillsByCategory'{_lsssbcNextToken =
                                       Nothing,
...
data ListSkillsStoreSkillsByCategoryResponse = ListSkillsStoreSkillsByCategoryResponse'{_lsssbcrsNextToken
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
...
listSkillsStoreSkillsByCategoryResponse
  pResponseStatus_
  = ListSkillsStoreSkillsByCategoryResponse'{_lsssbcrsNextToken
                                               = Nothing,
                                             _lsssbcrsSkillsStoreSkills =
                                               Nothing,
                                             _lsssbcrsResponseStatus =
