...
newtype StartSmartHomeApplianceDiscovery = StartSmartHomeApplianceDiscovery'{_sshadRoomARN
                                                                             ::
                                                                             Text}
...
startSmartHomeApplianceDiscovery pRoomARN_
  = StartSmartHomeApplianceDiscovery'{_sshadRoomARN =
                                        pRoomARN_}
...
newtype StartSmartHomeApplianceDiscoveryResponse = StartSmartHomeApplianceDiscoveryResponse'{_sshadrsResponseStatus
                                                                                             ::
                                                                                             Int}
...
startSmartHomeApplianceDiscoveryResponse
  pResponseStatus_
  = StartSmartHomeApplianceDiscoveryResponse'{_sshadrsResponseStatus
                                                = pResponseStatus_}
