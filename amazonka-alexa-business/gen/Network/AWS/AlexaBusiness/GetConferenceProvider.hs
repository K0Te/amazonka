...
newtype GetConferenceProvider = GetConferenceProvider'{_gcpConferenceProviderARN
                                                       :: Text}
...
getConferenceProvider pConferenceProviderARN_
  = GetConferenceProvider'{_gcpConferenceProviderARN =
...
data GetConferenceProviderResponse = GetConferenceProviderResponse'{_grsConferenceProvider
                                                                    ::
                                                                    !(Maybe
                                                                        ConferenceProvider),
                                                                    _grsResponseStatus
...
getConferenceProviderResponse pResponseStatus_
  = GetConferenceProviderResponse'{_grsConferenceProvider
                                     = Nothing,
