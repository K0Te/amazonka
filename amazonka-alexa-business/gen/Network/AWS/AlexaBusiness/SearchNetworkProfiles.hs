...
data SearchNetworkProfiles = SearchNetworkProfiles'{_snpFilters
                                                    :: !(Maybe [Filter]),
                                                    _snpSortCriteria ::
                                                    !(Maybe [Sort]),
                                                    _snpNextToken ::
...
searchNetworkProfiles
    :: SearchNetworkProfiles
searchNetworkProfiles
  = SearchNetworkProfiles'{_snpFilters = Nothing,
                           _snpSortCriteria = Nothing, _snpNextToken = Nothing,
...
instance Hashable SearchNetworkProfiles where

instance NFData SearchNetworkProfiles where
...
data SearchNetworkProfilesResponse = SearchNetworkProfilesResponse'{_snprsNetworkProfiles
                                                                    ::
                                                                    !(Maybe
                                                                        [NetworkProfileData]),
                                                                    _snprsNextToken
...
searchNetworkProfilesResponse
    :: Int -- ^ 'snprsResponseStatus'
    -> SearchNetworkProfilesResponse
searchNetworkProfilesResponse pResponseStatus_
  = SearchNetworkProfilesResponse'{_snprsNetworkProfiles
                                     = Nothing,
...
instance NFData SearchNetworkProfilesResponse where
