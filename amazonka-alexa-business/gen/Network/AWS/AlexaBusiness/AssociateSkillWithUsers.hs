...
newtype AssociateSkillWithUsers = AssociateSkillWithUsers'{_aswuSkillId
                                                           :: Text}
...
newtype AssociateSkillWithUsersResponse = AssociateSkillWithUsersResponse'{_aswursResponseStatus
                                                                           ::
                                                                           Int}
...
associateSkillWithUsersResponse pResponseStatus_
  = AssociateSkillWithUsersResponse'{_aswursResponseStatus
                                       = pResponseStatus_}
