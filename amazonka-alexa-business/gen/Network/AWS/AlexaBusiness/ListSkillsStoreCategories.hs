...
data ListSkillsStoreCategories = ListSkillsStoreCategories'{_lsscNextToken
                                                            :: !(Maybe Text),
                                                            _lsscMaxResults ::
                                                            !(Maybe Nat)}
...
listSkillsStoreCategories
    :: ListSkillsStoreCategories
listSkillsStoreCategories
  = ListSkillsStoreCategories'{_lsscNextToken =
                                 Nothing,
...
data ListSkillsStoreCategoriesResponse = ListSkillsStoreCategoriesResponse'{_lsscrsCategoryList
                                                                            ::
                                                                            !(Maybe
                                                                                [Category]),
                                                                            _lsscrsNextToken
...
listSkillsStoreCategoriesResponse pResponseStatus_
  = ListSkillsStoreCategoriesResponse'{_lsscrsCategoryList
                                         = Nothing,
