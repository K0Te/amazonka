...
data ListConferenceProviders = ListConferenceProviders'{_lcpNextToken
                                                        :: !(Maybe Text),
                                                        _lcpMaxResults ::
                                                        !(Maybe Nat)}
...
listConferenceProviders
    :: ListConferenceProviders
listConferenceProviders
  = ListConferenceProviders'{_lcpNextToken = Nothing,
...
data ListConferenceProvidersResponse = ListConferenceProvidersResponse'{_lcprsConferenceProviders
                                                                        ::
                                                                        !(Maybe
                                                                            [ConferenceProvider]),
                                                                        _lcprsNextToken
...
listConferenceProvidersResponse pResponseStatus_
  = ListConferenceProvidersResponse'{_lcprsConferenceProviders
                                       = Nothing,
