...
data DeleteSkillAuthorization = DeleteSkillAuthorization'{_dsaRoomARN
                                                          :: !(Maybe Text),
                                                          _dsaSkillId :: !Text}
...
deleteSkillAuthorization pSkillId_
  = DeleteSkillAuthorization'{_dsaRoomARN = Nothing,
...
newtype DeleteSkillAuthorizationResponse = DeleteSkillAuthorizationResponse'{_dsarsResponseStatus
                                                                             ::
                                                                             Int}
...
deleteSkillAuthorizationResponse pResponseStatus_
  = DeleteSkillAuthorizationResponse'{_dsarsResponseStatus
                                        = pResponseStatus_}
