...
data CreateNetworkProfile = CreateNetworkProfile'{_cnpCurrentPassword
...
createNetworkProfile
    :: Text -- ^ 'cnpNetworkProfileName'
    -> Text -- ^ 'cnpSsid'
    -> NetworkSecurityType -- ^ 'cnpSecurityType'
    -> Text -- ^ 'cnpClientRequestToken'
    -> CreateNetworkProfile
createNetworkProfile pNetworkProfileName_ pSsid_
  pSecurityType_ pClientRequestToken_
  = CreateNetworkProfile'{_cnpCurrentPassword =
                            Nothing,
                          _cnpNextPassword = Nothing, _cnpEapMethod = Nothing,
                          ...
                          _cnpSsid = pSsid_, _cnpSecurityType = pSecurityType_,
...
data CreateNetworkProfileResponse = CreateNetworkProfileResponse'{_cnprsNetworkProfileARN
                                                                  ::
                                                                  !(Maybe Text),
...
createNetworkProfileResponse pResponseStatus_
  = CreateNetworkProfileResponse'{_cnprsNetworkProfileARN
                                    = Nothing,
