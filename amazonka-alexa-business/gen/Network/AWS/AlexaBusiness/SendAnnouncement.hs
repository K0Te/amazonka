...
data SendAnnouncement = SendAnnouncement'{_saTimeToLiveInSeconds
                                          :: !(Maybe Nat),
...
sendAnnouncement
    :: Content -- ^ 'saContent'
    -> Text -- ^ 'saClientRequestToken'
    -> SendAnnouncement
sendAnnouncement pContent_ pClientRequestToken_
  = SendAnnouncement'{_saTimeToLiveInSeconds = Nothing,
                      _saRoomFilters = mempty, _saContent = pContent_,
...
instance Hashable SendAnnouncement where

instance NFData SendAnnouncement where
...
data SendAnnouncementResponse = SendAnnouncementResponse'{_sarsAnnouncementARN
                                                          :: !(Maybe Text),
                                                          _sarsResponseStatus ::
                                                          !Int}
...
sendAnnouncementResponse pResponseStatus_
  = SendAnnouncementResponse'{_sarsAnnouncementARN =
                                Nothing,
...
instance NFData SendAnnouncementResponse where
