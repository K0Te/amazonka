...
data ListGateways = ListGateways'{_lgNextToken ::
                                  !(Maybe Text),
...
listGateways
    :: ListGateways
listGateways
  = ListGateways'{_lgNextToken = Nothing,
...
data ListGatewaysResponse = ListGatewaysResponse'{_lgrsNextToken
                                                  :: !(Maybe Text),
                                                  _lgrsGateways ::
...
listGatewaysResponse pResponseStatus_
  = ListGatewaysResponse'{_lgrsNextToken = Nothing,
