...
data DisassociateSkillFromSkillGroup = DisassociateSkillFromSkillGroup'{_dsfsgSkillGroupARN
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _dsfsgSkillId
...
disassociateSkillFromSkillGroup pSkillId_
  = DisassociateSkillFromSkillGroup'{_dsfsgSkillGroupARN
                                       = Nothing,
...
newtype DisassociateSkillFromSkillGroupResponse = DisassociateSkillFromSkillGroupResponse'{_dsfsgrsResponseStatus
                                                                                           ::
                                                                                           Int}
...
disassociateSkillFromSkillGroupResponse
  pResponseStatus_
  = DisassociateSkillFromSkillGroupResponse'{_dsfsgrsResponseStatus
                                               = pResponseStatus_}
