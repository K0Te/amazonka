...
newtype ApproveSkill = ApproveSkill'{_asSkillId ::
                                     Text}
...
instance Hashable ApproveSkill where

instance NFData ApproveSkill where
...
newtype ApproveSkillResponse = ApproveSkillResponse'{_asrsResponseStatus
                                                     :: Int}
...
approveSkillResponse pResponseStatus_
  = ApproveSkillResponse'{_asrsResponseStatus =
                            pResponseStatus_}
...
instance NFData ApproveSkillResponse where
