...
data ListGatewayGroups = ListGatewayGroups'{_lggNextToken
                                            :: !(Maybe Text),
...
listGatewayGroups
    :: ListGatewayGroups
listGatewayGroups
  = ListGatewayGroups'{_lggNextToken = Nothing,
...
instance Hashable ListGatewayGroups where

instance NFData ListGatewayGroups where
...
data ListGatewayGroupsResponse = ListGatewayGroupsResponse'{_lggrsGatewayGroups
                                                            ::
                                                            !(Maybe
                                                                [GatewayGroupSummary]),
                                                            _lggrsNextToken ::
                                                            !(Maybe Text),
                                                            _lggrsResponseStatus
                                                            :: !Int}
...
listGatewayGroupsResponse
    :: Int -- ^ 'lggrsResponseStatus'
    -> ListGatewayGroupsResponse
listGatewayGroupsResponse pResponseStatus_
  = ListGatewayGroupsResponse'{_lggrsGatewayGroups =
                                 Nothing,
...
instance NFData ListGatewayGroupsResponse where
