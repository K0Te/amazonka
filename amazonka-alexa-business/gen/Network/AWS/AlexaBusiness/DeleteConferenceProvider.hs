...
newtype DeleteConferenceProvider = DeleteConferenceProvider'{_dcpConferenceProviderARN
                                                             :: Text}
...
deleteConferenceProvider pConferenceProviderARN_
  = DeleteConferenceProvider'{_dcpConferenceProviderARN
...
newtype DeleteConferenceProviderResponse = DeleteConferenceProviderResponse'{_dcprsResponseStatus
                                                                             ::
                                                                             Int}
...
deleteConferenceProviderResponse pResponseStatus_
  = DeleteConferenceProviderResponse'{_dcprsResponseStatus
                                        = pResponseStatus_}
