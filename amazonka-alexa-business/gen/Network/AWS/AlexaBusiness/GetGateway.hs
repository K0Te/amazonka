...
newtype GetGateway = GetGateway'{_ggGatewayARN ::
                                 Text}
...
instance Hashable GetGateway where

instance NFData GetGateway where
...
data GetGatewayResponse = GetGatewayResponse'{_ggrsGateway
                                              :: !(Maybe Gateway),
...
getGatewayResponse pResponseStatus_
  = GetGatewayResponse'{_ggrsGateway = Nothing,
