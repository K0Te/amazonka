...
data UpdateNetworkProfile = UpdateNetworkProfile'{_unpNetworkProfileName
                                                  :: !(Maybe Text),
                                                  _unpCurrentPassword ::
...
updateNetworkProfile
    :: Text -- ^ 'unpNetworkProfileARN'
    -> UpdateNetworkProfile
updateNetworkProfile pNetworkProfileARN_
  = UpdateNetworkProfile'{_unpNetworkProfileName =
                            Nothing,
...
newtype UpdateNetworkProfileResponse = UpdateNetworkProfileResponse'{_unprsResponseStatus
                                                                     :: Int}
...
updateNetworkProfileResponse pResponseStatus_
  = UpdateNetworkProfileResponse'{_unprsResponseStatus
                                    = pResponseStatus_}
