...
newtype PutConferencePreference = PutConferencePreference'{_pcpConferencePreference
                                                           ::
...
putConferencePreference pConferencePreference_
  = PutConferencePreference'{_pcpConferencePreference =
...
newtype PutConferencePreferenceResponse = PutConferencePreferenceResponse'{_pcprsResponseStatus
                                                                           ::
                                                                           Int}
...
putConferencePreferenceResponse pResponseStatus_
  = PutConferencePreferenceResponse'{_pcprsResponseStatus
                                       = pResponseStatus_}
