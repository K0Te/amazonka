...
data UpdateGateway = UpdateGateway'{_ugName ::
                                    !(Maybe Text),
...
instance Hashable UpdateGateway where

instance NFData UpdateGateway where
...
newtype UpdateGatewayResponse = UpdateGatewayResponse'{_ugrsResponseStatus
                                                       :: Int}
...
updateGatewayResponse pResponseStatus_
  = UpdateGatewayResponse'{_ugrsResponseStatus =
                             pResponseStatus_}
