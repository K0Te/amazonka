...
data AssociateDeviceWithNetworkProfile = AssociateDeviceWithNetworkProfile'{_adwnpDeviceARN
                                                                            ::
                                                                            !Text,
...
associateDeviceWithNetworkProfile
    :: Text -- ^ 'adwnpDeviceARN'
    -> Text -- ^ 'adwnpNetworkProfileARN'
    -> AssociateDeviceWithNetworkProfile
associateDeviceWithNetworkProfile pDeviceARN_
  pNetworkProfileARN_
  = AssociateDeviceWithNetworkProfile'{_adwnpDeviceARN
                                         = pDeviceARN_,
                                       _adwnpNetworkProfileARN =
                                         pNetworkProfileARN_}
...
instance AWSRequest AssociateDeviceWithNetworkProfile
         where
...
instance ToHeaders AssociateDeviceWithNetworkProfile
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON AssociateDeviceWithNetworkProfile
         where
...
instance ToPath AssociateDeviceWithNetworkProfile
         where
        toPath = const "/"

instance ToQuery AssociateDeviceWithNetworkProfile
         where
        toQuery = const mempty

-- | /See:/ 'associateDeviceWithNetworkProfileResponse' smart constructor.
newtype AssociateDeviceWithNetworkProfileResponse = AssociateDeviceWithNetworkProfileResponse'{_adwnprsResponseStatus
                                                                                               ::
                                                                                               Int}
...
associateDeviceWithNetworkProfileResponse
    :: Int -- ^ 'adwnprsResponseStatus'
    -> AssociateDeviceWithNetworkProfileResponse
associateDeviceWithNetworkProfileResponse
  pResponseStatus_
  = AssociateDeviceWithNetworkProfileResponse'{_adwnprsResponseStatus
                                                 = pResponseStatus_}
