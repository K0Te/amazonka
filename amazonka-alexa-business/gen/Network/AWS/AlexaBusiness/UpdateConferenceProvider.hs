...
data UpdateConferenceProvider = UpdateConferenceProvider'{_ucpPSTNDialIn
                                                          ::
                                                          !(Maybe PSTNDialIn),
                                                          _ucpIPDialIn ::
                                                          !(Maybe IPDialIn),
...
updateConferenceProvider
    ...
    -> UpdateConferenceProvider
updateConferenceProvider pConferenceProviderARN_
  pConferenceProviderType_ pMeetingSetting_
  = UpdateConferenceProvider'{_ucpPSTNDialIn = Nothing,
...
newtype UpdateConferenceProviderResponse = UpdateConferenceProviderResponse'{_ucprsResponseStatus
                                                                             ::
                                                                             Int}
...
updateConferenceProviderResponse pResponseStatus_
  = UpdateConferenceProviderResponse'{_ucprsResponseStatus
                                        = pResponseStatus_}
