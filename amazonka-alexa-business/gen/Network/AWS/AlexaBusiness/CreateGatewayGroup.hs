...
data CreateGatewayGroup = CreateGatewayGroup'{_cggDescription
                                              :: !(Maybe Text),
                                              _cggName :: !Text,
...
createGatewayGroup
    :: Text -- ^ 'cggName'
    -> Text -- ^ 'cggClientRequestToken'
    -> CreateGatewayGroup
createGatewayGroup pName_ pClientRequestToken_
  = CreateGatewayGroup'{_cggDescription = Nothing,
                        _cggName = pName_,
...
instance Hashable CreateGatewayGroup where

instance NFData CreateGatewayGroup where
...
data CreateGatewayGroupResponse = CreateGatewayGroupResponse'{_cggrsGatewayGroupARN
                                                              :: !(Maybe Text),
                                                              _cggrsResponseStatus
                                                              :: !Int}
...
createGatewayGroupResponse
    :: Int -- ^ 'cggrsResponseStatus'
    -> CreateGatewayGroupResponse
createGatewayGroupResponse pResponseStatus_
  = CreateGatewayGroupResponse'{_cggrsGatewayGroupARN =
                                  Nothing,
...
instance NFData CreateGatewayGroupResponse where
