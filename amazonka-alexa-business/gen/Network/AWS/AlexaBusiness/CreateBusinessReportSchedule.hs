...
data CreateBusinessReportSchedule = CreateBusinessReportSchedule'{_cbrsS3KeyPrefix
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _cbrsRecurrence
                                                                  ::
...
data CreateBusinessReportScheduleResponse = CreateBusinessReportScheduleResponse'{_cbrsrsScheduleARN
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
createBusinessReportScheduleResponse pResponseStatus_
  = CreateBusinessReportScheduleResponse'{_cbrsrsScheduleARN
                                            = Nothing,
                                          _cbrsrsResponseStatus =
                                            pResponseStatus_}
