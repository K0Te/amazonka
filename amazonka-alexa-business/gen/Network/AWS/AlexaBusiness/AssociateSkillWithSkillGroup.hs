...
data AssociateSkillWithSkillGroup = AssociateSkillWithSkillGroup'{_aswsgSkillGroupARN
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _aswsgSkillId
                                                                  :: !Text}
...
associateSkillWithSkillGroup pSkillId_
  = AssociateSkillWithSkillGroup'{_aswsgSkillGroupARN =
                                    Nothing,
...
newtype AssociateSkillWithSkillGroupResponse = AssociateSkillWithSkillGroupResponse'{_aswsgrsResponseStatus
                                                                                     ::
                                                                                     Int}
...
associateSkillWithSkillGroupResponse pResponseStatus_
  = AssociateSkillWithSkillGroupResponse'{_aswsgrsResponseStatus
                                            = pResponseStatus_}
