...
data DeleteDeviceUsageData = DeleteDeviceUsageData'{_ddudDeviceARN
                                                    :: !Text,
...
deleteDeviceUsageData
    :: Text -- ^ 'ddudDeviceARN'
    -> DeviceUsageType -- ^ 'ddudDeviceUsageType'
    -> DeleteDeviceUsageData
deleteDeviceUsageData pDeviceARN_ pDeviceUsageType_
  = DeleteDeviceUsageData'{_ddudDeviceARN =
                             pDeviceARN_,
...
instance Hashable DeleteDeviceUsageData where

instance NFData DeleteDeviceUsageData where
...
newtype DeleteDeviceUsageDataResponse = DeleteDeviceUsageDataResponse'{_ddudrsResponseStatus
                                                                       :: Int}
...
deleteDeviceUsageDataResponse
    :: Int -- ^ 'ddudrsResponseStatus'
    -> DeleteDeviceUsageDataResponse
deleteDeviceUsageDataResponse pResponseStatus_
  = DeleteDeviceUsageDataResponse'{_ddudrsResponseStatus
                                     = pResponseStatus_}
...
instance NFData DeleteDeviceUsageDataResponse where
