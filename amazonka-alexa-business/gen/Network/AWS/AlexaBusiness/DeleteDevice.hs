...
newtype DeleteDevice = DeleteDevice'{_delDeviceARN ::
                                     Text}
...
instance Hashable DeleteDevice where

instance NFData DeleteDevice where
...
newtype DeleteDeviceResponse = DeleteDeviceResponse'{_ddrsResponseStatus
                                                     :: Int}
...
deleteDeviceResponse pResponseStatus_
  = DeleteDeviceResponse'{_ddrsResponseStatus =
                            pResponseStatus_}
...
instance NFData DeleteDeviceResponse where
