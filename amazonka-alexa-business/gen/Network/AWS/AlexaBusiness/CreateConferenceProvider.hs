...
data CreateConferenceProvider = CreateConferenceProvider'{_ccpPSTNDialIn
                                                          ::
                                                          !(Maybe PSTNDialIn),
...
createConferenceProvider
    ...
    -> CreateConferenceProvider
createConferenceProvider pConferenceProviderName_
  pConferenceProviderType_ pMeetingSetting_
  = CreateConferenceProvider'{_ccpPSTNDialIn = Nothing,
...
data CreateConferenceProviderResponse = CreateConferenceProviderResponse'{_ccprsConferenceProviderARN
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
createConferenceProviderResponse pResponseStatus_
  = CreateConferenceProviderResponse'{_ccprsConferenceProviderARN
                                        = Nothing,
