...
newtype DeleteBusinessReportSchedule = DeleteBusinessReportSchedule'{_dbrsScheduleARN
                                                                     :: Text}
...
deleteBusinessReportSchedule pScheduleARN_
  = DeleteBusinessReportSchedule'{_dbrsScheduleARN =
                                    pScheduleARN_}
...
newtype DeleteBusinessReportScheduleResponse = DeleteBusinessReportScheduleResponse'{_dbrsrsResponseStatus
                                                                                     ::
                                                                                     Int}
                                                 deriving (Eq, Read, Show, Data,
                                                           Typeable, Generic)
...
deleteBusinessReportScheduleResponse pResponseStatus_
  = DeleteBusinessReportScheduleResponse'{_dbrsrsResponseStatus
                                            = pResponseStatus_}
