...
data RegisterAVSDevice = RegisterAVSDevice'{_ravsdRoomARN
                                            :: !(Maybe Text),
...
--
-- * 'ravsdRoomARN' - The ARN of the room with which to associate your AVS device.
--
...
registerAVSDevice
    ...
    -> Text -- ^ 'ravsdAmazonId'
    -> RegisterAVSDevice
registerAVSDevice pClientId_ pUserCode_ pProductId_
  pAmazonId_
  = RegisterAVSDevice'{_ravsdRoomARN = Nothing,
...
data RegisterAVSDeviceResponse = RegisterAVSDeviceResponse'{_ravsdrsDeviceARN
                                                            :: !(Maybe Text),
                                                            _ravsdrsResponseStatus
                                                            :: !Int}
...
registerAVSDeviceResponse pResponseStatus_
  = RegisterAVSDeviceResponse'{_ravsdrsDeviceARN =
                                 Nothing,
                               _ravsdrsResponseStatus = pResponseStatus_}
