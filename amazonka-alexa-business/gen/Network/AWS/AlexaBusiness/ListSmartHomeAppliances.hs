...
data ListSmartHomeAppliances = ListSmartHomeAppliances'{_lshaNextToken
                                                        :: !(Maybe Text),
                                                        _lshaMaxResults ::
                                                        !(Maybe Nat),
                                                        _lshaRoomARN :: !Text}
...
listSmartHomeAppliances pRoomARN_
  = ListSmartHomeAppliances'{_lshaNextToken = Nothing,
...
data ListSmartHomeAppliancesResponse = ListSmartHomeAppliancesResponse'{_lsharsSmartHomeAppliances
                                                                        ::
                                                                        !(Maybe
                                                                            [SmartHomeAppliance]),
                                                                        _lsharsNextToken
...
listSmartHomeAppliancesResponse pResponseStatus_
  = ListSmartHomeAppliancesResponse'{_lsharsSmartHomeAppliances
                                       = Nothing,
