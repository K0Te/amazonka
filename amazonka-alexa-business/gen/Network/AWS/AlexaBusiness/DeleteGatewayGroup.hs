...
newtype DeleteGatewayGroup = DeleteGatewayGroup'{_dggGatewayGroupARN
                                                 :: Text}
...
deleteGatewayGroup
    :: Text -- ^ 'dggGatewayGroupARN'
    -> DeleteGatewayGroup
deleteGatewayGroup pGatewayGroupARN_
  = DeleteGatewayGroup'{_dggGatewayGroupARN =
                          pGatewayGroupARN_}
...
instance Hashable DeleteGatewayGroup where

instance NFData DeleteGatewayGroup where
...
newtype DeleteGatewayGroupResponse = DeleteGatewayGroupResponse'{_dggrsResponseStatus
                                                                 :: Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
deleteGatewayGroupResponse
    :: Int -- ^ 'dggrsResponseStatus'
    -> DeleteGatewayGroupResponse
deleteGatewayGroupResponse pResponseStatus_
  = DeleteGatewayGroupResponse'{_dggrsResponseStatus =
                                  pResponseStatus_}
...
instance NFData DeleteGatewayGroupResponse where
