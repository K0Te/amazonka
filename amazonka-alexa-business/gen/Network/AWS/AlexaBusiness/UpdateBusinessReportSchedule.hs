...
data UpdateBusinessReportSchedule = UpdateBusinessReportSchedule'{_ubrsS3KeyPrefix
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _ubrsFormat ::
                                                                  !(Maybe
...
updateBusinessReportSchedule pScheduleARN_
  = UpdateBusinessReportSchedule'{_ubrsS3KeyPrefix =
                                    Nothing,
                                  _ubrsFormat = Nothing,
...
newtype UpdateBusinessReportScheduleResponse = UpdateBusinessReportScheduleResponse'{_ubrsrsResponseStatus
                                                                                     ::
                                                                                     Int}
...
updateBusinessReportScheduleResponse pResponseStatus_
  = UpdateBusinessReportScheduleResponse'{_ubrsrsResponseStatus
                                            = pResponseStatus_}
