...
data ListBusinessReportSchedules = ListBusinessReportSchedules'{_lbrsNextToken
                                                                ::
                                                                !(Maybe Text),
                                                                _lbrsMaxResults
                                                                :: !(Maybe Nat)}
...
listBusinessReportSchedules
    :: ListBusinessReportSchedules
listBusinessReportSchedules
  = ListBusinessReportSchedules'{_lbrsNextToken =
                                   Nothing,
...
data ListBusinessReportSchedulesResponse = ListBusinessReportSchedulesResponse'{_lbrsrsBusinessReportSchedules
                                                                                ::
                                                                                !(Maybe
...
listBusinessReportSchedulesResponse pResponseStatus_
  = ListBusinessReportSchedulesResponse'{_lbrsrsBusinessReportSchedules
                                           = Nothing,
