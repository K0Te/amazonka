...
data PutSkillAuthorization = PutSkillAuthorization'{_psaRoomARN
                                                    :: !(Maybe Text),
...
putSkillAuthorization pSkillId_
  = PutSkillAuthorization'{_psaRoomARN = Nothing,
...
newtype PutSkillAuthorizationResponse = PutSkillAuthorizationResponse'{_psarsResponseStatus
                                                                       :: Int}
...
putSkillAuthorizationResponse pResponseStatus_
  = PutSkillAuthorizationResponse'{_psarsResponseStatus
                                     = pResponseStatus_}
