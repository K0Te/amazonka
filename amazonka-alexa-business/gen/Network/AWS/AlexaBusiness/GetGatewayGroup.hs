...
newtype GetGatewayGroup = GetGatewayGroup'{_gggGatewayGroupARN
                                           :: Text}
...
getGatewayGroup
    :: Text -- ^ 'gggGatewayGroupARN'
    -> GetGatewayGroup
getGatewayGroup pGatewayGroupARN_
  = GetGatewayGroup'{_gggGatewayGroupARN =
                       pGatewayGroupARN_}
...
instance Hashable GetGatewayGroup where

instance NFData GetGatewayGroup where
...
data GetGatewayGroupResponse = GetGatewayGroupResponse'{_gggrsGatewayGroup
                                                        ::
                                                        !(Maybe GatewayGroup),
                                                        _gggrsResponseStatus ::
                                                        !Int}
...
getGatewayGroupResponse
    :: Int -- ^ 'gggrsResponseStatus'
    -> GetGatewayGroupResponse
getGatewayGroupResponse pResponseStatus_
  = GetGatewayGroupResponse'{_gggrsGatewayGroup =
                               Nothing,
...
instance NFData GetGatewayGroupResponse where
