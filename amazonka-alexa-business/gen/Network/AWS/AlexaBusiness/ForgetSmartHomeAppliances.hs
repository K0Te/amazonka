...
newtype ForgetSmartHomeAppliances = ForgetSmartHomeAppliances'{_fshaRoomARN
                                                               :: Text}
...
forgetSmartHomeAppliances pRoomARN_
  = ForgetSmartHomeAppliances'{_fshaRoomARN =
                                 pRoomARN_}
...
newtype ForgetSmartHomeAppliancesResponse = ForgetSmartHomeAppliancesResponse'{_fsharsResponseStatus
                                                                               ::
                                                                               Int}
...
forgetSmartHomeAppliancesResponse pResponseStatus_
  = ForgetSmartHomeAppliancesResponse'{_fsharsResponseStatus
                                         = pResponseStatus_}
