...
newtype DisassociateSkillFromUsers = DisassociateSkillFromUsers'{_dsfuSkillId
                                                                 :: Text}
...
disassociateSkillFromUsers pSkillId_
  = DisassociateSkillFromUsers'{_dsfuSkillId =
                                  pSkillId_}
...
newtype DisassociateSkillFromUsersResponse = DisassociateSkillFromUsersResponse'{_dsfursResponseStatus
                                                                                 ::
                                                                                 Int}
...
disassociateSkillFromUsersResponse pResponseStatus_
  = DisassociateSkillFromUsersResponse'{_dsfursResponseStatus
                                          = pResponseStatus_}
