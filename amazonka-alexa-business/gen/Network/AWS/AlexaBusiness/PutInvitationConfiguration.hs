...
data PutInvitationConfiguration = PutInvitationConfiguration'{_picContactEmail
                                                              :: !(Maybe Text),
                                                              _picPrivateSkillIds
                                                              ::
                                                              !(Maybe [Text]),
...
putInvitationConfiguration pOrganizationName_
  = PutInvitationConfiguration'{_picContactEmail =
                                  Nothing,
...
newtype PutInvitationConfigurationResponse = PutInvitationConfigurationResponse'{_picrsResponseStatus
                                                                                 ::
                                                                                 Int}
...
putInvitationConfigurationResponse pResponseStatus_
  = PutInvitationConfigurationResponse'{_picrsResponseStatus
                                          = pResponseStatus_}
