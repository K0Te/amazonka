...
data GraphqlAPI = GraphqlAPI'{_gaXrayEnabled ::
                              !(Maybe Bool),
                              _gaArn :: !(Maybe Text),
                              _gaApiId :: !(Maybe Text),
...
graphqlAPI
    :: GraphqlAPI
graphqlAPI
  = GraphqlAPI'{_gaXrayEnabled = Nothing,
                _gaArn = Nothing, _gaApiId = Nothing,
                _gaUris = Nothing, _gaOpenIdConnectConfig = Nothing,
                _gaWafWebACLARN = Nothing,
                _gaAdditionalAuthenticationProviders = Nothing,
                _gaName = Nothing, _gaUserPoolConfig = Nothing,
                _gaAuthenticationType = Nothing,
                _gaLogConfig = Nothing, _gaTags = Nothing}
