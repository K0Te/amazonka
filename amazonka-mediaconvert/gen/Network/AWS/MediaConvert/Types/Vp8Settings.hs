...
data Vp8Settings = Vp8Settings'{_vQualityTuningLevel
...
vp8Settings
    :: Vp8Settings
vp8Settings
  = Vp8Settings'{_vQualityTuningLevel = Nothing,
                 _vParNumerator = Nothing, _vGopSize = Nothing,
                 _vHrdBufferSize = Nothing,
                 _vRateControlMode = Nothing, _vParControl = Nothing,
                 _vBitrate = Nothing,
                 ...
                 _vMaxBitrate = Nothing, _vParDenominator = Nothing}
...
instance Hashable Vp8Settings where

instance NFData Vp8Settings where
