...
newtype AudioChannelTaggingSettings = AudioChannelTaggingSettings'{_actsChannelTag
                                                                   ::
                                                                   Maybe
                                                                     AudioChannelTag}
...
audioChannelTaggingSettings
    :: AudioChannelTaggingSettings
audioChannelTaggingSettings
  = AudioChannelTaggingSettings'{_actsChannelTag =
                                   Nothing}
...
instance FromJSON AudioChannelTaggingSettings where
        parseJSON
          = withObject "AudioChannelTaggingSettings"
              (\ x ->
                 AudioChannelTaggingSettings' <$>
                   (x .:? "channelTag"))

instance Hashable AudioChannelTaggingSettings where

instance NFData AudioChannelTaggingSettings where
