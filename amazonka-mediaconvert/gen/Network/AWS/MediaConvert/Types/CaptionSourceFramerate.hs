...
data CaptionSourceFramerate = CaptionSourceFramerate'{_csfFramerateDenominator
                                                      :: !(Maybe Nat),
...
captionSourceFramerate
    :: CaptionSourceFramerate
captionSourceFramerate
  = CaptionSourceFramerate'{_csfFramerateDenominator =
                              Nothing,
...
instance FromJSON CaptionSourceFramerate where
        parseJSON
          = withObject "CaptionSourceFramerate"
              (\ x ->
                 CaptionSourceFramerate' <$>
                   (x .:? "framerateDenominator") <*>
                     (x .:? "framerateNumerator"))

instance Hashable CaptionSourceFramerate where

instance NFData CaptionSourceFramerate where
