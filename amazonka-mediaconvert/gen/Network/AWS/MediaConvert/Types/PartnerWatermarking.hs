...
newtype PartnerWatermarking = PartnerWatermarking'{_pwNexguardFileMarkerSettings
                                                   ::
                                                   Maybe
...
partnerWatermarking
    :: PartnerWatermarking
partnerWatermarking
  = PartnerWatermarking'{_pwNexguardFileMarkerSettings
                           = Nothing}
...
instance FromJSON PartnerWatermarking where
        parseJSON
          = withObject "PartnerWatermarking"
              (\ x ->
                 PartnerWatermarking' <$>
                   (x .:? "nexguardFileMarkerSettings"))

instance Hashable PartnerWatermarking where

instance NFData PartnerWatermarking where
