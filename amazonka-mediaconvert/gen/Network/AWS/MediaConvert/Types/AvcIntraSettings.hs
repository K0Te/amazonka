...
data AvcIntraSettings = AvcIntraSettings'{_aisSlowPal
...
avcIntraSettings
    :: AvcIntraSettings
avcIntraSettings
  = AvcIntraSettings'{_aisSlowPal = Nothing,
                      _aisTelecine = Nothing, _aisInterlaceMode = Nothing,
...
instance FromJSON AvcIntraSettings where
        parseJSON
          = withObject "AvcIntraSettings"
              (\ x ->
                 AvcIntraSettings' <$>
                   (x .:? "slowPal") <*> (x .:? "telecine") <*>
                     (x .:? "interlaceMode")
                     <*> (x .:? "avcIntraClass")
...
instance Hashable AvcIntraSettings where

instance NFData AvcIntraSettings where
