...
data JobSettings = JobSettings'{_jsNielsenNonLinearWatermark
...
jobSettings
    :: JobSettings
jobSettings
  = JobSettings'{_jsNielsenNonLinearWatermark =
                   Nothing,
                 _jsEsam = Nothing, _jsInputs = Nothing,
