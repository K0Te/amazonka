...
data Vc3Settings = Vc3Settings'{_vssSlowPal ::
                                !(Maybe Vc3SlowPal),
...
vc3Settings
    :: Vc3Settings
vc3Settings
  = Vc3Settings'{_vssSlowPal = Nothing,
                 _vssTelecine = Nothing, _vssInterlaceMode = Nothing,
...
instance Hashable Vc3Settings where

instance NFData Vc3Settings where
