...
data AvcIntraFramerateControl = AvcIntraFramerateControl' (CI
                                                             Text)
                                  deriving (Eq, Ord, Read, Show, Data, Typeable,
                                            Generic)

pattern InitializeFromSource :: AvcIntraFramerateControl
pattern InitializeFromSource = AvcIntraFramerateControl' "INITIALIZE_FROM_SOURCE"

pattern Specified :: AvcIntraFramerateControl
pattern Specified = AvcIntraFramerateControl' "SPECIFIED"
