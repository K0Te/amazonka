...
data Vp9Settings = Vp9Settings'{_vsQualityTuningLevel
...
vp9Settings
    :: Vp9Settings
vp9Settings
  = Vp9Settings'{_vsQualityTuningLevel = Nothing,
                 _vsParNumerator = Nothing, _vsGopSize = Nothing,
                 _vsHrdBufferSize = Nothing,
                 _vsRateControlMode = Nothing,
                 _vsParControl = Nothing, _vsBitrate = Nothing,
                 ...
                 _vsMaxBitrate = Nothing, _vsParDenominator = Nothing}
...
instance Hashable Vp9Settings where

instance NFData Vp9Settings where
