...
newtype AutomatedEncodingSettings = AutomatedEncodingSettings'{_aesAbrSettings
                                                               ::
                                                               Maybe
...
automatedEncodingSettings
    :: AutomatedEncodingSettings
automatedEncodingSettings
  = AutomatedEncodingSettings'{_aesAbrSettings =
                                 Nothing}
...
instance FromJSON AutomatedEncodingSettings where
        parseJSON
          = withObject "AutomatedEncodingSettings"
              (\ x ->
                 AutomatedEncodingSettings' <$> (x .:? "abrSettings"))

instance Hashable AutomatedEncodingSettings where

instance NFData AutomatedEncodingSettings where
