...
data JobTemplateSettings = JobTemplateSettings'{_jtsNielsenNonLinearWatermark
                                                ::
                                                !(Maybe
...
jobTemplateSettings
    :: JobTemplateSettings
jobTemplateSettings
  = JobTemplateSettings'{_jtsNielsenNonLinearWatermark
                           = Nothing,
                         _jtsEsam = Nothing, _jtsInputs = Nothing,
