...
data CreateJob = CreateJob'{_cjJobTemplate ::
                            ...
                            _cjRole :: !Text, _cjSettings :: !JobSettings}
...
createJob pRole_ pSettings_
  = CreateJob'{_cjJobTemplate = Nothing,
               ...
               _cjQueue = Nothing, _cjUserMetadata = Nothing,
               _cjBillingTagsSource = Nothing,
               _cjClientRequestToken = Nothing, _cjTags = Nothing,
               _cjRole = pRole_, _cjSettings = pSettings_}
          ...
          = object
              (catMaybes
                 [("jobTemplate" .=) <$> _cjJobTemplate,
                  ...
                  ("tags" .=) <$> _cjTags, Just ("role" .= _cjRole),
