...
data CreateJobTemplate = CreateJobTemplate'{_cjtAccelerationSettings
...
createJobTemplate pSettings_ pName_
  = CreateJobTemplate'{_cjtAccelerationSettings =
                         Nothing,
                       _cjtPriority = Nothing,
                       _cjtStatusUpdateInterval = Nothing,
                       _cjtCategory = Nothing,
                       _cjtHopDestinations = Nothing, _cjtQueue = Nothing,
                       _cjtDescription = Nothing, _cjtTags = Nothing,
                       _cjtSettings = pSettings_, _cjtName = pName_}
