...
newtype DisassociateCertificate = DisassociateCertificate'{_dcARN
                                                           :: Text}
...
newtype DisassociateCertificateResponse = DisassociateCertificateResponse'{_dcrsResponseStatus
                                                                           ::
                                                                           Int}
...
disassociateCertificateResponse pResponseStatus_
  = DisassociateCertificateResponse'{_dcrsResponseStatus
                                       = pResponseStatus_}
