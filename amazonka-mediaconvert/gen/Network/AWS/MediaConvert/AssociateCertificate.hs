...
newtype AssociateCertificate = AssociateCertificate'{_acARN
                                                     :: Text}
...
instance Hashable AssociateCertificate where

instance NFData AssociateCertificate where
...
newtype AssociateCertificateResponse = AssociateCertificateResponse'{_acrsResponseStatus
                                                                     :: Int}
...
associateCertificateResponse pResponseStatus_
  = AssociateCertificateResponse'{_acrsResponseStatus =
                                    pResponseStatus_}
...
instance NFData AssociateCertificateResponse where
