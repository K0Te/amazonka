...
data ListArchives = ListArchives'{_laEventSourceARN
                                  :: !(Maybe Text),
...
listArchives
    :: ListArchives
listArchives
  = ListArchives'{_laEventSourceARN = Nothing,
                  _laState = Nothing, _laNextToken = Nothing,
                  _laNamePrefix = Nothing, _laLimit = Nothing}
...
instance AWSRequest ListArchives where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 ListArchivesResponse' <$>
                   (x .?> "Archives" .!@ mempty) <*> (x .?> "NextToken")
                     <*> (pure (fromEnum s)))

instance Hashable ListArchives where

instance NFData ListArchives where
...
data ListArchivesResponse = ListArchivesResponse'{_larsArchives
                                                  :: !(Maybe [Archive]),
                                                  _larsNextToken ::
                                                  !(Maybe Text),
...
listArchivesResponse pResponseStatus_
  = ListArchivesResponse'{_larsArchives = Nothing,
...
instance NFData ListArchivesResponse where
