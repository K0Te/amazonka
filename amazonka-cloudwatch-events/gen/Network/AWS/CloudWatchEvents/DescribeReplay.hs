...
newtype DescribeReplay = DescribeReplay'{_drReplayName
                                         :: Text}
...
instance AWSRequest DescribeReplay where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribeReplayResponse' <$>
                   (x .?> "EventSourceArn") <*> (x .?> "Destination")
                     <*> (x .?> "State")
                     <*> (x .?> "EventEndTime")
                     <*> (x .?> "ReplayStartTime")
                     <*> (x .?> "ReplayArn")
...
instance Hashable DescribeReplay where

instance NFData DescribeReplay where
...
data DescribeReplayResponse = DescribeReplayResponse'{_drsEventSourceARN
                                                      :: !(Maybe Text),
                                                      _drsDestination ::
                                                      !(Maybe
                                                          ReplayDestination),
...
describeReplayResponse pResponseStatus_
  = DescribeReplayResponse'{_drsEventSourceARN =
                              Nothing,
                            _drsDestination = Nothing, _drsState = Nothing,
                            ...
                            _drsReplayName = Nothing, _drsStateReason = Nothing,
...
instance NFData DescribeReplayResponse where
