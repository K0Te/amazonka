...
data UpdateArchive = UpdateArchive'{_uaEventPattern
                                    :: !(Maybe Text),
...
updateArchive pArchiveName_
  = UpdateArchive'{_uaEventPattern = Nothing,
                   _uaRetentionDays = Nothing, _uaDescription = Nothing,
...
instance Hashable UpdateArchive where

instance NFData UpdateArchive where
...
data UpdateArchiveResponse = UpdateArchiveResponse'{_uarsCreationTime
                                                    :: !(Maybe POSIX),
                                                    _uarsState ::
                                                    !(Maybe ArchiveState),
                                                    _uarsArchiveARN ::
...
updateArchiveResponse pResponseStatus_
  = UpdateArchiveResponse'{_uarsCreationTime = Nothing,
                           _uarsState = Nothing, _uarsArchiveARN = Nothing,
...
instance NFData UpdateArchiveResponse where
