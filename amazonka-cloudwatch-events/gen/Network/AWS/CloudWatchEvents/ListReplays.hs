...
data ListReplays = ListReplays'{_lEventSourceARN ::
                                !(Maybe Text),
...
listReplays
    :: ListReplays
listReplays
  = ListReplays'{_lEventSourceARN = Nothing,
                 _lState = Nothing, _lNextToken = Nothing,
                 _lNamePrefix = Nothing, _lLimit = Nothing}
...
instance AWSRequest ListReplays where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 ListReplaysResponse' <$>
                   (x .?> "Replays" .!@ mempty) <*> (x .?> "NextToken")
                     <*> (pure (fromEnum s)))

instance Hashable ListReplays where

instance NFData ListReplays where
...
data ListReplaysResponse = ListReplaysResponse'{_lrsReplays
                                                :: !(Maybe [Replay]),
...
listReplaysResponse pResponseStatus_
  = ListReplaysResponse'{_lrsReplays = Nothing,
...
instance NFData ListReplaysResponse where
