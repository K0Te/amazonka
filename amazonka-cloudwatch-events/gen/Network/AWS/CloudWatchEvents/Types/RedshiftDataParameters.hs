...
data RedshiftDataParameters = RedshiftDataParameters'{_rdpDBUser
                                                      :: !(Maybe Text),
...
redshiftDataParameters pDatabase_ pSql_
  = RedshiftDataParameters'{_rdpDBUser = Nothing,
                            _rdpSecretManagerARN = Nothing,
                            _rdpStatementName = Nothing,
                            _rdpWithEvent = Nothing, _rdpDatabase = pDatabase_,
                            _rdpSql = pSql_}
...
instance FromJSON RedshiftDataParameters where
        parseJSON
          = withObject "RedshiftDataParameters"
              (\ x ->
                 RedshiftDataParameters' <$>
                   (x .:? "DbUser") <*> (x .:? "SecretManagerArn") <*>
                     (x .:? "StatementName")
                     <*> (x .:? "WithEvent")
                     <*> (x .: "Database")
                     <*> (x .: "Sql"))

instance Hashable RedshiftDataParameters where

instance NFData RedshiftDataParameters where
