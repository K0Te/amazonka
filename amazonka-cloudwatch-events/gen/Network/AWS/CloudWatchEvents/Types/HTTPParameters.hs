...
data HTTPParameters = HTTPParameters'{_httppPathParameterValues
                                      :: !(Maybe [Text]),
...
hTTPParameters
    :: HTTPParameters
hTTPParameters
  = HTTPParameters'{_httppPathParameterValues =
                      Nothing,
...
instance Hashable HTTPParameters where

instance NFData HTTPParameters where
