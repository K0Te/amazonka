...
newtype DeleteArchive = DeleteArchive'{_dArchiveName
                                       :: Text}
...
newtype DeleteArchiveResponse = DeleteArchiveResponse'{_delrsResponseStatus
                                                       :: Int}
...
deleteArchiveResponse pResponseStatus_
  = DeleteArchiveResponse'{_delrsResponseStatus =
                             pResponseStatus_}
