...
newtype CancelReplay = CancelReplay'{_crReplayName ::
                                     Text}
...
instance Hashable CancelReplay where

instance NFData CancelReplay where
...
data CancelReplayResponse = CancelReplayResponse'{_crrsState
                                                  :: !(Maybe ReplayState),
                                                  _crrsReplayARN ::
                                                  !(Maybe Text),
                                                  _crrsStateReason ::
...
cancelReplayResponse pResponseStatus_
  = CancelReplayResponse'{_crrsState = Nothing,
                          _crrsReplayARN = Nothing, _crrsStateReason = Nothing,
...
instance NFData CancelReplayResponse where
