...
newtype DescribeArchive = DescribeArchive'{_daArchiveName
                                           :: Text}
...
instance Hashable DescribeArchive where

instance NFData DescribeArchive where
...
data DescribeArchiveResponse = DescribeArchiveResponse'{_darsCreationTime
                                                        :: !(Maybe POSIX),
                                                        _darsSizeBytes ::
                                                        !(Maybe Integer),
                                                        _darsEventSourceARN ::
...
describeArchiveResponse pResponseStatus_
  = DescribeArchiveResponse'{_darsCreationTime =
                               Nothing,
                             _darsSizeBytes = Nothing,
                             _darsEventSourceARN = Nothing,
                             _darsEventPattern = Nothing, _darsState = Nothing,
...
instance NFData DescribeArchiveResponse where
