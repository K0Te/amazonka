...
data PutConfigurationSetDeliveryOptions = PutConfigurationSetDeliveryOptions'{_pcsdoDeliveryOptions
                                                                              ::
                                                                              !(Maybe
                                                                                  DeliveryOptions),
...
putConfigurationSetDeliveryOptions
    :: Text -- ^ 'pcsdoConfigurationSetName'
    -> PutConfigurationSetDeliveryOptions
putConfigurationSetDeliveryOptions
  pConfigurationSetName_
  = PutConfigurationSetDeliveryOptions'{_pcsdoDeliveryOptions
                                          = Nothing,
                                        _pcsdoConfigurationSetName =
                                          pConfigurationSetName_}
...
instance ToHeaders PutConfigurationSetDeliveryOptions
         where
        toHeaders = const mempty

instance ToPath PutConfigurationSetDeliveryOptions
         where
        toPath = const "/"

instance ToQuery PutConfigurationSetDeliveryOptions
         where
...
newtype PutConfigurationSetDeliveryOptionsResponse = PutConfigurationSetDeliveryOptionsResponse'{_pcsdorsResponseStatus
                                                                                                 ::
                                                                                                 Int}
...
putConfigurationSetDeliveryOptionsResponse
    :: Int -- ^ 'pcsdorsResponseStatus'
    -> PutConfigurationSetDeliveryOptionsResponse
putConfigurationSetDeliveryOptionsResponse
  pResponseStatus_
  = PutConfigurationSetDeliveryOptionsResponse'{_pcsdorsResponseStatus
                                                  = pResponseStatus_}
