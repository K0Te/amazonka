...
data ListPlatformBranches = ListPlatformBranches'{_lpbFilters
                                                  :: !(Maybe [SearchFilter]),
                                                  _lpbNextToken ::
                                                  !(Maybe Text),
                                                  _lpbMaxRecords ::
...
listPlatformBranches
    :: ListPlatformBranches
listPlatformBranches
  = ListPlatformBranches'{_lpbFilters = Nothing,
                          _lpbNextToken = Nothing, _lpbMaxRecords = Nothing}
...
instance AWSRequest ListPlatformBranches where
        type Rs ListPlatformBranches =
             ListPlatformBranchesResponse
        request = postQuery elasticBeanstalk
        response
          = receiveXMLWrapper "ListPlatformBranchesResult"
              (\ s h x ->
                 ListPlatformBranchesResponse' <$>
...
instance Hashable ListPlatformBranches where

instance NFData ListPlatformBranches where
...
data ListPlatformBranchesResponse = ListPlatformBranchesResponse'{_lpbrsPlatformBranchSummaryList
                                                                  ::
                                                                  !(Maybe
...
listPlatformBranchesResponse
    :: Int -- ^ 'lpbrsResponseStatus'
    -> ListPlatformBranchesResponse
listPlatformBranchesResponse pResponseStatus_
  = ListPlatformBranchesResponse'{_lpbrsPlatformBranchSummaryList
                                    = Nothing,
...
instance NFData ListPlatformBranchesResponse where
