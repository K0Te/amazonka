...
data AssociateEnvironmentOperationsRole = AssociateEnvironmentOperationsRole'{_aeorEnvironmentName
                                                                              ::
                                                                              !Text,
                                                                              _aeorOperationsRole
                                                                              ::
...
associateEnvironmentOperationsRole
    :: Text -- ^ 'aeorEnvironmentName'
    -> Text -- ^ 'aeorOperationsRole'
    -> AssociateEnvironmentOperationsRole
associateEnvironmentOperationsRole pEnvironmentName_
  pOperationsRole_
  = AssociateEnvironmentOperationsRole'{_aeorEnvironmentName
                                          = pEnvironmentName_,
...
instance ToHeaders AssociateEnvironmentOperationsRole
         where
        toHeaders = const mempty

instance ToPath AssociateEnvironmentOperationsRole
         where
        toPath = const "/"

instance ToQuery AssociateEnvironmentOperationsRole
         where
