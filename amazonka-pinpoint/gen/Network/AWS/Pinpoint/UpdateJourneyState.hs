...
data UpdateJourneyState = UpdateJourneyState'{_ujsJourneyId
                                              :: !Text,
...
updateJourneyState
    :: Text -- ^ 'ujsJourneyId'
    -> Text -- ^ 'ujsApplicationId'
    -> JourneyStateRequest -- ^ 'ujsJourneyStateRequest'
    -> UpdateJourneyState
updateJourneyState pJourneyId_ pApplicationId_
  pJourneyStateRequest_
  = UpdateJourneyState'{_ujsJourneyId = pJourneyId_,
...
instance Hashable UpdateJourneyState where

instance NFData UpdateJourneyState where
...
instance ToPath UpdateJourneyState where
        toPath UpdateJourneyState'{..}
          = mconcat
              ["/v1/apps/", toBS _ujsApplicationId, "/journeys/",
               toBS _ujsJourneyId, "/state"]

instance ToQuery UpdateJourneyState where
        toQuery = const mempty

-- | /See:/ 'updateJourneyStateResponse' smart constructor.
data UpdateJourneyStateResponse = UpdateJourneyStateResponse'{_ujsrsResponseStatus
                                                              :: !Int,
...
updateJourneyStateResponse
    :: Int -- ^ 'ujsrsResponseStatus'
    -> JourneyResponse -- ^ 'ujsrsJourneyResponse'
    -> UpdateJourneyStateResponse
updateJourneyStateResponse pResponseStatus_
  pJourneyResponse_
  = UpdateJourneyStateResponse'{_ujsrsResponseStatus =
                                  pResponseStatus_,
...
instance NFData UpdateJourneyStateResponse where
