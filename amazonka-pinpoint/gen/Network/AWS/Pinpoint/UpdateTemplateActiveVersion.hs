...
data UpdateTemplateActiveVersion = UpdateTemplateActiveVersion'{_utavTemplateName
                                                                :: !Text,
                                                                _utavTemplateType
                                                                :: !Text,
...
updateTemplateActiveVersion
    :: Text -- ^ 'utavTemplateName'
    -> Text -- ^ 'utavTemplateType'
    -> TemplateActiveVersionRequest -- ^ 'utavTemplateActiveVersionRequest'
    -> UpdateTemplateActiveVersion
updateTemplateActiveVersion pTemplateName_
  pTemplateType_ pTemplateActiveVersionRequest_
  = UpdateTemplateActiveVersion'{_utavTemplateName =
                                   pTemplateName_,
...
instance Hashable UpdateTemplateActiveVersion where

instance NFData UpdateTemplateActiveVersion where
...
instance ToPath UpdateTemplateActiveVersion where
        toPath UpdateTemplateActiveVersion'{..}
          = mconcat
              ["/v1/templates/", toBS _utavTemplateName, "/",
               toBS _utavTemplateType, "/active-version"]

instance ToQuery UpdateTemplateActiveVersion where
        toQuery = const mempty

-- | /See:/ 'updateTemplateActiveVersionResponse' smart constructor.
data UpdateTemplateActiveVersionResponse = UpdateTemplateActiveVersionResponse'{_utavrsResponseStatus
                                                                                ::
                                                                                !Int,
                                                                                _utavrsMessageBody
                                                                                ::
...
updateTemplateActiveVersionResponse
    :: Int -- ^ 'utavrsResponseStatus'
    -> MessageBody -- ^ 'utavrsMessageBody'
    -> UpdateTemplateActiveVersionResponse
updateTemplateActiveVersionResponse pResponseStatus_
  pMessageBody_
  = UpdateTemplateActiveVersionResponse'{_utavrsResponseStatus
                                           = pResponseStatus_,
