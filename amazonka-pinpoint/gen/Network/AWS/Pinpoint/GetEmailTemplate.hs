...
data GetEmailTemplate = GetEmailTemplate'{_getVersion
                                          :: !(Maybe Text),
...
getEmailTemplate pTemplateName_
  = GetEmailTemplate'{_getVersion = Nothing,
...
instance Hashable GetEmailTemplate where

instance NFData GetEmailTemplate where
...
data GetEmailTemplateResponse = GetEmailTemplateResponse'{_getrsResponseStatus
                                                          :: !Int,
...
getEmailTemplateResponse
    ...
    -> EmailTemplateResponse -- ^ 'getrsEmailTemplateResponse'
    -> GetEmailTemplateResponse
getEmailTemplateResponse pResponseStatus_
  pEmailTemplateResponse_
  = GetEmailTemplateResponse'{_getrsResponseStatus =
                                pResponseStatus_,
                              _getrsEmailTemplateResponse =
                                pEmailTemplateResponse_}
...
instance NFData GetEmailTemplateResponse where
