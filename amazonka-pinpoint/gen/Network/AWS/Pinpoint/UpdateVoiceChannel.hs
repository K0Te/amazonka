...
data UpdateVoiceChannel = UpdateVoiceChannel'{_uvcApplicationId
                                              :: !Text,
...
updateVoiceChannel
    ...
    -> UpdateVoiceChannel
updateVoiceChannel pApplicationId_
  pVoiceChannelRequest_
  = UpdateVoiceChannel'{_uvcApplicationId =
                          pApplicationId_,
...
data UpdateVoiceChannelResponse = UpdateVoiceChannelResponse'{_uvcrsResponseStatus
                                                              :: !Int,
...
updateVoiceChannelResponse
    ...
    -> UpdateVoiceChannelResponse
updateVoiceChannelResponse pResponseStatus_
  pVoiceChannelResponse_
  = UpdateVoiceChannelResponse'{_uvcrsResponseStatus =
                                  pResponseStatus_,
                                _uvcrsVoiceChannelResponse =
                                  pVoiceChannelResponse_}
