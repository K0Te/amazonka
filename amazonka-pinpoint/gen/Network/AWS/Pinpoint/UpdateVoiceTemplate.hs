...
data UpdateVoiceTemplate = UpdateVoiceTemplate'{_uvtVersion
                                                :: !(Maybe Text),
...
updateVoiceTemplate
    :: Text -- ^ 'uvtTemplateName'
    -> VoiceTemplateRequest -- ^ 'uvtVoiceTemplateRequest'
    -> UpdateVoiceTemplate
updateVoiceTemplate pTemplateName_
  pVoiceTemplateRequest_
  = UpdateVoiceTemplate'{_uvtVersion = Nothing,
...
instance Hashable UpdateVoiceTemplate where

instance NFData UpdateVoiceTemplate where
...
data UpdateVoiceTemplateResponse = UpdateVoiceTemplateResponse'{_uvtrsResponseStatus
                                                                :: !Int,
                                                                _uvtrsMessageBody
                                                                :: !MessageBody}
...
updateVoiceTemplateResponse
    :: Int -- ^ 'uvtrsResponseStatus'
    -> MessageBody -- ^ 'uvtrsMessageBody'
    -> UpdateVoiceTemplateResponse
updateVoiceTemplateResponse pResponseStatus_
  pMessageBody_
  = UpdateVoiceTemplateResponse'{_uvtrsResponseStatus =
                                   pResponseStatus_,
...
instance NFData UpdateVoiceTemplateResponse where
