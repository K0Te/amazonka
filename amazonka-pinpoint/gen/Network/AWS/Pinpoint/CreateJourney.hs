...
data CreateJourney = CreateJourney'{_cjApplicationId
                                    :: !Text,
...
createJourney
    :: Text -- ^ 'cjApplicationId'
    -> WriteJourneyRequest -- ^ 'cjWriteJourneyRequest'
    -> CreateJourney
createJourney pApplicationId_ pWriteJourneyRequest_
  = CreateJourney'{_cjApplicationId = pApplicationId_,
...
instance Hashable CreateJourney where

instance NFData CreateJourney where
...
data CreateJourneyResponse = CreateJourneyResponse'{_cjrsResponseStatus
                                                    :: !Int,
                                                    _cjrsJourneyResponse ::
                                                    !JourneyResponse}
...
createJourneyResponse
    ...
    -> JourneyResponse -- ^ 'cjrsJourneyResponse'
    -> CreateJourneyResponse
createJourneyResponse pResponseStatus_
  pJourneyResponse_
  = CreateJourneyResponse'{_cjrsResponseStatus =
                             pResponseStatus_,
...
instance NFData CreateJourneyResponse where
