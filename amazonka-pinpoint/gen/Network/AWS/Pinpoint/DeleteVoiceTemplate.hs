...
data DeleteVoiceTemplate = DeleteVoiceTemplate'{_dvtVersion
                                                :: !(Maybe Text),
...
deleteVoiceTemplate
    :: Text -- ^ 'dvtTemplateName'
    -> DeleteVoiceTemplate
deleteVoiceTemplate pTemplateName_
  = DeleteVoiceTemplate'{_dvtVersion = Nothing,
...
instance Hashable DeleteVoiceTemplate where

instance NFData DeleteVoiceTemplate where
...
data DeleteVoiceTemplateResponse = DeleteVoiceTemplateResponse'{_dvtrsResponseStatus
                                                                :: !Int,
                                                                _dvtrsMessageBody
                                                                :: !MessageBody}
...
deleteVoiceTemplateResponse
    :: Int -- ^ 'dvtrsResponseStatus'
    -> MessageBody -- ^ 'dvtrsMessageBody'
    -> DeleteVoiceTemplateResponse
deleteVoiceTemplateResponse pResponseStatus_
  pMessageBody_
  = DeleteVoiceTemplateResponse'{_dvtrsResponseStatus =
                                   pResponseStatus_,
...
instance NFData DeleteVoiceTemplateResponse where
