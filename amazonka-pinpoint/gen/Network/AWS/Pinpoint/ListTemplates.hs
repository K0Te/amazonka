...
data ListTemplates = ListTemplates'{_ltTemplateType
                                    :: !(Maybe Text),
...
listTemplates
    :: ListTemplates
listTemplates
  = ListTemplates'{_ltTemplateType = Nothing,
                   _ltPrefix = Nothing, _ltNextToken = Nothing,
                   _ltPageSize = Nothing}
        ...
        toQuery ListTemplates'{..}
          = mconcat
              ["template-type" =: _ltTemplateType,
               "prefix" =: _ltPrefix, "next-token" =: _ltNextToken,
               "page-size" =: _ltPageSize]

-- | /See:/ 'listTemplatesResponse' smart constructor.
data ListTemplatesResponse = ListTemplatesResponse'{_ltrsResponseStatus
                                                    :: !Int,
                                                    _ltrsTemplatesResponse ::
                                                    !TemplatesResponse}
...
listTemplatesResponse
    ...
    -> TemplatesResponse -- ^ 'ltrsTemplatesResponse'
    -> ListTemplatesResponse
listTemplatesResponse pResponseStatus_
  pTemplatesResponse_
  = ListTemplatesResponse'{_ltrsResponseStatus =
                             pResponseStatus_,
