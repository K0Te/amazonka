...
data GetJourneyExecutionActivityMetrics = GetJourneyExecutionActivityMetrics'{_gjeamNextToken
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
                                                                              _gjeamPageSize
...
getJourneyExecutionActivityMetrics
    :: Text -- ^ 'gjeamJourneyActivityId'
    -> Text -- ^ 'gjeamApplicationId'
    -> Text -- ^ 'gjeamJourneyId'
    -> GetJourneyExecutionActivityMetrics
getJourneyExecutionActivityMetrics
  pJourneyActivityId_ pApplicationId_ pJourneyId_
  = GetJourneyExecutionActivityMetrics'{_gjeamNextToken
                                          = Nothing,
...
instance ToHeaders GetJourneyExecutionActivityMetrics
         where
        toHeaders
          = const
              (mconcat
...
instance ToPath GetJourneyExecutionActivityMetrics
         where
        toPath GetJourneyExecutionActivityMetrics'{..}
          = mconcat
              ["/v1/apps/", toBS _gjeamApplicationId, "/journeys/",
               toBS _gjeamJourneyId, "/activities/",
               toBS _gjeamJourneyActivityId, "/execution-metrics"]

instance ToQuery GetJourneyExecutionActivityMetrics
         where
...
data GetJourneyExecutionActivityMetricsResponse = GetJourneyExecutionActivityMetricsResponse'{_gjeamrsResponseStatus
                                                                                              ::
                                                                                              !Int,
...
getJourneyExecutionActivityMetricsResponse
    :: Int -- ^ 'gjeamrsResponseStatus'
    -> JourneyExecutionActivityMetricsResponse -- ^ 'gjeamrsJourneyExecutionActivityMetricsResponse'
    -> GetJourneyExecutionActivityMetricsResponse
getJourneyExecutionActivityMetricsResponse
  pResponseStatus_
  pJourneyExecutionActivityMetricsResponse_
  = GetJourneyExecutionActivityMetricsResponse'{_gjeamrsResponseStatus
                                                  = pResponseStatus_,
                                                _gjeamrsJourneyExecutionActivityMetricsResponse
                                                  =
                                                  pJourneyExecutionActivityMetricsResponse_}
