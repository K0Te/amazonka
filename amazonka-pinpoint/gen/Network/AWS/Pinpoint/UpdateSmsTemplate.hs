...
data UpdateSmsTemplate = UpdateSmsTemplate'{_ustVersion
                                            :: !(Maybe Text),
...
updateSmsTemplate
    :: Text -- ^ 'ustTemplateName'
    -> SMSTemplateRequest -- ^ 'ustSMSTemplateRequest'
    -> UpdateSmsTemplate
updateSmsTemplate pTemplateName_ pSMSTemplateRequest_
  = UpdateSmsTemplate'{_ustVersion = Nothing,
...
instance Hashable UpdateSmsTemplate where

instance NFData UpdateSmsTemplate where
...
data UpdateSmsTemplateResponse = UpdateSmsTemplateResponse'{_ustrsResponseStatus
                                                            :: !Int,
                                                            _ustrsMessageBody ::
                                                            !MessageBody}
...
updateSmsTemplateResponse
    :: Int -- ^ 'ustrsResponseStatus'
    -> MessageBody -- ^ 'ustrsMessageBody'
    -> UpdateSmsTemplateResponse
updateSmsTemplateResponse pResponseStatus_
  pMessageBody_
  = UpdateSmsTemplateResponse'{_ustrsResponseStatus =
                                 pResponseStatus_,
...
instance NFData UpdateSmsTemplateResponse where
