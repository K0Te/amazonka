...
data RemoveAttributes = RemoveAttributes'{_raAttributeType
                                          :: !Text,
...
removeAttributes
    ...
    -> RemoveAttributes
removeAttributes pAttributeType_ pApplicationId_
  pUpdateAttributesRequest_
  = RemoveAttributes'{_raAttributeType =
                        pAttributeType_,
...
data RemoveAttributesResponse = RemoveAttributesResponse'{_rarsResponseStatus
                                                          :: !Int,
...
removeAttributesResponse
    ...
    -> RemoveAttributesResponse
removeAttributesResponse pResponseStatus_
  pAttributesResource_
  = RemoveAttributesResponse'{_rarsResponseStatus =
                                pResponseStatus_,
