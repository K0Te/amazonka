...
data DeleteSmsTemplate = DeleteSmsTemplate'{_dstVersion
                                            :: !(Maybe Text),
...
deleteSmsTemplate
    :: Text -- ^ 'dstTemplateName'
    -> DeleteSmsTemplate
deleteSmsTemplate pTemplateName_
  = DeleteSmsTemplate'{_dstVersion = Nothing,
...
instance Hashable DeleteSmsTemplate where

instance NFData DeleteSmsTemplate where
...
data DeleteSmsTemplateResponse = DeleteSmsTemplateResponse'{_dstrsResponseStatus
                                                            :: !Int,
                                                            _dstrsMessageBody ::
                                                            !MessageBody}
...
deleteSmsTemplateResponse
    ...
    -> MessageBody -- ^ 'dstrsMessageBody'
    -> DeleteSmsTemplateResponse
deleteSmsTemplateResponse pResponseStatus_
  pMessageBody_
  = DeleteSmsTemplateResponse'{_dstrsResponseStatus =
                                 pResponseStatus_,
...
instance NFData DeleteSmsTemplateResponse where
