...
newtype DeleteRecommenderConfiguration = DeleteRecommenderConfiguration'{_drcRecommenderId
                                                                         ::
                                                                         Text}
...
deleteRecommenderConfiguration
    :: Text -- ^ 'drcRecommenderId'
    -> DeleteRecommenderConfiguration
deleteRecommenderConfiguration pRecommenderId_
  = DeleteRecommenderConfiguration'{_drcRecommenderId =
                                      pRecommenderId_}
...
instance AWSRequest DeleteRecommenderConfiguration
         where
...
instance NFData DeleteRecommenderConfiguration where

instance ToHeaders DeleteRecommenderConfiguration
         where
        toHeaders
          = const
              (mconcat
...
data DeleteRecommenderConfigurationResponse = DeleteRecommenderConfigurationResponse'{_drcrsResponseStatus
                                                                                      ::
                                                                                      !Int,
...
deleteRecommenderConfigurationResponse
    ...
    -> RecommenderConfigurationResponse -- ^ 'drcrsRecommenderConfigurationResponse'
    -> DeleteRecommenderConfigurationResponse
deleteRecommenderConfigurationResponse
  pResponseStatus_ pRecommenderConfigurationResponse_
  = DeleteRecommenderConfigurationResponse'{_drcrsResponseStatus
                                              = pResponseStatus_,
                                            _drcrsRecommenderConfigurationResponse
                                              =
