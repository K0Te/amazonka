...
newtype PhoneNumberValidate = PhoneNumberValidate'{_pnvNumberValidateRequest
...
phoneNumberValidate pNumberValidateRequest_
  = PhoneNumberValidate'{_pnvNumberValidateRequest =
...
data PhoneNumberValidateResponse = PhoneNumberValidateResponse'{_pnvrsResponseStatus
                                                                :: !Int,
                                                                _pnvrsNumberValidateResponse
                                                                ::
...
phoneNumberValidateResponse
    ...
    -> PhoneNumberValidateResponse
phoneNumberValidateResponse pResponseStatus_
  pNumberValidateResponse_
  = PhoneNumberValidateResponse'{_pnvrsResponseStatus =
                                   pResponseStatus_,
                                 _pnvrsNumberValidateResponse =
                                   pNumberValidateResponse_}
