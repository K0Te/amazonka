...
data UpdateRecommenderConfiguration = UpdateRecommenderConfiguration'{_urcRecommenderId
                                                                      :: !Text,
...
updateRecommenderConfiguration
    :: Text -- ^ 'urcRecommenderId'
    -> UpdateRecommenderConfiguration -- ^ 'urcUpdateRecommenderConfiguration'
    -> UpdateRecommenderConfiguration
updateRecommenderConfiguration pRecommenderId_
  pUpdateRecommenderConfiguration_
  = UpdateRecommenderConfiguration'{_urcRecommenderId =
                                      pRecommenderId_,
                                    _urcUpdateRecommenderConfiguration =
                                      pUpdateRecommenderConfiguration_}
...
instance AWSRequest UpdateRecommenderConfiguration
         where
...
instance NFData UpdateRecommenderConfiguration where

instance ToHeaders UpdateRecommenderConfiguration
         where
        toHeaders
          = const
              (mconcat
...
data UpdateRecommenderConfigurationResponse = UpdateRecommenderConfigurationResponse'{_urcrsResponseStatus
                                                                                      ::
                                                                                      !Int,
...
updateRecommenderConfigurationResponse
    ...
    -> RecommenderConfigurationResponse -- ^ 'urcrsRecommenderConfigurationResponse'
    -> UpdateRecommenderConfigurationResponse
updateRecommenderConfigurationResponse
  pResponseStatus_ pRecommenderConfigurationResponse_
  = UpdateRecommenderConfigurationResponse'{_urcrsResponseStatus
                                              = pResponseStatus_,
                                            _urcrsRecommenderConfigurationResponse
                                              =
