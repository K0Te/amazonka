...
newtype GetVoiceChannel = GetVoiceChannel'{_gvcApplicationId
                                           :: Text}
...
getVoiceChannel pApplicationId_
  = GetVoiceChannel'{_gvcApplicationId =
                       pApplicationId_}
...
data GetVoiceChannelResponse = GetVoiceChannelResponse'{_gvcrsResponseStatus
                                                        :: !Int,
...
getVoiceChannelResponse
    ...
    -> GetVoiceChannelResponse
getVoiceChannelResponse pResponseStatus_
  pVoiceChannelResponse_
  = GetVoiceChannelResponse'{_gvcrsResponseStatus =
                               pResponseStatus_,
                             _gvcrsVoiceChannelResponse =
                               pVoiceChannelResponse_}
