...
data UpdateEmailTemplate = UpdateEmailTemplate'{_uetVersion
                                                :: !(Maybe Text),
...
updateEmailTemplate
    :: Text -- ^ 'uetTemplateName'
    -> EmailTemplateRequest -- ^ 'uetEmailTemplateRequest'
    -> UpdateEmailTemplate
updateEmailTemplate pTemplateName_
  pEmailTemplateRequest_
  = UpdateEmailTemplate'{_uetVersion = Nothing,
...
instance Hashable UpdateEmailTemplate where

instance NFData UpdateEmailTemplate where
...
data UpdateEmailTemplateResponse = UpdateEmailTemplateResponse'{_uetrsResponseStatus
                                                                :: !Int,
                                                                _uetrsMessageBody
                                                                :: !MessageBody}
...
updateEmailTemplateResponse
    :: Int -- ^ 'uetrsResponseStatus'
    -> MessageBody -- ^ 'uetrsMessageBody'
    -> UpdateEmailTemplateResponse
updateEmailTemplateResponse pResponseStatus_
  pMessageBody_
  = UpdateEmailTemplateResponse'{_uetrsResponseStatus =
                                   pResponseStatus_,
...
instance NFData UpdateEmailTemplateResponse where
