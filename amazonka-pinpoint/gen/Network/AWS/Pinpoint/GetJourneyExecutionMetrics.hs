...
data GetJourneyExecutionMetrics = GetJourneyExecutionMetrics'{_gjemNextToken
                                                              :: !(Maybe Text),
                                                              _gjemPageSize ::
                                                              !(Maybe Text),
                                                              _gjemApplicationId
...
getJourneyExecutionMetrics
    :: Text -- ^ 'gjemApplicationId'
    -> Text -- ^ 'gjemJourneyId'
    -> GetJourneyExecutionMetrics
getJourneyExecutionMetrics pApplicationId_
  pJourneyId_
  = GetJourneyExecutionMetrics'{_gjemNextToken =
                                  Nothing,
...
instance Hashable GetJourneyExecutionMetrics where

instance NFData GetJourneyExecutionMetrics where
...
instance ToPath GetJourneyExecutionMetrics where
        toPath GetJourneyExecutionMetrics'{..}
          = mconcat
              ["/v1/apps/", toBS _gjemApplicationId, "/journeys/",
               toBS _gjemJourneyId, "/execution-metrics"]
...
data GetJourneyExecutionMetricsResponse = GetJourneyExecutionMetricsResponse'{_gjemrsResponseStatus
                                                                              ::
                                                                              !Int,
...
getJourneyExecutionMetricsResponse
    :: Int -- ^ 'gjemrsResponseStatus'
    -> JourneyExecutionMetricsResponse -- ^ 'gjemrsJourneyExecutionMetricsResponse'
    -> GetJourneyExecutionMetricsResponse
getJourneyExecutionMetricsResponse pResponseStatus_
  pJourneyExecutionMetricsResponse_
  = GetJourneyExecutionMetricsResponse'{_gjemrsResponseStatus
                                          = pResponseStatus_,
                                        _gjemrsJourneyExecutionMetricsResponse =
                                          pJourneyExecutionMetricsResponse_}
