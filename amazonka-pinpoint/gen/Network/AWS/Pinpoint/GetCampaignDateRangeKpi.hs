...
data GetCampaignDateRangeKpi = GetCampaignDateRangeKpi'{_gcdrkStartTime
                                                        :: !(Maybe POSIX),
                                                        _gcdrkNextToken ::
                                                        !(Maybe Text),
                                                        _gcdrkEndTime ::
...
getCampaignDateRangeKpi
    :: Text -- ^ 'gcdrkApplicationId'
    -> Text -- ^ 'gcdrkKpiName'
    -> Text -- ^ 'gcdrkCampaignId'
    -> GetCampaignDateRangeKpi
getCampaignDateRangeKpi pApplicationId_ pKpiName_
  pCampaignId_
  = GetCampaignDateRangeKpi'{_gcdrkStartTime = Nothing,
                             _gcdrkNextToken = Nothing, _gcdrkEndTime = Nothing,
...
instance AWSRequest GetCampaignDateRangeKpi where
        type Rs GetCampaignDateRangeKpi =
             GetCampaignDateRangeKpiResponse
...
instance Hashable GetCampaignDateRangeKpi where

instance NFData GetCampaignDateRangeKpi where
...
instance ToPath GetCampaignDateRangeKpi where
        toPath GetCampaignDateRangeKpi'{..}
          = mconcat
              ["/v1/apps/", toBS _gcdrkApplicationId,
               "/campaigns/", toBS _gcdrkCampaignId,
               "/kpis/daterange/", toBS _gcdrkKpiName]
...
data GetCampaignDateRangeKpiResponse = GetCampaignDateRangeKpiResponse'{_gcdrkrsResponseStatus
                                                                        :: !Int,
...
getCampaignDateRangeKpiResponse
    :: Int -- ^ 'gcdrkrsResponseStatus'
    -> CampaignDateRangeKpiResponse -- ^ 'gcdrkrsCampaignDateRangeKpiResponse'
    -> GetCampaignDateRangeKpiResponse
getCampaignDateRangeKpiResponse pResponseStatus_
  pCampaignDateRangeKpiResponse_
  = GetCampaignDateRangeKpiResponse'{_gcdrkrsResponseStatus
                                       = pResponseStatus_,
                                     _gcdrkrsCampaignDateRangeKpiResponse =
                                       pCampaignDateRangeKpiResponse_}
...
instance NFData GetCampaignDateRangeKpiResponse where
