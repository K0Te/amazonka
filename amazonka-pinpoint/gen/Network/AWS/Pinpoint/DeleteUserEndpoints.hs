...
data DeleteUserEndpoints = DeleteUserEndpoints'{_dueApplicationId
                                                :: !Text,
                                                _dueUserId :: !Text}
...
deleteUserEndpoints
    :: Text -- ^ 'dueApplicationId'
    -> Text -- ^ 'dueUserId'
    -> DeleteUserEndpoints
deleteUserEndpoints pApplicationId_ pUserId_
  = DeleteUserEndpoints'{_dueApplicationId =
                           pApplicationId_,
                         _dueUserId = pUserId_}
...
instance Hashable DeleteUserEndpoints where

instance NFData DeleteUserEndpoints where
...
instance ToPath DeleteUserEndpoints where
        toPath DeleteUserEndpoints'{..}
          = mconcat
              ["/v1/apps/", toBS _dueApplicationId, "/users/",
               toBS _dueUserId]
...
data DeleteUserEndpointsResponse = DeleteUserEndpointsResponse'{_duersResponseStatus
                                                                :: !Int,
...
deleteUserEndpointsResponse
    :: Int -- ^ 'duersResponseStatus'
    -> EndpointsResponse -- ^ 'duersEndpointsResponse'
    -> DeleteUserEndpointsResponse
deleteUserEndpointsResponse pResponseStatus_
  pEndpointsResponse_
  = DeleteUserEndpointsResponse'{_duersResponseStatus =
                                   pResponseStatus_,
...
instance NFData DeleteUserEndpointsResponse where
