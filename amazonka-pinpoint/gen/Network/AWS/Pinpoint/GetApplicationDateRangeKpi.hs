...
data GetApplicationDateRangeKpi = GetApplicationDateRangeKpi'{_gadrkStartTime
                                                              :: !(Maybe POSIX),
                                                              _gadrkNextToken ::
                                                              !(Maybe Text),
                                                              _gadrkEndTime ::
...
getApplicationDateRangeKpi
    :: Text -- ^ 'gadrkApplicationId'
    -> Text -- ^ 'gadrkKpiName'
    -> GetApplicationDateRangeKpi
getApplicationDateRangeKpi pApplicationId_ pKpiName_
  = GetApplicationDateRangeKpi'{_gadrkStartTime =
                                  Nothing,
...
instance AWSRequest GetApplicationDateRangeKpi where
        type Rs GetApplicationDateRangeKpi =
             GetApplicationDateRangeKpiResponse
...
instance Hashable GetApplicationDateRangeKpi where

instance NFData GetApplicationDateRangeKpi where
...
instance ToPath GetApplicationDateRangeKpi where
        toPath GetApplicationDateRangeKpi'{..}
          = mconcat
              ["/v1/apps/", toBS _gadrkApplicationId,
               "/kpis/daterange/", toBS _gadrkKpiName]
...
data GetApplicationDateRangeKpiResponse = GetApplicationDateRangeKpiResponse'{_gadrkrsResponseStatus
                                                                              ::
                                                                              !Int,
...
getApplicationDateRangeKpiResponse
    :: Int -- ^ 'gadrkrsResponseStatus'
    -> ApplicationDateRangeKpiResponse -- ^ 'gadrkrsApplicationDateRangeKpiResponse'
    -> GetApplicationDateRangeKpiResponse
getApplicationDateRangeKpiResponse pResponseStatus_
  pApplicationDateRangeKpiResponse_
  = GetApplicationDateRangeKpiResponse'{_gadrkrsResponseStatus
                                          = pResponseStatus_,
                                        _gadrkrsApplicationDateRangeKpiResponse
                                          = pApplicationDateRangeKpiResponse_}
