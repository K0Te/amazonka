...
data CreateSmsTemplate = CreateSmsTemplate'{_cstTemplateName
                                            :: !Text,
...
createSmsTemplate
    :: Text -- ^ 'cstTemplateName'
    -> SMSTemplateRequest -- ^ 'cstSMSTemplateRequest'
    -> CreateSmsTemplate
createSmsTemplate pTemplateName_ pSMSTemplateRequest_
  = CreateSmsTemplate'{_cstTemplateName =
                         pTemplateName_,
...
instance Hashable CreateSmsTemplate where

instance NFData CreateSmsTemplate where
...
data CreateSmsTemplateResponse = CreateSmsTemplateResponse'{_cstrsResponseStatus
                                                            :: !Int,
...
createSmsTemplateResponse
    :: Int -- ^ 'cstrsResponseStatus'
    -> CreateTemplateMessageBody -- ^ 'cstrsCreateTemplateMessageBody'
    -> CreateSmsTemplateResponse
createSmsTemplateResponse pResponseStatus_
  pCreateTemplateMessageBody_
  = CreateSmsTemplateResponse'{_cstrsResponseStatus =
                                 pResponseStatus_,
                               _cstrsCreateTemplateMessageBody =
                                 pCreateTemplateMessageBody_}
...
instance NFData CreateSmsTemplateResponse where
