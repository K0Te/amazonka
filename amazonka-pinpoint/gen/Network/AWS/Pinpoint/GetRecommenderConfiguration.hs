...
data GetRecommenderConfigurationResponse = GetRecommenderConfigurationResponse'{_grcrrsResponseStatus
                                                                                ::
                                                                                !Int,
...
getRecommenderConfigurationResponse
    :: Int -- ^ 'grcrrsResponseStatus'
    -> RecommenderConfigurationResponse -- ^ 'grcrrsRecommenderConfigurationResponse'
    -> GetRecommenderConfigurationResponse
getRecommenderConfigurationResponse pResponseStatus_
  pRecommenderConfigurationResponse_
  = GetRecommenderConfigurationResponse'{_grcrrsResponseStatus
                                           = pResponseStatus_,
                                         _grcrrsRecommenderConfigurationResponse
                                           = pRecommenderConfigurationResponse_}
