...
newtype GetChannels = GetChannels'{_gcsApplicationId
                                   :: Text}
...
data GetChannelsResponse = GetChannelsResponse'{_gcsrsResponseStatus
                                                :: !Int,
                                                _gcsrsChannelsResponse ::
                                                !ChannelsResponse}
                             deriving (Eq, Read, Show, Data, Typeable, Generic)
...
getChannelsResponse
    ...
    -> GetChannelsResponse
getChannelsResponse pResponseStatus_
  pChannelsResponse_
  = GetChannelsResponse'{_gcsrsResponseStatus =
                           pResponseStatus_,
