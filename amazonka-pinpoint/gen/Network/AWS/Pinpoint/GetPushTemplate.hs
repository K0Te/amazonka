...
data GetPushTemplate = GetPushTemplate'{_gptVersion
                                        :: !(Maybe Text),
...
getPushTemplate
    :: Text -- ^ 'gptTemplateName'
    -> GetPushTemplate
getPushTemplate pTemplateName_
  = GetPushTemplate'{_gptVersion = Nothing,
...
instance Hashable GetPushTemplate where

instance NFData GetPushTemplate where
...
data GetPushTemplateResponse = GetPushTemplateResponse'{_gptrsResponseStatus
                                                        :: !Int,
...
getPushTemplateResponse
    ...
    -> PushNotificationTemplateResponse -- ^ 'gptrsPushNotificationTemplateResponse'
    -> GetPushTemplateResponse
getPushTemplateResponse pResponseStatus_
  pPushNotificationTemplateResponse_
  = GetPushTemplateResponse'{_gptrsResponseStatus =
                               pResponseStatus_,
                             _gptrsPushNotificationTemplateResponse =
                               pPushNotificationTemplateResponse_}
...
instance NFData GetPushTemplateResponse where
