...
data DeletePushTemplate = DeletePushTemplate'{_dptVersion
                                              :: !(Maybe Text),
...
deletePushTemplate
    :: Text -- ^ 'dptTemplateName'
    -> DeletePushTemplate
deletePushTemplate pTemplateName_
  = DeletePushTemplate'{_dptVersion = Nothing,
...
instance Hashable DeletePushTemplate where

instance NFData DeletePushTemplate where
...
data DeletePushTemplateResponse = DeletePushTemplateResponse'{_dptrsResponseStatus
                                                              :: !Int,
                                                              _dptrsMessageBody
                                                              :: !MessageBody}
...
deletePushTemplateResponse
    ...
    -> MessageBody -- ^ 'dptrsMessageBody'
    -> DeletePushTemplateResponse
deletePushTemplateResponse pResponseStatus_
  pMessageBody_
  = DeletePushTemplateResponse'{_dptrsResponseStatus =
                                  pResponseStatus_,
...
instance NFData DeletePushTemplateResponse where
