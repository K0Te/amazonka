...
data GetSmsTemplate = GetSmsTemplate'{_gstVersion ::
                                      !(Maybe Text),
...
getSmsTemplate
    :: Text -- ^ 'gstTemplateName'
    -> GetSmsTemplate
getSmsTemplate pTemplateName_
  = GetSmsTemplate'{_gstVersion = Nothing,
...
instance Hashable GetSmsTemplate where

instance NFData GetSmsTemplate where
...
data GetSmsTemplateResponse = GetSmsTemplateResponse'{_gstrsResponseStatus
                                                      :: !Int,
...
getSmsTemplateResponse
    ...
    -> SMSTemplateResponse -- ^ 'gstrsSMSTemplateResponse'
    -> GetSmsTemplateResponse
getSmsTemplateResponse pResponseStatus_
  pSMSTemplateResponse_
  = GetSmsTemplateResponse'{_gstrsResponseStatus =
                              pResponseStatus_,
...
instance NFData GetSmsTemplateResponse where
