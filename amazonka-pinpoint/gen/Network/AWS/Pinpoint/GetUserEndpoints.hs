...
data GetUserEndpoints = GetUserEndpoints'{_gueApplicationId
                                          :: !Text,
                                          _gueUserId :: !Text}
...
getUserEndpoints pApplicationId_ pUserId_
  = GetUserEndpoints'{_gueApplicationId =
                        pApplicationId_,
                      _gueUserId = pUserId_}
...
data GetUserEndpointsResponse = GetUserEndpointsResponse'{_guersResponseStatus
                                                          :: !Int,
...
getUserEndpointsResponse
    ...
    -> GetUserEndpointsResponse
getUserEndpointsResponse pResponseStatus_
  pEndpointsResponse_
  = GetUserEndpointsResponse'{_guersResponseStatus =
                                pResponseStatus_,
