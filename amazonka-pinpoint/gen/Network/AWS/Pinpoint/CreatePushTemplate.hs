...
data CreatePushTemplate = CreatePushTemplate'{_cptTemplateName
                                              :: !Text,
...
createPushTemplate
    :: Text -- ^ 'cptTemplateName'
    -> PushNotificationTemplateRequest -- ^ 'cptPushNotificationTemplateRequest'
    -> CreatePushTemplate
createPushTemplate pTemplateName_
  pPushNotificationTemplateRequest_
  = CreatePushTemplate'{_cptTemplateName =
                          pTemplateName_,
                        _cptPushNotificationTemplateRequest =
                          pPushNotificationTemplateRequest_}
...
instance Hashable CreatePushTemplate where

instance NFData CreatePushTemplate where
...
data CreatePushTemplateResponse = CreatePushTemplateResponse'{_cptrsResponseStatus
                                                              :: !Int,
...
createPushTemplateResponse
    :: Int -- ^ 'cptrsResponseStatus'
    -> CreateTemplateMessageBody -- ^ 'cptrsCreateTemplateMessageBody'
    -> CreatePushTemplateResponse
createPushTemplateResponse pResponseStatus_
  pCreateTemplateMessageBody_
  = CreatePushTemplateResponse'{_cptrsResponseStatus =
                                  pResponseStatus_,
                                _cptrsCreateTemplateMessageBody =
                                  pCreateTemplateMessageBody_}
...
instance NFData CreatePushTemplateResponse where
