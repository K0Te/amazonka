...
data CreateVoiceTemplate = CreateVoiceTemplate'{_cvtTemplateName
                                                :: !Text,
...
createVoiceTemplate
    :: Text -- ^ 'cvtTemplateName'
    -> VoiceTemplateRequest -- ^ 'cvtVoiceTemplateRequest'
    -> CreateVoiceTemplate
createVoiceTemplate pTemplateName_
  pVoiceTemplateRequest_
  = CreateVoiceTemplate'{_cvtTemplateName =
                           pTemplateName_,
...
instance Hashable CreateVoiceTemplate where

instance NFData CreateVoiceTemplate where
...
data CreateVoiceTemplateResponse = CreateVoiceTemplateResponse'{_cvtrsResponseStatus
                                                                :: !Int,
...
createVoiceTemplateResponse
    :: Int -- ^ 'cvtrsResponseStatus'
    -> CreateTemplateMessageBody -- ^ 'cvtrsCreateTemplateMessageBody'
    -> CreateVoiceTemplateResponse
createVoiceTemplateResponse pResponseStatus_
  pCreateTemplateMessageBody_
  = CreateVoiceTemplateResponse'{_cvtrsResponseStatus =
                                   pResponseStatus_,
                                 _cvtrsCreateTemplateMessageBody =
                                   pCreateTemplateMessageBody_}
...
instance NFData CreateVoiceTemplateResponse where
