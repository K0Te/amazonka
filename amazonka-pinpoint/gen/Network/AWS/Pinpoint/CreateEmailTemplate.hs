...
data CreateEmailTemplate = CreateEmailTemplate'{_cetTemplateName
                                                :: !Text,
...
createEmailTemplate
    :: Text -- ^ 'cetTemplateName'
    -> EmailTemplateRequest -- ^ 'cetEmailTemplateRequest'
    -> CreateEmailTemplate
createEmailTemplate pTemplateName_
  pEmailTemplateRequest_
  = CreateEmailTemplate'{_cetTemplateName =
                           pTemplateName_,
...
instance Hashable CreateEmailTemplate where

instance NFData CreateEmailTemplate where
...
data CreateEmailTemplateResponse = CreateEmailTemplateResponse'{_cetrsResponseStatus
                                                                :: !Int,
...
createEmailTemplateResponse
    ...
    -> CreateTemplateMessageBody -- ^ 'cetrsCreateTemplateMessageBody'
    -> CreateEmailTemplateResponse
createEmailTemplateResponse pResponseStatus_
  pCreateTemplateMessageBody_
  = CreateEmailTemplateResponse'{_cetrsResponseStatus =
                                   pResponseStatus_,
                                 _cetrsCreateTemplateMessageBody =
                                   pCreateTemplateMessageBody_}
...
instance NFData CreateEmailTemplateResponse where
