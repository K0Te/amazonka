...
data UpdatePushTemplate = UpdatePushTemplate'{_uptVersion
                                              :: !(Maybe Text),
...
updatePushTemplate
    :: Text -- ^ 'uptTemplateName'
    -> PushNotificationTemplateRequest -- ^ 'uptPushNotificationTemplateRequest'
    -> UpdatePushTemplate
updatePushTemplate pTemplateName_
  pPushNotificationTemplateRequest_
  = UpdatePushTemplate'{_uptVersion = Nothing,
...
instance Hashable UpdatePushTemplate where

instance NFData UpdatePushTemplate where
...
data UpdatePushTemplateResponse = UpdatePushTemplateResponse'{_uptrsResponseStatus
                                                              :: !Int,
                                                              _uptrsMessageBody
                                                              :: !MessageBody}
...
updatePushTemplateResponse
    :: Int -- ^ 'uptrsResponseStatus'
    -> MessageBody -- ^ 'uptrsMessageBody'
    -> UpdatePushTemplateResponse
updatePushTemplateResponse pResponseStatus_
  pMessageBody_
  = UpdatePushTemplateResponse'{_uptrsResponseStatus =
                                  pResponseStatus_,
...
instance NFData UpdatePushTemplateResponse where
