...
data DeleteEmailTemplate = DeleteEmailTemplate'{_detVersion
                                                :: !(Maybe Text),
...
deleteEmailTemplate
    :: Text -- ^ 'detTemplateName'
    -> DeleteEmailTemplate
deleteEmailTemplate pTemplateName_
  = DeleteEmailTemplate'{_detVersion = Nothing,
...
instance Hashable DeleteEmailTemplate where

instance NFData DeleteEmailTemplate where
...
data DeleteEmailTemplateResponse = DeleteEmailTemplateResponse'{_detrsResponseStatus
                                                                :: !Int,
                                                                _detrsMessageBody
                                                                :: !MessageBody}
...
deleteEmailTemplateResponse
    ...
    -> MessageBody -- ^ 'detrsMessageBody'
    -> DeleteEmailTemplateResponse
deleteEmailTemplateResponse pResponseStatus_
  pMessageBody_
  = DeleteEmailTemplateResponse'{_detrsResponseStatus =
                                   pResponseStatus_,
...
instance NFData DeleteEmailTemplateResponse where
