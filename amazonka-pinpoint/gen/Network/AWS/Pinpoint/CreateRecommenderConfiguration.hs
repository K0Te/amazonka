...
newtype CreateRecommenderConfiguration = CreateRecommenderConfiguration'{_crcCreateRecommenderConfiguration
                                                                         ::
                                                                         CreateRecommenderConfiguration}
...
createRecommenderConfiguration
    :: CreateRecommenderConfiguration -- ^ 'crcCreateRecommenderConfiguration'
    -> CreateRecommenderConfiguration
createRecommenderConfiguration
  pCreateRecommenderConfiguration_
  = CreateRecommenderConfiguration'{_crcCreateRecommenderConfiguration
                                      = pCreateRecommenderConfiguration_}
...
instance AWSRequest CreateRecommenderConfiguration
         where
...
instance NFData CreateRecommenderConfiguration where

instance ToHeaders CreateRecommenderConfiguration
         where
        toHeaders
          = const
              (mconcat
...
data CreateRecommenderConfigurationResponse = CreateRecommenderConfigurationResponse'{_crcrsResponseStatus
                                                                                      ::
                                                                                      !Int,
...
createRecommenderConfigurationResponse
    :: Int -- ^ 'crcrsResponseStatus'
    -> RecommenderConfigurationResponse -- ^ 'crcrsRecommenderConfigurationResponse'
    -> CreateRecommenderConfigurationResponse
createRecommenderConfigurationResponse
  pResponseStatus_ pRecommenderConfigurationResponse_
  = CreateRecommenderConfigurationResponse'{_crcrsResponseStatus
                                              = pResponseStatus_,
                                            _crcrsRecommenderConfigurationResponse
                                              =
