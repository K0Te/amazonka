...
data GetJourneyDateRangeKpi = GetJourneyDateRangeKpi'{_gjdrkStartTime
                                                      :: !(Maybe POSIX),
                                                      _gjdrkNextToken ::
                                                      !(Maybe Text),
                                                      _gjdrkEndTime ::
...
getJourneyDateRangeKpi
    :: Text -- ^ 'gjdrkJourneyId'
    -> Text -- ^ 'gjdrkApplicationId'
    -> Text -- ^ 'gjdrkKpiName'
    -> GetJourneyDateRangeKpi
getJourneyDateRangeKpi pJourneyId_ pApplicationId_
  pKpiName_
  = GetJourneyDateRangeKpi'{_gjdrkStartTime = Nothing,
                            _gjdrkNextToken = Nothing, _gjdrkEndTime = Nothing,
...
instance AWSRequest GetJourneyDateRangeKpi where
        type Rs GetJourneyDateRangeKpi =
             GetJourneyDateRangeKpiResponse
...
instance Hashable GetJourneyDateRangeKpi where

instance NFData GetJourneyDateRangeKpi where
...
instance ToPath GetJourneyDateRangeKpi where
        toPath GetJourneyDateRangeKpi'{..}
          = mconcat
              ["/v1/apps/", toBS _gjdrkApplicationId, "/journeys/",
               toBS _gjdrkJourneyId, "/kpis/daterange/",
               toBS _gjdrkKpiName]
...
data GetJourneyDateRangeKpiResponse = GetJourneyDateRangeKpiResponse'{_gjdrkrsResponseStatus
                                                                      :: !Int,
...
getJourneyDateRangeKpiResponse
    :: Int -- ^ 'gjdrkrsResponseStatus'
    -> JourneyDateRangeKpiResponse -- ^ 'gjdrkrsJourneyDateRangeKpiResponse'
    -> GetJourneyDateRangeKpiResponse
getJourneyDateRangeKpiResponse pResponseStatus_
  pJourneyDateRangeKpiResponse_
  = GetJourneyDateRangeKpiResponse'{_gjdrkrsResponseStatus
                                      = pResponseStatus_,
                                    _gjdrkrsJourneyDateRangeKpiResponse =
                                      pJourneyDateRangeKpiResponse_}
...
instance NFData GetJourneyDateRangeKpiResponse where
