...
newtype DeleteVoiceChannel = DeleteVoiceChannel'{_dvcApplicationId
                                                 :: Text}
...
deleteVoiceChannel pApplicationId_
  = DeleteVoiceChannel'{_dvcApplicationId =
                          pApplicationId_}
...
data DeleteVoiceChannelResponse = DeleteVoiceChannelResponse'{_dvcrsResponseStatus
                                                              :: !Int,
...
deleteVoiceChannelResponse
    ...
    -> DeleteVoiceChannelResponse
deleteVoiceChannelResponse pResponseStatus_
  pVoiceChannelResponse_
  = DeleteVoiceChannelResponse'{_dvcrsResponseStatus =
                                  pResponseStatus_,
                                _dvcrsVoiceChannelResponse =
                                  pVoiceChannelResponse_}
