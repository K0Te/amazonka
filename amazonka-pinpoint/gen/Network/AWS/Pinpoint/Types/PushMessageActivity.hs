...
data PushMessageActivity = PushMessageActivity'{_pmaTemplateName
                                                :: !(Maybe Text),
                                                _pmaTemplateVersion ::
                                                !(Maybe Text),
                                                _pmaNextActivity ::
...
pushMessageActivity
    :: PushMessageActivity
pushMessageActivity
  = PushMessageActivity'{_pmaTemplateName = Nothing,
...
instance FromJSON PushMessageActivity where
        parseJSON
          = withObject "PushMessageActivity"
              (\ x ->
                 PushMessageActivity' <$>
...
instance Hashable PushMessageActivity where

instance NFData PushMessageActivity where
