...
data SMSMessageActivity = SMSMessageActivity'{_smsmaTemplateName
                                              :: !(Maybe Text),
...
sMSMessageActivity
    :: SMSMessageActivity
sMSMessageActivity
  = SMSMessageActivity'{_smsmaTemplateName = Nothing,
...
instance Hashable SMSMessageActivity where

instance NFData SMSMessageActivity where
