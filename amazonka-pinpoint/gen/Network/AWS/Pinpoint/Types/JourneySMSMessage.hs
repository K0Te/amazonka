...
data JourneySMSMessage = JourneySMSMessage'{_jsmsmMessageType
                                            :: !(Maybe MessageType),
...
journeySMSMessage
    :: JourneySMSMessage
journeySMSMessage
  = JourneySMSMessage'{_jsmsmMessageType = Nothing,
...
instance FromJSON JourneySMSMessage where
        parseJSON
          = withObject "JourneySMSMessage"
              (\ x ->
                 JourneySMSMessage' <$>
                   (x .:? "MessageType") <*> (x .:? "SenderId"))

instance Hashable JourneySMSMessage where

instance NFData JourneySMSMessage where
