...
data EmailMessageActivity = EmailMessageActivity'{_emaTemplateName
                                                  :: !(Maybe Text),
                                                  _emaTemplateVersion ::
                                                  !(Maybe Text),
                                                  _emaNextActivity ::
...
emailMessageActivity
    :: EmailMessageActivity
emailMessageActivity
  = EmailMessageActivity'{_emaTemplateName = Nothing,
...
instance FromJSON EmailMessageActivity where
        parseJSON
          = withObject "EmailMessageActivity"
              (\ x ->
                 EmailMessageActivity' <$>
...
instance Hashable EmailMessageActivity where

instance NFData EmailMessageActivity where
