...
data CustomMessageActivity = CustomMessageActivity'{_cmaTemplateName
                                                    :: !(Maybe Text),
                                                    _cmaTemplateVersion ::
                                                    !(Maybe Text),
                                                    _cmaEndpointTypes ::
...
customMessageActivity
    :: CustomMessageActivity
customMessageActivity
  = CustomMessageActivity'{_cmaTemplateName = Nothing,
...
cmaEndpointTypes :: Lens' CustomMessageActivity [__EndpointTypesElement]
...
instance FromJSON CustomMessageActivity where
        parseJSON
          = withObject "CustomMessageActivity"
              (\ x ->
                 CustomMessageActivity' <$>
                   (x .:? "TemplateName") <*> (x .:? "TemplateVersion")
                     <*> (x .:? "EndpointTypes" .!= mempty)
                     <*> (x .:? "NextActivity")
                     <*> (x .:? "DeliveryUri")
                     <*> (x .:? "MessageConfig"))

instance Hashable CustomMessageActivity where

instance NFData CustomMessageActivity where
