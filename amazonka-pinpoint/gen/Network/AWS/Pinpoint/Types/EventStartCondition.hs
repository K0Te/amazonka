...
data EventStartCondition = EventStartCondition'{_escEventFilter
                                                :: !(Maybe EventFilter),
...
eventStartCondition
    :: EventStartCondition
eventStartCondition
  = EventStartCondition'{_escEventFilter = Nothing,
...
instance FromJSON EventStartCondition where
        parseJSON
          = withObject "EventStartCondition"
              (\ x ->
                 EventStartCondition' <$>
                   (x .:? "EventFilter") <*> (x .:? "SegmentId"))

instance Hashable EventStartCondition where

instance NFData EventStartCondition where
