...
data MessageRequest = MessageRequest'{_mrTraceId ::
                                      !(Maybe Text),
...
messageRequest
    :: DirectMessageConfiguration -- ^ 'mrMessageConfiguration'
    -> MessageRequest
messageRequest pMessageConfiguration_
  = MessageRequest'{_mrTraceId = Nothing,
                    _mrContext = Nothing, _mrAddresses = Nothing,
