...
data ListTemplateVersions = ListTemplateVersions'{_ltvNextToken
                                                  :: !(Maybe Text),
...
listTemplateVersions
    :: Text -- ^ 'ltvTemplateName'
    -> Text -- ^ 'ltvTemplateType'
    -> ListTemplateVersions
listTemplateVersions pTemplateName_ pTemplateType_
  = ListTemplateVersions'{_ltvNextToken = Nothing,
...
instance Hashable ListTemplateVersions where

instance NFData ListTemplateVersions where
...
instance ToPath ListTemplateVersions where
        toPath ListTemplateVersions'{..}
          = mconcat
              ["/v1/templates/", toBS _ltvTemplateName, "/",
               toBS _ltvTemplateType, "/versions"]
...
data ListTemplateVersionsResponse = ListTemplateVersionsResponse'{_ltvrsResponseStatus
                                                                  :: !Int,
...
listTemplateVersionsResponse
    ...
    -> TemplateVersionsResponse -- ^ 'ltvrsTemplateVersionsResponse'
    -> ListTemplateVersionsResponse
listTemplateVersionsResponse pResponseStatus_
  pTemplateVersionsResponse_
  = ListTemplateVersionsResponse'{_ltvrsResponseStatus
                                    = pResponseStatus_,
                                  _ltvrsTemplateVersionsResponse =
                                    pTemplateVersionsResponse_}
...
instance NFData ListTemplateVersionsResponse where
