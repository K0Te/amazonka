...
data PutEvents = PutEvents'{_peApplicationId ::
                            !Text,
...
putEvents
    :: Text -- ^ 'peApplicationId'
    -> EventsRequest -- ^ 'peEventsRequest'
    -> PutEvents
putEvents pApplicationId_ pEventsRequest_
  = PutEvents'{_peApplicationId = pApplicationId_,
...
data PutEventsResponse = PutEventsResponse'{_persResponseStatus
                                            :: !Int,
                                            _persEventsResponse ::
                                            !EventsResponse}
                           deriving (Eq, Read, Show, Data, Typeable, Generic)
...
putEventsResponse
    ...
    -> EventsResponse -- ^ 'persEventsResponse'
    -> PutEventsResponse
putEventsResponse pResponseStatus_ pEventsResponse_
  = PutEventsResponse'{_persResponseStatus =
                         pResponseStatus_,
