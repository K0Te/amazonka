...
data GetRecommenderConfigurations = GetRecommenderConfigurations'{_grcToken
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _grcPageSize
                                                                  ::
...
getRecommenderConfigurations
    :: GetRecommenderConfigurations
getRecommenderConfigurations
  = GetRecommenderConfigurations'{_grcToken = Nothing,
...
instance AWSRequest GetRecommenderConfigurations
         where
...
instance Hashable GetRecommenderConfigurations where

instance NFData GetRecommenderConfigurations where
...
instance ToQuery GetRecommenderConfigurations where
        toQuery GetRecommenderConfigurations'{..}
          = mconcat
              ["token" =: _grcToken, "page-size" =: _grcPageSize]

-- | /See:/ 'getRecommenderConfigurationsResponse' smart constructor.
data GetRecommenderConfigurationsResponse = GetRecommenderConfigurationsResponse'{_grcrsResponseStatus
                                                                                  ::
                                                                                  !Int,
...
getRecommenderConfigurationsResponse
    ...
    -> ListRecommenderConfigurationsResponse -- ^ 'grcrsListRecommenderConfigurationsResponse'
    -> GetRecommenderConfigurationsResponse
getRecommenderConfigurationsResponse pResponseStatus_
  pListRecommenderConfigurationsResponse_
  = GetRecommenderConfigurationsResponse'{_grcrsResponseStatus
                                            = pResponseStatus_,
                                          _grcrsListRecommenderConfigurationsResponse
                                            =
                                            pListRecommenderConfigurationsResponse_}
