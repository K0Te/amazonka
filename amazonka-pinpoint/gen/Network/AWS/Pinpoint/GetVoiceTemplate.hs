...
data GetVoiceTemplate = GetVoiceTemplate'{_gvtVersion
                                          :: !(Maybe Text),
...
getVoiceTemplate
    :: Text -- ^ 'gvtTemplateName'
    -> GetVoiceTemplate
getVoiceTemplate pTemplateName_
  = GetVoiceTemplate'{_gvtVersion = Nothing,
...
instance Hashable GetVoiceTemplate where

instance NFData GetVoiceTemplate where
...
data GetVoiceTemplateResponse = GetVoiceTemplateResponse'{_gvtrsResponseStatus
                                                          :: !Int,
...
getVoiceTemplateResponse
    :: Int -- ^ 'gvtrsResponseStatus'
    -> VoiceTemplateResponse -- ^ 'gvtrsVoiceTemplateResponse'
    -> GetVoiceTemplateResponse
getVoiceTemplateResponse pResponseStatus_
  pVoiceTemplateResponse_
  = GetVoiceTemplateResponse'{_gvtrsResponseStatus =
                                pResponseStatus_,
                              _gvtrsVoiceTemplateResponse =
                                pVoiceTemplateResponse_}
...
instance NFData GetVoiceTemplateResponse where
