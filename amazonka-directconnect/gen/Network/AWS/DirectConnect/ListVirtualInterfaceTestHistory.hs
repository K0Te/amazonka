...
data ListVirtualInterfaceTestHistory = ListVirtualInterfaceTestHistory'{_lvithBgpPeers
                                                                        ::
                                                                        !(Maybe
                                                                            [Text]),
                                                                        _lvithStatus
...
listVirtualInterfaceTestHistory
    :: ListVirtualInterfaceTestHistory
listVirtualInterfaceTestHistory
  = ListVirtualInterfaceTestHistory'{_lvithBgpPeers =
                                       Nothing,
...
instance AWSRequest ListVirtualInterfaceTestHistory
         where
...
instance NFData ListVirtualInterfaceTestHistory where

instance ToHeaders ListVirtualInterfaceTestHistory
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery ListVirtualInterfaceTestHistory
         where
        toQuery = const mempty

-- | /See:/ 'listVirtualInterfaceTestHistoryResponse' smart constructor.
data ListVirtualInterfaceTestHistoryResponse = ListVirtualInterfaceTestHistoryResponse'{_lvithrsNextToken
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
...
listVirtualInterfaceTestHistoryResponse
    :: Int -- ^ 'lvithrsResponseStatus'
    -> ListVirtualInterfaceTestHistoryResponse
listVirtualInterfaceTestHistoryResponse
  pResponseStatus_
  = ListVirtualInterfaceTestHistoryResponse'{_lvithrsNextToken
                                               = Nothing,
                                             _lvithrsVirtualInterfaceTestHistory
                                               = Nothing,
                                             _lvithrsResponseStatus =
