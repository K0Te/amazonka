...
instance AWSRequest CreateTransitVirtualInterface
         where
...
instance Hashable CreateTransitVirtualInterface where

instance NFData CreateTransitVirtualInterface where

instance ToHeaders CreateTransitVirtualInterface
         where
        toHeaders
          = const
              (mconcat
