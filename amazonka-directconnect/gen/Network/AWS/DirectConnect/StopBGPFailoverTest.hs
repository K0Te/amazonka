...
newtype StopBGPFailoverTest = StopBGPFailoverTest'{_sbgpftVirtualInterfaceId
                                                   :: Text}
...
stopBGPFailoverTest
    :: Text -- ^ 'sbgpftVirtualInterfaceId'
    -> StopBGPFailoverTest
stopBGPFailoverTest pVirtualInterfaceId_
  = StopBGPFailoverTest'{_sbgpftVirtualInterfaceId =
...
instance Hashable StopBGPFailoverTest where

instance NFData StopBGPFailoverTest where
...
data StopBGPFailoverTestResponse = StopBGPFailoverTestResponse'{_sbgpftrsVirtualInterfaceTest
                                                                ::
                                                                !(Maybe
                                                                    VirtualInterfaceTestHistory),
                                                                _sbgpftrsResponseStatus
                                                                :: !Int}
                                     deriving (Eq, Read, Show, Data, Typeable,
                                               Generic)
...
stopBGPFailoverTestResponse
    :: Int -- ^ 'sbgpftrsResponseStatus'
    -> StopBGPFailoverTestResponse
stopBGPFailoverTestResponse pResponseStatus_
  = StopBGPFailoverTestResponse'{_sbgpftrsVirtualInterfaceTest
                                   = Nothing,
...
instance NFData StopBGPFailoverTestResponse where
