...
data StartBGPFailoverTest = StartBGPFailoverTest'{_sbftBgpPeers
                                                  :: !(Maybe [Text]),
...
startBGPFailoverTest
    :: Text -- ^ 'sbftVirtualInterfaceId'
    -> StartBGPFailoverTest
startBGPFailoverTest pVirtualInterfaceId_
  = StartBGPFailoverTest'{_sbftBgpPeers = Nothing,
...
instance Hashable StartBGPFailoverTest where

instance NFData StartBGPFailoverTest where
...
data StartBGPFailoverTestResponse = StartBGPFailoverTestResponse'{_sbftrsVirtualInterfaceTest
                                                                  ::
                                                                  !(Maybe
                                                                      VirtualInterfaceTestHistory),
                                                                  _sbftrsResponseStatus
                                                                  :: !Int}
...
startBGPFailoverTestResponse
    :: Int -- ^ 'sbftrsResponseStatus'
    -> StartBGPFailoverTestResponse
startBGPFailoverTestResponse pResponseStatus_
  = StartBGPFailoverTestResponse'{_sbftrsVirtualInterfaceTest
                                    = Nothing,
...
instance NFData StartBGPFailoverTestResponse where
