...
data NewPrivateVirtualInterface = NewPrivateVirtualInterface'{_nVirtualGatewayId
                                                              :: !(Maybe Text),
                                                              _nMtu ::
                                                              !(Maybe Int),
                                                              _nCustomerAddress
...
newPrivateVirtualInterface
    ...
    -> Int -- ^ 'nAsn'
    -> NewPrivateVirtualInterface
newPrivateVirtualInterface pVirtualInterfaceName_
  pVlan_ pAsn_
  = NewPrivateVirtualInterface'{_nVirtualGatewayId =
                                  Nothing,
                                _nMtu = Nothing, _nCustomerAddress = Nothing,
                                _nAmazonAddress = Nothing,
                                _nAddressFamily = Nothing,
                                _nDirectConnectGatewayId = Nothing,
                                _nAuthKey = Nothing, _nTags = Nothing,
                                _nVirtualInterfaceName = pVirtualInterfaceName_,
                                _nVlan = pVlan_, _nAsn = pAsn_}
