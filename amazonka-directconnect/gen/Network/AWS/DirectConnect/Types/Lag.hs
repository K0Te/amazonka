...
data Lag = Lag'{_lagLagId :: !(Maybe Text),
...
lag
    :: Lag
lag
  = Lag'{_lagLagId = Nothing,
         _lagConnectionsBandwidth = Nothing,
         _lagMinimumLinks = Nothing, _lagLagName = Nothing,
         _lagLocation = Nothing, _lagConnections = Nothing,
         ...
         _lagLagState = Nothing, _lagOwnerAccount = Nothing,
         _lagRegion = Nothing, _lagProviderName = Nothing,
         _lagAwsDeviceV2 = Nothing, _lagTags = Nothing}
