...
data NewTransitVirtualInterface = NewTransitVirtualInterface'{_ntviMtu
                                                              :: !(Maybe Int),
...
instance Hashable NewTransitVirtualInterface where

instance NFData NewTransitVirtualInterface where
