...
data NewPublicVirtualInterfaceAllocation = NewPublicVirtualInterfaceAllocation'{_newRouteFilterPrefixes
                                                                                ::
                                                                                !(Maybe
                                                                                    [RouteFilterPrefix]),
                                                                                _newCustomerAddress
...
newPublicVirtualInterfaceAllocation
    ...
    -> NewPublicVirtualInterfaceAllocation
newPublicVirtualInterfaceAllocation
  pVirtualInterfaceName_ pVlan_ pAsn_
  = NewPublicVirtualInterfaceAllocation'{_newRouteFilterPrefixes
                                           = Nothing,
