...
data NewPublicVirtualInterface = NewPublicVirtualInterface'{_npviRouteFilterPrefixes
                                                            ::
                                                            !(Maybe
                                                                [RouteFilterPrefix]),
...
newPublicVirtualInterface
    ...
    -> Int -- ^ 'npviAsn'
    -> NewPublicVirtualInterface
newPublicVirtualInterface pVirtualInterfaceName_
  pVlan_ pAsn_
  = NewPublicVirtualInterface'{_npviRouteFilterPrefixes
                                 = Nothing,
                               _npviCustomerAddress = Nothing,
                               _npviAmazonAddress = Nothing,
                               _npviAddressFamily = Nothing,
                               _npviAuthKey = Nothing, _npviTags = Nothing,
                               _npviVirtualInterfaceName =
                                 pVirtualInterfaceName_,
                               _npviVlan = pVlan_, _npviAsn = pAsn_}
