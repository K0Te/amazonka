...
data VirtualInterfaceTestHistory = VirtualInterfaceTestHistory'{_vithBgpPeers
                                                                ::
                                                                !(Maybe [Text]),
                                                                _vithStatus ::
                                                                !(Maybe Text),
...
virtualInterfaceTestHistory
    :: VirtualInterfaceTestHistory
virtualInterfaceTestHistory
  = VirtualInterfaceTestHistory'{_vithBgpPeers =
                                   Nothing,
                                 _vithStatus = Nothing,
                                 _vithTestDurationInMinutes = Nothing,
                                 _vithStartTime = Nothing,
                                 _vithTestId = Nothing, _vithEndTime = Nothing,
...
instance FromJSON VirtualInterfaceTestHistory where
        parseJSON
          = withObject "VirtualInterfaceTestHistory"
              (\ x ->
                 VirtualInterfaceTestHistory' <$>
                   (x .:? "bgpPeers" .!= mempty) <*> (x .:? "status")
...
instance Hashable VirtualInterfaceTestHistory where

instance NFData VirtualInterfaceTestHistory where
