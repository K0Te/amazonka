...
data NewTransitVirtualInterfaceAllocation = NewTransitVirtualInterfaceAllocation'{_ntviaMtu
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Int),
...
newTransitVirtualInterfaceAllocation
    :: NewTransitVirtualInterfaceAllocation
newTransitVirtualInterfaceAllocation
  = NewTransitVirtualInterfaceAllocation'{_ntviaMtu =
                                            Nothing,
...
instance ToJSON NewTransitVirtualInterfaceAllocation
         where
