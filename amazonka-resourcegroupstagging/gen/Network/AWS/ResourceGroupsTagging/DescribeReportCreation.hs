...
instance AWSRequest DescribeReportCreation where
        type Rs DescribeReportCreation =
             DescribeReportCreationResponse
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribeReportCreationResponse' <$>
                   (x .?> "Status") <*> (x .?> "S3Location") <*>
                     (x .?> "ErrorMessage")
                     <*> (pure (fromEnum s)))

instance Hashable DescribeReportCreation where

instance NFData DescribeReportCreation where
...
data DescribeReportCreationResponse = DescribeReportCreationResponse'{_drcrsStatus
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _drcrsS3Location
...
describeReportCreationResponse pResponseStatus_
  = DescribeReportCreationResponse'{_drcrsStatus =
                                      Nothing,
...
instance NFData DescribeReportCreationResponse where
