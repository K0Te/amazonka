...
data GetComplianceSummary = GetComplianceSummary'{_gcsGroupBy
                                                  ::
...
getComplianceSummary
    :: GetComplianceSummary
getComplianceSummary
  = GetComplianceSummary'{_gcsGroupBy = Nothing,
...
instance AWSPager GetComplianceSummary where
        page rq rs
          ...
          | otherwise =
            Just $ rq &
              gcsPaginationToken .~ rs ^. gcsrsPaginationToken

instance AWSRequest GetComplianceSummary where
        type Rs GetComplianceSummary =
             GetComplianceSummaryResponse
...
instance Hashable GetComplianceSummary where

instance NFData GetComplianceSummary where
...
data GetComplianceSummaryResponse = GetComplianceSummaryResponse'{_gcsrsPaginationToken
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _gcsrsSummaryList
                                                                  ::
...
getComplianceSummaryResponse pResponseStatus_
  = GetComplianceSummaryResponse'{_gcsrsPaginationToken
                                    = Nothing,
...
instance NFData GetComplianceSummaryResponse where
