...
newtype StartReportCreation = StartReportCreation'{_srcS3Bucket
                                                   :: Text}
...
instance Hashable StartReportCreation where

instance NFData StartReportCreation where
...
newtype StartReportCreationResponse = StartReportCreationResponse'{_srcrsResponseStatus
                                                                   :: Int}
...
startReportCreationResponse pResponseStatus_
  = StartReportCreationResponse'{_srcrsResponseStatus =
                                   pResponseStatus_}
...
instance NFData StartReportCreationResponse where
