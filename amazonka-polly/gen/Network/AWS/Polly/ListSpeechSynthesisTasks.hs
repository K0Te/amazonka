...
data ListSpeechSynthesisTasks = ListSpeechSynthesisTasks'{_lsstStatus
                                                          ::
                                                          !(Maybe TaskStatus),
                                                          _lsstNextToken ::
                                                          !(Maybe Text),
...
listSpeechSynthesisTasks
    :: ListSpeechSynthesisTasks
listSpeechSynthesisTasks
  = ListSpeechSynthesisTasks'{_lsstStatus = Nothing,
...
data ListSpeechSynthesisTasksResponse = ListSpeechSynthesisTasksResponse'{_lsstrsNextToken
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
listSpeechSynthesisTasksResponse pResponseStatus_
  = ListSpeechSynthesisTasksResponse'{_lsstrsNextToken
                                        = Nothing,
