...
newtype GetSpeechSynthesisTask = GetSpeechSynthesisTask'{_gsstTaskId
                                                         :: Text}
...
data GetSpeechSynthesisTaskResponse = GetSpeechSynthesisTaskResponse'{_gsstrsSynthesisTask
                                                                      ::
                                                                      !(Maybe
                                                                          SynthesisTask),
                                                                      _gsstrsResponseStatus
                                                                      :: !Int}
...
getSpeechSynthesisTaskResponse pResponseStatus_
  = GetSpeechSynthesisTaskResponse'{_gsstrsSynthesisTask
                                      = Nothing,
