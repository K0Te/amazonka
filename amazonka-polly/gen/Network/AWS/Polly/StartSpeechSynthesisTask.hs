...
data StartSpeechSynthesisTask = StartSpeechSynthesisTask'{_ssstLanguageCode
                                                          ::
                                                          !(Maybe LanguageCode),
                                                          _ssstSNSTopicARN ::
                                                          !(Maybe Text),
...
startSpeechSynthesisTask
    ...
    -> VoiceId -- ^ 'ssstVoiceId'
    -> StartSpeechSynthesisTask
startSpeechSynthesisTask pOutputFormat_
  pOutputS3BucketName_ pText_ pVoiceId_
  = StartSpeechSynthesisTask'{_ssstLanguageCode =
                                Nothing,
                              ...
                              _ssstText = pText_, _ssstVoiceId = pVoiceId_}
...
data StartSpeechSynthesisTaskResponse = StartSpeechSynthesisTaskResponse'{_ssstrsSynthesisTask
                                                                          ::
                                                                          !(Maybe
                                                                              SynthesisTask),
                                                                          _ssstrsResponseStatus
                                                                          ::
                                                                          !Int}
...
startSpeechSynthesisTaskResponse pResponseStatus_
  = StartSpeechSynthesisTaskResponse'{_ssstrsSynthesisTask
                                        = Nothing,
                                      _ssstrsResponseStatus = pResponseStatus_}
