...
data ListPoliciesGrantingServiceAccess = ListPoliciesGrantingServiceAccess'{_lpgsaMarker
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _lpgsaARN
...
listPoliciesGrantingServiceAccess
    ...
    -> ListPoliciesGrantingServiceAccess
listPoliciesGrantingServiceAccess pARN_
  pServiceNamespaces_
  = ListPoliciesGrantingServiceAccess'{_lpgsaMarker =
                                         Nothing,
                                       _lpgsaARN = pARN_,
                                       _lpgsaServiceNamespaces =
...
data ListPoliciesGrantingServiceAccessResponse = ListPoliciesGrantingServiceAccessResponse'{_lpgsarsMarker
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
                                                                                            _lpgsarsIsTruncated
                                                                                            ...
                                                                                            !(Maybe
                                                                                                Bool),
                                                                                            _lpgsarsResponseStatus
                                                                                            ::
                                                                                            !Int,
                                                                                            _lpgsarsPoliciesGrantingServiceAccess
                                                                                            ::
...
listPoliciesGrantingServiceAccessResponse
  pResponseStatus_
  = ListPoliciesGrantingServiceAccessResponse'{_lpgsarsMarker
                                                 = Nothing,
