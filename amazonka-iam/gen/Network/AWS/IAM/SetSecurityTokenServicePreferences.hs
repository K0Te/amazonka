...
newtype SetSecurityTokenServicePreferences = SetSecurityTokenServicePreferences'{_sstspGlobalEndpointTokenVersion
                                                                                 ::
...
setSecurityTokenServicePreferences
    :: GlobalEndpointTokenVersion -- ^ 'sstspGlobalEndpointTokenVersion'
    -> SetSecurityTokenServicePreferences
setSecurityTokenServicePreferences
  pGlobalEndpointTokenVersion_
  = SetSecurityTokenServicePreferences'{_sstspGlobalEndpointTokenVersion
                                          = pGlobalEndpointTokenVersion_}
...
instance AWSRequest
           SetSecurityTokenServicePreferences
         where
        type Rs SetSecurityTokenServicePreferences =
             SetSecurityTokenServicePreferencesResponse
...
instance ToHeaders SetSecurityTokenServicePreferences
         where
        toHeaders = const mempty

instance ToPath SetSecurityTokenServicePreferences
         where
        toPath = const "/"

instance ToQuery SetSecurityTokenServicePreferences
         where
