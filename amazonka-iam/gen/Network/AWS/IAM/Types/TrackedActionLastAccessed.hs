...
data TrackedActionLastAccessed = TrackedActionLastAccessed'{_talaLastAccessedTime
                                                            :: !(Maybe ISO8601),
                                                            _talaActionName ::
                                                            !(Maybe Text),
...
trackedActionLastAccessed
    :: TrackedActionLastAccessed
trackedActionLastAccessed
  = TrackedActionLastAccessed'{_talaLastAccessedTime =
                                 Nothing,
...
instance FromXML TrackedActionLastAccessed where
        parseXML x
          = TrackedActionLastAccessed' <$>
              (x .@? "LastAccessedTime") <*> (x .@? "ActionName")
                <*> (x .@? "LastAccessedEntity")
                <*> (x .@? "LastAccessedRegion")

instance Hashable TrackedActionLastAccessed where

instance NFData TrackedActionLastAccessed where
