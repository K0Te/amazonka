...
data ListRoleTags = ListRoleTags'{_lrtMarker ::
                                  !(Maybe Text),
...
listRoleTags pRoleName_
  = ListRoleTags'{_lrtMarker = Nothing,
                  _lrtMaxItems = Nothing, _lrtRoleName = pRoleName_}
...
data ListRoleTagsResponse = ListRoleTagsResponse'{_lrtrsMarker
                                                  :: !(Maybe Text),
                                                  _lrtrsIsTruncated ::
                                                  !(Maybe Bool),
...
listRoleTagsResponse pResponseStatus_
  = ListRoleTagsResponse'{_lrtrsMarker = Nothing,
