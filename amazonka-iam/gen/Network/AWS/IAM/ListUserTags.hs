...
data ListUserTags = ListUserTags'{_lutMarker ::
                                  !(Maybe Text),
...
listUserTags pUserName_
  = ListUserTags'{_lutMarker = Nothing,
                  _lutMaxItems = Nothing, _lutUserName = pUserName_}
...
data ListUserTagsResponse = ListUserTagsResponse'{_lutrsMarker
                                                  :: !(Maybe Text),
                                                  _lutrsIsTruncated ::
                                                  !(Maybe Bool),
...
listUserTagsResponse pResponseStatus_
  = ListUserTagsResponse'{_lutrsMarker = Nothing,
