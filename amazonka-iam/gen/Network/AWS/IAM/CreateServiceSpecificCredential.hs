...
data CreateServiceSpecificCredential = CreateServiceSpecificCredential'{_csscUserName
                                                                        ::
                                                                        !Text,
                                                                        _csscServiceName
                                                                        ::
...
createServiceSpecificCredential
    ...
    -> CreateServiceSpecificCredential
createServiceSpecificCredential pUserName_
  pServiceName_
  = CreateServiceSpecificCredential'{_csscUserName =
                                       pUserName_,
...
data CreateServiceSpecificCredentialResponse = CreateServiceSpecificCredentialResponse'{_csscrsServiceSpecificCredential
                                                                                        ::
                                                                                        !(Maybe
...
createServiceSpecificCredentialResponse
  pResponseStatus_
  = CreateServiceSpecificCredentialResponse'{_csscrsServiceSpecificCredential
                                               = Nothing,
                                             _csscrsResponseStatus =
                                               pResponseStatus_}
