...
data CreateRole = CreateRole'{_crMaxSessionDuration
                              ...
                              _crTags :: !(Maybe [Tag]), _crRoleName :: !Text,
...
--
-- * 'crTags' - A list of tags that you want to attach to the newly created role. Each tag consists of a key name and an associated value. For more information about tagging, see <https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html Tagging IAM Identities> in the /IAM User Guide/ .
--
...
createRole pRoleName_ pAssumeRolePolicyDocument_
  = CreateRole'{_crMaxSessionDuration = Nothing,
                _crPath = Nothing, _crPermissionsBoundary = Nothing,
