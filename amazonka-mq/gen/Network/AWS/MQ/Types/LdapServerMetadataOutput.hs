...
data LdapServerMetadataOutput = LdapServerMetadataOutput'{_lsmoUserBase
                                                          :: !(Maybe Text),
...
ldapServerMetadataOutput
    :: LdapServerMetadataOutput
ldapServerMetadataOutput
  = LdapServerMetadataOutput'{_lsmoUserBase = Nothing,
                              ...
                              _lsmoHosts = Nothing, _lsmoRoleName = Nothing,
...
instance FromJSON LdapServerMetadataOutput where
        parseJSON
          = withObject "LdapServerMetadataOutput"
              (\ x ->
                 LdapServerMetadataOutput' <$>
                   (x .:? "userBase") <*> (x .:? "userSearchMatching")
                     <*> (x .:? "userRoleName")
...
instance Hashable LdapServerMetadataOutput where

instance NFData LdapServerMetadataOutput where
