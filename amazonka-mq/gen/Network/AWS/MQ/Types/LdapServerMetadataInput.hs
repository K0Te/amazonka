...
data LdapServerMetadataInput = LdapServerMetadataInput'{_lsmiUserBase
                                                        :: !(Maybe Text),
...
ldapServerMetadataInput
    :: LdapServerMetadataInput
ldapServerMetadataInput
  = LdapServerMetadataInput'{_lsmiUserBase = Nothing,
                             ...
                             _lsmiHosts = Nothing, _lsmiRoleName = Nothing,
...
instance Hashable LdapServerMetadataInput where

instance NFData LdapServerMetadataInput where
