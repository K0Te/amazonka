...
data DescribeBrokerEngineTypes = DescribeBrokerEngineTypes'{_dbetNextToken
                                                            :: !(Maybe Text),
                                                            _dbetEngineType ::
                                                            !(Maybe Text),
                                                            _dbetMaxResults ::
...
describeBrokerEngineTypes
    :: DescribeBrokerEngineTypes
describeBrokerEngineTypes
  = DescribeBrokerEngineTypes'{_dbetNextToken =
                                 Nothing,
...
instance Hashable DescribeBrokerEngineTypes where

instance NFData DescribeBrokerEngineTypes where
...
data DescribeBrokerEngineTypesResponse = DescribeBrokerEngineTypesResponse'{_dbetrsBrokerEngineTypes
                                                                            ::
                                                                            !(Maybe
                                                                                [BrokerEngineType]),
                                                                            _dbetrsNextToken
...
describeBrokerEngineTypesResponse
    :: Int -- ^ 'dbetrsResponseStatus'
    -> DescribeBrokerEngineTypesResponse
describeBrokerEngineTypesResponse pResponseStatus_
  = DescribeBrokerEngineTypesResponse'{_dbetrsBrokerEngineTypes
                                         = Nothing,
