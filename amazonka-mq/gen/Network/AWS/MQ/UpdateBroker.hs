...
data UpdateBroker = UpdateBroker'{_ubEngineVersion ::
                                  !(Maybe Text),
...
data UpdateBrokerResponse = UpdateBrokerResponse'{_ubrsEngineVersion
                                                  :: !(Maybe Text),
                                                  _ubrsAutoMinorVersionUpgrade
                                                  :: !(Maybe Bool),
                                                  _ubrsSecurityGroups ::
                                                  !(Maybe [Text]),
...
updateBrokerResponse pResponseStatus_
  = UpdateBrokerResponse'{_ubrsEngineVersion = Nothing,
                          ...
                          _ubrsLogs = Nothing, _ubrsConfiguration = Nothing,
