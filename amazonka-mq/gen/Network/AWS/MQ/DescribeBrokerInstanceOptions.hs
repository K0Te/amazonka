...
data DescribeBrokerInstanceOptions = DescribeBrokerInstanceOptions'{_dbioNextToken
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _dbioEngineType
...
describeBrokerInstanceOptions
    :: DescribeBrokerInstanceOptions
describeBrokerInstanceOptions
  = DescribeBrokerInstanceOptions'{_dbioNextToken =
                                     Nothing,
...
instance AWSRequest DescribeBrokerInstanceOptions
         where
...
instance Hashable DescribeBrokerInstanceOptions where

instance NFData DescribeBrokerInstanceOptions where

instance ToHeaders DescribeBrokerInstanceOptions
         where
        toHeaders
          = const
              (mconcat
...
data DescribeBrokerInstanceOptionsResponse = DescribeBrokerInstanceOptionsResponse'{_dbiorsNextToken
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Text),
...
describeBrokerInstanceOptionsResponse
    :: Int -- ^ 'dbiorsResponseStatus'
    -> DescribeBrokerInstanceOptionsResponse
describeBrokerInstanceOptionsResponse
  pResponseStatus_
  = DescribeBrokerInstanceOptionsResponse'{_dbiorsNextToken
                                             = Nothing,
                                           _dbiorsBrokerInstanceOptions =
                                             Nothing,
