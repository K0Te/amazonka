...
newtype DescribeLanguageModel = DescribeLanguageModel'{_dModelName
                                                       :: Text}
...
instance Hashable DescribeLanguageModel where

instance NFData DescribeLanguageModel where
...
data DescribeLanguageModelResponse = DescribeLanguageModelResponse'{_dlmrsLanguageModel
                                                                    ::
                                                                    !(Maybe
                                                                        LanguageModel),
                                                                    _dlmrsResponseStatus
                                                                    :: !Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
describeLanguageModelResponse
    :: Int -- ^ 'dlmrsResponseStatus'
    -> DescribeLanguageModelResponse
describeLanguageModelResponse pResponseStatus_
  = DescribeLanguageModelResponse'{_dlmrsLanguageModel
                                     = Nothing,
...
instance NFData DescribeLanguageModelResponse where
