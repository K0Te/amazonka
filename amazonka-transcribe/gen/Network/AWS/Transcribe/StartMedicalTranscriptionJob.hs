...
data StartMedicalTranscriptionJob = StartMedicalTranscriptionJob'{_smtjSettings
                                                                  ::
                                                                  !(Maybe
...
startMedicalTranscriptionJob
    :: Text -- ^ 'smtjMedicalTranscriptionJobName'
    -> LanguageCode -- ^ 'smtjLanguageCode'
    -> Media -- ^ 'smtjMedia'
    -> Text -- ^ 'smtjOutputBucketName'
    -> Specialty -- ^ 'smtjSpecialty'
    -> Type -- ^ 'smtjType'
    -> StartMedicalTranscriptionJob
startMedicalTranscriptionJob
  pMedicalTranscriptionJobName_ pLanguageCode_ pMedia_
  pOutputBucketName_ pSpecialty_ pType_
  = StartMedicalTranscriptionJob'{_smtjSettings =
                                    Nothing,
...
instance AWSRequest StartMedicalTranscriptionJob
         where
...
instance Hashable StartMedicalTranscriptionJob where

instance NFData StartMedicalTranscriptionJob where
...
data StartMedicalTranscriptionJobResponse = StartMedicalTranscriptionJobResponse'{_smtjrsMedicalTranscriptionJob
                                                                                  ::
                                                                                  !(Maybe
...
startMedicalTranscriptionJobResponse
    :: Int -- ^ 'smtjrsResponseStatus'
    -> StartMedicalTranscriptionJobResponse
startMedicalTranscriptionJobResponse pResponseStatus_
  = StartMedicalTranscriptionJobResponse'{_smtjrsMedicalTranscriptionJob
                                            = Nothing,
                                          _smtjrsResponseStatus =
                                            pResponseStatus_}
