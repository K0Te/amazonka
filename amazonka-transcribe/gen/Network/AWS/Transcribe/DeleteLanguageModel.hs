...
newtype DeleteLanguageModel = DeleteLanguageModel'{_dlmModelName
                                                   :: Text}
...
instance AWSRequest DeleteLanguageModel where
        type Rs DeleteLanguageModel =
             DeleteLanguageModelResponse
        request = postJSON transcribe
        response = receiveNull DeleteLanguageModelResponse'

instance Hashable DeleteLanguageModel where

instance NFData DeleteLanguageModel where
...
instance NFData DeleteLanguageModelResponse where
