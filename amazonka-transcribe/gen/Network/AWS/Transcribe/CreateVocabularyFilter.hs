...
data CreateVocabularyFilter = CreateVocabularyFilter'{_cvfVocabularyFilterFileURI
                                                      :: !(Maybe Text),
                                                      _cvfWords ::
                                                      !(Maybe (List1 Text)),
...
createVocabularyFilter
    :: Text -- ^ 'cvfVocabularyFilterName'
    -> LanguageCode -- ^ 'cvfLanguageCode'
    -> CreateVocabularyFilter
createVocabularyFilter pVocabularyFilterName_
  pLanguageCode_
  = CreateVocabularyFilter'{_cvfVocabularyFilterFileURI
                              = Nothing,
                            _cvfWords = Nothing,
...
instance AWSRequest CreateVocabularyFilter where
        type Rs CreateVocabularyFilter =
             CreateVocabularyFilterResponse
        ...
        response
          = receiveJSON
              (\ s h x ->
                 CreateVocabularyFilterResponse' <$>
                   (x .?> "LanguageCode") <*> (x .?> "LastModifiedTime")
                     <*> (x .?> "VocabularyFilterName")
                     <*> (pure (fromEnum s)))

instance Hashable CreateVocabularyFilter where

instance NFData CreateVocabularyFilter where
...
data CreateVocabularyFilterResponse = CreateVocabularyFilterResponse'{_cvfrsLanguageCode
                                                                      ::
                                                                      !(Maybe
                                                                          LanguageCode),
...
createVocabularyFilterResponse
    :: Int -- ^ 'cvfrsResponseStatus'
    -> CreateVocabularyFilterResponse
createVocabularyFilterResponse pResponseStatus_
  = CreateVocabularyFilterResponse'{_cvfrsLanguageCode
                                      = Nothing,
...
instance NFData CreateVocabularyFilterResponse where
