...
newtype GetVocabularyFilter = GetVocabularyFilter'{_gvfVocabularyFilterName
                                                   :: Text}
...
getVocabularyFilter
    :: Text -- ^ 'gvfVocabularyFilterName'
    -> GetVocabularyFilter
getVocabularyFilter pVocabularyFilterName_
  = GetVocabularyFilter'{_gvfVocabularyFilterName =
...
instance AWSRequest GetVocabularyFilter where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 GetVocabularyFilterResponse' <$>
                   (x .?> "LanguageCode") <*> (x .?> "DownloadUri") <*>
                     (x .?> "LastModifiedTime")
                     <*> (x .?> "VocabularyFilterName")
                     <*> (pure (fromEnum s)))

instance Hashable GetVocabularyFilter where

instance NFData GetVocabularyFilter where
...
data GetVocabularyFilterResponse = GetVocabularyFilterResponse'{_gvfrsLanguageCode
                                                                ::
                                                                !(Maybe
                                                                    LanguageCode),
                                                                _gvfrsDownloadURI
...
getVocabularyFilterResponse
    :: Int -- ^ 'gvfrsResponseStatus'
    -> GetVocabularyFilterResponse
getVocabularyFilterResponse pResponseStatus_
  = GetVocabularyFilterResponse'{_gvfrsLanguageCode =
                                   Nothing,
...
instance NFData GetVocabularyFilterResponse where
