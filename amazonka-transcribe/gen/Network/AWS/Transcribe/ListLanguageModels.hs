...
data ListLanguageModels = ListLanguageModels'{_llmNameContains
                                              :: !(Maybe Text),
...
listLanguageModels
    :: ListLanguageModels
listLanguageModels
  = ListLanguageModels'{_llmNameContains = Nothing,
                        _llmNextToken = Nothing, _llmStatusEquals = Nothing,
...
instance AWSRequest ListLanguageModels where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 ListLanguageModelsResponse' <$>
                   (x .?> "NextToken") <*> (x .?> "Models" .!@ mempty)
                     <*> (pure (fromEnum s)))

instance Hashable ListLanguageModels where

instance NFData ListLanguageModels where
...
data ListLanguageModelsResponse = ListLanguageModelsResponse'{_llmrsNextToken
                                                              :: !(Maybe Text),
                                                              _llmrsModels ::
                                                              !(Maybe
                                                                  [LanguageModel]),
                                                              _llmrsResponseStatus
                                                              :: !Int}
...
listLanguageModelsResponse
    :: Int -- ^ 'llmrsResponseStatus'
    -> ListLanguageModelsResponse
listLanguageModelsResponse pResponseStatus_
  = ListLanguageModelsResponse'{_llmrsNextToken =
                                  Nothing,
...
instance NFData ListLanguageModelsResponse where
