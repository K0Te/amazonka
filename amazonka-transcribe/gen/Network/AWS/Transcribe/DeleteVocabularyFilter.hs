...
newtype DeleteVocabularyFilter = DeleteVocabularyFilter'{_dvfVocabularyFilterName
                                                         :: Text}
...
deleteVocabularyFilter
    :: Text -- ^ 'dvfVocabularyFilterName'
    -> DeleteVocabularyFilter
deleteVocabularyFilter pVocabularyFilterName_
  = DeleteVocabularyFilter'{_dvfVocabularyFilterName =
...
instance AWSRequest DeleteVocabularyFilter where
        type Rs DeleteVocabularyFilter =
             DeleteVocabularyFilterResponse
        request = postJSON transcribe
        response
          = receiveNull DeleteVocabularyFilterResponse'

instance Hashable DeleteVocabularyFilter where

instance NFData DeleteVocabularyFilter where
...
instance NFData DeleteVocabularyFilterResponse where
