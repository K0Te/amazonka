...
data CreateMedicalVocabulary = CreateMedicalVocabulary'{_cmvVocabularyName
                                                        :: !Text,
                                                        _cmvLanguageCode ::
                                                        !LanguageCode,
...
createMedicalVocabulary
    :: Text -- ^ 'cmvVocabularyName'
    -> LanguageCode -- ^ 'cmvLanguageCode'
    -> Text -- ^ 'cmvVocabularyFileURI'
    -> CreateMedicalVocabulary
createMedicalVocabulary pVocabularyName_
  pLanguageCode_ pVocabularyFileURI_
  = CreateMedicalVocabulary'{_cmvVocabularyName =
                               pVocabularyName_,
...
instance AWSRequest CreateMedicalVocabulary where
        type Rs CreateMedicalVocabulary =
             CreateMedicalVocabularyResponse
...
instance Hashable CreateMedicalVocabulary where

instance NFData CreateMedicalVocabulary where
...
data CreateMedicalVocabularyResponse = CreateMedicalVocabularyResponse'{_cmvrsFailureReason
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _cmvrsLanguageCode
...
createMedicalVocabularyResponse
    :: Int -- ^ 'cmvrsResponseStatus'
    -> CreateMedicalVocabularyResponse
createMedicalVocabularyResponse pResponseStatus_
  = CreateMedicalVocabularyResponse'{_cmvrsFailureReason
                                       = Nothing,
...
instance NFData CreateMedicalVocabularyResponse where
