...
newtype GetMedicalTranscriptionJob = GetMedicalTranscriptionJob'{_gmtjMedicalTranscriptionJobName
                                                                 :: Text}
...
getMedicalTranscriptionJob
    :: Text -- ^ 'gmtjMedicalTranscriptionJobName'
    -> GetMedicalTranscriptionJob
getMedicalTranscriptionJob
  pMedicalTranscriptionJobName_
  = GetMedicalTranscriptionJob'{_gmtjMedicalTranscriptionJobName
                                  = pMedicalTranscriptionJobName_}
...
instance AWSRequest GetMedicalTranscriptionJob where
        type Rs GetMedicalTranscriptionJob =
             GetMedicalTranscriptionJobResponse
...
instance Hashable GetMedicalTranscriptionJob where

instance NFData GetMedicalTranscriptionJob where
...
data GetMedicalTranscriptionJobResponse = GetMedicalTranscriptionJobResponse'{_gmtjrsMedicalTranscriptionJob
                                                                              ::
                                                                              !(Maybe
...
getMedicalTranscriptionJobResponse
    :: Int -- ^ 'gmtjrsResponseStatus'
    -> GetMedicalTranscriptionJobResponse
getMedicalTranscriptionJobResponse pResponseStatus_
  = GetMedicalTranscriptionJobResponse'{_gmtjrsMedicalTranscriptionJob
                                          = Nothing,
                                        _gmtjrsResponseStatus =
                                          pResponseStatus_}
