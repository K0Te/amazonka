...
newtype DeleteMedicalVocabulary = DeleteMedicalVocabulary'{_dmvVocabularyName
                                                           :: Text}
...
deleteMedicalVocabulary
    :: Text -- ^ 'dmvVocabularyName'
    -> DeleteMedicalVocabulary
deleteMedicalVocabulary pVocabularyName_
  = DeleteMedicalVocabulary'{_dmvVocabularyName =
                               pVocabularyName_}
...
instance AWSRequest DeleteMedicalVocabulary where
        type Rs DeleteMedicalVocabulary =
             DeleteMedicalVocabularyResponse
        request = postJSON transcribe
        response
          = receiveNull DeleteMedicalVocabularyResponse'

instance Hashable DeleteMedicalVocabulary where

instance NFData DeleteMedicalVocabulary where
...
instance NFData DeleteMedicalVocabularyResponse where
