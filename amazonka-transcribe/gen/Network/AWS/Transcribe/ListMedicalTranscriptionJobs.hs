...
data ListMedicalTranscriptionJobs = ListMedicalTranscriptionJobs'{_lmtjStatus
                                                                  ::
                                                                  !(Maybe
...
listMedicalTranscriptionJobs
    :: ListMedicalTranscriptionJobs
listMedicalTranscriptionJobs
  = ListMedicalTranscriptionJobs'{_lmtjStatus =
                                    Nothing,
...
instance AWSRequest ListMedicalTranscriptionJobs
         where
...
instance Hashable ListMedicalTranscriptionJobs where

instance NFData ListMedicalTranscriptionJobs where
...
data ListMedicalTranscriptionJobsResponse = ListMedicalTranscriptionJobsResponse'{_lmtjrsStatus
                                                                                  ::
                                                                                  !(Maybe
                                                                                      TranscriptionJobStatus),
                                                                                  _lmtjrsNextToken
...
listMedicalTranscriptionJobsResponse
    :: Int -- ^ 'lmtjrsResponseStatus'
    -> ListMedicalTranscriptionJobsResponse
listMedicalTranscriptionJobsResponse pResponseStatus_
  = ListMedicalTranscriptionJobsResponse'{_lmtjrsStatus
                                            = Nothing,
