...
data CreateLanguageModel = CreateLanguageModel'{_clmLanguageCode
                                                :: !CLMLanguageCode,
                                                _clmBaseModelName ::
                                                !BaseModelName,
                                                _clmModelName :: !Text,
...
createLanguageModel
    ...
    -> BaseModelName -- ^ 'clmBaseModelName'
    -> Text -- ^ 'clmModelName'
    -> InputDataConfig -- ^ 'clmInputDataConfig'
    -> CreateLanguageModel
createLanguageModel pLanguageCode_ pBaseModelName_
  pModelName_ pInputDataConfig_
  = CreateLanguageModel'{_clmLanguageCode =
                           pLanguageCode_,
...
instance AWSRequest CreateLanguageModel where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 CreateLanguageModelResponse' <$>
                   (x .?> "LanguageCode") <*> (x .?> "ModelName") <*>
                     (x .?> "InputDataConfig")
                     <*> (x .?> "BaseModelName")
                     <*> (x .?> "ModelStatus")
                     <*> (pure (fromEnum s)))

instance Hashable CreateLanguageModel where

instance NFData CreateLanguageModel where
...
data CreateLanguageModelResponse = CreateLanguageModelResponse'{_clmrsLanguageCode
                                                                ::
                                                                !(Maybe
                                                                    CLMLanguageCode),
                                                                _clmrsModelName
...
createLanguageModelResponse
    :: Int -- ^ 'clmrsResponseStatus'
    -> CreateLanguageModelResponse
createLanguageModelResponse pResponseStatus_
  = CreateLanguageModelResponse'{_clmrsLanguageCode =
                                   Nothing,
...
instance NFData CreateLanguageModelResponse where
