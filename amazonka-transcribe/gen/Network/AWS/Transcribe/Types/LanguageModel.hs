...
data LanguageModel = LanguageModel'{_lmFailureReason
                                    :: !(Maybe Text),
...
languageModel
    :: LanguageModel
languageModel
  = LanguageModel'{_lmFailureReason = Nothing,
                   _lmLanguageCode = Nothing, _lmModelName = Nothing,
                   _lmLastModifiedTime = Nothing,
                   _lmUpgradeAvailability = Nothing,
                   _lmInputDataConfig = Nothing,
                   _lmBaseModelName = Nothing, _lmModelStatus = Nothing,
...
instance Hashable LanguageModel where

instance NFData LanguageModel where
