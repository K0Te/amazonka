...
data ListVocabularyFilters = ListVocabularyFilters'{_lvfNameContains
                                                    :: !(Maybe Text),
                                                    _lvfNextToken ::
                                                    !(Maybe Text),
                                                    _lvfMaxResults ::
...
listVocabularyFilters
    :: ListVocabularyFilters
listVocabularyFilters
  = ListVocabularyFilters'{_lvfNameContains = Nothing,
                           _lvfNextToken = Nothing, _lvfMaxResults = Nothing}
...
instance Hashable ListVocabularyFilters where

instance NFData ListVocabularyFilters where
...
data ListVocabularyFiltersResponse = ListVocabularyFiltersResponse'{_lvfrsNextToken
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
...
listVocabularyFiltersResponse
    :: Int -- ^ 'lvfrsResponseStatus'
    -> ListVocabularyFiltersResponse
listVocabularyFiltersResponse pResponseStatus_
  = ListVocabularyFiltersResponse'{_lvfrsNextToken =
                                     Nothing,
...
instance NFData ListVocabularyFiltersResponse where
