...
data UpdateVocabularyFilter = UpdateVocabularyFilter'{_uvfVocabularyFilterFileURI
                                                      :: !(Maybe Text),
                                                      _uvfWords ::
                                                      !(Maybe (List1 Text)),
...
updateVocabularyFilter
    :: Text -- ^ 'uvfVocabularyFilterName'
    -> UpdateVocabularyFilter
updateVocabularyFilter pVocabularyFilterName_
  = UpdateVocabularyFilter'{_uvfVocabularyFilterFileURI
                              = Nothing,
                            _uvfWords = Nothing,
...
instance AWSRequest UpdateVocabularyFilter where
        type Rs UpdateVocabularyFilter =
             UpdateVocabularyFilterResponse
...
instance Hashable UpdateVocabularyFilter where

instance NFData UpdateVocabularyFilter where
...
data UpdateVocabularyFilterResponse = UpdateVocabularyFilterResponse'{_uvfrsLanguageCode
                                                                      ::
                                                                      !(Maybe
                                                                          LanguageCode),
...
updateVocabularyFilterResponse
    :: Int -- ^ 'uvfrsResponseStatus'
    -> UpdateVocabularyFilterResponse
updateVocabularyFilterResponse pResponseStatus_
  = UpdateVocabularyFilterResponse'{_uvfrsLanguageCode
                                      = Nothing,
...
instance NFData UpdateVocabularyFilterResponse where
