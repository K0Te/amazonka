...
data GetProtocolsList = GetProtocolsList'{_gplDefaultList
                                          :: !(Maybe Bool),
                                          _gplListId :: !Text}
...
getProtocolsList pListId_
  = GetProtocolsList'{_gplDefaultList = Nothing,
                      _gplListId = pListId_}
...
instance Hashable GetProtocolsList where

instance NFData GetProtocolsList where
...
data GetProtocolsListResponse = GetProtocolsListResponse'{_gplrsProtocolsList
                                                          ::
                                                          !(Maybe
                                                              ProtocolsListData),
                                                          _gplrsProtocolsListARN
                                                          :: !(Maybe Text),
                                                          _gplrsResponseStatus
                                                          :: !Int}
...
getProtocolsListResponse
    :: Int -- ^ 'gplrsResponseStatus'
    -> GetProtocolsListResponse
getProtocolsListResponse pResponseStatus_
  = GetProtocolsListResponse'{_gplrsProtocolsList =
                                Nothing,
...
instance NFData GetProtocolsListResponse where
