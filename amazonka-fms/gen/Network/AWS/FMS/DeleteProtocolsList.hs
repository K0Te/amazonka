...
newtype DeleteProtocolsList = DeleteProtocolsList'{_dplListId
                                                   :: Text}
...
instance AWSRequest DeleteProtocolsList where
        type Rs DeleteProtocolsList =
             DeleteProtocolsListResponse
        request = postJSON fms
        response = receiveNull DeleteProtocolsListResponse'

instance Hashable DeleteProtocolsList where

instance NFData DeleteProtocolsList where
...
instance NFData DeleteProtocolsListResponse where
