...
newtype DeleteAppsList = DeleteAppsList'{_dalListId
                                         :: Text}
...
instance Hashable DeleteAppsList where

instance NFData DeleteAppsList where
...
instance NFData DeleteAppsListResponse where
