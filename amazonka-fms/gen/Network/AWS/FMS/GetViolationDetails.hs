...
data GetViolationDetails = GetViolationDetails'{_gvdPolicyId
                                                :: !Text,
...
getViolationDetails
    :: Text -- ^ 'gvdPolicyId'
    -> Text -- ^ 'gvdMemberAccount'
    -> Text -- ^ 'gvdResourceId'
    -> Text -- ^ 'gvdResourceType'
    -> GetViolationDetails
getViolationDetails pPolicyId_ pMemberAccount_
  pResourceId_ pResourceType_
  = GetViolationDetails'{_gvdPolicyId = pPolicyId_,
...
instance Hashable GetViolationDetails where

instance NFData GetViolationDetails where
...
data GetViolationDetailsResponse = GetViolationDetailsResponse'{_gvdrsViolationDetail
                                                                ::
                                                                !(Maybe
                                                                    ViolationDetail),
                                                                _gvdrsResponseStatus
                                                                :: !Int}
...
getViolationDetailsResponse
    :: Int -- ^ 'gvdrsResponseStatus'
    -> GetViolationDetailsResponse
getViolationDetailsResponse pResponseStatus_
  = GetViolationDetailsResponse'{_gvdrsViolationDetail
                                   = Nothing,
...
instance NFData GetViolationDetailsResponse where
