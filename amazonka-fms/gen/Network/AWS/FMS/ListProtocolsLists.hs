...
data ListProtocolsLists = ListProtocolsLists'{_lplDefaultLists
                                              :: !(Maybe Bool),
...
listProtocolsLists
    :: Natural -- ^ 'lplMaxResults'
    -> ListProtocolsLists
listProtocolsLists pMaxResults_
  = ListProtocolsLists'{_lplDefaultLists = Nothing,
...
instance Hashable ListProtocolsLists where

instance NFData ListProtocolsLists where
...
data ListProtocolsListsResponse = ListProtocolsListsResponse'{_lplrsProtocolsLists
                                                              ::
                                                              !(Maybe
                                                                  [ProtocolsListDataSummary]),
                                                              _lplrsNextToken ::
                                                              !(Maybe Text),
                                                              _lplrsResponseStatus
                                                              :: !Int}
...
listProtocolsListsResponse
    :: Int -- ^ 'lplrsResponseStatus'
    -> ListProtocolsListsResponse
listProtocolsListsResponse pResponseStatus_
  = ListProtocolsListsResponse'{_lplrsProtocolsLists =
                                  Nothing,
...
instance NFData ListProtocolsListsResponse where
