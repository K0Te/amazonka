...
data ListAppsLists = ListAppsLists'{_lalDefaultLists
                                    :: !(Maybe Bool),
...
listAppsLists
    :: Natural -- ^ 'lalMaxResults'
    -> ListAppsLists
listAppsLists pMaxResults_
  = ListAppsLists'{_lalDefaultLists = Nothing,
...
instance Hashable ListAppsLists where

instance NFData ListAppsLists where
...
data ListAppsListsResponse = ListAppsListsResponse'{_lalrsNextToken
                                                    :: !(Maybe Text),
                                                    _lalrsAppsLists ::
                                                    !(Maybe
                                                        [AppsListDataSummary]),
                                                    _lalrsResponseStatus ::
                                                    !Int}
...
listAppsListsResponse
    :: Int -- ^ 'lalrsResponseStatus'
    -> ListAppsListsResponse
listAppsListsResponse pResponseStatus_
  = ListAppsListsResponse'{_lalrsNextToken = Nothing,
...
instance NFData ListAppsListsResponse where
