...
data PutProtocolsList = PutProtocolsList'{_pplTagList
                                          :: !(Maybe [Tag]),
                                          _pplProtocolsList ::
                                          !ProtocolsListData}
...
putProtocolsList
    :: ProtocolsListData -- ^ 'pplProtocolsList'
    -> PutProtocolsList
putProtocolsList pProtocolsList_
  = PutProtocolsList'{_pplTagList = Nothing,
...
instance Hashable PutProtocolsList where

instance NFData PutProtocolsList where
...
data PutProtocolsListResponse = PutProtocolsListResponse'{_pplrsProtocolsList
                                                          ::
                                                          !(Maybe
                                                              ProtocolsListData),
                                                          _pplrsProtocolsListARN
                                                          :: !(Maybe Text),
                                                          _pplrsResponseStatus
                                                          :: !Int}
...
putProtocolsListResponse
    :: Int -- ^ 'pplrsResponseStatus'
    -> PutProtocolsListResponse
putProtocolsListResponse pResponseStatus_
  = PutProtocolsListResponse'{_pplrsProtocolsList =
                                Nothing,
...
instance NFData PutProtocolsListResponse where
