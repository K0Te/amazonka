...
data StatelessRuleGroup = StatelessRuleGroup'{_sResourceId
                                              :: !(Maybe Text),
...
statelessRuleGroup
    :: StatelessRuleGroup
statelessRuleGroup
  = StatelessRuleGroup'{_sResourceId = Nothing,
                        _sPriority = Nothing, _sRuleGroupName = Nothing}
...
instance FromJSON StatelessRuleGroup where
        parseJSON
          = withObject "StatelessRuleGroup"
              (\ x ->
                 StatelessRuleGroup' <$>
                   (x .:? "ResourceId") <*> (x .:? "Priority") <*>
                     (x .:? "RuleGroupName"))

instance Hashable StatelessRuleGroup where

instance NFData StatelessRuleGroup where
