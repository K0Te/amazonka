...
data NetworkFirewallMissingFirewallViolation = NetworkFirewallMissingFirewallViolation'{_nfmfvTargetViolationReason
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
...
networkFirewallMissingFirewallViolation
    :: NetworkFirewallMissingFirewallViolation
networkFirewallMissingFirewallViolation
  = NetworkFirewallMissingFirewallViolation'{_nfmfvTargetViolationReason
                                               = Nothing,
