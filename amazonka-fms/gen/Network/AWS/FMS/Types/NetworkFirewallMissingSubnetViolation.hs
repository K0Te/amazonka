...
data NetworkFirewallMissingSubnetViolation = NetworkFirewallMissingSubnetViolation'{_nfmsvTargetViolationReason
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Text),
...
networkFirewallMissingSubnetViolation
    :: NetworkFirewallMissingSubnetViolation
networkFirewallMissingSubnetViolation
  = NetworkFirewallMissingSubnetViolation'{_nfmsvTargetViolationReason
                                             = Nothing,
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "NetworkFirewallMissingSubnetViolation"
              (\ x ->
                 NetworkFirewallMissingSubnetViolation' <$>
