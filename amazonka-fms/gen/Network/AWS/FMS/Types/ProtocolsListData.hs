...
data ProtocolsListData = ProtocolsListData'{_pldListUpdateToken
                                            :: !(Maybe Text),
...
protocolsListData pListName_
  = ProtocolsListData'{_pldListUpdateToken = Nothing,
                       _pldListId = Nothing, _pldLastUpdateTime = Nothing,
                       _pldPreviousProtocolsList = Nothing,
                       _pldCreateTime = Nothing, _pldListName = pListName_,
...
instance Hashable ProtocolsListData where

instance NFData ProtocolsListData where
