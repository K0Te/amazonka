...
data AWSVPCSecurityGroupViolation = AWSVPCSecurityGroupViolation'{_avsgvViolationTargetDescription
                                                                  ::
                                                                  !(Maybe Text),
...
awsVPCSecurityGroupViolation
    :: AWSVPCSecurityGroupViolation
awsVPCSecurityGroupViolation
  = AWSVPCSecurityGroupViolation'{_avsgvViolationTargetDescription
                                    = Nothing,
                                  _avsgvPossibleSecurityGroupRemediationActions
                                    = Nothing,
...
instance FromJSON AWSVPCSecurityGroupViolation where
        parseJSON
          = withObject "AWSVPCSecurityGroupViolation"
              (\ x ->
                 AWSVPCSecurityGroupViolation' <$>
...
instance Hashable AWSVPCSecurityGroupViolation where

instance NFData AWSVPCSecurityGroupViolation where
