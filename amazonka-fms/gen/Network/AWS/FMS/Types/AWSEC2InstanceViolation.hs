...
data AWSEC2InstanceViolation = AWSEC2InstanceViolation'{_aeivViolationTarget
                                                        :: !(Maybe Text),
...
awsEC2InstanceViolation
    :: AWSEC2InstanceViolation
awsEC2InstanceViolation
  = AWSEC2InstanceViolation'{_aeivViolationTarget =
                               Nothing,
...
instance FromJSON AWSEC2InstanceViolation where
        parseJSON
          = withObject "AWSEC2InstanceViolation"
              (\ x ->
                 AWSEC2InstanceViolation' <$>
                   (x .:? "ViolationTarget") <*>
...
instance Hashable AWSEC2InstanceViolation where

instance NFData AWSEC2InstanceViolation where
