...
data NetworkFirewallPolicyDescription = NetworkFirewallPolicyDescription'{_nfpdStatefulRuleGroups
                                                                          ::
                                                                          !(Maybe
                                                                              [StatefulRuleGroup]),
...
networkFirewallPolicyDescription
    :: NetworkFirewallPolicyDescription
networkFirewallPolicyDescription
  = NetworkFirewallPolicyDescription'{_nfpdStatefulRuleGroups
                                        = Nothing,
...
instance FromJSON NetworkFirewallPolicyDescription
         where
        parseJSON
          = withObject "NetworkFirewallPolicyDescription"
              (\ x ->
                 NetworkFirewallPolicyDescription' <$>
