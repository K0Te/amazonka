...
data SecurityGroupRemediationAction = SecurityGroupRemediationAction'{_sgraIsDefaultAction
                                                                      ::
                                                                      !(Maybe
                                                                          Bool),
...
securityGroupRemediationAction
    :: SecurityGroupRemediationAction
securityGroupRemediationAction
  = SecurityGroupRemediationAction'{_sgraIsDefaultAction
                                      = Nothing,
...
instance FromJSON SecurityGroupRemediationAction
         where
        parseJSON
          = withObject "SecurityGroupRemediationAction"
              (\ x ->
                 SecurityGroupRemediationAction' <$>
                   (x .:? "IsDefaultAction") <*>
                     (x .:? "RemediationResult")
...
instance NFData SecurityGroupRemediationAction where
