...
data NetworkFirewallPolicyModifiedViolation = NetworkFirewallPolicyModifiedViolation'{_nfpmvCurrentPolicyDescription
                                                                                      ::
                                                                                      !(Maybe
...
networkFirewallPolicyModifiedViolation
    :: NetworkFirewallPolicyModifiedViolation
networkFirewallPolicyModifiedViolation
  = NetworkFirewallPolicyModifiedViolation'{_nfpmvCurrentPolicyDescription
                                              = Nothing,
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "NetworkFirewallPolicyModifiedViolation"
              (\ x ->
                 NetworkFirewallPolicyModifiedViolation' <$>
