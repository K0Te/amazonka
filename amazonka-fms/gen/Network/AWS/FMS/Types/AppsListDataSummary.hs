...
data AppsListDataSummary = AppsListDataSummary'{_aldsListARN
                                                :: !(Maybe Text),
...
appsListDataSummary
    :: AppsListDataSummary
appsListDataSummary
  = AppsListDataSummary'{_aldsListARN = Nothing,
                         _aldsAppsList = Nothing, _aldsListId = Nothing,
...
instance FromJSON AppsListDataSummary where
        parseJSON
          = withObject "AppsListDataSummary"
              (\ x ->
                 AppsListDataSummary' <$>
                   (x .:? "ListArn") <*> (x .:? "AppsList" .!= mempty)
                     <*> (x .:? "ListId")
                     <*> (x .:? "ListName"))

instance Hashable AppsListDataSummary where

instance NFData AppsListDataSummary where
