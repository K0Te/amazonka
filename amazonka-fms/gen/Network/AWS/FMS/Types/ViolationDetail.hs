...
data ViolationDetail = ViolationDetail'{_vdResourceTags
                                        :: !(Maybe [Tag]),
...
violationDetail
    :: Text -- ^ 'vdPolicyId'
    -> Text -- ^ 'vdMemberAccount'
    -> Text -- ^ 'vdResourceId'
    -> Text -- ^ 'vdResourceType'
    -> ViolationDetail
violationDetail pPolicyId_ pMemberAccount_
  pResourceId_ pResourceType_
  = ViolationDetail'{_vdResourceTags = Nothing,
...
instance Hashable ViolationDetail where

instance NFData ViolationDetail where
