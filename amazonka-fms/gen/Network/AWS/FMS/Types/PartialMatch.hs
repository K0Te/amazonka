...
data PartialMatch = PartialMatch'{_pmTargetViolationReasons
                                  :: !(Maybe [Text]),
...
partialMatch
    :: PartialMatch
partialMatch
  = PartialMatch'{_pmTargetViolationReasons = Nothing,
...
instance NFData PartialMatch where
