...
data ProtocolsListDataSummary = ProtocolsListDataSummary'{_pldsProtocolsList
                                                          :: !(Maybe [Text]),
                                                          _pldsListARN ::
                                                          !(Maybe Text),
                                                          _pldsListId ::
...
protocolsListDataSummary
    :: ProtocolsListDataSummary
protocolsListDataSummary
  = ProtocolsListDataSummary'{_pldsProtocolsList =
                                Nothing,
                              _pldsListARN = Nothing, _pldsListId = Nothing,
...
instance FromJSON ProtocolsListDataSummary where
        parseJSON
          = withObject "ProtocolsListDataSummary"
              (\ x ->
                 ProtocolsListDataSummary' <$>
...
instance Hashable ProtocolsListDataSummary where

instance NFData ProtocolsListDataSummary where
