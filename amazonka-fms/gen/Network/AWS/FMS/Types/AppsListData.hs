...
data AppsListData = AppsListData'{_aldListUpdateToken
                                  :: !(Maybe Text),
                                  ...
                                  _aldListName :: !Text, _aldAppsList :: ![App]}
...
appsListData pListName_
  = AppsListData'{_aldListUpdateToken = Nothing,
                  _aldListId = Nothing, _aldLastUpdateTime = Nothing,
                  _aldPreviousAppsList = Nothing,
                  _aldCreateTime = Nothing, _aldListName = pListName_,
                  _aldAppsList = mempty}
...
instance FromJSON AppsListData where
        parseJSON
          = withObject "AppsListData"
              (\ x ->
                 AppsListData' <$>
                   (x .:? "ListUpdateToken") <*> (x .:? "ListId") <*>
                     (x .:? "LastUpdateTime")
...
instance Hashable AppsListData where

instance NFData AppsListData where
