...
data AWSEC2NetworkInterfaceViolation = AWSEC2NetworkInterfaceViolation'{_aenivViolatingSecurityGroups
                                                                        ::
                                                                        !(Maybe
                                                                            [Text]),
...
awsEC2NetworkInterfaceViolation
    :: AWSEC2NetworkInterfaceViolation
awsEC2NetworkInterfaceViolation
  = AWSEC2NetworkInterfaceViolation'{_aenivViolatingSecurityGroups
                                       = Nothing,
...
instance FromJSON AWSEC2NetworkInterfaceViolation
         where
        parseJSON
          = withObject "AWSEC2NetworkInterfaceViolation"
              (\ x ->
                 AWSEC2NetworkInterfaceViolation' <$>
...
instance NFData AWSEC2NetworkInterfaceViolation where
