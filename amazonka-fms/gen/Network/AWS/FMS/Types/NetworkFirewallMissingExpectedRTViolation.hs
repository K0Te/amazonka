...
data NetworkFirewallMissingExpectedRTViolation = NetworkFirewallMissingExpectedRTViolation'{_nfmertvCurrentRouteTable
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
...
networkFirewallMissingExpectedRTViolation
    :: NetworkFirewallMissingExpectedRTViolation
networkFirewallMissingExpectedRTViolation
  = NetworkFirewallMissingExpectedRTViolation'{_nfmertvCurrentRouteTable
                                                 = Nothing,
                                               _nfmertvAvailabilityZone =
                                                 Nothing,
                                               _nfmertvVPC = Nothing,
