...
data GetAppsList = GetAppsList'{_galDefaultList ::
                                !(Maybe Bool),
                                _galListId :: !Text}
...
getAppsList pListId_
  = GetAppsList'{_galDefaultList = Nothing,
                 _galListId = pListId_}
...
instance Hashable GetAppsList where

instance NFData GetAppsList where
...
data GetAppsListResponse = GetAppsListResponse'{_galrsAppsListARN
                                                :: !(Maybe Text),
                                                _galrsAppsList ::
                                                !(Maybe AppsListData),
...
getAppsListResponse pResponseStatus_
  = GetAppsListResponse'{_galrsAppsListARN = Nothing,
...
instance NFData GetAppsListResponse where
