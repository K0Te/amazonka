...
data ListMemberAccounts = ListMemberAccounts'{_lmaNextToken
                                              :: !(Maybe Text),
...
listMemberAccounts
    :: ListMemberAccounts
listMemberAccounts
  = ListMemberAccounts'{_lmaNextToken = Nothing,
...
instance AWSPager ListMemberAccounts where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lmaNextToken .~ rs ^. lmarsNextToken

instance AWSRequest ListMemberAccounts where
        type Rs ListMemberAccounts =
             ListMemberAccountsResponse
...
instance Hashable ListMemberAccounts where

instance NFData ListMemberAccounts where
...
data ListMemberAccountsResponse = ListMemberAccountsResponse'{_lmarsNextToken
                                                              :: !(Maybe Text),
                                                              _lmarsMemberAccounts
                                                              ::
                                                              !(Maybe [Text]),
                                                              _lmarsResponseStatus
                                                              :: !Int}
...
listMemberAccountsResponse
    :: Int -- ^ 'lmarsResponseStatus'
    -> ListMemberAccountsResponse
listMemberAccountsResponse pResponseStatus_
  = ListMemberAccountsResponse'{_lmarsNextToken =
                                  Nothing,
...
instance NFData ListMemberAccountsResponse where
