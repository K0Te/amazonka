...
data ModifyAccount = ModifyAccount'{_maDedicatedTenancySupport
...
modifyAccount
    :: ModifyAccount
modifyAccount
  = ModifyAccount'{_maDedicatedTenancySupport =
                     Nothing,
...
newtype ModifyAccountResponse = ModifyAccountResponse'{_marsResponseStatus
                                                       :: Int}
...
modifyAccountResponse pResponseStatus_
  = ModifyAccountResponse'{_marsResponseStatus =
                             pResponseStatus_}
