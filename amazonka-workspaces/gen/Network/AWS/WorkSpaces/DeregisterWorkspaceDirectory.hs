...
newtype DeregisterWorkspaceDirectory = DeregisterWorkspaceDirectory'{_dwdDirectoryId
                                                                     :: Text}
...
deregisterWorkspaceDirectory pDirectoryId_
  = DeregisterWorkspaceDirectory'{_dwdDirectoryId =
                                    pDirectoryId_}
...
instance AWSRequest DeregisterWorkspaceDirectory
         where
...
instance Hashable DeregisterWorkspaceDirectory where

instance NFData DeregisterWorkspaceDirectory where
...
newtype DeregisterWorkspaceDirectoryResponse = DeregisterWorkspaceDirectoryResponse'{_drsResponseStatus
                                                                                     ::
                                                                                     Int}
                                                 deriving (Eq, Read, Show, Data,
                                                           Typeable, Generic)
...
deregisterWorkspaceDirectoryResponse pResponseStatus_
  = DeregisterWorkspaceDirectoryResponse'{_drsResponseStatus
                                            = pResponseStatus_}
