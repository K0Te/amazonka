...
data ConnectionAliasAssociation = ConnectionAliasAssociation'{_caaAssociatedAccountId
                                                              :: !(Maybe Text),
                                                              _caaResourceId ::
                                                              !(Maybe Text),
...
connectionAliasAssociation
    :: ConnectionAliasAssociation
connectionAliasAssociation
  = ConnectionAliasAssociation'{_caaAssociatedAccountId
                                  = Nothing,
...
instance FromJSON ConnectionAliasAssociation where
        parseJSON
          = withObject "ConnectionAliasAssociation"
              (\ x ->
                 ConnectionAliasAssociation' <$>
...
instance Hashable ConnectionAliasAssociation where

instance NFData ConnectionAliasAssociation where
