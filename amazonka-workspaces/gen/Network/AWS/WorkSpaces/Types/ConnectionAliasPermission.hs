...
data ConnectionAliasPermission = ConnectionAliasPermission'{_capSharedAccountId
                                                            :: !Text,
...
connectionAliasPermission
    :: Text -- ^ 'capSharedAccountId'
    -> Bool -- ^ 'capAllowAssociation'
    -> ConnectionAliasPermission
connectionAliasPermission pSharedAccountId_
  pAllowAssociation_
  = ConnectionAliasPermission'{_capSharedAccountId =
                                 pSharedAccountId_,
...
instance FromJSON ConnectionAliasPermission where
        parseJSON
          = withObject "ConnectionAliasPermission"
              (\ x ->
                 ConnectionAliasPermission' <$>
                   (x .: "SharedAccountId") <*>
                     (x .: "AllowAssociation"))

instance Hashable ConnectionAliasPermission where

instance NFData ConnectionAliasPermission where
