...
newtype DisassociateConnectionAlias = DisassociateConnectionAlias'{_dcaAliasId
                                                                   :: Text}
...
disassociateConnectionAlias pAliasId_
  = DisassociateConnectionAlias'{_dcaAliasId =
                                   pAliasId_}
...
instance Hashable DisassociateConnectionAlias where

instance NFData DisassociateConnectionAlias where
...
newtype DisassociateConnectionAliasResponse = DisassociateConnectionAliasResponse'{_dcasrsResponseStatus
                                                                                   ::
                                                                                   Int}
                                                deriving (Eq, Read, Show, Data,
                                                          Typeable, Generic)
...
disassociateConnectionAliasResponse pResponseStatus_
  = DisassociateConnectionAliasResponse'{_dcasrsResponseStatus
                                           = pResponseStatus_}
