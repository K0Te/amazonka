...
data DescribeWorkspaceImagePermissions = DescribeWorkspaceImagePermissions'{_dwipNextToken
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _dwipMaxResults
...
describeWorkspaceImagePermissions pImageId_
  = DescribeWorkspaceImagePermissions'{_dwipNextToken =
                                         Nothing,
...
instance AWSRequest DescribeWorkspaceImagePermissions
         where
        type Rs DescribeWorkspaceImagePermissions =
             DescribeWorkspaceImagePermissionsResponse
...
instance ToHeaders DescribeWorkspaceImagePermissions
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DescribeWorkspaceImagePermissions
         where
...
instance ToPath DescribeWorkspaceImagePermissions
         where
        toPath = const "/"

instance ToQuery DescribeWorkspaceImagePermissions
         where
        toQuery = const mempty

-- | /See:/ 'describeWorkspaceImagePermissionsResponse' smart constructor.
data DescribeWorkspaceImagePermissionsResponse = DescribeWorkspaceImagePermissionsResponse'{_dwiprsImagePermissions
                                                                                            ::
                                                                                            !(Maybe
                                                                                                [ImagePermission]),
                                                                                            _dwiprsNextToken
...
describeWorkspaceImagePermissionsResponse
    :: Int -- ^ 'dwiprsResponseStatus'
    -> DescribeWorkspaceImagePermissionsResponse
describeWorkspaceImagePermissionsResponse
  pResponseStatus_
  = DescribeWorkspaceImagePermissionsResponse'{_dwiprsImagePermissions
                                                 = Nothing,
