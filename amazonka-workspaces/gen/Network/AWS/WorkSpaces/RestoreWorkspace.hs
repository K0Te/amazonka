...
newtype RestoreWorkspace = RestoreWorkspace'{_rwWorkspaceId
                                             :: Text}
...
instance Hashable RestoreWorkspace where

instance NFData RestoreWorkspace where
...
newtype RestoreWorkspaceResponse = RestoreWorkspaceResponse'{_resrsResponseStatus
                                                             :: Int}
...
restoreWorkspaceResponse
    :: Int -- ^ 'resrsResponseStatus'
    -> RestoreWorkspaceResponse
restoreWorkspaceResponse pResponseStatus_
  = RestoreWorkspaceResponse'{_resrsResponseStatus =
                                pResponseStatus_}
...
instance NFData RestoreWorkspaceResponse where
