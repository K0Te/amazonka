...
data ListAvailableManagementCidrRanges = ListAvailableManagementCidrRanges'{_lamcrNextToken
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _lamcrMaxResults
...
listAvailableManagementCidrRanges
    :: Text -- ^ 'lamcrManagementCidrRangeConstraint'
    -> ListAvailableManagementCidrRanges
listAvailableManagementCidrRanges
  pManagementCidrRangeConstraint_
  = ListAvailableManagementCidrRanges'{_lamcrNextToken
                                         = Nothing,
...
instance AWSPager ListAvailableManagementCidrRanges
         where
        page rq rs
          | stop (rs ^. lamcrrsNextToken) = Nothing
          | stop (rs ^. lamcrrsManagementCidrRanges) = Nothing
          | otherwise =
            Just $ rq & lamcrNextToken .~ rs ^. lamcrrsNextToken

instance AWSRequest ListAvailableManagementCidrRanges
         where
...
instance ToHeaders ListAvailableManagementCidrRanges
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON ListAvailableManagementCidrRanges
         where
...
instance ToPath ListAvailableManagementCidrRanges
         where
        toPath = const "/"

instance ToQuery ListAvailableManagementCidrRanges
         where
        toQuery = const mempty

-- | /See:/ 'listAvailableManagementCidrRangesResponse' smart constructor.
data ListAvailableManagementCidrRangesResponse = ListAvailableManagementCidrRangesResponse'{_lamcrrsManagementCidrRanges
                                                                                            ::
                                                                                            !(Maybe
                                                                                                [Text]),
                                                                                            _lamcrrsNextToken
...
listAvailableManagementCidrRangesResponse
    :: Int -- ^ 'lamcrrsResponseStatus'
    -> ListAvailableManagementCidrRangesResponse
listAvailableManagementCidrRangesResponse
  pResponseStatus_
  = ListAvailableManagementCidrRangesResponse'{_lamcrrsManagementCidrRanges
                                                 = Nothing,
