...
data DescribeConnectionAliasPermissions = DescribeConnectionAliasPermissions'{_dcapNextToken
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
                                                                              _dcapMaxResults
...
describeConnectionAliasPermissions pAliasId_
  = DescribeConnectionAliasPermissions'{_dcapNextToken
                                          = Nothing,
...
instance ToHeaders DescribeConnectionAliasPermissions
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DescribeConnectionAliasPermissions
         where
...
instance ToPath DescribeConnectionAliasPermissions
         where
        toPath = const "/"

instance ToQuery DescribeConnectionAliasPermissions
         where
        toQuery = const mempty

-- | /See:/ 'describeConnectionAliasPermissionsResponse' smart constructor.
data DescribeConnectionAliasPermissionsResponse = DescribeConnectionAliasPermissionsResponse'{_dcaprsAliasId
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  Text),
                                                                                              _dcaprsNextToken
...
describeConnectionAliasPermissionsResponse
    :: Int -- ^ 'dcaprsResponseStatus'
    -> DescribeConnectionAliasPermissionsResponse
describeConnectionAliasPermissionsResponse
  pResponseStatus_
  = DescribeConnectionAliasPermissionsResponse'{_dcaprsAliasId
                                                  = Nothing,
