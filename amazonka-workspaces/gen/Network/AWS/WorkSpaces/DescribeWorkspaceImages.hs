...
data DescribeWorkspaceImages = DescribeWorkspaceImages'{_dwiImageIds
                                                        ::
                                                        !(Maybe (List1 Text)),
                                                        _dwiNextToken ::
                                                        !(Maybe Text),
...
describeWorkspaceImages
    :: DescribeWorkspaceImages
describeWorkspaceImages
  = DescribeWorkspaceImages'{_dwiImageIds = Nothing,
                             _dwiNextToken = Nothing, _dwiImageType = Nothing,
...
data DescribeWorkspaceImagesResponse = DescribeWorkspaceImagesResponse'{_dwirsImages
                                                                        ::
                                                                        !(Maybe
                                                                            [WorkspaceImage]),
                                                                        _dwirsNextToken
...
describeWorkspaceImagesResponse pResponseStatus_
  = DescribeWorkspaceImagesResponse'{_dwirsImages =
                                       Nothing,
