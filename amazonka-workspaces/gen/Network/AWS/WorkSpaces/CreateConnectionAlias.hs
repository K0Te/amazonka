...
data CreateConnectionAlias = CreateConnectionAlias'{_ccaTags
                                                    :: !(Maybe [Tag]),
...
createConnectionAlias
    :: Text -- ^ 'ccaConnectionString'
    -> CreateConnectionAlias
createConnectionAlias pConnectionString_
  = CreateConnectionAlias'{_ccaTags = Nothing,
...
instance Hashable CreateConnectionAlias where

instance NFData CreateConnectionAlias where
...
data CreateConnectionAliasResponse = CreateConnectionAliasResponse'{_ccarsAliasId
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
...
createConnectionAliasResponse pResponseStatus_
  = CreateConnectionAliasResponse'{_ccarsAliasId =
                                     Nothing,
...
instance NFData CreateConnectionAliasResponse where
