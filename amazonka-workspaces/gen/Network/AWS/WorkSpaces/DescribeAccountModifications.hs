...
newtype DescribeAccountModifications = DescribeAccountModifications'{_damNextToken
                                                                     ::
                                                                     Maybe Text}
...
describeAccountModifications
    :: DescribeAccountModifications
describeAccountModifications
  = DescribeAccountModifications'{_damNextToken =
                                    Nothing}
...
data DescribeAccountModificationsResponse = DescribeAccountModificationsResponse'{_damrsAccountModifications
                                                                                  ::
                                                                                  !(Maybe
                                                                                      [AccountModification]),
                                                                                  _damrsNextToken
...
describeAccountModificationsResponse pResponseStatus_
  = DescribeAccountModificationsResponse'{_damrsAccountModifications
                                            = Nothing,
