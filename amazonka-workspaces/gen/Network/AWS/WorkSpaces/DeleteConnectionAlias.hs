...
newtype DeleteConnectionAlias = DeleteConnectionAlias'{_dAliasId
                                                       :: Text}
...
instance Hashable DeleteConnectionAlias where

instance NFData DeleteConnectionAlias where
...
newtype DeleteConnectionAliasResponse = DeleteConnectionAliasResponse'{_dcarsResponseStatus
                                                                       :: Int}
...
deleteConnectionAliasResponse pResponseStatus_
  = DeleteConnectionAliasResponse'{_dcarsResponseStatus
                                     = pResponseStatus_}
...
instance NFData DeleteConnectionAliasResponse where
