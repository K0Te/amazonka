...
newtype DeleteWorkspaceImage = DeleteWorkspaceImage'{_dwiImageId
                                                     :: Text}
...
newtype DeleteWorkspaceImageResponse = DeleteWorkspaceImageResponse'{_delrsResponseStatus
                                                                     :: Int}
...
deleteWorkspaceImageResponse pResponseStatus_
  = DeleteWorkspaceImageResponse'{_delrsResponseStatus
                                    = pResponseStatus_}
