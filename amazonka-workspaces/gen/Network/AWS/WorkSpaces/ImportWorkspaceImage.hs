...
data ImportWorkspaceImage = ImportWorkspaceImage'{_iwiApplications
                                                  ::
...
importWorkspaceImage
    ...
    -> ImportWorkspaceImage
importWorkspaceImage pEC2ImageId_ pIngestionProcess_
  pImageName_ pImageDescription_
  = ImportWorkspaceImage'{_iwiApplications = Nothing,
                          _iwiTags = Nothing, _iwiEC2ImageId = pEC2ImageId_,
...
data ImportWorkspaceImageResponse = ImportWorkspaceImageResponse'{_iwirsImageId
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _iwirsResponseStatus
                                                                  :: !Int}
...
importWorkspaceImageResponse pResponseStatus_
  = ImportWorkspaceImageResponse'{_iwirsImageId =
                                    Nothing,
