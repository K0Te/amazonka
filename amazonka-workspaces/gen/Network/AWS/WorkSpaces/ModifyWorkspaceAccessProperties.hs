...
data ModifyWorkspaceAccessProperties = ModifyWorkspaceAccessProperties'{_mwapResourceId
                                                                        ::
                                                                        !Text,
...
modifyWorkspaceAccessProperties
    :: Text -- ^ 'mwapResourceId'
    -> WorkspaceAccessProperties -- ^ 'mwapWorkspaceAccessProperties'
    -> ModifyWorkspaceAccessProperties
modifyWorkspaceAccessProperties pResourceId_
  pWorkspaceAccessProperties_
  = ModifyWorkspaceAccessProperties'{_mwapResourceId =
                                       pResourceId_,
                                     _mwapWorkspaceAccessProperties =
                                       pWorkspaceAccessProperties_}
...
instance AWSRequest ModifyWorkspaceAccessProperties
         where
...
instance NFData ModifyWorkspaceAccessProperties where

instance ToHeaders ModifyWorkspaceAccessProperties
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery ModifyWorkspaceAccessProperties
         where
        toQuery = const mempty

-- | /See:/ 'modifyWorkspaceAccessPropertiesResponse' smart constructor.
newtype ModifyWorkspaceAccessPropertiesResponse = ModifyWorkspaceAccessPropertiesResponse'{_mwaprsResponseStatus
                                                                                           ::
                                                                                           Int}
...
modifyWorkspaceAccessPropertiesResponse
    :: Int -- ^ 'mwaprsResponseStatus'
    -> ModifyWorkspaceAccessPropertiesResponse
modifyWorkspaceAccessPropertiesResponse
  pResponseStatus_
  = ModifyWorkspaceAccessPropertiesResponse'{_mwaprsResponseStatus
                                               = pResponseStatus_}
