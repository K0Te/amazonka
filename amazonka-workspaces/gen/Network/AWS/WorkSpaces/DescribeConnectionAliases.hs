...
data DescribeConnectionAliases = DescribeConnectionAliases'{_dcaResourceId
                                                            :: !(Maybe Text),
                                                            _dcaAliasIds ::
                                                            !(Maybe
                                                                (List1 Text)),
...
describeConnectionAliases
    :: DescribeConnectionAliases
describeConnectionAliases
  = DescribeConnectionAliases'{_dcaResourceId =
                                 Nothing,
                               _dcaAliasIds = Nothing, _dcaNextToken = Nothing,
                               _dcaLimit = Nothing}
...
instance AWSRequest DescribeConnectionAliases where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribeConnectionAliasesResponse' <$>
                   (x .?> "ConnectionAliases") <*> (x .?> "NextToken")
                     <*> (pure (fromEnum s)))

instance Hashable DescribeConnectionAliases where

instance NFData DescribeConnectionAliases where
...
data DescribeConnectionAliasesResponse = DescribeConnectionAliasesResponse'{_desrsConnectionAliases
                                                                            ::
                                                                            !(Maybe
                                                                                (List1
                                                                                   ConnectionAlias)),
...
describeConnectionAliasesResponse pResponseStatus_
  = DescribeConnectionAliasesResponse'{_desrsConnectionAliases
                                         = Nothing,
