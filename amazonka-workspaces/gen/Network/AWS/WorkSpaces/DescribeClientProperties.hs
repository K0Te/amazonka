...
newtype DescribeClientProperties = DescribeClientProperties'{_dcpResourceIds
                                                             :: List1 Text}
...
describeClientProperties
    :: NonEmpty Text -- ^ 'dcpResourceIds'
    -> DescribeClientProperties
describeClientProperties pResourceIds_
  = DescribeClientProperties'{_dcpResourceIds =
...
instance AWSRequest DescribeClientProperties where
        type Rs DescribeClientProperties =
             DescribeClientPropertiesResponse
...
instance Hashable DescribeClientProperties where

instance NFData DescribeClientProperties where
...
data DescribeClientPropertiesResponse = DescribeClientPropertiesResponse'{_dcprsClientPropertiesList
                                                                          ::
                                                                          !(Maybe
...
describeClientPropertiesResponse pResponseStatus_
  = DescribeClientPropertiesResponse'{_dcprsClientPropertiesList
                                        = Nothing,
