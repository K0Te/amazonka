...
data ModifyClientProperties = ModifyClientProperties'{_mcpResourceId
                                                      :: !Text,
...
modifyClientProperties
    ...
    -> ModifyClientProperties
modifyClientProperties pResourceId_
  pClientProperties_
  = ModifyClientProperties'{_mcpResourceId =
                              pResourceId_,
...
newtype ModifyClientPropertiesResponse = ModifyClientPropertiesResponse'{_mcprsResponseStatus
                                                                         :: Int}
...
modifyClientPropertiesResponse pResponseStatus_
  = ModifyClientPropertiesResponse'{_mcprsResponseStatus
                                      = pResponseStatus_}
