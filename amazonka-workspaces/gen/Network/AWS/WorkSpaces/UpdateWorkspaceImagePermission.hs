...
data UpdateWorkspaceImagePermission = UpdateWorkspaceImagePermission'{_uwipImageId
                                                                      :: !Text,
                                                                      _uwipAllowCopyImage
                                                                      :: !Bool,
...
updateWorkspaceImagePermission
    :: Text -- ^ 'uwipImageId'
    -> Bool -- ^ 'uwipAllowCopyImage'
    -> Text -- ^ 'uwipSharedAccountId'
    -> UpdateWorkspaceImagePermission
updateWorkspaceImagePermission pImageId_
  pAllowCopyImage_ pSharedAccountId_
  = UpdateWorkspaceImagePermission'{_uwipImageId =
                                      pImageId_,
...
instance AWSRequest UpdateWorkspaceImagePermission
         where
...
instance NFData UpdateWorkspaceImagePermission where

instance ToHeaders UpdateWorkspaceImagePermission
         where
        toHeaders
          = const
              (mconcat
...
newtype UpdateWorkspaceImagePermissionResponse = UpdateWorkspaceImagePermissionResponse'{_uwiprsResponseStatus
                                                                                         ::
                                                                                         Int}
...
updateWorkspaceImagePermissionResponse
    :: Int -- ^ 'uwiprsResponseStatus'
    -> UpdateWorkspaceImagePermissionResponse
updateWorkspaceImagePermissionResponse
  pResponseStatus_
  = UpdateWorkspaceImagePermissionResponse'{_uwiprsResponseStatus
                                              = pResponseStatus_}
