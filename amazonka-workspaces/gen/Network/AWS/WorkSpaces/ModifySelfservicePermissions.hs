...
data ModifySelfservicePermissions = ModifySelfservicePermissions'{_mspResourceId
                                                                  :: !Text,
...
modifySelfservicePermissions
    :: Text -- ^ 'mspResourceId'
    -> SelfservicePermissions -- ^ 'mspSelfservicePermissions'
    -> ModifySelfservicePermissions
modifySelfservicePermissions pResourceId_
  pSelfservicePermissions_
  = ModifySelfservicePermissions'{_mspResourceId =
                                    pResourceId_,
                                  _mspSelfservicePermissions =
                                    pSelfservicePermissions_}
...
instance AWSRequest ModifySelfservicePermissions
         where
...
instance Hashable ModifySelfservicePermissions where

instance NFData ModifySelfservicePermissions where
...
newtype ModifySelfservicePermissionsResponse = ModifySelfservicePermissionsResponse'{_msprsResponseStatus
                                                                                     ::
                                                                                     Int}
...
modifySelfservicePermissionsResponse
    :: Int -- ^ 'msprsResponseStatus'
    -> ModifySelfservicePermissionsResponse
modifySelfservicePermissionsResponse pResponseStatus_
  = ModifySelfservicePermissionsResponse'{_msprsResponseStatus
                                            = pResponseStatus_}
