...
newtype DescribeWorkspaceSnapshots = DescribeWorkspaceSnapshots'{_dwsWorkspaceId
                                                                 :: Text}
...
describeWorkspaceSnapshots pWorkspaceId_
  = DescribeWorkspaceSnapshots'{_dwsWorkspaceId =
                                  pWorkspaceId_}
...
instance Hashable DescribeWorkspaceSnapshots where

instance NFData DescribeWorkspaceSnapshots where
...
data DescribeWorkspaceSnapshotsResponse = DescribeWorkspaceSnapshotsResponse'{_dwsrsRestoreSnapshots
                                                                              ::
                                                                              !(Maybe
                                                                                  [Snapshot]),
...
describeWorkspaceSnapshotsResponse pResponseStatus_
  = DescribeWorkspaceSnapshotsResponse'{_dwsrsRestoreSnapshots
                                          = Nothing,
