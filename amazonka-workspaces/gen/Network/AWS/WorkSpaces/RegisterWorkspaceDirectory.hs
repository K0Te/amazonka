...
data RegisterWorkspaceDirectory = RegisterWorkspaceDirectory'{_rwdSubnetIds
                                                              ::
                                                              !(Maybe [Text]),
...
registerWorkspaceDirectory
    :: Text -- ^ 'rwdDirectoryId'
    -> Bool -- ^ 'rwdEnableWorkDocs'
    -> RegisterWorkspaceDirectory
registerWorkspaceDirectory pDirectoryId_
  pEnableWorkDocs_
  = RegisterWorkspaceDirectory'{_rwdSubnetIds =
                                  Nothing,
                                _rwdEnableSelfService = Nothing,
                                _rwdTenancy = Nothing, _rwdTags = Nothing,
...
instance Hashable RegisterWorkspaceDirectory where

instance NFData RegisterWorkspaceDirectory where
...
newtype RegisterWorkspaceDirectoryResponse = RegisterWorkspaceDirectoryResponse'{_rwdrsResponseStatus
                                                                                 ::
                                                                                 Int}
...
registerWorkspaceDirectoryResponse
    :: Int -- ^ 'rwdrsResponseStatus'
    -> RegisterWorkspaceDirectoryResponse
registerWorkspaceDirectoryResponse pResponseStatus_
  = RegisterWorkspaceDirectoryResponse'{_rwdrsResponseStatus
                                          = pResponseStatus_}
