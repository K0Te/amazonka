...
data UpdateConnectionAliasPermission = UpdateConnectionAliasPermission'{_ucapAliasId
                                                                        ::
                                                                        !Text,
...
updateConnectionAliasPermission
    :: Text -- ^ 'ucapAliasId'
    -> ConnectionAliasPermission -- ^ 'ucapConnectionAliasPermission'
    -> UpdateConnectionAliasPermission
updateConnectionAliasPermission pAliasId_
  pConnectionAliasPermission_
  = UpdateConnectionAliasPermission'{_ucapAliasId =
                                       pAliasId_,
                                     _ucapConnectionAliasPermission =
                                       pConnectionAliasPermission_}
...
instance AWSRequest UpdateConnectionAliasPermission
         where
...
instance NFData UpdateConnectionAliasPermission where

instance ToHeaders UpdateConnectionAliasPermission
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery UpdateConnectionAliasPermission
         where
        toQuery = const mempty

-- | /See:/ 'updateConnectionAliasPermissionResponse' smart constructor.
newtype UpdateConnectionAliasPermissionResponse = UpdateConnectionAliasPermissionResponse'{_ucaprsResponseStatus
                                                                                           ::
                                                                                           Int}
...
updateConnectionAliasPermissionResponse
    :: Int -- ^ 'ucaprsResponseStatus'
    -> UpdateConnectionAliasPermissionResponse
updateConnectionAliasPermissionResponse
  pResponseStatus_
  = UpdateConnectionAliasPermissionResponse'{_ucaprsResponseStatus
                                               = pResponseStatus_}
