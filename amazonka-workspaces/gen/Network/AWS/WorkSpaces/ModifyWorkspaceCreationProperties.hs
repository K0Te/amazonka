...
data ModifyWorkspaceCreationProperties = ModifyWorkspaceCreationProperties'{_mwcpResourceId
                                                                            ::
                                                                            !Text,
...
modifyWorkspaceCreationProperties
    :: Text -- ^ 'mwcpResourceId'
    -> WorkspaceCreationProperties -- ^ 'mwcpWorkspaceCreationProperties'
    -> ModifyWorkspaceCreationProperties
modifyWorkspaceCreationProperties pResourceId_
  pWorkspaceCreationProperties_
  = ModifyWorkspaceCreationProperties'{_mwcpResourceId
                                         = pResourceId_,
                                       _mwcpWorkspaceCreationProperties =
                                         pWorkspaceCreationProperties_}
...
instance AWSRequest ModifyWorkspaceCreationProperties
         where
...
instance ToHeaders ModifyWorkspaceCreationProperties
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON ModifyWorkspaceCreationProperties
         where
...
instance ToPath ModifyWorkspaceCreationProperties
         where
        toPath = const "/"

instance ToQuery ModifyWorkspaceCreationProperties
         where
        toQuery = const mempty

-- | /See:/ 'modifyWorkspaceCreationPropertiesResponse' smart constructor.
newtype ModifyWorkspaceCreationPropertiesResponse = ModifyWorkspaceCreationPropertiesResponse'{_mwcprsResponseStatus
                                                                                               ::
                                                                                               Int}
...
modifyWorkspaceCreationPropertiesResponse
    :: Int -- ^ 'mwcprsResponseStatus'
    -> ModifyWorkspaceCreationPropertiesResponse
modifyWorkspaceCreationPropertiesResponse
  pResponseStatus_
  = ModifyWorkspaceCreationPropertiesResponse'{_mwcprsResponseStatus
                                                 = pResponseStatus_}
