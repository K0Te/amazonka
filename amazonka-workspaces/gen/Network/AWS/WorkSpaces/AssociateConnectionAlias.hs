...
data AssociateConnectionAlias = AssociateConnectionAlias'{_acaAliasId
                                                          :: !Text,
                                                          _acaResourceId ::
                                                          !Text}
...
associateConnectionAlias pAliasId_ pResourceId_
  = AssociateConnectionAlias'{_acaAliasId = pAliasId_,
...
instance AWSRequest AssociateConnectionAlias where
        type Rs AssociateConnectionAlias =
             AssociateConnectionAliasResponse
...
instance Hashable AssociateConnectionAlias where

instance NFData AssociateConnectionAlias where
...
data AssociateConnectionAliasResponse = AssociateConnectionAliasResponse'{_acarsConnectionIdentifier
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
associateConnectionAliasResponse pResponseStatus_
  = AssociateConnectionAliasResponse'{_acarsConnectionIdentifier
                                        = Nothing,
