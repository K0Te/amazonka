...
getBucketIntelligentTieringConfiguration
    ...
    -> Text -- ^ 'gbitcId'
    -> GetBucketIntelligentTieringConfiguration
getBucketIntelligentTieringConfiguration pBucket_
  pId_
  = GetBucketIntelligentTieringConfiguration'{_gbitcBucket
                                                = pBucket_,
                                              _gbitcId = pId_}
...
getBucketIntelligentTieringConfigurationResponse
  pResponseStatus_
  = GetBucketIntelligentTieringConfigurationResponse'{_gbitcrsIntelligentTieringConfiguration
                                                        = Nothing,
                                                      _gbitcrsResponseStatus =
                                                        pResponseStatus_}
