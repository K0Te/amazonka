...
putObjectRetention pBucket_ pKey_
  = PutObjectRetention'{_porRetention = Nothing,
                        _porVersionId = Nothing, _porRequestPayer = Nothing,
                        _porContentMD5 = Nothing,
                        _porBypassGovernanceRetention = Nothing,
                        _porExpectedBucketOwner = Nothing,
                        _porBucket = pBucket_, _porKey = pKey_}
...
putObjectRetentionResponse pResponseStatus_
  = PutObjectRetentionResponse'{_porrsRequestCharged =
                                  Nothing,
