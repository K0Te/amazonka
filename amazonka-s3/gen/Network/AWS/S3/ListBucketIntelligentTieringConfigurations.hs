...
listBucketIntelligentTieringConfigurations pBucket_
  = ListBucketIntelligentTieringConfigurations'{_lbitcContinuationToken
                                                  = Nothing,
        ...
        response
          = receiveXML
              (\ s h x ->
                 ListBucketIntelligentTieringConfigurationsResponse'
                   <$>
                   (may (parseXMLList "IntelligentTieringConfiguration")
                      x)
                     <*> (x .@? "ContinuationToken")
...
listBucketIntelligentTieringConfigurationsResponse
  pResponseStatus_
  = ListBucketIntelligentTieringConfigurationsResponse'{_lbitcrsIntelligentTieringConfigurationList
                                                          = Nothing,
                                                        _lbitcrsContinuationToken
                                                          = Nothing,
                                                        _lbitcrsNextContinuationToken
