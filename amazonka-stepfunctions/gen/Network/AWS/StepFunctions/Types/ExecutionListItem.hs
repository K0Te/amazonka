...
data ExecutionListItem = ExecutionListItem'{_eliStopDate
                                            :: !(Maybe POSIX),
...
executionListItem
    ...
    -> ExecutionListItem
executionListItem pExecutionARN_ pStateMachineARN_
  pName_ pStatus_ pStartDate_
  = ExecutionListItem'{_eliStopDate = Nothing,
                       _eliExecutionARN = pExecutionARN_,
                       _eliStateMachineARN = pStateMachineARN_,
                       _eliName = pName_, _eliStatus = pStatus_,
