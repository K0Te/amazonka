...
newtype HistoryEventExecutionDataDetails = HistoryEventExecutionDataDetails'{_heeddTruncated
                                                                             ::
                                                                             Maybe
                                                                               Bool}
...
historyEventExecutionDataDetails
    :: HistoryEventExecutionDataDetails
historyEventExecutionDataDetails
  = HistoryEventExecutionDataDetails'{_heeddTruncated =
                                        Nothing}
...
instance FromJSON HistoryEventExecutionDataDetails
         where
        parseJSON
          = withObject "HistoryEventExecutionDataDetails"
              (\ x ->
                 HistoryEventExecutionDataDetails' <$>
                   (x .:? "truncated"))
