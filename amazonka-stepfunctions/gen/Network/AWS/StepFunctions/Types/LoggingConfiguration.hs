...
data LoggingConfiguration = LoggingConfiguration'{_lcIncludeExecutionData
                                                  :: !(Maybe Bool),
                                                  _lcDestinations ::
...
loggingConfiguration
    :: LoggingConfiguration
loggingConfiguration
  = LoggingConfiguration'{_lcIncludeExecutionData =
                            Nothing,
                          _lcDestinations = Nothing, _lcLevel = Nothing}
...
instance FromJSON LoggingConfiguration where
        parseJSON
          = withObject "LoggingConfiguration"
              (\ x ->
                 LoggingConfiguration' <$>
...
instance Hashable LoggingConfiguration where

instance NFData LoggingConfiguration where
