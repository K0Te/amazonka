...
data ExecutionStartedEventDetails = ExecutionStartedEventDetails'{_esedInputDetails
                                                                  ::
                                                                  !(Maybe
...
executionStartedEventDetails
    :: ExecutionStartedEventDetails
executionStartedEventDetails
  = ExecutionStartedEventDetails'{_esedInputDetails =
                                    Nothing,
                                  _esedInput = Nothing, _esedRoleARN = Nothing}
