...
data BillingDetails = BillingDetails'{_bdBilledMemoryUsedInMB
                                      :: !(Maybe Nat),
...
billingDetails
    :: BillingDetails
billingDetails
  = BillingDetails'{_bdBilledMemoryUsedInMB = Nothing,
...
instance FromJSON BillingDetails where
        parseJSON
          = withObject "BillingDetails"
              (\ x ->
                 BillingDetails' <$>
                   (x .:? "billedMemoryUsedInMB") <*>
                     (x .:? "billedDurationInMilliseconds"))

instance Hashable BillingDetails where

instance NFData BillingDetails where
