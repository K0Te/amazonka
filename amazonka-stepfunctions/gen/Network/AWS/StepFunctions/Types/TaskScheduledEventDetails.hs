...
data TaskScheduledEventDetails = TaskScheduledEventDetails'{_tasHeartbeatInSeconds
                                                            :: !(Maybe Integer),
...
taskScheduledEventDetails
    ...
    -> Text -- ^ 'tasParameters'
    -> TaskScheduledEventDetails
taskScheduledEventDetails pResourceType_ pResource_
  pRegion_ pParameters_
  = TaskScheduledEventDetails'{_tasHeartbeatInSeconds =
                                 Nothing,
                               _tasTimeoutInSeconds = Nothing,
                               _tasResourceType = pResourceType_,
                               _tasResource = pResource_, _tasRegion = pRegion_,
