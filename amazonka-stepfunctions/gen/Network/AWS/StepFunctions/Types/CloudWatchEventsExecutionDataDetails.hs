...
newtype CloudWatchEventsExecutionDataDetails = CloudWatchEventsExecutionDataDetails'{_cweeddIncluded
                                                                                     ::
                                                                                     Maybe
                                                                                       Bool}
...
cloudWatchEventsExecutionDataDetails
    :: CloudWatchEventsExecutionDataDetails
cloudWatchEventsExecutionDataDetails
  = CloudWatchEventsExecutionDataDetails'{_cweeddIncluded
                                            = Nothing}
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "CloudWatchEventsExecutionDataDetails"
              (\ x ->
                 CloudWatchEventsExecutionDataDetails' <$>
                   (x .:? "included"))
