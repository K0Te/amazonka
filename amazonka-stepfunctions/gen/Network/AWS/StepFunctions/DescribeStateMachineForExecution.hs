...
data DescribeStateMachineForExecutionResponse = DescribeStateMachineForExecutionResponse'{_dsmfersTracingConfiguration
                                                                                          ::
                                                                                          !(Maybe
...
describeStateMachineForExecutionResponse
  ...
  = DescribeStateMachineForExecutionResponse'{_dsmfersTracingConfiguration
                                                = Nothing,
                                              _dsmfersLoggingConfiguration =
                                                Nothing,
                                              _dsmfersResponseStatus =
