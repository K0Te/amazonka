...
data StartSyncExecution = StartSyncExecution'{_sseInput
...
startSyncExecution
    :: Text -- ^ 'sseStateMachineARN'
    -> StartSyncExecution
startSyncExecution pStateMachineARN_
  = StartSyncExecution'{_sseInput = Nothing,
                        _sseName = Nothing, _sseTraceHeader = Nothing,
...
instance Hashable StartSyncExecution where

instance NFData StartSyncExecution where
...
data StartSyncExecutionResponse = StartSyncExecutionResponse'{_ssersInputDetails
                                                              ::
                                                              !(Maybe
...
startSyncExecutionResponse
    ...
    -> Text -- ^ 'ssersExecutionARN'
    -> UTCTime -- ^ 'ssersStartDate'
    -> UTCTime -- ^ 'ssersStopDate'
    -> SyncExecutionStatus -- ^ 'ssersStatus'
    -> StartSyncExecutionResponse
startSyncExecutionResponse pResponseStatus_
  pExecutionARN_ pStartDate_ pStopDate_ pStatus_
  = StartSyncExecutionResponse'{_ssersInputDetails =
                                  Nothing,
                                _ssersError = Nothing, _ssersInput = Nothing,
                                _ssersCause = Nothing, _ssersName = Nothing,
...
instance NFData StartSyncExecutionResponse where
