...
data UpdateRoutingProfileDefaultOutboundQueue = UpdateRoutingProfileDefaultOutboundQueue'{_urpdoqInstanceId
                                                                                          ::
                                                                                          !Text,
...
updateRoutingProfileDefaultOutboundQueue
    :: Text -- ^ 'urpdoqInstanceId'
    -> Text -- ^ 'urpdoqRoutingProfileId'
    -> Text -- ^ 'urpdoqDefaultOutboundQueueId'
    -> UpdateRoutingProfileDefaultOutboundQueue
updateRoutingProfileDefaultOutboundQueue pInstanceId_
  pRoutingProfileId_ pDefaultOutboundQueueId_
  = UpdateRoutingProfileDefaultOutboundQueue'{_urpdoqInstanceId
                                                = pInstanceId_,
                                              _urpdoqRoutingProfileId =
                                                pRoutingProfileId_,
                                              _urpdoqDefaultOutboundQueueId =
...
instance ToPath
        ...
        toPath UpdateRoutingProfileDefaultOutboundQueue'{..}
          = mconcat
              ["/routing-profiles/", toBS _urpdoqInstanceId, "/",
