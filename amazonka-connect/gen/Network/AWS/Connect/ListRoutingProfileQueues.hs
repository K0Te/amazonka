...
data ListRoutingProfileQueues = ListRoutingProfileQueues'{_lrpqNextToken
                                                          :: !(Maybe Text),
                                                          _lrpqMaxResults ::
                                                          !(Maybe Nat),
                                                          _lrpqInstanceId ::
...
listRoutingProfileQueues
    :: Text -- ^ 'lrpqInstanceId'
    -> Text -- ^ 'lrpqRoutingProfileId'
    -> ListRoutingProfileQueues
listRoutingProfileQueues pInstanceId_
  pRoutingProfileId_
  = ListRoutingProfileQueues'{_lrpqNextToken = Nothing,
...
instance AWSPager ListRoutingProfileQueues where
        page rq rs
          ...
          | stop
              (rs ^. lrpqrsRoutingProfileQueueConfigSummaryList)
            = Nothing
          | otherwise =
            Just $ rq & lrpqNextToken .~ rs ^. lrpqrsNextToken

instance AWSRequest ListRoutingProfileQueues where
        type Rs ListRoutingProfileQueues =
             ListRoutingProfileQueuesResponse
        request = get connect
        response
          = receiveJSON
...
instance Hashable ListRoutingProfileQueues where

instance NFData ListRoutingProfileQueues where
...
instance ToPath ListRoutingProfileQueues where
        toPath ListRoutingProfileQueues'{..}
          = mconcat
              ["/routing-profiles/", toBS _lrpqInstanceId, "/",
               toBS _lrpqRoutingProfileId, "/queues"]
...
data ListRoutingProfileQueuesResponse = ListRoutingProfileQueuesResponse'{_lrpqrsRoutingProfileQueueConfigSummaryList
                                                                          ::
                                                                          !(Maybe
...
listRoutingProfileQueuesResponse
    :: Int -- ^ 'lrpqrsResponseStatus'
    -> ListRoutingProfileQueuesResponse
listRoutingProfileQueuesResponse pResponseStatus_
  = ListRoutingProfileQueuesResponse'{_lrpqrsRoutingProfileQueueConfigSummaryList
                                        = Nothing,
