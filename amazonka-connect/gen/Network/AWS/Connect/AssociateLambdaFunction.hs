...
data AssociateLambdaFunction = AssociateLambdaFunction'{_alfInstanceId
                                                        :: !Text,
                                                        _alfFunctionARN ::
                                                        !Text}
...
associateLambdaFunction pInstanceId_ pFunctionARN_
  = AssociateLambdaFunction'{_alfInstanceId =
                               pInstanceId_,
...
instance AWSRequest AssociateLambdaFunction where
        type Rs AssociateLambdaFunction =
             AssociateLambdaFunctionResponse
        request = putJSON connect
        response
          = receiveNull AssociateLambdaFunctionResponse'

instance Hashable AssociateLambdaFunction where

instance NFData AssociateLambdaFunction where
...
instance NFData AssociateLambdaFunctionResponse where
