...
data CreateContactFlow = CreateContactFlow'{_ccfDescription
                                            :: !(Maybe Text),
                                            _ccfTags ::
                                            !(Maybe (Map Text Text)),
                                            _ccfInstanceId :: !Text,
...
createContactFlow
    :: Text -- ^ 'ccfInstanceId'
    -> Text -- ^ 'ccfName'
    -> ContactFlowType -- ^ 'ccfType'
    -> Text -- ^ 'ccfContent'
    -> CreateContactFlow
createContactFlow pInstanceId_ pName_ pType_
  pContent_
  = CreateContactFlow'{_ccfDescription = Nothing,
                       _ccfTags = Nothing, _ccfInstanceId = pInstanceId_,
                       _ccfName = pName_, _ccfType = pType_,
...
instance AWSRequest CreateContactFlow where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 CreateContactFlowResponse' <$>
                   (x .?> "ContactFlowArn") <*> (x .?> "ContactFlowId")
                     <*> (pure (fromEnum s)))

instance Hashable CreateContactFlow where

instance NFData CreateContactFlow where
          ...
          = object
              (catMaybes
                 [("Description" .=) <$> _ccfDescription,
                  ("Tags" .=) <$> _ccfTags, Just ("Name" .= _ccfName),
                  Just ("Type" .= _ccfType),
...
data CreateContactFlowResponse = CreateContactFlowResponse'{_ccfrsContactFlowARN
                                                            :: !(Maybe Text),
                                                            _ccfrsContactFlowId
                                                            :: !(Maybe Text),
                                                            _ccfrsResponseStatus
                                                            :: !Int}
...
createContactFlowResponse pResponseStatus_
  = CreateContactFlowResponse'{_ccfrsContactFlowARN =
                                 Nothing,
...
instance NFData CreateContactFlowResponse where
