...
data DisassociateInstanceStorageConfig = DisassociateInstanceStorageConfig'{_disInstanceId
                                                                            ::
                                                                            !Text,
                                                                            _disAssociationId
                                                                            ::
...
disassociateInstanceStorageConfig
    :: Text -- ^ 'disInstanceId'
    -> Text -- ^ 'disAssociationId'
    -> InstanceStorageResourceType -- ^ 'disResourceType'
    -> DisassociateInstanceStorageConfig
disassociateInstanceStorageConfig pInstanceId_
  pAssociationId_ pResourceType_
  = DisassociateInstanceStorageConfig'{_disInstanceId =
                                         pInstanceId_,
...
instance AWSRequest DisassociateInstanceStorageConfig
         where
...
instance ToHeaders DisassociateInstanceStorageConfig
         where
        toHeaders
          = const
              (mconcat
...
instance ToPath DisassociateInstanceStorageConfig
         where
        toPath DisassociateInstanceStorageConfig'{..}
          = mconcat
              ["/instance/", toBS _disInstanceId,
               "/storage-config/", toBS _disAssociationId]

instance ToQuery DisassociateInstanceStorageConfig
         where
