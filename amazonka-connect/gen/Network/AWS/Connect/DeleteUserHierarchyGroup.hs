...
data DeleteUserHierarchyGroup = DeleteUserHierarchyGroup'{_duhguHierarchyGroupId
                                                          :: !Text,
                                                          _duhguInstanceId ::
                                                          !Text}
...
deleteUserHierarchyGroup
    :: Text -- ^ 'duhguHierarchyGroupId'
    -> Text -- ^ 'duhguInstanceId'
    -> DeleteUserHierarchyGroup
deleteUserHierarchyGroup pHierarchyGroupId_
  pInstanceId_
  = DeleteUserHierarchyGroup'{_duhguHierarchyGroupId =
                                pHierarchyGroupId_,
...
instance AWSRequest DeleteUserHierarchyGroup where
        type Rs DeleteUserHierarchyGroup =
             DeleteUserHierarchyGroupResponse
        request = delete connect
        response
          = receiveNull DeleteUserHierarchyGroupResponse'

instance Hashable DeleteUserHierarchyGroup where

instance NFData DeleteUserHierarchyGroup where
...
instance ToPath DeleteUserHierarchyGroup where
        toPath DeleteUserHierarchyGroup'{..}
          = mconcat
              ["/user-hierarchy-groups/", toBS _duhguInstanceId,
