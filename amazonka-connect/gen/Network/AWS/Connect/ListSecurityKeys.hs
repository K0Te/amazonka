...
data ListSecurityKeys = ListSecurityKeys'{_lskNextToken
                                          :: !(Maybe Text),
...
listSecurityKeys pInstanceId_
  = ListSecurityKeys'{_lskNextToken = Nothing,
...
instance AWSPager ListSecurityKeys where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lskNextToken .~ rs ^. lskrsNextToken
...
instance Hashable ListSecurityKeys where

instance NFData ListSecurityKeys where
...
data ListSecurityKeysResponse = ListSecurityKeysResponse'{_lskrsNextToken
                                                          :: !(Maybe Text),
                                                          _lskrsSecurityKeys ::
                                                          !(Maybe
                                                              [SecurityKey]),
                                                          _lskrsResponseStatus
                                                          :: !Int}
...
listSecurityKeysResponse
    :: Int -- ^ 'lskrsResponseStatus'
    -> ListSecurityKeysResponse
listSecurityKeysResponse pResponseStatus_
  = ListSecurityKeysResponse'{_lskrsNextToken =
                                Nothing,
...
instance NFData ListSecurityKeysResponse where
