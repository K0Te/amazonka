...
data AssociateApprovedOrigin = AssociateApprovedOrigin'{_aaoInstanceId
                                                        :: !Text,
                                                        _aaoOrigin :: !Text}
...
associateApprovedOrigin pInstanceId_ pOrigin_
  = AssociateApprovedOrigin'{_aaoInstanceId =
                               pInstanceId_,
                             _aaoOrigin = pOrigin_}
...
instance AWSRequest AssociateApprovedOrigin where
        type Rs AssociateApprovedOrigin =
             AssociateApprovedOriginResponse
        request = putJSON connect
        response
          = receiveNull AssociateApprovedOriginResponse'

instance Hashable AssociateApprovedOrigin where

instance NFData AssociateApprovedOrigin where
...
instance NFData AssociateApprovedOriginResponse where
