...
data CreateInstance = CreateInstance'{_ciDirectoryId
                                      :: !(Maybe Text),
...
createInstance
    :: DirectoryType -- ^ 'ciIdentityManagementType'
    -> Bool -- ^ 'ciInboundCallsEnabled'
    -> Bool -- ^ 'ciOutboundCallsEnabled'
    -> CreateInstance
createInstance pIdentityManagementType_
  pInboundCallsEnabled_ pOutboundCallsEnabled_
  = CreateInstance'{_ciDirectoryId = Nothing,
                    _ciClientToken = Nothing, _ciInstanceAlias = Nothing,
...
data CreateInstanceResponse = CreateInstanceResponse'{_cirsARN
                                                      :: !(Maybe Text),
                                                      _cirsId :: !(Maybe Text),
                                                      _cirsResponseStatus ::
                                                      !Int}
...
createInstanceResponse pResponseStatus_
  = CreateInstanceResponse'{_cirsARN = Nothing,
                            _cirsId = Nothing,
