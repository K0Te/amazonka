...
data DescribeInstanceAttribute = DescribeInstanceAttribute'{_diaInstanceId
                                                            :: !Text,
                                                            _diaAttributeType ::
...
describeInstanceAttribute
    :: Text -- ^ 'diaInstanceId'
    -> InstanceAttributeType -- ^ 'diaAttributeType'
    -> DescribeInstanceAttribute
describeInstanceAttribute pInstanceId_
  pAttributeType_
  = DescribeInstanceAttribute'{_diaInstanceId =
                                 pInstanceId_,
...
instance ToPath DescribeInstanceAttribute where
        toPath DescribeInstanceAttribute'{..}
          = mconcat
              ["/instance/", toBS _diaInstanceId, "/attribute/",
...
data DescribeInstanceAttributeResponse = DescribeInstanceAttributeResponse'{_diarsAttribute
                                                                            ::
                                                                            !(Maybe
                                                                                Attribute),
...
describeInstanceAttributeResponse pResponseStatus_
  = DescribeInstanceAttributeResponse'{_diarsAttribute
                                         = Nothing,
