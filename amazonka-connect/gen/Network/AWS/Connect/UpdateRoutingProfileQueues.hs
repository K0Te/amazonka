...
data UpdateRoutingProfileQueues = UpdateRoutingProfileQueues'{_urpqInstanceId
                                                              :: !Text,
...
updateRoutingProfileQueues
    :: Text -- ^ 'urpqInstanceId'
    -> Text -- ^ 'urpqRoutingProfileId'
    -> NonEmpty RoutingProfileQueueConfig -- ^ 'urpqQueueConfigs'
    -> UpdateRoutingProfileQueues
updateRoutingProfileQueues pInstanceId_
  pRoutingProfileId_ pQueueConfigs_
  = UpdateRoutingProfileQueues'{_urpqInstanceId =
                                  pInstanceId_,
...
instance Hashable UpdateRoutingProfileQueues where

instance NFData UpdateRoutingProfileQueues where
...
instance ToPath UpdateRoutingProfileQueues where
        toPath UpdateRoutingProfileQueues'{..}
          = mconcat
              ["/routing-profiles/", toBS _urpqInstanceId, "/",
               toBS _urpqRoutingProfileId, "/queues"]
