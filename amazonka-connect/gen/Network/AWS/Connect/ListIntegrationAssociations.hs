...
data ListIntegrationAssociations = ListIntegrationAssociations'{_lNextToken
                                                                ::
                                                                !(Maybe Text),
                                                                _lMaxResults ::
                                                                !(Maybe Nat),
...
--
-- * 'lMaxResults' - The maximimum number of results to return per page.
--
...
listIntegrationAssociations pInstanceId_
  = ListIntegrationAssociations'{_lNextToken = Nothing,
...
instance AWSRequest ListIntegrationAssociations where
        type Rs ListIntegrationAssociations =
             ListIntegrationAssociationsResponse
        request = get connect
        response
          = receiveJSON
...
instance Hashable ListIntegrationAssociations where

instance NFData ListIntegrationAssociations where
...
data ListIntegrationAssociationsResponse = ListIntegrationAssociationsResponse'{_lrsNextToken
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
...
listIntegrationAssociationsResponse pResponseStatus_
  = ListIntegrationAssociationsResponse'{_lrsNextToken
                                           = Nothing,
                                         _lrsIntegrationAssociationSummaryList =
                                           Nothing,
