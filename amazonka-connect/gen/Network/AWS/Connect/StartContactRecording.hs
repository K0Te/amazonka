...
data StartContactRecording = StartContactRecording'{_scrInstanceId
                                                    :: !Text,
                                                    _scrContactId :: !Text,
...
startContactRecording
    :: Text -- ^ 'scrInstanceId'
    -> Text -- ^ 'scrContactId'
    -> Text -- ^ 'scrInitialContactId'
    -> VoiceRecordingConfiguration -- ^ 'scrVoiceRecordingConfiguration'
    -> StartContactRecording
startContactRecording pInstanceId_ pContactId_
  pInitialContactId_ pVoiceRecordingConfiguration_
  = StartContactRecording'{_scrInstanceId =
                             pInstanceId_,
...
instance Hashable StartContactRecording where

instance NFData StartContactRecording where
...
newtype StartContactRecordingResponse = StartContactRecordingResponse'{_starsResponseStatus
                                                                       :: Int}
...
startContactRecordingResponse pResponseStatus_
  = StartContactRecordingResponse'{_starsResponseStatus
                                     = pResponseStatus_}
...
instance NFData StartContactRecordingResponse where
