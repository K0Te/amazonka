...
data AssociateRoutingProfileQueues = AssociateRoutingProfileQueues'{_arpqInstanceId
                                                                    :: !Text,
...
associateRoutingProfileQueues
    :: Text -- ^ 'arpqInstanceId'
    -> Text -- ^ 'arpqRoutingProfileId'
    -> NonEmpty RoutingProfileQueueConfig -- ^ 'arpqQueueConfigs'
    -> AssociateRoutingProfileQueues
associateRoutingProfileQueues pInstanceId_
  pRoutingProfileId_ pQueueConfigs_
  = AssociateRoutingProfileQueues'{_arpqInstanceId =
                                     pInstanceId_,
...
instance AWSRequest AssociateRoutingProfileQueues
         where
...
instance Hashable AssociateRoutingProfileQueues where

instance NFData AssociateRoutingProfileQueues where

instance ToHeaders AssociateRoutingProfileQueues
         where
        toHeaders
          = const
              (mconcat
...
instance ToPath AssociateRoutingProfileQueues where
        toPath AssociateRoutingProfileQueues'{..}
          = mconcat
              ["/routing-profiles/", toBS _arpqInstanceId, "/",
               toBS _arpqRoutingProfileId, "/associate-queues"]
