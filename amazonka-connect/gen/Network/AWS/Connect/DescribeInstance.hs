...
newtype DescribeInstance = DescribeInstance'{_diInstanceId
                                             :: Text}
...
instance Hashable DescribeInstance where

instance NFData DescribeInstance where
...
data DescribeInstanceResponse = DescribeInstanceResponse'{_dirsInstance
                                                          :: !(Maybe Instance),
                                                          _dirsResponseStatus ::
                                                          !Int}
...
describeInstanceResponse pResponseStatus_
  = DescribeInstanceResponse'{_dirsInstance = Nothing,
...
instance NFData DescribeInstanceResponse where
