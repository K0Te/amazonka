...
data DisassociateLexBot = DisassociateLexBot'{_dlbInstanceId
                                              :: !Text,
                                              _dlbBotName :: !Text,
                                              _dlbLexRegion :: !Text}
...
disassociateLexBot pInstanceId_ pBotName_ pLexRegion_
  = DisassociateLexBot'{_dlbInstanceId = pInstanceId_,
                        _dlbBotName = pBotName_, _dlbLexRegion = pLexRegion_}
...
instance AWSRequest DisassociateLexBot where
        type Rs DisassociateLexBot =
             DisassociateLexBotResponse
        request = delete connect
        response = receiveNull DisassociateLexBotResponse'

instance Hashable DisassociateLexBot where

instance NFData DisassociateLexBot where
...
instance NFData DisassociateLexBotResponse where
