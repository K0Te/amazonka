...
data DisassociateSecurityKey = DisassociateSecurityKey'{_dskInstanceId
                                                        :: !Text,
                                                        _dskAssociationId ::
                                                        !Text}
...
disassociateSecurityKey
    :: Text -- ^ 'dskInstanceId'
    -> Text -- ^ 'dskAssociationId'
    -> DisassociateSecurityKey
disassociateSecurityKey pInstanceId_ pAssociationId_
  = DisassociateSecurityKey'{_dskInstanceId =
                               pInstanceId_,
...
instance AWSRequest DisassociateSecurityKey where
        type Rs DisassociateSecurityKey =
             DisassociateSecurityKeyResponse
        request = delete connect
        response
          = receiveNull DisassociateSecurityKeyResponse'

instance Hashable DisassociateSecurityKey where

instance NFData DisassociateSecurityKey where
...
instance ToPath DisassociateSecurityKey where
        toPath DisassociateSecurityKey'{..}
          = mconcat
              ["/instance/", toBS _dskInstanceId, "/security-key/",
...
instance NFData DisassociateSecurityKeyResponse where
