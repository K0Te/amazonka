...
data UpdateInstanceAttribute = UpdateInstanceAttribute'{_uiaInstanceId
                                                        :: !Text,
                                                        _uiaAttributeType ::
...
updateInstanceAttribute
    :: Text -- ^ 'uiaInstanceId'
    -> InstanceAttributeType -- ^ 'uiaAttributeType'
    -> Text -- ^ 'uiaValue'
    -> UpdateInstanceAttribute
updateInstanceAttribute pInstanceId_ pAttributeType_
  pValue_
  = UpdateInstanceAttribute'{_uiaInstanceId =
                               pInstanceId_,
...
instance AWSRequest UpdateInstanceAttribute where
        type Rs UpdateInstanceAttribute =
             UpdateInstanceAttributeResponse
        request = postJSON connect
        response
          = receiveNull UpdateInstanceAttributeResponse'

instance Hashable UpdateInstanceAttribute where

instance NFData UpdateInstanceAttribute where
...
instance ToPath UpdateInstanceAttribute where
        toPath UpdateInstanceAttribute'{..}
          = mconcat
              ["/instance/", toBS _uiaInstanceId, "/attribute/",
...
instance NFData UpdateInstanceAttributeResponse where
