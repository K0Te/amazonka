...
data DescribeContactFlow = DescribeContactFlow'{_dcfInstanceId
                                                :: !Text,
...
describeContactFlow
    :: Text -- ^ 'dcfInstanceId'
    -> Text -- ^ 'dcfContactFlowId'
    -> DescribeContactFlow
describeContactFlow pInstanceId_ pContactFlowId_
  = DescribeContactFlow'{_dcfInstanceId = pInstanceId_,
...
instance Hashable DescribeContactFlow where

instance NFData DescribeContactFlow where
...
instance ToPath DescribeContactFlow where
        toPath DescribeContactFlow'{..}
          = mconcat
              ["/contact-flows/", toBS _dcfInstanceId, "/",
...
data DescribeContactFlowResponse = DescribeContactFlowResponse'{_dcfrsContactFlow
                                                                ::
                                                                !(Maybe
                                                                    ContactFlow),
...
describeContactFlowResponse pResponseStatus_
  = DescribeContactFlowResponse'{_dcfrsContactFlow =
                                   Nothing,
...
instance NFData DescribeContactFlowResponse where
