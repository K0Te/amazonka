...
data AssociateSecurityKey = AssociateSecurityKey'{_askInstanceId
                                                  :: !Text,
                                                  _askKey :: !Text}
...
associateSecurityKey pInstanceId_ pKey_
  = AssociateSecurityKey'{_askInstanceId =
                            pInstanceId_,
                          _askKey = pKey_}
...
instance Hashable AssociateSecurityKey where

instance NFData AssociateSecurityKey where
...
data AssociateSecurityKeyResponse = AssociateSecurityKeyResponse'{_askrsAssociationId
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _askrsResponseStatus
                                                                  :: !Int}
...
associateSecurityKeyResponse
    :: Int -- ^ 'askrsResponseStatus'
    -> AssociateSecurityKeyResponse
associateSecurityKeyResponse pResponseStatus_
  = AssociateSecurityKeyResponse'{_askrsAssociationId =
                                    Nothing,
...
instance NFData AssociateSecurityKeyResponse where
