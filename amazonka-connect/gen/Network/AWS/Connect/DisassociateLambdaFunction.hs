...
data DisassociateLambdaFunction = DisassociateLambdaFunction'{_dlfInstanceId
                                                              :: !Text,
                                                              _dlfFunctionARN ::
                                                              !Text}
...
disassociateLambdaFunction pInstanceId_ pFunctionARN_
  = DisassociateLambdaFunction'{_dlfInstanceId =
                                  pInstanceId_,
...
instance Hashable DisassociateLambdaFunction where

instance NFData DisassociateLambdaFunction where
