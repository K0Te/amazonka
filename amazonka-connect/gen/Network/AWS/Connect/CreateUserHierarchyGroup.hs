...
data CreateUserHierarchyGroup = CreateUserHierarchyGroup'{_cuhgParentGroupId
                                                          :: !(Maybe Text),
                                                          _cuhgName :: !Text,
                                                          _cuhgInstanceId ::
                                                          !Text}
...
createUserHierarchyGroup pName_ pInstanceId_
  = CreateUserHierarchyGroup'{_cuhgParentGroupId =
                                Nothing,
                              _cuhgName = pName_,
...
instance AWSRequest CreateUserHierarchyGroup where
        type Rs CreateUserHierarchyGroup =
             CreateUserHierarchyGroupResponse
...
instance Hashable CreateUserHierarchyGroup where

instance NFData CreateUserHierarchyGroup where
...
data CreateUserHierarchyGroupResponse = CreateUserHierarchyGroupResponse'{_cuhgrsHierarchyGroupARN
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
...
createUserHierarchyGroupResponse
    :: Int -- ^ 'cuhgrsResponseStatus'
    -> CreateUserHierarchyGroupResponse
createUserHierarchyGroupResponse pResponseStatus_
  = CreateUserHierarchyGroupResponse'{_cuhgrsHierarchyGroupARN
                                        = Nothing,
