...
data ResumeContactRecording = ResumeContactRecording'{_rcrInstanceId
                                                      :: !Text,
                                                      _rcrContactId :: !Text,
...
resumeContactRecording
    :: Text -- ^ 'rcrInstanceId'
    -> Text -- ^ 'rcrContactId'
    -> Text -- ^ 'rcrInitialContactId'
    -> ResumeContactRecording
resumeContactRecording pInstanceId_ pContactId_
  pInitialContactId_
  = ResumeContactRecording'{_rcrInstanceId =
                              pInstanceId_,
...
instance AWSRequest ResumeContactRecording where
        type Rs ResumeContactRecording =
             ResumeContactRecordingResponse
...
instance Hashable ResumeContactRecording where

instance NFData ResumeContactRecording where
...
newtype ResumeContactRecordingResponse = ResumeContactRecordingResponse'{_rcrrsResponseStatus
                                                                         :: Int}
...
resumeContactRecordingResponse
    :: Int -- ^ 'rcrrsResponseStatus'
    -> ResumeContactRecordingResponse
resumeContactRecordingResponse pResponseStatus_
  = ResumeContactRecordingResponse'{_rcrrsResponseStatus
                                      = pResponseStatus_}
...
instance NFData ResumeContactRecordingResponse where
