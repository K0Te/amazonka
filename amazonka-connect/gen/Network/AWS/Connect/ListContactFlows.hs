...
instance AWSPager ListContactFlows where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lcfNextToken .~ rs ^. lcfrsNextToken
...
instance Hashable ListContactFlows where

instance NFData ListContactFlows where
...
instance NFData ListContactFlowsResponse where
