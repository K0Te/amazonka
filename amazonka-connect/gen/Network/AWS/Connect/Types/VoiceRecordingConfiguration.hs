...
newtype VoiceRecordingConfiguration = VoiceRecordingConfiguration'{_vrcVoiceRecordingTrack
                                                                   ::
                                                                   Maybe
                                                                     VoiceRecordingTrack}
...
voiceRecordingConfiguration
    :: VoiceRecordingConfiguration
voiceRecordingConfiguration
  = VoiceRecordingConfiguration'{_vrcVoiceRecordingTrack
                                   = Nothing}
...
instance Hashable VoiceRecordingConfiguration where

instance NFData VoiceRecordingConfiguration where
