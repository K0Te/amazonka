...
data RoutingProfile = RoutingProfile'{_rpInstanceId
                                      :: !(Maybe Text),
...
routingProfile
    :: RoutingProfile
routingProfile
  = RoutingProfile'{_rpInstanceId = Nothing,
                    _rpRoutingProfileARN = Nothing,
                    _rpRoutingProfileId = Nothing,
                    _rpDefaultOutboundQueueId = Nothing,
                    _rpName = Nothing, _rpMediaConcurrencies = Nothing,
                    _rpDescription = Nothing, _rpTags = Nothing}
...
instance FromJSON RoutingProfile where
        parseJSON
          = withObject "RoutingProfile"
              (\ x ->
                 RoutingProfile' <$>
                   (x .:? "InstanceId") <*> (x .:? "RoutingProfileArn")
                     <*> (x .:? "RoutingProfileId")
...
instance Hashable RoutingProfile where

instance NFData RoutingProfile where
