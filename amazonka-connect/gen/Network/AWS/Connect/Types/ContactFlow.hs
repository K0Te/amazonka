...
data ContactFlow = ContactFlow'{_cfARN ::
                                !(Maybe Text),
...
contactFlow
    :: ContactFlow
contactFlow
  = ContactFlow'{_cfARN = Nothing,
                 _cfContent = Nothing, _cfName = Nothing,
                 _cfId = Nothing, _cfType = Nothing,
                 _cfDescription = Nothing, _cfTags = Nothing}
...
instance Hashable ContactFlow where

instance NFData ContactFlow where
