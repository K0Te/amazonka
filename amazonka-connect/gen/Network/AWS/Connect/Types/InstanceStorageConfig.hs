...
data InstanceStorageConfig = InstanceStorageConfig'{_iscAssociationId
                                                    :: !(Maybe Text),
...
instanceStorageConfig
    :: StorageType -- ^ 'iscStorageType'
    -> InstanceStorageConfig
instanceStorageConfig pStorageType_
  = InstanceStorageConfig'{_iscAssociationId = Nothing,
...
instance FromJSON InstanceStorageConfig where
        parseJSON
          = withObject "InstanceStorageConfig"
              (\ x ->
                 InstanceStorageConfig' <$>
                   (x .:? "AssociationId") <*>
...
instance Hashable InstanceStorageConfig where

instance NFData InstanceStorageConfig where
