...
newtype KinesisFirehoseConfig = KinesisFirehoseConfig'{_kfcFirehoseARN
                                                       :: Text}
...
kinesisFirehoseConfig pFirehoseARN_
  = KinesisFirehoseConfig'{_kfcFirehoseARN =
                             pFirehoseARN_}
...
instance FromJSON KinesisFirehoseConfig where
        parseJSON
          = withObject "KinesisFirehoseConfig"
              (\ x ->
                 KinesisFirehoseConfig' <$> (x .: "FirehoseArn"))

instance Hashable KinesisFirehoseConfig where

instance NFData KinesisFirehoseConfig where
