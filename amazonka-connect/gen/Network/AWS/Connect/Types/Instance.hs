...
data Instance = Instance'{_iARN :: !(Maybe Text),
...
instance'
    :: Instance
instance'
  = Instance'{_iARN = Nothing, _iCreatedTime = Nothing,
              _iOutboundCallsEnabled = Nothing,
              _iInboundCallsEnabled = Nothing,
              _iInstanceAlias = Nothing, _iId = Nothing,
              _iInstanceStatus = Nothing,
              _iIdentityManagementType = Nothing,
              _iStatusReason = Nothing, _iServiceRole = Nothing}
