...
data RoutingProfileQueueConfigSummary = RoutingProfileQueueConfigSummary'{_rpqcsQueueId
                                                                          ::
                                                                          !Text,
                                                                          _rpqcsQueueARN
                                                                          ::
...
routingProfileQueueConfigSummary
    ...
    -> Text -- ^ 'rpqcsQueueARN'
    -> Text -- ^ 'rpqcsQueueName'
    -> Natural -- ^ 'rpqcsPriority'
    -> Natural -- ^ 'rpqcsDelay'
    -> Channel -- ^ 'rpqcsChannel'
    -> RoutingProfileQueueConfigSummary
routingProfileQueueConfigSummary pQueueId_ pQueueARN_
  pQueueName_ pPriority_ pDelay_ pChannel_
  = RoutingProfileQueueConfigSummary'{_rpqcsQueueId =
                                        pQueueId_,
...
instance FromJSON RoutingProfileQueueConfigSummary
         where
        parseJSON
          = withObject "RoutingProfileQueueConfigSummary"
              (\ x ->
                 RoutingProfileQueueConfigSummary' <$>
                   (x .: "QueueId") <*> (x .: "QueueArn") <*>
                     (x .: "QueueName")
                     <*> (x .: "Priority")
                     <*> (x .: "Delay")
                     <*> (x .: "Channel"))
