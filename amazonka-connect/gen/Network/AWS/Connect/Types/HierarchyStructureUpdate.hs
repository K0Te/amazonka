...
data HierarchyStructureUpdate = HierarchyStructureUpdate'{_hsuLevelFive
                                                          ::
                                                          !(Maybe
...
hierarchyStructureUpdate
    :: HierarchyStructureUpdate
hierarchyStructureUpdate
  = HierarchyStructureUpdate'{_hsuLevelFive = Nothing,
                              _hsuLevelThree = Nothing, _hsuLevelFour = Nothing,
                              _hsuLevelTwo = Nothing, _hsuLevelOne = Nothing}
...
instance Hashable HierarchyStructureUpdate where

instance NFData HierarchyStructureUpdate where
