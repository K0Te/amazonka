...
data RoutingProfileQueueReference = RoutingProfileQueueReference'{_rpqrQueueId
                                                                  :: !Text,
                                                                  _rpqrChannel
                                                                  :: !Channel}
...
routingProfileQueueReference pQueueId_ pChannel_
  = RoutingProfileQueueReference'{_rpqrQueueId =
                                    pQueueId_,
...
instance Hashable RoutingProfileQueueReference where

instance NFData RoutingProfileQueueReference where
