...
data RoutingProfileQueueConfig = RoutingProfileQueueConfig'{_rpqcQueueReference
                                                            ::
...
routingProfileQueueConfig
    :: RoutingProfileQueueReference -- ^ 'rpqcQueueReference'
    -> Natural -- ^ 'rpqcPriority'
    -> Natural -- ^ 'rpqcDelay'
    -> RoutingProfileQueueConfig
routingProfileQueueConfig pQueueReference_ pPriority_
  pDelay_
  = RoutingProfileQueueConfig'{_rpqcQueueReference =
                                 pQueueReference_,
...
instance Hashable RoutingProfileQueueConfig where

instance NFData RoutingProfileQueueConfig where
