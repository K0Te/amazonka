...
data KinesisVideoStreamConfig = KinesisVideoStreamConfig'{_kvscPrefix
                                                          :: !Text,
...
kinesisVideoStreamConfig
    :: Text -- ^ 'kvscPrefix'
    -> Natural -- ^ 'kvscRetentionPeriodHours'
    -> EncryptionConfig -- ^ 'kvscEncryptionConfig'
    -> KinesisVideoStreamConfig
kinesisVideoStreamConfig pPrefix_
  pRetentionPeriodHours_ pEncryptionConfig_
  = KinesisVideoStreamConfig'{_kvscPrefix = pPrefix_,
                              _kvscRetentionPeriodHours =
...
instance FromJSON KinesisVideoStreamConfig where
        parseJSON
          = withObject "KinesisVideoStreamConfig"
              (\ x ->
                 KinesisVideoStreamConfig' <$>
                   (x .: "Prefix") <*> (x .: "RetentionPeriodHours") <*>
                     (x .: "EncryptionConfig"))

instance Hashable KinesisVideoStreamConfig where

instance NFData KinesisVideoStreamConfig where
