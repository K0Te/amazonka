...
data DisassociateApprovedOrigin = DisassociateApprovedOrigin'{_daoInstanceId
                                                              :: !Text,
                                                              _daoOrigin ::
                                                              !Text}
...
disassociateApprovedOrigin pInstanceId_ pOrigin_
  = DisassociateApprovedOrigin'{_daoInstanceId =
                                  pInstanceId_,
                                _daoOrigin = pOrigin_}
...
instance Hashable DisassociateApprovedOrigin where

instance NFData DisassociateApprovedOrigin where
