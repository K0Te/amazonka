...
data DescribeRoutingProfile = DescribeRoutingProfile'{_drpInstanceId
                                                      :: !Text,
...
describeRoutingProfile
    :: Text -- ^ 'drpInstanceId'
    -> Text -- ^ 'drpRoutingProfileId'
    -> DescribeRoutingProfile
describeRoutingProfile pInstanceId_
  pRoutingProfileId_
  = DescribeRoutingProfile'{_drpInstanceId =
                              pInstanceId_,
...
instance AWSRequest DescribeRoutingProfile where
        type Rs DescribeRoutingProfile =
             DescribeRoutingProfileResponse
        request = get connect
        response
          = receiveJSON
...
instance Hashable DescribeRoutingProfile where

instance NFData DescribeRoutingProfile where
...
instance ToPath DescribeRoutingProfile where
        toPath DescribeRoutingProfile'{..}
          = mconcat
              ["/routing-profiles/", toBS _drpInstanceId, "/",
...
data DescribeRoutingProfileResponse = DescribeRoutingProfileResponse'{_drprsRoutingProfile
                                                                      ::
                                                                      !(Maybe
                                                                          RoutingProfile),
...
describeRoutingProfileResponse pResponseStatus_
  = DescribeRoutingProfileResponse'{_drprsRoutingProfile
                                      = Nothing,
...
instance NFData DescribeRoutingProfileResponse where
