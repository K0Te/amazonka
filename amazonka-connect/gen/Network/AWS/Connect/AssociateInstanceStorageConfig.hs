...
data AssociateInstanceStorageConfig = AssociateInstanceStorageConfig'{_aiscInstanceId
                                                                      :: !Text,
                                                                      _aiscResourceType
                                                                      ::
...
associateInstanceStorageConfig
    :: Text -- ^ 'aiscInstanceId'
    -> InstanceStorageResourceType -- ^ 'aiscResourceType'
    -> InstanceStorageConfig -- ^ 'aiscStorageConfig'
    -> AssociateInstanceStorageConfig
associateInstanceStorageConfig pInstanceId_
  pResourceType_ pStorageConfig_
  = AssociateInstanceStorageConfig'{_aiscInstanceId =
                                      pInstanceId_,
...
instance AWSRequest AssociateInstanceStorageConfig
         where
...
instance NFData AssociateInstanceStorageConfig where

instance ToHeaders AssociateInstanceStorageConfig
         where
        toHeaders
          = const
              (mconcat
...
data AssociateInstanceStorageConfigResponse = AssociateInstanceStorageConfigResponse'{_aiscrsAssociationId
                                                                                      ::
                                                                                      !(Maybe
                                                                                          Text),
...
associateInstanceStorageConfigResponse
    :: Int -- ^ 'aiscrsResponseStatus'
    -> AssociateInstanceStorageConfigResponse
associateInstanceStorageConfigResponse
  pResponseStatus_
  = AssociateInstanceStorageConfigResponse'{_aiscrsAssociationId
                                              = Nothing,
                                            _aiscrsResponseStatus =
                                              pResponseStatus_}
