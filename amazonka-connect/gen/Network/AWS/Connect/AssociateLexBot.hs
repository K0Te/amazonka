...
data AssociateLexBot = AssociateLexBot'{_albInstanceId
                                        :: !Text,
                                        _albLexBot :: !LexBot}
...
associateLexBot pInstanceId_ pLexBot_
  = AssociateLexBot'{_albInstanceId = pInstanceId_,
                     _albLexBot = pLexBot_}
...
instance Hashable AssociateLexBot where

instance NFData AssociateLexBot where
...
instance NFData AssociateLexBotResponse where
