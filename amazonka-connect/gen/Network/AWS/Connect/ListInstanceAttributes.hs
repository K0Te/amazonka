...
data ListInstanceAttributes = ListInstanceAttributes'{_liaNextToken
                                                      :: !(Maybe Text),
                                                      _liaMaxResults ::
                                                      !(Maybe Nat),
                                                      _liaInstanceId :: !Text}
...
listInstanceAttributes pInstanceId_
  = ListInstanceAttributes'{_liaNextToken = Nothing,
...
instance AWSPager ListInstanceAttributes where
        page rq rs
          ...
          | otherwise =
            Just $ rq & liaNextToken .~ rs ^. liarsNextToken

instance AWSRequest ListInstanceAttributes where
        type Rs ListInstanceAttributes =
             ListInstanceAttributesResponse
        request = get connect
        response
          = receiveJSON
...
instance Hashable ListInstanceAttributes where

instance NFData ListInstanceAttributes where
...
data ListInstanceAttributesResponse = ListInstanceAttributesResponse'{_liarsNextToken
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _liarsAttributes
...
listInstanceAttributesResponse
    :: Int -- ^ 'liarsResponseStatus'
    -> ListInstanceAttributesResponse
listInstanceAttributesResponse pResponseStatus_
  = ListInstanceAttributesResponse'{_liarsNextToken =
                                      Nothing,
...
instance NFData ListInstanceAttributesResponse where
