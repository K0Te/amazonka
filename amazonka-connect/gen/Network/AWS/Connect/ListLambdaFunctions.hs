...
data ListLambdaFunctions = ListLambdaFunctions'{_llfNextToken
                                                :: !(Maybe Text),
...
listLambdaFunctions pInstanceId_
  = ListLambdaFunctions'{_llfNextToken = Nothing,
...
instance AWSPager ListLambdaFunctions where
        page rq rs
          ...
          | otherwise =
            Just $ rq & llfNextToken .~ rs ^. llfrsNextToken

instance AWSRequest ListLambdaFunctions where
        type Rs ListLambdaFunctions =
             ListLambdaFunctionsResponse
        request = get connect
        response
          = receiveJSON
...
instance Hashable ListLambdaFunctions where

instance NFData ListLambdaFunctions where
...
data ListLambdaFunctionsResponse = ListLambdaFunctionsResponse'{_llfrsLambdaFunctions
                                                                ::
                                                                !(Maybe [Text]),
                                                                _llfrsNextToken
                                                                ::
                                                                !(Maybe Text),
                                                                _llfrsResponseStatus
                                                                :: !Int}
...
listLambdaFunctionsResponse
    :: Int -- ^ 'llfrsResponseStatus'
    -> ListLambdaFunctionsResponse
listLambdaFunctionsResponse pResponseStatus_
  = ListLambdaFunctionsResponse'{_llfrsLambdaFunctions
                                   = Nothing,
...
instance NFData ListLambdaFunctionsResponse where
