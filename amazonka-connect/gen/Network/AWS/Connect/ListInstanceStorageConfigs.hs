...
data ListInstanceStorageConfigs = ListInstanceStorageConfigs'{_liscNextToken
                                                              :: !(Maybe Text),
                                                              _liscMaxResults ::
                                                              !(Maybe Nat),
                                                              _liscInstanceId ::
...
listInstanceStorageConfigs
    :: Text -- ^ 'liscInstanceId'
    -> InstanceStorageResourceType -- ^ 'liscResourceType'
    -> ListInstanceStorageConfigs
listInstanceStorageConfigs pInstanceId_
  pResourceType_
  = ListInstanceStorageConfigs'{_liscNextToken =
                                  Nothing,
...
instance AWSPager ListInstanceStorageConfigs where
        page rq rs
          ...
          | otherwise =
            Just $ rq & liscNextToken .~ rs ^. liscrsNextToken
...
instance Hashable ListInstanceStorageConfigs where

instance NFData ListInstanceStorageConfigs where
...
data ListInstanceStorageConfigsResponse = ListInstanceStorageConfigsResponse'{_liscrsStorageConfigs
                                                                              ::
                                                                              !(Maybe
...
listInstanceStorageConfigsResponse
    :: Int -- ^ 'liscrsResponseStatus'
    -> ListInstanceStorageConfigsResponse
listInstanceStorageConfigsResponse pResponseStatus_
  = ListInstanceStorageConfigsResponse'{_liscrsStorageConfigs
                                          = Nothing,
