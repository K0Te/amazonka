...
data ListPrompts = ListPrompts'{_lpNextToken ::
                                !(Maybe Text),
...
listPrompts pInstanceId_
  = ListPrompts'{_lpNextToken = Nothing,
...
instance Hashable ListPrompts where

instance NFData ListPrompts where
...
data ListPromptsResponse = ListPromptsResponse'{_lprsPromptSummaryList
                                                :: !(Maybe [PromptSummary]),
...
listPromptsResponse pResponseStatus_
  = ListPromptsResponse'{_lprsPromptSummaryList =
                           Nothing,
...
instance NFData ListPromptsResponse where
