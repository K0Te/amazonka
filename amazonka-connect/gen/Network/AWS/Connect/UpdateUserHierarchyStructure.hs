...
data UpdateUserHierarchyStructure = UpdateUserHierarchyStructure'{_uuhsHierarchyStructure
                                                                  ::
...
updateUserHierarchyStructure
    :: HierarchyStructureUpdate -- ^ 'uuhsHierarchyStructure'
    -> Text -- ^ 'uuhsInstanceId'
    -> UpdateUserHierarchyStructure
updateUserHierarchyStructure pHierarchyStructure_
  pInstanceId_
  = UpdateUserHierarchyStructure'{_uuhsHierarchyStructure
...
instance AWSRequest UpdateUserHierarchyStructure
         where
...
instance Hashable UpdateUserHierarchyStructure where

instance NFData UpdateUserHierarchyStructure where
