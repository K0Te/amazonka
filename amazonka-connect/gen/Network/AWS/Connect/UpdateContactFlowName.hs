...
data UpdateContactFlowName = UpdateContactFlowName'{_ucfnName
                                                    :: !(Maybe Text),
                                                    _ucfnDescription ::
                                                    !(Maybe Text),
...
updateContactFlowName
    :: Text -- ^ 'ucfnInstanceId'
    -> Text -- ^ 'ucfnContactFlowId'
    -> UpdateContactFlowName
updateContactFlowName pInstanceId_ pContactFlowId_
  = UpdateContactFlowName'{_ucfnName = Nothing,
...
instance AWSRequest UpdateContactFlowName where
        type Rs UpdateContactFlowName =
             UpdateContactFlowNameResponse
        request = postJSON connect
        response = receiveNull UpdateContactFlowNameResponse'

instance Hashable UpdateContactFlowName where

instance NFData UpdateContactFlowName where
...
instance ToPath UpdateContactFlowName where
        toPath UpdateContactFlowName'{..}
          = mconcat
              ["/contact-flows/", toBS _ucfnInstanceId, "/",
               toBS _ucfnContactFlowId, "/name"]
...
instance NFData UpdateContactFlowNameResponse where
