...
instance AWSPager ListPhoneNumbers where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lpnNextToken .~ rs ^. lpnrsNextToken
...
instance Hashable ListPhoneNumbers where

instance NFData ListPhoneNumbers where
...
instance NFData ListPhoneNumbersResponse where
