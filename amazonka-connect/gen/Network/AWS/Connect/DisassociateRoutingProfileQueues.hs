...
data DisassociateRoutingProfileQueues = DisassociateRoutingProfileQueues'{_drpqInstanceId
                                                                          ::
                                                                          !Text,
...
disassociateRoutingProfileQueues
    :: Text -- ^ 'drpqInstanceId'
    -> Text -- ^ 'drpqRoutingProfileId'
    -> DisassociateRoutingProfileQueues
disassociateRoutingProfileQueues pInstanceId_
  pRoutingProfileId_
  = DisassociateRoutingProfileQueues'{_drpqInstanceId =
                                        pInstanceId_,
                                      _drpqRoutingProfileId =
                                        pRoutingProfileId_,
...
instance AWSRequest DisassociateRoutingProfileQueues
         where
...
instance ToHeaders DisassociateRoutingProfileQueues
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DisassociateRoutingProfileQueues
         where
...
instance ToPath DisassociateRoutingProfileQueues
         where
        toPath DisassociateRoutingProfileQueues'{..}
          = mconcat
              ["/routing-profiles/", toBS _drpqInstanceId, "/",
               toBS _drpqRoutingProfileId, "/disassociate-queues"]

instance ToQuery DisassociateRoutingProfileQueues
         where
