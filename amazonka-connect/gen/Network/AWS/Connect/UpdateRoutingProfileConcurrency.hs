...
data UpdateRoutingProfileConcurrency = UpdateRoutingProfileConcurrency'{_urpcInstanceId
                                                                        ::
                                                                        !Text,
...
updateRoutingProfileConcurrency
    :: Text -- ^ 'urpcInstanceId'
    -> Text -- ^ 'urpcRoutingProfileId'
    -> UpdateRoutingProfileConcurrency
updateRoutingProfileConcurrency pInstanceId_
  pRoutingProfileId_
  = UpdateRoutingProfileConcurrency'{_urpcInstanceId =
                                       pInstanceId_,
...
instance AWSRequest UpdateRoutingProfileConcurrency
         where
...
instance NFData UpdateRoutingProfileConcurrency where

instance ToHeaders UpdateRoutingProfileConcurrency
         where
        toHeaders
          = const
              (mconcat
...
instance ToPath UpdateRoutingProfileConcurrency where
        toPath UpdateRoutingProfileConcurrency'{..}
          = mconcat
              ["/routing-profiles/", toBS _urpcInstanceId, "/",
               toBS _urpcRoutingProfileId, "/concurrency"]

instance ToQuery UpdateRoutingProfileConcurrency
         where
