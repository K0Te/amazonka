...
data DeleteUseCase = DeleteUseCase'{_ducInstanceId ::
                                    !Text,
...
deleteUseCase
    :: Text -- ^ 'ducInstanceId'
    -> Text -- ^ 'ducIntegrationAssociationId'
    -> Text -- ^ 'ducUseCaseId'
    -> DeleteUseCase
deleteUseCase pInstanceId_ pIntegrationAssociationId_
  pUseCaseId_
  = DeleteUseCase'{_ducInstanceId = pInstanceId_,
...
instance Hashable DeleteUseCase where

instance NFData DeleteUseCase where
...
instance ToPath DeleteUseCase where
        toPath DeleteUseCase'{..}
          = mconcat
              ["/instance/", toBS _ducInstanceId,
               "/integration-associations/",
               toBS _ducIntegrationAssociationId, "/use-cases/",
               toBS _ducUseCaseId]
...
instance NFData DeleteUseCaseResponse where
