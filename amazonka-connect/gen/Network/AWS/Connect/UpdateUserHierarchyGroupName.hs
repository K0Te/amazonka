...
data UpdateUserHierarchyGroupName = UpdateUserHierarchyGroupName'{_uuhgnName
                                                                  :: !Text,
...
updateUserHierarchyGroupName
    :: Text -- ^ 'uuhgnName'
    -> Text -- ^ 'uuhgnHierarchyGroupId'
    -> Text -- ^ 'uuhgnInstanceId'
    -> UpdateUserHierarchyGroupName
updateUserHierarchyGroupName pName_
  pHierarchyGroupId_ pInstanceId_
  = UpdateUserHierarchyGroupName'{_uuhgnName = pName_,
...
instance AWSRequest UpdateUserHierarchyGroupName
         where
...
instance Hashable UpdateUserHierarchyGroupName where

instance NFData UpdateUserHierarchyGroupName where
...
instance ToPath UpdateUserHierarchyGroupName where
        toPath UpdateUserHierarchyGroupName'{..}
          = mconcat
              ["/user-hierarchy-groups/", toBS _uuhgnInstanceId,
               "/", toBS _uuhgnHierarchyGroupId, "/name"]
