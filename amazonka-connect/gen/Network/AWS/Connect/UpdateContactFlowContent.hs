...
data UpdateContactFlowContent = UpdateContactFlowContent'{_ucfcInstanceId
                                                          :: !Text,
                                                          _ucfcContactFlowId ::
                                                          !Text,
                                                          _ucfcContent :: !Text}
...
updateContactFlowContent
    :: Text -- ^ 'ucfcInstanceId'
    -> Text -- ^ 'ucfcContactFlowId'
    -> Text -- ^ 'ucfcContent'
    -> UpdateContactFlowContent
updateContactFlowContent pInstanceId_ pContactFlowId_
  pContent_
  = UpdateContactFlowContent'{_ucfcInstanceId =
                                pInstanceId_,
...
instance AWSRequest UpdateContactFlowContent where
        type Rs UpdateContactFlowContent =
             UpdateContactFlowContentResponse
        request = postJSON connect
        response
          = receiveNull UpdateContactFlowContentResponse'

instance Hashable UpdateContactFlowContent where

instance NFData UpdateContactFlowContent where
...
instance ToPath UpdateContactFlowContent where
        toPath UpdateContactFlowContent'{..}
          = mconcat
              ["/contact-flows/", toBS _ucfcInstanceId, "/",
               toBS _ucfcContactFlowId, "/content"]
