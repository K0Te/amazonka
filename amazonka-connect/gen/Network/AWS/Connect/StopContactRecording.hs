...
data StopContactRecording = StopContactRecording'{_stoInstanceId
                                                  :: !Text,
                                                  _stoContactId :: !Text,
...
stopContactRecording
    :: Text -- ^ 'stoInstanceId'
    -> Text -- ^ 'stoContactId'
    -> Text -- ^ 'stoInitialContactId'
    -> StopContactRecording
stopContactRecording pInstanceId_ pContactId_
  pInitialContactId_
  = StopContactRecording'{_stoInstanceId =
                            pInstanceId_,
...
instance Hashable StopContactRecording where

instance NFData StopContactRecording where
...
newtype StopContactRecordingResponse = StopContactRecordingResponse'{_scrrsResponseStatus
                                                                     :: Int}
...
stopContactRecordingResponse pResponseStatus_
  = StopContactRecordingResponse'{_scrrsResponseStatus
                                    = pResponseStatus_}
...
instance NFData StopContactRecordingResponse where
