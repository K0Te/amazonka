...
data SuspendContactRecording = SuspendContactRecording'{_sInstanceId
                                                        :: !Text,
                                                        _sContactId :: !Text,
                                                        _sInitialContactId ::
                                                        !Text}
...
suspendContactRecording
    :: Text -- ^ 'sInstanceId'
    -> Text -- ^ 'sContactId'
    -> Text -- ^ 'sInitialContactId'
    -> SuspendContactRecording
suspendContactRecording pInstanceId_ pContactId_
  pInitialContactId_
  = SuspendContactRecording'{_sInstanceId =
                               pInstanceId_,
...
instance AWSRequest SuspendContactRecording where
        type Rs SuspendContactRecording =
             SuspendContactRecordingResponse
...
instance Hashable SuspendContactRecording where

instance NFData SuspendContactRecording where
...
newtype SuspendContactRecordingResponse = SuspendContactRecordingResponse'{_srsResponseStatus
                                                                           ::
                                                                           Int}
...
suspendContactRecordingResponse pResponseStatus_
  = SuspendContactRecordingResponse'{_srsResponseStatus
                                       = pResponseStatus_}
...
instance NFData SuspendContactRecordingResponse where
