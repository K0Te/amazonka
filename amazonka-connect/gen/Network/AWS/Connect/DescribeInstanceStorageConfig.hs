...
data DescribeInstanceStorageConfig = DescribeInstanceStorageConfig'{_discInstanceId
                                                                    :: !Text,
                                                                    _discAssociationId
                                                                    :: !Text,
                                                                    _discResourceType
...
describeInstanceStorageConfig
    :: Text -- ^ 'discInstanceId'
    -> Text -- ^ 'discAssociationId'
    -> InstanceStorageResourceType -- ^ 'discResourceType'
    -> DescribeInstanceStorageConfig
describeInstanceStorageConfig pInstanceId_
  pAssociationId_ pResourceType_
  = DescribeInstanceStorageConfig'{_discInstanceId =
                                     pInstanceId_,
...
instance AWSRequest DescribeInstanceStorageConfig
         where
...
instance Hashable DescribeInstanceStorageConfig where

instance NFData DescribeInstanceStorageConfig where

instance ToHeaders DescribeInstanceStorageConfig
         where
        toHeaders
          = const
              (mconcat
...
instance ToPath DescribeInstanceStorageConfig where
        toPath DescribeInstanceStorageConfig'{..}
          = mconcat
              ["/instance/", toBS _discInstanceId,
               "/storage-config/", toBS _discAssociationId]
...
data DescribeInstanceStorageConfigResponse = DescribeInstanceStorageConfigResponse'{_discrsStorageConfig
                                                                                    ::
                                                                                    !(Maybe
...
describeInstanceStorageConfigResponse
    :: Int -- ^ 'discrsResponseStatus'
    -> DescribeInstanceStorageConfigResponse
describeInstanceStorageConfigResponse
  pResponseStatus_
  = DescribeInstanceStorageConfigResponse'{_discrsStorageConfig
                                             = Nothing,
                                           _discrsResponseStatus =
                                             pResponseStatus_}
