...
data CreateRoutingProfile = CreateRoutingProfile'{_crpQueueConfigs
                                                  ::
                                                  !(Maybe
                                                      (List1
...
createRoutingProfile
    ...
    -> Text -- ^ 'crpName'
    -> Text -- ^ 'crpDescription'
    -> Text -- ^ 'crpDefaultOutboundQueueId'
    -> CreateRoutingProfile
createRoutingProfile pInstanceId_ pName_
  pDescription_ pDefaultOutboundQueueId_
  = CreateRoutingProfile'{_crpQueueConfigs = Nothing,
                          _crpTags = Nothing, _crpInstanceId = pInstanceId_,
                          _crpName = pName_, _crpDescription = pDescription_,
                          _crpDefaultOutboundQueueId =
...
instance Hashable CreateRoutingProfile where

instance NFData CreateRoutingProfile where
          ...
          = object
              (catMaybes
                 [("QueueConfigs" .=) <$> _crpQueueConfigs,
                  ("Tags" .=) <$> _crpTags, Just ("Name" .= _crpName),
...
data CreateRoutingProfileResponse = CreateRoutingProfileResponse'{_crprsRoutingProfileARN
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _crprsRoutingProfileId
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _crprsResponseStatus
                                                                  :: !Int}
...
createRoutingProfileResponse
    :: Int -- ^ 'crprsResponseStatus'
    -> CreateRoutingProfileResponse
createRoutingProfileResponse pResponseStatus_
  = CreateRoutingProfileResponse'{_crprsRoutingProfileARN
                                    = Nothing,
...
instance NFData CreateRoutingProfileResponse where
