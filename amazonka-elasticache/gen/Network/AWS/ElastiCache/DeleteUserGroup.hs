...
newtype DeleteUserGroup = DeleteUserGroup'{_dugUserGroupId
                                           :: Text}
...
instance AWSRequest DeleteUserGroup where
        ...
        response
          = receiveXMLWrapper "DeleteUserGroupResult"
              (\ s h x -> parseXML x)

instance Hashable DeleteUserGroup where

instance NFData DeleteUserGroup where
