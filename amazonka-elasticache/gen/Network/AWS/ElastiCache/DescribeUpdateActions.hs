...
data DescribeUpdateActions = DescribeUpdateActions'{_duaCacheClusterIds
                                                    :: !(Maybe [Text]),
...
instance AWSPager DescribeUpdateActions where
        page rq rs
          ...
          | otherwise =
            Just $ rq & duaMarker .~ rs ^. duarsMarker

instance AWSRequest DescribeUpdateActions where
        type Rs DescribeUpdateActions =
             DescribeUpdateActionsResponse
        request = postQuery elastiCache
        response
          = receiveXMLWrapper "DescribeUpdateActionsResult"
              (\ s h x ->
                 DescribeUpdateActionsResponse' <$>
...
instance Hashable DescribeUpdateActions where

instance NFData DescribeUpdateActions where
...
data DescribeUpdateActionsResponse = DescribeUpdateActionsResponse'{_duarsUpdateActions
                                                                    ::
                                                                    !(Maybe
                                                                        [UpdateAction]),
                                                                    _duarsMarker
...
describeUpdateActionsResponse pResponseStatus_
  = DescribeUpdateActionsResponse'{_duarsUpdateActions
                                     = Nothing,
...
instance NFData DescribeUpdateActionsResponse where
