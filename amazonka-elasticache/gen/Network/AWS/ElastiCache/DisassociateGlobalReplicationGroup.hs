...
data DisassociateGlobalReplicationGroup = DisassociateGlobalReplicationGroup'{_dgrgGlobalReplicationGroupId
                                                                              ::
                                                                              !Text,
...
disassociateGlobalReplicationGroup
    :: Text -- ^ 'dgrgGlobalReplicationGroupId'
    -> Text -- ^ 'dgrgReplicationGroupId'
    -> Text -- ^ 'dgrgReplicationGroupRegion'
    -> DisassociateGlobalReplicationGroup
disassociateGlobalReplicationGroup
  pGlobalReplicationGroupId_ pReplicationGroupId_
  pReplicationGroupRegion_
  = DisassociateGlobalReplicationGroup'{_dgrgGlobalReplicationGroupId
...
instance ToHeaders DisassociateGlobalReplicationGroup
         where
        toHeaders = const mempty

instance ToPath DisassociateGlobalReplicationGroup
         where
        toPath = const "/"

instance ToQuery DisassociateGlobalReplicationGroup
         where
...
data DisassociateGlobalReplicationGroupResponse = DisassociateGlobalReplicationGroupResponse'{_dgrgrsGlobalReplicationGroup
                                                                                              ::
                                                                                              !(Maybe
...
disassociateGlobalReplicationGroupResponse
    :: Int -- ^ 'dgrgrsResponseStatus'
    -> DisassociateGlobalReplicationGroupResponse
disassociateGlobalReplicationGroupResponse
  pResponseStatus_
  = DisassociateGlobalReplicationGroupResponse'{_dgrgrsGlobalReplicationGroup
                                                  = Nothing,
                                                _dgrgrsResponseStatus =
                                                  pResponseStatus_}
