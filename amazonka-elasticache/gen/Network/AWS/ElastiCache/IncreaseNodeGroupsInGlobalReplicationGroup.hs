...
data IncreaseNodeGroupsInGlobalReplicationGroup = IncreaseNodeGroupsInGlobalReplicationGroup'{_ingigrgRegionalConfigurations
                                                                                              ::
                                                                                              !(Maybe
...
increaseNodeGroupsInGlobalReplicationGroup
    :: Text -- ^ 'ingigrgGlobalReplicationGroupId'
    -> Int -- ^ 'ingigrgNodeGroupCount'
    -> Bool -- ^ 'ingigrgApplyImmediately'
    -> IncreaseNodeGroupsInGlobalReplicationGroup
increaseNodeGroupsInGlobalReplicationGroup
  pGlobalReplicationGroupId_ pNodeGroupCount_
  pApplyImmediately_
  = IncreaseNodeGroupsInGlobalReplicationGroup'{_ingigrgRegionalConfigurations
                                                  = Nothing,
                                                _ingigrgGlobalReplicationGroupId
...
instance AWSRequest
           IncreaseNodeGroupsInGlobalReplicationGroup
         where
        type Rs IncreaseNodeGroupsInGlobalReplicationGroup =
             IncreaseNodeGroupsInGlobalReplicationGroupResponse
...
data IncreaseNodeGroupsInGlobalReplicationGroupResponse = IncreaseNodeGroupsInGlobalReplicationGroupResponse'{_ingigrgrsGlobalReplicationGroup
                                                                                                              ::
                                                                                                              !(Maybe
...
increaseNodeGroupsInGlobalReplicationGroupResponse
    :: Int -- ^ 'ingigrgrsResponseStatus'
    -> IncreaseNodeGroupsInGlobalReplicationGroupResponse
increaseNodeGroupsInGlobalReplicationGroupResponse
  pResponseStatus_
  = IncreaseNodeGroupsInGlobalReplicationGroupResponse'{_ingigrgrsGlobalReplicationGroup
                                                          = Nothing,
                                                        _ingigrgrsResponseStatus
                                                          = pResponseStatus_}
