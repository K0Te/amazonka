...
data ModifyGlobalReplicationGroup = ModifyGlobalReplicationGroup'{_mgrgAutomaticFailoverEnabled
                                                                  ::
                                                                  !(Maybe Bool),
                                                                  _mgrgEngineVersion
                                                                  ::
...
modifyGlobalReplicationGroup
    :: Text -- ^ 'mgrgGlobalReplicationGroupId'
    -> Bool -- ^ 'mgrgApplyImmediately'
    -> ModifyGlobalReplicationGroup
modifyGlobalReplicationGroup
  pGlobalReplicationGroupId_ pApplyImmediately_
  = ModifyGlobalReplicationGroup'{_mgrgAutomaticFailoverEnabled
                                    = Nothing,
...
instance AWSRequest ModifyGlobalReplicationGroup
         where
...
instance Hashable ModifyGlobalReplicationGroup where

instance NFData ModifyGlobalReplicationGroup where
...
data ModifyGlobalReplicationGroupResponse = ModifyGlobalReplicationGroupResponse'{_mgrgrsGlobalReplicationGroup
                                                                                  ::
                                                                                  !(Maybe
...
modifyGlobalReplicationGroupResponse
    :: Int -- ^ 'mgrgrsResponseStatus'
    -> ModifyGlobalReplicationGroupResponse
modifyGlobalReplicationGroupResponse pResponseStatus_
  = ModifyGlobalReplicationGroupResponse'{_mgrgrsGlobalReplicationGroup
                                            = Nothing,
                                          _mgrgrsResponseStatus =
                                            pResponseStatus_}
