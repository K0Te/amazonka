...
data UserGroup = UserGroup'{_ugStatus ::
                            !(Maybe Text),
...
userGroup
    :: UserGroup
userGroup
  = UserGroup'{_ugStatus = Nothing,
               _ugUserIds = Nothing, _ugARN = Nothing,
               _ugUserGroupId = Nothing, _ugEngine = Nothing,
...
instance Hashable UserGroup where

instance NFData UserGroup where
