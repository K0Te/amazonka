...
data GlobalReplicationGroup = GlobalReplicationGroup'{_grgEngineVersion
                                                      :: !(Maybe Text),
                                                      _grgStatus ::
                                                      !(Maybe Text),
                                                      _grgCacheNodeType ::
...
globalReplicationGroup
    :: GlobalReplicationGroup
globalReplicationGroup
  = GlobalReplicationGroup'{_grgEngineVersion =
                              Nothing,
                            _grgStatus = Nothing, _grgCacheNodeType = Nothing,
                            _grgClusterEnabled = Nothing,
                            _grgAtRestEncryptionEnabled = Nothing,
                            _grgARN = Nothing,
                            _grgTransitEncryptionEnabled = Nothing,
                            _grgMembers = Nothing, _grgEngine = Nothing,
...
instance Hashable GlobalReplicationGroup where

instance NFData GlobalReplicationGroup where
