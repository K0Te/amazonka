...
data CacheSecurityGroup = CacheSecurityGroup'{_csgCacheSecurityGroupName
                                              :: !(Maybe Text),
                                              _csgARN :: !(Maybe Text),
...
cacheSecurityGroup
    :: CacheSecurityGroup
cacheSecurityGroup
  = CacheSecurityGroup'{_csgCacheSecurityGroupName =
                          Nothing,
                        _csgARN = Nothing, _csgOwnerId = Nothing,
...
instance FromXML CacheSecurityGroup where
        parseXML x
          = CacheSecurityGroup' <$>
              (x .@? "CacheSecurityGroupName") <*> (x .@? "ARN")
                <*> (x .@? "OwnerId")
                <*>
