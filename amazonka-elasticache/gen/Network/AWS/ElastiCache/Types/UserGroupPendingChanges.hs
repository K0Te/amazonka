...
data UserGroupPendingChanges = UserGroupPendingChanges'{_ugpcUserIdsToAdd
                                                        :: !(Maybe [Text]),
...
userGroupPendingChanges
    :: UserGroupPendingChanges
userGroupPendingChanges
  = UserGroupPendingChanges'{_ugpcUserIdsToAdd =
                               Nothing,
...
instance Hashable UserGroupPendingChanges where

instance NFData UserGroupPendingChanges where
