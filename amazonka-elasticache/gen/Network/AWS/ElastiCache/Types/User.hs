...
data User = User'{_uStatus :: !(Maybe Text),
                  _uARN :: !(Maybe Text),
...
user
    :: User
user
  = User'{_uStatus = Nothing, _uARN = Nothing,
          _uUserGroupIds = Nothing, _uAuthentication = Nothing,
          _uEngine = Nothing, _uUserName = Nothing,
          _uAccessString = Nothing, _uUserId = Nothing}
