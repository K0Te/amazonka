...
data ReservedCacheNode = ReservedCacheNode'{_rcnCacheNodeType
                                            :: !(Maybe Text),
...
reservedCacheNode
    :: ReservedCacheNode
reservedCacheNode
  = ReservedCacheNode'{_rcnCacheNodeType = Nothing,
                       _rcnState = Nothing, _rcnStartTime = Nothing,
                       ...
                       _rcnOfferingType = Nothing, _rcnUsagePrice = Nothing,
                       _rcnFixedPrice = Nothing, _rcnDuration = Nothing,
