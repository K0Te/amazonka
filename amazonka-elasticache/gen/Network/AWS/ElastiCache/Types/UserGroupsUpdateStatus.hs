...
data UserGroupsUpdateStatus = UserGroupsUpdateStatus'{_ugusUserGroupIdsToAdd
                                                      :: !(Maybe [Text]),
...
userGroupsUpdateStatus
    :: UserGroupsUpdateStatus
userGroupsUpdateStatus
  = UserGroupsUpdateStatus'{_ugusUserGroupIdsToAdd =
                              Nothing,
...
instance Hashable UserGroupsUpdateStatus where

instance NFData UserGroupsUpdateStatus where
