...
data Authentication = Authentication'{_aPasswordCount
                                      :: !(Maybe Int),
...
authentication
    :: Authentication
authentication
  = Authentication'{_aPasswordCount = Nothing,
                    _aType = Nothing}
...
instance Hashable Authentication where

instance NFData Authentication where
