...
data DescribeGlobalReplicationGroups = DescribeGlobalReplicationGroups'{_dgrgsShowMemberInfo
                                                                        ::
                                                                        !(Maybe
                                                                            Bool),
                                                                        _dgrgsMarker
...
describeGlobalReplicationGroups
    :: DescribeGlobalReplicationGroups
describeGlobalReplicationGroups
  = DescribeGlobalReplicationGroups'{_dgrgsShowMemberInfo
                                       = Nothing,
...
instance AWSPager DescribeGlobalReplicationGroups
         where
        page rq rs
          | stop (rs ^. dgrgsrsMarker) = Nothing
          | stop (rs ^. dgrgsrsGlobalReplicationGroups) =
            Nothing
          | otherwise =
            Just $ rq & dgrgsMarker .~ rs ^. dgrgsrsMarker

instance AWSRequest DescribeGlobalReplicationGroups
         where
...
instance NFData DescribeGlobalReplicationGroups where

instance ToHeaders DescribeGlobalReplicationGroups
         where
...
instance ToQuery DescribeGlobalReplicationGroups
         where
...
data DescribeGlobalReplicationGroupsResponse = DescribeGlobalReplicationGroupsResponse'{_dgrgsrsMarker
                                                                                        ::
                                                                                        !(Maybe
                                                                                            Text),
...
describeGlobalReplicationGroupsResponse
    :: Int -- ^ 'dgrgsrsResponseStatus'
    -> DescribeGlobalReplicationGroupsResponse
describeGlobalReplicationGroupsResponse
  pResponseStatus_
  = DescribeGlobalReplicationGroupsResponse'{_dgrgsrsMarker
                                               = Nothing,
                                             _dgrgsrsGlobalReplicationGroups =
                                               Nothing,
                                             _dgrgsrsResponseStatus =
