...
data BatchStopUpdateAction = BatchStopUpdateAction'{_bsuaCacheClusterIds
                                                    :: !(Maybe [Text]),
...
batchStopUpdateAction
    :: Text -- ^ 'bsuaServiceUpdateName'
    -> BatchStopUpdateAction
batchStopUpdateAction pServiceUpdateName_
  = BatchStopUpdateAction'{_bsuaCacheClusterIds =
                             Nothing,
...
instance AWSRequest BatchStopUpdateAction where
        type Rs BatchStopUpdateAction =
             UpdateActionResultsMessage
        request = postQuery elastiCache
        response
          = receiveXMLWrapper "BatchStopUpdateActionResult"
              (\ s h x -> parseXML x)

instance Hashable BatchStopUpdateAction where

instance NFData BatchStopUpdateAction where
