...
data DecreaseNodeGroupsInGlobalReplicationGroup = DecreaseNodeGroupsInGlobalReplicationGroup'{_dngigrgGlobalNodeGroupsToRemove
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  [Text]),
...
decreaseNodeGroupsInGlobalReplicationGroup
    :: Text -- ^ 'dngigrgGlobalReplicationGroupId'
    -> Int -- ^ 'dngigrgNodeGroupCount'
    -> Bool -- ^ 'dngigrgApplyImmediately'
    -> DecreaseNodeGroupsInGlobalReplicationGroup
decreaseNodeGroupsInGlobalReplicationGroup
  pGlobalReplicationGroupId_ pNodeGroupCount_
  pApplyImmediately_
  = DecreaseNodeGroupsInGlobalReplicationGroup'{_dngigrgGlobalNodeGroupsToRemove
                                                  = Nothing,
                                                _dngigrgGlobalNodeGroupsToRetain
                                                  = Nothing,
                                                _dngigrgGlobalReplicationGroupId
...
data DecreaseNodeGroupsInGlobalReplicationGroupResponse = DecreaseNodeGroupsInGlobalReplicationGroupResponse'{_dngigrgrsGlobalReplicationGroup
                                                                                                              ::
                                                                                                              !(Maybe
...
decreaseNodeGroupsInGlobalReplicationGroupResponse
    :: Int -- ^ 'dngigrgrsResponseStatus'
    -> DecreaseNodeGroupsInGlobalReplicationGroupResponse
decreaseNodeGroupsInGlobalReplicationGroupResponse
  pResponseStatus_
  = DecreaseNodeGroupsInGlobalReplicationGroupResponse'{_dngigrgrsGlobalReplicationGroup
                                                          = Nothing,
                                                        _dngigrgrsResponseStatus
                                                          = pResponseStatus_}
