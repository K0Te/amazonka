...
data DescribeUserGroups = DescribeUserGroups'{_dugsUserGroupId
                                              :: !(Maybe Text),
...
describeUserGroups
    :: DescribeUserGroups
describeUserGroups
  = DescribeUserGroups'{_dugsUserGroupId = Nothing,
                        _dugsMarker = Nothing, _dugsMaxRecords = Nothing}
...
instance AWSPager DescribeUserGroups where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dugsMarker .~ rs ^. dugrsMarker

instance AWSRequest DescribeUserGroups where
        type Rs DescribeUserGroups =
             DescribeUserGroupsResponse
        request = postQuery elastiCache
        response
          = receiveXMLWrapper "DescribeUserGroupsResult"
              (\ s h x ->
                 DescribeUserGroupsResponse' <$>
                   (x .@? "UserGroups" .!@ mempty >>=
...
instance Hashable DescribeUserGroups where

instance NFData DescribeUserGroups where
...
data DescribeUserGroupsResponse = DescribeUserGroupsResponse'{_dugrsUserGroups
                                                              ::
                                                              !(Maybe
                                                                  [UserGroup]),
                                                              _dugrsMarker ::
                                                              !(Maybe Text),
                                                              _dugrsResponseStatus
                                                              :: !Int}
...
describeUserGroupsResponse
    :: Int -- ^ 'dugrsResponseStatus'
    -> DescribeUserGroupsResponse
describeUserGroupsResponse pResponseStatus_
  = DescribeUserGroupsResponse'{_dugrsUserGroups =
                                  Nothing,
...
instance NFData DescribeUserGroupsResponse where
