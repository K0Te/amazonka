...
data RebalanceSlotsInGlobalReplicationGroup = RebalanceSlotsInGlobalReplicationGroup'{_rsigrgGlobalReplicationGroupId
                                                                                      ::
                                                                                      !Text,
...
rebalanceSlotsInGlobalReplicationGroup
    :: Text -- ^ 'rsigrgGlobalReplicationGroupId'
    -> Bool -- ^ 'rsigrgApplyImmediately'
    -> RebalanceSlotsInGlobalReplicationGroup
rebalanceSlotsInGlobalReplicationGroup
  pGlobalReplicationGroupId_ pApplyImmediately_
  = RebalanceSlotsInGlobalReplicationGroup'{_rsigrgGlobalReplicationGroupId
...
data RebalanceSlotsInGlobalReplicationGroupResponse = RebalanceSlotsInGlobalReplicationGroupResponse'{_rsigrgrsGlobalReplicationGroup
                                                                                                      ::
                                                                                                      !(Maybe
...
rebalanceSlotsInGlobalReplicationGroupResponse
    :: Int -- ^ 'rsigrgrsResponseStatus'
    -> RebalanceSlotsInGlobalReplicationGroupResponse
rebalanceSlotsInGlobalReplicationGroupResponse
  pResponseStatus_
  = RebalanceSlotsInGlobalReplicationGroupResponse'{_rsigrgrsGlobalReplicationGroup
                                                      = Nothing,
                                                    _rsigrgrsResponseStatus =
                                                      pResponseStatus_}
