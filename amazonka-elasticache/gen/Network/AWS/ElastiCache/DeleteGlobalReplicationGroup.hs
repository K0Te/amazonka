...
data DeleteGlobalReplicationGroupResponse = DeleteGlobalReplicationGroupResponse'{_dgrggrsGlobalReplicationGroup
                                                                                  ::
                                                                                  !(Maybe
...
deleteGlobalReplicationGroupResponse
    :: Int -- ^ 'dgrggrsResponseStatus'
    -> DeleteGlobalReplicationGroupResponse
deleteGlobalReplicationGroupResponse pResponseStatus_
  = DeleteGlobalReplicationGroupResponse'{_dgrggrsGlobalReplicationGroup
                                            = Nothing,
                                          _dgrggrsResponseStatus =
                                            pResponseStatus_}
