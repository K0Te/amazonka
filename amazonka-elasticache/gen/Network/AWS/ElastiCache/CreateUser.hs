...
data CreateUser = CreateUser'{_cuPasswords ::
                              !(Maybe (List1 Text)),
                              _cuNoPasswordRequired :: !(Maybe Bool),
                              _cuUserId :: !Text, _cuUserName :: !Text,
                              _cuEngine :: !Text, _cuAccessString :: !Text}
...
createUser
    ...
    -> Text -- ^ 'cuAccessString'
    -> CreateUser
createUser pUserId_ pUserName_ pEngine_
  pAccessString_
  = CreateUser'{_cuPasswords = Nothing,
                _cuNoPasswordRequired = Nothing,
                _cuUserId = pUserId_, _cuUserName = pUserName_,
                _cuEngine = pEngine_,
        ...
        toQuery CreateUser'{..}
          = mconcat
              ["Action" =: ("CreateUser" :: ByteString),
               ...
               "UserId" =: _cuUserId, "UserName" =: _cuUserName,
               "Engine" =: _cuEngine,
