...
data ModifyReplicationGroupShardConfiguration = ModifyReplicationGroupShardConfiguration'{_mrgscNodeGroupsToRetain
                                                                                          ::
                                                                                          !(Maybe
                                                                                              [Text]),
...
modifyReplicationGroupShardConfiguration
  ...
  pApplyImmediately_
  = ModifyReplicationGroupShardConfiguration'{_mrgscNodeGroupsToRetain
                                                = Nothing,
                                              _mrgscReshardingConfiguration =
                                                Nothing,
                                              _mrgscNodeGroupsToRemove =
