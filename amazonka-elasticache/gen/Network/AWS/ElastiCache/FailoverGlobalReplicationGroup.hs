...
data FailoverGlobalReplicationGroup = FailoverGlobalReplicationGroup'{_fgrgGlobalReplicationGroupId
                                                                      :: !Text,
                                                                      _fgrgPrimaryRegion
                                                                      :: !Text,
...
failoverGlobalReplicationGroup
    :: Text -- ^ 'fgrgGlobalReplicationGroupId'
    -> Text -- ^ 'fgrgPrimaryRegion'
    -> Text -- ^ 'fgrgPrimaryReplicationGroupId'
    -> FailoverGlobalReplicationGroup
failoverGlobalReplicationGroup
  pGlobalReplicationGroupId_ pPrimaryRegion_
  pPrimaryReplicationGroupId_
  = FailoverGlobalReplicationGroup'{_fgrgGlobalReplicationGroupId
...
instance AWSRequest FailoverGlobalReplicationGroup
         where
...
instance NFData FailoverGlobalReplicationGroup where

instance ToHeaders FailoverGlobalReplicationGroup
         where
...
data FailoverGlobalReplicationGroupResponse = FailoverGlobalReplicationGroupResponse'{_fgrgrsGlobalReplicationGroup
                                                                                      ::
                                                                                      !(Maybe
...
failoverGlobalReplicationGroupResponse
    :: Int -- ^ 'fgrgrsResponseStatus'
    -> FailoverGlobalReplicationGroupResponse
failoverGlobalReplicationGroupResponse
  pResponseStatus_
  = FailoverGlobalReplicationGroupResponse'{_fgrgrsGlobalReplicationGroup
                                              = Nothing,
                                            _fgrgrsResponseStatus =
                                              pResponseStatus_}
