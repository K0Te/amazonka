...
data BatchApplyUpdateAction = BatchApplyUpdateAction'{_bauaCacheClusterIds
                                                      :: !(Maybe [Text]),
...
batchApplyUpdateAction
    :: Text -- ^ 'bauaServiceUpdateName'
    -> BatchApplyUpdateAction
batchApplyUpdateAction pServiceUpdateName_
  = BatchApplyUpdateAction'{_bauaCacheClusterIds =
                              Nothing,
...
instance AWSRequest BatchApplyUpdateAction where
        type Rs BatchApplyUpdateAction =
             UpdateActionResultsMessage
        request = postQuery elastiCache
        response
          = receiveXMLWrapper "BatchApplyUpdateActionResult"
              (\ s h x -> parseXML x)

instance Hashable BatchApplyUpdateAction where

instance NFData BatchApplyUpdateAction where
