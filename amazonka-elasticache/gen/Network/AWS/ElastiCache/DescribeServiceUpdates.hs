...
data DescribeServiceUpdates = DescribeServiceUpdates'{_dsuServiceUpdateName
                                                      :: !(Maybe Text),
                                                      _dsuMarker ::
                                                      !(Maybe Text),
                                                      _dsuMaxRecords ::
...
describeServiceUpdates
    :: DescribeServiceUpdates
describeServiceUpdates
  = DescribeServiceUpdates'{_dsuServiceUpdateName =
                              Nothing,
                            _dsuMarker = Nothing, _dsuMaxRecords = Nothing,
...
instance AWSPager DescribeServiceUpdates where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dsuMarker .~ rs ^. dsursMarker

instance AWSRequest DescribeServiceUpdates where
        type Rs DescribeServiceUpdates =
             DescribeServiceUpdatesResponse
        request = postQuery elastiCache
        response
          = receiveXMLWrapper "DescribeServiceUpdatesResult"
              (\ s h x ->
                 DescribeServiceUpdatesResponse' <$>
...
instance Hashable DescribeServiceUpdates where

instance NFData DescribeServiceUpdates where
...
data DescribeServiceUpdatesResponse = DescribeServiceUpdatesResponse'{_dsursServiceUpdates
                                                                      ::
                                                                      !(Maybe
                                                                          [ServiceUpdate]),
                                                                      _dsursMarker
...
describeServiceUpdatesResponse
    :: Int -- ^ 'dsursResponseStatus'
    -> DescribeServiceUpdatesResponse
describeServiceUpdatesResponse pResponseStatus_
  = DescribeServiceUpdatesResponse'{_dsursServiceUpdates
                                      = Nothing,
...
instance NFData DescribeServiceUpdatesResponse where
