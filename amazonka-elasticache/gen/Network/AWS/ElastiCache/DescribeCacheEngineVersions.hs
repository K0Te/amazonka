...
data DescribeCacheEngineVersions = DescribeCacheEngineVersions'{_dcevEngineVersion
                                                                ::
                                                                !(Maybe Text),
...
describeCacheEngineVersions
    :: DescribeCacheEngineVersions
describeCacheEngineVersions
  = DescribeCacheEngineVersions'{_dcevEngineVersion =
                                   Nothing,
                                 _dcevCacheParameterGroupFamily = Nothing,
                                 _dcevDefaultOnly = Nothing,
                                 _dcevEngine = Nothing, _dcevMarker = Nothing,
...
data DescribeCacheEngineVersionsResponse = DescribeCacheEngineVersionsResponse'{_dcevrsCacheEngineVersions
                                                                                ::
                                                                                !(Maybe
                                                                                    [CacheEngineVersion]),
                                                                                _dcevrsMarker
