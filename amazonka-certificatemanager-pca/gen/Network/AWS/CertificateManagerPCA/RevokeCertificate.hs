...
data RevokeCertificate = RevokeCertificate'{_rcCertificateAuthorityARN
                                            :: !Text,
...
revokeCertificate
    ...
    -> RevokeCertificate
revokeCertificate pCertificateAuthorityARN_
  pCertificateSerial_ pRevocationReason_
  = RevokeCertificate'{_rcCertificateAuthorityARN =
