...
data ListPermissions = ListPermissions'{_lpNextToken
                                        :: !(Maybe Text),
...
listPermissions pCertificateAuthorityARN_
  = ListPermissions'{_lpNextToken = Nothing,
...
data ListPermissionsResponse = ListPermissionsResponse'{_lprsNextToken
                                                        :: !(Maybe Text),
                                                        _lprsPermissions ::
                                                        !(Maybe [Permission]),
                                                        _lprsResponseStatus ::
...
listPermissionsResponse pResponseStatus_
  = ListPermissionsResponse'{_lprsNextToken = Nothing,
