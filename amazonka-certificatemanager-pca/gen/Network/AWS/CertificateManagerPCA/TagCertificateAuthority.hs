...
data TagCertificateAuthority = TagCertificateAuthority'{_tcaCertificateAuthorityARN
                                                        :: !Text,
                                                        _tcaTags ::
                                                        !(List1 Tag)}
...
tagCertificateAuthority
    ...
    -> TagCertificateAuthority
tagCertificateAuthority pCertificateAuthorityARN_
  pTags_
  = TagCertificateAuthority'{_tcaCertificateAuthorityARN
