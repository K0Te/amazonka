...
data CreatePermission = CreatePermission'{_cpSourceAccount
                                          :: !(Maybe Text),
...
createPermission
    ...
    -> CreatePermission
createPermission pCertificateAuthorityARN_
  pPrincipal_ pActions_
  = CreatePermission'{_cpSourceAccount = Nothing,
