...
data UntagCertificateAuthority = UntagCertificateAuthority'{_uCertificateAuthorityARN
                                                            :: !Text,
                                                            _uTags ::
                                                            !(List1 Tag)}
...
untagCertificateAuthority
    ...
    -> NonEmpty Tag -- ^ 'uTags'
    -> UntagCertificateAuthority
untagCertificateAuthority pCertificateAuthorityARN_
  pTags_
  = UntagCertificateAuthority'{_uCertificateAuthorityARN
