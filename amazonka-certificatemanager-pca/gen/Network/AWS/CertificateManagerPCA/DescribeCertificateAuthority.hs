...
newtype DescribeCertificateAuthority = DescribeCertificateAuthority'{_dCertificateAuthorityARN
                                                                     :: Text}
...
describeCertificateAuthority
  ...
  = DescribeCertificateAuthority'{_dCertificateAuthorityARN
                                    = pCertificateAuthorityARN_}
...
data DescribeCertificateAuthorityResponse = DescribeCertificateAuthorityResponse'{_dcarsCertificateAuthority
                                                                                  ::
                                                                                  !(Maybe
...
describeCertificateAuthorityResponse pResponseStatus_
  = DescribeCertificateAuthorityResponse'{_dcarsCertificateAuthority
                                            = Nothing,
                                          _dcarsResponseStatus =
                                            pResponseStatus_}
