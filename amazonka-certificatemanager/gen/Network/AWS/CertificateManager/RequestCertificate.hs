...
data RequestCertificate = RequestCertificate'{_rcIdempotencyToken
                                              :: !(Maybe Text),
                                              _rcValidationMethod ::
...
requestCertificate pDomainName_
  = RequestCertificate'{_rcIdempotencyToken = Nothing,
                        ...
                        _rcTags = Nothing, _rcDomainName = pDomainName_}
...
data RequestCertificateResponse = RequestCertificateResponse'{_rcrsCertificateARN
                                                              :: !(Maybe Text),
                                                              _rcrsResponseStatus
                                                              :: !Int}
...
requestCertificateResponse pResponseStatus_
  = RequestCertificateResponse'{_rcrsCertificateARN =
                                  Nothing,
