...
data ImportCertificate = ImportCertificate'{_icCertificateARN
                                            :: !(Maybe Text),
                                            _icCertificateChain ::
                                            !(Maybe Base64),
...
importCertificate pCertificate_ pPrivateKey_
  = ImportCertificate'{_icCertificateARN = Nothing,
                       _icCertificateChain = Nothing, _icTags = Nothing,
...
data ImportCertificateResponse = ImportCertificateResponse'{_icrsCertificateARN
                                                            :: !(Maybe Text),
                                                            _icrsResponseStatus
                                                            :: !Int}
...
importCertificateResponse pResponseStatus_
  = ImportCertificateResponse'{_icrsCertificateARN =
                                 Nothing,
