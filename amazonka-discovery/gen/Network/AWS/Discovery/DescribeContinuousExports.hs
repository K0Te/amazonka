...
data DescribeContinuousExports = DescribeContinuousExports'{_dceNextToken
                                                            :: !(Maybe Text),
                                                            _dceExportIds ::
                                                            !(Maybe [Text]),
                                                            _dceMaxResults ::
...
describeContinuousExports
    :: DescribeContinuousExports
describeContinuousExports
  = DescribeContinuousExports'{_dceNextToken = Nothing,
...
data DescribeContinuousExportsResponse = DescribeContinuousExportsResponse'{_dcersNextToken
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
                                                                            _dcersDescriptions
...
describeContinuousExportsResponse pResponseStatus_
  = DescribeContinuousExportsResponse'{_dcersNextToken
                                         = Nothing,
