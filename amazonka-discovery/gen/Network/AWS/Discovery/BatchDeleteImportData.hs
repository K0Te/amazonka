...
newtype BatchDeleteImportData = BatchDeleteImportData'{_bdidImportTaskIds
                                                       :: List1 Text}
...
batchDeleteImportData pImportTaskIds_
  = BatchDeleteImportData'{_bdidImportTaskIds =
...
data BatchDeleteImportDataResponse = BatchDeleteImportDataResponse'{_bdidrsErrors
                                                                    ::
                                                                    !(Maybe
                                                                        [BatchDeleteImportDataError]),
                                                                    _bdidrsResponseStatus
                                                                    :: !Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
batchDeleteImportDataResponse pResponseStatus_
  = BatchDeleteImportDataResponse'{_bdidrsErrors =
                                     Nothing,
