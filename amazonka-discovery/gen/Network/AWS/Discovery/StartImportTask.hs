...
data StartImportTask = StartImportTask'{_sitClientRequestToken
                                        :: !(Maybe Text),
                                        _sitName :: !Text,
                                        _sitImportURL :: !Text}
...
startImportTask pName_ pImportURL_
  = StartImportTask'{_sitClientRequestToken = Nothing,
                     _sitName = pName_, _sitImportURL = pImportURL_}
...
data StartImportTaskResponse = StartImportTaskResponse'{_sitrsTask
                                                        :: !(Maybe ImportTask),
                                                        _sitrsResponseStatus ::
                                                        !Int}
...
startImportTaskResponse pResponseStatus_
  = StartImportTaskResponse'{_sitrsTask = Nothing,
