...
newtype StopContinuousExport = StopContinuousExport'{_sceExportId
                                                     :: Text}
...
data StopContinuousExportResponse = StopContinuousExportResponse'{_srsStartTime
                                                                  ::
                                                                  !(Maybe
                                                                      POSIX),
                                                                  _srsStopTime
...
stopContinuousExportResponse pResponseStatus_
  = StopContinuousExportResponse'{_srsStartTime =
                                    Nothing,
