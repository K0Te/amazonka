...
data StartContinuousExportResponse = StartContinuousExportResponse'{_scersStartTime
                                                                    ::
                                                                    !(Maybe
                                                                        POSIX),
                                                                    _scersSchemaStorageConfig
                                                                    ::
                                                                    !(Maybe
                                                                        (Map
                                                                           Text
...
startContinuousExportResponse pResponseStatus_
  = StartContinuousExportResponse'{_scersStartTime =
                                     Nothing,
