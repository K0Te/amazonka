...
data DescribeAgents = DescribeAgents'{_daAgentIds ::
                                      !(Maybe [Text]),
...
describeAgents
    :: DescribeAgents
describeAgents
  = DescribeAgents'{_daAgentIds = Nothing,
                    _daFilters = Nothing, _daNextToken = Nothing,
...
data DescribeAgentsResponse = DescribeAgentsResponse'{_dasrsAgentsInfo
                                                      :: !(Maybe [AgentInfo]),
                                                      _dasrsNextToken ::
                                                      !(Maybe Text),
...
describeAgentsResponse pResponseStatus_
  = DescribeAgentsResponse'{_dasrsAgentsInfo = Nothing,
