...
data DescribeImportTasks = DescribeImportTasks'{_ditFilters
...
describeImportTasks
    :: DescribeImportTasks
describeImportTasks
  = DescribeImportTasks'{_ditFilters = Nothing,
                         _ditNextToken = Nothing, _ditMaxResults = Nothing}
...
data DescribeImportTasksResponse = DescribeImportTasksResponse'{_ditrsTasks
                                                                ::
                                                                !(Maybe
                                                                    [ImportTask]),
                                                                _ditrsNextToken
...
describeImportTasksResponse pResponseStatus_
  = DescribeImportTasksResponse'{_ditrsTasks = Nothing,
