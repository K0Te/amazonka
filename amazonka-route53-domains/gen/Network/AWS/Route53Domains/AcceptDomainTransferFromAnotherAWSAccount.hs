...
data AcceptDomainTransferFromAnotherAWSAccount = AcceptDomainTransferFromAnotherAWSAccount'{_adtfaaaDomainName
                                                                                            ::
                                                                                            !Text,
                                                                                            _adtfaaaPassword
                                                                                            ::
...
acceptDomainTransferFromAnotherAWSAccount
    :: Text -- ^ 'adtfaaaDomainName'
    -> Text -- ^ 'adtfaaaPassword'
    -> AcceptDomainTransferFromAnotherAWSAccount
acceptDomainTransferFromAnotherAWSAccount
  pDomainName_ pPassword_
  = AcceptDomainTransferFromAnotherAWSAccount'{_adtfaaaDomainName
                                                 = pDomainName_,
...
data AcceptDomainTransferFromAnotherAWSAccountResponse = AcceptDomainTransferFromAnotherAWSAccountResponse'{_adtfaaarsOperationId
                                                                                                            ::
                                                                                                            !(Maybe
                                                                                                                Text),
...
acceptDomainTransferFromAnotherAWSAccountResponse
    :: Int -- ^ 'adtfaaarsResponseStatus'
    -> AcceptDomainTransferFromAnotherAWSAccountResponse
acceptDomainTransferFromAnotherAWSAccountResponse
  pResponseStatus_
  = AcceptDomainTransferFromAnotherAWSAccountResponse'{_adtfaaarsOperationId
                                                         = Nothing,
                                                       _adtfaaarsResponseStatus
                                                         = pResponseStatus_}
