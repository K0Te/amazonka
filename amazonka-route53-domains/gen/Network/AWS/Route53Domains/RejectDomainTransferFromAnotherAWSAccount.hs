...
newtype RejectDomainTransferFromAnotherAWSAccount = RejectDomainTransferFromAnotherAWSAccount'{_rdtfaaaDomainName
                                                                                               ::
                                                                                               Text}
...
rejectDomainTransferFromAnotherAWSAccount
    :: Text -- ^ 'rdtfaaaDomainName'
    -> RejectDomainTransferFromAnotherAWSAccount
rejectDomainTransferFromAnotherAWSAccount
  pDomainName_
  = RejectDomainTransferFromAnotherAWSAccount'{_rdtfaaaDomainName
                                                 = pDomainName_}
...
data RejectDomainTransferFromAnotherAWSAccountResponse = RejectDomainTransferFromAnotherAWSAccountResponse'{_rdtfaaarsOperationId
                                                                                                            ::
                                                                                                            !(Maybe
                                                                                                                Text),
...
rejectDomainTransferFromAnotherAWSAccountResponse
    :: Int -- ^ 'rdtfaaarsResponseStatus'
    -> RejectDomainTransferFromAnotherAWSAccountResponse
rejectDomainTransferFromAnotherAWSAccountResponse
  pResponseStatus_
  = RejectDomainTransferFromAnotherAWSAccountResponse'{_rdtfaaarsOperationId
                                                         = Nothing,
                                                       _rdtfaaarsResponseStatus
                                                         = pResponseStatus_}
