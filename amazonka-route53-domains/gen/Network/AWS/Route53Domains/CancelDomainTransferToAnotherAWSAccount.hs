...
newtype CancelDomainTransferToAnotherAWSAccount = CancelDomainTransferToAnotherAWSAccount'{_cdttaaaDomainName
                                                                                           ::
                                                                                           Text}
...
cancelDomainTransferToAnotherAWSAccount
    :: Text -- ^ 'cdttaaaDomainName'
    -> CancelDomainTransferToAnotherAWSAccount
cancelDomainTransferToAnotherAWSAccount pDomainName_
  = CancelDomainTransferToAnotherAWSAccount'{_cdttaaaDomainName
                                               = pDomainName_}
...
data CancelDomainTransferToAnotherAWSAccountResponse = CancelDomainTransferToAnotherAWSAccountResponse'{_cdttaaarsOperationId
                                                                                                        ::
                                                                                                        !(Maybe
                                                                                                            Text),
...
cancelDomainTransferToAnotherAWSAccountResponse
    :: Int -- ^ 'cdttaaarsResponseStatus'
    -> CancelDomainTransferToAnotherAWSAccountResponse
cancelDomainTransferToAnotherAWSAccountResponse
  pResponseStatus_
  = CancelDomainTransferToAnotherAWSAccountResponse'{_cdttaaarsOperationId
                                                       = Nothing,
                                                     _cdttaaarsResponseStatus =
                                                       pResponseStatus_}
