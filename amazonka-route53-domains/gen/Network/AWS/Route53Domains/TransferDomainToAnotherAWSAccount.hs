...
data TransferDomainToAnotherAWSAccount = TransferDomainToAnotherAWSAccount'{_tdtaaaDomainName
                                                                            ::
                                                                            !Text,
                                                                            _tdtaaaAccountId
                                                                            ::
...
transferDomainToAnotherAWSAccount
    :: Text -- ^ 'tdtaaaDomainName'
    -> Text -- ^ 'tdtaaaAccountId'
    -> TransferDomainToAnotherAWSAccount
transferDomainToAnotherAWSAccount pDomainName_
  pAccountId_
  = TransferDomainToAnotherAWSAccount'{_tdtaaaDomainName
                                         = pDomainName_,
...
instance AWSRequest TransferDomainToAnotherAWSAccount
         where
...
instance ToHeaders TransferDomainToAnotherAWSAccount
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON TransferDomainToAnotherAWSAccount
         where
...
instance ToPath TransferDomainToAnotherAWSAccount
         where
        toPath = const "/"

instance ToQuery TransferDomainToAnotherAWSAccount
         where
...
data TransferDomainToAnotherAWSAccountResponse = TransferDomainToAnotherAWSAccountResponse'{_tdtaaarsPassword
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
...
transferDomainToAnotherAWSAccountResponse
    :: Int -- ^ 'tdtaaarsResponseStatus'
    -> TransferDomainToAnotherAWSAccountResponse
transferDomainToAnotherAWSAccountResponse
  pResponseStatus_
  = TransferDomainToAnotherAWSAccountResponse'{_tdtaaarsPassword
                                                 = Nothing,
