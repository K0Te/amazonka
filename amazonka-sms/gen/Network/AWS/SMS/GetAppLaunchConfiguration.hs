...
newtype GetAppLaunchConfiguration = GetAppLaunchConfiguration'{_galcAppId
                                                               :: Maybe Text}
...
data GetAppLaunchConfigurationResponse = GetAppLaunchConfigurationResponse'{_galcrsServerGroupLaunchConfigurations
                                                                            ::
                                                                            !(Maybe
...
getAppLaunchConfigurationResponse pResponseStatus_
  = GetAppLaunchConfigurationResponse'{_galcrsServerGroupLaunchConfigurations
                                         = Nothing,
