...
data PutAppLaunchConfiguration = PutAppLaunchConfiguration'{_palcServerGroupLaunchConfigurations
                                                            ::
                                                            !(Maybe
...
putAppLaunchConfiguration
    :: PutAppLaunchConfiguration
putAppLaunchConfiguration
  = PutAppLaunchConfiguration'{_palcServerGroupLaunchConfigurations
                                 = Nothing,
                               _palcAutoLaunch = Nothing,
                               _palcRoleName = Nothing, _palcAppId = Nothing}
...
newtype PutAppLaunchConfigurationResponse = PutAppLaunchConfigurationResponse'{_palcrsResponseStatus
                                                                               ::
                                                                               Int}
...
putAppLaunchConfigurationResponse pResponseStatus_
  = PutAppLaunchConfigurationResponse'{_palcrsResponseStatus
                                         = pResponseStatus_}
