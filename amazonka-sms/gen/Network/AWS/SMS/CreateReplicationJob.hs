...
data CreateReplicationJob = CreateReplicationJob'{_crjFrequency
                                                  :: !(Maybe Int),
...
createReplicationJob pServerId_ pSeedReplicationTime_
  = CreateReplicationJob'{_crjFrequency = Nothing,
                          _crjNumberOfRecentAMIsToKeep = Nothing,
                          _crjLicenseType = Nothing, _crjRoleName = Nothing,
                          _crjEncrypted = Nothing, _crjKmsKeyId = Nothing,
                          _crjRunOnce = Nothing, _crjDescription = Nothing,
