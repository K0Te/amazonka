...
data StartOnDemandAppReplication = StartOnDemandAppReplication'{_sodarDescription
                                                                ::
                                                                !(Maybe Text),
                                                                _sodarAppId ::
                                                                !Text}
...
startOnDemandAppReplication pAppId_
  = StartOnDemandAppReplication'{_sodarDescription =
                                   Nothing,
                                 _sodarAppId = pAppId_}
...
instance Hashable StartOnDemandAppReplication where

instance NFData StartOnDemandAppReplication where
...
newtype StartOnDemandAppReplicationResponse = StartOnDemandAppReplicationResponse'{_sodarrsResponseStatus
                                                                                   ::
                                                                                   Int}
...
startOnDemandAppReplicationResponse
    :: Int -- ^ 'sodarrsResponseStatus'
    -> StartOnDemandAppReplicationResponse
startOnDemandAppReplicationResponse pResponseStatus_
  = StartOnDemandAppReplicationResponse'{_sodarrsResponseStatus
                                           = pResponseStatus_}
