...
data CreateApp = CreateApp'{_caClientToken ::
                            !(Maybe Text),
...
createApp
    :: CreateApp
createApp
  = CreateApp'{_caClientToken = Nothing,
               _caRoleName = Nothing, _caName = Nothing,
               _caDescription = Nothing, _caServerGroups = Nothing,
               _caTags = Nothing}
...
data CreateAppResponse = CreateAppResponse'{_carsAppSummary
                                            :: !(Maybe AppSummary),
                                            _carsServerGroups ::
                                            !(Maybe [ServerGroup]),
                                            _carsTags :: !(Maybe [Tag]),
...
createAppResponse pResponseStatus_
  = CreateAppResponse'{_carsAppSummary = Nothing,
                       _carsServerGroups = Nothing, _carsTags = Nothing,
