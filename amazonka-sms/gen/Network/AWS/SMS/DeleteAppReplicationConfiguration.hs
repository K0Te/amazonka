...
newtype DeleteAppReplicationConfiguration = DeleteAppReplicationConfiguration'{_darcAppId
                                                                               ::
                                                                               Maybe
                                                                                 Text}
...
deleteAppReplicationConfiguration
    :: DeleteAppReplicationConfiguration
deleteAppReplicationConfiguration
  = DeleteAppReplicationConfiguration'{_darcAppId =
                                         Nothing}
...
newtype DeleteAppReplicationConfigurationResponse = DeleteAppReplicationConfigurationResponse'{_darcrsResponseStatus
                                                                                               ::
                                                                                               Int}
...
deleteAppReplicationConfigurationResponse
  pResponseStatus_
  = DeleteAppReplicationConfigurationResponse'{_darcrsResponseStatus
                                                 = pResponseStatus_}
