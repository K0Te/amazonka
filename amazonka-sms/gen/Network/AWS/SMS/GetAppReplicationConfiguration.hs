...
newtype GetAppReplicationConfiguration = GetAppReplicationConfiguration'{_garcAppId
                                                                         ::
                                                                         Maybe
                                                                           Text}
...
getAppReplicationConfiguration
    :: GetAppReplicationConfiguration
getAppReplicationConfiguration
  = GetAppReplicationConfiguration'{_garcAppId =
                                      Nothing}
...
data GetAppReplicationConfigurationResponse = GetAppReplicationConfigurationResponse'{_garcrsServerGroupReplicationConfigurations
                                                                                      ::
                                                                                      !(Maybe
...
getAppReplicationConfigurationResponse
  pResponseStatus_
  = GetAppReplicationConfigurationResponse'{_garcrsServerGroupReplicationConfigurations
                                              = Nothing,
                                            _garcrsResponseStatus =
                                              pResponseStatus_}
