...
newtype GetAppValidationOutput = GetAppValidationOutput'{_gavoAppId
                                                         :: Text}
...
instance AWSRequest GetAppValidationOutput where
        type Rs GetAppValidationOutput =
             GetAppValidationOutputResponse
...
instance Hashable GetAppValidationOutput where

instance NFData GetAppValidationOutput where
...
data GetAppValidationOutputResponse = GetAppValidationOutputResponse'{_gavorsValidationOutputList
                                                                      ::
                                                                      !(Maybe
                                                                          [ValidationOutput]),
                                                                      _gavorsResponseStatus
                                                                      :: !Int}
...
getAppValidationOutputResponse
    :: Int -- ^ 'gavorsResponseStatus'
    -> GetAppValidationOutputResponse
getAppValidationOutputResponse pResponseStatus_
  = GetAppValidationOutputResponse'{_gavorsValidationOutputList
                                      = Nothing,
...
instance NFData GetAppValidationOutputResponse where
