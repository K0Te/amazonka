...
newtype GetAppValidationConfiguration = GetAppValidationConfiguration'{_gavcAppId
                                                                       :: Text}
...
getAppValidationConfiguration pAppId_
  = GetAppValidationConfiguration'{_gavcAppId =
                                     pAppId_}
...
instance AWSRequest GetAppValidationConfiguration
         where
...
instance Hashable GetAppValidationConfiguration where

instance NFData GetAppValidationConfiguration where

instance ToHeaders GetAppValidationConfiguration
         where
        toHeaders
          = const
              (mconcat
...
data GetAppValidationConfigurationResponse = GetAppValidationConfigurationResponse'{_gavcrsServerGroupValidationConfigurations
                                                                                    ::
                                                                                    !(Maybe
...
getAppValidationConfigurationResponse
  pResponseStatus_
  = GetAppValidationConfigurationResponse'{_gavcrsServerGroupValidationConfigurations
                                             = Nothing,
                                           _gavcrsAppValidationConfigurations =
                                             Nothing,
                                           _gavcrsResponseStatus =
