...
data PutAppValidationConfiguration = PutAppValidationConfiguration'{_pavcServerGroupValidationConfigurations
                                                                    ::
                                                                    !(Maybe
...
putAppValidationConfiguration pAppId_
  = PutAppValidationConfiguration'{_pavcServerGroupValidationConfigurations
                                     = Nothing,
...
instance AWSRequest PutAppValidationConfiguration
         where
...
instance Hashable PutAppValidationConfiguration where

instance NFData PutAppValidationConfiguration where

instance ToHeaders PutAppValidationConfiguration
         where
        toHeaders
          = const
              (mconcat
...
newtype PutAppValidationConfigurationResponse = PutAppValidationConfigurationResponse'{_pavcrsResponseStatus
                                                                                       ::
                                                                                       Int}
...
putAppValidationConfigurationResponse
    :: Int -- ^ 'pavcrsResponseStatus'
    -> PutAppValidationConfigurationResponse
putAppValidationConfigurationResponse
  pResponseStatus_
  = PutAppValidationConfigurationResponse'{_pavcrsResponseStatus
                                             = pResponseStatus_}
