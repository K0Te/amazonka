...
newtype TerminateApp = TerminateApp'{_taAppId ::
                                     Maybe Text}
...
newtype TerminateAppResponse = TerminateAppResponse'{_tarsResponseStatus
                                                     :: Int}
...
terminateAppResponse pResponseStatus_
  = TerminateAppResponse'{_tarsResponseStatus =
                            pResponseStatus_}
