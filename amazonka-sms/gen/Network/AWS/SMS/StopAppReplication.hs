...
newtype StopAppReplication = StopAppReplication'{_sAppId
                                                 :: Maybe Text}
...
newtype StopAppReplicationResponse = StopAppReplicationResponse'{_sarrsResponseStatus
                                                                 :: Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
stopAppReplicationResponse pResponseStatus_
  = StopAppReplicationResponse'{_sarrsResponseStatus =
                                  pResponseStatus_}
