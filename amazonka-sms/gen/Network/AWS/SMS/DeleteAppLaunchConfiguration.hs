...
newtype DeleteAppLaunchConfiguration = DeleteAppLaunchConfiguration'{_dalcAppId
                                                                     ::
                                                                     Maybe Text}
...
newtype DeleteAppLaunchConfigurationResponse = DeleteAppLaunchConfigurationResponse'{_dalcrsResponseStatus
                                                                                     ::
                                                                                     Int}
                                                 deriving (Eq, Read, Show, Data,
                                                           Typeable, Generic)
...
deleteAppLaunchConfigurationResponse pResponseStatus_
  = DeleteAppLaunchConfigurationResponse'{_dalcrsResponseStatus
                                            = pResponseStatus_}
