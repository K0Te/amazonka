...
data NotifyAppValidationOutput = NotifyAppValidationOutput'{_navoNotificationContext
                                                            ::
                                                            !(Maybe
                                                                NotificationContext),
                                                            _navoAppId :: !Text}
...
notifyAppValidationOutput pAppId_
  = NotifyAppValidationOutput'{_navoNotificationContext
                                 = Nothing,
                               _navoAppId = pAppId_}
...
instance Hashable NotifyAppValidationOutput where

instance NFData NotifyAppValidationOutput where
...
newtype NotifyAppValidationOutputResponse = NotifyAppValidationOutputResponse'{_navorsResponseStatus
                                                                               ::
                                                                               Int}
...
notifyAppValidationOutputResponse
    :: Int -- ^ 'navorsResponseStatus'
    -> NotifyAppValidationOutputResponse
notifyAppValidationOutputResponse pResponseStatus_
  = NotifyAppValidationOutputResponse'{_navorsResponseStatus
                                         = pResponseStatus_}
