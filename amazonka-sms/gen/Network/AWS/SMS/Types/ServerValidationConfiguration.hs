...
data ServerValidationConfiguration = ServerValidationConfiguration'{_svcServerValidationStrategy
                                                                    ::
                                                                    !(Maybe
...
serverValidationConfiguration
    :: ServerValidationConfiguration
serverValidationConfiguration
  = ServerValidationConfiguration'{_svcServerValidationStrategy
                                     = Nothing,
                                   _svcUserDataValidationParameters = Nothing,
                                   _svcName = Nothing, _svcServer = Nothing,
...
instance FromJSON ServerValidationConfiguration where
        parseJSON
          = withObject "ServerValidationConfiguration"
              (\ x ->
                 ServerValidationConfiguration' <$>
...
instance Hashable ServerValidationConfiguration where

instance NFData ServerValidationConfiguration where
