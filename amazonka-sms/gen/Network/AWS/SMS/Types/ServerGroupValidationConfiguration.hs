...
data ServerGroupValidationConfiguration = ServerGroupValidationConfiguration'{_sgvcServerValidationConfigurations
                                                                              ::
                                                                              !(Maybe
...
serverGroupValidationConfiguration
    :: ServerGroupValidationConfiguration
serverGroupValidationConfiguration
  = ServerGroupValidationConfiguration'{_sgvcServerValidationConfigurations
                                          = Nothing,
...
instance FromJSON ServerGroupValidationConfiguration
         where
        parseJSON
          = withObject "ServerGroupValidationConfiguration"
              (\ x ->
                 ServerGroupValidationConfiguration' <$>
...
instance ToJSON ServerGroupValidationConfiguration
         where
