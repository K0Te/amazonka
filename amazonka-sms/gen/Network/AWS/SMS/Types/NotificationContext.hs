...
data NotificationContext = NotificationContext'{_ncStatus
...
notificationContext
    :: NotificationContext
notificationContext
  = NotificationContext'{_ncStatus = Nothing,
...
instance Hashable NotificationContext where

instance NFData NotificationContext where
