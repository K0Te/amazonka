...
data GenerateChangeSet = GenerateChangeSet'{_gcsAppId
                                            :: !(Maybe Text),
                                            _gcsChangesetFormat ::
                                            !(Maybe OutputFormat)}
...
generateChangeSet
    :: GenerateChangeSet
generateChangeSet
  = GenerateChangeSet'{_gcsAppId = Nothing,
...
instance Hashable GenerateChangeSet where

instance NFData GenerateChangeSet where
...
data GenerateChangeSetResponse = GenerateChangeSetResponse'{_gcsrsS3Location
                                                            ::
                                                            !(Maybe S3Location),
...
generateChangeSetResponse pResponseStatus_
  = GenerateChangeSetResponse'{_gcsrsS3Location =
                                 Nothing,
...
instance NFData GenerateChangeSetResponse where
