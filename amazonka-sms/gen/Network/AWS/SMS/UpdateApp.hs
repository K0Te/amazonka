...
data UpdateApp = UpdateApp'{_uaRoleName ::
                            !(Maybe Text),
                            _uaAppId :: !(Maybe Text), _uaName :: !(Maybe Text),
...
updateApp
    :: UpdateApp
updateApp
  = UpdateApp'{_uaRoleName = Nothing,
               _uaAppId = Nothing, _uaName = Nothing,
               _uaDescription = Nothing, _uaServerGroups = Nothing,
               _uaTags = Nothing}
...
data UpdateAppResponse = UpdateAppResponse'{_uarsAppSummary
                                            :: !(Maybe AppSummary),
                                            _uarsServerGroups ::
                                            !(Maybe [ServerGroup]),
                                            _uarsTags :: !(Maybe [Tag]),
...
updateAppResponse pResponseStatus_
  = UpdateAppResponse'{_uarsAppSummary = Nothing,
                       _uarsServerGroups = Nothing, _uarsTags = Nothing,
