...
newtype ImportAppCatalog = ImportAppCatalog'{_iacRoleName
                                             :: Maybe Text}
...
instance Hashable ImportAppCatalog where

instance NFData ImportAppCatalog where
...
newtype ImportAppCatalogResponse = ImportAppCatalogResponse'{_iacrsResponseStatus
                                                             :: Int}
...
importAppCatalogResponse
    :: Int -- ^ 'iacrsResponseStatus'
    -> ImportAppCatalogResponse
importAppCatalogResponse pResponseStatus_
  = ImportAppCatalogResponse'{_iacrsResponseStatus =
                                pResponseStatus_}
...
instance NFData ImportAppCatalogResponse where
