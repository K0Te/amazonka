...
newtype DeleteAppValidationConfiguration = DeleteAppValidationConfiguration'{_davcAppId
                                                                             ::
                                                                             Text}
...
deleteAppValidationConfiguration pAppId_
  = DeleteAppValidationConfiguration'{_davcAppId =
                                        pAppId_}
...
instance AWSRequest DeleteAppValidationConfiguration
         where
...
instance ToHeaders DeleteAppValidationConfiguration
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DeleteAppValidationConfiguration
         where
        toJSON DeleteAppValidationConfiguration'{..}
          = object (catMaybes [Just ("appId" .= _davcAppId)])

instance ToPath DeleteAppValidationConfiguration
         where
        toPath = const "/"

instance ToQuery DeleteAppValidationConfiguration
         where
        toQuery = const mempty

-- | /See:/ 'deleteAppValidationConfigurationResponse' smart constructor.
newtype DeleteAppValidationConfigurationResponse = DeleteAppValidationConfigurationResponse'{_davcrsResponseStatus
                                                                                             ::
                                                                                             Int}
...
deleteAppValidationConfigurationResponse
  pResponseStatus_
  = DeleteAppValidationConfigurationResponse'{_davcrsResponseStatus
                                                = pResponseStatus_}
