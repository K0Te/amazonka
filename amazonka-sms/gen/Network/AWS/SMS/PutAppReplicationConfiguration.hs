...
data PutAppReplicationConfiguration = PutAppReplicationConfiguration'{_parcAppId
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
...
putAppReplicationConfiguration
    :: PutAppReplicationConfiguration
putAppReplicationConfiguration
  = PutAppReplicationConfiguration'{_parcAppId =
                                      Nothing,
                                    _parcServerGroupReplicationConfigurations =
                                      Nothing}
...
newtype PutAppReplicationConfigurationResponse = PutAppReplicationConfigurationResponse'{_parcrsResponseStatus
                                                                                         ::
                                                                                         Int}
...
putAppReplicationConfigurationResponse
  pResponseStatus_
  = PutAppReplicationConfigurationResponse'{_parcrsResponseStatus
                                              = pResponseStatus_}
