...
newtype StartAppReplication = StartAppReplication'{_sarAppId
                                                   :: Maybe Text}
...
instance Hashable StartAppReplication where

instance NFData StartAppReplication where
...
newtype StartAppReplicationResponse = StartAppReplicationResponse'{_srsResponseStatus
                                                                   :: Int}
...
startAppReplicationResponse pResponseStatus_
  = StartAppReplicationResponse'{_srsResponseStatus =
                                   pResponseStatus_}
...
instance NFData StartAppReplicationResponse where
