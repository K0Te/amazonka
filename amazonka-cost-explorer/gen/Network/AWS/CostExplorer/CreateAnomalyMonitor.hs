...
newtype CreateAnomalyMonitor = CreateAnomalyMonitor'{_camAnomalyMonitor
                                                     :: AnomalyMonitor}
...
createAnomalyMonitor
    :: AnomalyMonitor -- ^ 'camAnomalyMonitor'
    -> CreateAnomalyMonitor
createAnomalyMonitor pAnomalyMonitor_
  = CreateAnomalyMonitor'{_camAnomalyMonitor =
                            pAnomalyMonitor_}
...
instance Hashable CreateAnomalyMonitor where

instance NFData CreateAnomalyMonitor where
...
data CreateAnomalyMonitorResponse = CreateAnomalyMonitorResponse'{_camrsResponseStatus
                                                                  :: !Int,
                                                                  _camrsMonitorARN
                                                                  :: !Text}
                                      deriving (Eq, Read, Show, Data, Typeable,
...
createAnomalyMonitorResponse
    ...
    -> Text -- ^ 'camrsMonitorARN'
    -> CreateAnomalyMonitorResponse
createAnomalyMonitorResponse pResponseStatus_
  pMonitorARN_
  = CreateAnomalyMonitorResponse'{_camrsResponseStatus
                                    = pResponseStatus_,
...
instance NFData CreateAnomalyMonitorResponse where
