...
data GetAnomalySubscriptions = GetAnomalySubscriptions'{_gasSubscriptionARNList
                                                        :: !(Maybe [Text]),
                                                        _gasNextPageToken ::
                                                        !(Maybe Text),
                                                        _gasMaxResults ::
...
getAnomalySubscriptions
    :: GetAnomalySubscriptions
getAnomalySubscriptions
  = GetAnomalySubscriptions'{_gasSubscriptionARNList =
                               Nothing,
                             _gasNextPageToken = Nothing,
                             _gasMaxResults = Nothing, _gasMonitorARN = Nothing}
...
instance AWSRequest GetAnomalySubscriptions where
        type Rs GetAnomalySubscriptions =
             GetAnomalySubscriptionsResponse
...
instance Hashable GetAnomalySubscriptions where

instance NFData GetAnomalySubscriptions where
...
data GetAnomalySubscriptionsResponse = GetAnomalySubscriptionsResponse'{_gasrsNextPageToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
...
getAnomalySubscriptionsResponse pResponseStatus_
  = GetAnomalySubscriptionsResponse'{_gasrsNextPageToken
                                       = Nothing,
...
instance NFData GetAnomalySubscriptionsResponse where
