...
newtype DeleteAnomalySubscription = DeleteAnomalySubscription'{_dasSubscriptionARN
                                                               :: Text}
...
deleteAnomalySubscription
    :: Text -- ^ 'dasSubscriptionARN'
    -> DeleteAnomalySubscription
deleteAnomalySubscription pSubscriptionARN_
  = DeleteAnomalySubscription'{_dasSubscriptionARN =
                                 pSubscriptionARN_}
...
instance Hashable DeleteAnomalySubscription where

instance NFData DeleteAnomalySubscription where
...
newtype DeleteAnomalySubscriptionResponse = DeleteAnomalySubscriptionResponse'{_dasrsResponseStatus
                                                                               ::
                                                                               Int}
...
deleteAnomalySubscriptionResponse pResponseStatus_
  = DeleteAnomalySubscriptionResponse'{_dasrsResponseStatus
                                         = pResponseStatus_}
