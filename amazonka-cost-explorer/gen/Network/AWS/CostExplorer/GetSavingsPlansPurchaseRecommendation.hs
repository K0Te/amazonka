...
getSavingsPlansPurchaseRecommendation
    :: SupportedSavingsPlansType -- ^ 'gspprSavingsPlansType'
    -> TermInYears -- ^ 'gspprTermInYears'
...
instance ToJSON GetSavingsPlansPurchaseRecommendation
         where
...
instance ToPath GetSavingsPlansPurchaseRecommendation
         where
        toPath = const "/"
