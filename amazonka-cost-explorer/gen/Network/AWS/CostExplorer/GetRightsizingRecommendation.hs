...
instance AWSRequest GetRightsizingRecommendation
         where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 GetRightsizingRecommendationResponse' <$>
                   (x .?> "Summary") <*> (x .?> "NextPageToken") <*>
                     (x .?> "RightsizingRecommendations" .!@ mempty)
                     <*> (x .?> "Metadata")
                     <*> (x .?> "Configuration")
                     <*> (pure (fromEnum s)))

instance Hashable GetRightsizingRecommendation where

instance NFData GetRightsizingRecommendation where
