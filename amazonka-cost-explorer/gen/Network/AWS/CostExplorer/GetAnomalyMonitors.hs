...
data GetAnomalyMonitors = GetAnomalyMonitors'{_gamNextPageToken
                                              :: !(Maybe Text),
                                              _gamMonitorARNList ::
                                              !(Maybe [Text]),
...
getAnomalyMonitors
    :: GetAnomalyMonitors
getAnomalyMonitors
  = GetAnomalyMonitors'{_gamNextPageToken = Nothing,
...
instance Hashable GetAnomalyMonitors where

instance NFData GetAnomalyMonitors where
...
data GetAnomalyMonitorsResponse = GetAnomalyMonitorsResponse'{_gamrsNextPageToken
                                                              :: !(Maybe Text),
                                                              _gamrsResponseStatus
                                                              :: !Int,
...
getAnomalyMonitorsResponse pResponseStatus_
  = GetAnomalyMonitorsResponse'{_gamrsNextPageToken =
                                  Nothing,
...
instance NFData GetAnomalyMonitorsResponse where
