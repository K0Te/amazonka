...
instance AWSRequest GetCostAndUsageWithResources
         where
...
instance Hashable GetCostAndUsageWithResources where

instance NFData GetCostAndUsageWithResources where
