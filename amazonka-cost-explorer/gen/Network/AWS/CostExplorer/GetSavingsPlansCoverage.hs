...
instance AWSRequest GetSavingsPlansCoverage where
        type Rs GetSavingsPlansCoverage =
             GetSavingsPlansCoverageResponse
...
instance Hashable GetSavingsPlansCoverage where

instance NFData GetSavingsPlansCoverage where
...
instance NFData GetSavingsPlansCoverageResponse where
