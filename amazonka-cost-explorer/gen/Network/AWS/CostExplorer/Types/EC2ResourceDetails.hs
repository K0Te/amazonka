...
data EC2ResourceDetails = EC2ResourceDetails'{_erdPlatform
                                              :: !(Maybe Text),
                                              _erdVcpu :: !(Maybe Text),
...
ec2ResourceDetails
    :: EC2ResourceDetails
ec2ResourceDetails
  = EC2ResourceDetails'{_erdPlatform = Nothing,
                        _erdVcpu = Nothing, _erdNetworkPerformance = Nothing,
                        _erdMemory = Nothing, _erdInstanceType = Nothing,
                        _erdStorage = Nothing, _erdSku = Nothing,
                        _erdRegion = Nothing,
