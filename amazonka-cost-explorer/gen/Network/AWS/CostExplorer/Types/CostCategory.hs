...
data CostCategory = CostCategory'{_ccProcessingStatus
                                  :: !(Maybe [CostCategoryProcessingStatus]),
                                  _ccEffectiveEnd :: !(Maybe Text),
                                  _ccCostCategoryARN :: !Text,
                                  _ccEffectiveStart :: !Text, _ccName :: !Text,
...
costCategory
    ...
    -> CostCategory
costCategory pCostCategoryARN_ pEffectiveStart_
  pName_ pRuleVersion_ pRules_
  = CostCategory'{_ccProcessingStatus = Nothing,
                  _ccEffectiveEnd = Nothing,
                  _ccCostCategoryARN = pCostCategoryARN_,
                  _ccEffectiveStart = pEffectiveStart_,
                  _ccName = pName_, _ccRuleVersion = pRuleVersion_,
