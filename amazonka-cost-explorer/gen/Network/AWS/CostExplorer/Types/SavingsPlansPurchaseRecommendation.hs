...
data SavingsPlansPurchaseRecommendation = SavingsPlansPurchaseRecommendation'{_spprSavingsPlansPurchaseRecommendationDetails
                                                                              ::
                                                                              !(Maybe
...
savingsPlansPurchaseRecommendation
    :: SavingsPlansPurchaseRecommendation
savingsPlansPurchaseRecommendation
  = SavingsPlansPurchaseRecommendation'{_spprSavingsPlansPurchaseRecommendationDetails
                                          = Nothing,
