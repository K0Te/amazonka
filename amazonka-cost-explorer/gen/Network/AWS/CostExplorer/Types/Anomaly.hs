...
data Anomaly = Anomaly'{_aAnomalyStartDate ::
                        !(Maybe Text),
                        ...
                        _aAnomalyId :: !Text,
                        _aAnomalyScore :: !AnomalyScore, _aImpact :: !Impact,
                        _aMonitorARN :: !Text}
...
anomaly
    :: Text -- ^ 'aAnomalyId'
    -> AnomalyScore -- ^ 'aAnomalyScore'
    -> Impact -- ^ 'aImpact'
    -> Text -- ^ 'aMonitorARN'
    -> Anomaly
anomaly pAnomalyId_ pAnomalyScore_ pImpact_
  pMonitorARN_
  = Anomaly'{_aAnomalyStartDate = Nothing,
             _aDimensionValue = Nothing, _aRootCauses = Nothing,
             _aAnomalyEndDate = Nothing, _aFeedback = Nothing,
             _aAnomalyId = pAnomalyId_,
             _aAnomalyScore = pAnomalyScore_, _aImpact = pImpact_,
...
instance Hashable Anomaly where

instance NFData Anomaly where
