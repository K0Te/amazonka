...
data EBSResourceUtilization = EBSResourceUtilization'{_eruEBSWriteBytesPerSecond
                                                      :: !(Maybe Text),
...
ebsResourceUtilization
    :: EBSResourceUtilization
ebsResourceUtilization
  = EBSResourceUtilization'{_eruEBSWriteBytesPerSecond
                              = Nothing,
...
instance FromJSON EBSResourceUtilization where
        parseJSON
          = withObject "EBSResourceUtilization"
              (\ x ->
                 EBSResourceUtilization' <$>
...
instance Hashable EBSResourceUtilization where

instance NFData EBSResourceUtilization where
