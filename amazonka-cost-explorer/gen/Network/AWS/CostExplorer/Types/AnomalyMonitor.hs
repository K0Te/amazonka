...
data AnomalyMonitor = AnomalyMonitor'{_amDimensionalValueCount
                                      :: !(Maybe Nat),
...
anomalyMonitor
    :: Text -- ^ 'amMonitorName'
    -> MonitorType -- ^ 'amMonitorType'
    -> AnomalyMonitor
anomalyMonitor pMonitorName_ pMonitorType_
  = AnomalyMonitor'{_amDimensionalValueCount = Nothing,
...
instance Hashable AnomalyMonitor where

instance NFData AnomalyMonitor where
