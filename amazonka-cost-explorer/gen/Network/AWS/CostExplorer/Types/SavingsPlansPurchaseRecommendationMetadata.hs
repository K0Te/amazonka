...
data SavingsPlansPurchaseRecommendationMetadata = SavingsPlansPurchaseRecommendationMetadata'{_spprmRecommendationId
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  Text),
...
savingsPlansPurchaseRecommendationMetadata
    :: SavingsPlansPurchaseRecommendationMetadata
savingsPlansPurchaseRecommendationMetadata
  = SavingsPlansPurchaseRecommendationMetadata'{_spprmRecommendationId
                                                  = Nothing,
                                                _spprmGenerationTimestamp =
                                                  Nothing,
                                                _spprmAdditionalMetadata =
