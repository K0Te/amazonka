...
data CostCategoryProcessingStatus = CostCategoryProcessingStatus'{_ccpsStatus
                                                                  ::
                                                                  !(Maybe
                                                                      CostCategoryStatus),
                                                                  _ccpsComponent
...
costCategoryProcessingStatus
    :: CostCategoryProcessingStatus
costCategoryProcessingStatus
  = CostCategoryProcessingStatus'{_ccpsStatus =
                                    Nothing,
...
instance FromJSON CostCategoryProcessingStatus where
        parseJSON
          = withObject "CostCategoryProcessingStatus"
              (\ x ->
                 CostCategoryProcessingStatus' <$>
                   (x .:? "Status") <*> (x .:? "Component"))

instance Hashable CostCategoryProcessingStatus where

instance NFData CostCategoryProcessingStatus where
