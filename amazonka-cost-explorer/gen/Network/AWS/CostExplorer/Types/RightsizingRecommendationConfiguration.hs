...
data RightsizingRecommendationConfiguration = RightsizingRecommendationConfiguration'{_rrcRecommendationTarget
                                                                                      ::
...
rightsizingRecommendationConfiguration
    ...
    -> RightsizingRecommendationConfiguration
rightsizingRecommendationConfiguration
  pRecommendationTarget_ pBenefitsConsidered_
  = RightsizingRecommendationConfiguration'{_rrcRecommendationTarget
