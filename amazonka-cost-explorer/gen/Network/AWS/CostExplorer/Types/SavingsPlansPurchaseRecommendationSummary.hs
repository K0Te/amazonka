...
data SavingsPlansPurchaseRecommendationSummary = SavingsPlansPurchaseRecommendationSummary'{_spprsCurrencyCode
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
...
savingsPlansPurchaseRecommendationSummary
    :: SavingsPlansPurchaseRecommendationSummary
savingsPlansPurchaseRecommendationSummary
  = SavingsPlansPurchaseRecommendationSummary'{_spprsCurrencyCode
                                                 = Nothing,
                                               _spprsDailyCommitmentToPurchase =
                                                 Nothing,
                                               _spprsEstimatedTotalCost =
