...
data TotalImpactFilter = TotalImpactFilter'{_tifEndValue
                                            :: !(Maybe Double),
                                            _tifNumericOperator ::
                                            !NumericOperator,
...
totalImpactFilter
    :: NumericOperator -- ^ 'tifNumericOperator'
    -> Double -- ^ 'tifStartValue'
    -> TotalImpactFilter
totalImpactFilter pNumericOperator_ pStartValue_
  = TotalImpactFilter'{_tifEndValue = Nothing,
...
instance Hashable TotalImpactFilter where

instance NFData TotalImpactFilter where
