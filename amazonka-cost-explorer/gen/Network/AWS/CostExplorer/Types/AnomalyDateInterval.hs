...
data AnomalyDateInterval = AnomalyDateInterval'{_adiEndDate
                                                :: !(Maybe Text),
                                                _adiStartDate :: !Text}
...
anomalyDateInterval pStartDate_
  = AnomalyDateInterval'{_adiEndDate = Nothing,
...
instance Hashable AnomalyDateInterval where

instance NFData AnomalyDateInterval where
