...
data SavingsPlansPurchaseRecommendationDetail = SavingsPlansPurchaseRecommendationDetail'{_spprdCurrencyCode
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
...
savingsPlansPurchaseRecommendationDetail
    :: SavingsPlansPurchaseRecommendationDetail
savingsPlansPurchaseRecommendationDetail
  = SavingsPlansPurchaseRecommendationDetail'{_spprdCurrencyCode
                                                = Nothing,
                                              _spprdCurrentAverageHourlyOnDemandSpend
                                                = Nothing,
                                              _spprdSavingsPlansDetails =
