...
data ProvideAnomalyFeedback = ProvideAnomalyFeedback'{_pafAnomalyId
                                                      :: !Text,
                                                      _pafFeedback ::
                                                      !AnomalyFeedbackType}
...
provideAnomalyFeedback
    :: Text -- ^ 'pafAnomalyId'
    -> AnomalyFeedbackType -- ^ 'pafFeedback'
    -> ProvideAnomalyFeedback
provideAnomalyFeedback pAnomalyId_ pFeedback_
  = ProvideAnomalyFeedback'{_pafAnomalyId =
                              pAnomalyId_,
...
instance AWSRequest ProvideAnomalyFeedback where
        type Rs ProvideAnomalyFeedback =
             ProvideAnomalyFeedbackResponse
...
instance Hashable ProvideAnomalyFeedback where

instance NFData ProvideAnomalyFeedback where
...
data ProvideAnomalyFeedbackResponse = ProvideAnomalyFeedbackResponse'{_pafrsResponseStatus
                                                                      :: !Int,
                                                                      _pafrsAnomalyId
                                                                      :: !Text}
...
provideAnomalyFeedbackResponse
    :: Int -- ^ 'pafrsResponseStatus'
    -> Text -- ^ 'pafrsAnomalyId'
    -> ProvideAnomalyFeedbackResponse
provideAnomalyFeedbackResponse pResponseStatus_
  pAnomalyId_
  = ProvideAnomalyFeedbackResponse'{_pafrsResponseStatus
                                      = pResponseStatus_,
...
instance NFData ProvideAnomalyFeedbackResponse where
