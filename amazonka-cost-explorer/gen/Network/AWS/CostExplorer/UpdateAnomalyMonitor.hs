...
data UpdateAnomalyMonitor = UpdateAnomalyMonitor'{_uamMonitorName
                                                  :: !(Maybe Text),
                                                  _uamMonitorARN :: !Text}
...
updateAnomalyMonitor pMonitorARN_
  = UpdateAnomalyMonitor'{_uamMonitorName = Nothing,
...
instance Hashable UpdateAnomalyMonitor where

instance NFData UpdateAnomalyMonitor where
...
data UpdateAnomalyMonitorResponse = UpdateAnomalyMonitorResponse'{_uamrsResponseStatus
                                                                  :: !Int,
                                                                  _uamrsMonitorARN
                                                                  :: !Text}
...
updateAnomalyMonitorResponse
    ...
    -> Text -- ^ 'uamrsMonitorARN'
    -> UpdateAnomalyMonitorResponse
updateAnomalyMonitorResponse pResponseStatus_
  pMonitorARN_
  = UpdateAnomalyMonitorResponse'{_uamrsResponseStatus
                                    = pResponseStatus_,
...
instance NFData UpdateAnomalyMonitorResponse where
