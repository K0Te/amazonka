...
newtype DeleteAnomalyMonitor = DeleteAnomalyMonitor'{_damMonitorARN
                                                     :: Text}
...
deleteAnomalyMonitor pMonitorARN_
  = DeleteAnomalyMonitor'{_damMonitorARN =
                            pMonitorARN_}
...
instance Hashable DeleteAnomalyMonitor where

instance NFData DeleteAnomalyMonitor where
...
newtype DeleteAnomalyMonitorResponse = DeleteAnomalyMonitorResponse'{_damrsResponseStatus
                                                                     :: Int}
...
deleteAnomalyMonitorResponse pResponseStatus_
  = DeleteAnomalyMonitorResponse'{_damrsResponseStatus
                                    = pResponseStatus_}
...
instance NFData DeleteAnomalyMonitorResponse where
