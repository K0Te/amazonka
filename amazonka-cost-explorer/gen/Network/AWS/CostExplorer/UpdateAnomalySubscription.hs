...
data UpdateAnomalySubscription = UpdateAnomalySubscription'{_uasSubscriptionName
                                                            :: !(Maybe Text),
                                                            _uasFrequency ::
                                                            !(Maybe
...
updateAnomalySubscription
    :: Text -- ^ 'uasSubscriptionARN'
    -> UpdateAnomalySubscription
updateAnomalySubscription pSubscriptionARN_
  = UpdateAnomalySubscription'{_uasSubscriptionName =
                                 Nothing,
                               _uasFrequency = Nothing, _uasThreshold = Nothing,
...
instance Hashable UpdateAnomalySubscription where

instance NFData UpdateAnomalySubscription where
...
data UpdateAnomalySubscriptionResponse = UpdateAnomalySubscriptionResponse'{_uasrsResponseStatus
                                                                            ::
                                                                            !Int,
...
updateAnomalySubscriptionResponse
    ...
    -> Text -- ^ 'uasrsSubscriptionARN'
    -> UpdateAnomalySubscriptionResponse
updateAnomalySubscriptionResponse pResponseStatus_
  pSubscriptionARN_
  = UpdateAnomalySubscriptionResponse'{_uasrsResponseStatus
                                         = pResponseStatus_,
                                       _uasrsSubscriptionARN =
                                         pSubscriptionARN_}
