...
data GetAnomalies = GetAnomalies'{_gaNextPageToken ::
                                  !(Maybe Text),
...
getAnomalies
    :: AnomalyDateInterval -- ^ 'gaDateInterval'
    -> GetAnomalies
getAnomalies pDateInterval_
  = GetAnomalies'{_gaNextPageToken = Nothing,
                  _gaTotalImpact = Nothing, _gaMaxResults = Nothing,
                  _gaFeedback = Nothing, _gaMonitorARN = Nothing,
...
instance Hashable GetAnomalies where

instance NFData GetAnomalies where
...
data GetAnomaliesResponse = GetAnomaliesResponse'{_garsNextPageToken
                                                  :: !(Maybe Text),
...
getAnomaliesResponse pResponseStatus_
  = GetAnomaliesResponse'{_garsNextPageToken = Nothing,
...
instance NFData GetAnomaliesResponse where
