...
newtype CreateAnomalySubscription = CreateAnomalySubscription'{_casAnomalySubscription
                                                               ::
                                                               AnomalySubscription}
...
createAnomalySubscription
    :: AnomalySubscription -- ^ 'casAnomalySubscription'
    -> CreateAnomalySubscription
createAnomalySubscription pAnomalySubscription_
  = CreateAnomalySubscription'{_casAnomalySubscription
...
instance Hashable CreateAnomalySubscription where

instance NFData CreateAnomalySubscription where
...
data CreateAnomalySubscriptionResponse = CreateAnomalySubscriptionResponse'{_casrsResponseStatus
                                                                            ::
                                                                            !Int,
...
createAnomalySubscriptionResponse
    :: Int -- ^ 'casrsResponseStatus'
    -> Text -- ^ 'casrsSubscriptionARN'
    -> CreateAnomalySubscriptionResponse
createAnomalySubscriptionResponse pResponseStatus_
  pSubscriptionARN_
  = CreateAnomalySubscriptionResponse'{_casrsResponseStatus
                                         = pResponseStatus_,
                                       _casrsSubscriptionARN =
                                         pSubscriptionARN_}
