...
data ReactionValueFormats = ReactionValueFormats'{_rvfEmoji
                                                  :: !(Maybe Text),
                                                  _rvfShortCode ::
                                                  !(Maybe Text),
...
reactionValueFormats
    :: ReactionValueFormats
reactionValueFormats
  = ReactionValueFormats'{_rvfEmoji = Nothing,
                          _rvfShortCode = Nothing, _rvfUnicode = Nothing}
...
instance FromJSON ReactionValueFormats where
        parseJSON
          = withObject "ReactionValueFormats"
              (\ x ->
                 ReactionValueFormats' <$>
                   (x .:? "emoji") <*> (x .:? "shortCode") <*>
                     (x .:? "unicode"))

instance Hashable ReactionValueFormats where

instance NFData ReactionValueFormats where
