...
data GetCommentReactions = GetCommentReactions'{_gcrNextToken
                                                :: !(Maybe Text),
                                                _gcrReactionUserARN ::
                                                !(Maybe Text),
...
getCommentReactions pCommentId_
  = GetCommentReactions'{_gcrNextToken = Nothing,
...
instance Hashable GetCommentReactions where

instance NFData GetCommentReactions where
...
data GetCommentReactionsResponse = GetCommentReactionsResponse'{_gcrrsNextToken
                                                                ::
                                                                !(Maybe Text),
...
getCommentReactionsResponse pResponseStatus_
  = GetCommentReactionsResponse'{_gcrrsNextToken =
                                   Nothing,
...
instance NFData GetCommentReactionsResponse where
