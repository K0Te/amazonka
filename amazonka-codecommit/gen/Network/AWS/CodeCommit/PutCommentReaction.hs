...
data PutCommentReaction = PutCommentReaction'{_pcrCommentId
                                              :: !Text,
...
putCommentReaction
    :: Text -- ^ 'pcrCommentId'
    -> Text -- ^ 'pcrReactionValue'
    -> PutCommentReaction
putCommentReaction pCommentId_ pReactionValue_
  = PutCommentReaction'{_pcrCommentId = pCommentId_,
...
instance AWSRequest PutCommentReaction where
        type Rs PutCommentReaction =
             PutCommentReactionResponse
        request = postJSON codeCommit
        response = receiveNull PutCommentReactionResponse'

instance Hashable PutCommentReaction where

instance NFData PutCommentReaction where
...
instance NFData PutCommentReactionResponse where
