...
data AssociateNode = AssociateNode'{_anServerName ::
                                    !Text,
                                    _anNodeName :: !Text,
...
associateNode pServerName_ pNodeName_
  = AssociateNode'{_anServerName = pServerName_,
...
data AssociateNodeResponse = AssociateNodeResponse'{_anrsNodeAssociationStatusToken
                                                    :: !(Maybe Text),
...
associateNodeResponse pResponseStatus_
  = AssociateNodeResponse'{_anrsNodeAssociationStatusToken
                             = Nothing,
