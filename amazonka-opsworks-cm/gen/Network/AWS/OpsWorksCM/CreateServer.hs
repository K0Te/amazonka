...
data CreateServer = CreateServer'{_csEngineVersion ::
                                  ...
                                  _csEngine :: !Text, _csServerName :: !Text,
...
createServer
    ...
    -> CreateServer
createServer pEngine_ pServerName_
  pInstanceProfileARN_ pInstanceType_ pServiceRoleARN_
  = CreateServer'{_csEngineVersion = Nothing,
                  ...
                  _csEngine = pEngine_, _csServerName = pServerName_,
