...
data UpdateServerEngineAttributes = UpdateServerEngineAttributes'{_useaAttributeValue
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _useaServerName
                                                                  :: !Text,
...
updateServerEngineAttributes
    ...
    -> UpdateServerEngineAttributes
updateServerEngineAttributes pServerName_
  pAttributeName_
  = UpdateServerEngineAttributes'{_useaAttributeValue =
                                    Nothing,
...
data UpdateServerEngineAttributesResponse = UpdateServerEngineAttributesResponse'{_usearsServer
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Server),
...
updateServerEngineAttributesResponse pResponseStatus_
  = UpdateServerEngineAttributesResponse'{_usearsServer
                                            = Nothing,
                                          _usearsResponseStatus =
                                            pResponseStatus_}
