...
data ExportServerEngineAttribute = ExportServerEngineAttribute'{_eseaInputAttributes
                                                                ::
                                                                !(Maybe
                                                                    [EngineAttribute]),
...
exportServerEngineAttribute
    :: Text -- ^ 'eseaExportAttributeName'
    -> Text -- ^ 'eseaServerName'
    -> ExportServerEngineAttribute
exportServerEngineAttribute pExportAttributeName_
  pServerName_
  = ExportServerEngineAttribute'{_eseaInputAttributes =
                                   Nothing,
                                 _eseaExportAttributeName =
...
instance AWSRequest ExportServerEngineAttribute where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 ExportServerEngineAttributeResponse' <$>
                   (x .?> "ServerName") <*> (x .?> "EngineAttribute")
                     <*> (pure (fromEnum s)))

instance Hashable ExportServerEngineAttribute where

instance NFData ExportServerEngineAttribute where
...
data ExportServerEngineAttributeResponse = ExportServerEngineAttributeResponse'{_esearsServerName
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
...
exportServerEngineAttributeResponse
    :: Int -- ^ 'esearsResponseStatus'
    -> ExportServerEngineAttributeResponse
exportServerEngineAttributeResponse pResponseStatus_
  = ExportServerEngineAttributeResponse'{_esearsServerName
                                           = Nothing,
