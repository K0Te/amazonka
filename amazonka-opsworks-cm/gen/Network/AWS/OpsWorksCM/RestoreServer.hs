...
data RestoreServer = RestoreServer'{_rsKeyPair ::
                                    !(Maybe Text),
...
restoreServer pBackupId_ pServerName_
  = RestoreServer'{_rsKeyPair = Nothing,
                   _rsInstanceType = Nothing, _rsBackupId = pBackupId_,
...
newtype RestoreServerResponse = RestoreServerResponse'{_rsrsResponseStatus
                                                       :: Int}
...
restoreServerResponse pResponseStatus_
  = RestoreServerResponse'{_rsrsResponseStatus =
                             pResponseStatus_}
