...
data ListDelegatedServicesForAccount = ListDelegatedServicesForAccount'{_ldsfaNextToken
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _ldsfaMaxResults
...
listDelegatedServicesForAccount pAccountId_
  = ListDelegatedServicesForAccount'{_ldsfaNextToken =
                                       Nothing,
...
instance AWSPager ListDelegatedServicesForAccount
         where
        page rq rs
          | stop (rs ^. ldsfarsNextToken) = Nothing
          | stop (rs ^. ldsfarsDelegatedServices) = Nothing
          | otherwise =
            Just $ rq & ldsfaNextToken .~ rs ^. ldsfarsNextToken

instance AWSRequest ListDelegatedServicesForAccount
         where
        type Rs ListDelegatedServicesForAccount =
             ListDelegatedServicesForAccountResponse
...
instance NFData ListDelegatedServicesForAccount where

instance ToHeaders ListDelegatedServicesForAccount
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery ListDelegatedServicesForAccount
         where
        toQuery = const mempty

-- | /See:/ 'listDelegatedServicesForAccountResponse' smart constructor.
data ListDelegatedServicesForAccountResponse = ListDelegatedServicesForAccountResponse'{_ldsfarsDelegatedServices
                                                                                        ::
                                                                                        !(Maybe
                                                                                            [DelegatedService]),
                                                                                        _ldsfarsNextToken
...
listDelegatedServicesForAccountResponse
    :: Int -- ^ 'ldsfarsResponseStatus'
    -> ListDelegatedServicesForAccountResponse
listDelegatedServicesForAccountResponse
  pResponseStatus_
  = ListDelegatedServicesForAccountResponse'{_ldsfarsDelegatedServices
                                               = Nothing,
