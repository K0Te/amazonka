...
data RegisterDelegatedAdministrator = RegisterDelegatedAdministrator'{_rdaAccountId
                                                                      :: !Text,
...
registerDelegatedAdministrator
    :: Text -- ^ 'rdaAccountId'
    -> Text -- ^ 'rdaServicePrincipal'
    -> RegisterDelegatedAdministrator
registerDelegatedAdministrator pAccountId_
  pServicePrincipal_
  = RegisterDelegatedAdministrator'{_rdaAccountId =
                                      pAccountId_,
...
instance AWSRequest RegisterDelegatedAdministrator
         where
...
instance NFData RegisterDelegatedAdministrator where

instance ToHeaders RegisterDelegatedAdministrator
         where
        toHeaders
          = const
              (mconcat
