...
data GetResources = GetResources'{_grAuthenticationToken
...
getResources
    :: GetResources
getResources
  = GetResources'{_grAuthenticationToken = Nothing,
                  _grUserId = Nothing, _grMarker = Nothing,
                  _grLimit = Nothing, _grCollectionType = Nothing}
...
data GetResourcesResponse = GetResourcesResponse'{_grrsFolders
...
getResourcesResponse pResponseStatus_
  = GetResourcesResponse'{_grrsFolders = Nothing,
                          _grrsDocuments = Nothing, _grrsMarker = Nothing,
