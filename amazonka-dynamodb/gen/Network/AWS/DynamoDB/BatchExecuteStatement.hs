...
newtype BatchExecuteStatement = BatchExecuteStatement'{_besStatements
                                                       ::
                                                       List1
...
batchExecuteStatement
    :: NonEmpty BatchStatementRequest -- ^ 'besStatements'
    -> BatchExecuteStatement
batchExecuteStatement pStatements_
  = BatchExecuteStatement'{_besStatements =
                             _List1 # pStatements_}
...
instance Hashable BatchExecuteStatement where

instance NFData BatchExecuteStatement where
...
data BatchExecuteStatementResponse = BatchExecuteStatementResponse'{_besrsResponses
                                                                    ::
                                                                    !(Maybe
                                                                        [BatchStatementResponse]),
                                                                    _besrsResponseStatus
                                                                    :: !Int}
                                       deriving (Eq, Read, Show, Data, Typeable,
                                                 Generic)
...
batchExecuteStatementResponse
    :: Int -- ^ 'besrsResponseStatus'
    -> BatchExecuteStatementResponse
batchExecuteStatementResponse pResponseStatus_
  = BatchExecuteStatementResponse'{_besrsResponses =
                                     Nothing,
...
instance NFData BatchExecuteStatementResponse where
