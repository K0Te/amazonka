...
data ListBackups = ListBackups'{_lbTimeRangeUpperBound
                                :: !(Maybe POSIX),
...
listBackups
    :: ListBackups
listBackups
  = ListBackups'{_lbTimeRangeUpperBound = Nothing,
                 _lbTimeRangeLowerBound = Nothing, _lbLimit = Nothing,
                 _lbExclusiveStartBackupARN = Nothing,
                 _lbBackupType = Nothing, _lbTableName = Nothing}
...
data ListBackupsResponse = ListBackupsResponse'{_lbrsBackupSummaries
                                                :: !(Maybe [BackupSummary]),
                                                _lbrsLastEvaluatedBackupARN ::
                                                !(Maybe Text),
...
listBackupsResponse pResponseStatus_
  = ListBackupsResponse'{_lbrsBackupSummaries =
                           Nothing,
