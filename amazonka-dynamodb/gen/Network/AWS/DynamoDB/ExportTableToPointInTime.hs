...
data ExportTableToPointInTime = ExportTableToPointInTime'{_ettpitS3BucketOwner
                                                          :: !(Maybe Text),
                                                          _ettpitExportFormat ::
                                                          !(Maybe ExportFormat),
...
exportTableToPointInTime pTableARN_ pS3Bucket_
  = ExportTableToPointInTime'{_ettpitS3BucketOwner =
                                Nothing,
...
instance AWSRequest ExportTableToPointInTime where
        type Rs ExportTableToPointInTime =
             ExportTableToPointInTimeResponse
...
instance Hashable ExportTableToPointInTime where

instance NFData ExportTableToPointInTime where
...
data ExportTableToPointInTimeResponse = ExportTableToPointInTimeResponse'{_ettpitrsExportDescription
                                                                          ::
                                                                          !(Maybe
                                                                              ExportDescription),
...
exportTableToPointInTimeResponse
    :: Int -- ^ 'ettpitrsResponseStatus'
    -> ExportTableToPointInTimeResponse
exportTableToPointInTimeResponse pResponseStatus_
  = ExportTableToPointInTimeResponse'{_ettpitrsExportDescription
                                        = Nothing,
                                      _ettpitrsResponseStatus =
                                        pResponseStatus_}
