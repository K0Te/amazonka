...
data EnableKinesisStreamingDestination = EnableKinesisStreamingDestination'{_eksdTableName
                                                                            ::
                                                                            !Text,
                                                                            _eksdStreamARN
                                                                            ::
...
enableKinesisStreamingDestination
    ...
    -> Text -- ^ 'eksdStreamARN'
    -> EnableKinesisStreamingDestination
enableKinesisStreamingDestination pTableName_
  pStreamARN_
  = EnableKinesisStreamingDestination'{_eksdTableName =
                                         pTableName_,
...
instance AWSRequest EnableKinesisStreamingDestination
         where
...
instance ToHeaders EnableKinesisStreamingDestination
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON EnableKinesisStreamingDestination
         where
...
instance ToPath EnableKinesisStreamingDestination
         where
        toPath = const "/"

instance ToQuery EnableKinesisStreamingDestination
         where
