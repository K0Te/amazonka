...
newtype DescribeKinesisStreamingDestination = DescribeKinesisStreamingDestination'{_dksdkTableName
                                                                                   ::
                                                                                   Text}
...
describeKinesisStreamingDestination pTableName_
  = DescribeKinesisStreamingDestination'{_dksdkTableName
                                           = pTableName_}
...
instance ToJSON DescribeKinesisStreamingDestination
         where
        toJSON DescribeKinesisStreamingDestination'{..}
          = object
              (catMaybes [Just ("TableName" .= _dksdkTableName)])

instance ToPath DescribeKinesisStreamingDestination
         where
        toPath = const "/"

instance ToQuery DescribeKinesisStreamingDestination
         where
        toQuery = const mempty

-- | /See:/ 'describeKinesisStreamingDestinationResponse' smart constructor.
data DescribeKinesisStreamingDestinationResponse = DescribeKinesisStreamingDestinationResponse'{_dksdrsKinesisDataStreamDestinations
                                                                                                ::
                                                                                                !(Maybe
...
describeKinesisStreamingDestinationResponse
    :: Int -- ^ 'dksdrsResponseStatus'
    -> DescribeKinesisStreamingDestinationResponse
describeKinesisStreamingDestinationResponse
  pResponseStatus_
  = DescribeKinesisStreamingDestinationResponse'{_dksdrsKinesisDataStreamDestinations
                                                   = Nothing,
