...
newtype DescribeExport = DescribeExport'{_deExportARN
                                         :: Text}
...
instance Hashable DescribeExport where

instance NFData DescribeExport where
...
data DescribeExportResponse = DescribeExportResponse'{_deersExportDescription
                                                      ::
                                                      !(Maybe
                                                          ExportDescription),
...
describeExportResponse pResponseStatus_
  = DescribeExportResponse'{_deersExportDescription =
                              Nothing,
...
instance NFData DescribeExportResponse where
