...
data ListExports = ListExports'{_leTableARN ::
                                !(Maybe Text),
...
listExports
    :: ListExports
listExports
  = ListExports'{_leTableARN = Nothing,
...
data ListExportsResponse = ListExportsResponse'{_lersExportSummaries
                                                :: !(Maybe [ExportSummary]),
...
listExportsResponse pResponseStatus_
  = ListExportsResponse'{_lersExportSummaries =
                           Nothing,
