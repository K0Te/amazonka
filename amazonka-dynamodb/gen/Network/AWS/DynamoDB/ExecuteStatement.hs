...
data ExecuteStatement = ExecuteStatement'{_esConsistentRead
                                          :: !(Maybe Bool),
...
executeStatement pStatement_
  = ExecuteStatement'{_esConsistentRead = Nothing,
                      _esNextToken = Nothing, _esParameters = Nothing,
...
instance Hashable ExecuteStatement where

instance NFData ExecuteStatement where
...
data ExecuteStatementResponse = ExecuteStatementResponse'{_esrsItems
                                                          ::
                                                          !(Maybe
                                                              [Map Text
                                                                 AttributeValue]),
...
executeStatementResponse pResponseStatus_
  = ExecuteStatementResponse'{_esrsItems = Nothing,
...
instance NFData ExecuteStatementResponse where
