...
data ExecuteTransaction = ExecuteTransaction'{_etClientRequestToken
                                              :: !(Maybe Text),
...
executeTransaction
    :: NonEmpty ParameterizedStatement -- ^ 'etTransactStatements'
    -> ExecuteTransaction
executeTransaction pTransactStatements_
  = ExecuteTransaction'{_etClientRequestToken =
                          Nothing,
                        _etTransactStatements =
...
instance Hashable ExecuteTransaction where

instance NFData ExecuteTransaction where
...
data ExecuteTransactionResponse = ExecuteTransactionResponse'{_etrsResponses
                                                              ::
                                                              !(Maybe
                                                                  (List1
                                                                     ItemResponse)),
...
executeTransactionResponse
    :: Int -- ^ 'etrsResponseStatus'
    -> ExecuteTransactionResponse
executeTransactionResponse pResponseStatus_
  = ExecuteTransactionResponse'{_etrsResponses =
                                  Nothing,
...
instance NFData ExecuteTransactionResponse where
