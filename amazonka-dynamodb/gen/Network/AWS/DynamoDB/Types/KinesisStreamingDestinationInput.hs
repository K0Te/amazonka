...
data KinesisStreamingDestinationInput = KinesisStreamingDestinationInput'{_ksdiTableName
                                                                          ::
                                                                          !Text,
                                                                          _ksdiStreamARN
                                                                          ::
...
kinesisStreamingDestinationInput
    ...
    -> Text -- ^ 'ksdiStreamARN'
    -> KinesisStreamingDestinationInput
kinesisStreamingDestinationInput pTableName_
  pStreamARN_
  = KinesisStreamingDestinationInput'{_ksdiTableName =
                                        pTableName_,
...
instance ToJSON KinesisStreamingDestinationInput
         where
