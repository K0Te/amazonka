...
data BatchStatementRequest = BatchStatementRequest'{_bsrConsistentRead
                                                    :: !(Maybe Bool),
                                                    _bsrParameters ::
                                                    !(Maybe
...
batchStatementRequest pStatement_
  = BatchStatementRequest'{_bsrConsistentRead =
                             Nothing,
...
instance Hashable BatchStatementRequest where

instance NFData BatchStatementRequest where
