...
data KinesisDataStreamDestination = KinesisDataStreamDestination'{_kdsdDestinationStatus
                                                                  ::
                                                                  !(Maybe
                                                                      DestinationStatus),
                                                                  _kdsdStreamARN
...
kinesisDataStreamDestination
    :: KinesisDataStreamDestination
kinesisDataStreamDestination
  = KinesisDataStreamDestination'{_kdsdDestinationStatus
                                    = Nothing,
...
instance FromJSON KinesisDataStreamDestination where
        parseJSON
          = withObject "KinesisDataStreamDestination"
              (\ x ->
                 KinesisDataStreamDestination' <$>
                   (x .:? "DestinationStatus") <*> (x .:? "StreamArn")
                     <*> (x .:? "DestinationStatusDescription"))

instance Hashable KinesisDataStreamDestination where

instance NFData KinesisDataStreamDestination where
