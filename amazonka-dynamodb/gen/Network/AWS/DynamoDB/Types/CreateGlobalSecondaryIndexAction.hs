...
data CreateGlobalSecondaryIndexAction = CreateGlobalSecondaryIndexAction'{_cgsiaProvisionedThroughput
                                                                          ::
                                                                          !(Maybe
...
createGlobalSecondaryIndexAction
    ...
    -> CreateGlobalSecondaryIndexAction
createGlobalSecondaryIndexAction pIndexName_
  pKeySchema_ pProjection_
  = CreateGlobalSecondaryIndexAction'{_cgsiaProvisionedThroughput
                                        = Nothing,
