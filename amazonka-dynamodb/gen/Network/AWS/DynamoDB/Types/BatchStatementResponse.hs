...
data BatchStatementResponse = BatchStatementResponse'{_bError
                                                      ::
                                                      !(Maybe
                                                          BatchStatementError),
                                                      _bItem ::
...
batchStatementResponse
    :: BatchStatementResponse
batchStatementResponse
  = BatchStatementResponse'{_bError = Nothing,
                            _bItem = Nothing, _bTableName = Nothing}
...
instance FromJSON BatchStatementResponse where
        parseJSON
          = withObject "BatchStatementResponse"
              (\ x ->
                 BatchStatementResponse' <$>
                   (x .:? "Error") <*> (x .:? "Item" .!= mempty) <*>
                     (x .:? "TableName"))

instance Hashable BatchStatementResponse where

instance NFData BatchStatementResponse where
