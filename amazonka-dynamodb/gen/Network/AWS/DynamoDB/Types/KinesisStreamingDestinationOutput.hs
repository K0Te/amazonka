...
data KinesisStreamingDestinationOutput = KinesisStreamingDestinationOutput'{_ksdoDestinationStatus
                                                                            ::
                                                                            !(Maybe
                                                                                DestinationStatus),
                                                                            _ksdoStreamARN
...
kinesisStreamingDestinationOutput
    :: KinesisStreamingDestinationOutput
kinesisStreamingDestinationOutput
  = KinesisStreamingDestinationOutput'{_ksdoDestinationStatus
                                         = Nothing,
...
instance FromJSON KinesisStreamingDestinationOutput
         where
        parseJSON
          = withObject "KinesisStreamingDestinationOutput"
              (\ x ->
                 KinesisStreamingDestinationOutput' <$>
