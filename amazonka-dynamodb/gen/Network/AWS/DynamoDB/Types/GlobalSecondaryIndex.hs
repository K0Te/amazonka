...
data GlobalSecondaryIndex = GlobalSecondaryIndex'{_gsiProvisionedThroughput
                                                  ::
                                                  !(Maybe
...
globalSecondaryIndex
    ...
    -> GlobalSecondaryIndex
globalSecondaryIndex pIndexName_ pKeySchema_
  pProjection_
  = GlobalSecondaryIndex'{_gsiProvisionedThroughput =
                            Nothing,
