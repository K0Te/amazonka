...
data ParameterizedStatement = ParameterizedStatement'{_psParameters
                                                      ::
                                                      !(Maybe
                                                          (List1
                                                             AttributeValue)),
...
parameterizedStatement pStatement_
  = ParameterizedStatement'{_psParameters = Nothing,
...
instance Hashable ParameterizedStatement where

instance NFData ParameterizedStatement where
