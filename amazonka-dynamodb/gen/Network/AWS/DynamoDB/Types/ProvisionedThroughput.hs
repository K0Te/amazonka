...
data ProvisionedThroughput = ProvisionedThroughput'{_ptReadCapacityUnits
                                                    :: !Nat,
...
provisionedThroughput
    ...
    -> ProvisionedThroughput
provisionedThroughput pReadCapacityUnits_
  pWriteCapacityUnits_
  = ProvisionedThroughput'{_ptReadCapacityUnits =
