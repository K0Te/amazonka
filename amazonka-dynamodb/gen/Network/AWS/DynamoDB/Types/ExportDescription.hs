...
data ExportDescription = ExportDescription'{_edS3BucketOwner
                                            :: !(Maybe Text),
                                            _edExportFormat ::
                                            !(Maybe ExportFormat),
...
exportDescription
    :: ExportDescription
exportDescription
  = ExportDescription'{_edS3BucketOwner = Nothing,
                       _edExportFormat = Nothing,
                       _edS3SseKMSKeyId = Nothing, _edClientToken = Nothing,
                       _edStartTime = Nothing, _edFailureCode = Nothing,
                       _edExportStatus = Nothing,
                       _edFailureMessage = Nothing, _edTableARN = Nothing,
                       _edBilledSizeBytes = Nothing, _edExportARN = Nothing,
                       _edExportTime = Nothing, _edS3SseAlgorithm = Nothing,
                       _edEndTime = Nothing, _edS3Prefix = Nothing,
                       _edExportManifest = Nothing, _edTableId = Nothing,
                       _edItemCount = Nothing, _edS3Bucket = Nothing}
...
instance FromJSON ExportDescription where
        parseJSON
          = withObject "ExportDescription"
              (\ x ->
                 ExportDescription' <$>
                   (x .:? "S3BucketOwner") <*> (x .:? "ExportFormat")
                     <*> (x .:? "S3SseKmsKeyId")
                     <*> (x .:? "ClientToken")
                     <*> (x .:? "StartTime")
                     <*> (x .:? "FailureCode")
...
instance Hashable ExportDescription where

instance NFData ExportDescription where
