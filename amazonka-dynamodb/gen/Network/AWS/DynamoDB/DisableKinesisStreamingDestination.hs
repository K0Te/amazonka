...
data DisableKinesisStreamingDestination = DisableKinesisStreamingDestination'{_dksdTableName
                                                                              ::
                                                                              !Text,
                                                                              _dksdStreamARN
                                                                              ::
...
disableKinesisStreamingDestination
    ...
    -> Text -- ^ 'dksdStreamARN'
    -> DisableKinesisStreamingDestination
disableKinesisStreamingDestination pTableName_
  pStreamARN_
  = DisableKinesisStreamingDestination'{_dksdTableName
                                          = pTableName_,
...
instance ToHeaders DisableKinesisStreamingDestination
         where
        toHeaders
          = const
              (mconcat
...
instance ToJSON DisableKinesisStreamingDestination
         where
...
instance ToPath DisableKinesisStreamingDestination
         where
        toPath = const "/"

instance ToQuery DisableKinesisStreamingDestination
         where
