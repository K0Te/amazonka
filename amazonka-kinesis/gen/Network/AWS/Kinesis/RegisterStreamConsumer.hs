...
data RegisterStreamConsumer = RegisterStreamConsumer'{_rscStreamARN
                                                      :: !Text,
...
registerStreamConsumer
    :: Text -- ^ 'rscStreamARN'
    -> Text -- ^ 'rscConsumerName'
    -> RegisterStreamConsumer
registerStreamConsumer pStreamARN_ pConsumerName_
  = RegisterStreamConsumer'{_rscStreamARN =
                              pStreamARN_,
...
instance AWSRequest RegisterStreamConsumer where
        type Rs RegisterStreamConsumer =
             RegisterStreamConsumerResponse
...
instance Hashable RegisterStreamConsumer where

instance NFData RegisterStreamConsumer where
...
data RegisterStreamConsumerResponse = RegisterStreamConsumerResponse'{_rscrsResponseStatus
                                                                      :: !Int,
                                                                      _rscrsConsumer
                                                                      ::
                                                                      !Consumer}
...
registerStreamConsumerResponse
    :: Int -- ^ 'rscrsResponseStatus'
    -> Consumer -- ^ 'rscrsConsumer'
    -> RegisterStreamConsumerResponse
registerStreamConsumerResponse pResponseStatus_
  pConsumer_
  = RegisterStreamConsumerResponse'{_rscrsResponseStatus
                                      = pResponseStatus_,
...
instance NFData RegisterStreamConsumerResponse where
