...
data SubscribeToShard = SubscribeToShard'{_stsConsumerARN
                                          :: !Text,
                                          _stsShardId :: !Text,
...
subscribeToShard
    ...
    -> SubscribeToShard
subscribeToShard pConsumerARN_ pShardId_
  pStartingPosition_
  = SubscribeToShard'{_stsConsumerARN = pConsumerARN_,
...
data SubscribeToShardResponse = SubscribeToShardResponse'{_stsrsResponseStatus
                                                          :: !Int,
                                                          _stsrsEventStream ::
...
subscribeToShardResponse
    ...
    -> SubscribeToShardResponse
subscribeToShardResponse pResponseStatus_
  pEventStream_
  = SubscribeToShardResponse'{_stsrsResponseStatus =
                                pResponseStatus_,
