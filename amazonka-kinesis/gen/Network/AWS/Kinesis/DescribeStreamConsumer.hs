...
data DescribeStreamConsumer = DescribeStreamConsumer'{_dConsumerARN
                                                      :: !(Maybe Text),
                                                      _dStreamARN ::
                                                      !(Maybe Text),
                                                      _dConsumerName ::
...
describeStreamConsumer
    :: DescribeStreamConsumer
describeStreamConsumer
  = DescribeStreamConsumer'{_dConsumerARN = Nothing,
                            _dStreamARN = Nothing, _dConsumerName = Nothing}
...
instance AWSRequest DescribeStreamConsumer where
        type Rs DescribeStreamConsumer =
             DescribeStreamConsumerResponse
...
instance Hashable DescribeStreamConsumer where

instance NFData DescribeStreamConsumer where
...
data DescribeStreamConsumerResponse = DescribeStreamConsumerResponse'{_dscrsResponseStatus
                                                                      :: !Int,
...
describeStreamConsumerResponse
    ...
    -> ConsumerDescription -- ^ 'dscrsConsumerDescription'
    -> DescribeStreamConsumerResponse
describeStreamConsumerResponse pResponseStatus_
  pConsumerDescription_
  = DescribeStreamConsumerResponse'{_dscrsResponseStatus
                                      = pResponseStatus_,
                                    _dscrsConsumerDescription =
                                      pConsumerDescription_}
...
instance NFData DescribeStreamConsumerResponse where
