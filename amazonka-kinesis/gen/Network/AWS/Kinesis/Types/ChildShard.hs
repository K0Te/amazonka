...
data ChildShard = ChildShard'{_csShardId :: !Text,
...
childShard
    :: Text -- ^ 'csShardId'
    -> HashKeyRange -- ^ 'csHashKeyRange'
    -> ChildShard
childShard pShardId_ pHashKeyRange_
  = ChildShard'{_csShardId = pShardId_,
...
instance Hashable ChildShard where

instance NFData ChildShard where
