...
data ConsumerDescription = ConsumerDescription'{_cdConsumerName
                                                :: !Text,
                                                _cdConsumerARN :: !Text,
                                                _cdConsumerStatus ::
                                                !ConsumerStatus,
...
consumerDescription
    ...
    -> Text -- ^ 'cdStreamARN'
    -> ConsumerDescription
consumerDescription pConsumerName_ pConsumerARN_
  pConsumerStatus_ pConsumerCreationTimestamp_
  pStreamARN_
  = ConsumerDescription'{_cdConsumerName =
                           pConsumerName_,
