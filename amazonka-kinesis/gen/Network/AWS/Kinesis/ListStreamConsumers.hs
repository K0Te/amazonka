...
data ListStreamConsumers = ListStreamConsumers'{_lscNextToken
                                                :: !(Maybe Text),
...
listStreamConsumers pStreamARN_
  = ListStreamConsumers'{_lscNextToken = Nothing,
...
instance Hashable ListStreamConsumers where

instance NFData ListStreamConsumers where
...
data ListStreamConsumersResponse = ListStreamConsumersResponse'{_lscrsNextToken
                                                                ::
                                                                !(Maybe Text),
                                                                _lscrsConsumers
                                                                ::
...
listStreamConsumersResponse pResponseStatus_
  = ListStreamConsumersResponse'{_lscrsNextToken =
                                   Nothing,
...
instance NFData ListStreamConsumersResponse where
