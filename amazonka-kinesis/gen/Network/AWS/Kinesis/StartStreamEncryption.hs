...
data StartStreamEncryption = StartStreamEncryption'{_sStreamName
                                                    :: !Text,
                                                    _sEncryptionType ::
                                                    !EncryptionType,
                                                    _sKeyId :: !Text}
...
startStreamEncryption
    ...
    -> Text -- ^ 'sKeyId'
    -> StartStreamEncryption
startStreamEncryption pStreamName_ pEncryptionType_
  pKeyId_
  = StartStreamEncryption'{_sStreamName = pStreamName_,
