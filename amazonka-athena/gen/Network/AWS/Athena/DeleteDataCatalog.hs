...
newtype DeleteDataCatalog = DeleteDataCatalog'{_ddcName
                                               :: Text}
...
instance Hashable DeleteDataCatalog where

instance NFData DeleteDataCatalog where
...
newtype DeleteDataCatalogResponse = DeleteDataCatalogResponse'{_ddcrsResponseStatus
                                                               :: Int}
...
deleteDataCatalogResponse pResponseStatus_
  = DeleteDataCatalogResponse'{_ddcrsResponseStatus =
                                 pResponseStatus_}
...
instance NFData DeleteDataCatalogResponse where
