...
data DataCatalogSummary = DataCatalogSummary'{_dcsCatalogName
                                              :: !(Maybe Text),
                                              _dcsType ::
...
dataCatalogSummary
    :: DataCatalogSummary
dataCatalogSummary
  = DataCatalogSummary'{_dcsCatalogName = Nothing,
                        _dcsType = Nothing}
...
instance FromJSON DataCatalogSummary where
        parseJSON
          = withObject "DataCatalogSummary"
              (\ x ->
                 DataCatalogSummary' <$>
                   (x .:? "CatalogName") <*> (x .:? "Type"))

instance Hashable DataCatalogSummary where

instance NFData DataCatalogSummary where
