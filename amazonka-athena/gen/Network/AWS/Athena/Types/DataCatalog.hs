...
data DataCatalog = DataCatalog'{_dcParameters ::
                                !(Maybe (Map Text Text)),
                                _dcDescription :: !(Maybe Text),
                                _dcName :: !Text, _dcType :: !DataCatalogType}
...
dataCatalog
    :: Text -- ^ 'dcName'
    -> DataCatalogType -- ^ 'dcType'
    -> DataCatalog
dataCatalog pName_ pType_
  = DataCatalog'{_dcParameters = Nothing,
                 _dcDescription = Nothing, _dcName = pName_,
                 _dcType = pType_}
...
instance Hashable DataCatalog where

instance NFData DataCatalog where
