...
data TableMetadata = TableMetadata'{_tmTableType ::
                                    !(Maybe Text),
...
tableMetadata pName_
  = TableMetadata'{_tmTableType = Nothing,
                   _tmParameters = Nothing, _tmColumns = Nothing,
                   _tmLastAccessTime = Nothing,
                   _tmPartitionKeys = Nothing, _tmCreateTime = Nothing,
                   _tmName = pName_}
...
instance Hashable TableMetadata where

instance NFData TableMetadata where
