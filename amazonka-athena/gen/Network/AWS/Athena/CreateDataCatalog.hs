...
data CreateDataCatalog = CreateDataCatalog'{_cdcParameters
                                            :: !(Maybe (Map Text Text)),
...
createDataCatalog
    :: Text -- ^ 'cdcName'
    -> DataCatalogType -- ^ 'cdcType'
    -> CreateDataCatalog
createDataCatalog pName_ pType_
  = CreateDataCatalog'{_cdcParameters = Nothing,
                       _cdcDescription = Nothing, _cdcTags = Nothing,
                       _cdcName = pName_, _cdcType = pType_}
...
instance Hashable CreateDataCatalog where

instance NFData CreateDataCatalog where
          ...
          = object
              (catMaybes
                 [("Parameters" .=) <$> _cdcParameters,
                  ...
                  ("Tags" .=) <$> _cdcTags, Just ("Name" .= _cdcName),
                  Just ("Type" .= _cdcType)])
...
newtype CreateDataCatalogResponse = CreateDataCatalogResponse'{_cdcrsResponseStatus
                                                               :: Int}
...
createDataCatalogResponse pResponseStatus_
  = CreateDataCatalogResponse'{_cdcrsResponseStatus =
                                 pResponseStatus_}
...
instance NFData CreateDataCatalogResponse where
