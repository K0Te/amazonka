...
newtype GetDataCatalog = GetDataCatalog'{_gdcName ::
                                         Text}
...
instance Hashable GetDataCatalog where

instance NFData GetDataCatalog where
...
data GetDataCatalogResponse = GetDataCatalogResponse'{_gdcrsDataCatalog
                                                      :: !(Maybe DataCatalog),
...
getDataCatalogResponse pResponseStatus_
  = GetDataCatalogResponse'{_gdcrsDataCatalog =
                              Nothing,
...
instance NFData GetDataCatalogResponse where
