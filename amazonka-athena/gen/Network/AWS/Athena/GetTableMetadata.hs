...
data GetTableMetadata = GetTableMetadata'{_gtmCatalogName
                                          :: !Text,
...
getTableMetadata
    :: Text -- ^ 'gtmCatalogName'
    -> Text -- ^ 'gtmDatabaseName'
    -> Text -- ^ 'gtmTableName'
    -> GetTableMetadata
getTableMetadata pCatalogName_ pDatabaseName_
  pTableName_
  = GetTableMetadata'{_gtmCatalogName = pCatalogName_,
...
instance Hashable GetTableMetadata where

instance NFData GetTableMetadata where
...
data GetTableMetadataResponse = GetTableMetadataResponse'{_gtmrsTableMetadata
                                                          ::
                                                          !(Maybe
                                                              TableMetadata),
...
getTableMetadataResponse pResponseStatus_
  = GetTableMetadataResponse'{_gtmrsTableMetadata =
                                Nothing,
...
instance NFData GetTableMetadataResponse where
