...
data UpdateDataCatalog = UpdateDataCatalog'{_udcParameters
                                            :: !(Maybe (Map Text Text)),
...
updateDataCatalog
    :: Text -- ^ 'udcName'
    -> DataCatalogType -- ^ 'udcType'
    -> UpdateDataCatalog
updateDataCatalog pName_ pType_
  = UpdateDataCatalog'{_udcParameters = Nothing,
                       _udcDescription = Nothing, _udcName = pName_,
                       _udcType = pType_}
...
instance Hashable UpdateDataCatalog where

instance NFData UpdateDataCatalog where
...
newtype UpdateDataCatalogResponse = UpdateDataCatalogResponse'{_udcrsResponseStatus
                                                               :: Int}
...
updateDataCatalogResponse pResponseStatus_
  = UpdateDataCatalogResponse'{_udcrsResponseStatus =
                                 pResponseStatus_}
...
instance NFData UpdateDataCatalogResponse where
