...
data ListEventsDetectionJobs = ListEventsDetectionJobs'{_lNextToken
                                                        :: !(Maybe Text),
                                                        _lFilter ::
                                                        !(Maybe
...
listEventsDetectionJobs
    :: ListEventsDetectionJobs
listEventsDetectionJobs
  = ListEventsDetectionJobs'{_lNextToken = Nothing,
...
instance AWSRequest ListEventsDetectionJobs where
        type Rs ListEventsDetectionJobs =
             ListEventsDetectionJobsResponse
...
instance Hashable ListEventsDetectionJobs where

instance NFData ListEventsDetectionJobs where
...
data ListEventsDetectionJobsResponse = ListEventsDetectionJobsResponse'{_lrsEventsDetectionJobPropertiesList
                                                                        ::
                                                                        !(Maybe
...
listEventsDetectionJobsResponse pResponseStatus_
  = ListEventsDetectionJobsResponse'{_lrsEventsDetectionJobPropertiesList
                                       = Nothing,
...
instance NFData ListEventsDetectionJobsResponse where
