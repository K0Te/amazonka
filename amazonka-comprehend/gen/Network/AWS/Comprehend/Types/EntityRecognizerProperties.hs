...
data EntityRecognizerProperties = EntityRecognizerProperties'{_erpStatus
                                                              ::
                                                              !(Maybe
                                                                  ModelStatus),
                                                              _erpLanguageCode
...
entityRecognizerProperties
    :: EntityRecognizerProperties
entityRecognizerProperties
  = EntityRecognizerProperties'{_erpStatus = Nothing,
                                ...
                                _erpMessage = Nothing, _erpSubmitTime = Nothing}
