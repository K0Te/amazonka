...
data DocumentClassifierInputDataConfig = DocumentClassifierInputDataConfig'{_dcidcAugmentedManifests
                                                                            ::
                                                                            !(Maybe
...
documentClassifierInputDataConfig
    :: DocumentClassifierInputDataConfig
documentClassifierInputDataConfig
  = DocumentClassifierInputDataConfig'{_dcidcAugmentedManifests
                                         = Nothing,
