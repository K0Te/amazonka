...
data AugmentedManifestsListItem = AugmentedManifestsListItem'{_amliS3URI
                                                              :: !Text,
                                                              _amliAttributeNames
                                                              :: ![Text]}
...
augmentedManifestsListItem pS3URI_
  = AugmentedManifestsListItem'{_amliS3URI = pS3URI_,
...
instance FromJSON AugmentedManifestsListItem where
        parseJSON
          = withObject "AugmentedManifestsListItem"
              (\ x ->
                 AugmentedManifestsListItem' <$>
                   (x .: "S3Uri") <*>
                     (x .:? "AttributeNames" .!= mempty))

instance Hashable AugmentedManifestsListItem where

instance NFData AugmentedManifestsListItem where
