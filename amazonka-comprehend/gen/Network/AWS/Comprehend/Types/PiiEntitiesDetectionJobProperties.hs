...
data PiiEntitiesDetectionJobProperties = PiiEntitiesDetectionJobProperties'{_pedjpLanguageCode
                                                                            ::
                                                                            !(Maybe
                                                                                LanguageCode),
                                                                            _pedjpJobId
...
piiEntitiesDetectionJobProperties
    :: PiiEntitiesDetectionJobProperties
piiEntitiesDetectionJobProperties
  = PiiEntitiesDetectionJobProperties'{_pedjpLanguageCode
                                         = Nothing,
                                       _pedjpJobId = Nothing,
...
instance FromJSON PiiEntitiesDetectionJobProperties
         where
        parseJSON
          = withObject "PiiEntitiesDetectionJobProperties"
              (\ x ->
                 PiiEntitiesDetectionJobProperties' <$>
