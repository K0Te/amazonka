...
data EventsDetectionJobProperties = EventsDetectionJobProperties'{_edjpLanguageCode
                                                                  ::
                                                                  !(Maybe
                                                                      LanguageCode),
                                                                  _edjpJobId ::
...
eventsDetectionJobProperties
    :: EventsDetectionJobProperties
eventsDetectionJobProperties
  = EventsDetectionJobProperties'{_edjpLanguageCode =
                                    Nothing,
                                  _edjpJobId = Nothing, _edjpJobName = Nothing,
...
instance FromJSON EventsDetectionJobProperties where
        parseJSON
          = withObject "EventsDetectionJobProperties"
              (\ x ->
                 EventsDetectionJobProperties' <$>
...
instance Hashable EventsDetectionJobProperties where

instance NFData EventsDetectionJobProperties where
