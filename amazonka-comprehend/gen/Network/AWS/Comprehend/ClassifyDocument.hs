...
classifyDocument pText_ pEndpointARN_
  = ClassifyDocument'{_cdText = _Sensitive # pText_,
...
instance Hashable ClassifyDocument where

instance NFData ClassifyDocument where
...
instance NFData ClassifyDocumentResponse where
