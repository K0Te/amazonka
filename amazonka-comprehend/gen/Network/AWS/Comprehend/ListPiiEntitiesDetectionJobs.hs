...
data ListPiiEntitiesDetectionJobs = ListPiiEntitiesDetectionJobs'{_lpedjNextToken
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _lpedjFilter
                                                                  ::
...
listPiiEntitiesDetectionJobs
    :: ListPiiEntitiesDetectionJobs
listPiiEntitiesDetectionJobs
  = ListPiiEntitiesDetectionJobs'{_lpedjNextToken =
                                    Nothing,
...
instance AWSRequest ListPiiEntitiesDetectionJobs
         where
...
instance Hashable ListPiiEntitiesDetectionJobs where

instance NFData ListPiiEntitiesDetectionJobs where
...
data ListPiiEntitiesDetectionJobsResponse = ListPiiEntitiesDetectionJobsResponse'{_lpedjrsNextToken
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
...
listPiiEntitiesDetectionJobsResponse
    :: Int -- ^ 'lpedjrsResponseStatus'
    -> ListPiiEntitiesDetectionJobsResponse
listPiiEntitiesDetectionJobsResponse pResponseStatus_
  = ListPiiEntitiesDetectionJobsResponse'{_lpedjrsNextToken
                                            = Nothing,
                                          _lpedjrsPiiEntitiesDetectionJobPropertiesList
                                            = Nothing,
                                          _lpedjrsResponseStatus =
