...
newtype StopPiiEntitiesDetectionJob = StopPiiEntitiesDetectionJob'{_spedjJobId
                                                                   :: Text}
...
instance Hashable StopPiiEntitiesDetectionJob where

instance NFData StopPiiEntitiesDetectionJob where
...
data StopPiiEntitiesDetectionJobResponse = StopPiiEntitiesDetectionJobResponse'{_spedjprsJobId
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
                                                                                _spedjprsJobStatus
...
stopPiiEntitiesDetectionJobResponse
    :: Int -- ^ 'spedjprsResponseStatus'
    -> StopPiiEntitiesDetectionJobResponse
stopPiiEntitiesDetectionJobResponse pResponseStatus_
  = StopPiiEntitiesDetectionJobResponse'{_spedjprsJobId
                                           = Nothing,
