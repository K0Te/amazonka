...
data CreateEntityRecognizer = CreateEntityRecognizer'{_cerVPCConfig
                                                      :: !(Maybe VPCConfig),
                                                      _cerVolumeKMSKeyId ::
                                                      !(Maybe Text),
...
createEntityRecognizer
    ...
    -> CreateEntityRecognizer
createEntityRecognizer pRecognizerName_
  pDataAccessRoleARN_ pInputDataConfig_ pLanguageCode_
  = CreateEntityRecognizer'{_cerVPCConfig = Nothing,
...
data CreateEntityRecognizerResponse = CreateEntityRecognizerResponse'{_cerrsEntityRecognizerARN
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
...
createEntityRecognizerResponse pResponseStatus_
  = CreateEntityRecognizerResponse'{_cerrsEntityRecognizerARN
                                      = Nothing,
