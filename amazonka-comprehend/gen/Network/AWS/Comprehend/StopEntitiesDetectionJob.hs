...
newtype StopEntitiesDetectionJob = StopEntitiesDetectionJob'{_sJobId
                                                             :: Text}
...
data StopEntitiesDetectionJobResponse = StopEntitiesDetectionJobResponse'{_srsJobId
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _srsJobStatus
...
stopEntitiesDetectionJobResponse pResponseStatus_
  = StopEntitiesDetectionJobResponse'{_srsJobId =
                                        Nothing,
