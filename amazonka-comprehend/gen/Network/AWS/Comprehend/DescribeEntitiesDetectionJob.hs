...
newtype DescribeEntitiesDetectionJob = DescribeEntitiesDetectionJob'{_dJobId
                                                                     :: Text}
...
data DescribeEntitiesDetectionJobResponse = DescribeEntitiesDetectionJobResponse'{_desrsEntitiesDetectionJobProperties
                                                                                  ::
                                                                                  !(Maybe
...
describeEntitiesDetectionJobResponse pResponseStatus_
  = DescribeEntitiesDetectionJobResponse'{_desrsEntitiesDetectionJobProperties
                                            = Nothing,
                                          _desrsResponseStatus =
                                            pResponseStatus_}
