...
newtype DescribeEventsDetectionJob = DescribeEventsDetectionJob'{_dedjJobId
                                                                 :: Text}
...
instance Hashable DescribeEventsDetectionJob where

instance NFData DescribeEventsDetectionJob where
...
data DescribeEventsDetectionJobResponse = DescribeEventsDetectionJobResponse'{_dedjrsEventsDetectionJobProperties
                                                                              ::
                                                                              !(Maybe
...
describeEventsDetectionJobResponse pResponseStatus_
  = DescribeEventsDetectionJobResponse'{_dedjrsEventsDetectionJobProperties
                                          = Nothing,
                                        _dedjrsResponseStatus =
                                          pResponseStatus_}
