...
data StartEventsDetectionJob = StartEventsDetectionJob'{_sJobName
                                                        :: !(Maybe Text),
...
startEventsDetectionJob
    :: InputDataConfig -- ^ 'sInputDataConfig'
    -> OutputDataConfig -- ^ 'sOutputDataConfig'
    -> Text -- ^ 'sDataAccessRoleARN'
    -> LanguageCode -- ^ 'sLanguageCode'
    -> NonEmpty Text -- ^ 'sTargetEventTypes'
    -> StartEventsDetectionJob
startEventsDetectionJob pInputDataConfig_
  pOutputDataConfig_ pDataAccessRoleARN_ pLanguageCode_
  pTargetEventTypes_
  = StartEventsDetectionJob'{_sJobName = Nothing,
...
instance AWSRequest StartEventsDetectionJob where
        type Rs StartEventsDetectionJob =
             StartEventsDetectionJobResponse
...
instance Hashable StartEventsDetectionJob where

instance NFData StartEventsDetectionJob where
...
data StartEventsDetectionJobResponse = StartEventsDetectionJobResponse'{_starsJobId
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _starsJobStatus
...
startEventsDetectionJobResponse pResponseStatus_
  = StartEventsDetectionJobResponse'{_starsJobId =
                                       Nothing,
...
instance NFData StartEventsDetectionJobResponse where
