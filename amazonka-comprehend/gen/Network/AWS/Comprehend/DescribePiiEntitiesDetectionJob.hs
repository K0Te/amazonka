...
newtype DescribePiiEntitiesDetectionJob = DescribePiiEntitiesDetectionJob'{_dpedjJobId
                                                                           ::
                                                                           Text}
...
describePiiEntitiesDetectionJob pJobId_
  = DescribePiiEntitiesDetectionJob'{_dpedjJobId =
                                       pJobId_}
...
instance AWSRequest DescribePiiEntitiesDetectionJob
         where
...
instance NFData DescribePiiEntitiesDetectionJob where

instance ToHeaders DescribePiiEntitiesDetectionJob
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery DescribePiiEntitiesDetectionJob
         where
        toQuery = const mempty

-- | /See:/ 'describePiiEntitiesDetectionJobResponse' smart constructor.
data DescribePiiEntitiesDetectionJobResponse = DescribePiiEntitiesDetectionJobResponse'{_dpedjrsPiiEntitiesDetectionJobProperties
                                                                                        ::
                                                                                        !(Maybe
...
describePiiEntitiesDetectionJobResponse
    :: Int -- ^ 'dpedjrsResponseStatus'
    -> DescribePiiEntitiesDetectionJobResponse
describePiiEntitiesDetectionJobResponse
  pResponseStatus_
  = DescribePiiEntitiesDetectionJobResponse'{_dpedjrsPiiEntitiesDetectionJobProperties
                                               = Nothing,
                                             _dpedjrsResponseStatus =
                                               pResponseStatus_}
