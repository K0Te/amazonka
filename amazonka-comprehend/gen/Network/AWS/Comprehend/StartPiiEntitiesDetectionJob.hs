...
data StartPiiEntitiesDetectionJob = StartPiiEntitiesDetectionJob'{_spedjJobName
                                                                  ::
                                                                  !(Maybe Text),
...
startPiiEntitiesDetectionJob
    :: InputDataConfig -- ^ 'spedjInputDataConfig'
    -> OutputDataConfig -- ^ 'spedjOutputDataConfig'
    -> PiiEntitiesDetectionMode -- ^ 'spedjMode'
    -> Text -- ^ 'spedjDataAccessRoleARN'
    -> LanguageCode -- ^ 'spedjLanguageCode'
    -> StartPiiEntitiesDetectionJob
startPiiEntitiesDetectionJob pInputDataConfig_
  pOutputDataConfig_ pMode_ pDataAccessRoleARN_
  pLanguageCode_
  = StartPiiEntitiesDetectionJob'{_spedjJobName =
                                    Nothing,
...
instance AWSRequest StartPiiEntitiesDetectionJob
         where
...
instance Hashable StartPiiEntitiesDetectionJob where

instance NFData StartPiiEntitiesDetectionJob where
...
data StartPiiEntitiesDetectionJobResponse = StartPiiEntitiesDetectionJobResponse'{_spedjrsJobId
                                                                                  ::
                                                                                  !(Maybe
                                                                                      Text),
                                                                                  _spedjrsJobStatus
...
startPiiEntitiesDetectionJobResponse
    :: Int -- ^ 'spedjrsResponseStatus'
    -> StartPiiEntitiesDetectionJobResponse
startPiiEntitiesDetectionJobResponse pResponseStatus_
  = StartPiiEntitiesDetectionJobResponse'{_spedjrsJobId
                                            = Nothing,
