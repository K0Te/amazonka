...
data DetectPiiEntities = DetectPiiEntities'{_dpeText
                                            :: !Text,
...
detectPiiEntities
    :: Text -- ^ 'dpeText'
    -> LanguageCode -- ^ 'dpeLanguageCode'
    -> DetectPiiEntities
detectPiiEntities pText_ pLanguageCode_
  = DetectPiiEntities'{_dpeText = pText_,
...
instance Hashable DetectPiiEntities where

instance NFData DetectPiiEntities where
...
data DetectPiiEntitiesResponse = DetectPiiEntitiesResponse'{_dpersEntities
                                                            ::
                                                            !(Maybe
                                                                [PiiEntity]),
...
detectPiiEntitiesResponse pResponseStatus_
  = DetectPiiEntitiesResponse'{_dpersEntities =
                                 Nothing,
...
instance NFData DetectPiiEntitiesResponse where
