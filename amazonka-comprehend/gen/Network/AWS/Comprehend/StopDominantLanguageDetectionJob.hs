...
data StopDominantLanguageDetectionJobResponse = StopDominantLanguageDetectionJobResponse'{_sdldjdrsJobId
                                                                                          ::
                                                                                          !(Maybe
                                                                                              Text),
                                                                                          _sdldjdrsJobStatus
...
stopDominantLanguageDetectionJobResponse
    :: Int -- ^ 'sdldjdrsResponseStatus'
    -> StopDominantLanguageDetectionJobResponse
stopDominantLanguageDetectionJobResponse
  pResponseStatus_
  = StopDominantLanguageDetectionJobResponse'{_sdldjdrsJobId
                                                = Nothing,
