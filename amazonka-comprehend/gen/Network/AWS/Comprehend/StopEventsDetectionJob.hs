...
newtype StopEventsDetectionJob = StopEventsDetectionJob'{_sedjJobId
                                                         :: Text}
...
instance AWSRequest StopEventsDetectionJob where
        type Rs StopEventsDetectionJob =
             StopEventsDetectionJobResponse
...
instance Hashable StopEventsDetectionJob where

instance NFData StopEventsDetectionJob where
...
data StopEventsDetectionJobResponse = StopEventsDetectionJobResponse'{_sedjrsJobId
                                                                      ::
                                                                      !(Maybe
                                                                          Text),
                                                                      _sedjrsJobStatus
...
stopEventsDetectionJobResponse pResponseStatus_
  = StopEventsDetectionJobResponse'{_sedjrsJobId =
                                      Nothing,
...
instance NFData StopEventsDetectionJobResponse where
