...
data StartKeyPhrasesDetectionJobResponse = StartKeyPhrasesDetectionJobResponse'{_skpdjkrsJobId
                                                                                ::
                                                                                !(Maybe
                                                                                    Text),
                                                                                _skpdjkrsJobStatus
...
startKeyPhrasesDetectionJobResponse
    :: Int -- ^ 'skpdjkrsResponseStatus'
    -> StartKeyPhrasesDetectionJobResponse
startKeyPhrasesDetectionJobResponse pResponseStatus_
  = StartKeyPhrasesDetectionJobResponse'{_skpdjkrsJobId
                                           = Nothing,
