...
data InviteMembers = InviteMembers'{_imDisableEmailNotification
                                    :: !(Maybe Bool),
...
inviteMembers
    :: Text -- ^ 'imDetectorId'
    -> NonEmpty Text -- ^ 'imAccountIds'
    -> InviteMembers
inviteMembers pDetectorId_ pAccountIds_
  = InviteMembers'{_imDisableEmailNotification =
                     Nothing,
...
data InviteMembersResponse = InviteMembersResponse'{_imrsResponseStatus
                                                    :: !Int,
...
inviteMembersResponse pResponseStatus_
  = InviteMembersResponse'{_imrsResponseStatus =
                             pResponseStatus_,
