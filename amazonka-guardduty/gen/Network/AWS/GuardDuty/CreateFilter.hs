...
data CreateFilter = CreateFilter'{_cfClientToken ::
                                  !(Maybe Text),
                                  _cfAction :: !(Maybe FilterAction),
                                  _cfDescription :: !(Maybe Text),
                                  _cfRank :: !(Maybe Nat),
                                  _cfTags :: !(Maybe (Map Text Text)),
                                  _cfDetectorId :: !Text, _cfName :: !Text,
...
createFilter pDetectorId_ pName_ pFindingCriteria_
  = CreateFilter'{_cfClientToken = Nothing,
                  _cfAction = Nothing, _cfDescription = Nothing,
                  _cfRank = Nothing, _cfTags = Nothing,
                  _cfDetectorId = pDetectorId_, _cfName = pName_,
...
data CreateFilterResponse = CreateFilterResponse'{_cfrsResponseStatus
                                                  :: !Int,
                                                  _cfrsName :: !Text}
                              deriving (Eq, Read, Show, Data, Typeable, Generic)
...
createFilterResponse pResponseStatus_ pName_
  = CreateFilterResponse'{_cfrsResponseStatus =
                            pResponseStatus_,
                          _cfrsName = pName_}
