...
data UpdatePublishingDestination = UpdatePublishingDestination'{_updDestinationProperties
                                                                ::
                                                                !(Maybe
...
updatePublishingDestination
    :: Text -- ^ 'updDetectorId'
    -> Text -- ^ 'updDestinationId'
    -> UpdatePublishingDestination
updatePublishingDestination pDetectorId_
  pDestinationId_
  = UpdatePublishingDestination'{_updDestinationProperties
                                   = Nothing,
...
instance Hashable UpdatePublishingDestination where

instance NFData UpdatePublishingDestination where
...
instance ToPath UpdatePublishingDestination where
        toPath UpdatePublishingDestination'{..}
          = mconcat
              ["/detector/", toBS _updDetectorId,
               "/publishingDestination/", toBS _updDestinationId]

instance ToQuery UpdatePublishingDestination where
        toQuery = const mempty

-- | /See:/ 'updatePublishingDestinationResponse' smart constructor.
newtype UpdatePublishingDestinationResponse = UpdatePublishingDestinationResponse'{_updrsResponseStatus
                                                                                   ::
                                                                                   Int}
...
updatePublishingDestinationResponse pResponseStatus_
  = UpdatePublishingDestinationResponse'{_updrsResponseStatus
                                           = pResponseStatus_}
