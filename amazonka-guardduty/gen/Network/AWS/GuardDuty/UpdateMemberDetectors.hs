...
data UpdateMemberDetectors = UpdateMemberDetectors'{_umdDataSources
                                                    ::
                                                    !(Maybe
...
updateMemberDetectors
    :: Text -- ^ 'umdDetectorId'
    -> NonEmpty Text -- ^ 'umdAccountIds'
    -> UpdateMemberDetectors
updateMemberDetectors pDetectorId_ pAccountIds_
  = UpdateMemberDetectors'{_umdDataSources = Nothing,
...
instance Hashable UpdateMemberDetectors where

instance NFData UpdateMemberDetectors where
...
data UpdateMemberDetectorsResponse = UpdateMemberDetectorsResponse'{_umdrsResponseStatus
                                                                    :: !Int,
...
updateMemberDetectorsResponse
    :: Int -- ^ 'umdrsResponseStatus'
    -> UpdateMemberDetectorsResponse
updateMemberDetectorsResponse pResponseStatus_
  = UpdateMemberDetectorsResponse'{_umdrsResponseStatus
                                     = pResponseStatus_,
...
instance NFData UpdateMemberDetectorsResponse where
