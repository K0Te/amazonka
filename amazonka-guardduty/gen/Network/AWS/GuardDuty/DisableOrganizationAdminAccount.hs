...
newtype DisableOrganizationAdminAccount = DisableOrganizationAdminAccount'{_doaaAdminAccountId
                                                                           ::
                                                                           Text}
...
disableOrganizationAdminAccount
    :: Text -- ^ 'doaaAdminAccountId'
    -> DisableOrganizationAdminAccount
disableOrganizationAdminAccount pAdminAccountId_
  = DisableOrganizationAdminAccount'{_doaaAdminAccountId
                                       = pAdminAccountId_}
...
instance AWSRequest DisableOrganizationAdminAccount
         where
...
instance NFData DisableOrganizationAdminAccount where

instance ToHeaders DisableOrganizationAdminAccount
         where
        toHeaders
          = const
              (mconcat
...
instance ToQuery DisableOrganizationAdminAccount
         where
        toQuery = const mempty

-- | /See:/ 'disableOrganizationAdminAccountResponse' smart constructor.
newtype DisableOrganizationAdminAccountResponse = DisableOrganizationAdminAccountResponse'{_doaarsResponseStatus
                                                                                           ::
                                                                                           Int}
...
disableOrganizationAdminAccountResponse
    :: Int -- ^ 'doaarsResponseStatus'
    -> DisableOrganizationAdminAccountResponse
disableOrganizationAdminAccountResponse
  pResponseStatus_
  = DisableOrganizationAdminAccountResponse'{_doaarsResponseStatus
                                               = pResponseStatus_}
