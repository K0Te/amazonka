...
newtype EnableOrganizationAdminAccount = EnableOrganizationAdminAccount'{_eoaaAdminAccountId
                                                                         ::
                                                                         Text}
...
enableOrganizationAdminAccount
    :: Text -- ^ 'eoaaAdminAccountId'
    -> EnableOrganizationAdminAccount
enableOrganizationAdminAccount pAdminAccountId_
  = EnableOrganizationAdminAccount'{_eoaaAdminAccountId
                                      = pAdminAccountId_}
...
instance AWSRequest EnableOrganizationAdminAccount
         where
...
instance NFData EnableOrganizationAdminAccount where

instance ToHeaders EnableOrganizationAdminAccount
         where
        toHeaders
          = const
              (mconcat
...
newtype EnableOrganizationAdminAccountResponse = EnableOrganizationAdminAccountResponse'{_eoaarsResponseStatus
                                                                                         ::
                                                                                         Int}
...
enableOrganizationAdminAccountResponse
    :: Int -- ^ 'eoaarsResponseStatus'
    -> EnableOrganizationAdminAccountResponse
enableOrganizationAdminAccountResponse
  pResponseStatus_
  = EnableOrganizationAdminAccountResponse'{_eoaarsResponseStatus
                                              = pResponseStatus_}
