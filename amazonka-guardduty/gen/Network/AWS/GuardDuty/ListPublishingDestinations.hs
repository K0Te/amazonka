...
data ListPublishingDestinations = ListPublishingDestinations'{_lpdNextToken
                                                              :: !(Maybe Text),
                                                              _lpdMaxResults ::
                                                              !(Maybe Nat),
                                                              _lpdDetectorId ::
...
listPublishingDestinations pDetectorId_
  = ListPublishingDestinations'{_lpdNextToken =
                                  Nothing,
...
instance Hashable ListPublishingDestinations where

instance NFData ListPublishingDestinations where
...
data ListPublishingDestinationsResponse = ListPublishingDestinationsResponse'{_lpdrsNextToken
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
...
listPublishingDestinationsResponse
    :: Int -- ^ 'lpdrsResponseStatus'
    -> ListPublishingDestinationsResponse
listPublishingDestinationsResponse pResponseStatus_
  = ListPublishingDestinationsResponse'{_lpdrsNextToken
                                          = Nothing,
