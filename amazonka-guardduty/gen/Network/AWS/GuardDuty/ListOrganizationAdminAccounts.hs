...
data ListOrganizationAdminAccounts = ListOrganizationAdminAccounts'{_loaaNextToken
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _loaaMaxResults
...
listOrganizationAdminAccounts
    :: ListOrganizationAdminAccounts
listOrganizationAdminAccounts
  = ListOrganizationAdminAccounts'{_loaaNextToken =
                                     Nothing,
...
instance AWSPager ListOrganizationAdminAccounts where
        page rq rs
          ...
          | otherwise =
            Just $ rq & loaaNextToken .~ rs ^. loaarsNextToken

instance AWSRequest ListOrganizationAdminAccounts
         where
...
instance Hashable ListOrganizationAdminAccounts where

instance NFData ListOrganizationAdminAccounts where

instance ToHeaders ListOrganizationAdminAccounts
         where
        toHeaders
          = const
              (mconcat
...
data ListOrganizationAdminAccountsResponse = ListOrganizationAdminAccountsResponse'{_loaarsAdminAccounts
                                                                                    ::
                                                                                    !(Maybe
                                                                                        [AdminAccount]),
                                                                                    _loaarsNextToken
...
-- Use one of the following lenses to modify other fields as desired:
--
-- * 'loaarsAdminAccounts' - A list of accounts configured as GuardDuty delegated administrators.
--
...
listOrganizationAdminAccountsResponse
    :: Int -- ^ 'loaarsResponseStatus'
    -> ListOrganizationAdminAccountsResponse
listOrganizationAdminAccountsResponse
  pResponseStatus_
  = ListOrganizationAdminAccountsResponse'{_loaarsAdminAccounts
                                             = Nothing,
