...
data CreatePublishingDestination = CreatePublishingDestination'{_cpdClientToken
                                                                ::
                                                                !(Maybe Text),
                                                                _cpdDetectorId
                                                                :: !Text,
...
createPublishingDestination
    :: Text -- ^ 'cpdDetectorId'
    -> DestinationType -- ^ 'cpdDestinationType'
    -> DestinationProperties -- ^ 'cpdDestinationProperties'
    -> CreatePublishingDestination
createPublishingDestination pDetectorId_
  pDestinationType_ pDestinationProperties_
  = CreatePublishingDestination'{_cpdClientToken =
                                   Nothing,
...
instance Hashable CreatePublishingDestination where

instance NFData CreatePublishingDestination where
...
data CreatePublishingDestinationResponse = CreatePublishingDestinationResponse'{_cpdrsResponseStatus
                                                                                ::
                                                                                !Int,
                                                                                _cpdrsDestinationId
                                                                                ::
...
createPublishingDestinationResponse
    :: Int -- ^ 'cpdrsResponseStatus'
    -> Text -- ^ 'cpdrsDestinationId'
    -> CreatePublishingDestinationResponse
createPublishingDestinationResponse pResponseStatus_
  pDestinationId_
  = CreatePublishingDestinationResponse'{_cpdrsResponseStatus
                                           = pResponseStatus_,
