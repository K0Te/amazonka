...
data DeletePublishingDestination = DeletePublishingDestination'{_dpdDetectorId
                                                                :: !Text,
                                                                _dpdDestinationId
                                                                :: !Text}
...
deletePublishingDestination
    :: Text -- ^ 'dpdDetectorId'
    -> Text -- ^ 'dpdDestinationId'
    -> DeletePublishingDestination
deletePublishingDestination pDetectorId_
  pDestinationId_
  = DeletePublishingDestination'{_dpdDetectorId =
                                   pDetectorId_,
...
instance Hashable DeletePublishingDestination where

instance NFData DeletePublishingDestination where
...
instance ToPath DeletePublishingDestination where
        toPath DeletePublishingDestination'{..}
          = mconcat
              ["/detector/", toBS _dpdDetectorId,
               "/publishingDestination/", toBS _dpdDestinationId]

instance ToQuery DeletePublishingDestination where
        toQuery = const mempty

-- | /See:/ 'deletePublishingDestinationResponse' smart constructor.
newtype DeletePublishingDestinationResponse = DeletePublishingDestinationResponse'{_dpdrsResponseStatus
                                                                                   ::
                                                                                   Int}
...
deletePublishingDestinationResponse
    :: Int -- ^ 'dpdrsResponseStatus'
    -> DeletePublishingDestinationResponse
deletePublishingDestinationResponse pResponseStatus_
  = DeletePublishingDestinationResponse'{_dpdrsResponseStatus
                                           = pResponseStatus_}
