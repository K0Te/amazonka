...
newtype FlowLogsConfigurationResult = FlowLogsConfigurationResult'{_flcrStatus
                                                                   ::
                                                                   DataSourceStatus}
...
flowLogsConfigurationResult
    :: DataSourceStatus -- ^ 'flcrStatus'
    -> FlowLogsConfigurationResult
flowLogsConfigurationResult pStatus_
  = FlowLogsConfigurationResult'{_flcrStatus =
                                   pStatus_}
...
instance FromJSON FlowLogsConfigurationResult where
        parseJSON
          = withObject "FlowLogsConfigurationResult"
              (\ x ->
                 FlowLogsConfigurationResult' <$> (x .: "status"))

instance Hashable FlowLogsConfigurationResult where

instance NFData FlowLogsConfigurationResult where
