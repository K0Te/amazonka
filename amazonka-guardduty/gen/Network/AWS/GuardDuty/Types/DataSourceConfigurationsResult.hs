...
data DataSourceConfigurationsResult = DataSourceConfigurationsResult'{_dscrCloudTrail
                                                                      ::
...
dataSourceConfigurationsResult
    :: CloudTrailConfigurationResult -- ^ 'dscrCloudTrail'
    -> DNSLogsConfigurationResult -- ^ 'dscrDNSLogs'
    -> FlowLogsConfigurationResult -- ^ 'dscrFlowLogs'
    -> S3LogsConfigurationResult -- ^ 'dscrS3Logs'
    -> DataSourceConfigurationsResult
dataSourceConfigurationsResult pCloudTrail_ pDNSLogs_
  pFlowLogs_ pS3Logs_
  = DataSourceConfigurationsResult'{_dscrCloudTrail =
                                      pCloudTrail_,
...
instance FromJSON DataSourceConfigurationsResult
         where
        parseJSON
          = withObject "DataSourceConfigurationsResult"
              (\ x ->
                 DataSourceConfigurationsResult' <$>
                   (x .: "cloudTrail") <*> (x .: "dnsLogs") <*>
                     (x .: "flowLogs")
                     <*> (x .: "s3Logs"))
...
instance NFData DataSourceConfigurationsResult where
