...
data AccessControlList = AccessControlList'{_aclAllowsPublicWriteAccess
                                            :: !(Maybe Bool),
...
accessControlList
    :: AccessControlList
accessControlList
  = AccessControlList'{_aclAllowsPublicWriteAccess =
                         Nothing,
...
instance FromJSON AccessControlList where
        parseJSON
          = withObject "AccessControlList"
              (\ x ->
                 AccessControlList' <$>
                   (x .:? "allowsPublicWriteAccess") <*>
                     (x .:? "allowsPublicReadAccess"))

instance Hashable AccessControlList where

instance NFData AccessControlList where
