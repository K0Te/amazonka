...
newtype OrganizationDataSourceConfigurationsResult = OrganizationDataSourceConfigurationsResult'{_odscrS3Logs
                                                                                                 ::
...
organizationDataSourceConfigurationsResult
    :: OrganizationS3LogsConfigurationResult -- ^ 'odscrS3Logs'
    -> OrganizationDataSourceConfigurationsResult
organizationDataSourceConfigurationsResult pS3Logs_
  = OrganizationDataSourceConfigurationsResult'{_odscrS3Logs
                                                  = pS3Logs_}
