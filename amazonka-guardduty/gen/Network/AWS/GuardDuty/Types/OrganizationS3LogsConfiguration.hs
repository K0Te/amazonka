...
newtype OrganizationS3LogsConfiguration = OrganizationS3LogsConfiguration'{_oslcAutoEnable
                                                                           ::
                                                                           Bool}
...
organizationS3LogsConfiguration pAutoEnable_
  = OrganizationS3LogsConfiguration'{_oslcAutoEnable =
                                       pAutoEnable_}
...
instance NFData OrganizationS3LogsConfiguration where
