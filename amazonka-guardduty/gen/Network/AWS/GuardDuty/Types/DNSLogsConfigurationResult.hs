...
newtype DNSLogsConfigurationResult = DNSLogsConfigurationResult'{_dlcrStatus
                                                                 ::
                                                                 DataSourceStatus}
...
instance FromJSON DNSLogsConfigurationResult where
        parseJSON
          = withObject "DNSLogsConfigurationResult"
              (\ x ->
                 DNSLogsConfigurationResult' <$> (x .: "status"))

instance Hashable DNSLogsConfigurationResult where

instance NFData DNSLogsConfigurationResult where
