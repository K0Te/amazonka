...
data UsageCriteria = UsageCriteria'{_ucAccountIds ::
                                    !(Maybe (List1 Text)),
...
usageCriteria
    :: UsageCriteria
usageCriteria
  = UsageCriteria'{_ucAccountIds = Nothing,
                   _ucResources = Nothing, _ucDataSources = mempty}
...
instance Hashable UsageCriteria where

instance NFData UsageCriteria where
