...
newtype AccountLevelPermissions = AccountLevelPermissions'{_alpBlockPublicAccess
                                                           ::
                                                           Maybe
                                                             BlockPublicAccess}
...
accountLevelPermissions
    :: AccountLevelPermissions
accountLevelPermissions
  = AccountLevelPermissions'{_alpBlockPublicAccess =
                               Nothing}
...
instance FromJSON AccountLevelPermissions where
        parseJSON
          = withObject "AccountLevelPermissions"
              (\ x ->
                 AccountLevelPermissions' <$>
                   (x .:? "blockPublicAccess"))

instance Hashable AccountLevelPermissions where

instance NFData AccountLevelPermissions where
