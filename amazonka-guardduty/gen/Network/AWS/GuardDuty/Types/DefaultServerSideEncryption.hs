...
data DefaultServerSideEncryption = DefaultServerSideEncryption'{_dsseEncryptionType
                                                                ::
                                                                !(Maybe Text),
...
defaultServerSideEncryption
    :: DefaultServerSideEncryption
defaultServerSideEncryption
  = DefaultServerSideEncryption'{_dsseEncryptionType =
                                   Nothing,
...
instance FromJSON DefaultServerSideEncryption where
        parseJSON
          = withObject "DefaultServerSideEncryption"
              (\ x ->
                 DefaultServerSideEncryption' <$>
                   (x .:? "encryptionType") <*>
                     (x .:? "kmsMasterKeyArn"))

instance Hashable DefaultServerSideEncryption where

instance NFData DefaultServerSideEncryption where
