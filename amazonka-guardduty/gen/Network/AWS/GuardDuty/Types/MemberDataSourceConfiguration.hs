...
data MemberDataSourceConfiguration = MemberDataSourceConfiguration'{_mdscAccountId
                                                                    :: !Text,
                                                                    _mdscDataSources
                                                                    ::
...
memberDataSourceConfiguration
    :: Text -- ^ 'mdscAccountId'
    -> DataSourceConfigurationsResult -- ^ 'mdscDataSources'
    -> MemberDataSourceConfiguration
memberDataSourceConfiguration pAccountId_
  pDataSources_
  = MemberDataSourceConfiguration'{_mdscAccountId =
                                     pAccountId_,
...
instance FromJSON MemberDataSourceConfiguration where
        parseJSON
          = withObject "MemberDataSourceConfiguration"
              (\ x ->
                 MemberDataSourceConfiguration' <$>
                   (x .: "accountId") <*> (x .: "dataSources"))

instance Hashable MemberDataSourceConfiguration where

instance NFData MemberDataSourceConfiguration where
