...
data BucketLevelPermissions = BucketLevelPermissions'{_blpAccessControlList
                                                      ::
                                                      !(Maybe
                                                          AccessControlList),
...
bucketLevelPermissions
    :: BucketLevelPermissions
bucketLevelPermissions
  = BucketLevelPermissions'{_blpAccessControlList =
                              Nothing,
...
instance FromJSON BucketLevelPermissions where
        parseJSON
          = withObject "BucketLevelPermissions"
              (\ x ->
                 BucketLevelPermissions' <$>
                   (x .:? "accessControlList") <*>
                     (x .:? "blockPublicAccess")
...
instance Hashable BucketLevelPermissions where

instance NFData BucketLevelPermissions where
