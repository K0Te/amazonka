...
newtype DataSourceConfigurations = DataSourceConfigurations'{_dscS3Logs
                                                             ::
                                                             Maybe
                                                               S3LogsConfiguration}
...
instance Hashable DataSourceConfigurations where

instance NFData DataSourceConfigurations where
