...
data S3BucketDetail = S3BucketDetail'{_sbdARN ::
                                      !(Maybe Text),
...
s3BucketDetail
    :: S3BucketDetail
s3BucketDetail
  = S3BucketDetail'{_sbdARN = Nothing,
                    _sbdCreatedAt = Nothing, _sbdOwner = Nothing,
                    _sbdName = Nothing,
                    _sbdDefaultServerSideEncryption = Nothing,
                    _sbdPublicAccess = Nothing, _sbdType = Nothing,
                    _sbdTags = Nothing}
...
instance Hashable S3BucketDetail where

instance NFData S3BucketDetail where
