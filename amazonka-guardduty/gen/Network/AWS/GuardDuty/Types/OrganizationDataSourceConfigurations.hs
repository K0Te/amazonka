...
newtype OrganizationDataSourceConfigurations = OrganizationDataSourceConfigurations'{_odscS3Logs
                                                                                     ::
                                                                                     Maybe
...
organizationDataSourceConfigurations
    :: OrganizationDataSourceConfigurations
organizationDataSourceConfigurations
  = OrganizationDataSourceConfigurations'{_odscS3Logs =
                                            Nothing}
...
instance ToJSON OrganizationDataSourceConfigurations
         where
