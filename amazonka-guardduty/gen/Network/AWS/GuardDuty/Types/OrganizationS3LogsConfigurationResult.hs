...
newtype OrganizationS3LogsConfigurationResult = OrganizationS3LogsConfigurationResult'{_oslcrAutoEnable
                                                                                       ::
                                                                                       Bool}
...
organizationS3LogsConfigurationResult
    :: Bool -- ^ 'oslcrAutoEnable'
    -> OrganizationS3LogsConfigurationResult
organizationS3LogsConfigurationResult pAutoEnable_
  = OrganizationS3LogsConfigurationResult'{_oslcrAutoEnable
                                             = pAutoEnable_}
...
instance FromJSON
         ...
         where
        parseJSON
          = withObject "OrganizationS3LogsConfigurationResult"
              (\ x ->
                 OrganizationS3LogsConfigurationResult' <$>
                   (x .: "autoEnable"))
