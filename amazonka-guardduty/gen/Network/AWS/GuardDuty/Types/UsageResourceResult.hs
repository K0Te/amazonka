...
data UsageResourceResult = UsageResourceResult'{_urrTotal
                                                :: !(Maybe Total),
...
usageResourceResult
    :: UsageResourceResult
usageResourceResult
  = UsageResourceResult'{_urrTotal = Nothing,
...
instance FromJSON UsageResourceResult where
        parseJSON
          = withObject "UsageResourceResult"
              (\ x ->
                 UsageResourceResult' <$>
                   (x .:? "total") <*> (x .:? "resource"))

instance Hashable UsageResourceResult where

instance NFData UsageResourceResult where
