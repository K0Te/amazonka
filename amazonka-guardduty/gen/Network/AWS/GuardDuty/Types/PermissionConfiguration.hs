...
data PermissionConfiguration = PermissionConfiguration'{_pcBucketLevelPermissions
                                                        ::
                                                        !(Maybe
...
permissionConfiguration
    :: PermissionConfiguration
permissionConfiguration
  = PermissionConfiguration'{_pcBucketLevelPermissions
                               = Nothing,
...
instance FromJSON PermissionConfiguration where
        parseJSON
          = withObject "PermissionConfiguration"
              (\ x ->
                 PermissionConfiguration' <$>
                   (x .:? "bucketLevelPermissions") <*>
                     (x .:? "accountLevelPermissions"))

instance Hashable PermissionConfiguration where

instance NFData PermissionConfiguration where
