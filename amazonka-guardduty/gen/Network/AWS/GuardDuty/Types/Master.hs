...
--
-- * 'masRelationshipStatus' - The status of the relationship between the administrator and member accounts.
--
-- * 'masInvitationId' - The value used to validate the administrator account to the member account.
--
-- * 'masAccountId' - The ID of the account used as the administrator account.
master
    :: Master
master
