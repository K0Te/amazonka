...
data BlockPublicAccess = BlockPublicAccess'{_bpaIgnorePublicACLs
                                            :: !(Maybe Bool),
                                            _bpaBlockPublicACLs ::
                                            !(Maybe Bool),
...
blockPublicAccess
    :: BlockPublicAccess
blockPublicAccess
  = BlockPublicAccess'{_bpaIgnorePublicACLs = Nothing,
...
instance Hashable BlockPublicAccess where

instance NFData BlockPublicAccess where
