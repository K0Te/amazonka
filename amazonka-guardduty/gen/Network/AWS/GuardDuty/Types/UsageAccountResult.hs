...
data UsageAccountResult = UsageAccountResult'{_uarAccountId
                                              :: !(Maybe Text),
...
usageAccountResult
    :: UsageAccountResult
usageAccountResult
  = UsageAccountResult'{_uarAccountId = Nothing,
                        _uarTotal = Nothing}
...
instance FromJSON UsageAccountResult where
        parseJSON
          = withObject "UsageAccountResult"
              (\ x ->
                 UsageAccountResult' <$>
                   (x .:? "accountId") <*> (x .:? "total"))

instance Hashable UsageAccountResult where

instance NFData UsageAccountResult where
