...
data UsageStatistics = UsageStatistics'{_usTopResources
...
usageStatistics
    :: UsageStatistics
usageStatistics
  = UsageStatistics'{_usTopResources = Nothing,
...
instance Hashable UsageStatistics where

instance NFData UsageStatistics where
