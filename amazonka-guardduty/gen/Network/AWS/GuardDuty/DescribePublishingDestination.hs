...
data DescribePublishingDestination = DescribePublishingDestination'{_desDetectorId
                                                                    :: !Text,
                                                                    _desDestinationId
                                                                    :: !Text}
...
describePublishingDestination
    :: Text -- ^ 'desDetectorId'
    -> Text -- ^ 'desDestinationId'
    -> DescribePublishingDestination
describePublishingDestination pDetectorId_
  pDestinationId_
  = DescribePublishingDestination'{_desDetectorId =
                                     pDetectorId_,
...
instance AWSRequest DescribePublishingDestination
         where
...
instance Hashable DescribePublishingDestination where

instance NFData DescribePublishingDestination where

instance ToHeaders DescribePublishingDestination
         where
        toHeaders
          = const
              (mconcat
...
instance ToPath DescribePublishingDestination where
        toPath DescribePublishingDestination'{..}
          = mconcat
              ["/detector/", toBS _desDetectorId,
               "/publishingDestination/", toBS _desDestinationId]

instance ToQuery DescribePublishingDestination where
        toQuery = const mempty

-- | /See:/ 'describePublishingDestinationResponse' smart constructor.
data DescribePublishingDestinationResponse = DescribePublishingDestinationResponse'{_desrsResponseStatus
                                                                                    ::
                                                                                    !Int,
                                                                                    _desrsDestinationId
                                                                                    ::
...
describePublishingDestinationResponse
    ...
    -> Text -- ^ 'desrsDestinationId'
    -> DestinationType -- ^ 'desrsDestinationType'
    -> PublishingStatus -- ^ 'desrsStatus'
    -> Integer -- ^ 'desrsPublishingFailureStartTimestamp'
    -> DestinationProperties -- ^ 'desrsDestinationProperties'
    -> DescribePublishingDestinationResponse
describePublishingDestinationResponse
  pResponseStatus_ pDestinationId_ pDestinationType_
  pStatus_ pPublishingFailureStartTimestamp_
  pDestinationProperties_
  = DescribePublishingDestinationResponse'{_desrsResponseStatus
                                             = pResponseStatus_,
                                           _desrsDestinationId =
                                             pDestinationId_,
                                           _desrsDestinationType =
