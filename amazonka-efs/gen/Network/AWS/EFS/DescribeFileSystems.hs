...
data DescribeFileSystems = DescribeFileSystems'{_dfsFileSystemId
                                                :: !(Maybe Text),
                                                _dfsCreationToken ::
                                                !(Maybe Text),
...
describeFileSystems
    :: DescribeFileSystems
describeFileSystems
  = DescribeFileSystems'{_dfsFileSystemId = Nothing,
                         _dfsCreationToken = Nothing, _dfsMarker = Nothing,
...
data DescribeFileSystemsResponse = DescribeFileSystemsResponse'{_dfsrsFileSystems
                                                                ::
                                                                !(Maybe
...
describeFileSystemsResponse pResponseStatus_
  = DescribeFileSystemsResponse'{_dfsrsFileSystems =
                                   Nothing,
