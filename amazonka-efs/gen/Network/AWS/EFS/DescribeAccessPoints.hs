...
data DescribeAccessPoints = DescribeAccessPoints'{_dapAccessPointId
                                                  :: !(Maybe Text),
                                                  _dapFileSystemId ::
                                                  !(Maybe Text),
                                                  _dapNextToken ::
...
describeAccessPoints
    :: DescribeAccessPoints
describeAccessPoints
  = DescribeAccessPoints'{_dapAccessPointId = Nothing,
                          _dapFileSystemId = Nothing, _dapNextToken = Nothing,
...
instance Hashable DescribeAccessPoints where

instance NFData DescribeAccessPoints where
...
data DescribeAccessPointsResponse = DescribeAccessPointsResponse'{_daprsAccessPoints
                                                                  ::
                                                                  !(Maybe
...
describeAccessPointsResponse pResponseStatus_
  = DescribeAccessPointsResponse'{_daprsAccessPoints =
                                    Nothing,
...
instance NFData DescribeAccessPointsResponse where
