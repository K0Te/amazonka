...
newtype DescribeFileSystemPolicy = DescribeFileSystemPolicy'{_desFileSystemId
                                                             :: Text}
...
describeFileSystemPolicy
    :: Text -- ^ 'desFileSystemId'
    -> DescribeFileSystemPolicy
describeFileSystemPolicy pFileSystemId_
  = DescribeFileSystemPolicy'{_desFileSystemId =
                                pFileSystemId_}
...
instance Hashable DescribeFileSystemPolicy where

instance NFData DescribeFileSystemPolicy where
...
instance ToPath DescribeFileSystemPolicy where
        toPath DescribeFileSystemPolicy'{..}
          = mconcat
              ["/2015-02-01/file-systems/", toBS _desFileSystemId,
               "/policy"]
