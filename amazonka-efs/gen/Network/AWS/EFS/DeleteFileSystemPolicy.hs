...
newtype DeleteFileSystemPolicy = DeleteFileSystemPolicy'{_dfspFileSystemId
                                                         :: Text}
...
deleteFileSystemPolicy
    :: Text -- ^ 'dfspFileSystemId'
    -> DeleteFileSystemPolicy
deleteFileSystemPolicy pFileSystemId_
  = DeleteFileSystemPolicy'{_dfspFileSystemId =
                              pFileSystemId_}
...
instance AWSRequest DeleteFileSystemPolicy where
        type Rs DeleteFileSystemPolicy =
             DeleteFileSystemPolicyResponse
        request = delete efs
        response
          = receiveNull DeleteFileSystemPolicyResponse'

instance Hashable DeleteFileSystemPolicy where

instance NFData DeleteFileSystemPolicy where
...
instance ToPath DeleteFileSystemPolicy where
        toPath DeleteFileSystemPolicy'{..}
          = mconcat
              ["/2015-02-01/file-systems/", toBS _dfspFileSystemId,
               "/policy"]
...
instance NFData DeleteFileSystemPolicyResponse where
