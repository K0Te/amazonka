...
newtype BackupPolicyDescription = BackupPolicyDescription'{_bpdBackupPolicy
                                                           ::
                                                           Maybe BackupPolicy}
...
backupPolicyDescription
    :: BackupPolicyDescription
backupPolicyDescription
  = BackupPolicyDescription'{_bpdBackupPolicy =
                               Nothing}
...
instance FromJSON BackupPolicyDescription where
        parseJSON
          = withObject "BackupPolicyDescription"
              (\ x ->
                 BackupPolicyDescription' <$> (x .:? "BackupPolicy"))

instance Hashable BackupPolicyDescription where

instance NFData BackupPolicyDescription where
