...
newtype DeleteAccessPoint = DeleteAccessPoint'{_dAccessPointId
                                               :: Text}
...
deleteAccessPoint pAccessPointId_
  = DeleteAccessPoint'{_dAccessPointId =
                         pAccessPointId_}
...
instance Hashable DeleteAccessPoint where

instance NFData DeleteAccessPoint where
...
instance ToPath DeleteAccessPoint where
        toPath DeleteAccessPoint'{..}
          = mconcat
              ["/2015-02-01/access-points/", toBS _dAccessPointId]
...
instance NFData DeleteAccessPointResponse where
