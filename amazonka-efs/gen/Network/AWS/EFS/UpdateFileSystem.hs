...
data UpdateFileSystem = UpdateFileSystem'{_ufsProvisionedThroughputInMibps
                                          :: !(Maybe Double),
                                          _ufsThroughputMode ::
...
updateFileSystem
    :: Text -- ^ 'ufsFileSystemId'
    -> UpdateFileSystem
updateFileSystem pFileSystemId_
  = UpdateFileSystem'{_ufsProvisionedThroughputInMibps
                        = Nothing,
...
instance Hashable UpdateFileSystem where

instance NFData UpdateFileSystem where
