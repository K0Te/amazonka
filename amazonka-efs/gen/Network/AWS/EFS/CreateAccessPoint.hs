...
data CreateAccessPoint = CreateAccessPoint'{_capPosixUser
                                            :: !(Maybe PosixUser),
                                            _capRootDirectory ::
                                            !(Maybe RootDirectory),
                                            _capTags :: !(Maybe [Tag]),
...
createAccessPoint
    :: Text -- ^ 'capClientToken'
    -> Text -- ^ 'capFileSystemId'
    -> CreateAccessPoint
createAccessPoint pClientToken_ pFileSystemId_
  = CreateAccessPoint'{_capPosixUser = Nothing,
                       _capRootDirectory = Nothing, _capTags = Nothing,
...
instance Hashable CreateAccessPoint where

instance NFData CreateAccessPoint where
