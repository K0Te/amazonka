...
data GetObject = GetObject'{_goRange ::
                            !(Maybe Text),
                            _goPath :: !Text}
...
data GetObjectResponse = GetObjectResponse'{_gorsETag
                                            :: !(Maybe Text),
...
getObjectResponse pStatusCode_ pBody_
  = GetObjectResponse'{_gorsETag = Nothing,
                       ...
                       _gorsStatusCode = pStatusCode_, _gorsBody = pBody_}
