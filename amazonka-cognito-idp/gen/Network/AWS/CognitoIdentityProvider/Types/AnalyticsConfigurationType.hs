...
data AnalyticsConfigurationType = AnalyticsConfigurationType'{_actApplicationARN
                                                              :: !(Maybe Text),
                                                              _actUserDataShared
                                                              :: !(Maybe Bool),
                                                              _actApplicationId
...
analyticsConfigurationType
    :: AnalyticsConfigurationType
analyticsConfigurationType
  = AnalyticsConfigurationType'{_actApplicationARN =
                                  Nothing,
                                _actUserDataShared = Nothing,
                                _actApplicationId = Nothing,
                                _actExternalId = Nothing, _actRoleARN = Nothing}
...
instance FromJSON AnalyticsConfigurationType where
        parseJSON
          = withObject "AnalyticsConfigurationType"
              (\ x ->
                 AnalyticsConfigurationType' <$>
                   (x .:? "ApplicationArn") <*> (x .:? "UserDataShared")
                     <*> (x .:? "ApplicationId")
                     <*> (x .:? "ExternalId")
                     <*> (x .:? "RoleArn"))
