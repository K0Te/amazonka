...
data CustomSMSLambdaVersionConfigType = CustomSMSLambdaVersionConfigType'{_csmslvctLambdaVersion
                                                                          ::
...
customSMSLambdaVersionConfigType
    :: CustomSMSSenderLambdaVersionType -- ^ 'csmslvctLambdaVersion'
    -> Text -- ^ 'csmslvctLambdaARN'
    -> CustomSMSLambdaVersionConfigType
customSMSLambdaVersionConfigType pLambdaVersion_
  pLambdaARN_
  = CustomSMSLambdaVersionConfigType'{_csmslvctLambdaVersion
                                        = pLambdaVersion_,
...
instance FromJSON CustomSMSLambdaVersionConfigType
         where
        parseJSON
          = withObject "CustomSMSLambdaVersionConfigType"
              (\ x ->
                 CustomSMSLambdaVersionConfigType' <$>
...
instance ToJSON CustomSMSLambdaVersionConfigType
         where
