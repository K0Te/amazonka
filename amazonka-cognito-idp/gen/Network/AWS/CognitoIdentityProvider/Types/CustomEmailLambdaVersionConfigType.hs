...
data CustomEmailLambdaVersionConfigType = CustomEmailLambdaVersionConfigType'{_celvctLambdaVersion
                                                                              ::
...
customEmailLambdaVersionConfigType
    :: CustomEmailSenderLambdaVersionType -- ^ 'celvctLambdaVersion'
    -> Text -- ^ 'celvctLambdaARN'
    -> CustomEmailLambdaVersionConfigType
customEmailLambdaVersionConfigType pLambdaVersion_
  pLambdaARN_
  = CustomEmailLambdaVersionConfigType'{_celvctLambdaVersion
                                          = pLambdaVersion_,
...
instance FromJSON CustomEmailLambdaVersionConfigType
         where
        parseJSON
          = withObject "CustomEmailLambdaVersionConfigType"
              (\ x ->
                 CustomEmailLambdaVersionConfigType' <$>
...
instance ToJSON CustomEmailLambdaVersionConfigType
         where
