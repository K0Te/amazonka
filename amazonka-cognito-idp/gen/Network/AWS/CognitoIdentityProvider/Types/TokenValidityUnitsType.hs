...
data TokenValidityUnitsType = TokenValidityUnitsType'{_tvutAccessToken
                                                      :: !(Maybe TimeUnitsType),
                                                      _tvutRefreshToken ::
                                                      !(Maybe TimeUnitsType),
                                                      _tvutIdToken ::
...
tokenValidityUnitsType
    :: TokenValidityUnitsType
tokenValidityUnitsType
  = TokenValidityUnitsType'{_tvutAccessToken = Nothing,
                            _tvutRefreshToken = Nothing, _tvutIdToken = Nothing}
...
instance FromJSON TokenValidityUnitsType where
        parseJSON
          = withObject "TokenValidityUnitsType"
              (\ x ->
                 TokenValidityUnitsType' <$>
                   (x .:? "AccessToken") <*> (x .:? "RefreshToken") <*>
                     (x .:? "IdToken"))

instance Hashable TokenValidityUnitsType where

instance NFData TokenValidityUnitsType where
