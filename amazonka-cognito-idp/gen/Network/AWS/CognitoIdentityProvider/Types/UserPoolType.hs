...
data UserPoolType = UserPoolType'{_uptStatus ::
                                  !(Maybe StatusType),
...
userPoolType
    :: UserPoolType
userPoolType
  = UserPoolType'{_uptStatus = Nothing,
                  ...
                  _uptARN = Nothing, _uptDomain = Nothing,
                  ...
                  _uptName = Nothing, _uptMFAConfiguration = Nothing,
                  _uptId = Nothing,
