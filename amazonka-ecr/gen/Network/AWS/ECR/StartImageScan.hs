...
data StartImageScan = StartImageScan'{_sisRegistryId
                                      :: !(Maybe Text),
...
startImageScan
    :: Text -- ^ 'sisRepositoryName'
    -> ImageIdentifier -- ^ 'sisImageId'
    -> StartImageScan
startImageScan pRepositoryName_ pImageId_
  = StartImageScan'{_sisRegistryId = Nothing,
...
instance AWSRequest StartImageScan where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 StartImageScanResponse' <$>
                   (x .?> "registryId") <*> (x .?> "imageScanStatus")
                     <*> (x .?> "imageId")
                     <*> (x .?> "repositoryName")
                     <*> (pure (fromEnum s)))

instance Hashable StartImageScan where

instance NFData StartImageScan where
...
data StartImageScanResponse = StartImageScanResponse'{_sisrsRegistryId
                                                      :: !(Maybe Text),
                                                      _sisrsImageScanStatus ::
                                                      !(Maybe ImageScanStatus),
                                                      _sisrsImageId ::
                                                      !(Maybe ImageIdentifier),
                                                      _sisrsRepositoryName ::
                                                      !(Maybe Text),
                                                      _sisrsResponseStatus ::
                                                      !Int}
...
startImageScanResponse
    :: Int -- ^ 'sisrsResponseStatus'
    -> StartImageScanResponse
startImageScanResponse pResponseStatus_
  = StartImageScanResponse'{_sisrsRegistryId = Nothing,
...
instance NFData StartImageScanResponse where
