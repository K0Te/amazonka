...
data PutImageTagMutability = PutImageTagMutability'{_pitmRegistryId
                                                    :: !(Maybe Text),
                                                    _pitmRepositoryName ::
                                                    !Text,
...
putImageTagMutability
    :: Text -- ^ 'pitmRepositoryName'
    -> ImageTagMutability -- ^ 'pitmImageTagMutability'
    -> PutImageTagMutability
putImageTagMutability pRepositoryName_
  pImageTagMutability_
  = PutImageTagMutability'{_pitmRegistryId = Nothing,
...
instance Hashable PutImageTagMutability where

instance NFData PutImageTagMutability where
...
data PutImageTagMutabilityResponse = PutImageTagMutabilityResponse'{_pitmrsRegistryId
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
...
putImageTagMutabilityResponse
    :: Int -- ^ 'pitmrsResponseStatus'
    -> PutImageTagMutabilityResponse
putImageTagMutabilityResponse pResponseStatus_
  = PutImageTagMutabilityResponse'{_pitmrsRegistryId =
                                     Nothing,
...
instance NFData PutImageTagMutabilityResponse where
