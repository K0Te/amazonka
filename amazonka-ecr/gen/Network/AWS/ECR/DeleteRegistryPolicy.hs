...
instance Hashable DeleteRegistryPolicy where

instance NFData DeleteRegistryPolicy where
...
data DeleteRegistryPolicyResponse = DeleteRegistryPolicyResponse'{_delrsRegistryId
                                                                  ::
                                                                  !(Maybe Text),
                                                                  _delrsPolicyText
                                                                  ::
...
deleteRegistryPolicyResponse pResponseStatus_
  = DeleteRegistryPolicyResponse'{_delrsRegistryId =
                                    Nothing,
...
instance NFData DeleteRegistryPolicyResponse where
