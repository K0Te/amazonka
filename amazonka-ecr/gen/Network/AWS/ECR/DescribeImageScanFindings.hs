...
data DescribeImageScanFindings = DescribeImageScanFindings'{_disfRegistryId
                                                            :: !(Maybe Text),
                                                            _disfNextToken ::
                                                            !(Maybe Text),
                                                            _disfMaxResults ::
...
describeImageScanFindings
    :: Text -- ^ 'disfRepositoryName'
    -> ImageIdentifier -- ^ 'disfImageId'
    -> DescribeImageScanFindings
describeImageScanFindings pRepositoryName_ pImageId_
  = DescribeImageScanFindings'{_disfRegistryId =
                                 Nothing,
...
instance AWSPager DescribeImageScanFindings where
        page rq rs
          ...
          | stop
              (rs ^? disfrsImageScanFindings . _Just . isfFindings)
            = Nothing
          | otherwise =
            Just $ rq & disfNextToken .~ rs ^. disfrsNextToken
...
instance AWSRequest DescribeImageScanFindings where
        ...
        response
          = receiveJSON
              (\ s h x ->
                 DescribeImageScanFindingsResponse' <$>
                   (x .?> "registryId") <*> (x .?> "imageScanFindings")
                     <*> (x .?> "imageScanStatus")
                     <*> (x .?> "nextToken")
                     <*> (x .?> "imageId")
                     <*> (x .?> "repositoryName")
...
instance Hashable DescribeImageScanFindings where

instance NFData DescribeImageScanFindings where
...
data DescribeImageScanFindingsResponse = DescribeImageScanFindingsResponse'{_disfrsRegistryId
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
describeImageScanFindingsResponse
    :: Int -- ^ 'disfrsResponseStatus'
    -> DescribeImageScanFindingsResponse
describeImageScanFindingsResponse pResponseStatus_
  = DescribeImageScanFindingsResponse'{_disfrsRegistryId
                                         = Nothing,
