...
data PutImageScanningConfiguration = PutImageScanningConfiguration'{_piscRegistryId
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _piscRepositoryName
...
putImageScanningConfiguration
    :: Text -- ^ 'piscRepositoryName'
    -> ImageScanningConfiguration -- ^ 'piscImageScanningConfiguration'
    -> PutImageScanningConfiguration
putImageScanningConfiguration pRepositoryName_
  pImageScanningConfiguration_
  = PutImageScanningConfiguration'{_piscRegistryId =
                                     Nothing,
...
instance AWSRequest PutImageScanningConfiguration
         where
...
instance Hashable PutImageScanningConfiguration where

instance NFData PutImageScanningConfiguration where

instance ToHeaders PutImageScanningConfiguration
         where
        toHeaders
          = const
              (mconcat
...
data PutImageScanningConfigurationResponse = PutImageScanningConfigurationResponse'{_piscrsRegistryId
                                                                                    ::
                                                                                    !(Maybe
                                                                                        Text),
...
putImageScanningConfigurationResponse
    :: Int -- ^ 'piscrsResponseStatus'
    -> PutImageScanningConfigurationResponse
putImageScanningConfigurationResponse
  pResponseStatus_
  = PutImageScanningConfigurationResponse'{_piscrsRegistryId
                                             = Nothing,
                                           _piscrsImageScanningConfiguration =
                                             Nothing,
