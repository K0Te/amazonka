...
data DescribeGameServerInstances = DescribeGameServerInstances'{_dgsiNextToken
                                                                ::
                                                                !(Maybe Text),
                                                                _dgsiInstanceIds
                                                                ::
...
describeGameServerInstances
    :: Text -- ^ 'dgsiGameServerGroupName'
    -> DescribeGameServerInstances
describeGameServerInstances pGameServerGroupName_
  = DescribeGameServerInstances'{_dgsiNextToken =
                                   Nothing,
...
instance AWSPager DescribeGameServerInstances where
        page rq rs
          ...
          | otherwise =
            Just $ rq & dgsiNextToken .~ rs ^. dgsirsNextToken
...
instance Hashable DescribeGameServerInstances where

instance NFData DescribeGameServerInstances where
...
data DescribeGameServerInstancesResponse = DescribeGameServerInstancesResponse'{_dgsirsGameServerInstances
                                                                                ::
                                                                                !(Maybe
                                                                                    [GameServerInstance]),
                                                                                _dgsirsNextToken
...
describeGameServerInstancesResponse
    :: Int -- ^ 'dgsirsResponseStatus'
    -> DescribeGameServerInstancesResponse
describeGameServerInstancesResponse pResponseStatus_
  = DescribeGameServerInstancesResponse'{_dgsirsGameServerInstances
                                           = Nothing,
