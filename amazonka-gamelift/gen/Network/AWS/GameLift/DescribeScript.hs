...
newtype DescribeScript = DescribeScript'{_dScriptId
                                         :: Text}
...
instance Hashable DescribeScript where

instance NFData DescribeScript where
...
data DescribeScriptResponse = DescribeScriptResponse'{_dsrsScript
                                                      :: !(Maybe Script),
                                                      _dsrsResponseStatus ::
                                                      !Int}
...
describeScriptResponse pResponseStatus_
  = DescribeScriptResponse'{_dsrsScript = Nothing,
...
instance NFData DescribeScriptResponse where
