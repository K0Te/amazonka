...
data CreateVPCPeeringConnection = CreateVPCPeeringConnection'{_cvpcFleetId
                                                              :: !Text,
...
createVPCPeeringConnection
    ...
    -> Text -- ^ 'cvpcPeerVPCId'
    -> CreateVPCPeeringConnection
createVPCPeeringConnection pFleetId_
  pPeerVPCAWSAccountId_ pPeerVPCId_
  = CreateVPCPeeringConnection'{_cvpcFleetId =
                                  pFleetId_,
                                _cvpcPeerVPCAWSAccountId =
...
newtype CreateVPCPeeringConnectionResponse = CreateVPCPeeringConnectionResponse'{_cvpcrsResponseStatus
                                                                                 ::
                                                                                 Int}
...
createVPCPeeringConnectionResponse pResponseStatus_
  = CreateVPCPeeringConnectionResponse'{_cvpcrsResponseStatus
                                          = pResponseStatus_}
