...
data ListGameServerGroups = ListGameServerGroups'{_lgsgNextToken
                                                  :: !(Maybe Text),
...
listGameServerGroups
    :: ListGameServerGroups
listGameServerGroups
  = ListGameServerGroups'{_lgsgNextToken = Nothing,
                          _lgsgLimit = Nothing}
...
instance AWSPager ListGameServerGroups where
        page rq rs
          ...
          | otherwise =
            Just $ rq & lgsgNextToken .~ rs ^. lgsgrsNextToken

instance AWSRequest ListGameServerGroups where
        type Rs ListGameServerGroups =
             ListGameServerGroupsResponse
...
instance Hashable ListGameServerGroups where

instance NFData ListGameServerGroups where
...
data ListGameServerGroupsResponse = ListGameServerGroupsResponse'{_lgsgrsGameServerGroups
                                                                  ::
                                                                  !(Maybe
                                                                      [GameServerGroup]),
                                                                  _lgsgrsNextToken
...
listGameServerGroupsResponse
    :: Int -- ^ 'lgsgrsResponseStatus'
    -> ListGameServerGroupsResponse
listGameServerGroupsResponse pResponseStatus_
  = ListGameServerGroupsResponse'{_lgsgrsGameServerGroups
                                    = Nothing,
...
instance NFData ListGameServerGroupsResponse where
