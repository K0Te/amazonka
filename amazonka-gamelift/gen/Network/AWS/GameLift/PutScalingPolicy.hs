...
data PutScalingPolicy = PutScalingPolicy'{_pspScalingAdjustmentType
...
putScalingPolicy pName_ pFleetId_ pMetricName_
  = PutScalingPolicy'{_pspScalingAdjustmentType =
                        Nothing,
                      ...
                      _pspTargetConfiguration = Nothing, _pspName = pName_,
...
data PutScalingPolicyResponse = PutScalingPolicyResponse'{_psprsName
                                                          :: !(Maybe Text),
