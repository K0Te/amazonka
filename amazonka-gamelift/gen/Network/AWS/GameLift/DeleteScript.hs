...
newtype DeleteScript = DeleteScript'{_dsScriptId ::
                                     Text}
...
instance Hashable DeleteScript where

instance NFData DeleteScript where
...
instance NFData DeleteScriptResponse where
