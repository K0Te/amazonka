...
newtype DeleteMatchmakingRuleSet = DeleteMatchmakingRuleSet'{_dmrsName
                                                             :: Text}
...
instance AWSRequest DeleteMatchmakingRuleSet where
        type Rs DeleteMatchmakingRuleSet =
             DeleteMatchmakingRuleSetResponse
...
instance Hashable DeleteMatchmakingRuleSet where

instance NFData DeleteMatchmakingRuleSet where
...
newtype DeleteMatchmakingRuleSetResponse = DeleteMatchmakingRuleSetResponse'{_dmrsrsResponseStatus
                                                                             ::
                                                                             Int}
...
deleteMatchmakingRuleSetResponse pResponseStatus_
  = DeleteMatchmakingRuleSetResponse'{_dmrsrsResponseStatus
                                        = pResponseStatus_}
