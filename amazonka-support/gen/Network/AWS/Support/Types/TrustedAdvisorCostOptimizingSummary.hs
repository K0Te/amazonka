...
data TrustedAdvisorCostOptimizingSummary = TrustedAdvisorCostOptimizingSummary'{_tacosEstimatedMonthlySavings
                                                                                ::
                                                                                !Double,
...
trustedAdvisorCostOptimizingSummary
  ...
  = TrustedAdvisorCostOptimizingSummary'{_tacosEstimatedMonthlySavings
                                           = pEstimatedMonthlySavings_,
                                         _tacosEstimatedPercentMonthlySavings =
                                           pEstimatedPercentMonthlySavings_}
