...
data AddApplicationOutput = AddApplicationOutput'{_aaoApplicationName
                                                  :: !Text,
...
addApplicationOutput
    ...
    -> Output -- ^ 'aaoOutput'
    -> AddApplicationOutput
addApplicationOutput pApplicationName_
  pCurrentApplicationVersionId_ pOutput_
...
newtype AddApplicationOutputResponse = AddApplicationOutputResponse'{_aaorsResponseStatus
                                                                     :: Int}
...
addApplicationOutputResponse pResponseStatus_
  = AddApplicationOutputResponse'{_aaorsResponseStatus
                                    = pResponseStatus_}
